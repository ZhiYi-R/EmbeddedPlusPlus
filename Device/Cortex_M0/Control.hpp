...
#ifndef EMBEDDED_PP_CORTEX_M0_CONTROL_HPP
#define EMBEDDED_PP_CORTEX_M0_CONTROL_HPP
...
namespace Cortex_M0::Control {
    ...
    /** @brief CCR */
    using CCR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief STKALIGN */
