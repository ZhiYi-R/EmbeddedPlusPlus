...
#ifndef EMBEDDED_PP_CORTEX_M7_CONTROL_HPP
#define EMBEDDED_PP_CORTEX_M7_CONTROL_HPP
...
namespace Cortex_M7::Control {

    /** @brief ACTLR */
    using ACTLR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DISOOFP */
    using ACTLR_DISOOFP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - Enabled: No description (value: 0)
     *          - Disabled: No description (value: 1)
     */
        /** @brief Enabled value */
    constexpr std::uint32_t ACTLR_DISOOFP_Enabled = 0;
        /** @brief Disabled value */
    constexpr std::uint32_t ACTLR_DISOOFP_Disabled = 1;

    /** @brief DISFPCA */
    using ACTLR_DISFPCA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - Enabled: No description (value: 0)
     *          - Disabled: No description (value: 1)
     */
        /** @brief Enabled value */
    constexpr std::uint32_t ACTLR_DISFPCA_Enabled = 0;
        /** @brief Disabled value */
    constexpr std::uint32_t ACTLR_DISFPCA_Disabled = 1;
    ...
    /** @brief TBLOFF */
    using VTOR_TBLOFF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 23, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DEMCR */
    ...
    /** @brief VECTKEYSTAT */
    using AIRCR_VECTKEYSTAT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ENDIANNESS */
    ...
    /** @brief PRIGROUP */
    using AIRCR_PRIGROUP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SYSRESETREQ */
    using AIRCR_SYSRESETREQ = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    /** @brief VECTCLRACTIVE */
    using AIRCR_VECTCLRACTIVE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - Do_not_clear: No description (value: 0)
     ...
     */
        /** @brief Disabled value */
    constexpr std::uint32_t CCR_BP_Disabled = 0;
        /** @brief Enabled value */
    constexpr std::uint32_t CCR_BP_Enabled = 1;
     ...
     */
        /** @brief Disabled value */
    constexpr std::uint32_t CCR_IC_Disabled = 0;
        /** @brief Enabled value */
    constexpr std::uint32_t CCR_IC_Enabled = 1;
     ...
     */
        /** @brief Disabled value */
    constexpr std::uint32_t CCR_DC_Disabled = 0;
        /** @brief Enabled value */
    constexpr std::uint32_t CCR_DC_Enabled = 1;
