...
#ifndef EMBEDDED_PP_CORTEX_M7_ID_HPP
#define EMBEDDED_PP_CORTEX_M7_ID_HPP
...
namespace Cortex_M7::ID {
    ...
    /** @brief TCM_support */
    using ID_MMFR0_TCM_support = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - No_TCM: No description (value: 0)
     *          - TCM_Implemented: No description (value: 1)
     */
        /** @brief No_TCM value */
    constexpr std::uint32_t ID_MMFR0_TCM_support_No_TCM = 0;
        /** @brief TCM_Implemented value */
    constexpr std::uint32_t ID_MMFR0_TCM_support_TCM_Implemented = 1;
    ...
    /** @brief PSR_AR_instrs */
    using ID_ISAR2_PSR_AR_instrs = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief MultU_instrs */
    ...
    /** @brief MemHint_instrs */
    using ID_ISAR2_MemHint_instrs = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
