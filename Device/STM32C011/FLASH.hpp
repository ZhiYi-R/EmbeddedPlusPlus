...
#ifndef EMBEDDED_PP_STM32C011_FLASH_HPP
#define EMBEDDED_PP_STM32C011_FLASH_HPP
...
namespace STM32C011::FLASH {
    ...
    /** @brief Page number selection These bits select the page to erase: ... Note: Values corresponding to addresses outside the Main memory are not allowed. See Table 6 and Table 7. */
    using FLASH_CR_PNB = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    /** @brief BOR threshold at falling VDD supply Falling VDD crossings this threshold activates the reset signal. */
    ...
    /** @brief Boot configuration Together with the BOOT0 pin or option bit nBOOT0 (depending on nBOOT_SEL option bit configuration), this bit selects boot mode from the Main flash memory, SRAM or the System memory. Refer to Section 3: Boot configuration. */
    ...
    using FLASH_PCROP1ASR_PCROP1A_STRT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 6, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using FLASH_PCROP1AER_PCROP1A_END = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 6, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using FLASH_WRP1AR_WRP1A_STRT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using FLASH_WRP1AR_WRP1A_END = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using FLASH_WRP1BR_WRP1B_STRT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using FLASH_WRP1BR_WRP1B_END = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using FLASH_PCROP1BSR_PCROP1B_STRT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 6, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using FLASH_PCROP1BER_PCROP1B_END = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 6, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using FLASH_SECR_SEC_SIZE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
