...
#ifndef EMBEDDED_PP_STM32C011_I2C1_HPP
#define EMBEDDED_PP_STM32C011_I2C1_HPP
...
namespace STM32C011::I2C1 {
    ...
    /** @brief Timing prescaler This field is used to prescale I2CCLK in order to generate the clock period tPRESC used for data setup and hold counters (refer to ) and for SCL high and low level counters (refer to ). tPRESC = (PRESC+1) x tI2CCLK */
