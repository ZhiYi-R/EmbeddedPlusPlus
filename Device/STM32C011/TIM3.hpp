...
#ifndef EMBEDDED_PP_STM32C011_TIM3_HPP
#define EMBEDDED_PP_STM32C011_TIM3_HPP
...
namespace STM32C011::TIM3 {
     ...
     *          - B_0x1: The TIMx_CH1, CH2 and CH3 pins are connected to the TI1 input (XOR combination) See also (value: 1)
     */
        /** @brief The TIMx_CH1 pin is connected to TI1 input */
    constexpr std::uint16_t TIM3_CR2_TI1S_B_0x0 = 0;
        /** @brief The TIMx_CH1, CH2 and CH3 pins are connected to the TI1 input (XOR combination) See also */
    ...
    /** @brief Slave mode selection When external signals are selected the active edge of the trigger signal (TRGI) is linked to the polarity selected on the external input (see Input Control register and Control Register description. reinitializes the counter, generates an update of the registers and starts the counter. Note: The gated mode must not be used if TI1F_ED is selected as the trigger input (TS=00100). Indeed, TI1F_ED outputs 1 pulse for each transition on TI1F, whereas the gated mode checks the level of the trigger signal. Note: The clock of the slave peripherals (timer, ADC, ...) receiving the TRGO or the TRGO2 signals must be enabled prior to receive events from the master timer, and the clock frequency (prescaler) must not be changed on-the-fly while triggers are received from the master timer. */
    using TIM3_SMCR_SMS1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM3_SMCR_TS1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM3_SMCR_TS1_B_0x0 = 0;
        /** @brief Internal Trigger 1 (ITR1) */
    constexpr std::uint32_t TIM3_SMCR_TS1_B_0x1 = 1;
        /** @brief Internal Trigger 2 (ITR2) */
    constexpr std::uint32_t TIM3_SMCR_TS1_B_0x2 = 2;
        /** @brief Internal Trigger 3 (ITR3) */
    constexpr std::uint32_t TIM3_SMCR_TS1_B_0x3 = 3;
        /** @brief TI1 Edge Detector (TI1F_ED) */
    constexpr std::uint32_t TIM3_SMCR_TS1_B_0x4 = 4;
        /** @brief Filtered Timer Input 1 (TI1FP1) */
    constexpr std::uint32_t TIM3_SMCR_TS1_B_0x5 = 5;
        /** @brief Filtered Timer Input 2 (TI2FP2) */
    constexpr std::uint32_t TIM3_SMCR_TS1_B_0x6 = 6;
        /** @brief External Trigger input (ETRF) */
    constexpr std::uint32_t TIM3_SMCR_TS1_B_0x7 = 7;
    ...
    /** @brief Slave mode selection When external signals are selected the active edge of the trigger signal (TRGI) is linked to the polarity selected on the external input (see Input Control register and Control Register description. reinitializes the counter, generates an update of the registers and starts the counter. Note: The gated mode must not be used if TI1F_ED is selected as the trigger input (TS=00100). Indeed, TI1F_ED outputs 1 pulse for each transition on TI1F, whereas the gated mode checks the level of the trigger signal. Note: The clock of the slave peripherals (timer, ADC, ...) receiving the TRGO or the TRGO2 signals must be enabled prior to receive events from the master timer, and the clock frequency (prescaler) must not be changed on-the-fly while triggers are received from the master timer. */
    using TIM3_SMCR_SMS2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM3_SMCR_SMS2_B_0x0 = 0;
        /** @brief Encoder mode 1 - Counter counts up/down on TI1FP1 edge depending on TI2FP2 level. */
    constexpr std::uint32_t TIM3_SMCR_SMS2_B_0x1 = 1;

    /** @brief Trigger selection This bit-field selects the trigger input to be used to synchronize the counter. Others: Reserved See for more details on ITRx meaning for each Timer. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition. */
    using TIM3_SMCR_TS2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Internal Trigger 0 (ITR0) (value: 0)
     *          - B_0x1: Internal Trigger 1 (ITR1) (value: 1)
     *          - B_0x2: Internal Trigger 2 (ITR2) (value: 2)
     ...
     */
        /** @brief Internal Trigger 0 (ITR0) */
    constexpr std::uint32_t TIM3_SMCR_TS2_B_0x0 = 0;
        /** @brief Internal Trigger 1 (ITR1) */
    constexpr std::uint32_t TIM3_SMCR_TS2_B_0x1 = 1;
        /** @brief Internal Trigger 2 (ITR2) */
    constexpr std::uint32_t TIM3_SMCR_TS2_B_0x2 = 2;
        /** @brief Internal Trigger 3 (ITR3) */
    constexpr std::uint32_t TIM3_SMCR_TS2_B_0x3 = 3;
    ...
    using TIM3_CCMR1_input = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x18, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM3_CCMR1_input_CC1S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM3_CCMR1_input_CC1S_B_0x0 = 0;
        /** @brief CC1 channel is configured as input, IC1 is mapped on TI1 */
    constexpr std::uint32_t TIM3_CCMR1_input_CC1S_B_0x1 = 1;
        /** @brief CC1 channel is configured as input, IC1 is mapped on TI2 */
    constexpr std::uint32_t TIM3_CCMR1_input_CC1S_B_0x2 = 2;
    ...
    constexpr std::uint32_t TIM3_CCMR1_input_CC1S_B_0x3 = 3;
    ...
    using TIM3_CCMR1_input_IC1PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM3_CCMR1_input_IC1PSC_B_0x0 = 0;
        /** @brief capture is done once every 2 events */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1PSC_B_0x1 = 1;
        /** @brief capture is done once every 4 events */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1PSC_B_0x2 = 2;
        /** @brief capture is done once every 8 events */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1PSC_B_0x3 = 3;
    ...
    using TIM3_CCMR1_input_IC1F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No filter, sampling is done at fDTS (value: 0)
     *          - B_0x1: fSAMPLING=fCK_INT, N=2 (value: 1)
     *          - B_0x2: fSAMPLING=fCK_INT, N=4 (value: 2)
     ...
     */
        /** @brief No filter, sampling is done at fDTS */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1F_B_0x0 = 0;
        /** @brief fSAMPLING=fCK_INT, N=2 */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1F_B_0x1 = 1;
        /** @brief fSAMPLING=fCK_INT, N=4 */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1F_B_0x2 = 2;
        /** @brief fSAMPLING=fCK_INT, N=8 */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1F_B_0x3 = 3;
        /** @brief fSAMPLING=fDTS/2, N=6 */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1F_B_0x4 = 4;
        /** @brief fSAMPLING=fDTS/2, N=8 */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1F_B_0x5 = 5;
        /** @brief fSAMPLING=fDTS/4, N=6 */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1F_B_0x6 = 6;
        /** @brief fSAMPLING=fDTS/4, N=8 */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1F_B_0x7 = 7;
        /** @brief fSAMPLING=fDTS/8, N=6 */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1F_B_0x8 = 8;
        /** @brief fSAMPLING=fDTS/8, N=8 */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1F_B_0x9 = 9;
        /** @brief fSAMPLING=fDTS/16, N=5 */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1F_B_0xA = 10;
        /** @brief fSAMPLING=fDTS/16, N=6 */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1F_B_0xB = 11;
        /** @brief fSAMPLING=fDTS/16, N=8 */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1F_B_0xC = 12;
        /** @brief fSAMPLING=fDTS/32, N=5 */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1F_B_0xD = 13;
        /** @brief fSAMPLING=fDTS/32, N=6 */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1F_B_0xE = 14;
        /** @brief fSAMPLING=fDTS/32, N=8 */
    constexpr std::uint32_t TIM3_CCMR1_input_IC1F_B_0xF = 15;
    ...
    using TIM3_CCMR1_input_CC2S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM3_CCMR1_input_CC2S_B_0x0 = 0;
        /** @brief CC2 channel is configured as input, IC2 is mapped on TI2. */
    constexpr std::uint32_t TIM3_CCMR1_input_CC2S_B_0x1 = 1;
        /** @brief CC2 channel is configured as input, IC2 is mapped on TI1. */
    constexpr std::uint32_t TIM3_CCMR1_input_CC2S_B_0x2 = 2;
    ...
    constexpr std::uint32_t TIM3_CCMR1_input_CC2S_B_0x3 = 3;

    /** @brief Input capture 2 prescaler */
    using TIM3_CCMR1_input_IC2PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Input capture 2 filter */
    using TIM3_CCMR1_input_IC2F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM3 capture/compare mode register 1 [alternate] */
    using TIM3_CCMR1_output = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x18, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIMx_CCER). */
    using TIM3_CCMR1_output_CC1S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC1 channel is configured as output. (value: 0)
     *          - B_0x1: CC1 channel is configured as input, IC1 is mapped on TI1. (value: 1)
     *          - B_0x2: CC1 channel is configured as input, IC1 is mapped on TI2. (value: 2)
     ...
     */
        /** @brief CC1 channel is configured as output. */
    constexpr std::uint32_t TIM3_CCMR1_output_CC1S_B_0x0 = 0;
        /** @brief CC1 channel is configured as input, IC1 is mapped on TI1. */
    constexpr std::uint32_t TIM3_CCMR1_output_CC1S_B_0x1 = 1;
        /** @brief CC1 channel is configured as input, IC1 is mapped on TI2. */
    constexpr std::uint32_t TIM3_CCMR1_output_CC1S_B_0x2 = 2;
        /** @brief CC1 channel is configured as input, IC1 is mapped on TRC. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register) */
    constexpr std::uint32_t TIM3_CCMR1_output_CC1S_B_0x3 = 3;
    ...
    using TIM3_CCMR1_output_OC1FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM3_CCMR1_output_OC1FE_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM3_CCMR1_output_OC1FE_B_0x1 = 1;
    ...
    using TIM3_CCMR1_output_OC1PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM3_CCMR1_output_OC1PE_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM3_CCMR1_output_OC1PE_B_0x1 = 1;
    ...
    using TIM3_CCMR1_output_OC1M1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM3_CCMR1_output_OC1M1_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM3_CCMR1_output_OC1M1_B_0x1 = 1;
    ...
    constexpr std::uint32_t TIM3_CCMR1_output_OC1M1_B_0x2 = 2;
        /** @brief Toggle - OC1REF toggles when TIMx_CNT=TIMx_CCR1. */
    constexpr std::uint32_t TIM3_CCMR1_output_OC1M1_B_0x3 = 3;
        /** @brief Force inactive level - OC1REF is forced low. */
    constexpr std::uint32_t TIM3_CCMR1_output_OC1M1_B_0x4 = 4;
        /** @brief Force active level - OC1REF is forced high. */
    constexpr std::uint32_t TIM3_CCMR1_output_OC1M1_B_0x5 = 5;
    ...
    constexpr std::uint32_t TIM3_CCMR1_output_OC1M1_B_0x6 = 6;
    ...
    constexpr std::uint32_t TIM3_CCMR1_output_OC1M1_B_0x7 = 7;

    /** @brief Output compare 1 clear enable */
    using TIM3_CCMR1_output_OC1CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM3_CCMR1_output_OC1CE_B_0x0 = 0;
        /** @brief OC1Ref is cleared as soon as a High level is detected on ETRF input */
    constexpr std::uint32_t TIM3_CCMR1_output_OC1CE_B_0x1 = 1;

    /** @brief Capture/Compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = 0 in TIMx_CCER). */
    using TIM3_CCMR1_output_CC2S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC2 channel is configured as output (value: 0)
     *          - B_0x1: CC2 channel is configured as input, IC2 is mapped on TI2 (value: 1)
     *          - B_0x2: CC2 channel is configured as input, IC2 is mapped on TI1 (value: 2)
     ...
     */
        /** @brief CC2 channel is configured as output */
    constexpr std::uint32_t TIM3_CCMR1_output_CC2S_B_0x0 = 0;
        /** @brief CC2 channel is configured as input, IC2 is mapped on TI2 */
    constexpr std::uint32_t TIM3_CCMR1_output_CC2S_B_0x1 = 1;
        /** @brief CC2 channel is configured as input, IC2 is mapped on TI1 */
    constexpr std::uint32_t TIM3_CCMR1_output_CC2S_B_0x2 = 2;
    ...
    constexpr std::uint32_t TIM3_CCMR1_output_CC2S_B_0x3 = 3;

    /** @brief Output compare 2 fast enable */
    using TIM3_CCMR1_output_OC2FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 2 preload enable */
    using TIM3_CCMR1_output_OC2PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 2 mode refer to OC1M description on bits 6:4 */
    using TIM3_CCMR1_output_OC2M1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 2 clear enable */
    using TIM3_CCMR1_output_OC2CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 1 mode These bits define the behavior of the output reference signal OC1REF from which OC1 and OC1N are derived. OC1REF is active high whereas OC1 and OC1N active level depends on CC1P and CC1NP bits. Note: In PWM mode, the OCREF level changes only when the result of the comparison changes or when the output compare mode switches from frozen mode to PWM mode. Note: The OC1M[3] bit is not contiguous, located in bit 16. */
    using TIM3_CCMR1_output_OC1M2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Frozen - The comparison between the output compare register TIMx_CCR1 and the counter TIMx_CNT has no effect on the outputs.(this mode is used to generate a timing base). (value: 0)
     *          - B_0x1: Set channel 1 to active level on match. OC1REF signal is forced high when the counter TIMx_CNT matches the capture/compare register 1 (TIMx_CCR1). (value: 1)
     */
        /** @brief Frozen - The comparison between the output compare register TIMx_CCR1 and the counter TIMx_CNT has no effect on the outputs.(this mode is used to generate a timing base). */
    constexpr std::uint32_t TIM3_CCMR1_output_OC1M2_B_0x0 = 0;
        /** @brief Set channel 1 to active level on match. OC1REF signal is forced high when the counter TIMx_CNT matches the capture/compare register 1 (TIMx_CCR1). */
    constexpr std::uint32_t TIM3_CCMR1_output_OC1M2_B_0x1 = 1;

    /** @brief Output compare 2 mode refer to OC1M description on bits 6:4 */
    using TIM3_CCMR1_output_OC2M2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM3 capture/compare mode register 2 [alternate] */
    using TIM3_CCMR2_input = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM3_CCMR2_input_CC3S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM3_CCMR2_input_CC3S_B_0x0 = 0;
        /** @brief CC3 channel is configured as input, IC3 is mapped on TI3 */
    constexpr std::uint32_t TIM3_CCMR2_input_CC3S_B_0x1 = 1;
        /** @brief CC3 channel is configured as input, IC3 is mapped on TI4 */
    constexpr std::uint32_t TIM3_CCMR2_input_CC3S_B_0x2 = 2;
    ...
    constexpr std::uint32_t TIM3_CCMR2_input_CC3S_B_0x3 = 3;

    /** @brief Input capture 3 prescaler */
    using TIM3_CCMR2_input_IC3PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Input capture 3 filter */
    using TIM3_CCMR2_input_IC3F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM3_CCMR2_input_CC4S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM3_CCMR2_input_CC4S_B_0x0 = 0;
        /** @brief CC4 channel is configured as input, IC4 is mapped on TI4 */
    constexpr std::uint32_t TIM3_CCMR2_input_CC4S_B_0x1 = 1;
        /** @brief CC4 channel is configured as input, IC4 is mapped on TI3 */
    constexpr std::uint32_t TIM3_CCMR2_input_CC4S_B_0x2 = 2;
    ...
    constexpr std::uint32_t TIM3_CCMR2_input_CC4S_B_0x3 = 3;

    /** @brief Input capture 4 prescaler */
    using TIM3_CCMR2_input_IC4PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Input capture 4 filter */
    using TIM3_CCMR2_input_IC4F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM3 capture/compare mode register 2 [alternate] */
    using TIM3_CCMR2_output = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = 0 in TIMx_CCER). */
    using TIM3_CCMR2_output_CC3S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC3 channel is configured as output (value: 0)
     *          - B_0x1: CC3 channel is configured as input, IC3 is mapped on TI3 (value: 1)
     *          - B_0x2: CC3 channel is configured as input, IC3 is mapped on TI4 (value: 2)
     ...
     */
        /** @brief CC3 channel is configured as output */
    constexpr std::uint32_t TIM3_CCMR2_output_CC3S_B_0x0 = 0;
        /** @brief CC3 channel is configured as input, IC3 is mapped on TI3 */
    constexpr std::uint32_t TIM3_CCMR2_output_CC3S_B_0x1 = 1;
        /** @brief CC3 channel is configured as input, IC3 is mapped on TI4 */
    constexpr std::uint32_t TIM3_CCMR2_output_CC3S_B_0x2 = 2;
        /** @brief CC3 channel is configured as input, IC3 is mapped on TRC. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register) */
    constexpr std::uint32_t TIM3_CCMR2_output_CC3S_B_0x3 = 3;

    /** @brief Output compare 3 fast enable */
    using TIM3_CCMR2_output_OC3FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 3 preload enable */
    using TIM3_CCMR2_output_OC3PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 3 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register) */
    using TIM3_CCMR2_output_OC3M1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 3 clear enable */
    using TIM3_CCMR2_output_OC3CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = 0 in TIMx_CCER). */
    using TIM3_CCMR2_output_CC4S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC4 channel is configured as output (value: 0)
     *          - B_0x1: CC4 channel is configured as input, IC4 is mapped on TI4 (value: 1)
     *          - B_0x2: CC4 channel is configured as input, IC4 is mapped on TI3 (value: 2)
     ...
     */
        /** @brief CC4 channel is configured as output */
    constexpr std::uint32_t TIM3_CCMR2_output_CC4S_B_0x0 = 0;
        /** @brief CC4 channel is configured as input, IC4 is mapped on TI4 */
    constexpr std::uint32_t TIM3_CCMR2_output_CC4S_B_0x1 = 1;
        /** @brief CC4 channel is configured as input, IC4 is mapped on TI3 */
    constexpr std::uint32_t TIM3_CCMR2_output_CC4S_B_0x2 = 2;
        /** @brief CC4 channel is configured as input, IC4 is mapped on TRC. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register) */
    constexpr std::uint32_t TIM3_CCMR2_output_CC4S_B_0x3 = 3;

    /** @brief Output compare 4 fast enable */
    using TIM3_CCMR2_output_OC4FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 4 preload enable */
    using TIM3_CCMR2_output_OC4PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 4 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register) */
    using TIM3_CCMR2_output_OC4M1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 4 clear enable */
    using TIM3_CCMR2_output_OC4CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 3 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register) */
    using TIM3_CCMR2_output_OC3M2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 4 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register) */
    using TIM3_CCMR2_output_OC4M2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief TIM3 counter [alternate] */
    using TIM3_CNT_alternate = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x24, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief counter value */
    using TIM3_CNT_alternate_CNT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief UIF Copy This bit is a read-only copy of the UIF bit of the TIMx_ISR register */
    using TIM3_CNT_alternate_UIFCPY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM3_ARR_ARR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM3_CCR1_CCR1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM3_CCR2_CCR2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM3_CCR3_CCR3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM3_CCR4_CCR4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief ETR source selection These bits select the ETR input source. Others: Reserved */
    ...
    /** @brief TI1[0] to TI1[15] input selection These bits select the TI1[0] to TI1[15] input source. Others: Reserved */
    ...
    /** @brief TI2[0] to TI2[15] input selection These bits select the TI2[0] to TI2[15] input source. Others: Reserved */
    ...
    /** @brief TI3[0] to TI3[15] input selection These bits select the TI3[0] to TI3[15] input source. Others: Reserved */
