...
#ifndef EMBEDDED_PP_STM32C031_RTC_HPP
#define EMBEDDED_PP_STM32C031_RTC_HPP
...
namespace STM32C031::RTC {
     ...
     *          - B_0x1: SS[14:1] are dont care in alarm A comparison. Only SS[0] is compared. (value: 1)
     */
    ...
    constexpr std::uint32_t RTC_ALRMASSR_MASKSS_B_0x0 = 0;
        /** @brief SS[14:1] are dont care in alarm A comparison. Only SS[0] is compared. */
