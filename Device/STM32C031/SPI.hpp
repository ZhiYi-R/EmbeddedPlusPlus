...
#ifndef EMBEDDED_PP_STM32C031_SPI_HPP
#define EMBEDDED_PP_STM32C031_SPI_HPP
...
namespace STM32C031::SPI {
    ...
    /** @brief FIFO reception level These bits are set and cleared by hardware. Note: These bits are not used in IS mode and in SPI receive-only mode while CRC calculation is enabled. */
