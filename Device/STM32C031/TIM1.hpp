...
#ifndef EMBEDDED_PP_STM32C031_TIM1_HPP
#define EMBEDDED_PP_STM32C031_TIM1_HPP
...
namespace STM32C031::TIM1 {
    ...
    /** @brief Clock division This bit-field indicates the division ratio between the timer clock (CK_INT) frequency and the dead-time and sampling clock (tDTS)used by the dead-time generators and the digital filters (ETR, TIx): Note: tDTS = 1/fDTS, tCK_INT = 1/fCK_INT. */
    ...
    using TIM1_SMCR_SMS1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @details Possible values:
     *          - B_0x0: OCREF_CLR_INT is not connected (reserved configuration) (value: 0)
     *          - B_0x1: OCREF_CLR_INT is connected to ETRF (value: 1)
     */
        /** @brief OCREF_CLR_INT is not connected (reserved configuration) */
    ...
    /** @brief Trigger selection This bit-field selects the trigger input to be used to synchronize the counter. Others: Reserved See for more details on ITRx meaning for each Timer. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition. */
    using TIM1_SMCR_TS1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM1_SMCR_TS1_B_0x0 = 0;
        /** @brief Internal Trigger 1 (ITR1) */
    constexpr std::uint32_t TIM1_SMCR_TS1_B_0x1 = 1;
        /** @brief Internal Trigger 2 (ITR2) */
    constexpr std::uint32_t TIM1_SMCR_TS1_B_0x2 = 2;
        /** @brief Internal Trigger 3 (ITR3) */
    constexpr std::uint32_t TIM1_SMCR_TS1_B_0x3 = 3;
        /** @brief TI1 Edge Detector (TI1F_ED) */
    constexpr std::uint32_t TIM1_SMCR_TS1_B_0x4 = 4;
        /** @brief Filtered Timer Input 1 (TI1FP1) */
    constexpr std::uint32_t TIM1_SMCR_TS1_B_0x5 = 5;
        /** @brief Filtered Timer Input 2 (TI2FP2) */
    constexpr std::uint32_t TIM1_SMCR_TS1_B_0x6 = 6;
        /** @brief External Trigger input (ETRF) */
    constexpr std::uint32_t TIM1_SMCR_TS1_B_0x7 = 7;
    ...
    /** @brief External trigger prescaler External trigger signal ETRP frequency must be at most 1/4 of fCK_INT frequency. A prescaler can be enabled to reduce ETRP frequency. It is useful when inputting fast external clocks. */
    ...
    /** @brief Slave mode selection When external signals are selected the active edge of the trigger signal (TRGI) is linked to the polarity selected on the external input (see Input Control register and Control Register description. Note: The gated mode must not be used if TI1F_ED is selected as the trigger input (TS=00100). Indeed, TI1F_ED outputs 1 pulse for each transition on TI1F, whereas the gated mode checks the level of the trigger signal. Note: The clock of the slave peripherals (timer, ADC, ...) receiving the TRGO or the TRGO2 signals must be enabled prior to receive events from the master timer, and the clock frequency (prescaler) must not be changed on-the-fly while triggers are received from the master timer. */
    using TIM1_SMCR_SMS2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM1_SMCR_SMS2_B_0x0 = 0;
        /** @brief Encoder mode 1 - Counter counts up/down on TI1FP1 edge depending on TI2FP2 level. */
    constexpr std::uint32_t TIM1_SMCR_SMS2_B_0x1 = 1;

    /** @brief Trigger selection This bit-field selects the trigger input to be used to synchronize the counter. Others: Reserved See for more details on ITRx meaning for each Timer. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition. */
    using TIM1_SMCR_TS2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Internal Trigger 0 (ITR0) (value: 0)
     *          - B_0x1: Internal Trigger 1 (ITR1) (value: 1)
     *          - B_0x2: Internal Trigger 2 (ITR2) (value: 2)
     ...
     */
        /** @brief Internal Trigger 0 (ITR0) */
    constexpr std::uint32_t TIM1_SMCR_TS2_B_0x0 = 0;
        /** @brief Internal Trigger 1 (ITR1) */
    constexpr std::uint32_t TIM1_SMCR_TS2_B_0x1 = 1;
        /** @brief Internal Trigger 2 (ITR2) */
    constexpr std::uint32_t TIM1_SMCR_TS2_B_0x2 = 2;
        /** @brief Internal Trigger 3 (ITR3) */
    constexpr std::uint32_t TIM1_SMCR_TS2_B_0x3 = 3;
    ...
    using TIM1_CCMR1_output_OC1M1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM1_CCMR1_output_OC1M1_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM1_CCMR1_output_OC1M1_B_0x1 = 1;
    ...
    constexpr std::uint32_t TIM1_CCMR1_output_OC1M1_B_0x2 = 2;
        /** @brief Toggle - OC1REF toggles when TIMx_CNT=TIMx_CCR1. */
    constexpr std::uint32_t TIM1_CCMR1_output_OC1M1_B_0x3 = 3;
        /** @brief Force inactive level - OC1REF is forced low. */
    constexpr std::uint32_t TIM1_CCMR1_output_OC1M1_B_0x4 = 4;
        /** @brief Force active level - OC1REF is forced high. */
    constexpr std::uint32_t TIM1_CCMR1_output_OC1M1_B_0x5 = 5;
    ...
    constexpr std::uint32_t TIM1_CCMR1_output_OC1M1_B_0x6 = 6;
    ...
    constexpr std::uint32_t TIM1_CCMR1_output_OC1M1_B_0x7 = 7;
    ...
    /** @brief Output Compare 2 mode Refer to OC1M[3:0] description. */
    using TIM1_CCMR1_output_OC2M1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Output Compare 1 mode These bits define the behavior of the output reference signal OC1REF from which OC1 and OC1N are derived. OC1REF is active high whereas OC1 and OC1N active level depends on CC1P and CC1NP bits. Note: These bits can not be modified as long as LOCK level 3 has been programmed (LOCK bits in TIMx_BDTR register) and CC1S=00 (the channel is configured in output). Note: In PWM mode, the OCREF level changes only when the result of the comparison changes or when the output compare mode switches from frozen mode to PWM mode. Note: On channels having a complementary output, this bit field is preloaded. If the CCPC bit is set in the TIMx_CR2 register then the OC1M active bits take the new value from the preloaded bits only when a COM event is generated. Note: The OC1M[3] bit is not contiguous, located in bit 16. */
    using TIM1_CCMR1_output_OC1M2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Frozen - The comparison between the output compare register TIMx_CCR1 and the counter TIMx_CNT has no effect on the outputs.(this mode is used to generate a timing base). (value: 0)
     *          - B_0x1: Set channel 1 to active level on match. OC1REF signal is forced high when the counter TIMx_CNT matches the capture/compare register 1 (TIMx_CCR1). (value: 1)
     */
        /** @brief Frozen - The comparison between the output compare register TIMx_CCR1 and the counter TIMx_CNT has no effect on the outputs.(this mode is used to generate a timing base). */
    constexpr std::uint32_t TIM1_CCMR1_output_OC1M2_B_0x0 = 0;
        /** @brief Set channel 1 to active level on match. OC1REF signal is forced high when the counter TIMx_CNT matches the capture/compare register 1 (TIMx_CCR1). */
    constexpr std::uint32_t TIM1_CCMR1_output_OC1M2_B_0x1 = 1;

    /** @brief Output Compare 2 mode Refer to OC1M[3:0] description. */
    using TIM1_CCMR1_output_OC2M2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Output compare 3 mode Refer to OC1M[3:0] description. */
    using TIM1_CCMR2_output_OC3M1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Output compare 4 mode Refer to OC3M[3:0] description. */
    using TIM1_CCMR2_output_OC4M1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Output compare 3 mode Refer to OC1M[3:0] description. */
    using TIM1_CCMR2_output_OC3M2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 4 mode Refer to OC3M[3:0] description. */
    using TIM1_CCMR2_output_OC4M2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Output compare 5 mode Refer to OC1M description. */
    using TIM1_CCMR3_OC5M1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Output compare 6 mode Refer to OC1M description. */
    using TIM1_CCMR3_OC6M1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Output compare 5 mode Refer to OC1M description. */
    using TIM1_CCMR3_OC5M2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 6 mode Refer to OC1M description. */
    using TIM1_CCMR3_OC6M2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
