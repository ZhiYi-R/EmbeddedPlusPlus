...
#ifndef EMBEDDED_PP_STM32C031_TIM14_HPP
#define EMBEDDED_PP_STM32C031_TIM14_HPP
...
namespace STM32C031::TIM14 {
    ...
    /** @brief Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null. */
