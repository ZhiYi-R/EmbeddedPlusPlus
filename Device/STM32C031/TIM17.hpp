...
#ifndef EMBEDDED_PP_STM32C031_TIM17_HPP
#define EMBEDDED_PP_STM32C031_TIM17_HPP
...
namespace STM32C031::TIM17 {
    ...
    /** @brief Main output enable This bit is cleared asynchronously by hardware as soon as the break input is active. It is set by software or automatically depending on the AOE bit. It is acting only on the channels which are configured in output. enable register (TIM16_CCER)(TIMx_CCER)(x = 16 to 17) on page 1793). */
