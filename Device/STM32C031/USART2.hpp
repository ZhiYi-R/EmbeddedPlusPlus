...
#ifndef EMBEDDED_PP_STM32C031_USART2_HPP
#define EMBEDDED_PP_STM32C031_USART2_HPP
...
namespace STM32C031::USART2 {
    ...
    /** @brief Clock enable This bit enables the user to enable the CK pin. This bit can only be written when the USART is disabled (UE = 0). Note: If neither synchronous mode nor Smartcard mode is supported, this bit is reserved and must be kept at reset value. Refer to . In Smartcard mode, in order to provide correctly the CK clock to the smartcard, the steps below must be respected: UE = 0 SCEN = 1 GTPR configuration CLKEN= 1 UE = 1 */
    ...
    constexpr std::uint32_t USART_CR3_SCARCNT_B_0x1 = 1;
        /** @brief number of automatic retransmission attempts (before signaling error) */
    constexpr std::uint32_t USART_CR3_SCARCNT_B_0x2 = 2;
        /** @brief number of automatic retransmission attempts (before signaling error) */
    constexpr std::uint32_t USART_CR3_SCARCNT_B_0x3 = 3;
        /** @brief number of automatic retransmission attempts (before signaling error) */
    constexpr std::uint32_t USART_CR3_SCARCNT_B_0x4 = 4;
        /** @brief number of automatic retransmission attempts (before signaling error) */
    constexpr std::uint32_t USART_CR3_SCARCNT_B_0x5 = 5;
        /** @brief number of automatic retransmission attempts (before signaling error) */
    constexpr std::uint32_t USART_CR3_SCARCNT_B_0x6 = 6;
        /** @brief number of automatic retransmission attempts (before signaling error) */
    constexpr std::uint32_t USART_CR3_SCARCNT_B_0x7 = 7;
    ...
    /** @brief Wakeup from low-power mode interrupt enable This bit is set and cleared by software. Note: WUFIE must be set before entering in low-power mode. If the USART does not support the wakeup from Stop feature, this bit is reserved and must be kept at reset value. Refer to page 1985. */
    ...
    /** @brief Auto baud rate request Writing 1 to this bit resets the ABRF and ABRE flags in the USART_ISR and requests an automatic baud rate measurement on the next received data frame. Note: If the USART does not support the auto baud rate feature, this bit is reserved and must be kept at reset value. Refer to . */
    ...
    constexpr std::uint32_t USART_ISR_enabled_TC_B_0x0 = 0;
        /** @brief Transmission is complete */
    constexpr std::uint32_t USART_ISR_enabled_TC_B_0x1 = 1;
     ...
     */
        /** @brief No overrun error */
    constexpr std::uint32_t USART_ISR_disabled_ORE_B_0x0 = 0;
        /** @brief Overrun error is detected */
     ...
     */
        /** @brief Transmission is not complete */
    constexpr std::uint32_t USART_ISR_disabled_TC_B_0x0 = 0;
        /** @brief Transmission is complete */
    constexpr std::uint32_t USART_ISR_disabled_TC_B_0x1 = 1;
    ...
    /** @brief Receiver timeout clear flag Writing 1 to this bit clears the RTOF flag in the USART_ISR register. Note: If the USART does not support the Receiver timeout feature, this bit is reserved and must be kept at reset value. Refer to page 1985. */
    ...
    /** @brief Wakeup from low-power mode clear flag Writing 1 to this bit clears the WUF flag in the USART_ISR register. Note: If the USART does not support the wakeup from Stop feature, this bit is reserved and must be kept at reset value. Refer to page 1985. */
