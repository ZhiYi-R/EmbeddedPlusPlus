...
#ifndef EMBEDDED_PP_STM32C051_ADC_HPP
#define EMBEDDED_PP_STM32C051_ADC_HPP
...
namespace STM32C051::ADC {
    ...
    /** @brief ADC ready interrupt enable This bit is set and cleared by software to enable/disable the ADC Ready interrupt. Note: The software is allowed to write this bit only when ADSTART bit is cleared (this ensures that no conversion is ongoing). */
    ...
    /** @brief End of sampling flag interrupt enable This bit is set and cleared by software to enable/disable the end of the sampling phase interrupt. Note: The software is allowed to write this bit only when ADSTART bit is cleared (this ensures that no conversion is ongoing). */
    ...
    /** @brief End of conversion interrupt enable This bit is set and cleared by software to enable/disable the end of conversion interrupt. Note: The software is allowed to write this bit only when ADSTART bit is cleared (this ensures that no conversion is ongoing). */
    ...
    /** @brief End of conversion sequence interrupt enable This bit is set and cleared by software to enable/disable the end of sequence of conversions interrupt. Note: The software is allowed to write this bit only when ADSTART bit is cleared (this ensures that no conversion is ongoing). */
    ...
    /** @brief Overrun interrupt enable This bit is set and cleared by software to enable/disable the overrun interrupt. Note: The software is allowed to write this bit only when ADSTART bit is cleared (this ensures that no conversion is ongoing). */
    ...
    /** @brief Analog watchdog 1 interrupt enable This bit is set and cleared by software to enable/disable the analog watchdog interrupt. Note: The Software is allowed to write this bit only when ADSTART bit is cleared (this ensures that no conversion is ongoing). */
    ...
    /** @brief Analog watchdog 2 interrupt enable This bit is set and cleared by software to enable/disable the analog watchdog interrupt. Note: The Software is allowed to write this bit only when ADSTART bit is cleared (this ensures that no conversion is ongoing). */
    ...
    /** @brief Analog watchdog 3 interrupt enable This bit is set and cleared by software to enable/disable the analog watchdog interrupt. Note: The Software is allowed to write this bit only when ADSTART bit is cleared (this ensures that no conversion is ongoing). */
    ...
    /** @brief End of calibration interrupt enable This bit is set and cleared by software to enable/disable the end of calibration interrupt. Note: The software is allowed to write this bit only when ADSTART bit is cleared (this ensures that no conversion is ongoing). */
    ...
    /** @brief Channel Configuration Ready Interrupt enable This bit is set and cleared by software to enable/disable the channel configuration ready interrupt. Note: The software is allowed to write this bit only when ADSTART bit is cleared (this ensures that no conversion is ongoing). */
    ...
    /** @brief Direct memory access enable This bit is set and cleared by software to enable the generation of DMA requests. This allows the DMA controller to be used to manage automatically the converted data. For more details, refer to Section 16.6.5: Managing converted data using the DMA on page 325. */
    ...
    /** @brief Direct memory access configuration This bit is set and cleared by software to select between two DMA modes of operation and is effective only when DMAEN = 1. For more details, refer to Section 16.6.5: Managing converted data using the DMA on page 325. */
    ...
    /** @details Possible values:
     *          - B_0x0: Upward scan (from CHSEL0 to CHSEL22) (value: 0)
     *          - B_0x1: Backward scan (from CHSEL22 to CHSEL0) (value: 1)
     */
        /** @brief Upward scan (from CHSEL0 to CHSEL22) */
    constexpr std::uint32_t ADC_CFGR1_SCANDIR_B_0x0 = 0;
        /** @brief Backward scan (from CHSEL22 to CHSEL0) */
    constexpr std::uint32_t ADC_CFGR1_SCANDIR_B_0x1 = 1;

    /** @brief Data resolution These bits are written by software to select the resolution of the conversion. */
    ...
    /** @brief Data alignment This bit is set and cleared by software to select right or left alignment. Refer to Figure 43: Data alignment and resolution (oversampling disabled: OVSE = 0) on page 323 */
    ...
    /** @brief External trigger selection These bits select the external event used to trigger the start of conversion (refer to Table 67: External triggers for details): */
    ...
    /** @brief External trigger enable and polarity selection These bits are set and cleared by software to select the external trigger polarity and enable the trigger. */
    ...
    /** @brief Overrun management mode This bit is set and cleared by software and configure the way data overruns are managed. */
    ...
    /** @brief Single / continuous conversion mode This bit is set and cleared by software. If it is set, conversion takes place continuously until it is cleared. Note: It is not possible to have both discontinuous mode and continuous mode enabled: it is forbidden to set both bits DISCEN = 1 and CONT = 1. */
    ...
    /** @brief Wait conversion mode This bit is set and cleared by software to enable/disable wait conversion mode.<sup>.</sup> */
    ...
    /** @brief Auto-off mode This bit is set and cleared by software to enable/disable auto-off mode.<sup>.</sup> */
    ...
    /** @brief Discontinuous mode This bit is set and cleared by software to enable/disable discontinuous mode. Note: It is not possible to have both discontinuous mode and continuous mode enabled: it is forbidden to set both bits DISCEN = 1 and CONT = 1. */
    ...
    /** @brief Mode selection of the ADC_CHSELR register This bit is set and cleared by software to control the ADC_CHSELR feature: Note: If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    ...
    /** @brief Enable the watchdog on a single channel or on all channels This bit is set and cleared by software to enable the analog watchdog on the channel identified by the AWDCH[4:0] bits or on all the channels */
    ...
    /** @brief Analog watchdog enable This bit is set and cleared by software. */
    ...
    /** @brief Analog watchdog channel selection These bits are set and cleared by software. They select the input channel to be guarded by the analog watchdog. ..... Others: Reserved Note: The channel selected by the AWDCH[4:0] bits must be also set into the CHSELR register. */
     ...
     *          - B_0x16: ADC analog input Channel 22 monitored by AWD (value: 22)
     */
    ...
    constexpr std::uint32_t ADC_CFGR1_AWD1CH_B_0x1 = 1;
        /** @brief ADC analog input Channel 22 monitored by AWD */
    constexpr std::uint32_t ADC_CFGR1_AWD1CH_B_0x16 = 22;
    ...
    /** @brief Oversampler Enable This bit is set and cleared by software. Note: The software is allowed to write this bit only when ADEN bit is cleared. */
    ...
    /** @brief Oversampling ratio This bit filed defines the number of oversampling ratio. Note: The software is allowed to write this bit only when ADEN bit is cleared. */
    ...
    /** @brief Oversampling shift This bit is set and cleared by software. Others: Reserved Note: The software is allowed to write this bit only when ADEN bit is cleared. */
    ...
    /** @brief Triggered Oversampling This bit is set and cleared by software. Note: The software is allowed to write this bit only when ADEN bit is cleared. */
    ...
    /** @brief Low frequency trigger mode enable This bit is set and cleared by software. Note: The software is allowed to write this bit only when ADEN bit is cleared. */
     ...
     */
        /** @brief Sampling time of CHANNELx use the setting of SMP1[2:0] register. */
    constexpr std::uint32_t ADC_SMPR_SMPSEL19_B_0x0 = 0;
        /** @brief Sampling time of CHANNELx use the setting of SMP2[2:0] register. */
    constexpr std::uint32_t ADC_SMPR_SMPSEL19_B_0x1 = 1;
     ...
     */
        /** @brief Sampling time of CHANNELx use the setting of SMP1[2:0] register. */
    constexpr std::uint32_t ADC_SMPR_SMPSEL20_B_0x0 = 0;
        /** @brief Sampling time of CHANNELx use the setting of SMP2[2:0] register. */
    constexpr std::uint32_t ADC_SMPR_SMPSEL20_B_0x1 = 1;
     ...
     */
        /** @brief Sampling time of CHANNELx use the setting of SMP1[2:0] register. */
    constexpr std::uint32_t ADC_SMPR_SMPSEL21_B_0x0 = 0;
        /** @brief Sampling time of CHANNELx use the setting of SMP2[2:0] register. */
    constexpr std::uint32_t ADC_SMPR_SMPSEL21_B_0x1 = 1;
     ...
     */
        /** @brief Sampling time of CHANNELx use the setting of SMP1[2:0] register. */
    constexpr std::uint32_t ADC_SMPR_SMPSEL22_B_0x0 = 0;
        /** @brief Sampling time of CHANNELx use the setting of SMP2[2:0] register. */
    constexpr std::uint32_t ADC_SMPR_SMPSEL22_B_0x1 = 1;
    ...
    /** @brief Analog watchdog 1 lower threshold These bits are written by software to define the lower threshold for the analog watchdog. Refer to Section 16.8: Analog window watchdogs on page 329. */
    using ADC_AWD1TR_LT1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Analog watchdog 1 higher threshold These bits are written by software to define the higher threshold for the analog watchdog. Refer to Section 16.8: Analog window watchdogs on page 329. */
    ...
    /** @brief Analog watchdog 2 lower threshold These bits are written by software to define the lower threshold for the analog watchdog. Refer to Section 16.8: Analog window watchdogs on page 329. */
    using ADC_AWD2TR_LT2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Analog watchdog 2 higher threshold These bits are written by software to define the higher threshold for the analog watchdog. Refer to Section 16.8: Analog window watchdogs on page 329. */
    ...
    /** @brief Channel-x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Refer to Figure 35: ADC connectivity for ADC inputs connected to external channels and internal sources. Note: The software is allowed to write this bit only when ADSTART = 0 (which ensures that no conversion is ongoing). Note: If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELR_CHSEL14 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL14_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL14_B_0x1 = 1;

    /** @brief Channel-x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Refer to Figure 35: ADC connectivity for ADC inputs connected to external channels and internal sources. Note: The software is allowed to write this bit only when ADSTART = 0 (which ensures that no conversion is ongoing). Note: If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELR_CHSEL15 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL15_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL15_B_0x1 = 1;

    /** @brief Channel-x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Refer to Figure 35: ADC connectivity for ADC inputs connected to external channels and internal sources. Note: The software is allowed to write this bit only when ADSTART = 0 (which ensures that no conversion is ongoing). Note: If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELR_CHSEL16 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL16_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL16_B_0x1 = 1;

    /** @brief Channel-x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Refer to Figure 35: ADC connectivity for ADC inputs connected to external channels and internal sources. Note: The software is allowed to write this bit only when ADSTART = 0 (which ensures that no conversion is ongoing). Note: If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELR_CHSEL17 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL17_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL17_B_0x1 = 1;

    /** @brief Channel-x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Refer to Figure 35: ADC connectivity for ADC inputs connected to external channels and internal sources. Note: The software is allowed to write this bit only when ADSTART = 0 (which ensures that no conversion is ongoing). Note: If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELR_CHSEL18 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL18_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL18_B_0x1 = 1;

    /** @brief Channel-x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Refer to Figure 35: ADC connectivity for ADC inputs connected to external channels and internal sources. Note: The software is allowed to write this bit only when ADSTART = 0 (which ensures that no conversion is ongoing). Note: If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELR_CHSEL19 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL19_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL19_B_0x1 = 1;

    /** @brief Channel-x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Refer to Figure 35: ADC connectivity for ADC inputs connected to external channels and internal sources. Note: The software is allowed to write this bit only when ADSTART = 0 (which ensures that no conversion is ongoing). Note: If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELR_CHSEL20 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL20_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL20_B_0x1 = 1;

    /** @brief Channel-x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Refer to Figure 35: ADC connectivity for ADC inputs connected to external channels and internal sources. Note: The software is allowed to write this bit only when ADSTART = 0 (which ensures that no conversion is ongoing). Note: If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELR_CHSEL21 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL21_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL21_B_0x1 = 1;

    /** @brief Channel-x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Refer to Figure 35: ADC connectivity for ADC inputs connected to external channels and internal sources. Note: The software is allowed to write this bit only when ADSTART = 0 (which ensures that no conversion is ongoing). Note: If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELR_CHSEL22 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL22_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL22_B_0x1 = 1;

    /** @brief ADC channel selection register */
    using ADC_CHSELR_ALTERNATE1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x28, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using ADC_CHSELR_ALTERNATE1_SQ1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief 2nd conversion of the sequence These bits are programmed by software with the channel number (0...14) assigned to the 8th conversion of the sequence. 0b1111 indicates end of the sequence. When 0b1111 (end of sequence) is programmed to the lower sequence channels, these bits are ignored. Refer to SQ8[3:0] for a definition of channel selection. Note: The software is allowed to write this bit only when ADSTART = 0 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_ALTERNATE1_SQ2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief 3rd conversion of the sequence These bits are programmed by software with the channel number (0...14) assigned to the 8th conversion of the sequence. 0b1111 indicates end of the sequence. When 0b1111 (end of sequence) is programmed to the lower sequence channels, these bits are ignored. Refer to SQ8[3:0] for a definition of channel selection. Note: The software is allowed to write this bit only when ADSTART = 0 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_ALTERNATE1_SQ3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief 4th conversion of the sequence These bits are programmed by software with the channel number (0...14) assigned to the 8th conversion of the sequence. 0b1111 indicates end of the sequence. When 0b1111 (end of sequence) is programmed to the lower sequence channels, these bits are ignored. Refer to SQ8[3:0] for a definition of channel selection. Note: The software is allowed to write this bit only when ADSTART = 0 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_ALTERNATE1_SQ4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief 5th conversion of the sequence These bits are programmed by software with the channel number (0...14) assigned to the 8th conversion of the sequence. 0b1111 indicates end of the sequence. When 0b1111 (end of sequence) is programmed to the lower sequence channels, these bits are ignored. Refer to SQ8[3:0] for a definition of channel selection. Note: The software is allowed to write this bit only when ADSTART = 0 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_ALTERNATE1_SQ5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief 6th conversion of the sequence These bits are programmed by software with the channel number (0...14) assigned to the 8th conversion of the sequence. 0b1111 indicates end of the sequence. When 0b1111 (end of sequence) is programmed to the lower sequence channels, these bits are ignored. Refer to SQ8[3:0] for a definition of channel selection. Note: The software is allowed to write this bit only when ADSTART = 0 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_ALTERNATE1_SQ6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief 7th conversion of the sequence These bits are programmed by software with the channel number (0...14) assigned to the 8th conversion of the sequence. 0b1111 indicates end of the sequence. When 0b1111 (end of sequence) is programmed to the lower sequence channels, these bits are ignored. Refer to SQ8[3:0] for a definition of channel selection. Note: The software is allowed to write this bit only when ADSTART = 0 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_ALTERNATE1_SQ7 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using ADC_CHSELR_ALTERNATE1_SQ8 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CH0 (value: 0)
     *          - B_0x1: CH1 (value: 1)
     *          - B_0xC: CH12 (value: 12)
     ...
     */
        /** @brief CH0 */
    constexpr std::uint32_t ADC_CHSELR_ALTERNATE1_SQ8_B_0x0 = 0;
        /** @brief CH1 */
    constexpr std::uint32_t ADC_CHSELR_ALTERNATE1_SQ8_B_0x1 = 1;
        /** @brief CH12 */
    constexpr std::uint32_t ADC_CHSELR_ALTERNATE1_SQ8_B_0xC = 12;
        /** @brief CH13 */
    constexpr std::uint32_t ADC_CHSELR_ALTERNATE1_SQ8_B_0xD = 13;
        /** @brief CH14 */
    constexpr std::uint32_t ADC_CHSELR_ALTERNATE1_SQ8_B_0xE = 14;
        /** @brief No channel selected (End of sequence) */
    constexpr std::uint32_t ADC_CHSELR_ALTERNATE1_SQ8_B_0xF = 15;

    /** @brief ADC watchdog threshold register */
    using ADC_AWD3TR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x2C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Analog watchdog 3lower threshold These bits are written by software to define the lower threshold for the analog watchdog. Refer to Section 16.8: Analog window watchdogs on page 329. */
    using ADC_AWD3TR_LT3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Analog watchdog 3 higher threshold These bits are written by software to define the higher threshold for the analog watchdog. Refer to Section 16.8: Analog window watchdogs on page 329. */
     ...
     */
        /** @brief ADC analog channel-x is not monitored by AWD2 */
    constexpr std::uint32_t ADC_AWD2CR_AWD2CH19_B_0x0 = 0;
        /** @brief ADC analog channel-x is monitored by AWD2 */
    constexpr std::uint32_t ADC_AWD2CR_AWD2CH19_B_0x1 = 1;
     ...
     */
        /** @brief ADC analog channel-x is not monitored by AWD2 */
    constexpr std::uint32_t ADC_AWD2CR_AWD2CH20_B_0x0 = 0;
        /** @brief ADC analog channel-x is monitored by AWD2 */
    constexpr std::uint32_t ADC_AWD2CR_AWD2CH20_B_0x1 = 1;
     ...
     */
        /** @brief ADC analog channel-x is not monitored by AWD2 */
    constexpr std::uint32_t ADC_AWD2CR_AWD2CH21_B_0x0 = 0;
        /** @brief ADC analog channel-x is monitored by AWD2 */
    constexpr std::uint32_t ADC_AWD2CR_AWD2CH21_B_0x1 = 1;
     ...
     */
        /** @brief ADC analog channel-x is not monitored by AWD2 */
    constexpr std::uint32_t ADC_AWD2CR_AWD2CH22_B_0x0 = 0;
        /** @brief ADC analog channel-x is monitored by AWD2 */
    constexpr std::uint32_t ADC_AWD2CR_AWD2CH22_B_0x1 = 1;
    ...
    /** @brief Analog watchdog channel selection These bits are set and cleared by software. They enable and select the input channels to be guarded by analog watchdog 3 (AWD3). Note: The channels selected through ADC_AWD3CR must be also configured into the ADC_CHSELR registers. The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). */
     ...
     */
        /** @brief ADC analog channel-x is not monitored by AWD3 */
    constexpr std::uint32_t ADC_AWD3CR_AWD3CH19_B_0x0 = 0;
        /** @brief ADC analog channel-x is monitored by AWD3 */
    constexpr std::uint32_t ADC_AWD3CR_AWD3CH19_B_0x1 = 1;
     ...
     */
        /** @brief ADC analog channel-x is not monitored by AWD3 */
    constexpr std::uint32_t ADC_AWD3CR_AWD3CH20_B_0x0 = 0;
        /** @brief ADC analog channel-x is monitored by AWD3 */
    constexpr std::uint32_t ADC_AWD3CR_AWD3CH20_B_0x1 = 1;
     ...
     */
        /** @brief ADC analog channel-x is not monitored by AWD3 */
    constexpr std::uint32_t ADC_AWD3CR_AWD3CH21_B_0x0 = 0;
        /** @brief ADC analog channel-x is monitored by AWD3 */
    constexpr std::uint32_t ADC_AWD3CR_AWD3CH21_B_0x1 = 1;
     ...
     */
        /** @brief ADC analog channel-x is not monitored by AWD3 */
    constexpr std::uint32_t ADC_AWD3CR_AWD3CH22_B_0x0 = 0;
        /** @brief ADC analog channel-x is monitored by AWD3 */
    constexpr std::uint32_t ADC_AWD3CR_AWD3CH22_B_0x1 = 1;
    ...
    /** @brief V<sub>REFINT</sub> enable This bit is set and cleared by software to enable/disable the V<sub>REFINT</sub>. Note: Software is allowed to write this bit only when ADSTART = 0 (which ensures that no conversion is ongoing). */
    using ADC_CCR_VREFEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V<sub>REFINT</sub> disabled (value: 0)
     *          - B_0x1: V<sub>REFINT</sub> enabled (value: 1)
     */
        /** @brief V<sub>REFINT</sub> disabled */
    constexpr std::uint32_t ADC_CCR_VREFEN_B_0x0 = 0;
        /** @brief V<sub>REFINT</sub> enabled */
