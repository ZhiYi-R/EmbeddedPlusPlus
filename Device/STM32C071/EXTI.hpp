...
#ifndef EMBEDDED_PP_STM32C071_EXTI_HPP
#define EMBEDDED_PP_STM32C071_EXTI_HPP
...
namespace STM32C071::EXTI {
    ...
    /** @brief CPU wake-up with interrupt mask on line 36 */
     ...
     *          - B_0x1: wake-up with interrupt unmasked (value: 1)
     */
        /** @brief wake-up with interrupt masked */
    constexpr std::uint32_t EXTI_IMR2_IM36_B_0x0 = 0;
        /** @brief wake-up with interrupt unmasked */
    ...
    /** @brief CPU wake-up with event generation mask on line 36 */
