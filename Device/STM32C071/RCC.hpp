...
#ifndef EMBEDDED_PP_STM32C071_RCC_HPP
#define EMBEDDED_PP_STM32C071_RCC_HPP
...
namespace STM32C071::RCC {
    ...
    /** @brief Clock division factor for system clock Set and cleared by software. SYSCLK is result of the division by: Note: This bitfield is only available on STM32C071xx. */
    using RCC_CR_SYSDIV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: 1 (no division, reset value) (value: 0)
     *          - B_0x1: 2 (value: 1)
     *          - B_0x2: 3 (value: 2)
     *          - B_0x3: 4 (value: 3)
     *          - B_0x4: 5 (value: 4)
     ...
     *          - B_0x7: 8 (value: 7)
     */
        /** @brief 1 (no division, reset value) */
    ...
    /** @brief HSIUSB48 clock enable Set and cleared by software and hardware, with hardware taking priority. Kept low by hardware as long as the device is in a low-power mode. Kept high by hardware as long as the system is clocked from HSIUSB48. Note: Only applicable on STM32C071xx, reserved on other devices. */
    using RCC_CR_HSIUSB48ON = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Disable (value: 0)
     *          - B_0x1: Enable (value: 1)
     */
        /** @brief Disable */
    constexpr std::uint32_t RCC_CR_HSIUSB48ON_B_0x0 = 0;
        /** @brief Enable */
    constexpr std::uint32_t RCC_CR_HSIUSB48ON_B_0x1 = 1;

    /** @brief HSIUSB48 clock ready flag Set by hardware when the HSIUSB48 oscillator is enabled through HSIUSB48ON and ready to use (stable). Note: Only applicable on STM32C071xx, reserved on other devices. */
    using RCC_CR_HSIUSB48RDY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Not ready (value: 0)
     *          - B_0x1: Ready (value: 1)
     */
        /** @brief Not ready */
    constexpr std::uint32_t RCC_CR_HSIUSB48RDY_B_0x0 = 0;
        /** @brief Ready */
    constexpr std::uint32_t RCC_CR_HSIUSB48RDY_B_0x1 = 1;
    ...
    /** @brief HSIUSB48 clock calibration These bits are initialized at startup with the factory-programmed HSIUSB48 calibration trim value. */
    using RCC_CRRCR_HSIUSB48CAL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 9, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief HSIUSB48 ready interrupt enable Set and cleared by software to enable/disable interrupt caused by the HSIUSB48 oscillator stabilization: Note: Only applicable on STM32C071xx, reserved on other devices. */
    using RCC_CIER_HSIUSB48RDYIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Disable (value: 0)
     *          - B_0x1: Enable (value: 1)
     */
        /** @brief Disable */
    constexpr std::uint32_t RCC_CIER_HSIUSB48RDYIE_B_0x0 = 0;
        /** @brief Enable */
    constexpr std::uint32_t RCC_CIER_HSIUSB48RDYIE_B_0x1 = 1;
    ...
    /** @brief HSIUSB48 ready interrupt clear This bit is set software to clear the HSIUSB48RDYF flag. Note: Only applicable on STM32C071xx, reserved on other devices. */
    using RCC_CICR_HSIUSB48RDYC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No effect (value: 0)
     *          - B_0x1: Clear HSIUSB48RDYF flag (value: 1)
     */
        /** @brief No effect */
    constexpr std::uint32_t RCC_CICR_HSIUSB48RDYC_B_0x0 = 0;
        /** @brief Clear HSIUSB48RDYF flag */
    constexpr std::uint32_t RCC_CICR_HSIUSB48RDYC_B_0x1 = 1;

    /** @brief HSI48 ready interrupt clear This bit is set software to clear the HSIRDYF flag. */
    ...
    /** @brief TIM2 timer reset Set and cleared by software. Note: Only applicable on STM32C071xx, reserved on other devices. */
    ...
    /** @brief USB reset Set and cleared by software. Note: Only applicable on STM32C071xx, reserved on other devices. */
    ...
    /** @brief SPI2 reset Set and cleared by software. Note: Only applicable on STM32C071xx, reserved on other devices. */
    ...
    /** @brief CRS reset Set and cleared by software. Note: Only applicable on STM32C071xx, reserved on other devices. */
    ...
    /** @brief I2C2 reset Set and cleared by software. Note: Only applicable on STM32C071xx, reserved on other devices. */
    ...
    /** @brief USB clock enable Set and cleared by software. */
    ...
    using RCC_APBENR1_CRSEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Disable (value: 0)
     *          - B_0x1: Enable (value: 1)
     */
        /** @brief Disable */
    constexpr std::uint32_t RCC_APBENR1_CRSEN_B_0x0 = 0;
        /** @brief Enable */
    constexpr std::uint32_t RCC_APBENR1_CRSEN_B_0x1 = 1;
    ...
    /** @brief TIM2 timer clock enable during Sleep mode Set and cleared by software. Note: Only applicable on STM32C071xx, reserved on other devices. */
    ...
    /** @brief USB clock enable during Sleep and Stop modes Set and cleared by software. Note: Only applicable on STM32C071xx, reserved on other devices. */
    ...
    /** @brief SPI2 clock enable during Sleep and Stop modes Set and cleared by software. Note: Only applicable on STM32C071xx, reserved on other devices. */
    ...
    /** @brief CRS clock enable during Sleep and Stop modes Set and cleared by software. Note: Only applicable on STM32C071xx, reserved on other devices. */
    using RCC_APBSMENR1_CRSSMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Disable (value: 0)
     *          - B_0x1: Enable (value: 1)
     */
        /** @brief Disable */
    constexpr std::uint32_t RCC_APBSMENR1_CRSSMEN_B_0x0 = 0;
        /** @brief Enable */
    constexpr std::uint32_t RCC_APBSMENR1_CRSSMEN_B_0x1 = 1;
    ...
    /** @brief I2C2 clock enable during Sleep and Stop modes Set and cleared by software. Note: Only applicable on STM32C071xx, reserved on other devices. */
    ...
    using RCC_CCIPR1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x54, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using RCC_CCIPR1_I2C1SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: PCLK (value: 0)
     *          - B_0x1: SYSCLK (value: 1)
     *          - B_0x2: HSIKER (value: 2)
    ...
    using RCC_CCIPR1_I2S1SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     ...
     */
        /** @brief SYSCLK */
    constexpr std::uint32_t RCC_CCIPR1_I2S1SEL_B_0x0 = 0;
        /** @brief HSIKER */
    constexpr std::uint32_t RCC_CCIPR1_I2S1SEL_B_0x2 = 2;
        /** @brief I2S_CKIN */
    constexpr std::uint32_t RCC_CCIPR1_I2S1SEL_B_0x3 = 3;

    /** @brief ADCs clock source selection This bitfield is controlled by software to select the asynchronous clock source for ADC: */
    using RCC_CCIPR1_ADCSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    using RCC_CCIPR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x58, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USB clock source selection Set and cleared by software. */
    using RCC_CCIPR2_USBSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: HSIUSB48 (value: 0)
     *          - B_0x1: HSE (value: 1)
     */
        /** @brief HSIUSB48 */
    constexpr std::uint32_t RCC_CCIPR2_USBSEL_B_0x0 = 0;
        /** @brief HSE */
    constexpr std::uint32_t RCC_CCIPR2_USBSEL_B_0x1 = 1;
    ...
    using RCC_CSR1_LSEDRV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: medium-high driving capability (value: 0)
     *          - B_0x1: high driving capability (value: 1)
     */
