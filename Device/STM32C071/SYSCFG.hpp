...
#ifndef EMBEDDED_PP_STM32C071_SYSCFG_HPP
#define EMBEDDED_PP_STM32C071_SYSCFG_HPP
...
namespace STM32C071::SYSCFG {
    ...
    /** @brief Memory mapping selection bits This bitfield controlled by software selects the memory internally mapped at the address 0x0000 0000. Its reset value is determined by the boot mode configuration. Refer to Section 3: Boot configuration for more details. x0: Main Flash memory */
    ...
    /** @brief Fast Mode Plus (FM+) enable for PB6 This bit is set and cleared by software. It enables I<sup>2</sup>C FM+ driving capability on PB6 I/O port. */
    ...
    /** @details Possible values:
     *          - B_0x0: Disable disabled if not enabled through I2Cx_FMP (value: 0)
     *          - B_0x1: Enable (value: 1)
     */
        /** @brief Disable disabled if not enabled through I2Cx_FMP */
    constexpr std::uint32_t SYSCFG_CFGR1_I2C_PB6_FMP_B_0x0 = 0;
        /** @brief Enable */
    constexpr std::uint32_t SYSCFG_CFGR1_I2C_PB6_FMP_B_0x1 = 1;

    /** @brief Fast Mode Plus (FM+) enable for PB7 This bit is set and cleared by software. It enables I<sup>2</sup>C FM+ driving capability on PB7 I/O port. */
    ...
    /** @brief Fast Mode Plus (FM+) enable for PB8 This bit is set and cleared by software. It enables I<sup>2</sup>C FM+ driving capability on PB8 I/O port. Note: Not available on STM32C011xx. */
    ...
    /** @brief Fast Mode Plus (FM+) enable for PB9 This bit is set and cleared by software. It enables I<sup>2</sup>C FM+ driving capability on PB9 I/O port. Note: Not available on STM32C011xx. */
    ...
    /** @brief Fast Mode Plus (FM+) enable for I2C1 This bit is set and cleared by software. It enables I<sup>2</sup>C FM+ driving capability on I/O ports configured as I2C1 through GPIOx_AFR registers. */
    using SYSCFG_CFGR1_I2C1_FMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Disable disabled if not enabled through I2C_y_FMP (value: 0)
     *          - B_0x1: Enable (value: 1)
     */
        /** @brief Disable disabled if not enabled through I2C_y_FMP */
    constexpr std::uint32_t SYSCFG_CFGR1_I2C1_FMP_B_0x0 = 0;
        /** @brief Enable */
    constexpr std::uint32_t SYSCFG_CFGR1_I2C1_FMP_B_0x1 = 1;

    /** @brief Fast Mode Plus (FM+) enable for I2C2 This bit is set and cleared by software. It enables I<sup>2</sup>C FM+ driving capability on I/O ports configured as I2C2 through GPIOx_AFR registers. Note: Only applicable to STM32C071xx. Reserved on the other products. */
    using SYSCFG_CFGR1_I2C2_FMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Disable disabled if not enabled through I2C_y_FMP (value: 0)
     *          - B_0x1: Enable (value: 1)
     */
        /** @brief Disable disabled if not enabled through I2C_y_FMP */
    constexpr std::uint32_t SYSCFG_CFGR1_I2C2_FMP_B_0x0 = 0;
        /** @brief Enable */
    constexpr std::uint32_t SYSCFG_CFGR1_I2C2_FMP_B_0x1 = 1;

    /** @brief Fast Mode Plus (FM+) enable for PA9 This bit is set and cleared by software. It enables I<sup>2</sup>C FM+ driving capability on PA9 I/O port. */
    ...
    /** @brief Fast Mode Plus (FM+) enable for PA10 This bit is set and cleared by software. It enables I<sup>2</sup>C FM+ driving capability on PA10 I/O port. */
    ...
    /** @brief Fast Mode Plus (FM+) enable for PC14 This bit is set and cleared by software. It enables I<sup>2</sup>C FM+ driving capability on PC14 I/O port. Note: Not available on STM32C011xx. */
    ...
    /** @details Possible values:
     *          - B_0x0: Disable if not enabled through I2Cx_FMP (value: 0)
     *          - B_0x1: Enable (value: 1)
     */
        /** @brief Disable if not enabled through I2Cx_FMP */
    ...
    /** @brief Pin GPIO multiplexer 0 This bit is set by software and cleared by system reset. It assigns a GPIO to a pin. 1x: Reserved 1x: Reserved */
    ...
    /** @brief Pin GPIO multiplexer 2 This bit is set by software and cleared by system reset. It assigns a GPIO to a pin. 1x: Reserved Note: The PA11_RMP bit of the SYSCFG_CFGR1 takes priority over the selection through this bitfield. Refer to the description of the SYSCFG_CFGR1 register for more details. */
    ...
    /** @brief Pin GPIO multiplexer 4 This bit is set by software and cleared by system reset. It assigns a GPIO to a pin. 1x: Reserved Note: The PA12_RMP bit of the SYSCFG_CFGR1 takes priority over the selection through this bitfield. Refer to the description of the SYSCFG_CFGR1 register for more details. */
    ...
    /** @brief Pin GPIO multiplexer 5 This bit is set by software and cleared by system reset. It assigns a GPIO to a pin. */
    ...
    using SYSCFG_ITLINE1_PVM_VDDIO2_OUT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief CRS interrupt request pending Note: Only applicable on STM32C071xx, reserved on other products. */
    ...
    /** @brief DMA channel 5 interrupt request pending Note: Only applicable on STM32C071xx, reserved on the other products. */
    using SYSCFG_ITLINE11_DMA_CH4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DMA channel 5 interrupt request pending Note: Only applicable on STM32C071xx, reserved on the other products. */
    using SYSCFG_ITLINE11_DMA_CH5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
