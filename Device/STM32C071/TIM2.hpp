...
#ifndef EMBEDDED_PP_STM32C071_TIM2_HPP
#define EMBEDDED_PP_STM32C071_TIM2_HPP
...
namespace STM32C071::TIM2 {
     ...
     *          - B_0x1: The TIMx_CH1, CH2 and CH3 pins are connected to the TI1 input (XOR combination) See also Section17. (value: 1)
     */
        /** @brief The TIMx_CH1 pin is connected to TI1 input */
    constexpr std::uint16_t TIM2_CR2_TI1S_B_0x0 = 0;
        /** @brief The TIMx_CH1, CH2 and CH3 pins are connected to the TI1 input (XOR combination) See also Section17. */
    ...
    /** @details Possible values:
     *          - B_0x0: OCREF_CLR_INT is unconnected. (value: 0)
     *          - B_0x1: OCREF_CLR_INT is connected to ETRF (value: 1)
     */
        /** @brief OCREF_CLR_INT is unconnected. */
    ...
    /** @brief TIM2_CCMR1_ALTERNATE1 register */
    ...
    /** @brief TIM2_CCMR2_ALTERNATE1 register */
    ...
    /** @brief TIM2_CNT_ALTERNATE1 register */
