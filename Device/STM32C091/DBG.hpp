...
#ifndef EMBEDDED_PP_STM32C091_DBG_HPP
#define EMBEDDED_PP_STM32C091_DBG_HPP
...
namespace STM32C091::DBG {
    ...
    /** @brief Device identifier This field indicates the device ID. Refer to Table 152. */
    using DBG_IDCODE_DEV_ID = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Revision identifier This field indicates the revision of the device. Refer to Table 152. */
    ...
    /** @brief Clocking of TIM2 counter when the core is halted This bit enables/disables the clock to the counter of TIM2 when the core is halted: This bit is only available on STM32C071xx. On the other devices, it is reserved. */
