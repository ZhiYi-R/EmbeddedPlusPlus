...
#ifndef EMBEDDED_PP_STM32C091_TIM14_HPP
#define EMBEDDED_PP_STM32C091_TIM14_HPP
...
namespace STM32C091::TIM14 {
    ...
    using TIM14_CCMR1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x18, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM14_CCMR1_CC1S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM14_CCMR1_CC1S_B_0x0 = 0;
        /** @brief CC1 channel is configured as input, IC1 is mapped on TI1 */
    constexpr std::uint32_t TIM14_CCMR1_CC1S_B_0x1 = 1;
    ...
    using TIM14_CCMR1_IC1PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM14_CCMR1_IC1PSC_B_0x0 = 0;
        /** @brief capture is done once every 2 events */
    constexpr std::uint32_t TIM14_CCMR1_IC1PSC_B_0x1 = 1;
        /** @brief capture is done once every 4 events */
    constexpr std::uint32_t TIM14_CCMR1_IC1PSC_B_0x2 = 2;
        /** @brief capture is done once every 8 events */
    constexpr std::uint32_t TIM14_CCMR1_IC1PSC_B_0x3 = 3;
    ...
    using TIM14_CCMR1_IC1F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM14_CCMR1_IC1F_B_0x0 = 0;
        /** @brief f<sub>SAMPLING</sub>=f<sub>CK_INT</sub>, N=2 */
    constexpr std::uint32_t TIM14_CCMR1_IC1F_B_0x1 = 1;
        /** @brief f<sub>SAMPLING</sub>=f<sub>CK_INT</sub>, N=4 */
    constexpr std::uint32_t TIM14_CCMR1_IC1F_B_0x2 = 2;
        /** @brief f<sub>SAMPLING</sub>=f<sub>CK_INT</sub>, N=8 */
    constexpr std::uint32_t TIM14_CCMR1_IC1F_B_0x3 = 3;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/2, N=6 */
    constexpr std::uint32_t TIM14_CCMR1_IC1F_B_0x4 = 4;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/2, N=8 */
    constexpr std::uint32_t TIM14_CCMR1_IC1F_B_0x5 = 5;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/4, N=6 */
    constexpr std::uint32_t TIM14_CCMR1_IC1F_B_0x6 = 6;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/4, N=8 */
    constexpr std::uint32_t TIM14_CCMR1_IC1F_B_0x7 = 7;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/8, N=6 */
    constexpr std::uint32_t TIM14_CCMR1_IC1F_B_0x8 = 8;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/8, N=8 */
    constexpr std::uint32_t TIM14_CCMR1_IC1F_B_0x9 = 9;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/16, N=5 */
    constexpr std::uint32_t TIM14_CCMR1_IC1F_B_0xA = 10;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/16, N=6 */
    constexpr std::uint32_t TIM14_CCMR1_IC1F_B_0xB = 11;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/16, N=8 */
    constexpr std::uint32_t TIM14_CCMR1_IC1F_B_0xC = 12;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/32, N=5 */
    constexpr std::uint32_t TIM14_CCMR1_IC1F_B_0xD = 13;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/32, N=6 */
    constexpr std::uint32_t TIM14_CCMR1_IC1F_B_0xE = 14;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/32, N=8 */
    constexpr std::uint32_t TIM14_CCMR1_IC1F_B_0xF = 15;

    /** @brief TIM14 capture/compare mode register 1 */
    using TIM14_CCMR1_ALTERNATE1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x18, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIMx_CCER). */
    using TIM14_CCMR1_ALTERNATE1_CC1S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC1 channel is configured as output. (value: 0)
     *          - B_0x1: CC1 channel is configured as input, IC1 is mapped on TI1. (value: 1)
     ...
     */
        /** @brief CC1 channel is configured as output. */
    constexpr std::uint32_t TIM14_CCMR1_ALTERNATE1_CC1S_B_0x0 = 0;
        /** @brief CC1 channel is configured as input, IC1 is mapped on TI1. */
    constexpr std::uint32_t TIM14_CCMR1_ALTERNATE1_CC1S_B_0x1 = 1;
        /** @brief Reserved. */
    constexpr std::uint32_t TIM14_CCMR1_ALTERNATE1_CC1S_B_0x2 = 2;
        /** @brief Reserved. */
    constexpr std::uint32_t TIM14_CCMR1_ALTERNATE1_CC1S_B_0x3 = 3;
    ...
    using TIM14_CCMR1_ALTERNATE1_OC1FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM14_CCMR1_ALTERNATE1_OC1FE_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM14_CCMR1_ALTERNATE1_OC1FE_B_0x1 = 1;

    /** @brief Output compare 1 preload enable */
    using TIM14_CCMR1_ALTERNATE1_OC1PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM14_CCMR1_ALTERNATE1_OC1PE_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM14_CCMR1_ALTERNATE1_OC1PE_B_0x1 = 1;

    /** @brief OC1M[2:0]: Output compare 1 mode (refer to bit 16 for OC1M[3]) These bits define the behavior of the output reference signal OC1REF from which OC1 is derived. OC1REF is active high whereas OC1 active level depends on CC1P bit. Others: Reserved Note: In PWM mode 1 or 2, the OCREF level changes when the result of the comparison changes or when the output compare mode switches from frozen to PWM mode. Note: The OC1M[3] bit is not contiguous, located in bit 16. */
    using TIM14_CCMR1_ALTERNATE1_OC1M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM14_CCMR1_ALTERNATE1_OC1M_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM14_CCMR1_ALTERNATE1_OC1M_B_0x1 = 1;
    ...
    constexpr std::uint32_t TIM14_CCMR1_ALTERNATE1_OC1M_B_0x2 = 2;
        /** @brief Toggle - OC1REF toggles when TIMx_CNT = TIMx_CCR1. */
    constexpr std::uint32_t TIM14_CCMR1_ALTERNATE1_OC1M_B_0x3 = 3;
        /** @brief Force inactive level - OC1REF is forced low. */
    constexpr std::uint32_t TIM14_CCMR1_ALTERNATE1_OC1M_B_0x4 = 4;
        /** @brief Force active level - OC1REF is forced high. */
    constexpr std::uint32_t TIM14_CCMR1_ALTERNATE1_OC1M_B_0x5 = 5;
        /** @brief PWM mode 1 - Channel 1 is active as long as TIMx_CNT < TIMx_CCR1 else inactive. */
    constexpr std::uint32_t TIM14_CCMR1_ALTERNATE1_OC1M_B_0x6 = 6;
        /** @brief PWM mode 2 - Channel 1 is inactive as long as TIMx_CNT < TIMx_CCR1 else active */
    constexpr std::uint32_t TIM14_CCMR1_ALTERNATE1_OC1M_B_0x7 = 7;

    /** @brief OC1M[3] */
    using TIM14_CCMR1_ALTERNATE1_OC1M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM14_ARR = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x2C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to Section 19.3.1: Time-base unit on page 517 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null. */
    using TIM14_ARR_ARR = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM14 capture/compare register 1 */
    using TIM14_CCR1 = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x34, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM14_CCR1_CCR1 = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM14 timer input selection register */
    using TIM14_TISEL = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x68, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    constexpr std::uint16_t TIM14_TISEL_TI1SEL_B_0x1 = 1;
        /** @brief HSE/32 */
    constexpr std::uint16_t TIM14_TISEL_TI1SEL_B_0x2 = 2;
        /** @brief MCO */
    constexpr std::uint16_t TIM14_TISEL_TI1SEL_B_0x3 = 3;
        /** @brief MCO2 */
    constexpr std::uint16_t TIM14_TISEL_TI1SEL_B_0x4 = 4;
