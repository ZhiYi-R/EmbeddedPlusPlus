...
#ifndef EMBEDDED_PP_STM32C091_TIM2_HPP
#define EMBEDDED_PP_STM32C091_TIM2_HPP
...
namespace STM32C091::TIM2 {
    ...
    /** @details Possible values:
     *          - B_0x0: tless thansub>DTSless than/sub> = tless thansub>CK_INTless than/sub> (value: 0)
     *          - B_0x1: tless thansub>DTSless than/sub> = 2 X tless thansub>CK_INTless than/sub> (value: 1)
     *          - B_0x2: tless thansub>DTSless than/sub> = 4 X tless thansub>CK_INTless than/sub> (value: 2)
     */
        /** @brief tless thansub>DTSless than/sub> = tless thansub>CK_INTless than/sub> */
    constexpr std::uint16_t TIM2_CR1_CKD_B_0x0 = 0;
        /** @brief tless thansub>DTSless than/sub> = 2 X tless thansub>CK_INTless than/sub> */
    constexpr std::uint16_t TIM2_CR1_CKD_B_0x1 = 1;
        /** @brief tless thansub>DTSless than/sub> = 4 X tless thansub>CK_INTless than/sub> */
