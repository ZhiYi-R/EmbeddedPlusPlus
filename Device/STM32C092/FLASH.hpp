...
#ifndef EMBEDDED_PP_STM32C092_FLASH_HPP
#define EMBEDDED_PP_STM32C092_FLASH_HPP
...
namespace STM32C092::FLASH {
    ...
    using FLASH_PCROP1ASR_PCROP1A_STRT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 9, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using FLASH_PCROP1AER_PCROP1A_END = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 9, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using FLASH_PCROP1BSR_PCROP1B_STRT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 9, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using FLASH_PCROP1BER_PCROP1B_END = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 9, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
