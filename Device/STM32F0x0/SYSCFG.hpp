...
#ifndef EMBEDDED_PP_STM32F0X0_SYSCFG_HPP
#define EMBEDDED_PP_STM32F0X0_SYSCFG_HPP
...
namespace STM32F0x0::SYSCFG {
    ...
    using CFGR1_ADC_DMA_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USART1_TX DMA remapping bit */
    using CFGR1_USART1_TX_DMA_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USART1_RX DMA request remapping bit */
    using CFGR1_USART1_RX_DMA_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM16 DMA request remapping bit */
    using CFGR1_TIM16_DMA_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM17 DMA request remapping bit */
    using CFGR1_TIM17_DMA_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Fast Mode Plus (FM plus) driving capability activation bits. */
    using CFGR1_I2C_PB6_FM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Fast Mode Plus (FM+) driving capability activation bits. */
    using CFGR1_I2C_PB7_FM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Fast Mode Plus (FM+) driving capability activation bits. */
    using CFGR1_I2C_PB8_FM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Fast Mode Plus (FM+) driving capability activation bits. */
    using CFGR1_I2C_PB9_FM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FM+ driving capability activation for I2C1 */
    using CFGR1_I2C1_FM_plus = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FM+ driving capability activation for I2C2 */
    using CFGR1_I2C2_FM_plus = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SPI2 DMA request remapping bit */
    using CFGR1_SPI2_DMA_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USART2 DMA request remapping bit */
    using CFGR1_USART2_DMA_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USART3 DMA request remapping bit */
    using CFGR1_USART3_DMA_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief I2C1 DMA request remapping bit */
    using CFGR1_I2C1_DMA_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM1 DMA request remapping bit */
    using CFGR1_TIM1_DMA_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM2 DMA request remapping bit */
    using CFGR1_TIM2_DMA_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM3 DMA request remapping bit */
    using CFGR1_TIM3_DMA_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CFGR2_PVD_LOCK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CFGR2_LOCUP_LOCK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
