...
#ifndef EMBEDDED_PP_STM32F0X1_DBGMCU_HPP
#define EMBEDDED_PP_STM32F0X1_DBGMCU_HPP
...
namespace STM32F0x1::DBGMCU {
    ...
    using APB1_FZ_TIM3_counter_stopped_when_core_is_halted = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
