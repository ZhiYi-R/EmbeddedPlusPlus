...
#ifndef EMBEDDED_PP_STM32F0X1_TIM2_HPP
#define EMBEDDED_PP_STM32F0X1_TIM2_HPP
...
namespace STM32F0x1::TIM2 {
    ...
    using DMAR_DMAR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
