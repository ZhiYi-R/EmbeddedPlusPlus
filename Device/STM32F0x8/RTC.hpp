...
#ifndef EMBEDDED_PP_STM32F0X8_RTC_HPP
#define EMBEDDED_PP_STM32F0X8_RTC_HPP
...
namespace STM32F0x8::RTC {
    ...
    /** @brief RTC_ALARM output type/PC13 value */
    ...
    using TAFCR_TAMP_PUDIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RTC_TAMPx precharge duration */
    using TAFCR_TAMP_PRCH = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Active level for RTC_TAMP3 input */
    ...
    using TAFCR_TAMP2_TRG = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
