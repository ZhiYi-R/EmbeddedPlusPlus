...
#ifndef EMBEDDED_PP_STM32F0X8_USART7_HPP
#define EMBEDDED_PP_STM32F0X8_USART7_HPP
...
namespace STM32F0x8::USART7 {
    ...
    using CR2_ADD4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Address of the USART node */
    using CR2_ADD0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Wakeup from Stop mode flag */
    ...
    /** @brief End of timeout clear flag */
