...
#ifndef EMBEDDED_PP_STM32F100_TIM1_HPP
#define EMBEDDED_PP_STM32F100_TIM1_HPP
...
namespace STM32F100::TIM1 {
    ...
    using CCMR1_Input_IC2F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CCMR2_Input_IC4F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
