...
#ifndef EMBEDDED_PP_STM32F101_WWDG_HPP
#define EMBEDDED_PP_STM32F101_WWDG_HPP
...
namespace STM32F101::WWDG {
    ...
    /** @brief Early Wakeup Interrupt */
    using SR_EWI = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
