...
#ifndef EMBEDDED_PP_STM32F102_USART2_HPP
#define EMBEDDED_PP_STM32F102_USART2_HPP
...
namespace STM32F102::USART2 {
    ...
    using SR_NE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Framing error */
