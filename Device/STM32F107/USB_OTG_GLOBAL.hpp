...
#ifndef EMBEDDED_PP_STM32F107_USB_OTG_GLOBAL_HPP
#define EMBEDDED_PP_STM32F107_USB_OTG_GLOBAL_HPP
...
namespace STM32F107::USB_OTG_GLOBAL {
    ...
    using FS_GUSBCFG_PHYSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SRP-capable */
