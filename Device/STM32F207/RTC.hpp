...
#ifndef EMBEDDED_PP_STM32F207_RTC_HPP
#define EMBEDDED_PP_STM32F207_RTC_HPP
...
namespace STM32F207::RTC {
    ...
    using PRER_PREDIV_S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 13, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
