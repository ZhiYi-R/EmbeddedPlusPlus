...
#ifndef EMBEDDED_PP_STM32F207_TIM5_HPP
#define EMBEDDED_PP_STM32F207_TIM5_HPP
...
namespace STM32F207::TIM5 {
    ...
    using TIM5_OR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x50, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Timer Input 4 remap */
    using TIM5_OR_IT4_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
