...
#ifndef EMBEDDED_PP_STM32F215_CRYP_HPP
#define EMBEDDED_PP_STM32F215_CRYP_HPP
...
namespace STM32F215::CRYP {
    ...
    using CR_ALGOMODE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
