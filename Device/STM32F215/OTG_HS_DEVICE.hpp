...
#ifndef EMBEDDED_PP_STM32F215_OTG_HS_DEVICE_HPP
#define EMBEDDED_PP_STM32F215_OTG_HS_DEVICE_HPP
...
namespace STM32F215::OTG_HS_DEVICE {
    ...
    using OTG_HS_DIEPEACHMSK1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x40, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Transfer completed interrupt mask */
    ...
    using OTG_HS_DOEPEACHMSK1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x80, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Transfer completed interrupt mask */
