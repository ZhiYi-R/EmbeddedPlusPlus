...
#ifndef EMBEDDED_PP_STM32F217_ADC1_HPP
#define EMBEDDED_PP_STM32F217_ADC1_HPP
...
namespace STM32F217::ADC1 {
    ...
    using SMPR1_SMP18 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
