...
#ifndef EMBEDDED_PP_STM32F217_GPIOI_HPP
#define EMBEDDED_PP_STM32F217_GPIOI_HPP
...
namespace STM32F217::GPIOI {
    ...
    /** @brief Port x configuration bits (y = 0. */
    ...
    /** @brief Alternate function selection for port x bit y (y = 0. */
    ...
    /** @brief Alternate function selection for port x bit y (y = 8. */
