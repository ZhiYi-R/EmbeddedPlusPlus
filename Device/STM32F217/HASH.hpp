...
#ifndef EMBEDDED_PP_STM32F217_HASH_HPP
#define EMBEDDED_PP_STM32F217_HASH_HPP
...
namespace STM32F217::HASH {
    ...
    using CR_ALGO = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
