...
#ifndef EMBEDDED_PP_STM32F301_RCC_HPP
#define EMBEDDED_PP_STM32F301_RCC_HPP
...
namespace STM32F301::RCC {
    ...
    /** @brief Do not divide PLL to MCO */
    ...
    /** @brief ADC 1 */
    using AHBENR_ADC1EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief ADC1 reset */
    using AHBRSTR_ADC1RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CFGR2_ADC1PRES = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Timer15 clock source selection */
    using CFGR3_TIM15SW = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Timer16 clock source selection */
    using CFGR3_TIM16SW = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Timer17 clock source selection */
    using CFGR3_TIM17SW = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
