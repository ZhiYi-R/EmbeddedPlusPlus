...
#ifndef EMBEDDED_PP_STM32F302_TIM8_HPP
#define EMBEDDED_PP_STM32F302_TIM8_HPP
...
namespace STM32F302::TIM8 {
    ...
    /** @brief TIM8_ETR_ADC2 remapping capability */
    using OR_TIM8_ETR_ADC2_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM8_ETR_ADC3 remapping capability */
    using OR_TIM8_ETR_ADC3_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
