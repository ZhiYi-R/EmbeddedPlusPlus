...
#ifndef EMBEDDED_PP_STM32F303_I2C3_HPP
#define EMBEDDED_PP_STM32F303_I2C3_HPP
...
namespace STM32F303::I2C3 {
    ...
    using CR1_SWRST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Slave address bit 9:8 (master mode) */
    using CR2_SADD8 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Slave address bit 7:1 (master mode) */
    using CR2_SADD1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Slave address bit 0 (master mode) */
    ...
    using OAR1_OA1_0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Interface address */
    using OAR1_OA1_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Interface address */
    using OAR1_OA1_8 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
