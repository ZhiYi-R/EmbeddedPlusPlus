...
#ifndef EMBEDDED_PP_STM32F373_TIM5_HPP
#define EMBEDDED_PP_STM32F373_TIM5_HPP
...
namespace STM32F373::TIM5 {
    ...
    /** @brief Timer Input 4 remap */
    using OR_IT4_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
