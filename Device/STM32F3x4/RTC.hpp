...
#ifndef EMBEDDED_PP_STM32F3X4_RTC_HPP
#define EMBEDDED_PP_STM32F3X4_RTC_HPP
...
namespace STM32F3x4::RTC {
    ...
    /** @brief RTC_TAMP3 detection flag */
    ...
    using TAFCR_TAMP1TRG = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief PC13 value */
    using TAFCR_PC13VALUE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief PC13 mode */
    using TAFCR_PC13MODE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief PC14 value */
    using TAFCR_PC14VALUE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief PC 14 mode */
    using TAFCR_PC14MODE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief PC15 value */
    using TAFCR_PC15VALUE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief PC15 mode */
    using TAFCR_PC15MODE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
