...
#ifndef EMBEDDED_PP_STM32F3X4_SYSCFG_COMP_OPAMP_HPP
#define EMBEDDED_PP_STM32F3X4_SYSCFG_COMP_OPAMP_HPP
...
namespace STM32F3x4::SYSCFG_COMP_OPAMP {
    ...
    using COMP2_CSR_COMP2INMSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Comparator 2 output selection */
    using COMP2_CSR_COMP2OUTSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Comparator 2 inverting input selection. It is used with Bits [6..4] to configure the Comp inverting input */
    using COMP2_CSR_COMP2INMSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using COMP4_CSR_COMP4INMSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Comparator 4 output selection */
    using COMP4_CSR_COMP4OUTSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Comparator 4 inverting input selection. It is used with Bits [6..4] to configure the Comp inverting input */
    using COMP4_CSR_COMP4INMSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using COMP6_CSR_COMP6INMSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Comparator 6 output selection */
    using COMP6_CSR_COMP6OUTSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Comparator 6 inverting input selection. It is used with Bits [6..4] to configure the Comp inverting input */
    using COMP6_CSR_COMP6INMSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
