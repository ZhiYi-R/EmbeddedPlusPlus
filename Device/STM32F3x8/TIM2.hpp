...
#ifndef EMBEDDED_PP_STM32F3X8_TIM2_HPP
#define EMBEDDED_PP_STM32F3X8_TIM2_HPP
...
namespace STM32F3x8::TIM2 {
    ...
    using CNT_CNTH = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief prescaler */
    ...
    /** @brief Internal trigger 1 remap */
    using OR_ITR1_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
