...
#ifndef EMBEDDED_PP_STM32F405_DBG_HPP
#define EMBEDDED_PP_STM32F405_DBG_HPP
...
namespace STM32F405::DBG {
    ...
    using DBGMCU_CR_DBG_I2C2_SMBUS_TIMEOUT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DBG_TIM8_STOP */
    using DBGMCU_CR_DBG_TIM8_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DBG_TIM5_STOP */
    using DBGMCU_CR_DBG_TIM5_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DBG_TIM6_STOP */
    using DBGMCU_CR_DBG_TIM6_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DBG_TIM7_STOP */
    using DBGMCU_CR_DBG_TIM7_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
