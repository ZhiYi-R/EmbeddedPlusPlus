...
#ifndef EMBEDDED_PP_STM32F410_FLASH_HPP
#define EMBEDDED_PP_STM32F410_FLASH_HPP
...
namespace STM32F410::FLASH {
    ...
    using OPTCR_nWRP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SPRMOD */
