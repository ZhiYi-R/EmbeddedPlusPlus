...
#ifndef EMBEDDED_PP_STM32F410_LPTIM1_HPP
#define EMBEDDED_PP_STM32F410_LPTIM1_HPP
...
namespace STM32F410::LPTIM1 {
    ...
    /** @brief OR */
    using OPTR_OR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
