...
#ifndef EMBEDDED_PP_STM32F410_PWR_HPP
#define EMBEDDED_PP_STM32F410_PWR_HPP
...
namespace STM32F410::PWR {
    ...
    using CSR_EWUP3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
