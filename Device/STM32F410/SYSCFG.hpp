...
#ifndef EMBEDDED_PP_STM32F410_SYSCFG_HPP
#define EMBEDDED_PP_STM32F410_SYSCFG_HPP
...
namespace STM32F410::SYSCFG {
    ...
    using CFGR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x2C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FMPI2C1_SCL */
    using CFGR_FMPI2C1_SCL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FMPI2C1_SDA */
    using CFGR_FMPI2C1_SDA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
