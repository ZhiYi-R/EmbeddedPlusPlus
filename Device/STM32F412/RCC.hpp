...
#ifndef EMBEDDED_PP_STM32F412_RCC_HPP
#define EMBEDDED_PP_STM32F412_RCC_HPP
...
namespace STM32F412::RCC {
    ...
    /** @brief Division factor for the main PLL (PLL) input clock */
    ...
    /** @brief DFSDM1 kernel clock selection */
    using DCKCFGR_CKDFSDM1SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using DCKCFGR2_I2CFMP1SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
