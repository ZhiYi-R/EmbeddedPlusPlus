...
#ifndef EMBEDDED_PP_STM32F412_SYSCFG_HPP
#define EMBEDDED_PP_STM32F412_SYSCFG_HPP
...
namespace STM32F412::SYSCFG {
    ...
    /** @brief MEM_MODE */
    using MEMRM_MEM_MODE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief I2C_BUFOUT */
    using I2C_BUFOUT = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x2C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief I2C4SCL */
    using I2C_BUFOUT_I2C4SCL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief I2C4SDA */
    using I2C_BUFOUT_I2C4SDA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
