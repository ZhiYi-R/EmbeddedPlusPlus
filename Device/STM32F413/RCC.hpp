...
#ifndef EMBEDDED_PP_STM32F413_RCC_HPP
#define EMBEDDED_PP_STM32F413_RCC_HPP
...
namespace STM32F413::RCC {
    ...
    /** @brief Main PLL (PLL) division factor for I2S, DFSDM clocks */
    using PLLCFGR_PLLR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief LPTimer1 reset */
    using APB1RSTR_LPTIMER1RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USART4 reset */
    ...
    /** @brief CAN 3 reset */
    using APB1RSTR_CAN3RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DAC reset */
    ...
    /** @brief USART9 reset */
    using APB2RSTR_USART9RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USART10 reset */
    using APB2RSTR_SART10RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SPI4 reset */
    ...
    /** @brief DFSDM2 reset */
    using APB2RSTR_DFSDM2RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief LPTimer 1 clock enable */
    using APB1ENR_LPTIMER1EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief clock enable */
    using APB1ENR_RTCAPB = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using APB1ENR_CAN3EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief DFSDMEN */
    using APB2ENR_DFSDMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief SAI 1 clock enable */
    using APB2ENR_SAI1EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DFSDM2 clock enable */
    using APB2ENR_DFSDM2EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief SRAM2interface clock enable during Sleep mode */
    ...
    using AHB2LPENR_FSMCLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief QUADSPI memory controller module clock enable during Sleep mode */
    using AHB2LPENR_QSPILPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using APB1LPENR_LPTIMER1LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RTC APB clock enable during Sleep mode */
    using APB1LPENR_RTCAPBEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USART4 clock enable during Sleep mode */
    using APB1LPENR_USART4LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USART5 clock enable during Sleep mode */
    using APB1LPENR_USART5LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CAN3 clock enable during Sleep mode */
    using APB1LPENR_CAN3LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief DFSDMLPEN */
    using APB2LPENR_DFSDMLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USART9 clock enable during Sleep mode */
    using APB2LPENR_USART9LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief EXTIT APB and SYSCTRL PFREE clock enable during Sleep mode */
    using APB2LPENR_EXTITEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SPI5 clock enable during Sleep mode */
    ...
    /** @brief DFSDM2 clock enable during Sleep mode */
    using APB2LPENR_DFSDM2LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief External low-speed oscillator bypass */
    using BDCR_LSEMOD = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock */
    using PLLI2SCFGR_PLLI2SM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 6, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief PLLI2S entry clock source */
    using PLLI2SCFGR_PLLI2SSRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief PLLI2S division factor for USB OTG FS/SDIO/RNG clock */
    ...
    using AHB3RSTR_FSMCRST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief QUADSPI module reset */
    ...
    using AHB3ENR_FSMCEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief QUADSPI memory controller module clock enable */
    ...
    /** @brief Flexible memory controller module clock enable during Sleep mode */
    using AHB3LPENR_FSMCLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief QUADSPI memory controller module clock enable during Sleep mode */
    ...
    /** @brief DFSDM1 audio clock selection. */
    using DCKCFGR_CKDFSDM1ASEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief I2S APB1 clocks source selection (I2S2/3) */
    using DCKCFGR_I2S1SRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief I2S APB2 clocks source selection (I2S1/4/5) */
    using DCKCFGR_I2S2SRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief LPTIMER1 kernel clock selection. */
    using DCKCFGR_LPTIMER1SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RCC clocks gated enable register */
    using CKGATENR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x90, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief AHB to APB1 Bridge clock enable */
    using CKGATENR_AHB2APB1_CKEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief AHB to APB2 Bridge clock enable */
    using CKGATENR_AHB2APB2_CKEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Cortex M4 ETM clock enable */
    using CKGATENR_CM4DBG_CKEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Spare clock enable */
    using CKGATENR_SPARE_CKEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SRQAM controller clock enable */
    using CKGATENR_SRAM_CKEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Flash Interface clock enable */
    using CKGATENR_FLITF_CKEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RCC clock enable */
    using CKGATENR_RCC_CKEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief EVTCL_CKEN */
    using CKGATENR_EVTCL_CKEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Dedicated Clocks Configuration Register */
    using DCKCFGR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x94, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SDIO clock selection. */
    using DCKCFGR2_CKSDIOSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SDIO/USBFS clock selection. */
    using DCKCFGR2_CK48MSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief I2CFMP1 kernel clock source selection */
    using DCKCFGR2_I2CFMP1SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
