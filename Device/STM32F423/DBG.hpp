...
#ifndef EMBEDDED_PP_STM32F423_DBG_HPP
#define EMBEDDED_PP_STM32F423_DBG_HPP
...
namespace STM32F423::DBG {
    ...
    /** @brief RTC stopped when Core is halted */
    ...
    using DBGMCU_APB1_FZ_DBG_I2C1_SMBUS_TIMEOUT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DBG_J2C2_SMBUS_TIMEOUT */
    using DBGMCU_APB1_FZ_DBG_I2C2_SMBUS_TIMEOUT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DBG_J2C3SMBUS_TIMEOUT */
    using DBGMCU_APB1_FZ_DBG_I2C3SMBUS_TIMEOUT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
