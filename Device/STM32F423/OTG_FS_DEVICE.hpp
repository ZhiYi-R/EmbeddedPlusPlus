...
#ifndef EMBEDDED_PP_STM32F423_OTG_FS_DEVICE_HPP
#define EMBEDDED_PP_STM32F423_OTG_FS_DEVICE_HPP
...
namespace STM32F423::OTG_FS_DEVICE {
    ...
    using FS_DSTS_DEVLNSTS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
