...
#ifndef EMBEDDED_PP_STM32F423_RCC_HPP
#define EMBEDDED_PP_STM32F423_RCC_HPP
...
namespace STM32F423::RCC {
    ...
    using APB2ENR_SPI6EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
