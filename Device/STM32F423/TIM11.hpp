...
#ifndef EMBEDDED_PP_STM32F423_TIM11_HPP
#define EMBEDDED_PP_STM32F423_TIM11_HPP
...
namespace STM32F423::TIM11 {
    ...
    /** @brief Input 1 remapping capability */
    using OR_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
