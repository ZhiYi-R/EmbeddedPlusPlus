...
#ifndef EMBEDDED_PP_STM32F439_FMC_HPP
#define EMBEDDED_PP_STM32F439_FMC_HPP
...
namespace STM32F439::FMC {
    ...
    /** @brief WRAPMOD */
    using BCR1_WRAPMOD = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief WAITPOL */
    ...
    using BWTR3 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x104, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ACCMOD */
    ...
    using BWTR4 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x10C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ACCMOD */
    ...
    /** @brief SDRAM clock configuration */
    using SDCR2_CLK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
