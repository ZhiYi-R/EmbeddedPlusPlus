...
#ifndef EMBEDDED_PP_STM32F439_LTDC_HPP
#define EMBEDDED_PP_STM32F439_LTDC_HPP
...
namespace STM32F439::LTDC {
    ...
    using SSCR_HSW = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief AAW */
    using AWCR_AAW = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
