...
#ifndef EMBEDDED_PP_STM32F446_DBG_HPP
#define EMBEDDED_PP_STM32F446_DBG_HPP
...
namespace STM32F446::DBG {
    ...
    using DBGMCU_APB1_FZ_DBG_I2CFMP_SMBUS_TIMEOUT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DBG_CAN1_STOP */
