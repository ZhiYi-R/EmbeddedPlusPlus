...
#ifndef EMBEDDED_PP_STM32F446_FMPI2C_HPP
#define EMBEDDED_PP_STM32F446_FMPI2C_HPP
...
namespace STM32F446::FMPI2C {
    ...
    using CR2_SADD7_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Slave address bit 9:8 (master mode) */
    using CR2_SADD9_8 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Interface address */
    using OAR1_OA1_7_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Interface address */
    using OAR1_OA1_9_8 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Timeout or tLOW detection flag */
