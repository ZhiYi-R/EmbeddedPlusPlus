...
#ifndef EMBEDDED_PP_STM32F446_OTG_FS_DEVICE_HPP
#define EMBEDDED_PP_STM32F446_OTG_FS_DEVICE_HPP
...
namespace STM32F446::OTG_FS_DEVICE {
    ...
    using FS_DCFG_ERRATIM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
