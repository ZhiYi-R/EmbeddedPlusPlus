...
#ifndef EMBEDDED_PP_STM32F446_RCC_HPP
#define EMBEDDED_PP_STM32F446_RCC_HPP
...
namespace STM32F446::RCC {
    ...
    /** @brief SPDIF-IN reset */
    using APB1RSTR_SPDIFRST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USART 2 reset */
    ...
    /** @brief I2CFMP1 reset */
    using APB1RSTR_I2CFMP1RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CAN1 reset */
    ...
    /** @brief SPDIF-IN clock enable */
    using APB1ENR_SPDIFEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief I2CFMP1 clock enable */
    using APB1ENR_I2CFMP1EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief CEC interface clock enable */
    using APB1ENR_CEC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief SPDIF clock enable during Sleep mode */
    using APB1LPENR_SPDIFLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief I2CFMP1 clock enable during Sleep mode */
    using APB1LPENR_I2CFMP1LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief CEC clock enable during Sleep mode */
    ...
    /** @brief External low-speed oscillator mode */
    ...
    /** @brief Division factor for audio PLL (PLLI2S) input clock */
    ...
    /** @brief PLLI2S division factor for SPDIF-IN clock */
    using PLLI2SCFGR_PLLI2SP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Division factor for audio PLLSAI input clock */
    using PLLSAICFGR_PLLSAIM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 6, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief PLLI2S division factor for SAIs clock */
    using DCKCFGR_PLLI2SDIVQ = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief PLLSAI division factor for SAIs clock */
    using DCKCFGR_PLLSAIDIVQ = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SAI1 clock source selection */
    using DCKCFGR_SAI1SRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SAI2 clock source selection */
    using DCKCFGR_SAI2SRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using DCKCFGR2_FMPI2C1SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief HDMI CEC clock source selection */
    using DCKCFGR2_CECSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SDIO/USBFS/HS clock selection */
    ...
    using DCKCFGR2_SDIOSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SPDIF clock selection */
    using DCKCFGR2_SPDIFSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
