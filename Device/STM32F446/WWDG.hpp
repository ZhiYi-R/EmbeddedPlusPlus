...
#ifndef EMBEDDED_PP_STM32F446_WWDG_HPP
#define EMBEDDED_PP_STM32F446_WWDG_HPP
...
namespace STM32F446::WWDG {
    ...
    /** @brief Timer base */
    using CFR_WDGTB1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Timer base */
    using CFR_WDGTB0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
