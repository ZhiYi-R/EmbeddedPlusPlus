...
#ifndef EMBEDDED_PP_STM32F469_FLASH_HPP
#define EMBEDDED_PP_STM32F469_FLASH_HPP
...
namespace STM32F469::FLASH {
    ...
    /** @brief Proprietary readout protection (PCROP) error */
    ...
    /** @brief Dual-bank Boot option byte */
    using OPTCR_BFB2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief WDG_SW User option bytes */
    using OPTCR_WDG_SW = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using OPTCR_DB1M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Selection of protection mode for nWPRi bits */
    using OPTCR_SPRMOD = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Not write protect */
    using OPTCR1_nWRP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
