...
#ifndef EMBEDDED_PP_STM32F479_RCC_HPP
#define EMBEDDED_PP_STM32F479_RCC_HPP
...
namespace STM32F479::RCC {
    ...
    using PLLCFGR_PLLM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 6, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Main PLL (PLL) multiplication factor for VCO */
    using PLLCFGR_PLLN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 9, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Main PLL (PLL) division factor for main system clock */
    using PLLCFGR_PLLP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using PLLCFGR_PLLQ = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Main PLL division factor for DSI clock */
    ...
    /** @brief QUADSPI memory controller reset */
    ...
    /** @brief DSI clocks enable during Sleep mode */
    using APB2LPENR_DSILPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using DCKCFGR_PLLIS2DIVQ = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief PLLSAIDIVR */
    using DCKCFGR_PLLSAIDIVR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SAI1 clock source selection */
    using DCKCFGR_SAI1ASRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SAI1-B clock source selection */
    using DCKCFGR_SAI1BSRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using DCKCFGR_MSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SDIO clock source selection */
    using DCKCFGR_SDMMCSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DSI clock source selection */
    using DCKCFGR_DSISEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
