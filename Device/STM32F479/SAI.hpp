...
#ifndef EMBEDDED_PP_STM32F479_SAI_HPP
#define EMBEDDED_PP_STM32F479_SAI_HPP
...
namespace STM32F479::SAI {
    ...
    using GCR_SYNCOUT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
