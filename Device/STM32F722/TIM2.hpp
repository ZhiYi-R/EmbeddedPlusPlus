...
#ifndef EMBEDDED_PP_STM32F722_TIM2_HPP
#define EMBEDDED_PP_STM32F722_TIM2_HPP
...
namespace STM32F722::TIM2 {
    ...
    using CNT_CNT_H = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
