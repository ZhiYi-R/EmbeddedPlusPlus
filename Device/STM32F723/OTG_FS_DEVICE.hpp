...
#ifndef EMBEDDED_PP_STM32F723_OTG_FS_DEVICE_HPP
#define EMBEDDED_PP_STM32F723_OTG_FS_DEVICE_HPP
...
namespace STM32F723::OTG_FS_DEVICE {
    ...
    using OTG_FS_DIEPTSIZ4 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x190, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Multi count */
    ...
    /** @brief OTG_FS device IN endpoint transmit FIFO status register */
    using OTG_FS_DTXFSTS4 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x198, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief IN endpoint TxFIFO space available */
    ...
    using OTG_FS_DIEPTSIZ5 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1B0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Multi count */
    using OTG_FS_DIEPTSIZ5_MCNT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Packet count */
    using OTG_FS_DIEPTSIZ5_PKTCNT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 10, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Transfer size */
    using OTG_FS_DIEPTSIZ5_XFRSIZ = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 19, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OTG_FS device IN endpoint transmit FIFO status register */
    using OTG_FS_DTXFSTS5 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1B8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief IN endpoint TxFIFO space available */
    using OTG_FS_DTXFSTS5_INEPTFSAV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief device endpoint-4 control register */
    using OTG_FS_DOEPCTL4 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x380, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief EPENA */
    ...
    /** @brief device endpoint-4 interrupt register */
    using OTG_FS_DOEPINT4 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x388, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief B2BSTUP */
    ...
    using OTG_FS_DOEPTSIZ4 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x390, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Received data PID/SETUP packet count */
    ...
    using OTG_FS_DOEPCTL5 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x3A0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief EPENA */
    ...
    /** @brief device endpoint-5 interrupt register */
    using OTG_FS_DOEPINT5 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x3A8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief B2BSTUP */
    ...
    using OTG_FS_DOEPTSIZ5 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x3B0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Received data PID/SETUP packet count */
