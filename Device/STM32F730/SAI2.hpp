...
#ifndef EMBEDDED_PP_STM32F730_SAI2_HPP
#define EMBEDDED_PP_STM32F730_SAI2_HPP
...
namespace STM32F730::SAI2 {
    ...
    using BCR1_MCKDIV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief No divider */
    ...
    using BCR1_SAIXEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output drive */
    ...
    /** @brief Master clock divider */
    using ACR1_MCKDIV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief No divider */
    ...
    using ACR1_SAIXEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output drive */
