...
#ifndef EMBEDDED_PP_STM32F732_PWR_HPP
#define EMBEDDED_PP_STM32F732_PWR_HPP
...
namespace STM32F732::PWR {
    ...
    using CSR1_EIWUP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief power control register */
