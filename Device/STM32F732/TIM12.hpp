...
#ifndef EMBEDDED_PP_STM32F732_TIM12_HPP
#define EMBEDDED_PP_STM32F732_TIM12_HPP
...
namespace STM32F732::TIM12 {
    ...
    using CCMR1_Input_IC2F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CCMR1_Input_IC1F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
