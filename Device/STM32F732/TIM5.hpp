...
#ifndef EMBEDDED_PP_STM32F732_TIM5_HPP
#define EMBEDDED_PP_STM32F732_TIM5_HPP
...
namespace STM32F732::TIM5 {
    ...
    using OR_TI4_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
