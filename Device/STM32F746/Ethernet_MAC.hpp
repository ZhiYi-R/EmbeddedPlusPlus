...
#ifndef EMBEDDED_PP_STM32F746_ETHERNET_MAC_HPP
#define EMBEDDED_PP_STM32F746_ETHERNET_MAC_HPP
...
namespace STM32F746::Ethernet_MAC {
    ...
    /** @brief MSFRWCS */
    using MACDBGR_MSFRWCS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RFWRA */
    using MACDBGR_RFWRA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RFRCS */
    using MACDBGR_RFRCS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RFFL */
    using MACDBGR_RFFL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief MMTEA */
    ...
    /** @brief MACA3L */
    using MACA3LR_MACA3L = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Ethernet MAC remote wakeup frame filter register */
    using MACRWUFFER = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x60, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
