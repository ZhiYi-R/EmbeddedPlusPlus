...
#ifndef EMBEDDED_PP_STM32F750_CEC_HPP
#define EMBEDDED_PP_STM32F750_CEC_HPP
...
namespace STM32F750::CEC {
    ...
    using CFGR_SFTOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
