...
#ifndef EMBEDDED_PP_STM32F767_ETHERNET_MMC_HPP
#define EMBEDDED_PP_STM32F767_ETHERNET_MMC_HPP
...
namespace STM32F767::Ethernet_MMC {
    ...
    /** @brief TGFM */
    using MMCTIMR_TGFM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
