...
#ifndef EMBEDDED_PP_STM32F767_NVIC_HPP
#define EMBEDDED_PP_STM32F767_NVIC_HPP
...
namespace STM32F767::NVIC {
    ...
    /** @brief Interrupt Clear-Pending Register */
    using ICPR3 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x18C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CLRPEND */
    using ICPR3_CLRPEND = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Interrupt Active Bit Register */
