...
#ifndef EMBEDDED_PP_STM32F767_RCC_HPP
#define EMBEDDED_PP_STM32F767_RCC_HPP
...
namespace STM32F767::RCC {
    ...
    /** @brief SDMMC clock source selection */
    using DKCFGR2_SDMMCSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
