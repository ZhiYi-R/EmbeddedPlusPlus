...
#ifndef EMBEDDED_PP_STM32F768_DBG_HPP
#define EMBEDDED_PP_STM32F768_DBG_HPP
...
namespace STM32F768::DBG {
    ...
    /** @brief TRACE_CLKINEN */
    using DBGMCU_CR_TRACE_CLKINEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TRACE_MODE */
    ...
    using DBGMCU_APB1_FZ_DBG_LPTIM1_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DBG_RTC_STOP */
    using DBGMCU_APB1_FZ_DBG_RTC_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DBG_WWDG_STOP */
    ...
    /** @brief DBG_CAN3_STOP */
    using DBGMCU_APB1_FZ_DBG_CAN3_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief DBG_I2C4_SMBUS_TIMEOUT */
    using DBGMCU_APB1_FZ_DBG_I2C4_SMBUS_TIMEOUT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DBG_CAN1_STOP */
