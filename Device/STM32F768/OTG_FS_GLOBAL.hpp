...
#ifndef EMBEDDED_PP_STM32F768_OTG_FS_GLOBAL_HPP
#define EMBEDDED_PP_STM32F768_OTG_FS_GLOBAL_HPP
...
namespace STM32F768::OTG_FS_GLOBAL {
    ...
    using OTG_FS_GPWRDN = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x58, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ADP module enable */
    using OTG_FS_GPWRDN_ADPMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ADP interrupt flag */
    using OTG_FS_GPWRDN_ADPIF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OTG ADP timer, control and status register */
    using OTG_FS_GADPCTL = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x60, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Probe discharge */
    using OTG_FS_GADPCTL_PRBDSCHG = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Probe delta */
    using OTG_FS_GADPCTL_PRBDELTA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Probe period */
    using OTG_FS_GADPCTL_PRBPER = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Ramp time */
    using OTG_FS_GADPCTL_RTIM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 11, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Enable probe */
    using OTG_FS_GADPCTL_ENAPRB = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Enable sense */
    using OTG_FS_GADPCTL_ENASNS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ADP reset */
    using OTG_FS_GADPCTL_ADPRST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ADP enable */
    using OTG_FS_GADPCTL_ADPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ADP probe interrupt flag */
    using OTG_FS_GADPCTL_ADPPRBIF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ADP sense interrupt flag */
    using OTG_FS_GADPCTL_ADPSNSIF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ADP timeout interrupt flag */
    using OTG_FS_GADPCTL_ADPTOIF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ADP probe interrupt mask */
    using OTG_FS_GADPCTL_ADPPRBIM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ADP sense interrupt mask */
    using OTG_FS_GADPCTL_ADPSNSIM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ADP timeout interrupt mask */
    using OTG_FS_GADPCTL_ADPTOIM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Access request */
    using OTG_FS_GADPCTL_AR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
