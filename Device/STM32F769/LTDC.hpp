...
#ifndef EMBEDDED_PP_STM32F769_LTDC_HPP
#define EMBEDDED_PP_STM32F769_LTDC_HPP
...
namespace STM32F769::LTDC {
    ...
    using BPCR_AHBP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 10, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief AAV */
    using AWCR_AAV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 10, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TWCR_TOTALW = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 10, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using BCCR_BC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 24, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Color Key Red value */
    using L2CKCR_CKRED = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 9, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Color Key Green value */
    using L2CKCR_CKGREEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Color Key Blue value */
