...
#ifndef EMBEDDED_PP_STM32F777_TIM8_HPP
#define EMBEDDED_PP_STM32F777_TIM8_HPP
...
namespace STM32F777::TIM8 {
    ...
    using AF1_BKDFBKE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief BRK2 DFSDM_BREAK enable */
    using AF2_BK2DFBKE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
