...
#ifndef EMBEDDED_PP_STM32G030_TAMP_HPP
#define EMBEDDED_PP_STM32G030_TAMP_HPP
...
namespace STM32G030::TAMP {
     ...
     *          - B_0x1: Tamper 3 event does not erase the backup registers. (value: 1)
     */
        /** @brief Tamper 3 event erases the backup registers. */
    constexpr std::uint32_t TAMP_CR2_TAMP3NOER_B_0x0 = 0;
        /** @brief Tamper 3 event does not erase the backup registers. */
     ...
     *          - B_0x1: If TAMPFLT equal 00 Tamper 2 input staying high triggers a tamper detection event. (value: 1)
     */
    ...
    constexpr std::uint32_t TAMP_CR2_TAMP2TRG_B_0x0 = 0;
        /** @brief If TAMPFLT equal 00 Tamper 2 input staying high triggers a tamper detection event. */
     ...
     *          - B_0x1: If TAMPFLT equal 00 Tamper 3 input staying high triggers a tamper detection event. (value: 1)
     */
    ...
    constexpr std::uint32_t TAMP_CR2_TAMP3TRG_B_0x0 = 0;
        /** @brief If TAMPFLT equal 00 Tamper 3 input staying high triggers a tamper detection event. */
