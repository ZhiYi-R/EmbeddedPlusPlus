...
#ifndef EMBEDDED_PP_STM32G031_FLASH_HPP
#define EMBEDDED_PP_STM32G031_FLASH_HPP
...
namespace STM32G031::FLASH {
    ...
    using SECR_SEC_SIZE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
