...
#ifndef EMBEDDED_PP_STM32G041_TIM3_HPP
#define EMBEDDED_PP_STM32G041_TIM3_HPP
...
namespace STM32G041::TIM3 {
    ...
    /** @brief IOCREF_CLR */
    using OR1_IOCREF_CLR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
