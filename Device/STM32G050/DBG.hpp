...
#ifndef EMBEDDED_PP_STM32G050_DBG_HPP
#define EMBEDDED_PP_STM32G050_DBG_HPP
...
namespace STM32G050::DBG {
    ...
    /** @brief SMBUS timeout when core is halted */
    using DBG_APB_FZ1_DBG_I2C2_SMBUS_TIMEOUT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
