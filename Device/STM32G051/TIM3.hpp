...
#ifndef EMBEDDED_PP_STM32G051_TIM3_HPP
#define EMBEDDED_PP_STM32G051_TIM3_HPP
...
namespace STM32G051::TIM3 {
    ...
    constexpr std::uint32_t CR1_DIR_B_0x0 = 0;
        /** @brief Counter used as downcounter */
    constexpr std::uint32_t CR1_DIR_B_0x1 = 1;
    ...
    constexpr std::uint32_t CR1_CMS_B_0x0 = 0;
    ...
    constexpr std::uint32_t CR1_CMS_B_0x1 = 1;
    ...
    constexpr std::uint32_t CR1_CMS_B_0x2 = 2;
    ...
    constexpr std::uint32_t CR1_CMS_B_0x3 = 3;
    ...
    /** @details Possible values:
     *          - B_0x0: OCREF_CLR_INT is connected to COMP1 or COMP2 output depending on TIMx_OR1.OCREF_CLR (value: 0)
     *          - B_0x1: OCREF_CLR_INT is connected to ETRF (value: 1)
     */
        /** @brief OCREF_CLR_INT is connected to COMP1 or COMP2 output depending on TIMx_OR1.OCREF_CLR */
    constexpr std::uint32_t SMCR_OCCS_B_0x0 = 0;
        /** @brief OCREF_CLR_INT is connected to ETRF */
    constexpr std::uint32_t SMCR_OCCS_B_0x1 = 1;
    ...
    constexpr std::uint32_t SMCR_TS1_B_0x7 = 7;
    ...
    constexpr std::uint32_t SMCR_ETF_B_0x0 = 0;
        /** @brief fSAMPLING=fCK_INT, N=2 */
    constexpr std::uint32_t SMCR_ETF_B_0x1 = 1;
        /** @brief fSAMPLING=fCK_INT, N=4 */
    constexpr std::uint32_t SMCR_ETF_B_0x2 = 2;
        /** @brief fSAMPLING=fCK_INT, N=8 */
    constexpr std::uint32_t SMCR_ETF_B_0x3 = 3;
        /** @brief fSAMPLING=fDTS/2, N=6 */
    constexpr std::uint32_t SMCR_ETF_B_0x4 = 4;
        /** @brief fSAMPLING=fDTS/2, N=8 */
    constexpr std::uint32_t SMCR_ETF_B_0x5 = 5;
        /** @brief fSAMPLING=fDTS/4, N=6 */
    constexpr std::uint32_t SMCR_ETF_B_0x6 = 6;
        /** @brief fSAMPLING=fDTS/4, N=8 */
    constexpr std::uint32_t SMCR_ETF_B_0x7 = 7;
        /** @brief fSAMPLING=fDTS/8, N=6 */
    constexpr std::uint32_t SMCR_ETF_B_0x8 = 8;
        /** @brief fSAMPLING=fDTS/8, N=8 */
    constexpr std::uint32_t SMCR_ETF_B_0x9 = 9;
        /** @brief fSAMPLING=fDTS/16, N=5 */
    constexpr std::uint32_t SMCR_ETF_B_0xA = 10;
        /** @brief fSAMPLING=fDTS/16, N=6 */
    constexpr std::uint32_t SMCR_ETF_B_0xB = 11;
        /** @brief fSAMPLING=fDTS/16, N=8 */
    constexpr std::uint32_t SMCR_ETF_B_0xC = 12;
        /** @brief fSAMPLING=fDTS/32, N=5 */
    constexpr std::uint32_t SMCR_ETF_B_0xD = 13;
        /** @brief fSAMPLING=fDTS/32, N=6 */
    constexpr std::uint32_t SMCR_ETF_B_0xE = 14;
        /** @brief fSAMPLING=fDTS/32, N=8 */
    constexpr std::uint32_t SMCR_ETF_B_0xF = 15;
     ...
     */
        /** @brief Prescaler OFF */
    constexpr std::uint32_t SMCR_ETPS_B_0x0 = 0;
        /** @brief ETRP frequency divided by 2 */
    constexpr std::uint32_t SMCR_ETPS_B_0x1 = 1;
        /** @brief ETRP frequency divided by 4 */
    constexpr std::uint32_t SMCR_ETPS_B_0x2 = 2;
        /** @brief ETRP frequency divided by 8 */
    constexpr std::uint32_t SMCR_ETPS_B_0x3 = 3;
    ...
    constexpr std::uint32_t SMCR_ETP_B_0x0 = 0;
        /** @brief ETR is inverted, active at low level or falling edge */
    constexpr std::uint32_t SMCR_ETP_B_0x1 = 1;
    ...
    constexpr std::uint32_t SMCR_SMS2_B_0x0 = 0;
        /** @brief Encoder mode 1 - Counter counts up/down on TI1FP1 edge depending on TI2FP2 level. */
    constexpr std::uint32_t SMCR_SMS2_B_0x1 = 1;
    ...
    constexpr std::uint32_t DIER_CC3IE_B_0x0 = 0;
        /** @brief CC3 interrupt enabled. */
    constexpr std::uint32_t DIER_CC3IE_B_0x1 = 1;
    ...
    constexpr std::uint32_t DIER_CC4IE_B_0x0 = 0;
        /** @brief CC4 interrupt enabled. */
    constexpr std::uint32_t DIER_CC4IE_B_0x1 = 1;
    ...
    constexpr std::uint32_t DIER_CC3DE_B_0x0 = 0;
        /** @brief CC3 DMA request enabled. */
    constexpr std::uint32_t DIER_CC3DE_B_0x1 = 1;
    ...
    constexpr std::uint32_t DIER_CC4DE_B_0x0 = 0;
        /** @brief CC4 DMA request enabled. */
    constexpr std::uint32_t DIER_CC4DE_B_0x1 = 1;
     ...
     *          - B_0x6: PWM mode 1 - In upcounting, channel 1 is active as long as TIMx_CNTTIMx_CCR1 else inactive. In downcounting, channel 1 is inactive (OC1REF='0) as long as TIMx_CNT>TIMx_CCR1 else active (OC1REF=1). (value: 6)
    ...
    constexpr std::uint32_t CCMR1_Output_OC1M1_B_0x5 = 5;
        /** @brief PWM mode 1 - In upcounting, channel 1 is active as long as TIMx_CNTTIMx_CCR1 else inactive. In downcounting, channel 1 is inactive (OC1REF='0) as long as TIMx_CNT>TIMx_CCR1 else active (OC1REF=1). */
    ...
    /** @brief counter */
    using CNT_ALTERNATE5 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x24, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Most significant part counter value (TIM2) nullLeast significant part of counter value */
    using CNT_ALTERNATE5_CNT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 31, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief UIF Copy This bit is a read-only copy of the UIF bit of the TIMx_ISR register */
    using CNT_ALTERNATE5_UIFCPY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief prescaler */
    ...
    /** @brief High auto-reload value (TIM2) nullLow Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null. */
    using ARR_ARR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief capture/compare register 1 */
    using CCR1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x34, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief High Capture/Compare 1 value (TIM2) nullLow Capture/Compare 1 value If channel CC1 is configured as output: CCR1 is the value to be loaded in the actual capture/compare 1 register (preload value). It is loaded permanently if the preload feature is not selected in the TIMx_CCMR1 register (bit OC1PE). Else the preload value is copied in the active capture/compare 1 register when an update event occurs. The active capture/compare register contains the value to be compared to the counter TIMx_CNT and signaled on OC1 output. If channel CC1is configured as input: CCR1 is the counter value transferred by the last input capture 1 event (IC1). The TIMx_CCR1 register is read-only and cannot be programmed. */
    using CCR1_CCR1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    constexpr std::uint32_t OR1_OCREF_CLR_B_0x0 = 0;
        /** @brief COMP2 output is connected to the OCREF_CLR input */
    constexpr std::uint32_t OR1_OCREF_CLR_B_0x1 = 1;
    ...
    constexpr std::uint32_t AF1_ETRSEL_B_0x0 = 0;
        /** @brief COMP1 */
    constexpr std::uint32_t AF1_ETRSEL_B_0x1 = 1;
        /** @brief COMP2 */
    constexpr std::uint32_t AF1_ETRSEL_B_0x2 = 2;
        /** @brief LSE */
    constexpr std::uint32_t AF1_ETRSEL_B_0x3 = 3;
