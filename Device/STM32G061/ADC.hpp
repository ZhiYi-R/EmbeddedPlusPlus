...
#ifndef EMBEDDED_PP_STM32G061_ADC_HPP
#define EMBEDDED_PP_STM32G061_ADC_HPP
...
namespace STM32G061::ADC {
    ...
    /** @brief Analog watchdog 1 lower threshold 	These bits are written by software to define the lower threshold for the analog watchdog. 	Refer to ADC_AWDxTR) on page395. */
    using ADC_AWD1TR_LT1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Analog watchdog 1 higher threshold 	These bits are written by software to define the higher threshold for the analog watchdog. 	Refer to ADC_AWDxTR) on page395. */
    ...
    /** @brief Analog watchdog 2 lower threshold 	These bits are written by software to define the lower threshold for the analog watchdog. 	Refer to ADC_AWDxTR) on page395. */
    using ADC_AWD2TR_LT2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Analog watchdog 2 higher threshold 	These bits are written by software to define the higher threshold for the analog watchdog. 	Refer to ADC_AWDxTR) on page395. */
    ...
    using ADC_CHSELRMOD0_CHSEL0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL0_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL0_B_0x1 = 1;

    /** @brief Channel-x selection 	These bits are written by software and define which channels are part of the sequence of channels to be converted. 	Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). 	If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELRMOD0_CHSEL1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL1_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL1_B_0x1 = 1;

    /** @brief Channel-x selection 	These bits are written by software and define which channels are part of the sequence of channels to be converted. 	Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). 	If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELRMOD0_CHSEL2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL2_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL2_B_0x1 = 1;

    /** @brief Channel-x selection 	These bits are written by software and define which channels are part of the sequence of channels to be converted. 	Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). 	If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELRMOD0_CHSEL3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL3_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL3_B_0x1 = 1;

    /** @brief Channel-x selection 	These bits are written by software and define which channels are part of the sequence of channels to be converted. 	Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). 	If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELRMOD0_CHSEL4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL4_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL4_B_0x1 = 1;

    /** @brief Channel-x selection 	These bits are written by software and define which channels are part of the sequence of channels to be converted. 	Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). 	If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELRMOD0_CHSEL5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL5_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL5_B_0x1 = 1;

    /** @brief Channel-x selection 	These bits are written by software and define which channels are part of the sequence of channels to be converted. 	Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). 	If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELRMOD0_CHSEL6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL6_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL6_B_0x1 = 1;

    /** @brief Channel-x selection 	These bits are written by software and define which channels are part of the sequence of channels to be converted. 	Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). 	If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELRMOD0_CHSEL7 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL7_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL7_B_0x1 = 1;

    /** @brief Channel-x selection 	These bits are written by software and define which channels are part of the sequence of channels to be converted. 	Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). 	If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELRMOD0_CHSEL8 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL8_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL8_B_0x1 = 1;

    /** @brief Channel-x selection 	These bits are written by software and define which channels are part of the sequence of channels to be converted. 	Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). 	If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELRMOD0_CHSEL9 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL9_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL9_B_0x1 = 1;

    /** @brief Channel-x selection 	These bits are written by software and define which channels are part of the sequence of channels to be converted. 	Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). 	If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELRMOD0_CHSEL10 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL10_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL10_B_0x1 = 1;

    /** @brief Channel-x selection 	These bits are written by software and define which channels are part of the sequence of channels to be converted. 	Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). 	If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELRMOD0_CHSEL11 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL11_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL11_B_0x1 = 1;

    /** @brief Channel-x selection 	These bits are written by software and define which channels are part of the sequence of channels to be converted. 	Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). 	If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELRMOD0_CHSEL12 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL12_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL12_B_0x1 = 1;

    /** @brief Channel-x selection 	These bits are written by software and define which channels are part of the sequence of channels to be converted. 	Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). 	If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELRMOD0_CHSEL13 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL13_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL13_B_0x1 = 1;

    /** @brief Channel-x selection 	These bits are written by software and define which channels are part of the sequence of channels to be converted. 	Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). 	If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELRMOD0_CHSEL14 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL14_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL14_B_0x1 = 1;

    /** @brief Channel-x selection 	These bits are written by software and define which channels are part of the sequence of channels to be converted. 	Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). 	If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELRMOD0_CHSEL15 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL15_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL15_B_0x1 = 1;

    /** @brief Channel-x selection 	These bits are written by software and define which channels are part of the sequence of channels to be converted. 	Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). 	If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELRMOD0_CHSEL16 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL16_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL16_B_0x1 = 1;

    /** @brief Channel-x selection 	These bits are written by software and define which channels are part of the sequence of channels to be converted. 	Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). 	If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELRMOD0_CHSEL17 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL17_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL17_B_0x1 = 1;

    /** @brief Channel-x selection 	These bits are written by software and define which channels are part of the sequence of channels to be converted. 	Note: The software is allowed to write this bit only when ADSTART=0 (which ensures that no conversion is ongoing). 	If CCRDY is not yet asserted after channel configuration (writing ADC_CHSELR register or changing CHSELRMOD or SCANDIR), the value written to this bit is ignored. */
    using ADC_CHSELRMOD0_CHSEL18 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL18_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELRMOD0_CHSEL18_B_0x1 = 1;
     ...
     */
        /** @brief CH0 */
    constexpr std::uint32_t ADC_CHSELRMOD1_SQ8_B_0x0 = 0;
        /** @brief CH1 */
    constexpr std::uint32_t ADC_CHSELRMOD1_SQ8_B_0x1 = 1;
        /** @brief CH12 */
    constexpr std::uint32_t ADC_CHSELRMOD1_SQ8_B_0xC = 12;
        /** @brief CH13 */
    constexpr std::uint32_t ADC_CHSELRMOD1_SQ8_B_0xD = 13;
        /** @brief CH14 */
    constexpr std::uint32_t ADC_CHSELRMOD1_SQ8_B_0xE = 14;
        /** @brief No channel selected (End of sequence) */
    constexpr std::uint32_t ADC_CHSELRMOD1_SQ8_B_0xF = 15;

    /** @brief ADC watchdog threshold register */
    using ADC_AWD3TR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x2C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Analog watchdog 3lower threshold 	These bits are written by software to define the lower threshold for the analog watchdog. 	Refer to ADC_AWDxTR) on page395. */
    using ADC_AWD3TR_LT3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Analog watchdog 3 higher threshold 	These bits are written by software to define the higher threshold for the analog watchdog. 	Refer to ADC_AWDxTR) on page395. */
    ...
    /** @brief Converted data 	These bits are read-only. They contain the conversion result from the last converted channel. The data are left- or right-aligned as shown in OVSE = 0) on page389. 	Just after a calibration is complete, DATA[6:0] contains the calibration factor. */
    ...
    /** @details Possible values:
     *          - B_0x0: Temperature sensor disabled, DAC_OUT1 connected to ADC channel 12 (value: 0)
     *          - B_0x1: Temperature sensor enabled (value: 1)
     */
        /** @brief Temperature sensor disabled, DAC_OUT1 connected to ADC channel 12 */
    ...
    /** @details Possible values:
     *          - B_0x0: VBAT channel disabled, DAC_OUT2 connected to ADC channel 14 (value: 0)
     *          - B_0x1: VBAT channel enabled (value: 1)
     */
        /** @brief VBAT channel disabled, DAC_OUT2 connected to ADC channel 14 */
