...
#ifndef EMBEDDED_PP_STM32G061_AES_HPP
#define EMBEDDED_PP_STM32G061_AES_HPP
...
namespace STM32G061::AES {
    ...
    /** @brief Busy This flag indicates whether AES is idle or busy during GCM payload encryption phase */
