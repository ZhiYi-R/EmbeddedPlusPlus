...
#ifndef EMBEDDED_PP_STM32G061_LPUART1_HPP
#define EMBEDDED_PP_STM32G061_LPUART1_HPP
...
namespace STM32G061::LPUART1 {

    /** @brief LPUART control register 1 [alternate] */
    using LPUART_CR1_enabled = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPUART_CR1_enabled_UE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    constexpr std::uint32_t LPUART_CR1_enabled_UE_B_0x0 = 0;
        /** @brief USART enabled */
    constexpr std::uint32_t LPUART_CR1_enabled_UE_B_0x1 = 1;
    ...
    using LPUART_CR1_enabled_UESM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPUART_CR1_enabled_UESM_B_0x0 = 0;
        /** @brief USART able to wake up the MCU from low-power mode. */
    constexpr std::uint32_t LPUART_CR1_enabled_UESM_B_0x1 = 1;

    /** @brief Receiver enable 	This bit enables the receiver. It is set and cleared by software. */
    using LPUART_CR1_enabled_RE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPUART_CR1_enabled_RE_B_0x0 = 0;
        /** @brief Receiver is enabled and begins searching for a start bit */
    constexpr std::uint32_t LPUART_CR1_enabled_RE_B_0x1 = 1;
    ...
    using LPUART_CR1_enabled_TE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Transmitter is disabled (value: 0)
     *          - B_0x1: Transmitter is enabled (value: 1)
     */
        /** @brief Transmitter is disabled */
    constexpr std::uint32_t LPUART_CR1_enabled_TE_B_0x0 = 0;
        /** @brief Transmitter is enabled */
    constexpr std::uint32_t LPUART_CR1_enabled_TE_B_0x1 = 1;

    /** @brief IDLE interrupt enable 	This bit is set and cleared by software. */
    using LPUART_CR1_enabled_IDLEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPUART_CR1_enabled_IDLEIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever IDLE = 1 in the USART_ISR register */
    constexpr std::uint32_t LPUART_CR1_enabled_IDLEIE_B_0x1 = 1;

    /** @brief RXFIFO not empty interrupt enable 	This bit is set and cleared by software. */
    using LPUART_CR1_enabled_RXFNEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever ORE = 1 or RXFNE = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t LPUART_CR1_enabled_RXFNEIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever ORE = 1 or RXFNE = 1 in the USART_ISR register */
    constexpr std::uint32_t LPUART_CR1_enabled_RXFNEIE_B_0x1 = 1;

    /** @brief Transmission complete interrupt enable 	This bit is set and cleared by software. */
    using LPUART_CR1_enabled_TCIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever TC = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t LPUART_CR1_enabled_TCIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever TC = 1 in the USART_ISR register */
    constexpr std::uint32_t LPUART_CR1_enabled_TCIE_B_0x1 = 1;

    /** @brief TXFIFO not full interrupt enable 	This bit is set and cleared by software. */
    using LPUART_CR1_enabled_TXFNFIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever TXFNF =1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t LPUART_CR1_enabled_TXFNFIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever TXFNF =1 in the USART_ISR register */
    constexpr std::uint32_t LPUART_CR1_enabled_TXFNFIE_B_0x1 = 1;

    /** @brief PE interrupt enable 	This bit is set and cleared by software. */
    using LPUART_CR1_enabled_PEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever PE = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t LPUART_CR1_enabled_PEIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever PE = 1 in the USART_ISR register */
    constexpr std::uint32_t LPUART_CR1_enabled_PEIE_B_0x1 = 1;
    ...
    using LPUART_CR1_enabled_PS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Even parity (value: 0)
     *          - B_0x1: Odd parity (value: 1)
     */
        /** @brief Even parity */
    constexpr std::uint32_t LPUART_CR1_enabled_PS_B_0x0 = 0;
        /** @brief Odd parity */
    constexpr std::uint32_t LPUART_CR1_enabled_PS_B_0x1 = 1;
    ...
    using LPUART_CR1_enabled_PCE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Parity control disabled (value: 0)
     *          - B_0x1: Parity control enabled (value: 1)
     */
        /** @brief Parity control disabled */
    constexpr std::uint32_t LPUART_CR1_enabled_PCE_B_0x0 = 0;
        /** @brief Parity control enabled */
    constexpr std::uint32_t LPUART_CR1_enabled_PCE_B_0x1 = 1;
    ...
    using LPUART_CR1_enabled_WAKE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Idle line (value: 0)
     *          - B_0x1: Address mark (value: 1)
     */
        /** @brief Idle line */
    constexpr std::uint32_t LPUART_CR1_enabled_WAKE_B_0x0 = 0;
        /** @brief Address mark */
    constexpr std::uint32_t LPUART_CR1_enabled_WAKE_B_0x1 = 1;
    ...
    using LPUART_CR1_enabled_M0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPUART_CR1_enabled_MME = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPUART_CR1_enabled_MME_B_0x0 = 0;
        /** @brief Receiver can switch between Mute mode and active mode. */
    constexpr std::uint32_t LPUART_CR1_enabled_MME_B_0x1 = 1;

    /** @brief Character match interrupt enable 	This bit is set and cleared by software. */
    using LPUART_CR1_enabled_CMIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated when the CMF bit is set in the USART_ISR register. (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t LPUART_CR1_enabled_CMIE_B_0x0 = 0;
        /** @brief USART interrupt generated when the CMF bit is set in the USART_ISR register. */
    constexpr std::uint32_t LPUART_CR1_enabled_CMIE_B_0x1 = 1;
    ...
    using LPUART_CR1_enabled_OVER8 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Oversampling by 16 (value: 0)
     *          - B_0x1: Oversampling by 8 (value: 1)
     */
        /** @brief Oversampling by 16 */
    constexpr std::uint32_t LPUART_CR1_enabled_OVER8_B_0x0 = 0;
        /** @brief Oversampling by 8 */
    constexpr std::uint32_t LPUART_CR1_enabled_OVER8_B_0x1 = 1;
    ...
    using LPUART_CR1_enabled_DEDT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPUART_CR1_enabled_DEAT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPUART_CR1_enabled_RTOIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated when the RTOF bit is set in the USART_ISR register. (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t LPUART_CR1_enabled_RTOIE_B_0x0 = 0;
        /** @brief USART interrupt generated when the RTOF bit is set in the USART_ISR register. */
    constexpr std::uint32_t LPUART_CR1_enabled_RTOIE_B_0x1 = 1;
    ...
    using LPUART_CR1_enabled_EOBIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated when the EOBF flag is set in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t LPUART_CR1_enabled_EOBIE_B_0x0 = 0;
        /** @brief USART interrupt generated when the EOBF flag is set in the USART_ISR register */
    constexpr std::uint32_t LPUART_CR1_enabled_EOBIE_B_0x1 = 1;
    ...
    using LPUART_CR1_enabled_M1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPUART_CR1_enabled_FIFOEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: FIFO mode is disabled. (value: 0)
     *          - B_0x1: FIFO mode is enabled. (value: 1)
     */
        /** @brief FIFO mode is disabled. */
    constexpr std::uint32_t LPUART_CR1_enabled_FIFOEN_B_0x0 = 0;
        /** @brief FIFO mode is enabled. */
    constexpr std::uint32_t LPUART_CR1_enabled_FIFOEN_B_0x1 = 1;

    /** @brief TXFIFO empty interrupt enable 	This bit is set and cleared by software. */
    using LPUART_CR1_enabled_TXFEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated when TXFE = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t LPUART_CR1_enabled_TXFEIE_B_0x0 = 0;
        /** @brief USART interrupt generated when TXFE = 1 in the USART_ISR register */
    constexpr std::uint32_t LPUART_CR1_enabled_TXFEIE_B_0x1 = 1;

    /** @brief RXFIFO Full interrupt enable 	This bit is set and cleared by software. */
    using LPUART_CR1_enabled_RXFFIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated when RXFF = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t LPUART_CR1_enabled_RXFFIE_B_0x0 = 0;
        /** @brief USART interrupt generated when RXFF = 1 in the USART_ISR register */
    constexpr std::uint32_t LPUART_CR1_enabled_RXFFIE_B_0x1 = 1;

    /** @brief LPUART control register 1 [alternate] */
    using LPUART_CR1_disabled = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USART enable When this bit is cleared, the USART prescalers and outputs are stopped immediately, and all current operations are discarded. The USART configuration is kept, but all the USART_ISR status flags are reset. This bit is set and cleared by software. Note: To enter low-power mode without generating errors on the line, the TE bit must be previously reset and the software must wait for the TC bit in the USART_ISR to be set before resetting the UE bit. The DMA requests are also reset when UE = 0 so the DMA channel must be disabled before resetting the UE bit. In Smartcard mode, (SCEN = 1), the SCLK is always available when CLKEN = 1, regardless of the UE bit value. */
    using LPUART_CR1_disabled_UE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: USART prescaler and outputs disabled, low-power mode (value: 0)
     *          - B_0x1: USART enabled (value: 1)
     */
        /** @brief USART prescaler and outputs disabled, low-power mode */
    constexpr std::uint32_t LPUART_CR1_disabled_UE_B_0x0 = 0;
        /** @brief USART enabled */
    constexpr std::uint32_t LPUART_CR1_disabled_UE_B_0x1 = 1;

    /** @brief USART enable in low-power mode When this bit is cleared, the USART cannot wake up the MCU from low-power mode. When this bit is set, the USART can wake up the MCU from low-power mode. This bit is set and cleared by software. Note: It is recommended to set the UESM bit just before entering low-power mode and clear it when exit from low-power mode. If the USART does not support the wakeup from Stop feature, this bit is reserved and must be kept at reset value. Refer to . */
    using LPUART_CR1_disabled_UESM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: USART not able to wake up the MCU from low-power mode. (value: 0)
     *          - B_0x1: USART able to wake up the MCU from low-power mode. (value: 1)
     */
        /** @brief USART not able to wake up the MCU from low-power mode. */
    constexpr std::uint32_t LPUART_CR1_disabled_UESM_B_0x0 = 0;
        /** @brief USART able to wake up the MCU from low-power mode. */
    constexpr std::uint32_t LPUART_CR1_disabled_UESM_B_0x1 = 1;

    /** @brief Receiver enable This bit enables the receiver. It is set and cleared by software. */
    using LPUART_CR1_disabled_RE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Receiver is disabled (value: 0)
     *          - B_0x1: Receiver is enabled and begins searching for a start bit (value: 1)
     */
        /** @brief Receiver is disabled */
    constexpr std::uint32_t LPUART_CR1_disabled_RE_B_0x0 = 0;
        /** @brief Receiver is enabled and begins searching for a start bit */
    constexpr std::uint32_t LPUART_CR1_disabled_RE_B_0x1 = 1;

    /** @brief Transmitter enable This bit enables the transmitter. It is set and cleared by software. Note: During transmission, a low pulse on the TE bit ('0' followed by '1') sends a preamble (idle line) after the current word, except in Smartcard mode. In order to generate an idle character, the TE must not be immediately written to '1'. To ensure the required duration, the software can poll the TEACK bit in the USART_ISR register. In Smartcard mode, when TE is set, there is a 1 bit-time delay before the transmission starts. */
    using LPUART_CR1_disabled_TE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Transmitter is disabled (value: 0)
     *          - B_0x1: Transmitter is enabled (value: 1)
     */
        /** @brief Transmitter is disabled */
    constexpr std::uint32_t LPUART_CR1_disabled_TE_B_0x0 = 0;
        /** @brief Transmitter is enabled */
    constexpr std::uint32_t LPUART_CR1_disabled_TE_B_0x1 = 1;

    /** @brief IDLE interrupt enable This bit is set and cleared by software. */
    using LPUART_CR1_disabled_IDLEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever IDLE = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t LPUART_CR1_disabled_IDLEIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever IDLE = 1 in the USART_ISR register */
    constexpr std::uint32_t LPUART_CR1_disabled_IDLEIE_B_0x1 = 1;

    /** @brief Receive data register not empty This bit is set and cleared by software. */
    using LPUART_CR1_disabled_RXNEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever ORE = 1 or RXNE = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t LPUART_CR1_disabled_RXNEIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever ORE = 1 or RXNE = 1 in the USART_ISR register */
    constexpr std::uint32_t LPUART_CR1_disabled_RXNEIE_B_0x1 = 1;

    /** @brief Transmission complete interrupt enable This bit is set and cleared by software. */
    using LPUART_CR1_disabled_TCIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever TC = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t LPUART_CR1_disabled_TCIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever TC = 1 in the USART_ISR register */
    constexpr std::uint32_t LPUART_CR1_disabled_TCIE_B_0x1 = 1;

    /** @brief Transmit data register empty This bit is set and cleared by software. */
    using LPUART_CR1_disabled_TXEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever TXE =1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t LPUART_CR1_disabled_TXEIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever TXE =1 in the USART_ISR register */
    constexpr std::uint32_t LPUART_CR1_disabled_TXEIE_B_0x1 = 1;

    /** @brief PE interrupt enable This bit is set and cleared by software. */
    using LPUART_CR1_disabled_PEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever PE = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t LPUART_CR1_disabled_PEIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever PE = 1 in the USART_ISR register */
    constexpr std::uint32_t LPUART_CR1_disabled_PEIE_B_0x1 = 1;

    /** @brief Parity selection This bit selects the odd or even parity when the parity generation/detection is enabled (PCE bit set). It is set and cleared by software. The parity is selected after the current byte. This bitfield can only be written when the USART is disabled (UE=0). */
    using LPUART_CR1_disabled_PS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Even parity (value: 0)
     *          - B_0x1: Odd parity (value: 1)
     */
        /** @brief Even parity */
    constexpr std::uint32_t LPUART_CR1_disabled_PS_B_0x0 = 0;
        /** @brief Odd parity */
    constexpr std::uint32_t LPUART_CR1_disabled_PS_B_0x1 = 1;

    /** @brief Parity control enable This bit selects the hardware parity control (generation and detection). When the parity control is enabled, the computed parity is inserted at the MSB position (9th bit if M=1; 8th bit if M=0) and the parity is checked on the received data. This bit is set and cleared by software. Once it is set, PCE is active after the current byte (in reception and in transmission). This bitfield can only be written when the USART is disabled (UE=0). */
    using LPUART_CR1_disabled_PCE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Parity control disabled (value: 0)
     *          - B_0x1: Parity control enabled (value: 1)
     */
        /** @brief Parity control disabled */
    constexpr std::uint32_t LPUART_CR1_disabled_PCE_B_0x0 = 0;
        /** @brief Parity control enabled */
    constexpr std::uint32_t LPUART_CR1_disabled_PCE_B_0x1 = 1;

    /** @brief Receiver wakeup method This bit determines the USART wakeup method from Mute mode. It is set or cleared by software. This bitfield can only be written when the USART is disabled (UE=0). */
    using LPUART_CR1_disabled_WAKE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Idle line (value: 0)
     *          - B_0x1: Address mark (value: 1)
     */
        /** @brief Idle line */
    constexpr std::uint32_t LPUART_CR1_disabled_WAKE_B_0x0 = 0;
        /** @brief Address mark */
    constexpr std::uint32_t LPUART_CR1_disabled_WAKE_B_0x1 = 1;

    /** @brief Word length This bit is used in conjunction with bit 28 (M1) to determine the word length. It is set or cleared by software (refer to bit 28 (M1)description). This bit can only be written when the USART is disabled (UE=0). */
    using LPUART_CR1_disabled_M0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Mute mode enable This bit enables the USART Mute mode function. When set, the USART can switch between active and Mute mode, as defined by the WAKE bit. It is set and cleared by software. */
    using LPUART_CR1_disabled_MME = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Receiver in active mode permanently (value: 0)
     *          - B_0x1: Receiver can switch between Mute mode and active mode. (value: 1)
     */
        /** @brief Receiver in active mode permanently */
    constexpr std::uint32_t LPUART_CR1_disabled_MME_B_0x0 = 0;
        /** @brief Receiver can switch between Mute mode and active mode. */
    constexpr std::uint32_t LPUART_CR1_disabled_MME_B_0x1 = 1;

    /** @brief Character match interrupt enable This bit is set and cleared by software. */
    using LPUART_CR1_disabled_CMIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated when the CMF bit is set in the USART_ISR register. (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t LPUART_CR1_disabled_CMIE_B_0x0 = 0;
        /** @brief USART interrupt generated when the CMF bit is set in the USART_ISR register. */
    constexpr std::uint32_t LPUART_CR1_disabled_CMIE_B_0x1 = 1;

    /** @brief Oversampling mode This bit can only be written when the USART is disabled (UE=0). Note: In LIN, IrDA and Smartcard modes, this bit must be kept cleared. */
    using LPUART_CR1_disabled_OVER8 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Oversampling by 16 (value: 0)
     *          - B_0x1: Oversampling by 8 (value: 1)
     */
        /** @brief Oversampling by 16 */
    constexpr std::uint32_t LPUART_CR1_disabled_OVER8_B_0x0 = 0;
        /** @brief Oversampling by 8 */
    constexpr std::uint32_t LPUART_CR1_disabled_OVER8_B_0x1 = 1;

    /** @brief Driver Enable deassertion time This 5-bit value defines the time between the end of the last stop bit, in a transmitted message, and the de-activation of the DE (Driver Enable) signal. It is expressed in sample time units (1/8 or 1/16 bit time, depending on the oversampling rate). If the USART_TDR register is written during the DEDT time, the new data is transmitted only when the DEDT and DEAT times have both elapsed. This bitfield can only be written when the USART is disabled (UE=0). Note: If the Driver Enable feature is not supported, this bit is reserved and must be kept at reset value. Refer to . */
    using LPUART_CR1_disabled_DEDT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Driver Enable assertion time This 5-bit value defines the time between the activation of the DE (Driver Enable) signal and the beginning of the start bit. It is expressed in sample time units (1/8 or 1/16 bit time, depending on the oversampling rate). This bitfield can only be written when the USART is disabled (UE=0). Note: If the Driver Enable feature is not supported, this bit is reserved and must be kept at reset value. Refer to . */
    using LPUART_CR1_disabled_DEAT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Receiver timeout interrupt enable This bit is set and cleared by software. Note: If the USART does not support the Receiver timeout feature, this bit is reserved and must be kept at reset value. . */
    using LPUART_CR1_disabled_RTOIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated when the RTOF bit is set in the USART_ISR register. (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t LPUART_CR1_disabled_RTOIE_B_0x0 = 0;
        /** @brief USART interrupt generated when the RTOF bit is set in the USART_ISR register. */
    constexpr std::uint32_t LPUART_CR1_disabled_RTOIE_B_0x1 = 1;

    /** @brief End of Block interrupt enable This bit is set and cleared by software. Note: If the USART does not support Smartcard mode, this bit is reserved and must be kept at reset value. Refer to . */
    using LPUART_CR1_disabled_EOBIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated when the EOBF flag is set in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t LPUART_CR1_disabled_EOBIE_B_0x0 = 0;
        /** @brief USART interrupt generated when the EOBF flag is set in the USART_ISR register */
    constexpr std::uint32_t LPUART_CR1_disabled_EOBIE_B_0x1 = 1;

    /** @brief Word length This bit must be used in conjunction with bit 12 (M0) to determine the word length. It is set or cleared by software. M[1:0] = '00': 1 start bit, 8 Data bits, n Stop bit M[1:0] = '01': 1 start bit, 9 Data bits, n Stop bit M[1:0] = '10': 1 start bit, 7 Data bits, n Stop bit This bit can only be written when the USART is disabled (UE=0). Note: In 7-bits data length mode, the Smartcard mode, LIN master mode and Auto baud rate (0x7F and 0x55 frames detection) are not supported. */
    using LPUART_CR1_disabled_M1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FIFO mode enable This bit is set and cleared by software. This bitfield can only be written when the USART is disabled (UE=0). Note: FIFO mode can be used on standard UART communication, in SPI master/slave mode and in Smartcard modes only. It must not be enabled in IrDA and LIN modes. */
    using LPUART_CR1_disabled_FIFOEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: FIFO mode is disabled. (value: 0)
     *          - B_0x1: FIFO mode is enabled. (value: 1)
     */
        /** @brief FIFO mode is disabled. */
    constexpr std::uint32_t LPUART_CR1_disabled_FIFOEN_B_0x0 = 0;
        /** @brief FIFO mode is enabled. */
    constexpr std::uint32_t LPUART_CR1_disabled_FIFOEN_B_0x1 = 1;
    ...
    using LPUART_CR3_WUS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: WUF active on address match (as defined by ADD[7:0] and ADDM7) (value: 0)
     *          - B_0x2: WUF active on Start bit detection (value: 2)
     *          - B_0x3: WUF active on RXNE. (value: 3)
     */
        /** @brief WUF active on address match (as defined by ADD[7:0] and ADDM7) */
    constexpr std::uint32_t LPUART_CR3_WUS_B_0x0 = 0;
        /** @brief WUF active on Start bit detection */
    constexpr std::uint32_t LPUART_CR3_WUS_B_0x2 = 2;
        /** @brief WUF active on RXNE. */
    constexpr std::uint32_t LPUART_CR3_WUS_B_0x3 = 3;

    /** @brief Wakeup from low-power mode interrupt enable This bit is set and cleared by software. Note: WUFIE must be set before entering in low-power mode. If the LPUART does not support the wakeup from Stop feature, this bit is reserved and must be kept at reset value. Refer to . */
    using LPUART_CR3_WUFIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt is inhibited (value: 0)
     *          - B_0x1: An LPUART interrupt is generated whenever WUF = 1 in the LPUART_ISR register (value: 1)
     */
        /** @brief Interrupt is inhibited */
    constexpr std::uint32_t LPUART_CR3_WUFIE_B_0x0 = 0;
        /** @brief An LPUART interrupt is generated whenever WUF = 1 in the LPUART_ISR register */
    ...
    using LPUART_ISR_enabled = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPUART_ISR_enabled_PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No parity error (value: 0)
     *          - B_0x1: Parity error (value: 1)
     */
        /** @brief No parity error */
    constexpr std::uint32_t LPUART_ISR_enabled_PE_B_0x0 = 0;
        /** @brief Parity error */
    constexpr std::uint32_t LPUART_ISR_enabled_PE_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPUART_ISR_enabled_FE_B_0x0 = 0;
        /** @brief Framing error or break character is detected */
    constexpr std::uint32_t LPUART_ISR_enabled_FE_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_NE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No noise is detected (value: 0)
     *          - B_0x1: Noise is detected (value: 1)
     */
        /** @brief No noise is detected */
    constexpr std::uint32_t LPUART_ISR_enabled_NE_B_0x0 = 0;
        /** @brief Noise is detected */
    constexpr std::uint32_t LPUART_ISR_enabled_NE_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_ORE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No overrun error (value: 0)
     *          - B_0x1: Overrun error is detected (value: 1)
     */
        /** @brief No overrun error */
    constexpr std::uint32_t LPUART_ISR_enabled_ORE_B_0x0 = 0;
        /** @brief Overrun error is detected */
    constexpr std::uint32_t LPUART_ISR_enabled_ORE_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_IDLE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No Idle line is detected (value: 0)
     *          - B_0x1: Idle line is detected (value: 1)
     */
        /** @brief No Idle line is detected */
    constexpr std::uint32_t LPUART_ISR_enabled_IDLE_B_0x0 = 0;
        /** @brief Idle line is detected */
    constexpr std::uint32_t LPUART_ISR_enabled_IDLE_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_RXFNE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Data is not received (value: 0)
     *          - B_0x1: Received data is ready to be read. (value: 1)
     */
        /** @brief Data is not received */
    constexpr std::uint32_t LPUART_ISR_enabled_RXFNE_B_0x0 = 0;
        /** @brief Received data is ready to be read. */
    constexpr std::uint32_t LPUART_ISR_enabled_RXFNE_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_TC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Transmission is not complete (value: 0)
     *          - B_0x1: Transmission is complete (value: 1)
     */
        /** @brief Transmission is not complete */
    constexpr std::uint32_t LPUART_ISR_enabled_TC_B_0x0 = 0;
        /** @brief Transmission is complete */
    constexpr std::uint32_t LPUART_ISR_enabled_TC_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_TXFNF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Transmit FIFO is full (value: 0)
     *          - B_0x1: Transmit FIFO is not full (value: 1)
     */
        /** @brief Transmit FIFO is full */
    constexpr std::uint32_t LPUART_ISR_enabled_TXFNF_B_0x0 = 0;
        /** @brief Transmit FIFO is not full */
    constexpr std::uint32_t LPUART_ISR_enabled_TXFNF_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_LBDF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: LIN Break not detected (value: 0)
     *          - B_0x1: LIN break detected (value: 1)
     */
        /** @brief LIN Break not detected */
    constexpr std::uint32_t LPUART_ISR_enabled_LBDF_B_0x0 = 0;
        /** @brief LIN break detected */
    constexpr std::uint32_t LPUART_ISR_enabled_LBDF_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_CTSIF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPUART_ISR_enabled_CTSIF_B_0x0 = 0;
        /** @brief A change occurred on the nCTS status line */
    constexpr std::uint32_t LPUART_ISR_enabled_CTSIF_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_CTS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: nCTS line set (value: 0)
     *          - B_0x1: nCTS line reset (value: 1)
     */
        /** @brief nCTS line set */
    constexpr std::uint32_t LPUART_ISR_enabled_CTS_B_0x0 = 0;
        /** @brief nCTS line reset */
    constexpr std::uint32_t LPUART_ISR_enabled_CTS_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_RTOF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPUART_ISR_enabled_RTOF_B_0x0 = 0;
        /** @brief Timeout value reached without any data reception */
    constexpr std::uint32_t LPUART_ISR_enabled_RTOF_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_EOBF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPUART_ISR_enabled_EOBF_B_0x0 = 0;
        /** @brief End of Block (number of characters) reached */
    constexpr std::uint32_t LPUART_ISR_enabled_EOBF_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_UDR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No underrun error (value: 0)
     *          - B_0x1: underrun error (value: 1)
     */
        /** @brief No underrun error */
    constexpr std::uint32_t LPUART_ISR_enabled_UDR_B_0x0 = 0;
        /** @brief underrun error */
    constexpr std::uint32_t LPUART_ISR_enabled_UDR_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_ABRE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPUART_ISR_enabled_ABRF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPUART_ISR_enabled_BUSY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: USART is idle (no reception) (value: 0)
     *          - B_0x1: Reception on going (value: 1)
     */
        /** @brief USART is idle (no reception) */
    constexpr std::uint32_t LPUART_ISR_enabled_BUSY_B_0x0 = 0;
        /** @brief Reception on going */
    constexpr std::uint32_t LPUART_ISR_enabled_BUSY_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_CMF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No Character match detected (value: 0)
     *          - B_0x1: Character Match detected (value: 1)
     */
        /** @brief No Character match detected */
    constexpr std::uint32_t LPUART_ISR_enabled_CMF_B_0x0 = 0;
        /** @brief Character Match detected */
    constexpr std::uint32_t LPUART_ISR_enabled_CMF_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_SBKF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPUART_ISR_enabled_SBKF_B_0x0 = 0;
        /** @brief Break character requested by setting SBKRQ bit in USART_RQR register */
    constexpr std::uint32_t LPUART_ISR_enabled_SBKF_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_RWU = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Receiver in active mode (value: 0)
     *          - B_0x1: Receiver in Mute mode (value: 1)
     */
        /** @brief Receiver in active mode */
    constexpr std::uint32_t LPUART_ISR_enabled_RWU_B_0x0 = 0;
        /** @brief Receiver in Mute mode */
    constexpr std::uint32_t LPUART_ISR_enabled_RWU_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_WUF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPUART_ISR_enabled_TEACK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPUART_ISR_enabled_REACK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPUART_ISR_enabled_TXFE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: TXFIFO not empty. (value: 0)
     *          - B_0x1: TXFIFO empty. (value: 1)
     */
        /** @brief TXFIFO not empty. */
    constexpr std::uint32_t LPUART_ISR_enabled_TXFE_B_0x0 = 0;
        /** @brief TXFIFO empty. */
    constexpr std::uint32_t LPUART_ISR_enabled_TXFE_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_RXFF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: RXFIFO not full. (value: 0)
     *          - B_0x1: RXFIFO Full. (value: 1)
     */
        /** @brief RXFIFO not full. */
    constexpr std::uint32_t LPUART_ISR_enabled_RXFF_B_0x0 = 0;
        /** @brief RXFIFO Full. */
    constexpr std::uint32_t LPUART_ISR_enabled_RXFF_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_TCBGT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    using LPUART_ISR_enabled_RXFT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPUART_ISR_enabled_RXFT_B_0x0 = 0;
        /** @brief Receive FIFO reached the programmed threshold. */
    constexpr std::uint32_t LPUART_ISR_enabled_RXFT_B_0x1 = 1;
    ...
    using LPUART_ISR_enabled_TXFT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPUART_ISR_enabled_TXFT_B_0x0 = 0;
        /** @brief TXFIFO reached the programmed threshold. */
    constexpr std::uint32_t LPUART_ISR_enabled_TXFT_B_0x1 = 1;

    /** @brief LPUART interrupt and status register [alternate] */
    using LPUART_ISR_disabled = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPUART_ISR_disabled_PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No parity error (value: 0)
     *          - B_0x1: Parity error (value: 1)
     */
        /** @brief No parity error */
    constexpr std::uint32_t LPUART_ISR_disabled_PE_B_0x0 = 0;
        /** @brief Parity error */
    constexpr std::uint32_t LPUART_ISR_disabled_PE_B_0x1 = 1;

    /** @brief Framing error This bit is set by hardware when a de-synchronization, excessive noise or a break character is detected. It is cleared by software, writing 1 to the FECF bit in the USART_ICR register. When transmitting data in Smartcard mode, this bit is set when the maximum number of transmit attempts is reached without success (the card NACKs the data frame). An interrupt is generated if EIE=1 in the USART_CR1 register. */
    using LPUART_ISR_disabled_FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No Framing error is detected (value: 0)
     *          - B_0x1: Framing error or break character is detected (value: 1)
     */
        /** @brief No Framing error is detected */
    constexpr std::uint32_t LPUART_ISR_disabled_FE_B_0x0 = 0;
        /** @brief Framing error or break character is detected */
    constexpr std::uint32_t LPUART_ISR_disabled_FE_B_0x1 = 1;
    ...
    using LPUART_ISR_disabled_NE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No noise is detected (value: 0)
     *          - B_0x1: Noise is detected (value: 1)
     */
        /** @brief No noise is detected */
    constexpr std::uint32_t LPUART_ISR_disabled_NE_B_0x0 = 0;
        /** @brief Noise is detected */
    constexpr std::uint32_t LPUART_ISR_disabled_NE_B_0x1 = 1;
    ...
    using LPUART_ISR_disabled_ORE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No overrun error (value: 0)
     *          - B_0x1: Overrun error is detected (value: 1)
     */
        /** @brief No overrun error */
    constexpr std::uint32_t LPUART_ISR_disabled_ORE_B_0x0 = 0;
        /** @brief Overrun error is detected */
    constexpr std::uint32_t LPUART_ISR_disabled_ORE_B_0x1 = 1;
    ...
    using LPUART_ISR_disabled_IDLE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No Idle line is detected (value: 0)
     *          - B_0x1: Idle line is detected (value: 1)
     */
        /** @brief No Idle line is detected */
    constexpr std::uint32_t LPUART_ISR_disabled_IDLE_B_0x0 = 0;
        /** @brief Idle line is detected */
    constexpr std::uint32_t LPUART_ISR_disabled_IDLE_B_0x1 = 1;
    ...
    using LPUART_ISR_disabled_RXNE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Data is not received (value: 0)
     *          - B_0x1: Received data is ready to be read. (value: 1)
     */
        /** @brief Data is not received */
    constexpr std::uint32_t LPUART_ISR_disabled_RXNE_B_0x0 = 0;
        /** @brief Received data is ready to be read. */
    constexpr std::uint32_t LPUART_ISR_disabled_RXNE_B_0x1 = 1;
    ...
    using LPUART_ISR_disabled_TC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Transmission is not complete (value: 0)
     *          - B_0x1: Transmission is complete (value: 1)
     */
        /** @brief Transmission is not complete */
    constexpr std::uint32_t LPUART_ISR_disabled_TC_B_0x0 = 0;
        /** @brief Transmission is complete */
    constexpr std::uint32_t LPUART_ISR_disabled_TC_B_0x1 = 1;
    ...
    using LPUART_ISR_disabled_TXE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Data register full (value: 0)
     *          - B_0x1: Data register not full (value: 1)
     */
        /** @brief Data register full */
    constexpr std::uint32_t LPUART_ISR_disabled_TXE_B_0x0 = 0;
        /** @brief Data register not full */
    constexpr std::uint32_t LPUART_ISR_disabled_TXE_B_0x1 = 1;

    /** @brief LIN break detection flag This bit is set by hardware when the LIN break is detected. It is cleared by software, by writing 1 to the LBDCF in the USART_ICR. An interrupt is generated if LBDIE = 1 in the USART_CR2 register. Note: If the USART does not support LIN mode, this bit is reserved and kept at reset value. Refer to . */
    using LPUART_ISR_disabled_LBDF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: LIN Break not detected (value: 0)
     *          - B_0x1: LIN break detected (value: 1)
     */
        /** @brief LIN Break not detected */
    constexpr std::uint32_t LPUART_ISR_disabled_LBDF_B_0x0 = 0;
        /** @brief LIN break detected */
    constexpr std::uint32_t LPUART_ISR_disabled_LBDF_B_0x1 = 1;

    /** @brief CTS interrupt flag This bit is set by hardware when the nCTS input toggles, if the CTSE bit is set. It is cleared by software, by writing 1 to the CTSCF bit in the USART_ICR register. An interrupt is generated if CTSIE=1 in the USART_CR3 register. Note: If the hardware flow control feature is not supported, this bit is reserved and kept at reset value. */
    using LPUART_ISR_disabled_CTSIF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No change occurred on the nCTS status line (value: 0)
     *          - B_0x1: A change occurred on the nCTS status line (value: 1)
     */
        /** @brief No change occurred on the nCTS status line */
    constexpr std::uint32_t LPUART_ISR_disabled_CTSIF_B_0x0 = 0;
        /** @brief A change occurred on the nCTS status line */
    constexpr std::uint32_t LPUART_ISR_disabled_CTSIF_B_0x1 = 1;

    /** @brief CTS flag This bit is set/reset by hardware. It is an inverted copy of the status of the nCTS input pin. Note: If the hardware flow control feature is not supported, this bit is reserved and kept at reset value. */
    using LPUART_ISR_disabled_CTS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: nCTS line set (value: 0)
     *          - B_0x1: nCTS line reset (value: 1)
     */
        /** @brief nCTS line set */
    constexpr std::uint32_t LPUART_ISR_disabled_CTS_B_0x0 = 0;
        /** @brief nCTS line reset */
    constexpr std::uint32_t LPUART_ISR_disabled_CTS_B_0x1 = 1;

    /** @brief Receiver timeout This bit is set by hardware when the timeout value, programmed in the RTOR register has lapsed, without any communication. It is cleared by software, writing 1 to the RTOCF bit in the USART_ICR register. An interrupt is generated if RTOIE=1 in the USART_CR2 register. In Smartcard mode, the timeout corresponds to the CWT or BWT timings. Note: If a time equal to the value programmed in RTOR register separates 2 characters, RTOF is not set. If this time exceeds this value + 2 sample times (2/16 or 2/8, depending on the oversampling method), RTOF flag is set. The counter counts even if RE = 0 but RTOF is set only when RE = 1. If the timeout has already elapsed when RE is set, then RTOF is set. If the USART does not support the Receiver timeout feature, this bit is reserved and kept at reset value. */
    using LPUART_ISR_disabled_RTOF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Timeout value not reached (value: 0)
     *          - B_0x1: Timeout value reached without any data reception (value: 1)
     */
        /** @brief Timeout value not reached */
    constexpr std::uint32_t LPUART_ISR_disabled_RTOF_B_0x0 = 0;
        /** @brief Timeout value reached without any data reception */
    constexpr std::uint32_t LPUART_ISR_disabled_RTOF_B_0x1 = 1;

    /** @brief End of block flag This bit is set by hardware when a complete block has been received (for example T=1 Smartcard mode). The detection is done when the number of received bytes (from the start of the block, including the prologue) is equal or greater than BLEN + 4. An interrupt is generated if the EOBIE=1 in the USART_CR2 register. It is cleared by software, writing 1 to the EOBCF in the USART_ICR register. Note: If Smartcard mode is not supported, this bit is reserved and kept at reset value. Refer to . */
    using LPUART_ISR_disabled_EOBF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: End of Block not reached (value: 0)
     *          - B_0x1: End of Block (number of characters) reached (value: 1)
     */
        /** @brief End of Block not reached */
    constexpr std::uint32_t LPUART_ISR_disabled_EOBF_B_0x0 = 0;
        /** @brief End of Block (number of characters) reached */
    constexpr std::uint32_t LPUART_ISR_disabled_EOBF_B_0x1 = 1;

    /** @brief SPI slave underrun error flag In slave transmission mode, this flag is set when the first clock pulse for data transmission appears while the software has not yet loaded any value into USART_TDR. This flag is reset by setting UDRCF bit in the USART_ICR register. Note: If the USART does not support the SPI slave mode, this bit is reserved and kept at reset value. Refer to . */
    using LPUART_ISR_disabled_UDR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No underrun error (value: 0)
     *          - B_0x1: underrun error (value: 1)
     */
        /** @brief No underrun error */
    constexpr std::uint32_t LPUART_ISR_disabled_UDR_B_0x0 = 0;
        /** @brief underrun error */
    constexpr std::uint32_t LPUART_ISR_disabled_UDR_B_0x1 = 1;

    /** @brief Auto baud rate error This bit is set by hardware if the baud rate measurement failed (baud rate out of range or character comparison failed) It is cleared by software, by writing 1 to the ABRRQ bit in the USART_CR3 register. Note: If the USART does not support the auto baud rate feature, this bit is reserved and kept at reset value. */
    using LPUART_ISR_disabled_ABRE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPUART_ISR_disabled_ABRF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Busy flag This bit is set and reset by hardware. It is active when a communication is ongoing on the RX line (successful start bit detected). It is reset at the end of the reception (successful or not). */
    using LPUART_ISR_disabled_BUSY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: USART is idle (no reception) (value: 0)
     *          - B_0x1: Reception on going (value: 1)
     */
        /** @brief USART is idle (no reception) */
    constexpr std::uint32_t LPUART_ISR_disabled_BUSY_B_0x0 = 0;
        /** @brief Reception on going */
    constexpr std::uint32_t LPUART_ISR_disabled_BUSY_B_0x1 = 1;

    /** @brief Character match flag This bit is set by hardware, when a the character defined by ADD[7:0] is received. It is cleared by software, writing 1 to the CMCF in the USART_ICR register. An interrupt is generated if CMIE=1in the USART_CR1 register. */
    using LPUART_ISR_disabled_CMF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No Character match detected (value: 0)
     *          - B_0x1: Character Match detected (value: 1)
     */
        /** @brief No Character match detected */
    constexpr std::uint32_t LPUART_ISR_disabled_CMF_B_0x0 = 0;
        /** @brief Character Match detected */
    constexpr std::uint32_t LPUART_ISR_disabled_CMF_B_0x1 = 1;

    /** @brief Send break flag This bit indicates that a send break character was requested. It is set by software, by writing 1 to the SBKRQ bit in the USART_CR3 register. It is automatically reset by hardware during the stop bit of break transmission. */
    using LPUART_ISR_disabled_SBKF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Break character transmitted (value: 0)
     *          - B_0x1: Break character requested by setting SBKRQ bit in USART_RQR register (value: 1)
     */
        /** @brief Break character transmitted */
    constexpr std::uint32_t LPUART_ISR_disabled_SBKF_B_0x0 = 0;
        /** @brief Break character requested by setting SBKRQ bit in USART_RQR register */
    constexpr std::uint32_t LPUART_ISR_disabled_SBKF_B_0x1 = 1;

    /** @brief Receiver wakeup from Mute mode This bit indicates if the USART is in Mute mode. It is cleared/set by hardware when a wakeup/mute sequence is recognized. The Mute mode control sequence (address or IDLE) is selected by the WAKE bit in the USART_CR1 register. When wakeup on IDLE mode is selected, this bit can only be set by software, writing 1 to the MMRQ bit in the USART_RQR register. Note: If the USART does not support the wakeup from Stop feature, this bit is reserved and kept at reset value. Refer to . */
    using LPUART_ISR_disabled_RWU = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Receiver in active mode (value: 0)
     *          - B_0x1: Receiver in Mute mode (value: 1)
     */
        /** @brief Receiver in active mode */
    constexpr std::uint32_t LPUART_ISR_disabled_RWU_B_0x0 = 0;
        /** @brief Receiver in Mute mode */
    constexpr std::uint32_t LPUART_ISR_disabled_RWU_B_0x1 = 1;

    /** @brief Wakeup from low-power mode flag This bit is set by hardware, when a wakeup event is detected. The event is defined by the WUS bitfield. It is cleared by software, writing a 1 to the WUCF in the USART_ICR register. An interrupt is generated if WUFIE=1 in the USART_CR3 register. Note: When UESM is cleared, WUF flag is also cleared. If the USART does not support the wakeup from Stop feature, this bit is reserved and kept at reset value. Refer to . */
    using LPUART_ISR_disabled_WUF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Transmit enable acknowledge flag This bit is set/reset by hardware, when the Transmit Enable value is taken into account by the USART. It can be used when an idle frame request is generated by writing TE=0, followed by TE=1 in the USART_CR1 register, in order to respect the TE=0 minimum period. */
    using LPUART_ISR_disabled_TEACK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Receive enable acknowledge flag This bit is set/reset by hardware, when the Receive Enable value is taken into account by the USART. It can be used to verify that the USART is ready for reception before entering low-power mode. Note: If the USART does not support the wakeup from Stop feature, this bit is reserved and kept at reset value. Refer to . */
    using LPUART_ISR_disabled_REACK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Transmission complete before guard time flag This bit is set when the last data written in the USART_TDR has been transmitted correctly out of the shift register. It is set by hardware in Smartcard mode, if the transmission of a frame containing data is complete and if the smartcard did not send back any NACK. An interrupt is generated if TCBGTIE=1 in the USART_CR3 register. This bit is cleared by software, by writing 1 to the TCBGTCF in the USART_ICR register or by a write to the USART_TDR register. Note: If the USART does not support the Smartcard mode, this bit is reserved and kept at reset value. If the USART supports the Smartcard mode and the Smartcard mode is enabled, the TCBGT reset value is '1'. Refer to on page877. */
    using LPUART_ISR_disabled_TCBGT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Transmission is not complete or transmission is complete unsuccessfully (i.e. a NACK is received from the card) (value: 0)
     *          - B_0x1: Transmission is complete successfully (before Guard time completion and there is no NACK from the smart card). (value: 1)
     */
        /** @brief Transmission is not complete or transmission is complete unsuccessfully (i.e. a NACK is received from the card) */
    constexpr std::uint32_t LPUART_ISR_disabled_TCBGT_B_0x0 = 0;
        /** @brief Transmission is complete successfully (before Guard time completion and there is no NACK from the smart card). */
    constexpr std::uint32_t LPUART_ISR_disabled_TCBGT_B_0x1 = 1;
    ...
    /** @brief Wakeup from low-power mode clear flag Writing 1 to this bit clears the WUF flag in the LPUART_ISR register. Note: If the LPUART does not support the wakeup from Stop feature, this bit is reserved and kept at reset value. Refer to . */
    ...
    /** @brief Receive data value Contains the received data character. The RDR register provides the parallel interface between the input shift register and the internal bus (see ). When receiving with the parity enabled, the value read in the MSB bit is the received parity bit. */
    ...
    /** @brief Clock prescaler The LPUART input clock can be divided by a prescaler: Remaining combinations: Reserved. Note: When PRESCALER is programmed with a value different of the allowed ones, programmed prescaler value is 1011 i.e. input clock divided by 256. */
