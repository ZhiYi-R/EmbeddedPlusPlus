...
#ifndef EMBEDDED_PP_STM32G061_RTC_HPP
#define EMBEDDED_PP_STM32G061_RTC_HPP
...
namespace STM32G061::RTC {
    ...
    /** @brief Initialization status flag This bit is set by hardware when the calendar year field is different from 0 (RTC domain reset state). */
    ...
    /** @brief RTC_OUT2 output enable Setting this bit allows to remap the RTC outputs on RTC_OUT2 */
