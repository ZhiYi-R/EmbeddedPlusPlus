...
#ifndef EMBEDDED_PP_STM32G061_TAMP_HPP
#define EMBEDDED_PP_STM32G061_TAMP_HPP
...
namespace STM32G061::TAMP {
    ...
    /** @details Possible values:
     *          - B_0x0: If TAMPFLT input staying low triggers a tamper detection event. (value: 0)
     *          - B_0x1: If TAMPFLT Tamper 1 input staying high triggers a tamper detection event. (value: 1)
     */
        /** @brief If TAMPFLT input staying low triggers a tamper detection event. */
    constexpr std::uint32_t TAMP_CR2_TAMP1TRG_B_0x0 = 0;
        /** @brief If TAMPFLT Tamper 1 input staying high triggers a tamper detection event. */
    ...
    /** @details Possible values:
     *          - B_0x0: If TAMPFLT Tamper 2 input staying low triggers a tamper detection event. (value: 0)
     *          - B_0x1: If TAMPFLT Tamper 2 input staying high triggers a tamper detection event. (value: 1)
     */
        /** @brief If TAMPFLT Tamper 2 input staying low triggers a tamper detection event. */
    constexpr std::uint32_t TAMP_CR2_TAMP2TRG_B_0x0 = 0;
        /** @brief If TAMPFLT Tamper 2 input staying high triggers a tamper detection event. */
