...
#ifndef EMBEDDED_PP_STM32G061_USART1_HPP
#define EMBEDDED_PP_STM32G061_USART1_HPP
...
namespace STM32G061::USART1 {

    /** @brief Control register 1 */
    using CR1_FIFO_ENABLED = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CR1_FIFO_ENABLED_UE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    constexpr std::uint32_t CR1_FIFO_ENABLED_UE_B_0x0 = 0;
        /** @brief USART enabled */
    constexpr std::uint32_t CR1_FIFO_ENABLED_UE_B_0x1 = 1;
    ...
    using CR1_FIFO_ENABLED_UESM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t CR1_FIFO_ENABLED_UESM_B_0x0 = 0;
        /** @brief USART able to wake up the MCU from low-power mode. */
    constexpr std::uint32_t CR1_FIFO_ENABLED_UESM_B_0x1 = 1;

    /** @brief Receiver enable This bit enables the receiver. It is set and cleared by software. */
    using CR1_FIFO_ENABLED_RE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t CR1_FIFO_ENABLED_RE_B_0x0 = 0;
        /** @brief Receiver is enabled and begins searching for a start bit */
    constexpr std::uint32_t CR1_FIFO_ENABLED_RE_B_0x1 = 1;
    ...
    using CR1_FIFO_ENABLED_TE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Transmitter is disabled (value: 0)
     *          - B_0x1: Transmitter is enabled (value: 1)
     */
        /** @brief Transmitter is disabled */
    constexpr std::uint32_t CR1_FIFO_ENABLED_TE_B_0x0 = 0;
        /** @brief Transmitter is enabled */
    constexpr std::uint32_t CR1_FIFO_ENABLED_TE_B_0x1 = 1;

    /** @brief IDLE interrupt enable This bit is set and cleared by software. */
    using CR1_FIFO_ENABLED_IDLEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t CR1_FIFO_ENABLED_IDLEIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever IDLE = 1 in the USART_ISR register */
    constexpr std::uint32_t CR1_FIFO_ENABLED_IDLEIE_B_0x1 = 1;

    /** @brief RXFIFO not empty interrupt enable This bit is set and cleared by software. */
    using CR1_FIFO_ENABLED_RXFNEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever ORE = 1 or RXFNE = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR1_FIFO_ENABLED_RXFNEIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever ORE = 1 or RXFNE = 1 in the USART_ISR register */
    constexpr std::uint32_t CR1_FIFO_ENABLED_RXFNEIE_B_0x1 = 1;

    /** @brief Transmission complete interrupt enable This bit is set and cleared by software. */
    using CR1_FIFO_ENABLED_TCIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever TC = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR1_FIFO_ENABLED_TCIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever TC = 1 in the USART_ISR register */
    constexpr std::uint32_t CR1_FIFO_ENABLED_TCIE_B_0x1 = 1;

    /** @brief TXFIFO not full interrupt enable This bit is set and cleared by software. */
    using CR1_FIFO_ENABLED_TXFNFIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever TXFNF =1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR1_FIFO_ENABLED_TXFNFIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever TXFNF =1 in the USART_ISR register */
    constexpr std::uint32_t CR1_FIFO_ENABLED_TXFNFIE_B_0x1 = 1;

    /** @brief PE interrupt enable This bit is set and cleared by software. */
    using CR1_FIFO_ENABLED_PEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever PE = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR1_FIFO_ENABLED_PEIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever PE = 1 in the USART_ISR register */
    constexpr std::uint32_t CR1_FIFO_ENABLED_PEIE_B_0x1 = 1;
    ...
    using CR1_FIFO_ENABLED_PS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Even parity (value: 0)
     *          - B_0x1: Odd parity (value: 1)
     */
        /** @brief Even parity */
    constexpr std::uint32_t CR1_FIFO_ENABLED_PS_B_0x0 = 0;
        /** @brief Odd parity */
    constexpr std::uint32_t CR1_FIFO_ENABLED_PS_B_0x1 = 1;
    ...
    using CR1_FIFO_ENABLED_PCE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Parity control disabled (value: 0)
     *          - B_0x1: Parity control enabled (value: 1)
     */
        /** @brief Parity control disabled */
    constexpr std::uint32_t CR1_FIFO_ENABLED_PCE_B_0x0 = 0;
        /** @brief Parity control enabled */
    constexpr std::uint32_t CR1_FIFO_ENABLED_PCE_B_0x1 = 1;
    ...
    using CR1_FIFO_ENABLED_WAKE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Idle line (value: 0)
     *          - B_0x1: Address mark (value: 1)
     */
        /** @brief Idle line */
    constexpr std::uint32_t CR1_FIFO_ENABLED_WAKE_B_0x0 = 0;
        /** @brief Address mark */
    constexpr std::uint32_t CR1_FIFO_ENABLED_WAKE_B_0x1 = 1;
    ...
    using CR1_FIFO_ENABLED_M0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CR1_FIFO_ENABLED_MME = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t CR1_FIFO_ENABLED_MME_B_0x0 = 0;
        /** @brief Receiver can switch between Mute mode and active mode. */
    constexpr std::uint32_t CR1_FIFO_ENABLED_MME_B_0x1 = 1;

    /** @brief Character match interrupt enable This bit is set and cleared by software. */
    using CR1_FIFO_ENABLED_CMIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated when the CMF bit is set in the USART_ISR register. (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR1_FIFO_ENABLED_CMIE_B_0x0 = 0;
        /** @brief USART interrupt generated when the CMF bit is set in the USART_ISR register. */
    constexpr std::uint32_t CR1_FIFO_ENABLED_CMIE_B_0x1 = 1;
    ...
    using CR1_FIFO_ENABLED_OVER8 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Oversampling by 16 (value: 0)
     *          - B_0x1: Oversampling by 8 (value: 1)
     */
        /** @brief Oversampling by 16 */
    constexpr std::uint32_t CR1_FIFO_ENABLED_OVER8_B_0x0 = 0;
        /** @brief Oversampling by 8 */
    constexpr std::uint32_t CR1_FIFO_ENABLED_OVER8_B_0x1 = 1;
    ...
    using CR1_FIFO_ENABLED_DEDT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CR1_FIFO_ENABLED_DEAT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Receiver timeout interrupt enable This bit is set and cleared by software. Note: If the USART does not support the Receiver timeout feature, this bit is reserved and must be kept at reset value. . */
    using CR1_FIFO_ENABLED_RTOIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated when the RTOF bit is set in the USART_ISR register. (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR1_FIFO_ENABLED_RTOIE_B_0x0 = 0;
        /** @brief USART interrupt generated when the RTOF bit is set in the USART_ISR register. */
    constexpr std::uint32_t CR1_FIFO_ENABLED_RTOIE_B_0x1 = 1;

    /** @brief End of Block interrupt enable This bit is set and cleared by software. Note: If the USART does not support Smartcard mode, this bit is reserved and must be kept at reset value. Refer to . */
    using CR1_FIFO_ENABLED_EOBIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated when the EOBF flag is set in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR1_FIFO_ENABLED_EOBIE_B_0x0 = 0;
        /** @brief USART interrupt generated when the EOBF flag is set in the USART_ISR register */
    constexpr std::uint32_t CR1_FIFO_ENABLED_EOBIE_B_0x1 = 1;
    ...
    using CR1_FIFO_ENABLED_M1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CR1_FIFO_ENABLED_FIFOEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: FIFO mode is disabled. (value: 0)
     *          - B_0x1: FIFO mode is enabled. (value: 1)
     */
        /** @brief FIFO mode is disabled. */
    constexpr std::uint32_t CR1_FIFO_ENABLED_FIFOEN_B_0x0 = 0;
        /** @brief FIFO mode is enabled. */
    constexpr std::uint32_t CR1_FIFO_ENABLED_FIFOEN_B_0x1 = 1;

    /** @brief TXFIFO empty interrupt enable This bit is set and cleared by software. */
    using CR1_FIFO_ENABLED_TXFEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated when TXFE = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR1_FIFO_ENABLED_TXFEIE_B_0x0 = 0;
        /** @brief USART interrupt generated when TXFE = 1 in the USART_ISR register */
    constexpr std::uint32_t CR1_FIFO_ENABLED_TXFEIE_B_0x1 = 1;

    /** @brief RXFIFO Full interrupt enable This bit is set and cleared by software. */
    using CR1_FIFO_ENABLED_RXFFIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated when RXFF = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR1_FIFO_ENABLED_RXFFIE_B_0x0 = 0;
        /** @brief USART interrupt generated when RXFF = 1 in the USART_ISR register */
    constexpr std::uint32_t CR1_FIFO_ENABLED_RXFFIE_B_0x1 = 1;

    /** @brief Control register 1 */
    using CR1_FIFO_DISABLED = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USART enable When this bit is cleared, the USART prescalers and outputs are stopped immediately, and all current operations are discarded. The USART configuration is kept, but all the USART_ISR status flags are reset. This bit is set and cleared by software. Note: To enter low-power mode without generating errors on the line, the TE bit must be previously reset and the software must wait for the TC bit in the USART_ISR to be set before resetting the UE bit. The DMA requests are also reset when UE = 0 so the DMA channel must be disabled before resetting the UE bit. In Smartcard mode, (SCEN = 1), the SCLK is always available when CLKEN = 1, regardless of the UE bit value. */
    using CR1_FIFO_DISABLED_UE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: USART prescaler and outputs disabled, low-power mode (value: 0)
     *          - B_0x1: USART enabled (value: 1)
     */
        /** @brief USART prescaler and outputs disabled, low-power mode */
    constexpr std::uint32_t CR1_FIFO_DISABLED_UE_B_0x0 = 0;
        /** @brief USART enabled */
    constexpr std::uint32_t CR1_FIFO_DISABLED_UE_B_0x1 = 1;

    /** @brief USART enable in low-power mode When this bit is cleared, the USART cannot wake up the MCU from low-power mode. When this bit is set, the USART can wake up the MCU from low-power mode. This bit is set and cleared by software. Note: It is recommended to set the UESM bit just before entering low-power mode and clear it when exit from low-power mode. If the USART does not support the wakeup from Stop feature, this bit is reserved and must be kept at reset value. Refer to . */
    using CR1_FIFO_DISABLED_UESM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: USART not able to wake up the MCU from low-power mode. (value: 0)
     *          - B_0x1: USART able to wake up the MCU from low-power mode. (value: 1)
     */
        /** @brief USART not able to wake up the MCU from low-power mode. */
    constexpr std::uint32_t CR1_FIFO_DISABLED_UESM_B_0x0 = 0;
        /** @brief USART able to wake up the MCU from low-power mode. */
    constexpr std::uint32_t CR1_FIFO_DISABLED_UESM_B_0x1 = 1;

    /** @brief Receiver enable This bit enables the receiver. It is set and cleared by software. */
    using CR1_FIFO_DISABLED_RE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Receiver is disabled (value: 0)
     *          - B_0x1: Receiver is enabled and begins searching for a start bit (value: 1)
     */
        /** @brief Receiver is disabled */
    constexpr std::uint32_t CR1_FIFO_DISABLED_RE_B_0x0 = 0;
        /** @brief Receiver is enabled and begins searching for a start bit */
    constexpr std::uint32_t CR1_FIFO_DISABLED_RE_B_0x1 = 1;

    /** @brief Transmitter enable This bit enables the transmitter. It is set and cleared by software. Note: During transmission, a low pulse on the TE bit ('0' followed by '1') sends a preamble (idle line) after the current word, except in Smartcard mode. In order to generate an idle character, the TE must not be immediately written to '1'. To ensure the required duration, the software can poll the TEACK bit in the USART_ISR register. In Smartcard mode, when TE is set, there is a 1 bit-time delay before the transmission starts. */
    using CR1_FIFO_DISABLED_TE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Transmitter is disabled (value: 0)
     *          - B_0x1: Transmitter is enabled (value: 1)
     */
        /** @brief Transmitter is disabled */
    constexpr std::uint32_t CR1_FIFO_DISABLED_TE_B_0x0 = 0;
        /** @brief Transmitter is enabled */
    constexpr std::uint32_t CR1_FIFO_DISABLED_TE_B_0x1 = 1;

    /** @brief IDLE interrupt enable This bit is set and cleared by software. */
    using CR1_FIFO_DISABLED_IDLEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever IDLE = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR1_FIFO_DISABLED_IDLEIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever IDLE = 1 in the USART_ISR register */
    constexpr std::uint32_t CR1_FIFO_DISABLED_IDLEIE_B_0x1 = 1;

    /** @brief Receive data register not empty This bit is set and cleared by software. */
    using CR1_FIFO_DISABLED_RXNEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever ORE = 1 or RXNE = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR1_FIFO_DISABLED_RXNEIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever ORE = 1 or RXNE = 1 in the USART_ISR register */
    constexpr std::uint32_t CR1_FIFO_DISABLED_RXNEIE_B_0x1 = 1;

    /** @brief Transmission complete interrupt enable This bit is set and cleared by software. */
    using CR1_FIFO_DISABLED_TCIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever TC = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR1_FIFO_DISABLED_TCIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever TC = 1 in the USART_ISR register */
    constexpr std::uint32_t CR1_FIFO_DISABLED_TCIE_B_0x1 = 1;

    /** @brief Transmit data register empty This bit is set and cleared by software. */
    using CR1_FIFO_DISABLED_TXEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever TXE =1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR1_FIFO_DISABLED_TXEIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever TXE =1 in the USART_ISR register */
    constexpr std::uint32_t CR1_FIFO_DISABLED_TXEIE_B_0x1 = 1;

    /** @brief PE interrupt enable This bit is set and cleared by software. */
    using CR1_FIFO_DISABLED_PEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever PE = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR1_FIFO_DISABLED_PEIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever PE = 1 in the USART_ISR register */
    constexpr std::uint32_t CR1_FIFO_DISABLED_PEIE_B_0x1 = 1;

    /** @brief Parity selection This bit selects the odd or even parity when the parity generation/detection is enabled (PCE bit set). It is set and cleared by software. The parity is selected after the current byte. This bitfield can only be written when the USART is disabled (UE=0). */
    using CR1_FIFO_DISABLED_PS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Even parity (value: 0)
     *          - B_0x1: Odd parity (value: 1)
     */
        /** @brief Even parity */
    constexpr std::uint32_t CR1_FIFO_DISABLED_PS_B_0x0 = 0;
        /** @brief Odd parity */
    constexpr std::uint32_t CR1_FIFO_DISABLED_PS_B_0x1 = 1;

    /** @brief Parity control enable This bit selects the hardware parity control (generation and detection). When the parity control is enabled, the computed parity is inserted at the MSB position (9th bit if M=1; 8th bit if M=0) and the parity is checked on the received data. This bit is set and cleared by software. Once it is set, PCE is active after the current byte (in reception and in transmission). This bitfield can only be written when the USART is disabled (UE=0). */
    using CR1_FIFO_DISABLED_PCE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Parity control disabled (value: 0)
     *          - B_0x1: Parity control enabled (value: 1)
     */
        /** @brief Parity control disabled */
    constexpr std::uint32_t CR1_FIFO_DISABLED_PCE_B_0x0 = 0;
        /** @brief Parity control enabled */
    constexpr std::uint32_t CR1_FIFO_DISABLED_PCE_B_0x1 = 1;

    /** @brief Receiver wakeup method This bit determines the USART wakeup method from Mute mode. It is set or cleared by software. This bitfield can only be written when the USART is disabled (UE=0). */
    using CR1_FIFO_DISABLED_WAKE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Idle line (value: 0)
     *          - B_0x1: Address mark (value: 1)
     */
        /** @brief Idle line */
    constexpr std::uint32_t CR1_FIFO_DISABLED_WAKE_B_0x0 = 0;
        /** @brief Address mark */
    constexpr std::uint32_t CR1_FIFO_DISABLED_WAKE_B_0x1 = 1;

    /** @brief Word length This bit is used in conjunction with bit 28 (M1) to determine the word length. It is set or cleared by software (refer to bit 28 (M1)description). This bit can only be written when the USART is disabled (UE=0). */
    using CR1_FIFO_DISABLED_M0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Mute mode enable This bit enables the USART Mute mode function. When set, the USART can switch between active and Mute mode, as defined by the WAKE bit. It is set and cleared by software. */
    using CR1_FIFO_DISABLED_MME = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Receiver in active mode permanently (value: 0)
     *          - B_0x1: Receiver can switch between Mute mode and active mode. (value: 1)
     */
        /** @brief Receiver in active mode permanently */
    constexpr std::uint32_t CR1_FIFO_DISABLED_MME_B_0x0 = 0;
        /** @brief Receiver can switch between Mute mode and active mode. */
    constexpr std::uint32_t CR1_FIFO_DISABLED_MME_B_0x1 = 1;

    /** @brief Character match interrupt enable This bit is set and cleared by software. */
    using CR1_FIFO_DISABLED_CMIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated when the CMF bit is set in the USART_ISR register. (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR1_FIFO_DISABLED_CMIE_B_0x0 = 0;
        /** @brief USART interrupt generated when the CMF bit is set in the USART_ISR register. */
    constexpr std::uint32_t CR1_FIFO_DISABLED_CMIE_B_0x1 = 1;

    /** @brief Oversampling mode This bit can only be written when the USART is disabled (UE=0). Note: In LIN, IrDA and Smartcard modes, this bit must be kept cleared. */
    using CR1_FIFO_DISABLED_OVER8 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Oversampling by 16 (value: 0)
     *          - B_0x1: Oversampling by 8 (value: 1)
     */
        /** @brief Oversampling by 16 */
    constexpr std::uint32_t CR1_FIFO_DISABLED_OVER8_B_0x0 = 0;
        /** @brief Oversampling by 8 */
    constexpr std::uint32_t CR1_FIFO_DISABLED_OVER8_B_0x1 = 1;

    /** @brief Driver Enable deassertion time This 5-bit value defines the time between the end of the last stop bit, in a transmitted message, and the de-activation of the DE (Driver Enable) signal. It is expressed in sample time units (1/8 or 1/16 bit time, depending on the oversampling rate). If the USART_TDR register is written during the DEDT time, the new data is transmitted only when the DEDT and DEAT times have both elapsed. This bitfield can only be written when the USART is disabled (UE=0). Note: If the Driver Enable feature is not supported, this bit is reserved and must be kept at reset value. Refer to . */
    using CR1_FIFO_DISABLED_DEDT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Driver Enable assertion time This 5-bit value defines the time between the activation of the DE (Driver Enable) signal and the beginning of the start bit. It is expressed in sample time units (1/8 or 1/16 bit time, depending on the oversampling rate). This bitfield can only be written when the USART is disabled (UE=0). Note: If the Driver Enable feature is not supported, this bit is reserved and must be kept at reset value. Refer to . */
    using CR1_FIFO_DISABLED_DEAT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Receiver timeout interrupt enable This bit is set and cleared by software. Note: If the USART does not support the Receiver timeout feature, this bit is reserved and must be kept at reset value. . */
    using CR1_FIFO_DISABLED_RTOIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated when the RTOF bit is set in the USART_ISR register. (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR1_FIFO_DISABLED_RTOIE_B_0x0 = 0;
        /** @brief USART interrupt generated when the RTOF bit is set in the USART_ISR register. */
    constexpr std::uint32_t CR1_FIFO_DISABLED_RTOIE_B_0x1 = 1;

    /** @brief End of Block interrupt enable This bit is set and cleared by software. Note: If the USART does not support Smartcard mode, this bit is reserved and must be kept at reset value. Refer to . */
    using CR1_FIFO_DISABLED_EOBIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated when the EOBF flag is set in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR1_FIFO_DISABLED_EOBIE_B_0x0 = 0;
        /** @brief USART interrupt generated when the EOBF flag is set in the USART_ISR register */
    constexpr std::uint32_t CR1_FIFO_DISABLED_EOBIE_B_0x1 = 1;

    /** @brief Word length This bit must be used in conjunction with bit 12 (M0) to determine the word length. It is set or cleared by software. M[1:0] = '00': 1 start bit, 8 Data bits, n Stop bit M[1:0] = '01': 1 start bit, 9 Data bits, n Stop bit M[1:0] = '10': 1 start bit, 7 Data bits, n Stop bit This bit can only be written when the USART is disabled (UE=0). Note: In 7-bits data length mode, the Smartcard mode, LIN master mode and Auto baud rate (0x7F and 0x55 frames detection) are not supported. */
    using CR1_FIFO_DISABLED_M1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FIFO mode enable This bit is set and cleared by software. This bitfield can only be written when the USART is disabled (UE=0). Note: FIFO mode can be used on standard UART communication, in SPI master/slave mode and in Smartcard modes only. It must not be enabled in IrDA and LIN modes. */
    using CR1_FIFO_DISABLED_FIFOEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: FIFO mode is disabled. (value: 0)
     *          - B_0x1: FIFO mode is enabled. (value: 1)
     */
        /** @brief FIFO mode is disabled. */
    constexpr std::uint32_t CR1_FIFO_DISABLED_FIFOEN_B_0x0 = 0;
        /** @brief FIFO mode is enabled. */
    constexpr std::uint32_t CR1_FIFO_DISABLED_FIFOEN_B_0x1 = 1;

    /** @brief Control register 2 */
    using CR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Synchronous Slave mode enable When the SLVEN bit is set, the synchronous slave mode is enabled. Note: When SPI slave mode is not supported, this bit is reserved and must be kept at reset value. Refer to . */
    ...
    constexpr std::uint32_t CR2_SLVEN_B_0x0 = 0;
        /** @brief Slave mode enabled. */
    constexpr std::uint32_t CR2_SLVEN_B_0x1 = 1;

    /** @brief When the DIS_NSS bit is set, the NSS pin input is ignored. Note: When SPI slave mode is not supported, this bit is reserved and must be kept at reset value. Refer to . */
    ...
    constexpr std::uint32_t CR2_DIS_NSS_B_0x0 = 0;
        /** @brief SPI slave is always selected and NSS input pin is ignored. */
    constexpr std::uint32_t CR2_DIS_NSS_B_0x1 = 1;
    ...
    constexpr std::uint32_t CR2_ADDM7_B_0x0 = 0;
        /** @brief 7-bit address detection (in 8-bit data mode) */
    constexpr std::uint32_t CR2_ADDM7_B_0x1 = 1;

    /** @brief LIN break detection length This bit is for selection between 11 bit or 10 bit break detection. This bit can only be written when the USART is disabled (UE=0). Note: If LIN mode is not supported, this bit is reserved and must be kept at reset value. Refer to . */
    ...
    constexpr std::uint32_t CR2_LBDL_B_0x0 = 0;
        /** @brief 11-bit break detection */
    constexpr std::uint32_t CR2_LBDL_B_0x1 = 1;

    /** @brief LIN break detection interrupt enable Break interrupt mask (break detection using break delimiter). Note: If LIN mode is not supported, this bit is reserved and must be kept at reset value. Refer to . */
    ...
    constexpr std::uint32_t CR2_LBDIE_B_0x0 = 0;
        /** @brief An interrupt is generated whenever LBDF = 1 in the USART_ISR register */
    constexpr std::uint32_t CR2_LBDIE_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: The clock pulse of the last data bit is not output to the SCLK pin (value: 0)
     *          - B_0x1: The clock pulse of the last data bit is output to the SCLK pin (value: 1)
     */
        /** @brief The clock pulse of the last data bit is not output to the SCLK pin */
    constexpr std::uint32_t CR2_LBCL_B_0x0 = 0;
        /** @brief The clock pulse of the last data bit is output to the SCLK pin */
    constexpr std::uint32_t CR2_LBCL_B_0x1 = 1;
    ...
    constexpr std::uint32_t CR2_CPHA_B_0x0 = 0;
        /** @brief The second clock transition is the first data capture edge */
    constexpr std::uint32_t CR2_CPHA_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: Steady low value on SCLK pin outside transmission window (value: 0)
     *          - B_0x1: Steady high value on SCLK pin outside transmission window (value: 1)
     */
        /** @brief Steady low value on SCLK pin outside transmission window */
    constexpr std::uint32_t CR2_CPOL_B_0x0 = 0;
        /** @brief Steady high value on SCLK pin outside transmission window */
    constexpr std::uint32_t CR2_CPOL_B_0x1 = 1;

    /** @brief Clock enable This bit enables the user to enable the SCLK pin. This bit can only be written when the USART is disabled (UE=0). Note: If neither synchronous mode nor Smartcard mode is supported, this bit is reserved and must be kept at reset value. Refer to . In Smartcard mode, in order to provide correctly the SCLK clock to the smartcard, the steps below must be respected: UE = 0 SCEN = 1 GTPR configuration CLKEN= 1 UE = 1 */
    using CR2_CLKEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: SCLK pin disabled (value: 0)
     *          - B_0x1: SCLK pin enabled (value: 1)
     */
        /** @brief SCLK pin disabled */
    constexpr std::uint32_t CR2_CLKEN_B_0x0 = 0;
        /** @brief SCLK pin enabled */
    constexpr std::uint32_t CR2_CLKEN_B_0x1 = 1;
     ...
     */
        /** @brief 1 stop bit */
    constexpr std::uint32_t CR2_STOP_B_0x0 = 0;
        /** @brief 0.5 stop bit. */
    constexpr std::uint32_t CR2_STOP_B_0x1 = 1;
        /** @brief 2 stop bits */
    constexpr std::uint32_t CR2_STOP_B_0x2 = 2;
        /** @brief 1.5 stop bits */
    constexpr std::uint32_t CR2_STOP_B_0x3 = 3;
    ...
    constexpr std::uint32_t CR2_LINEN_B_0x0 = 0;
        /** @brief LIN mode enabled */
    constexpr std::uint32_t CR2_LINEN_B_0x1 = 1;
    ...
    constexpr std::uint32_t CR2_SWAP_B_0x0 = 0;
    ...
    constexpr std::uint32_t CR2_SWAP_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: RX pin signal works using the standard logic levels (VDD =1/idle, Gnd = 0/mark) (value: 0)
     *          - B_0x1: RX pin signal values are inverted (VDD =0/mark, Gnd = 1/idle). (value: 1)
     */
        /** @brief RX pin signal works using the standard logic levels (VDD =1/idle, Gnd = 0/mark) */
    constexpr std::uint32_t CR2_RXINV_B_0x0 = 0;
        /** @brief RX pin signal values are inverted (VDD =0/mark, Gnd = 1/idle). */
    constexpr std::uint32_t CR2_RXINV_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: TX pin signal works using the standard logic levels (VDD =1/idle, Gnd = 0/mark) (value: 0)
     *          - B_0x1: TX pin signal values are inverted (VDD =0/mark, Gnd = 1/idle). (value: 1)
     */
        /** @brief TX pin signal works using the standard logic levels (VDD =1/idle, Gnd = 0/mark) */
    constexpr std::uint32_t CR2_TXINV_B_0x0 = 0;
        /** @brief TX pin signal values are inverted (VDD =0/mark, Gnd = 1/idle). */
    constexpr std::uint32_t CR2_TXINV_B_0x1 = 1;
    ...
    constexpr std::uint32_t CR2_DATAINV_B_0x0 = 0;
    ...
    constexpr std::uint32_t CR2_DATAINV_B_0x1 = 1;
    ...
    constexpr std::uint32_t CR2_MSBFIRST_B_0x0 = 0;
        /** @brief data is transmitted/received with the MSB (bit 7/8) first, following the start bit. */
    constexpr std::uint32_t CR2_MSBFIRST_B_0x1 = 1;

    /** @brief Auto baud rate enable This bit is set and cleared by software. Note: If the USART does not support the auto baud rate feature, this bit is reserved and must be kept at reset value. Refer to . */
    ...
    constexpr std::uint32_t CR2_ABREN_B_0x0 = 0;
        /** @brief Auto baud rate detection is enabled. */
    constexpr std::uint32_t CR2_ABREN_B_0x1 = 1;
     ...
     *          - B_0x1: Falling edge to falling edge measurement (the received frame must start with a single bit = 1 and Frame = Start10xxxxxx) (value: 1)
    ...
    constexpr std::uint32_t CR2_ABRMOD_B_0x0 = 0;
        /** @brief Falling edge to falling edge measurement (the received frame must start with a single bit = 1 and Frame = Start10xxxxxx) */
    constexpr std::uint32_t CR2_ABRMOD_B_0x1 = 1;
        /** @brief 0x7F frame detection. */
    constexpr std::uint32_t CR2_ABRMOD_B_0x2 = 2;
        /** @brief 0x55 frame detection */
    constexpr std::uint32_t CR2_ABRMOD_B_0x3 = 3;
    ...
    /** @brief Error interrupt enable Error Interrupt Enable Bit is required to enable interrupt generation in case of a framing error, overrun error noise flag or SPI slave underrun error (FE=1 or ORE=1 or NE=1 or UDR = 1 in the USART_ISR register). */
     ...
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR3_EIE_B_0x0 = 0;
        /** @brief interrupt generated when FE = 1 or ORE = 1 or NE = 1 or UDR = 1 (in SPI slave mode) in the USART_ISR register. */
    constexpr std::uint32_t CR3_EIE_B_0x1 = 1;

    /** @brief IrDA mode enable This bit is set and cleared by software. This bit can only be written when the USART is disabled (UE=0). Note: If IrDA mode is not supported, this bit is reserved and must be kept at reset value. Refer to . */
     ...
     */
        /** @brief IrDA disabled */
    constexpr std::uint32_t CR3_IREN_B_0x0 = 0;
        /** @brief IrDA enabled */
    constexpr std::uint32_t CR3_IREN_B_0x1 = 1;

    /** @brief IrDA low-power This bit is used for selecting between normal and low-power IrDA modes This bit can only be written when the USART is disabled (UE=0). Note: If IrDA mode is not supported, this bit is reserved and must be kept at reset value. Refer to . */
     ...
     */
        /** @brief Normal mode */
    constexpr std::uint32_t CR3_IRLP_B_0x0 = 0;
        /** @brief Low-power mode */
    constexpr std::uint32_t CR3_IRLP_B_0x1 = 1;
    ...
    constexpr std::uint32_t CR3_HDSEL_B_0x0 = 0;
        /** @brief Half duplex mode is selected */
    constexpr std::uint32_t CR3_HDSEL_B_0x1 = 1;

    /** @brief Smartcard NACK enable This bitfield can only be written when the USART is disabled (UE=0). Note: If the USART does not support Smartcard mode, this bit is reserved and must be kept at reset value. Refer to . */
    ...
    constexpr std::uint32_t CR3_NACK_B_0x0 = 0;
        /** @brief NACK transmission during parity error is enabled */
    constexpr std::uint32_t CR3_NACK_B_0x1 = 1;

    /** @brief Smartcard mode enable This bit is used for enabling Smartcard mode. This bitfield can only be written when the USART is disabled (UE=0). Note: If the USART does not support Smartcard mode, this bit is reserved and must be kept at reset value. Refer to . */
    ...
    constexpr std::uint32_t CR3_SCEN_B_0x0 = 0;
        /** @brief Smartcard Mode enabled */
    constexpr std::uint32_t CR3_SCEN_B_0x1 = 1;
    ...
    constexpr std::uint32_t CR3_DMAR_B_0x1 = 1;
        /** @brief DMA mode is disabled for reception */
    constexpr std::uint32_t CR3_DMAR_B_0x0 = 0;
    ...
    constexpr std::uint32_t CR3_DMAT_B_0x1 = 1;
        /** @brief DMA mode is disabled for transmission */
    constexpr std::uint32_t CR3_DMAT_B_0x0 = 0;

    /** @brief RTS enable This bit can only be written when the USART is disabled (UE=0). Note: If the hardware flow control feature is not supported, this bit is reserved and must be kept at reset value. Refer to . */
     ...
     *          - B_0x1: RTS output enabled, data is only requested when there is space in the receive buffer. The transmission of data is expected to cease after the current character has been transmitted. The nRTS output is asserted (pulled to 0) when data can be received. (value: 1)
     */
        /** @brief RTS hardware flow control disabled */
    constexpr std::uint32_t CR3_RTSE_B_0x0 = 0;
        /** @brief RTS output enabled, data is only requested when there is space in the receive buffer. The transmission of data is expected to cease after the current character has been transmitted. The nRTS output is asserted (pulled to 0) when data can be received. */
    constexpr std::uint32_t CR3_RTSE_B_0x1 = 1;

    /** @brief CTS enable This bit can only be written when the USART is disabled (UE=0) Note: If the hardware flow control feature is not supported, this bit is reserved and must be kept at reset value. Refer to . */
     ...
     *          - B_0x1: CTS mode enabled, data is only transmitted when the nCTS input is asserted (tied to 0). If the nCTS input is deasserted while data is being transmitted, then the transmission is completed before stopping. If data is written into the data register while nCTS is asserted, the transmission is postponed until nCTS is asserted. (value: 1)
     */
        /** @brief CTS hardware flow control disabled */
    constexpr std::uint32_t CR3_CTSE_B_0x0 = 0;
        /** @brief CTS mode enabled, data is only transmitted when the nCTS input is asserted (tied to 0). If the nCTS input is deasserted while data is being transmitted, then the transmission is completed before stopping. If data is written into the data register while nCTS is asserted, the transmission is postponed until nCTS is asserted. */
    constexpr std::uint32_t CR3_CTSE_B_0x1 = 1;

    /** @brief CTS interrupt enable Note: If the hardware flow control feature is not supported, this bit is reserved and must be kept at reset value. Refer to . */
     ...
     */
        /** @brief Interrupt is inhibited */
    constexpr std::uint32_t CR3_CTSIE_B_0x0 = 0;
        /** @brief An interrupt is generated whenever CTSIF = 1 in the USART_ISR register */
    constexpr std::uint32_t CR3_CTSIE_B_0x1 = 1;
    ...
    constexpr std::uint32_t CR3_ONEBIT_B_0x0 = 0;
        /** @brief One sample bit method */
    constexpr std::uint32_t CR3_ONEBIT_B_0x1 = 1;

    /** @brief Overrun Disable This bit is used to disable the receive overrun detection. the ORE flag is not set and the new received data overwrites the previous content of the USART_RDR register. When FIFO mode is enabled, the RXFIFO is bypassed and data is written directly in USART_RDR register. Even when FIFO management is enabled, the RXNE flag is to be used. This bit can only be written when the USART is disabled (UE=0). Note: This control bit enables checking the communication flow w/o reading the data */
    ...
    constexpr std::uint32_t CR3_DDRE_B_0x0 = 0;
    ...
    constexpr std::uint32_t CR3_DDRE_B_0x1 = 1;

    /** @brief Driver enable mode This bit enables the user to activate the external transceiver control, through the DE signal. This bit can only be written when the USART is disabled (UE=0). Note: If the Driver Enable feature is not supported, this bit is reserved and must be kept at reset value. . */
    ...
    constexpr std::uint32_t CR3_DEM_B_0x0 = 0;
        /** @brief DE function is enabled. The DE signal is output on the RTS pin. */
    constexpr std::uint32_t CR3_DEM_B_0x1 = 1;

    /** @brief Driver enable polarity selection This bit can only be written when the USART is disabled (UE=0). Note: If the Driver Enable feature is not supported, this bit is reserved and must be kept at reset value. Refer to . */
    ...
    constexpr std::uint32_t CR3_DEP_B_0x0 = 0;
        /** @brief DE signal is active low. */
    constexpr std::uint32_t CR3_DEP_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: retransmission disabled - No automatic retransmission in transmit mode. (value: 0)
     *          - B_0x1: number of automatic retransmission attempts (before signaling error) (value: 1)
     *          - B_0x2: number of automatic retransmission attempts (before signaling error) (value: 2)
     *          - B_0x3: number of automatic retransmission attempts (before signaling error) (value: 3)
     *          - B_0x4: number of automatic retransmission attempts (before signaling error) (value: 4)
     *          - B_0x5: number of automatic retransmission attempts (before signaling error) (value: 5)
     *          - B_0x6: number of automatic retransmission attempts (before signaling error) (value: 6)
     *          - B_0x7: number of automatic retransmission attempts (before signaling error) (value: 7)
     */
        /** @brief retransmission disabled - No automatic retransmission in transmit mode. */
    constexpr std::uint32_t CR3_SCARCNT_B_0x0 = 0;
        /** @brief number of automatic retransmission attempts (before signaling error) */
    constexpr std::uint32_t CR3_SCARCNT_B_0x1 = 1;
        /** @brief number of automatic retransmission attempts (before signaling error) */
    constexpr std::uint32_t CR3_SCARCNT_B_0x2 = 2;
        /** @brief number of automatic retransmission attempts (before signaling error) */
    constexpr std::uint32_t CR3_SCARCNT_B_0x3 = 3;
        /** @brief number of automatic retransmission attempts (before signaling error) */
    constexpr std::uint32_t CR3_SCARCNT_B_0x4 = 4;
        /** @brief number of automatic retransmission attempts (before signaling error) */
    constexpr std::uint32_t CR3_SCARCNT_B_0x5 = 5;
        /** @brief number of automatic retransmission attempts (before signaling error) */
    constexpr std::uint32_t CR3_SCARCNT_B_0x6 = 6;
        /** @brief number of automatic retransmission attempts (before signaling error) */
    constexpr std::uint32_t CR3_SCARCNT_B_0x7 = 7;
    ...
    using CR3_WUS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: WUF active on address match (as defined by ADD[7:0] and ADDM7) (value: 0)
     *          - B_0x2: WUF active on start bit detection (value: 2)
     *          - B_0x3: WUF active on RXNE/RXFNE. (value: 3)
     */
        /** @brief WUF active on address match (as defined by ADD[7:0] and ADDM7) */
    constexpr std::uint32_t CR3_WUS_B_0x0 = 0;
        /** @brief WUF active on start bit detection */
    constexpr std::uint32_t CR3_WUS_B_0x2 = 2;
        /** @brief WUF active on RXNE/RXFNE. */
    constexpr std::uint32_t CR3_WUS_B_0x3 = 3;

    /** @brief Wakeup from low-power mode interrupt enable This bit is set and cleared by software. Note: WUFIE must be set before entering in low-power mode. If the USART does not support the wakeup from Stop feature, this bit is reserved and must be kept at reset value. Refer to page835. */
    using CR3_WUFIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever WUF = 1 in the USART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR3_WUFIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever WUF = 1 in the USART_ISR register */
    constexpr std::uint32_t CR3_WUFIE_B_0x1 = 1;
     ...
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR3_TXFTIE_B_0x0 = 0;
        /** @brief USART interrupt generated when TXFIFO reaches the threshold programmed in TXFTCFG. */
    constexpr std::uint32_t CR3_TXFTIE_B_0x1 = 1;

    /** @brief Transmission Complete before guard time, interrupt enable This bit is set and cleared by software. Note: If the USART does not support the Smartcard mode, this bit is reserved and must be kept at reset value. Refer to . */
     ...
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t CR3_TCBGTIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever TCBGT=1 in the USART_ISR register */
    constexpr std::uint32_t CR3_TCBGTIE_B_0x1 = 1;
    ...
    constexpr std::uint32_t CR3_RXFTCFG_B_0x0 = 0;
        /** @brief Receive FIFO reaches 1/4 of its depth */
    constexpr std::uint32_t CR3_RXFTCFG_B_0x1 = 1;
        /** @brief Receive FIFO reaches 1/2 of its depth */
    constexpr std::uint32_t CR3_RXFTCFG_B_0x2 = 2;
        /** @brief Receive FIFO reaches 3/4 of its depth */
    constexpr std::uint32_t CR3_RXFTCFG_B_0x3 = 3;
        /** @brief Receive FIFO reaches 7/8 of its depth */
    constexpr std::uint32_t CR3_RXFTCFG_B_0x4 = 4;
        /** @brief Receive FIFO becomes full */
    constexpr std::uint32_t CR3_RXFTCFG_B_0x5 = 5;
    ...
    constexpr std::uint32_t CR3_TXFTCFG_B_0x0 = 0;
        /** @brief TXFIFO reaches 1/4 of its depth */
    constexpr std::uint32_t CR3_TXFTCFG_B_0x1 = 1;
        /** @brief TXFIFO reaches 1/2 of its depth */
    constexpr std::uint32_t CR3_TXFTCFG_B_0x2 = 2;
        /** @brief TXFIFO reaches 3/4 of its depth */
    constexpr std::uint32_t CR3_TXFTCFG_B_0x3 = 3;
        /** @brief TXFIFO reaches 7/8 of its depth */
    constexpr std::uint32_t CR3_TXFTCFG_B_0x4 = 4;
        /** @brief TXFIFO becomes empty */
    constexpr std::uint32_t CR3_TXFTCFG_B_0x5 = 5;
    ...
    /** @brief Prescaler value In IrDA low-power and normal IrDA mode: PSC[7:0] = IrDA Normal and Low-Power baud rate PSC[7:0] is used to program the prescaler for dividing the USART source clock to achieve the low-power frequency: the source clock is divided by the value given in the register (8 significant bits): In Smartcard mode: PSC[4:0]=Prescaler value PSC[4:0] is used to program the prescaler for dividing the USART source clock to provide the Smartcard clock. The value given in the register (5 significant bits) is multiplied by 2 to give the division factor of the source clock frequency: ... 00100000: Divides the source clock by 32 (IrDA mode) ... 11111111: Divides the source clock by 255 (IrDA mode) This bitfield can only be written when the USART is disabled (UE=0). Note: Bits [7:5] must be kept cleared if Smartcard mode is used. This bitfield is reserved and forced by hardware to '0' when the Smartcard and IrDA modes are not supported. Refer to . */
    using GTPR_PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Reserved - do not program this value (value: 0)
     *          - B_0x1: Divides the source clock by 1 (IrDA mode) / by 2 (Smarcard mode) (value: 1)
     *          - B_0x2: Divides the source clock by 2 (IrDA mode) / by 4 (Smartcard mode) (value: 2)
     *          - B_0x3: Divides the source clock by 3 (IrDA mode) / by 6 (Smartcard mode) (value: 3)
     *          - B_0x1F: Divides the source clock by 31 (IrDA mode) / by 62 (Smartcard mode) (value: 31)
     */
        /** @brief Reserved - do not program this value */
    constexpr std::uint32_t GTPR_PSC_B_0x0 = 0;
        /** @brief Divides the source clock by 1 (IrDA mode) / by 2 (Smarcard mode) */
    constexpr std::uint32_t GTPR_PSC_B_0x1 = 1;
        /** @brief Divides the source clock by 2 (IrDA mode) / by 4 (Smartcard mode) */
    constexpr std::uint32_t GTPR_PSC_B_0x2 = 2;
        /** @brief Divides the source clock by 3 (IrDA mode) / by 6 (Smartcard mode) */
    constexpr std::uint32_t GTPR_PSC_B_0x3 = 3;
        /** @brief Divides the source clock by 31 (IrDA mode) / by 62 (Smartcard mode) */
    constexpr std::uint32_t GTPR_PSC_B_0x1F = 31;
    ...
    /** @brief Auto baud rate request Writing 1 to this bit resets the ABRF flag in the USART_ISR and requests an automatic baud rate measurement on the next received data frame. Note: If the USART does not support the auto baud rate feature, this bit is reserved and must be kept at reset value. Refer to . */
    ...
    using ISR_FIFO_ENABLED = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Parity error This bit is set by hardware when a parity error occurs in receiver mode. It is cleared by software, writing 1 to the PECF in the USART_ICR register. An interrupt is generated if PEIE = 1 in the USART_CR1 register. Note: This error is associated with the character in the USART_RDR. */
    using ISR_FIFO_ENABLED_PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No parity error (value: 0)
     *          - B_0x1: Parity error (value: 1)
     */
        /** @brief No parity error */
    constexpr std::uint32_t ISR_FIFO_ENABLED_PE_B_0x0 = 0;
        /** @brief Parity error */
    constexpr std::uint32_t ISR_FIFO_ENABLED_PE_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t ISR_FIFO_ENABLED_FE_B_0x0 = 0;
        /** @brief Framing error or break character is detected */
    constexpr std::uint32_t ISR_FIFO_ENABLED_FE_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_NE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No noise is detected (value: 0)
     *          - B_0x1: Noise is detected (value: 1)
     */
        /** @brief No noise is detected */
    constexpr std::uint32_t ISR_FIFO_ENABLED_NE_B_0x0 = 0;
        /** @brief Noise is detected */
    constexpr std::uint32_t ISR_FIFO_ENABLED_NE_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_ORE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No overrun error (value: 0)
     *          - B_0x1: Overrun error is detected (value: 1)
     */
        /** @brief No overrun error */
    constexpr std::uint32_t ISR_FIFO_ENABLED_ORE_B_0x0 = 0;
        /** @brief Overrun error is detected */
    constexpr std::uint32_t ISR_FIFO_ENABLED_ORE_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_IDLE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No Idle line is detected (value: 0)
     *          - B_0x1: Idle line is detected (value: 1)
     */
        /** @brief No Idle line is detected */
    constexpr std::uint32_t ISR_FIFO_ENABLED_IDLE_B_0x0 = 0;
        /** @brief Idle line is detected */
    constexpr std::uint32_t ISR_FIFO_ENABLED_IDLE_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_RXFNE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Data is not received (value: 0)
     *          - B_0x1: Received data is ready to be read. (value: 1)
     */
        /** @brief Data is not received */
    constexpr std::uint32_t ISR_FIFO_ENABLED_RXFNE_B_0x0 = 0;
        /** @brief Received data is ready to be read. */
    constexpr std::uint32_t ISR_FIFO_ENABLED_RXFNE_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_TC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Transmission is not complete (value: 0)
     *          - B_0x1: Transmission is complete (value: 1)
     */
        /** @brief Transmission is not complete */
    constexpr std::uint32_t ISR_FIFO_ENABLED_TC_B_0x0 = 0;
        /** @brief Transmission is complete */
    constexpr std::uint32_t ISR_FIFO_ENABLED_TC_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_TXFNF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Transmit FIFO is full (value: 0)
     *          - B_0x1: Transmit FIFO is not full (value: 1)
     */
        /** @brief Transmit FIFO is full */
    constexpr std::uint32_t ISR_FIFO_ENABLED_TXFNF_B_0x0 = 0;
        /** @brief Transmit FIFO is not full */
    constexpr std::uint32_t ISR_FIFO_ENABLED_TXFNF_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_LBDF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: LIN Break not detected (value: 0)
     *          - B_0x1: LIN break detected (value: 1)
     */
        /** @brief LIN Break not detected */
    constexpr std::uint32_t ISR_FIFO_ENABLED_LBDF_B_0x0 = 0;
        /** @brief LIN break detected */
    constexpr std::uint32_t ISR_FIFO_ENABLED_LBDF_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_CTSIF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No change occurred on the nCTS status line (value: 0)
     *          - B_0x1: A change occurred on the nCTS status line (value: 1)
     */
        /** @brief No change occurred on the nCTS status line */
    constexpr std::uint32_t ISR_FIFO_ENABLED_CTSIF_B_0x0 = 0;
        /** @brief A change occurred on the nCTS status line */
    constexpr std::uint32_t ISR_FIFO_ENABLED_CTSIF_B_0x1 = 1;

    /** @brief CTS flag This bit is set/reset by hardware. It is an inverted copy of the status of the nCTS input pin. Note: If the hardware flow control feature is not supported, this bit is reserved and kept at reset value. */
    using ISR_FIFO_ENABLED_CTS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: nCTS line set (value: 0)
     *          - B_0x1: nCTS line reset (value: 1)
     */
        /** @brief nCTS line set */
    constexpr std::uint32_t ISR_FIFO_ENABLED_CTS_B_0x0 = 0;
        /** @brief nCTS line reset */
    constexpr std::uint32_t ISR_FIFO_ENABLED_CTS_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_RTOF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t ISR_FIFO_ENABLED_RTOF_B_0x0 = 0;
        /** @brief Timeout value reached without any data reception */
    constexpr std::uint32_t ISR_FIFO_ENABLED_RTOF_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_EOBF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t ISR_FIFO_ENABLED_EOBF_B_0x0 = 0;
        /** @brief End of Block (number of characters) reached */
    constexpr std::uint32_t ISR_FIFO_ENABLED_EOBF_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_UDR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No underrun error (value: 0)
     *          - B_0x1: underrun error (value: 1)
     */
        /** @brief No underrun error */
    constexpr std::uint32_t ISR_FIFO_ENABLED_UDR_B_0x0 = 0;
        /** @brief underrun error */
    constexpr std::uint32_t ISR_FIFO_ENABLED_UDR_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_ABRE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using ISR_FIFO_ENABLED_ABRF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using ISR_FIFO_ENABLED_BUSY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: USART is idle (no reception) (value: 0)
     *          - B_0x1: Reception on going (value: 1)
     */
        /** @brief USART is idle (no reception) */
    constexpr std::uint32_t ISR_FIFO_ENABLED_BUSY_B_0x0 = 0;
        /** @brief Reception on going */
    constexpr std::uint32_t ISR_FIFO_ENABLED_BUSY_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_CMF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No Character match detected (value: 0)
     *          - B_0x1: Character Match detected (value: 1)
     */
        /** @brief No Character match detected */
    constexpr std::uint32_t ISR_FIFO_ENABLED_CMF_B_0x0 = 0;
        /** @brief Character Match detected */
    constexpr std::uint32_t ISR_FIFO_ENABLED_CMF_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_SBKF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Break character transmitted (value: 0)
     *          - B_0x1: Break character requested by setting SBKRQ bit in USART_RQR register (value: 1)
     */
        /** @brief Break character transmitted */
    constexpr std::uint32_t ISR_FIFO_ENABLED_SBKF_B_0x0 = 0;
        /** @brief Break character requested by setting SBKRQ bit in USART_RQR register */
    constexpr std::uint32_t ISR_FIFO_ENABLED_SBKF_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_RWU = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Receiver in active mode (value: 0)
     *          - B_0x1: Receiver in Mute mode (value: 1)
     */
        /** @brief Receiver in active mode */
    constexpr std::uint32_t ISR_FIFO_ENABLED_RWU_B_0x0 = 0;
        /** @brief Receiver in Mute mode */
    constexpr std::uint32_t ISR_FIFO_ENABLED_RWU_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_WUF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using ISR_FIFO_ENABLED_TEACK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using ISR_FIFO_ENABLED_REACK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using ISR_FIFO_ENABLED_TXFE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: TXFIFO not empty. (value: 0)
     *          - B_0x1: TXFIFO empty. (value: 1)
     */
        /** @brief TXFIFO not empty. */
    constexpr std::uint32_t ISR_FIFO_ENABLED_TXFE_B_0x0 = 0;
        /** @brief TXFIFO empty. */
    constexpr std::uint32_t ISR_FIFO_ENABLED_TXFE_B_0x1 = 1;

    /** @brief RXFIFO full This bit is set by hardware when the number of received data corresponds to RXFIFOsize+1 (RXFIFO full + 1 data in the USART_RDR register. An interrupt is generated if the RXFFIE bit =1 in the USART_CR1 register. */
    using ISR_FIFO_ENABLED_RXFF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: RXFIFO not full. (value: 0)
     *          - B_0x1: RXFIFO Full. (value: 1)
     */
        /** @brief RXFIFO not full. */
    constexpr std::uint32_t ISR_FIFO_ENABLED_RXFF_B_0x0 = 0;
        /** @brief RXFIFO Full. */
    constexpr std::uint32_t ISR_FIFO_ENABLED_RXFF_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_TCBGT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    using ISR_FIFO_ENABLED_RXFT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t ISR_FIFO_ENABLED_RXFT_B_0x0 = 0;
        /** @brief Receive FIFO reached the programmed threshold. */
    constexpr std::uint32_t ISR_FIFO_ENABLED_RXFT_B_0x1 = 1;
    ...
    using ISR_FIFO_ENABLED_TXFT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t ISR_FIFO_ENABLED_TXFT_B_0x0 = 0;
        /** @brief TXFIFO reached the programmed threshold. */
    constexpr std::uint32_t ISR_FIFO_ENABLED_TXFT_B_0x1 = 1;

    /** @brief Interrupt & status register */
    using ISR_FIFO_DISABLED = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Parity error This bit is set by hardware when a parity error occurs in receiver mode. It is cleared by software, writing 1 to the PECF in the USART_ICR register. An interrupt is generated if PEIE = 1 in the USART_CR1 register. */
    using ISR_FIFO_DISABLED_PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No parity error (value: 0)
     *          - B_0x1: Parity error (value: 1)
     */
        /** @brief No parity error */
    constexpr std::uint32_t ISR_FIFO_DISABLED_PE_B_0x0 = 0;
        /** @brief Parity error */
    constexpr std::uint32_t ISR_FIFO_DISABLED_PE_B_0x1 = 1;

    /** @brief Framing error This bit is set by hardware when a de-synchronization, excessive noise or a break character is detected. It is cleared by software, writing 1 to the FECF bit in the USART_ICR register. When transmitting data in Smartcard mode, this bit is set when the maximum number of transmit attempts is reached without success (the card NACKs the data frame). An interrupt is generated if EIE=1 in the USART_CR1 register. */
    using ISR_FIFO_DISABLED_FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No Framing error is detected (value: 0)
     *          - B_0x1: Framing error or break character is detected (value: 1)
     */
        /** @brief No Framing error is detected */
    constexpr std::uint32_t ISR_FIFO_DISABLED_FE_B_0x0 = 0;
        /** @brief Framing error or break character is detected */
    constexpr std::uint32_t ISR_FIFO_DISABLED_FE_B_0x1 = 1;
    ...
    using ISR_FIFO_DISABLED_NE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No noise is detected (value: 0)
     *          - B_0x1: Noise is detected (value: 1)
     */
        /** @brief No noise is detected */
    constexpr std::uint32_t ISR_FIFO_DISABLED_NE_B_0x0 = 0;
        /** @brief Noise is detected */
    constexpr std::uint32_t ISR_FIFO_DISABLED_NE_B_0x1 = 1;
    ...
    using ISR_FIFO_DISABLED_ORE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No overrun error (value: 0)
     *          - B_0x1: Overrun error is detected (value: 1)
     */
        /** @brief No overrun error */
    constexpr std::uint32_t ISR_FIFO_DISABLED_ORE_B_0x0 = 0;
        /** @brief Overrun error is detected */
    constexpr std::uint32_t ISR_FIFO_DISABLED_ORE_B_0x1 = 1;
    ...
    using ISR_FIFO_DISABLED_IDLE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No Idle line is detected (value: 0)
     *          - B_0x1: Idle line is detected (value: 1)
     */
        /** @brief No Idle line is detected */
    constexpr std::uint32_t ISR_FIFO_DISABLED_IDLE_B_0x0 = 0;
        /** @brief Idle line is detected */
    constexpr std::uint32_t ISR_FIFO_DISABLED_IDLE_B_0x1 = 1;
    ...
    using ISR_FIFO_DISABLED_RXNE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Data is not received (value: 0)
     *          - B_0x1: Received data is ready to be read. (value: 1)
     */
        /** @brief Data is not received */
    constexpr std::uint32_t ISR_FIFO_DISABLED_RXNE_B_0x0 = 0;
        /** @brief Received data is ready to be read. */
    constexpr std::uint32_t ISR_FIFO_DISABLED_RXNE_B_0x1 = 1;
    ...
    using ISR_FIFO_DISABLED_TC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Transmission is not complete (value: 0)
     *          - B_0x1: Transmission is complete (value: 1)
     */
        /** @brief Transmission is not complete */
    constexpr std::uint32_t ISR_FIFO_DISABLED_TC_B_0x0 = 0;
        /** @brief Transmission is complete */
    constexpr std::uint32_t ISR_FIFO_DISABLED_TC_B_0x1 = 1;
    ...
    using ISR_FIFO_DISABLED_TXE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Data register full (value: 0)
     *          - B_0x1: Data register not full (value: 1)
     */
        /** @brief Data register full */
    constexpr std::uint32_t ISR_FIFO_DISABLED_TXE_B_0x0 = 0;
        /** @brief Data register not full */
    constexpr std::uint32_t ISR_FIFO_DISABLED_TXE_B_0x1 = 1;

    /** @brief LIN break detection flag This bit is set by hardware when the LIN break is detected. It is cleared by software, by writing 1 to the LBDCF in the USART_ICR. An interrupt is generated if LBDIE = 1 in the USART_CR2 register. Note: If the USART does not support LIN mode, this bit is reserved and kept at reset value. Refer to . */
    using ISR_FIFO_DISABLED_LBDF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: LIN Break not detected (value: 0)
     *          - B_0x1: LIN break detected (value: 1)
     */
        /** @brief LIN Break not detected */
    constexpr std::uint32_t ISR_FIFO_DISABLED_LBDF_B_0x0 = 0;
        /** @brief LIN break detected */
    constexpr std::uint32_t ISR_FIFO_DISABLED_LBDF_B_0x1 = 1;

    /** @brief CTS interrupt flag This bit is set by hardware when the nCTS input toggles, if the CTSE bit is set. It is cleared by software, by writing 1 to the CTSCF bit in the USART_ICR register. An interrupt is generated if CTSIE=1 in the USART_CR3 register. Note: If the hardware flow control feature is not supported, this bit is reserved and kept at reset value. */
    using ISR_FIFO_DISABLED_CTSIF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No change occurred on the nCTS status line (value: 0)
     *          - B_0x1: A change occurred on the nCTS status line (value: 1)
     */
        /** @brief No change occurred on the nCTS status line */
    constexpr std::uint32_t ISR_FIFO_DISABLED_CTSIF_B_0x0 = 0;
        /** @brief A change occurred on the nCTS status line */
    constexpr std::uint32_t ISR_FIFO_DISABLED_CTSIF_B_0x1 = 1;

    /** @brief CTS flag This bit is set/reset by hardware. It is an inverted copy of the status of the nCTS input pin. Note: If the hardware flow control feature is not supported, this bit is reserved and kept at reset value. */
    using ISR_FIFO_DISABLED_CTS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: nCTS line set (value: 0)
     *          - B_0x1: nCTS line reset (value: 1)
     */
        /** @brief nCTS line set */
    constexpr std::uint32_t ISR_FIFO_DISABLED_CTS_B_0x0 = 0;
        /** @brief nCTS line reset */
    constexpr std::uint32_t ISR_FIFO_DISABLED_CTS_B_0x1 = 1;

    /** @brief Receiver timeout This bit is set by hardware when the timeout value, programmed in the RTOR register has lapsed, without any communication. It is cleared by software, writing 1 to the RTOCF bit in the USART_ICR register. An interrupt is generated if RTOIE=1 in the USART_CR2 register. In Smartcard mode, the timeout corresponds to the CWT or BWT timings. Note: If a time equal to the value programmed in RTOR register separates 2 characters, RTOF is not set. If this time exceeds this value + 2 sample times (2/16 or 2/8, depending on the oversampling method), RTOF flag is set. The counter counts even if RE = 0 but RTOF is set only when RE = 1. If the timeout has already elapsed when RE is set, then RTOF is set. If the USART does not support the Receiver timeout feature, this bit is reserved and kept at reset value. */
    using ISR_FIFO_DISABLED_RTOF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Timeout value not reached (value: 0)
     *          - B_0x1: Timeout value reached without any data reception (value: 1)
     */
        /** @brief Timeout value not reached */
    constexpr std::uint32_t ISR_FIFO_DISABLED_RTOF_B_0x0 = 0;
        /** @brief Timeout value reached without any data reception */
    constexpr std::uint32_t ISR_FIFO_DISABLED_RTOF_B_0x1 = 1;

    /** @brief End of block flag This bit is set by hardware when a complete block has been received (for example T=1 Smartcard mode). The detection is done when the number of received bytes (from the start of the block, including the prologue) is equal or greater than BLEN + 4. An interrupt is generated if the EOBIE=1 in the USART_CR2 register. It is cleared by software, writing 1 to the EOBCF in the USART_ICR register. Note: If Smartcard mode is not supported, this bit is reserved and kept at reset value. Refer to . */
    using ISR_FIFO_DISABLED_EOBF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: End of Block not reached (value: 0)
     *          - B_0x1: End of Block (number of characters) reached (value: 1)
     */
        /** @brief End of Block not reached */
    constexpr std::uint32_t ISR_FIFO_DISABLED_EOBF_B_0x0 = 0;
        /** @brief End of Block (number of characters) reached */
    constexpr std::uint32_t ISR_FIFO_DISABLED_EOBF_B_0x1 = 1;

    /** @brief SPI slave underrun error flag In slave transmission mode, this flag is set when the first clock pulse for data transmission appears while the software has not yet loaded any value into USART_TDR. This flag is reset by setting UDRCF bit in the USART_ICR register. Note: If the USART does not support the SPI slave mode, this bit is reserved and kept at reset value. Refer to . */
    using ISR_FIFO_DISABLED_UDR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No underrun error (value: 0)
     *          - B_0x1: underrun error (value: 1)
     */
        /** @brief No underrun error */
    constexpr std::uint32_t ISR_FIFO_DISABLED_UDR_B_0x0 = 0;
        /** @brief underrun error */
    constexpr std::uint32_t ISR_FIFO_DISABLED_UDR_B_0x1 = 1;

    /** @brief Auto baud rate error This bit is set by hardware if the baud rate measurement failed (baud rate out of range or character comparison failed) It is cleared by software, by writing 1 to the ABRRQ bit in the USART_CR3 register. Note: If the USART does not support the auto baud rate feature, this bit is reserved and kept at reset value. */
    using ISR_FIFO_DISABLED_ABRE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using ISR_FIFO_DISABLED_ABRF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Busy flag This bit is set and reset by hardware. It is active when a communication is ongoing on the RX line (successful start bit detected). It is reset at the end of the reception (successful or not). */
    using ISR_FIFO_DISABLED_BUSY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: USART is idle (no reception) (value: 0)
     *          - B_0x1: Reception on going (value: 1)
     */
        /** @brief USART is idle (no reception) */
    constexpr std::uint32_t ISR_FIFO_DISABLED_BUSY_B_0x0 = 0;
        /** @brief Reception on going */
    constexpr std::uint32_t ISR_FIFO_DISABLED_BUSY_B_0x1 = 1;

    /** @brief Character match flag This bit is set by hardware, when a the character defined by ADD[7:0] is received. It is cleared by software, writing 1 to the CMCF in the USART_ICR register. An interrupt is generated if CMIE=1in the USART_CR1 register. */
    using ISR_FIFO_DISABLED_CMF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No Character match detected (value: 0)
     *          - B_0x1: Character Match detected (value: 1)
     */
        /** @brief No Character match detected */
    constexpr std::uint32_t ISR_FIFO_DISABLED_CMF_B_0x0 = 0;
        /** @brief Character Match detected */
    constexpr std::uint32_t ISR_FIFO_DISABLED_CMF_B_0x1 = 1;

    /** @brief Send break flag This bit indicates that a send break character was requested. It is set by software, by writing 1 to the SBKRQ bit in the USART_CR3 register. It is automatically reset by hardware during the stop bit of break transmission. */
    using ISR_FIFO_DISABLED_SBKF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Break character transmitted (value: 0)
     *          - B_0x1: Break character requested by setting SBKRQ bit in USART_RQR register (value: 1)
     */
        /** @brief Break character transmitted */
    constexpr std::uint32_t ISR_FIFO_DISABLED_SBKF_B_0x0 = 0;
        /** @brief Break character requested by setting SBKRQ bit in USART_RQR register */
    constexpr std::uint32_t ISR_FIFO_DISABLED_SBKF_B_0x1 = 1;

    /** @brief Receiver wakeup from Mute mode This bit indicates if the USART is in Mute mode. It is cleared/set by hardware when a wakeup/mute sequence is recognized. The Mute mode control sequence (address or IDLE) is selected by the WAKE bit in the USART_CR1 register. When wakeup on IDLE mode is selected, this bit can only be set by software, writing 1 to the MMRQ bit in the USART_RQR register. Note: If the USART does not support the wakeup from Stop feature, this bit is reserved and kept at reset value. Refer to . */
    using ISR_FIFO_DISABLED_RWU = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Receiver in active mode (value: 0)
     *          - B_0x1: Receiver in Mute mode (value: 1)
     */
        /** @brief Receiver in active mode */
    constexpr std::uint32_t ISR_FIFO_DISABLED_RWU_B_0x0 = 0;
        /** @brief Receiver in Mute mode */
    constexpr std::uint32_t ISR_FIFO_DISABLED_RWU_B_0x1 = 1;

    /** @brief Wakeup from low-power mode flag This bit is set by hardware, when a wakeup event is detected. The event is defined by the WUS bitfield. It is cleared by software, writing a 1 to the WUCF in the USART_ICR register. An interrupt is generated if WUFIE=1 in the USART_CR3 register. Note: When UESM is cleared, WUF flag is also cleared. If the USART does not support the wakeup from Stop feature, this bit is reserved and kept at reset value. Refer to . */
    using ISR_FIFO_DISABLED_WUF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Transmit enable acknowledge flag This bit is set/reset by hardware, when the Transmit Enable value is taken into account by the USART. It can be used when an idle frame request is generated by writing TE=0, followed by TE=1 in the USART_CR1 register, in order to respect the TE=0 minimum period. */
    using ISR_FIFO_DISABLED_TEACK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Receive enable acknowledge flag This bit is set/reset by hardware, when the Receive Enable value is taken into account by the USART. It can be used to verify that the USART is ready for reception before entering low-power mode. Note: If the USART does not support the wakeup from Stop feature, this bit is reserved and kept at reset value. Refer to . */
    using ISR_FIFO_DISABLED_REACK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Transmission complete before guard time flag This bit is set when the last data written in the USART_TDR has been transmitted correctly out of the shift register. It is set by hardware in Smartcard mode, if the transmission of a frame containing data is complete and if the smartcard did not send back any NACK. An interrupt is generated if TCBGTIE=1 in the USART_CR3 register. This bit is cleared by software, by writing 1 to the TCBGTCF in the USART_ICR register or by a write to the USART_TDR register. Note: If the USART does not support the Smartcard mode, this bit is reserved and kept at reset value. If the USART supports the Smartcard mode and the Smartcard mode is enabled, the TCBGT reset value is '1'. Refer to on page835. */
    using ISR_FIFO_DISABLED_TCBGT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Transmission is not complete or transmission is complete unsuccessfully (i.e. a NACK is received from the card) (value: 0)
     *          - B_0x1: Transmission is complete successfully (before Guard time completion and there is no NACK from the smart card). (value: 1)
     */
        /** @brief Transmission is not complete or transmission is complete unsuccessfully (i.e. a NACK is received from the card) */
    constexpr std::uint32_t ISR_FIFO_DISABLED_TCBGT_B_0x0 = 0;
        /** @brief Transmission is complete successfully (before Guard time completion and there is no NACK from the smart card). */
    constexpr std::uint32_t ISR_FIFO_DISABLED_TCBGT_B_0x1 = 1;
    ...
    /** @brief LIN break detection clear flag Writing 1 to this bit clears the LBDF flag in the USART_ISR register. Note: If LIN mode is not supported, this bit is reserved and must be kept at reset value. Refer to . */
    using ICR_LBDCF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CTS clear flag Writing 1 to this bit clears the CTSIF flag in the USART_ISR register. Note: If the hardware flow control feature is not supported, this bit is reserved and must be kept at reset value. Refer to . */
    using ICR_CTSCF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Receiver timeout clear flag Writing 1 to this bit clears the RTOF flag in the USART_ISR register. Note: If the USART does not support the Receiver timeout feature, this bit is reserved and must be kept at reset value. Refer to page835. */
    using ICR_RTOCF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief End of block clear flag Writing 1 to this bit clears the EOBF flag in the USART_ISR register. Note: If the USART does not support Smartcard mode, this bit is reserved and must be kept at reset value. Refer to . */
    using ICR_EOBCF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SPI slave underrun clear flag Writing 1 to this bit clears the UDRF flag in the USART_ISR register. Note: If the USART does not support SPI slave mode, this bit is reserved and must be kept at reset value. Refer to */
    ...
    /** @brief Wakeup from low-power mode clear flag Writing 1 to this bit clears the WUF flag in the USART_ISR register. Note: If the USART does not support the wakeup from Stop feature, this bit is reserved and must be kept at reset value. Refer to page835. */
    using ICR_WUCF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Clock prescaler The USART input clock can be divided by a prescaler factor: Remaining combinations: Reserved Note: When PRESCALER is programmed with a value different of the allowed ones, programmed prescaler value is 1011 i.e. input clock divided by 256. */
    ...
    constexpr std::uint32_t PRESC_PRESCALER_B_0x0 = 0;
        /** @brief input clock divided by 2 */
    constexpr std::uint32_t PRESC_PRESCALER_B_0x1 = 1;
        /** @brief input clock divided by 4 */
    constexpr std::uint32_t PRESC_PRESCALER_B_0x2 = 2;
        /** @brief input clock divided by 6 */
    constexpr std::uint32_t PRESC_PRESCALER_B_0x3 = 3;
        /** @brief input clock divided by 8 */
    constexpr std::uint32_t PRESC_PRESCALER_B_0x4 = 4;
        /** @brief input clock divided by 10 */
    constexpr std::uint32_t PRESC_PRESCALER_B_0x5 = 5;
        /** @brief input clock divided by 12 */
    constexpr std::uint32_t PRESC_PRESCALER_B_0x6 = 6;
        /** @brief input clock divided by 16 */
    constexpr std::uint32_t PRESC_PRESCALER_B_0x7 = 7;
        /** @brief input clock divided by 32 */
    constexpr std::uint32_t PRESC_PRESCALER_B_0x8 = 8;
        /** @brief input clock divided by 64 */
    constexpr std::uint32_t PRESC_PRESCALER_B_0x9 = 9;
        /** @brief input clock divided by 128 */
    constexpr std::uint32_t PRESC_PRESCALER_B_0xA = 10;
        /** @brief input clock divided by 256 */
    constexpr std::uint32_t PRESC_PRESCALER_B_0xB = 11;
