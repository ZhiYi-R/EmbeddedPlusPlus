...
#ifndef EMBEDDED_PP_STM32G070_DAC_HPP
#define EMBEDDED_PP_STM32G070_DAC_HPP
...
namespace STM32G070::DAC {
    ...
    using IP_HWCFGR0 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x3F0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Dual DAC capability */
    using IP_HWCFGR0_DUAL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Pseudonoise wave generation capability */
    using IP_HWCFGR0_LFSR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Triangle wave generation capability */
    using IP_HWCFGR0_TRIANGLE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Sample and hold mode capability */
    using IP_HWCFGR0_SAMPLE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief option register bit width */
    using IP_HWCFGR0_OR_CFG = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
