...
#ifndef EMBEDDED_PP_STM32G070_HDMI_CEC_HPP
#define EMBEDDED_PP_STM32G070_HDMI_CEC_HPP
...
namespace STM32G070::HDMI_CEC {
    ...
    using CEC_CFGR_SFTOPT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
