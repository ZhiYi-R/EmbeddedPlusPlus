...
#ifndef EMBEDDED_PP_STM32G070_I2C2_HPP
#define EMBEDDED_PP_STM32G070_I2C2_HPP
...
namespace STM32G070::I2C2 {
    ...
    /** @brief Interface address */
    using OAR1_OA1_8_9 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
