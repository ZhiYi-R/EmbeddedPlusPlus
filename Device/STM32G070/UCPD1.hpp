...
#ifndef EMBEDDED_PP_STM32G070_UCPD1_HPP
#define EMBEDDED_PP_STM32G070_UCPD1_HPP
...
namespace STM32G070::UCPD1 {

    /** @brief UCPD configuration register */
    using CFG1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief HBITCLKDIV */
    using CFG1_HBITCLKDIV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 6, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief IFRGAP */
    using CFG1_IFRGAP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TRANSWIN */
    using CFG1_TRANSWIN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief PSC_USBPDCLK */
    using CFG1_PSC_USBPDCLK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RXORDSETEN */
    using CFG1_RXORDSETEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 9, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TXDMAEN */
    using CFG1_TXDMAEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RXDMAEN: */
    using CFG1_RXDMAEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief UCPDEN */
    using CFG1_UCPDEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief UCPD configuration register 2 */
    using CFG2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RXFILTDIS */
    using CFG2_RXFILTDIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RXFILT2N3 */
    using CFG2_RXFILT2N3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FORCECLK */
    using CFG2_FORCECLK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief WUPEN */
    using CFG2_WUPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief UCPD configuration register 3 */
    using CFG3 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TRIM1_NG_CCRPD */
    using CFG3_TRIM1_NG_CCRPD = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TRIM1_NG_CC1A5 */
    using CFG3_TRIM1_NG_CC1A5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TRIM1_NG_CC3A0 */
    using CFG3_TRIM1_NG_CC3A0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TRIM2_NG_CCRPD */
    using CFG3_TRIM2_NG_CCRPD = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TRIM2_NG_CC1A5 */
    using CFG3_TRIM2_NG_CC1A5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TRIM2_NG_CC3A0 */
    using CFG3_TRIM2_NG_CC3A0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief DBATTEN */
    using CR_DBATTEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FRSRXEN */
    ...
    using IPVER = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x3F4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief IPVER */
    using IPVER_IPVER = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief UCPD IP ID register */
    using IPID = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x3F8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief IPID */
    using IPID_IPID = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief UCPD IP ID register */
    using MID = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x3FC, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief IPID */
    using MID_IPID = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
