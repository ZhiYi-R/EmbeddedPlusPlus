...
#ifndef EMBEDDED_PP_STM32G071_EXTI_HPP
#define EMBEDDED_PP_STM32G071_EXTI_HPP
...
namespace STM32G071::EXTI {
    ...
    /** @brief HW configuration of number of IO ports */
    using HWCFGR1_NBIOPORT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief HW configuration of CPU event output enable */
    using HWCFGR1_CPUEVTEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief configuration number of CPUs */
    using HWCFGR1_NBCPUS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief configuration number of event */
