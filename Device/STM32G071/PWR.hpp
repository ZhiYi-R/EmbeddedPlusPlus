...
#ifndef EMBEDDED_PP_STM32G071_PWR_HPP
#define EMBEDDED_PP_STM32G071_PWR_HPP
...
namespace STM32G071::PWR {
    ...
    /** @brief Enable the periodical sampling mode for PDR detection */
    using CR3_ULPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
