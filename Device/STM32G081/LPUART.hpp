...
#ifndef EMBEDDED_PP_STM32G081_LPUART_HPP
#define EMBEDDED_PP_STM32G081_LPUART_HPP
...
namespace STM32G081::LPUART {
    ...
    /** @brief DEDT0 */
    using CR1_DEDT0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief LUART hardware configuration 1 */
    using HWCFGR2_CFG1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief LUART hardware configuration 2 */
    using HWCFGR2_CFG2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief LUART hardware configuration 1 */
    using HWCFGR1_CFG1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief LUART hardware configuration 2 */
    using HWCFGR1_CFG2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief LUART hardware configuration 1 */
    using HWCFGR1_CFG3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief LUART hardware configuration 2 */
    using HWCFGR1_CFG4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief LUART hardware configuration 2 */
    using HWCFGR1_CFG5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief LUART hardware configuration 2 */
    using HWCFGR1_CFG6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief LUART hardware configuration 2 */
    using HWCFGR1_CFG7 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief LUART hardware configuration 2 */
    using HWCFGR1_CFG8 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
