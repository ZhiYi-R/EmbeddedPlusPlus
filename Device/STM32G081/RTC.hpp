...
#ifndef EMBEDDED_PP_STM32G081_RTC_HPP
#define EMBEDDED_PP_STM32G081_RTC_HPP
...
namespace STM32G081::RTC {
    ...
    /** @brief ALARMB */
    using HWCFGR_ALARMB = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief WAKEUP */
    using HWCFGR_WAKEUP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SMOOTH_CALIB */
    using HWCFGR_SMOOTH_CALIB = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIMESTAMP */
    using HWCFGR_TIMESTAMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OPTIONREG_OUT */
    using HWCFGR_OPTIONREG_OUT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TRUST_ZONE */
    using HWCFGR_TRUST_ZONE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
