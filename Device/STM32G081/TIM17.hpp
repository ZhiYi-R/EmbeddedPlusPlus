...
#ifndef EMBEDDED_PP_STM32G081_TIM17_HPP
#define EMBEDDED_PP_STM32G081_TIM17_HPP
...
namespace STM32G081::TIM17 {
    ...
    using AF1_BKDFBK1E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
