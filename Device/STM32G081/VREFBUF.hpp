...
#ifndef EMBEDDED_PP_STM32G081_VREFBUF_HPP
#define EMBEDDED_PP_STM32G081_VREFBUF_HPP
...
namespace STM32G081::VREFBUF {
    ...
    /** @details Possible values:
     *          - B_0x0: Voltage reference set to VREF_OUT1 (around 2.048 V). (value: 0)
     *          - B_0x1: Voltage reference set to VREF_OUT2 (around 2.5 V). (value: 1)
     */
        /** @brief Voltage reference set to VREF_OUT1 (around 2.048 V). */
    constexpr std::uint32_t VREFBUF_CSR_VRS_B_0x0 = 0;
        /** @brief Voltage reference set to VREF_OUT2 (around 2.5 V). */
    ...
    /** @brief Trimming code These bits are automatically initialized after reset with the trimming value stored in the Flash memory during the production test. Writing into these bits allows the tuning of the internal reference buffer voltage. */
