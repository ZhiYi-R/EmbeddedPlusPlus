...
#ifndef EMBEDDED_PP_STM32G0B0_FLASH_HPP
#define EMBEDDED_PP_STM32G0B0_FLASH_HPP
...
namespace STM32G0B0::FLASH {
    ...
    using ECCR_ADDR_ECC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 14, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief nSWAP_BANK */
    using OPTR_nSWAP_BANK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DUAL_BANK */
    using OPTR_DUAL_BANK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
