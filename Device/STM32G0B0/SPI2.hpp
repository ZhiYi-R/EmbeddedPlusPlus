...
#ifndef EMBEDDED_PP_STM32G0B0_SPI2_HPP
#define EMBEDDED_PP_STM32G0B0_SPI2_HPP
...
namespace STM32G0B0::SPI2 {

    /** @brief SPI_CR1 register */
    ...
    /** @brief SPI enable Note: When disabling the SPI, follow the procedure described in SPI on page1020. This bit is not used in I2S mode. */
    ...
    /** @brief Transmit CRC next Note: This bit has to be written as soon as the last data is written in the SPIx_DR register. This bit is not used in I2S mode. */
    ...
    using SPI_SR_CHSIDE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint16_t SPI_SR_CHSIDE_B_0x0 = 0;
        /** @brief Channel Right has to be transmitted or has been received */
    constexpr std::uint16_t SPI_SR_CHSIDE_B_0x1 = 1;

    /** @brief Underrun flag This flag is set by hardware and reset by a software sequence. Refer to page1056 for the software sequence. Note: This bit is not used in SPI mode. */
    using SPI_SR_UDR = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No underrun occurred (value: 0)
     *          - B_0x1: Underrun occurred (value: 1)
     */
        /** @brief No underrun occurred */
    constexpr std::uint16_t SPI_SR_UDR_B_0x0 = 0;
        /** @brief Underrun occurred */
    constexpr std::uint16_t SPI_SR_UDR_B_0x1 = 1;
    ...
    /** @brief Mode fault This flag is set by hardware and reset by a software sequence. Refer to (MODF) on page1030 for the software sequence. Note: This bit is not used in I2S mode. */
    ...
    /** @brief Overrun flag This flag is set by hardware and reset by a software sequence. Refer to page1056 for the software sequence. */
    ...
    /** @brief Frame format error This flag is used for SPI in TI slave mode and I2S slave mode. Refer to error flags and . This flag is set by hardware and reset when SPIx_SR is read by software. */
    ...
    /** @brief SPI_I2SCFGR register */
    using SPI_I2SCFGR = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x1C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using SPI_I2SCFGR_CHLEN = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: 16-bit wide (value: 0)
     *          - B_0x1: 32-bit wide (value: 1)
     */
        /** @brief 16-bit wide */
    constexpr std::uint16_t SPI_I2SCFGR_CHLEN_B_0x0 = 0;
        /** @brief 32-bit wide */
    constexpr std::uint16_t SPI_I2SCFGR_CHLEN_B_0x1 = 1;
    ...
    using SPI_I2SCFGR_DATLEN = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 1, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint16_t SPI_I2SCFGR_DATLEN_B_0x0 = 0;
        /** @brief 24-bit data length */
    constexpr std::uint16_t SPI_I2SCFGR_DATLEN_B_0x1 = 1;
        /** @brief 32-bit data length */
    constexpr std::uint16_t SPI_I2SCFGR_DATLEN_B_0x2 = 2;
        /** @brief Not allowed */
    constexpr std::uint16_t SPI_I2SCFGR_DATLEN_B_0x3 = 3;
    ...
    using SPI_I2SCFGR_CKPOL = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint16_t SPI_I2SCFGR_CKPOL_B_0x0 = 0;
        /** @brief I2S clock inactive state is high level */
    constexpr std::uint16_t SPI_I2SCFGR_CKPOL_B_0x1 = 1;
    ...
    using SPI_I2SCFGR_I2SSTD = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 4, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint16_t SPI_I2SCFGR_I2SSTD_B_0x0 = 0;
        /** @brief MSB justified standard (left justified) */
    constexpr std::uint16_t SPI_I2SCFGR_I2SSTD_B_0x1 = 1;
        /** @brief LSB justified standard (right justified) */
    constexpr std::uint16_t SPI_I2SCFGR_I2SSTD_B_0x2 = 2;
        /** @brief PCM standard */
    constexpr std::uint16_t SPI_I2SCFGR_I2SSTD_B_0x3 = 3;
    ...
    using SPI_I2SCFGR_PCMSYNC = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Short frame synchronization (value: 0)
     *          - B_0x1: Long frame synchronization (value: 1)
     */
        /** @brief Short frame synchronization */
    constexpr std::uint16_t SPI_I2SCFGR_PCMSYNC_B_0x0 = 0;
        /** @brief Long frame synchronization */
    constexpr std::uint16_t SPI_I2SCFGR_PCMSYNC_B_0x1 = 1;

    /** @brief I2S configuration mode Note: These bits should be configured when the I2S is disabled. They are not used in SPI mode. */
    using SPI_I2SCFGR_I2SCFG = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint16_t SPI_I2SCFGR_I2SCFG_B_0x0 = 0;
        /** @brief Slave - receive */
    constexpr std::uint16_t SPI_I2SCFGR_I2SCFG_B_0x1 = 1;
        /** @brief Master - transmit */
    constexpr std::uint16_t SPI_I2SCFGR_I2SCFG_B_0x2 = 2;
        /** @brief Master - receive */
    constexpr std::uint16_t SPI_I2SCFGR_I2SCFG_B_0x3 = 3;

    /** @brief I2S enable Note: This bit is not used in SPI mode. */
    using SPI_I2SCFGR_I2SE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: I2S peripheral is disabled (value: 0)
     *          - B_0x1: I2S peripheral is enabled (value: 1)
     */
        /** @brief I2S peripheral is disabled */
    constexpr std::uint16_t SPI_I2SCFGR_I2SE_B_0x0 = 0;
        /** @brief I2S peripheral is enabled */
    constexpr std::uint16_t SPI_I2SCFGR_I2SE_B_0x1 = 1;

    /** @brief I2S mode selection Note: This bit should be configured when the SPI is disabled. */
    using SPI_I2SCFGR_I2SMOD = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: SPI mode is selected (value: 0)
     *          - B_0x1: I2S mode is selected (value: 1)
     */
        /** @brief SPI mode is selected */
    constexpr std::uint16_t SPI_I2SCFGR_I2SMOD_B_0x0 = 0;
        /** @brief I2S mode is selected */
    constexpr std::uint16_t SPI_I2SCFGR_I2SMOD_B_0x1 = 1;
    ...
    using SPI_I2SCFGR_ASTRTEN = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint16_t SPI_I2SCFGR_ASTRTEN_B_0x0 = 0;
        /** @brief The Asynchronous start is enabled. */
    constexpr std::uint16_t SPI_I2SCFGR_ASTRTEN_B_0x1 = 1;

    /** @brief SPI_I2SPR register */
    using SPI_I2SPR = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x20, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using SPI_I2SPR_I2SDIV = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using SPI_I2SPR_ODD = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint16_t SPI_I2SPR_ODD_B_0x0 = 0;
        /** @brief Real divider value is = (I2SDIV * 2)+1 */
    constexpr std::uint16_t SPI_I2SPR_ODD_B_0x1 = 1;
    ...
    using SPI_I2SPR_MCKOE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint16_t SPI_I2SPR_MCKOE_B_0x0 = 0;
        /** @brief Master clock output is enabled */
    constexpr std::uint16_t SPI_I2SPR_MCKOE_B_0x1 = 1;
