...
#ifndef EMBEDDED_PP_STM32G0B1_ADC_HPP
#define EMBEDDED_PP_STM32G0B1_ADC_HPP
...
namespace STM32G0B1::ADC {
    ...
    /** @brief Analog watchdog 1 lower threshold These bits are written by software to define the lower threshold for the analog watchdog. Refer to ADC_AWDxTR) on page407. */
    using ADC_AWD1TR_LT1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Analog watchdog 1 higher threshold These bits are written by software to define the higher threshold for the analog watchdog. Refer to ADC_AWDxTR) on page407. */
    ...
    /** @brief Analog watchdog 2 lower threshold These bits are written by software to define the lower threshold for the analog watchdog. Refer to ADC_AWDxTR) on page407. */
    using ADC_AWD2TR_LT2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Analog watchdog 2 higher threshold These bits are written by software to define the higher threshold for the analog watchdog. Refer to ADC_AWDxTR) on page407. */
     ...
     */
        /** @brief CH0 */
    constexpr std::uint32_t CHSELR_1_SQ8_B_0x0 = 0;
        /** @brief CH1 */
    constexpr std::uint32_t CHSELR_1_SQ8_B_0x1 = 1;
        /** @brief CH12 */
    constexpr std::uint32_t CHSELR_1_SQ8_B_0xC = 12;
        /** @brief CH13 */
    constexpr std::uint32_t CHSELR_1_SQ8_B_0xD = 13;
        /** @brief CH14 */
    constexpr std::uint32_t CHSELR_1_SQ8_B_0xE = 14;
        /** @brief No channel selected (End of sequence) */
    constexpr std::uint32_t CHSELR_1_SQ8_B_0xF = 15;

    /** @brief ADC watchdog threshold register */
    using ADC_AWD3TR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x2C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Analog watchdog 3lower threshold These bits are written by software to define the lower threshold for the analog watchdog. Refer to ADC_AWDxTR) on page407. */
    using ADC_AWD3TR_LT3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Analog watchdog 3 higher threshold These bits are written by software to define the higher threshold for the analog watchdog. Refer to ADC_AWDxTR) on page407. */
    ...
    /** @brief Converted data These bits are read-only. They contain the conversion result from the last converted channel. The data are left- or right-aligned as shown in OVSE = 0) on page401. Just after a calibration is complete, DATA[6:0] contains the calibration factor. */
