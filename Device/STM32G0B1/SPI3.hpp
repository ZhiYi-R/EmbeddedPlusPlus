...
#ifndef EMBEDDED_PP_STM32G0B1_SPI3_HPP
#define EMBEDDED_PP_STM32G0B1_SPI3_HPP
...
namespace STM32G0B1::SPI3 {
    ...
    /** @brief SPI enable Note: When disabling the SPI, follow the procedure described in SPI on page1021. This bit is not used in I2S mode. */
    ...
    /** @brief Underrun flag This flag is set by hardware and reset by a software sequence. Refer to page1057 for the software sequence. Note: This bit is not used in SPI mode. */
    ...
    /** @brief Mode fault This flag is set by hardware and reset by a software sequence. Refer to (MODF) on page1031 for the software sequence. Note: This bit is not used in I2S mode. */
    ...
    /** @brief Overrun flag This flag is set by hardware and reset by a software sequence. Refer to page1057 for the software sequence. */
    ...
    /** @brief FIFO reception level These bits are set and cleared by hardware. Note: These bits are not used in I^2S mode and in SPI receive-only mode while CRC calculation is enabled. */
