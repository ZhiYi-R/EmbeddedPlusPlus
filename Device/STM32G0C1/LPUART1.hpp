...
#ifndef EMBEDDED_PP_STM32G0C1_LPUART1_HPP
#define EMBEDDED_PP_STM32G0C1_LPUART1_HPP
...
namespace STM32G0C1::LPUART1 {
    ...
    /** @brief Transmitter enable This bit enables the transmitter. It is set and cleared by software. Note: During transmission, a low pulse on the TE bit ('0' followed by '1') sends a preamble (idle line) after the current word. In order to generate an idle character, the TE must not be immediately written to 1. In order to ensure the required duration, the software can poll the TEACK bit in the LPUART_ISR register. When TE is set there is a 1 bit-time delay before the transmission starts. */
    ...
    /** @details Possible values:
     *          - B_0x0: Interrupt is inhibited (value: 0)
     *          - B_0x1: A LPUART interrupt is generated whenever ORE = 1 or RXNE/RXFNE = 1 in the LPUART_ISR register (value: 1)
     */
        /** @brief Interrupt is inhibited */
    constexpr std::uint32_t LPUART_CR1_enabled_RXFNEIE_B_0x0 = 0;
        /** @brief A LPUART interrupt is generated whenever ORE = 1 or RXNE/RXFNE = 1 in the LPUART_ISR register */
    ...
    /** @details Possible values:
     *          - B_0x0: Interrupt is inhibited (value: 0)
     *          - B_0x1: A LPUART interrupt is generated whenever TXE/TXFNF =1 in the LPUART_ISR register (value: 1)
     */
        /** @brief Interrupt is inhibited */
    constexpr std::uint32_t LPUART_CR1_enabled_TXFNFIE_B_0x0 = 0;
        /** @brief A LPUART interrupt is generated whenever TXE/TXFNF =1 in the LPUART_ISR register */
    ...
    /** @brief Receiver wakeup method This bit determines the LPUART wakeup method from Mute mode. It is set or cleared by software. This bitfield can only be written when the LPUART is disabled (UE=0). */
    ...
    /** @brief Driver Enable assertion time This 5-bit value defines the time between the activation of the DE (Driver Enable) signal and the beginning of the start bit. It is expressed in lpuart_ker_ck clock cycles. For more details, refer . This bitfield can only be written when the LPUART is disabled (UE=0). */
    ...
    /** @brief RXFIFO not empty interrupt enable This bit is set and cleared by software. */
    using LPUART_CR1_disabled_RXFNEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt is inhibited (value: 0)
     *          - B_0x1: A LPUART interrupt is generated whenever ORE = 1 or RXNE/RXFNE = 1 in the LPUART_ISR register (value: 1)
     */
        /** @brief Interrupt is inhibited */
    constexpr std::uint32_t LPUART_CR1_disabled_RXFNEIE_B_0x0 = 0;
        /** @brief A LPUART interrupt is generated whenever ORE = 1 or RXNE/RXFNE = 1 in the LPUART_ISR register */
    constexpr std::uint32_t LPUART_CR1_disabled_RXFNEIE_B_0x1 = 1;
    ...
    /** @brief TXFIFO not full interrupt enable This bit is set and cleared by software. */
    using LPUART_CR1_disabled_TXFNFIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt is inhibited (value: 0)
     *          - B_0x1: A LPUART interrupt is generated whenever TXE/TXFNF =1 in the LPUART_ISR register (value: 1)
     */
        /** @brief Interrupt is inhibited */
    constexpr std::uint32_t LPUART_CR1_disabled_TXFNFIE_B_0x0 = 0;
        /** @brief A LPUART interrupt is generated whenever TXE/TXFNF =1 in the LPUART_ISR register */
    constexpr std::uint32_t LPUART_CR1_disabled_TXFNFIE_B_0x1 = 1;
    ...
    /** @brief Parity error This bit is set by hardware when a parity error occurs in receiver mode. It is cleared by software, writing 1 to the PECF in the LPUART_ICR register. An interrupt is generated if PEIE = 1 in the LPUART_CR1 register. Note: This error is associated with the character in the LPUART_RDR. */
     ...
     *          - B_0x1: Break character requested by setting SBKRQ bit in LPUART_RQR register (value: 1)
     */
        /** @brief Break character transmitted */
    constexpr std::uint32_t LPUART_ISR_enabled_SBKF_B_0x0 = 0;
        /** @brief Break character requested by setting SBKRQ bit in LPUART_RQR register */
    ...
    /** @brief RXFIFO full This bit is set by hardware when the number of received data corresponds to RXFIFOsize+1 (RXFIFO full + 1 data in the LPUART_RDR register. An interrupt is generated if the RXFFIE bit =1 in the LPUART_CR1 register. */
    ...
    /** @brief RXFIFO not empty RXFNE bit is set by hardware when the RXFIFO is not empty, and so data can be read from the LPUART_RDR register. Every read of the LPUART_RDR frees a location in the RXFIFO. It is cleared when the RXFIFO is empty. The RXFNE flag can also be cleared by writing 1 to the RXFRQ in the LPUART_RQR register. An interrupt is generated if RXFNEIE=1 in the LPUART_CR1 register. */
    using LPUART_ISR_disabled_RXFNE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Data is not received (value: 0)
     *          - B_0x1: Received data is ready to be read. (value: 1)
     */
        /** @brief Data is not received */
    constexpr std::uint32_t LPUART_ISR_disabled_RXFNE_B_0x0 = 0;
        /** @brief Received data is ready to be read. */
    constexpr std::uint32_t LPUART_ISR_disabled_RXFNE_B_0x1 = 1;
    ...
    /** @brief TXFIFO not full TXFNF is set by hardware when TXFIFO is not full, and so data can be written in the LPUART_TDR. Every write in the LPUART_TDR places the data in the TXFIFO. This flag remains set until the TXFIFO is full. When the TXFIFO is full, this flag is cleared indicating that data can not be written into the LPUART_TDR. The TXFNF is kept reset during the flush request until TXFIFO is empty. After sending the flush request (by setting TXFRQ bit), the flag TXFNF should be checked prior to writing in TXFIFO (TXFNF and TXFE are set at the same time). An interrupt is generated if the TXFNFIE bit =1 in the LPUART_CR1 register. Note: This bit is used during single buffer transmission. */
    using LPUART_ISR_disabled_TXFNF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Data register is full/Transmit FIFO is full. (value: 0)
     *          - B_0x1: Data register/Transmit FIFO is not full. (value: 1)
     */
        /** @brief Data register is full/Transmit FIFO is full. */
    constexpr std::uint32_t LPUART_ISR_disabled_TXFNF_B_0x0 = 0;
        /** @brief Data register/Transmit FIFO is not full. */
    constexpr std::uint32_t LPUART_ISR_disabled_TXFNF_B_0x1 = 1;
