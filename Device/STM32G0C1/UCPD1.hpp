...
#ifndef EMBEDDED_PP_STM32G0C1_UCPD1_HPP
#define EMBEDDED_PP_STM32G0C1_UCPD1_HPP
...
namespace STM32G0C1::UCPD1 {
     ...
     */
        /** @brief 1 (bypass) */
    constexpr std::uint32_t UCPD_CFGR1_HBITCLKDIV_B_0x0 = 0;
        /** @brief 27 */
     ...
     */
        /** @brief Not supported */
    constexpr std::uint32_t UCPD_CFGR1_IFRGAP_B_0x0 = 0;
        /** @brief 2 */
    constexpr std::uint32_t UCPD_CFGR1_IFRGAP_B_0x1 = 1;
        /** @brief 14 */
    constexpr std::uint32_t UCPD_CFGR1_IFRGAP_B_0xD = 13;
        /** @brief 15 */
    constexpr std::uint32_t UCPD_CFGR1_IFRGAP_B_0xE = 14;
        /** @brief 16 */
    constexpr std::uint32_t UCPD_CFGR1_IFRGAP_B_0xF = 15;
        /** @brief 32 */
     ...
     *          - B_0x0: Not supported (value: 0)
     *          - B_0x1: 2 (value: 1)
     *          - B_0x9: 10 (recommended) (value: 9)
     *          - B_0x1F: 32 (value: 31)
     */
        /** @brief Not supported */
    constexpr std::uint32_t UCPD_CFGR1_TRANSWIN_B_0x0 = 0;
        /** @brief 2 */
    constexpr std::uint32_t UCPD_CFGR1_TRANSWIN_B_0x1 = 1;
        /** @brief 10 (recommended) */
    constexpr std::uint32_t UCPD_CFGR1_TRANSWIN_B_0x9 = 9;
        /** @brief 32 */
    ...
    using UCPD_CFGR3 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SW trim value for RPD resistors on the CC1 line */
    using UCPD_CFGR3_TRIM1_NG_CCRPD = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SW trim value for RP1A5 resistors on the CC1 line */
    using UCPD_CFGR3_TRIM1_NG_CC1A5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SW trim value for RP3A0 resistors on the CC1 line */
    using UCPD_CFGR3_TRIM1_NG_CC3A0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SW trim value for RPD resistors on the CC2 line */
    using UCPD_CFGR3_TRIM2_NG_CCRPD = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SW trim value for RP1A5 resistors on the CC2 line */
    using UCPD_CFGR3_TRIM2_NG_CC1A5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SW trim value for RP3A0 resistors on the CC2 line */
    using UCPD_CFGR3_TRIM2_NG_CC3A0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Analog PHY sub-mode Refer to TYPEC_VSTATE_CCx for the effect of this bitfield. */
    using UCPD_CR_ANASUBMODE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Analog PHY operating mode The bit takes effect upon setting the UCPDx_STROBE bit of the SYS_CONFIG register. The use of CC1 and CC2 depends on CCENABLE. Refer to ANAMODE, ANASUBMODE and link with TYPEC_VSTATE_CCx for the effect of this bitfield in conjunction with ANASUBMODE[1:0]. */
    ...
    /** @brief VCONN switch enable for CC1 */
    using UCPD_CR_CC1VCONNEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Disable (value: 0)
     *          - B_0x1: Enable (value: 1)
     */
        /** @brief Disable */
    constexpr std::uint32_t UCPD_CR_CC1VCONNEN_B_0x0 = 0;
        /** @brief Enable */
    constexpr std::uint32_t UCPD_CR_CC1VCONNEN_B_0x1 = 1;

    /** @brief VCONN switch enable for CC2 */
    using UCPD_CR_CC2VCONNEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Disable (value: 0)
     *          - B_0x1: Enable (value: 1)
     */
        /** @brief Disable */
    constexpr std::uint32_t UCPD_CR_CC2VCONNEN_B_0x0 = 0;
        /** @brief Enable */
    constexpr std::uint32_t UCPD_CR_CC2VCONNEN_B_0x1 = 1;

    /** @brief Dead battery function enable The bit takes effect upon setting the USBPDstrobe bit of the SYS_CONFIG register. Dead battery function only operates if the external circuit is appropriately configured. */
    using UCPD_CR_DBATTEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Disable (value: 0)
     *          - B_0x1: Enable (value: 1)
     */
        /** @brief Disable */
    constexpr std::uint32_t UCPD_CR_DBATTEN_B_0x0 = 0;
        /** @brief Enable */
    constexpr std::uint32_t UCPD_CR_DBATTEN_B_0x1 = 1;
    ...
    /** @brief FRS Tx signaling enable. Setting the bit enables FRS Tx signaling. The bit is cleared by hardware after a delay respecting the USB Power Delivery specification Revision 3.0. */
    ...
    /** @brief Ordered set to transmit The bitfield determines a full 20-bit sequence to transmit, consisting of four K-codes, each of five bits, defining the packet to transmit. The bit 0 (bit 0 of K-code1) is the first, the bit 19 (bit 4 of code4) the last. */
    ...
    /** @brief The bit indicates the number of correct For debug purposes only. */
    ...
    /** @details Possible values:
     *          - B_0x0: 4 correct out of 4 (value: 0)
     *          - B_0x1: 3 correct out of 4 (value: 1)
     */
        /** @brief 4 correct out of 4 */
    constexpr std::uint32_t UCPD_RX_ORDSETR_RXSOP3OF4_B_0x0 = 0;
        /** @brief 3 correct out of 4 */
