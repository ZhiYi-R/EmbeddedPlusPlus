...
#ifndef EMBEDDED_PP_STM32G474_ADC345_COMMON_HPP
#define EMBEDDED_PP_STM32G474_ADC345_COMMON_HPP
...
namespace STM32G474::ADC345_Common {
    ...
    /** @brief VTS selection */
    using CCR_VSENSESEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief VBAT selection */
    using CCR_VBATSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ADC prescaler */
