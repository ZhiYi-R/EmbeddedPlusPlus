...
#ifndef EMBEDDED_PP_STM32H503_DAC_HPP
#define EMBEDDED_PP_STM32H503_DAC_HPP
...
namespace STM32H503::DAC {
     ...
     *          - B_0x1: High frequency interface mode compatible to AHB80 MHz enabled (value: 1)
     */
        /** @brief High frequency interface mode disabled */
    constexpr std::uint32_t DAC_MCR_HFSEL0_B_0x0 = 0;
        /** @brief High frequency interface mode compatible to AHB80 MHz enabled */
