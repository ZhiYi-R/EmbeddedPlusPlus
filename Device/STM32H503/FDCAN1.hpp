...
#ifndef EMBEDDED_PP_STM32H503_FDCAN1_HPP
#define EMBEDDED_PP_STM32H503_FDCAN1_HPP
...
namespace STM32H503::FDCAN1 {
    ...
    /** @brief Timestamp counter prescaler Configures the timestamp and timeout counters time unit in multiples of CAN bit times . */
    ...
    /** @brief Timestamp counter The internal/external timestamp counter value is captured on start of frame (both Rx and Tx). */
    ...
    /** @brief Timeout counter The timeout counter is decremented in multiples of CAN bit times depending on the configuration of TSCC.TCP. When decremented to 0, interrupt flag IR.TOO is set and the timeout counter is stopped. Start and reset/restart conditions are configured via TOCC.TOS. */
