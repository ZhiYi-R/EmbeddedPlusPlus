...
#ifndef EMBEDDED_PP_STM32H503_PWR_HPP
#define EMBEDDED_PP_STM32H503_PWR_HPP
...
namespace STM32H503::PWR {
    ...
    /** @brief system Stop mode voltage scaling selection These bits control the V CORE voltage level in system Stop mode, to obtain the best trade-off between power consumption and performance. */
    ...
    /** @brief analog switch V BOOST control This bit enables the booster to guarantee the analog switch AC performance when the V DD supply voltage is below 2.7 V (reduction of the total harmonic distortion to have the same switch performance over the full supply voltage range) The V DD supply voltage can be monitored through the PVD and the PLS bits. */
    ...
    /** @details Possible values:
     *          - B_0x0: peripheral analog voltage V DDA not ready (default) (value: 0)
     *          - B_0x1: peripheral analog voltage V DDA ready. (value: 1)
     */
        /** @brief peripheral analog voltage V DDA not ready (default) */
    constexpr std::uint32_t PWR_PMCR_AVD_READY_B_0x0 = 0;
        /** @brief peripheral analog voltage V DDA ready. */
    constexpr std::uint32_t PWR_PMCR_AVD_READY_B_0x1 = 1;

    /** @brief AHB SRAM2 shut-off in Stop mode. */
    using PWR_PMCR_SRAM2SO = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: AHB RAM2 content is kept in Stop mode. (value: 0)
     *          - B_0x1: AHB RAM2 content is lost in Stop mode. (value: 1)
     */
        /** @brief AHB RAM2 content is kept in Stop mode. */
    constexpr std::uint32_t PWR_PMCR_SRAM2SO_B_0x0 = 0;
        /** @brief AHB RAM2 content is lost in Stop mode. */
    constexpr std::uint32_t PWR_PMCR_SRAM2SO_B_0x1 = 1;
    ...
    /** @brief Ready bit for V CORE voltage scaling output selection. */
    ...
    /** @details Possible values:
     *          - B_0x0: V CORE is above or below the current voltage scaling provided by ACTVOS[1:0]. (value: 0)
     *          - B_0x1: V CORE is equal to the current voltage scaling provided by ACTVOS[1:0] (value: 1)
     */
        /** @brief V CORE is above or below the current voltage scaling provided by ACTVOS[1:0]. */
    constexpr std::uint32_t PWR_VOSSR_ACTVOSRDY_B_0x0 = 0;
        /** @brief V CORE is equal to the current voltage scaling provided by ACTVOS[1:0] */
    constexpr std::uint32_t PWR_VOSSR_ACTVOSRDY_B_0x1 = 1;

    /** @brief voltage output scaling currently applied to V CORE This field provides the last VOS value. */
    ...
    /** @brief Backup RAM retention in Standby and V BAT modes When this bit set, the backup regulator (used to maintain the backup RAM content in Standby and V BAT modes) is enabled. If BREN is cleared, the backup regulator is switched off. The backup RAM can still be used in 	Run and Stop modes. However its content is lost in Standby and V BAT modes. If BREN is set, the application must wait till the backup regulator ready flag (BRRDY) is set to indicate that the data written into the SRAM is maintained in Standby and V BAT modes. */
    using PWR_BDCR_BREN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Backup RAM content lost in Standby and V BAT modes. (value: 0)
     *          - B_0x1: Backup RAM content preserved in Standby and V BAT modes (value: 1)
     */
        /** @brief Backup RAM content lost in Standby and V BAT modes. */
    constexpr std::uint32_t PWR_BDCR_BREN_B_0x0 = 0;
        /** @brief Backup RAM content preserved in Standby and V BAT modes */
    ...
    /** @brief V BAT charging enable Note: Reset only by POR,. */
    using PWR_BDCR_VBE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V BAT battery charging disabled. (value: 0)
     *          - B_0x1: V BAT battery charging enabled. (value: 1)
     */
        /** @brief V BAT battery charging disabled. */
    constexpr std::uint32_t PWR_BDCR_VBE_B_0x0 = 0;
        /** @brief V BAT battery charging enabled. */
    constexpr std::uint32_t PWR_BDCR_VBE_B_0x1 = 1;

    /** @brief V BAT charging resistor selection */
    using PWR_BDCR_VBRS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Charge V BAT through a 5 kohm resistor. (value: 0)
     *          - B_0x1: Charge V BAT through a 1.5 kohm resistor. (value: 1)
     */
        /** @brief Charge V BAT through a 5 kohm resistor. */
    constexpr std::uint32_t PWR_BDCR_VBRS_B_0x0 = 0;
        /** @brief Charge V BAT through a 1.5 kohm resistor. */
    ...
    /** @brief V BAT level monitoring versus low threshold */
    using PWR_BDSR_VBATL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V BAT level above low threshold level (value: 0)
     *          - B_0x1: V BAT level equal or below low threshold level (value: 1)
     */
        /** @brief V BAT level above low threshold level */
    constexpr std::uint32_t PWR_BDSR_VBATL_B_0x0 = 0;
        /** @brief V BAT level equal or below low threshold level */
    constexpr std::uint32_t PWR_BDSR_VBATL_B_0x1 = 1;

    /** @brief V BAT level monitoring versus high threshold */
    using PWR_BDSR_VBATH = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V BAT level below high threshold level (value: 0)
     *          - B_0x1: V BAT level equal or above high threshold level (value: 1)
     */
        /** @brief V BAT level below high threshold level */
    constexpr std::uint32_t PWR_BDSR_VBATH_B_0x0 = 0;
        /** @brief V BAT level equal or above high threshold level */
    ...
    /** @brief peripheral voltage monitor on V DDA enable */
    using PWR_VMCR_AVDEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: peripheral voltage monitor on V DDA disabled (value: 0)
     *          - B_0x1: peripheral voltage monitor on V DDA enabled (value: 1)
     */
        /** @brief peripheral voltage monitor on V DDA disabled */
    constexpr std::uint32_t PWR_VMCR_AVDEN_B_0x0 = 0;
        /** @brief peripheral voltage monitor on V DDA enabled */
    ...
    /** @brief analog voltage detector output on V DDA This bit is set and cleared by hardware. It is valid only if AVD on VDDA is enabled by the AVDEN bit. Note: Since the AVD is disabled in Standby mode, this bit is equal to 0 after standby or reset until the AVDEN bit is set. */
    using PWR_VMSR_AVDO = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V DDA is equal or higher than the AVD threshold selected with the ALS[2:0] bits. (value: 0)
     *          - B_0x1: V DDA is lower than the AVD threshold selected with the ALS[2:0] bits. (value: 1)
     */
        /** @brief V DDA is equal or higher than the AVD threshold selected with the ALS[2:0] bits. */
    constexpr std::uint32_t PWR_VMSR_AVDO_B_0x0 = 0;
        /** @brief V DDA is lower than the AVD threshold selected with the ALS[2:0] bits. */
    constexpr std::uint32_t PWR_VMSR_AVDO_B_0x1 = 1;

    /** @brief voltage detector output on V DDIO2 This bit is set and cleared by hardware. */
    using PWR_VMSR_VDDIO2RDY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V DDIO2 is below 1.2 V. (value: 0)
     *          - B_0x1: V DDIO2 is above or equal to 1.2 V. (value: 1)
     */
        /** @brief V DDIO2 is below 1.2 V. */
    constexpr std::uint32_t PWR_VMSR_VDDIO2RDY_B_0x0 = 0;
        /** @brief V DDIO2 is above or equal to 1.2 V. */
    ...
    /** @details Possible values:
     *          - B_0x0: V DD is equal or higher than the PVD threshold selected through the PLS[2:0] bits. (value: 0)
     *          - B_0x1: V DD is lower than the PVD threshold selected through the PLS[2:0] bits. (value: 1)
     */
        /** @brief V DD is equal or higher than the PVD threshold selected through the PLS[2:0] bits. */
    constexpr std::uint32_t PWR_VMSR_PVDO_B_0x0 = 0;
        /** @brief V DD is lower than the PVD threshold selected through the PLS[2:0] bits. */
    ...
    /** @brief IO retention enable: When entering into standby mode, the output is sampled, and applied to the output IO during the standby power mode. Note: the IO state is not retained if the DBG_STANDBY bit is set in DBGMCU_CR register. */
     ...
     *          - B_0x1: IO Retention mode is enabled for all IOs except the ones supporting the standby functionality (PC13, PC14 and PC15) and JTAG I/Os (PA13, PA14, PA15, PB4). (value: 1)
     */
        /** @brief IO Retention mode is disabled. */
    constexpr std::uint32_t PWR_IORETR_IORETEN_B_0x0 = 0;
        /** @brief IO Retention mode is enabled for all IOs except the ones supporting the standby functionality (PC13, PC14 and PC15) and JTAG I/Os (PA13, PA14, PA15, PB4). */
    constexpr std::uint32_t PWR_IORETR_IORETEN_B_0x1 = 1;

    /** @brief IO retention enable for JTAG IOs when entering into standby mode, the output is sampled, and applied to the output IO during the standby power mode */
    using PWR_IORETR_JTAGIORETEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: IO Retention mode is disabled. (value: 0)
     *          - B_0x1: IO Retention mode is enabled for PA13, PA14, PA15 and PB4. (value: 1)
     */
        /** @brief IO Retention mode is disabled. */
    constexpr std::uint32_t PWR_IORETR_JTAGIORETEN_B_0x0 = 0;
        /** @brief IO Retention mode is enabled for PA13, PA14, PA15 and PB4. */
    ...
    /** @brief PWR functions privilege configuration Set and reset by software. This bit can be written only by privileged access. */
    using PWR_PRIVCFGR_NSPRIV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Read and write to PWR functions can be done by privileged or unprivileged access. (value: 0)
     *          - B_0x1: Read and write to PWR functions can be done by privileged access only. (value: 1)
     */
        /** @brief Read and write to PWR functions can be done by privileged or unprivileged access. */
    constexpr std::uint32_t PWR_PRIVCFGR_NSPRIV_B_0x0 = 0;
        /** @brief Read and write to PWR functions can be done by privileged access only. */
