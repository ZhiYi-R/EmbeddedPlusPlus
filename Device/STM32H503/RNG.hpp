...
#ifndef EMBEDDED_PP_STM32H503_RNG_HPP
#define EMBEDDED_PP_STM32H503_RNG_HPP
...
namespace STM32H503::RNG {
     ...
     *          - B_0x1: Custom values for NIST compliant RNG. See Section 23.6: RNG entropy source validation for proposed configuration. (value: 1)
     */
    ...
    constexpr std::uint32_t RNG_CR_NISTC_B_0x0 = 0;
        /** @brief Custom values for NIST compliant RNG. See Section 23.6: RNG entropy source validation for proposed configuration. */
