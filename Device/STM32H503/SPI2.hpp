...
#ifndef EMBEDDED_PP_STM32H503_SPI2_HPP
#define EMBEDDED_PP_STM32H503_SPI2_HPP
...
namespace STM32H503::SPI2 {
    ...
    /** @brief FIFO threshold level Defines number of data frames at single data packet. Size of the packet should not exceed 1/2 of FIFO space. */
