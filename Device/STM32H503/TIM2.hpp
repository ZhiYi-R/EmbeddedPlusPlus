...
#ifndef EMBEDDED_PP_STM32H503_TIM2_HPP
#define EMBEDDED_PP_STM32H503_TIM2_HPP
...
namespace STM32H503::TIM2 {
     ...
     *          - B_0x1: The tim_ti1_in[15..0], tim_ti2_in[15..0] and tim_ti3_in[15..0] multiplexers outputs are XORed and connected to the tim_ti1 input. See also sensors on page 558. (value: 1)
     */
        /** @brief The tim_ti1_in[15..0] multiplexer output is to tim_ti1 input */
    constexpr std::uint32_t TIM2_CR2_TI1S_B_0x0 = 0;
        /** @brief The tim_ti1_in[15..0], tim_ti2_in[15..0] and tim_ti3_in[15..0] multiplexers outputs are XORed and connected to the tim_ti1 input. See also sensors on page 558. */
