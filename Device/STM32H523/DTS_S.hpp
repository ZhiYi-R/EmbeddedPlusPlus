...
#ifndef EMBEDDED_PP_STM32H523_DTS_S_HPP
#define EMBEDDED_PP_STM32H523_DTS_S_HPP
...
namespace STM32H523::DTS_S {
    ...
    /** @brief Temperature sensor 1 enable bit */
    ...
    /** @brief Start frequency measurement on temperature sensor 1 */
    ...
    /** @brief Quick measurement option bit */
    ...
    /** @brief High speed clock division ratio */
    ...
    /** @brief Engineering value of the frequency measured at T0 for */
    using DTS_T0VALR1_TS1_FMT0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Engineering value of the T0 temperature for temperature sensor 1. */
    ...
    /** @brief Engineering value of the ramp coefficient for the temperature sensor 1. */
    ...
    /** @brief Interrupt flag for end of measurement on temperature sensor 1, synchronized on PCLK. */
    ...
    /** @brief Interrupt flag for low threshold on temperature sensor 1, synchronized on PCLK. */
    ...
    /** @brief Interrupt flag for high threshold on temperature sensor 1, synchronized on PCLK */
    ...
    /** @brief Asynchronous interrupt flag for end of measure on temperature sensor 1 */
    ...
    /** @brief Asynchronous interrupt flag for low threshold on temperature sensor 1 */
    ...
    /** @brief Asynchronous interrupt flag for high threshold on temperature sensor 1 */
    ...
    /** @brief Temperature sensor 1 ready flag */
    ...
    /** @brief Interrupt enable flag for end of measurement on temperature sensor 1, synchronized on PCLK. */
    ...
    /** @brief Interrupt enable flag for low threshold on temperature sensor 1, synchronized on PCLK. */
    ...
    /** @brief Interrupt enable flag for high threshold on temperature sensor 1, synchronized on PCLK. */
    ...
    /** @brief Asynchronous interrupt enable flag for end of measurement on temperature sensor 1 */
    ...
    /** @brief Asynchronous interrupt enable flag for low threshold on temperature sensor 1. */
    ...
    /** @brief Asynchronous interrupt enable flag on high threshold for temperature sensor 1. */
