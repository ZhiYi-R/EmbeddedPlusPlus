...
#ifndef EMBEDDED_PP_STM32H523_EXTI_S_HPP
#define EMBEDDED_PP_STM32H523_EXTI_S_HPP
...
namespace STM32H523::EXTI_S {
    ...
    /** @brief Rising trigger event configuration bit of configurable event input xless thansup>(1)less than/sup> */
    ...
    /** @brief Falling trigger event configuration bit of configurable event input x less thansup>(1)less than/sup> */
    ...
    /** @brief EXTI external interrupt selection register */
    using EXTI_EXTICR4 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x60, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
     ...
     */
        /** @brief Wake-up with interrupt request from input event x is masked. */
    constexpr std::uint32_t EXTI_IMR2_IM58_B_0x0 = 0;
        /** @brief Wake-up with interrupt request from input event x is unmasked. */
    constexpr std::uint32_t EXTI_IMR2_IM58_B_0x1 = 1;
     ...
     */
        /** @brief Wake-up with event generation from Line x is masked. */
    constexpr std::uint32_t EXTI_EMR2_EM58_B_0x0 = 0;
        /** @brief Wake-up with event generation from Line x is unmasked. */
    constexpr std::uint32_t EXTI_EMR2_EM58_B_0x1 = 1;
