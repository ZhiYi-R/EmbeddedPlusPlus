...
#ifndef EMBEDDED_PP_STM32H523_FDCAN2_S_HPP
#define EMBEDDED_PP_STM32H523_FDCAN2_S_HPP
...
namespace STM32H523::FDCAN2_S {
     ...
     *          - B_0x1: The CPU has write access to the protected configuration registers (while CCCR. (value: 1)
     */
        /** @brief The CPU has no write access to the protected configuration registers. */
    constexpr std::uint32_t FDCAN_CCCR_CCE_B_0x0 = 0;
        /** @brief The CPU has write access to the protected configuration registers (while CCCR. */
     ...
     *          - B_0x5: Bit0Error: During the transmission of a message (or acknowledge bit, or active error flag, or overload flag), the device wanted to send a dominant level (data or identifier bit logical value 0), but the monitored bus value was recessive. (value: 5)
     *          - B_0x6: CRCError: The CRC check sum of a received message was incorrect. (value: 6)
     *          - B_0x7: NoChange: Any read access to the Protocol status register re-initializes the LEC to 7'. (value: 7)
     */
    ...
    constexpr std::uint32_t FDCAN_PSR_LEC_B_0x4 = 4;
        /** @brief Bit0Error: During the transmission of a message (or acknowledge bit, or active error flag, or overload flag), the device wanted to send a dominant level (data or identifier bit logical value 0), but the monitored bus value was recessive. */
    constexpr std::uint32_t FDCAN_PSR_LEC_B_0x5 = 5;
        /** @brief CRCError: The CRC check sum of a received message was incorrect. */
    constexpr std::uint32_t FDCAN_PSR_LEC_B_0x6 = 6;
        /** @brief NoChange: Any read access to the Protocol status register re-initializes the LEC to 7'. */
    ...
    /** @details Possible values:
     *          - B_0x0: The FDCAN is in the Error_Active state. (value: 0)
     *          - B_0x1: The FDCAN is in the Error_Passive state. (value: 1)
     */
        /** @brief The FDCAN is in the Error_Active state. */
     ...
     *          - B_0x1: Protocol error in arbitration phase detected (PSR. (value: 1)
     */
        /** @brief No protocol error in arbitration phase */
    constexpr std::uint32_t FDCAN_IR_PEA_B_0x0 = 0;
        /** @brief Protocol error in arbitration phase detected (PSR. */
     ...
     *          - B_0x1: Protocol error in data phase detected (PSR. (value: 1)
     */
        /** @brief No protocol error in data phase */
    constexpr std::uint32_t FDCAN_IR_PED_B_0x0 = 0;
        /** @brief Protocol error in data phase detected (PSR. */
