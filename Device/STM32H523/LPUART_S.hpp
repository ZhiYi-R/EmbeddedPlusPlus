...
#ifndef EMBEDDED_PP_STM32H523_LPUART_S_HPP
#define EMBEDDED_PP_STM32H523_LPUART_S_HPP
...
namespace STM32H523::LPUART_S {
    ...
    /** @brief Wake-up from low-power mode interrupt flag selection */
    using LPUART_CR3_ALTERNATE1_WUS0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: WUF active on address match (as defined by ADD[7:0] and ADDM7) (value: 0)
     */
        /** @brief WUF active on address match (as defined by ADD[7:0] and ADDM7) */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_WUS0_B_0x0 = 0;

    /** @brief Wake-up from low-power mode interrupt flag selection */
    using LPUART_CR3_ALTERNATE1_WUS1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: WUF active on address match (as defined by ADD[7:0] and ADDM7) (value: 0)
     */
        /** @brief WUF active on address match (as defined by ADD[7:0] and ADDM7) */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_WUS1_B_0x0 = 0;

    /** @brief Wake-up from low-power mode interrupt enable */
    using LPUART_CR3_ALTERNATE1_WUFIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated whenever WUF=1 in the LPUART_ISR register (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_WUFIE_B_0x0 = 0;
        /** @brief USART interrupt generated whenever WUF=1 in the LPUART_ISR register */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_WUFIE_B_0x1 = 1;
    ...
    /** @brief Wake-up from low-power mode flag */
    using LPUART_ISR_ALTERNATE1_WUF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Transmit enable acknowledge flag */
