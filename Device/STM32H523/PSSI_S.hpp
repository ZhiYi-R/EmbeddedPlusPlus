...
#ifndef EMBEDDED_PP_STM32H523_PSSI_S_HPP
#define EMBEDDED_PP_STM32H523_PSSI_S_HPP
...
namespace STM32H523::PSSI_S {
     ...
     *          - B_0x4: Both PSSI_RDY and PSSI_DE features enabled - bidirectional on PSSI_RDY pin (see Bidirectional PSSI_DE/PSSI_RDY signal on page 1245) (value: 4)
     ...
     *          - B_0x7: Both PSSI_RDY and PSSI_DE features enabled - bidirectional on PSSI_DE pin (see Bidirectional PSSI_DE/PSSI_RDY signal on page 1245) (value: 7)
     */
    ...
    constexpr std::uint32_t PSSI_CR_DERDYCFG_B_0x3 = 3;
        /** @brief Both PSSI_RDY and PSSI_DE features enabled - bidirectional on PSSI_RDY pin (see Bidirectional PSSI_DE/PSSI_RDY signal on page 1245) */
    ...
    constexpr std::uint32_t PSSI_CR_DERDYCFG_B_0x6 = 6;
        /** @brief Both PSSI_RDY and PSSI_DE features enabled - bidirectional on PSSI_DE pin (see Bidirectional PSSI_DE/PSSI_RDY signal on page 1245) */
    ...
    /** @details Possible values:
     *          - B_0x0: DMA transfers are disabled. (value: 0)
     *          - B_0x1: DMA transfers are enabled (default configuration). (value: 1)
     */
        /** @brief DMA transfers are disabled. */
    constexpr std::uint32_t PSSI_CR_DMAEN_B_0x0 = 0;
        /** @brief DMA transfers are enabled (default configuration). */
    ...
    /** @details Possible values:
     *          - B_0x1: FIFO is ready for a four-byte (32-bit) transfer. (value: 1)
     *          - B_0x0: FIFO is not ready for a four-byte transfer (value: 0)
     */
        /** @brief FIFO is ready for a four-byte (32-bit) transfer. */
    ...
    /** @details Possible values:
     *          - B_0x1: FIFO is ready for a one byte (32-bit) transfer. (value: 1)
     *          - B_0x0: FIFO is not ready for a 1-byte transfer (value: 0)
     */
        /** @brief FIFO is ready for a one byte (32-bit) transfer. */
