...
#ifndef EMBEDDED_PP_STM32H523_TIM15_S_HPP
#define EMBEDDED_PP_STM32H523_TIM15_S_HPP
...
namespace STM32H523::TIM15_S {
     ...
     */
        /** @brief Slave mode disabled - if CEN = '1 then the prescaler is clocked directly by the internal clock. */
    constexpr std::uint32_t TIM15_SMCR_SMS_1_B_0x0 = 0;
        /** @brief Encoder mode 1 - Counter counts up/down on tim_ti1fp1 edge depending on tim_ti2fp2 level. */
    constexpr std::uint32_t TIM15_SMCR_SMS_1_B_0x1 = 1;
     ...
     */
        /** @brief Internal trigger 0 (tim_itr0) */
    constexpr std::uint32_t TIM15_SMCR_TS_1_B_0x0 = 0;
        /** @brief Internal trigger 1 (tim_itr1) */
    constexpr std::uint32_t TIM15_SMCR_TS_1_B_0x1 = 1;
        /** @brief Internal trigger 2 (tim_itr2) */
    constexpr std::uint32_t TIM15_SMCR_TS_1_B_0x2 = 2;
        /** @brief Internal trigger 3 (tim_itr3) */
    constexpr std::uint32_t TIM15_SMCR_TS_1_B_0x3 = 3;
