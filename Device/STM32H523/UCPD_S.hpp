...
#ifndef EMBEDDED_PP_STM32H523_UCPD_S_HPP
#define EMBEDDED_PP_STM32H523_UCPD_S_HPP
...
namespace STM32H523::UCPD_S {
    ...
    /** @brief SW trim value for Rd resistor on the CC1 line */
    using UCPD_CFGR3_TRIM_CC1_RD = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SW trim value for Rp current sources on the CC1 line */
    using UCPD_CFGR3_TRIM_CC1_RP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SW trim value for Rd resistor on the CC2 line */
    using UCPD_CFGR3_TRIM_CC2_RD = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SW trim value for Rp current sources on the CC2 line */
    using UCPD_CFGR3_TRIM_CC2_RP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief The bit indicates the number of correct K-codes. */
