...
#ifndef EMBEDDED_PP_STM32H533_DCMI_S_HPP
#define EMBEDDED_PP_STM32H533_DCMI_S_HPP
...
namespace STM32H533::DCMI_S {
    ...
    /** @details Possible values:
     *          - B_0x0: Continuous grab mode - The received data are transferred into the destination memory through the DMA. (value: 0)
     *          - B_0x1: Snapshot mode (single frame) - Once activated, the interface waits for the start of frame and then transfers a single frame through the DMA. (value: 1)
     */
        /** @brief Continuous grab mode - The received data are transferred into the destination memory through the DMA. */
    constexpr std::uint32_t DCMI_CR_CM_B_0x0 = 0;
        /** @brief Snapshot mode (single frame) - Once activated, the interface waits for the start of frame and then transfers a single frame through the DMA. */
    ...
    /** @details Possible values:
     *          - B_0x0: The full image is captured. (value: 0)
     *          - B_0x1: Only the data inside the window specified by the crop register is captured. (value: 1)
     */
        /** @brief The full image is captured. */
    constexpr std::uint32_t DCMI_CR_CROP_B_0x0 = 0;
        /** @brief Only the data inside the window specified by the crop register is captured. */
     ...
     *          - B_0x1: This bit is used for JPEG data transfers. (value: 1)
     */
        /** @brief Uncompressed video format */
    constexpr std::uint32_t DCMI_CR_JPEG_B_0x0 = 0;
        /** @brief This bit is used for JPEG data transfers. */
