...
#ifndef EMBEDDED_PP_STM32H533_GPDMA2_S_HPP
#define EMBEDDED_PP_STM32H533_GPDMA2_S_HPP
...
namespace STM32H533::GPDMA2_S {
    ...
    /** @brief lock the configuration of GPDMA_SECCFGR. */
    ...
    /** @details Possible values:
     *          - B_0x0: channel executed for the full linked-list and completed at the end of the last LLI (GPDMA_CxLLR = 0). (value: 0)
     *          - B_0x1: channel executed once for the current LLI (value: 1)
     */
        /** @brief channel executed for the full linked-list and completed at the end of the last LLI (GPDMA_CxLLR = 0). */
    ...
    /** @details Possible values:
     *          - B_0x0: GPDMA transfer nonsecure (value: 0)
     *          - B_0x1: GPDMA transfer secure (value: 1)
     */
        /** @brief GPDMA transfer nonsecure */
    ...
    /** @details Possible values:
     *          - B_0x0: no software request. (value: 0)
     *          - B_0x1: software request for a memory-to-memory transfer. (value: 1)
     */
        /** @brief no software request. */
    constexpr std::uint32_t GPDMA_C0TR2_SWREQ_B_0x0 = 0;
        /** @brief software request for a memory-to-memory transfer. */
     ...
     *          - B_0x1: the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol at a block level (see Section 16. (value: 1)
     */
    ...
    constexpr std::uint32_t GPDMA_C0TR2_BREQ_B_0x0 = 0;
        /** @brief the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol at a block level (see Section 16. */
    ...
    /** @details Possible values:
     *          - B_0x0: the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in GPDMA control mode. (value: 0)
     *          - B_0x1: the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in peripheral control mode. (value: 1)
     */
        /** @brief the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in GPDMA control mode. */
    constexpr std::uint32_t GPDMA_C0TR2_PFREQ_B_0x0 = 0;
        /** @brief the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in peripheral control mode. */
    ...
    /** @details Possible values:
     *          - B_0x0: at block level: the first burst read of each block transfer is conditioned by one hit trigger (channel x (x = 6 to 7), for each block if a 2D/repeated block is configured with GPDMA_CxBR1. (value: 0)
     *          - B_0x1: channel x (x = 0 to 5), same as 00; channel x (x = 6 to 7), at 2D/repeated block level. (value: 1)
     *          - B_0x2: at link level: a LLI link transfer is conditioned by one hit trigger. (value: 2)
     *          - B_0x3: at programmed burst level: If SWREQ = 1, each programmed burst read is conditioned by one hit trigger. (value: 3)
     */
        /** @brief at block level: the first burst read of each block transfer is conditioned by one hit trigger (channel x (x = 6 to 7), for each block if a 2D/repeated block is configured with GPDMA_CxBR1. */
    constexpr std::uint32_t GPDMA_C0TR2_TRIGM_B_0x0 = 0;
        /** @brief channel x (x = 0 to 5), same as 00; channel x (x = 6 to 7), at 2D/repeated block level. */
    constexpr std::uint32_t GPDMA_C0TR2_TRIGM_B_0x1 = 1;
        /** @brief at link level: a LLI link transfer is conditioned by one hit trigger. */
    constexpr std::uint32_t GPDMA_C0TR2_TRIGM_B_0x2 = 2;
        /** @brief at programmed burst level: If SWREQ = 1, each programmed burst read is conditioned by one hit trigger. */
    ...
    /** @details Possible values:
     *          - B_0x0: at block level (when GPDMA_CxBR1. (value: 0)
     *          - B_0x1: channel x (x = 0 to 5), same as 00, channel x (x = 6 to 7), at 2D/repeated block level (when GPDMA_CxBR1. (value: 1)
     *          - B_0x2: at LLI level: the complete transfer event is generated at the end of the LLI transfer, including the update of the LLI if any. (value: 2)
     *          - B_0x3: at channel level: the complete transfer event is generated at the end of the last LLI transfer. (value: 3)
     */
        /** @brief at block level (when GPDMA_CxBR1. */
    constexpr std::uint32_t GPDMA_C0TR2_TCEM_B_0x0 = 0;
        /** @brief channel x (x = 0 to 5), same as 00, channel x (x = 6 to 7), at 2D/repeated block level (when GPDMA_CxBR1. */
    constexpr std::uint32_t GPDMA_C0TR2_TCEM_B_0x1 = 1;
        /** @brief at LLI level: the complete transfer event is generated at the end of the LLI transfer, including the update of the LLI if any. */
    constexpr std::uint32_t GPDMA_C0TR2_TCEM_B_0x2 = 2;
        /** @brief at channel level: the complete transfer event is generated at the end of the last LLI transfer. */
    ...
    /** @details Possible values:
     *          - B_0x0: no GPDMA_CxBR1 update from memory (GPDMA_CxBR1. (value: 0)
     *          - B_0x1: GPDMA_CxBR1 update (value: 1)
     */
        /** @brief no GPDMA_CxBR1 update from memory (GPDMA_CxBR1. */
    ...
    /** @details Possible values:
     *          - B_0x0: At the end of a programmed burst transfer from the source, the GPDMA_CxSAR register is updated by adding the programmed offset GPDMA_CxTR3. (value: 0)
     *          - B_0x1: At the end of a programmed burst transfer from the source, the GPDMA_CxSAR register is updated by subtracting the programmed offset GPDMA_CxTR3. (value: 1)
     */
        /** @brief At the end of a programmed burst transfer from the source, the GPDMA_CxSAR register is updated by adding the programmed offset GPDMA_CxTR3. */
    constexpr std::uint32_t GPDMA_C6BR1_SDEC_B_0x0 = 0;
        /** @brief At the end of a programmed burst transfer from the source, the GPDMA_CxSAR register is updated by subtracting the programmed offset GPDMA_CxTR3. */
    ...
    /** @details Possible values:
     *          - B_0x0: At the end of a programmed burst transfer to the destination, the GPDMA_CxDAR register is updated by adding the programmed offset GPDMA_CxTR3. (value: 0)
     *          - B_0x1: At the end of a programmed burst transfer to the destination, the GPDMA_CxDAR register is updated by subtracting the programmed offset GPDMA_CxTR3. (value: 1)
     */
        /** @brief At the end of a programmed burst transfer to the destination, the GPDMA_CxDAR register is updated by adding the programmed offset GPDMA_CxTR3. */
    constexpr std::uint32_t GPDMA_C6BR1_DDEC_B_0x0 = 0;
        /** @brief At the end of a programmed burst transfer to the destination, the GPDMA_CxDAR register is updated by subtracting the programmed offset GPDMA_CxTR3. */
    ...
    /** @details Possible values:
     *          - B_0x0: at the end of a block transfer, the GPDMA_CxSAR register is updated by adding the programmed offset GPDMA_CxBR2. (value: 0)
     *          - B_0x1: at the end of a block transfer, the GPDMA_CxSAR register is updated by subtracting the programmed offset GPDMA_CxBR2. (value: 1)
     */
        /** @brief at the end of a block transfer, the GPDMA_CxSAR register is updated by adding the programmed offset GPDMA_CxBR2. */
    constexpr std::uint32_t GPDMA_C6BR1_BRSDEC_B_0x0 = 0;
        /** @brief at the end of a block transfer, the GPDMA_CxSAR register is updated by subtracting the programmed offset GPDMA_CxBR2. */
    ...
    /** @details Possible values:
     *          - B_0x0: at the end of a block transfer, the GPDMA_CxDAR register is updated by adding the programmed offset GPDMA_CxBR2. (value: 0)
     *          - B_0x1: at the end of a block transfer, the GPDMA_CxDAR register is updated by subtracting the programmed offset GPDMA_CxBR2. (value: 1)
     */
        /** @brief at the end of a block transfer, the GPDMA_CxDAR register is updated by adding the programmed offset GPDMA_CxBR2. */
    constexpr std::uint32_t GPDMA_C6BR1_BRDDEC_B_0x0 = 0;
        /** @brief at the end of a block transfer, the GPDMA_CxDAR register is updated by subtracting the programmed offset GPDMA_CxBR2. */
