...
#ifndef EMBEDDED_PP_STM32H533_I2C3_S_HPP
#define EMBEDDED_PP_STM32H533_I2C3_S_HPP
...
namespace STM32H533::I2C3_S {
    ...
    /** @details Possible values:
     *          - B_0x0: The SMBus alert pin (SMBA) is not supported in host mode (SMBHEN = 1). (value: 0)
     *          - B_0x1: The SMBus alert pin is supported in host mode (SMBHEN = 1). (value: 1)
     */
        /** @brief The SMBus alert pin (SMBA) is not supported in host mode (SMBHEN = 1). */
    constexpr std::uint32_t I2C_CR1_ALERTEN_B_0x0 = 0;
        /** @brief The SMBus alert pin is supported in host mode (SMBHEN = 1). */
