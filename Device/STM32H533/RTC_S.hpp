...
#ifndef EMBEDDED_PP_STM32H533_RTC_S_HPP
#define EMBEDDED_PP_STM32H533_RTC_S_HPP
...
namespace STM32H533::RTC_S {
     ...
     *          - B_0x1: The synchronous binary counter (SS[31:0] in RTC_SSR) is running from 0xFFFF FFFF to RTC_ALRABINR. (value: 1)
     */
        /** @brief The synchronous binary counter (SS[31:0] in RTC_SSR) is free-running. */
    constexpr std::uint32_t RTC_ALRMASSR_SSCLR_B_0x0 = 0;
        /** @brief The synchronous binary counter (SS[31:0] in RTC_SSR) is running from 0xFFFF FFFF to RTC_ALRABINR. */
    ...
    /** @details Possible values:
     *          - B_0x0: The synchronous binary counter (SS[31:0] in RTC_SSR) is free-running. (value: 0)
     *          - B_0x1: The synchronous binary counter (SS[31:0] in RTC_SSR) is running from 0xFFFF FFFF to RTC_ALRBBINR. (value: 1)
     */
        /** @brief The synchronous binary counter (SS[31:0] in RTC_SSR) is free-running. */
    constexpr std::uint32_t RTC_ALRMBSSR_SSCLR_B_0x0 = 0;
        /** @brief The synchronous binary counter (SS[31:0] in RTC_SSR) is running from 0xFFFF FFFF to RTC_ALRBBINR. */
