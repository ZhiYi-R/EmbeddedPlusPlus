...
#ifndef EMBEDDED_PP_STM32H533_SPI2_S_HPP
#define EMBEDDED_PP_STM32H533_SPI2_S_HPP
...
namespace STM32H533::SPI2_S {
    ...
    /** @brief Iless thansup>2less than/sup>S standard selection */
    using SPI_I2SCFGR_I2SSTD = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Iless thansup>2less than/sup>S Philips standard. (value: 0)
     ...
     */
        /** @brief Iless thansup>2less than/sup>S Philips standard. */
    ...
    /** @details Possible values:
     *          - B_0x0: the signals generated by the SPI/I2S (i. (value: 0)
     *          - B_0x1: the signals generated by the SPI/I2S (i. (value: 1)
     */
        /** @brief the signals generated by the SPI/I2S (i. */
    ...
    /** @brief Iless thansup>2less than/sup>S linear prescaler */
