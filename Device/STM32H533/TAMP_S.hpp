...
#ifndef EMBEDDED_PP_STM32H533_TAMP_S_HPP
#define EMBEDDED_PP_STM32H533_TAMP_S_HPP
...
namespace STM32H533::TAMP_S {
    ...
    /** @brief Tamper detection on TAMP_IN8 enableless thansup>(1)less than/sup> */
    ...
    /** @brief Tamper 8 potential mode */
    using TAMP_CR2_TAMP8POM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Tamper 8 event detection is in confirmed modeless thansup>(1)less than/sup>. (value: 0)
     *          - B_0x1: Tamper 8 event detection is in potential modeless thansup>(2)less than/sup>. (value: 1)
     */
        /** @brief Tamper 8 event detection is in confirmed modeless thansup>(1)less than/sup>. */
    constexpr std::uint32_t TAMP_CR2_TAMP8POM_B_0x0 = 0;
        /** @brief Tamper 8 event detection is in potential modeless thansup>(2)less than/sup>. */
    constexpr std::uint32_t TAMP_CR2_TAMP8POM_B_0x1 = 1;
     ...
     *          - B_0x1: Tamper 1 event generates a trigger event. (value: 1)
     */
    ...
    constexpr std::uint32_t TAMP_CR2_TAMP1MSK_B_0x0 = 0;
        /** @brief Tamper 1 event generates a trigger event. */
     ...
     *          - B_0x1: Tamper 2 event generates a trigger event. (value: 1)
     */
    ...
    constexpr std::uint32_t TAMP_CR2_TAMP2MSK_B_0x0 = 0;
        /** @brief Tamper 2 event generates a trigger event. */
     ...
     *          - B_0x1: Tamper 3 event generates a trigger event. (value: 1)
     */
    ...
    constexpr std::uint32_t TAMP_CR2_TAMP3MSK_B_0x0 = 0;
        /** @brief Tamper 3 event generates a trigger event. */
    ...
    /** @details Possible values:
     *          - B_0x0: If TAMPFLT different to 00 tamper 8 input staying low triggers a tamper detection event. (value: 0)
     *          - B_0x1: If TAMPFLT different to 00 tamper 8 input staying high triggers a tamper detection event. (value: 1)
     */
        /** @brief If TAMPFLT different to 00 tamper 8 input staying low triggers a tamper detection event. */
    constexpr std::uint32_t TAMP_CR2_TAMP8TRG_B_0x0 = 0;
        /** @brief If TAMPFLT different to 00 tamper 8 input staying high triggers a tamper detection event. */
    ...
    /** @brief Internal tamper 12 potential mode */
    using TAMP_CR3_ITAMP12POM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Internal tamper 12 event detection is in confirmed modeless thansup>(1)less than/sup>. (value: 0)
     *          - B_0x1: Internal tamper 12 event detection is in potential modeless thansup>(2)less than/sup>. (value: 1)
     */
        /** @brief Internal tamper 12 event detection is in confirmed modeless thansup>(1)less than/sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP12POM_B_0x0 = 0;
        /** @brief Internal tamper 12 event detection is in potential modeless thansup>(2)less than/sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP12POM_B_0x1 = 1;

    /** @brief Internal tamper 13 potential mode */
    using TAMP_CR3_ITAMP13POM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Internal tamper 13 event detection is in confirmed modeless thansup>(1)less than/sup>. (value: 0)
     *          - B_0x1: Internal tamper 13 event detection is in potential modeless thansup>(2)less than/sup>. (value: 1)
     */
        /** @brief Internal tamper 13 event detection is in confirmed modeless thansup>(1)less than/sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP13POM_B_0x0 = 0;
        /** @brief Internal tamper 13 event detection is in potential modeless thansup>(2)less than/sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP13POM_B_0x1 = 1;

    /** @brief Internal tamper 15 potential mode */
    using TAMP_CR3_ITAMP15POM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Internal tamper 15 event detection is in confirmed modeless thansup>(1)less than/sup>. (value: 0)
     *          - B_0x1: Internal tamper 15 event detection is in potential modeless thansup>(2)less than/sup>. (value: 1)
     */
        /** @brief Internal tamper 15 event detection is in confirmed modeless thansup>(1)less than/sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP15POM_B_0x0 = 0;
        /** @brief Internal tamper 15 event detection is in potential modeless thansup>(2)less than/sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP15POM_B_0x1 = 1;
     ...
     *          - B_0x3: RTCCLK/8 is selected (value: 3)
     *          - B_0x4: RTCCLK/16 is selected (value: 4)
     *          - B_0x5: RTCCLK/32 is selected (value: 5)
     *          - B_0x6: RTCCLK/64 is selected (value: 6)
     *          - B_0x7: RTCCLK/128 is selected (value: 7)
     *          - B_0xB: RTCCLK/2048 is selected when (PREDIV_A+1) = 128 and (PREDIV_S+1) is a multiple of 16. (value: 11)
     */
    ...
    constexpr std::uint32_t TAMP_ATCR1_ATCKSEL_B_0x2 = 2;
        /** @brief RTCCLK/8 is selected */
    constexpr std::uint32_t TAMP_ATCR1_ATCKSEL_B_0x3 = 3;
        /** @brief RTCCLK/16 is selected */
    constexpr std::uint32_t TAMP_ATCR1_ATCKSEL_B_0x4 = 4;
        /** @brief RTCCLK/32 is selected */
    constexpr std::uint32_t TAMP_ATCR1_ATCKSEL_B_0x5 = 5;
        /** @brief RTCCLK/64 is selected */
    constexpr std::uint32_t TAMP_ATCR1_ATCKSEL_B_0x6 = 6;
        /** @brief RTCCLK/128 is selected */
    constexpr std::uint32_t TAMP_ATCR1_ATCKSEL_B_0x7 = 7;
        /** @brief RTCCLK/2048 is selected when (PREDIV_A+1) = 128 and (PREDIV_S+1) is a multiple of 16. */
    constexpr std::uint32_t TAMP_ATCR1_ATCKSEL_B_0xB = 11;
    ...
    /** @brief internal tamper 15 secure interrupt masked flag */
    ...
    /** @brief Clear ITAMP15 detection flag */
    ...
    /** @brief This register is read-only only and is incremented by one when a write access is done to this register. */
