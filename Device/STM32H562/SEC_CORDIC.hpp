...
#ifndef EMBEDDED_PP_STM32H562_SEC_CORDIC_HPP
#define EMBEDDED_PP_STM32H562_SEC_CORDIC_HPP
...
namespace STM32H562::SEC_CORDIC {
    ...
    /** @brief Function 2: Phase 3: Modulus 4: Arctangent 5: Hyperbolic cosine 6: Hyperbolic sine 7: Arctanh 8: Natural logarithm 9: Square Root */
    ...
    /** @brief Precision required (number of iterations) To determine the number of iterations needed for a given accuracy refer to . Note that for most functions, the recommended range for this field is 3 to 6. */
    using CORDIC_CSR_PRECISION = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x1: (Number of iterations)/4 (value: 1)
     *          - B_0x2: (Number of iterations)/4 (value: 2)
     *          - B_0x3: (Number of iterations)/4 (value: 3)
     *          - B_0x4: (Number of iterations)/4 (value: 4)
     *          - B_0x5: (Number of iterations)/4 (value: 5)
     *          - B_0x6: (Number of iterations)/4 (value: 6)
     *          - B_0x7: (Number of iterations)/4 (value: 7)
     *          - B_0x8: (Number of iterations)/4 (value: 8)
     *          - B_0x9: (Number of iterations)/4 (value: 9)
     *          - B_0xa: (Number of iterations)/4 (value: 10)
     *          - B_0xb: (Number of iterations)/4 (value: 11)
     *          - B_0xc: (Number of iterations)/4 (value: 12)
     *          - B_0xd: (Number of iterations)/4 (value: 13)
     *          - B_0xe: (Number of iterations)/4 (value: 14)
     *          - B_0xf: (Number of iterations)/4 (value: 15)
     */
        /** @brief (Number of iterations)/4 */
    constexpr std::uint32_t CORDIC_CSR_PRECISION_B_0x1 = 1;
        /** @brief (Number of iterations)/4 */
    constexpr std::uint32_t CORDIC_CSR_PRECISION_B_0x2 = 2;
        /** @brief (Number of iterations)/4 */
    constexpr std::uint32_t CORDIC_CSR_PRECISION_B_0x3 = 3;
        /** @brief (Number of iterations)/4 */
    constexpr std::uint32_t CORDIC_CSR_PRECISION_B_0x4 = 4;
        /** @brief (Number of iterations)/4 */
    constexpr std::uint32_t CORDIC_CSR_PRECISION_B_0x5 = 5;
        /** @brief (Number of iterations)/4 */
    constexpr std::uint32_t CORDIC_CSR_PRECISION_B_0x6 = 6;
        /** @brief (Number of iterations)/4 */
    constexpr std::uint32_t CORDIC_CSR_PRECISION_B_0x7 = 7;
        /** @brief (Number of iterations)/4 */
    constexpr std::uint32_t CORDIC_CSR_PRECISION_B_0x8 = 8;
        /** @brief (Number of iterations)/4 */
    constexpr std::uint32_t CORDIC_CSR_PRECISION_B_0x9 = 9;
        /** @brief (Number of iterations)/4 */
    constexpr std::uint32_t CORDIC_CSR_PRECISION_B_0xa = 10;
        /** @brief (Number of iterations)/4 */
    constexpr std::uint32_t CORDIC_CSR_PRECISION_B_0xb = 11;
        /** @brief (Number of iterations)/4 */
    constexpr std::uint32_t CORDIC_CSR_PRECISION_B_0xc = 12;
        /** @brief (Number of iterations)/4 */
    constexpr std::uint32_t CORDIC_CSR_PRECISION_B_0xd = 13;
        /** @brief (Number of iterations)/4 */
    constexpr std::uint32_t CORDIC_CSR_PRECISION_B_0xe = 14;
        /** @brief (Number of iterations)/4 */
    constexpr std::uint32_t CORDIC_CSR_PRECISION_B_0xf = 15;

    /** @brief Scaling factor The value of this field indicates the scaling factor applied to the arguments and/or results. A value n implies that the arguments have been multiplied by a factor 2-n, and/or the results need to be multiplied by 2n. Refer to for the applicability of the scaling factor for each function and the appropriate range. */
    ...
    /** @details Possible values:
     *          - B_0x0: No new result in output register (value: 0)
     *          - B_0x1: CORDIC_RDATA register contains new data. (value: 1)
     */
        /** @brief No new result in output register */
