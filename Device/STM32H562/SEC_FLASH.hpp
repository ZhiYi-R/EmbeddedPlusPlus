...
#ifndef EMBEDDED_PP_STM32H562_SEC_FLASH_HPP
#define EMBEDDED_PP_STM32H562_SEC_FLASH_HPP
...
namespace STM32H562::SEC_FLASH {
    ...
    /** @brief High-speed IO at low V DD voltage configuration bit. This bit can be set only with V DD below 2.7V. */
    ...
    /** @details Possible values:
     *          - B_0x0: High-speed IO at low V DD voltage feature disabled (V DD can exceed 2.7V) (value: 0)
     *          - B_0x1: High-speed IO at low V DD voltage feature enabled (V DD remains below 2.7V) (value: 1)
     */
        /** @brief High-speed IO at low V DD voltage feature disabled (V DD can exceed 2.7V) */
    constexpr std::uint32_t FLASH_OPTSR_CUR_IO_VDD_HSLV_B_0x0 = 0;
        /** @brief High-speed IO at low V DD voltage feature enabled (V DD remains below 2.7V) */
    constexpr std::uint32_t FLASH_OPTSR_CUR_IO_VDD_HSLV_B_0x1 = 1;

    /** @brief High-speed IO at low V DDIO2 voltage configuration bit. This bit can be set only with V DDIO2 below 2.7V. */
    ...
    /** @details Possible values:
     *          - B_0x0: High-speed IO at low V DDIO2 voltage feature disabled (V DDIO2 can exceed 2.7V) (value: 0)
     *          - B_0x1: High-speed IO at low V DDIO2 voltage feature enabled (V DDIO2 remains below 2.7V) (value: 1)
     */
        /** @brief High-speed IO at low V DDIO2 voltage feature disabled (V DDIO2 can exceed 2.7V) */
    constexpr std::uint32_t FLASH_OPTSR_CUR_IO_VDDIO2_HSLV_B_0x0 = 0;
        /** @brief High-speed IO at low V DDIO2 voltage feature enabled (V DDIO2 remains below 2.7V) */
