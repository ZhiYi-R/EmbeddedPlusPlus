...
#ifndef EMBEDDED_PP_STM32H562_SEC_PWR_HPP
#define EMBEDDED_PP_STM32H562_SEC_PWR_HPP
...
namespace STM32H562::SEC_PWR {
    ...
    /** @brief V DDUSB voltage level detector enable */
    using PWR_USBSCR_USB33DEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V DDUSB voltage level detector disabled (value: 0)
     *          - B_0x1: V DDUSB voltage level detector enabled (value: 1)
     */
        /** @brief V DDUSB voltage level detector disabled */
    constexpr std::uint32_t PWR_USBSCR_USB33DEN_B_0x0 = 0;
        /** @brief V DDUSB voltage level detector enabled */
    constexpr std::uint32_t PWR_USBSCR_USB33DEN_B_0x1 = 1;

    /** @brief independent USB supply valid This bit is used to validate the V DDUSB supply for electrical and logical isolation purpose. Setting this bit is mandatory to use the USBFS peripheral. If V DDUSB is not always present in the application, the V DDUSB voltage monitor can be used to determine whether this supply is ready or not. */
    using PWR_USBSCR_USB33SV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V DDUSB is not present. Logical and electrical isolation is applied to ignore this supply. (value: 0)
     *          - B_0x1: V DDUSB is valid. (value: 1)
     */
        /** @brief V DDUSB is not present. Logical and electrical isolation is applied to ignore this supply. */
    constexpr std::uint32_t PWR_USBSCR_USB33SV_B_0x0 = 0;
        /** @brief V DDUSB is valid. */
    ...
    /** @details Possible values:
     *          - B_0x0: V DDUSB is below the threshold of the V DDUSB voltage monitor. (value: 0)
     *          - B_0x1: V DDUSB is equal or above the threshold of the V DDUSB voltage monitor. (value: 1)
     */
        /** @brief V DDUSB is below the threshold of the V DDUSB voltage monitor. */
    constexpr std::uint32_t PWR_VMSR_USB33RDY_B_0x0 = 0;
        /** @brief V DDUSB is equal or above the threshold of the V DDUSB voltage monitor. */
