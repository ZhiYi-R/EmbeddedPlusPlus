...
#ifndef EMBEDDED_PP_STM32H562_SEC_SAI2_HPP
#define EMBEDDED_PP_STM32H562_SEC_SAI2_HPP
...
namespace STM32H562::SEC_SAI2 {
     ...
     *          - B_0x1: FIFO less than or equalbut not empty (transmitter mode), FIFO but not empty (receiver mode) (value: 1)
     *          - B_0x2: FIFO less than or equal one half (transmitter mode),less than or equal FIFO(receiver mode) (value: 2)
     *          - B_0x3: one half FIFO less than or equal 3/4(transmitter mode), one half less than or equal FIFO(receiver mode) (value: 3)
     *          - B_0x4: 3/4 FIFO but not full (transmitter mode), 3/4less than or equal FIFO but not full (receiver mode) (value: 4)
    ...
    constexpr std::uint32_t SAI_ASR_FLVL_B_0x0 = 0;
        /** @brief FIFO less than or equalbut not empty (transmitter mode), FIFO but not empty (receiver mode) */
    constexpr std::uint32_t SAI_ASR_FLVL_B_0x1 = 1;
        /** @brief FIFO less than or equal one half (transmitter mode),less than or equal FIFO(receiver mode) */
    constexpr std::uint32_t SAI_ASR_FLVL_B_0x2 = 2;
        /** @brief one half FIFO less than or equal 3/4(transmitter mode), one half less than or equal FIFO(receiver mode) */
    constexpr std::uint32_t SAI_ASR_FLVL_B_0x3 = 3;
        /** @brief 3/4 FIFO but not full (transmitter mode), 3/4less than or equal FIFO but not full (receiver mode) */
     ...
     *          - B_0x1: FIFO less than or equalbut not empty (transmitter mode), FIFO but not empty (receiver mode) (value: 1)
     *          - B_0x2: FIFO less than or equal one half (transmitter mode),less than or equal FIFO(receiver mode) (value: 2)
     *          - B_0x3: one half FIFO less than or equal 3/4(transmitter mode), one half less than or equal FIFO 3/4(receiver mode) (value: 3)
     *          - B_0x4: 3/4 FIFO but not full (transmitter mode), 3/4less than or equal FIFO but not full (receiver mode) (value: 4)
     *          - B_0x5: FIFO full (transmitter and receiver modes) (value: 5)
     */
        /** @brief FIFO empty (transmitter and receiver modes) */
    ...
    constexpr std::uint32_t SAI_BSR_FLVL_B_0x2 = 2;
        /** @brief one half FIFO less than or equal 3/4(transmitter mode), one half less than or equal FIFO 3/4(receiver mode) */
