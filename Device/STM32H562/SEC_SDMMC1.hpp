...
#ifndef EMBEDDED_PP_STM32H562_SEC_SDMMC1_HPP
#define EMBEDDED_PP_STM32H562_SEC_SDMMC1_HPP
...
namespace STM32H562::SEC_SDMMC1 {
    ...
    /** @brief CPSM waits for end of data transfer (CmdPend internal signal) from DPSM This bit when set, the CPSM waits for the end of data transfer trigger before it starts sending a command. */
    ...
    /** @brief Data transfer enable bit This bit can only be written by firmware when DPSM is inactive (DPSMACT = 0). This bit is cleared by Hardware when data transfer completes. */
