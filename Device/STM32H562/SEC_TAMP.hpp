...
#ifndef EMBEDDED_PP_STM32H562_SEC_TAMP_HPP
#define EMBEDDED_PP_STM32H562_SEC_TAMP_HPP
...
namespace STM32H562::SEC_TAMP {
    ...
    /** @brief Backup registers and device secrets erase Writing '1' to this bit reset the backup registers and device secrets(1). Writing 0 has no effect. This bit is always read as 0. */
    ...
    /** @details Possible values:
     *          - B_0x0: If TAMPFLT different 00 Tamper 7 input staying low triggers a tamper detection event. (value: 0)
     *          - B_0x1: If TAMPFLT different 00 Tamper 7 input staying high triggers a tamper detection event. (value: 1)
     */
        /** @brief If TAMPFLT different 00 Tamper 7 input staying low triggers a tamper detection event. */
    constexpr std::uint32_t TAMP_CR2_TAMP7TRG_B_0x0 = 0;
        /** @brief If TAMPFLT different 00 Tamper 7 input staying high triggers a tamper detection event. */
    ...
    /** @details Possible values:
     *          - B_0x0: If TAMPFLT different 00 Tamper 8 input staying low triggers a tamper detection event. (value: 0)
     *          - B_0x1: If TAMPFLT different 00 Tamper 8 input staying high triggers a tamper detection event. (value: 1)
     */
        /** @brief If TAMPFLT different 00 Tamper 8 input staying low triggers a tamper detection event. */
    constexpr std::uint32_t TAMP_CR2_TAMP8TRG_B_0x0 = 0;
        /** @brief If TAMPFLT different 00 Tamper 8 input staying high triggers a tamper detection event. */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal Tamper 4 event erases the backup registers and all device secrets(1). (value: 0)
     *          - B_0x1: Internal Tamper 4 event does not erase the backup registers and device secrets(2). (value: 1)
     */
        /** @brief Internal Tamper 4 event erases the backup registers and all device secrets(1). */
    constexpr std::uint32_t TAMP_CR3_ITAMP4NOER_B_0x0 = 0;
        /** @brief Internal Tamper 4 event does not erase the backup registers and device secrets(2). */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal Tamper 15 event erases the backup registers and all device secrets(1). (value: 0)
     *          - B_0x1: Internal Tamper 15 event does not erase the backup registers and device secrets(2). (value: 1)
     */
        /** @brief Internal Tamper 15 event erases the backup registers and all device secrets(1). */
    constexpr std::uint32_t TAMP_CR3_ITAMP15NOER_B_0x0 = 0;
        /** @brief Internal Tamper 15 event does not erase the backup registers and device secrets(2). */
    ...
    /** @brief Backup registers read/write protection offset Protection zone 1 is defined for backup registers from TAMP_BKP0R to TAMP_BKPxR (x = BKPRWSEC-1, from 0 to 128). if TZEN=1, these backup registers can be read and written only with secure access. If TZEN=0:	the protection zone 1 can be read and written with non-secure access. If BKPRWSEC = 0: there is no protection zone 1. If BKPRWPRIV is set, BKPRWSEC[7:0] can be written only in privileged mode. */
    ...
    /** @brief Backup registers write protection offset Protection zone 2 is defined for backup registers from TAMP_BKPyR (y = BKPRWSEC, from 0 to 128) to TAMP_BKPzR (z = BKPWSEC-1, from 0 to 128, BKPWSEC greater than or equal BKPRWSEC): if TZEN=1, these backup registers can be written only with secure access. They can be read with secure or non-secure access. Protection zone 3 defined for backup registers from TAMP_BKPtR (t = BKPWSEC, from 0 to 127). They can be read or written with secure or non-secure access. If TZEN=0:	the protection zone 2 can be read and written with non-secure access. If BKPWSEC = 0 or if BKPWSEC less than or equal BKPRWSEC: there is no protection zone 2. If BKPWPRIV is set, BKPRWSEC[7:0] can be written only in privileged mode. */
    ...
    /** @brief Tamper protection (excluding monotonic counters and backup registers) Note: Refer to for details on the read protection. */
    ...
    /** @brief Tamper privilege protection (excluding backup registers) Note: Refer to for details on the read protection. */
    ...
    /** @brief TAMP7 non-secure interrupt masked flag This flag is set by hardware when the tamper 7 non-secure interrupt is raised. */
    using TAMP_MISR_TAMP7MF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TAMP8 non-secure interrupt masked flag This flag is set by hardware when the tamper 8 non-secure interrupt is raised. */
    using TAMP_MISR_TAMP8MF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Internal tamper 1 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 1 non-secure interrupt is raised. */
    using TAMP_MISR_ITAMP1MF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Internal tamper 2 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 2 non-secure interrupt is raised. */
    ...
    /** @brief Internal tamper 4 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 4 non-secure interrupt is raised. */
    ...
    /** @brief internal tamper 15 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 15 non-secure interrupt is raised. */
    ...
    /** @brief TAMP7 secure interrupt masked flag This flag is set by hardware when the tamper 7 secure interrupt is raised. */
    using TAMP_SMISR_TAMP7MF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TAMP8 secure interrupt masked flag This flag is set by hardware when the tamper 8 secure interrupt is raised. */
    using TAMP_SMISR_TAMP8MF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Internal tamper 1 secure interrupt masked flag This flag is set by hardware when the internal tamper 1 secure interrupt is raised. */
    using TAMP_SMISR_ITAMP1MF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Internal tamper 2 secure interrupt masked flag This flag is set by hardware when the internal tamper 2 secure interrupt is raised. */
    ...
    /** @brief Internal tamper 4 secure interrupt masked flag This flag is set by hardware when the internal tamper 4 secure interrupt is raised. */
    ...
    /** @brief internal tamper 15 secure interrupt masked flag This flag is set by hardware when the internal tamper 15 secure interrupt is raised. */
    using TAMP_SMISR_ITAMP15MF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TAMP_OR_OUT3_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: TAMP_OUT3 is on PC13 (value: 0)
     *          - B_0x1: TAMP_OUT3 is on PI8 (value: 1)
     *          - B_0x2: TAMP_OUT3 is on PE3 (value: 2)
     *          - B_0x3: TAMP_OUT3 is on PA2 (value: 3)
     */
        /** @brief TAMP_OUT3 is on PC13 */
    constexpr std::uint32_t TAMP_OR_OUT3_RMP_B_0x0 = 0;
        /** @brief TAMP_OUT3 is on PI8 */
    constexpr std::uint32_t TAMP_OR_OUT3_RMP_B_0x1 = 1;
        /** @brief TAMP_OUT3 is on PE3 */
    constexpr std::uint32_t TAMP_OR_OUT3_RMP_B_0x2 = 2;
        /** @brief TAMP_OUT3 is on PA2 */
    constexpr std::uint32_t TAMP_OR_OUT3_RMP_B_0x3 = 3;

    /** @brief TAMP_OUT5 mapping */
    using TAMP_OR_OUT5_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: TAMP_OUT5 is on PI11 (value: 0)
     *          - B_0x1: TAMP_OUT5 is on PC1 (value: 1)
     */
        /** @brief TAMP_OUT5 is on PI11 */
    constexpr std::uint32_t TAMP_OR_OUT5_RMP_B_0x0 = 0;
        /** @brief TAMP_OUT5 is on PC1 */
    constexpr std::uint32_t TAMP_OR_OUT5_RMP_B_0x1 = 1;

    /** @brief TAMP_IN2 mapping */
    using TAMP_OR_IN2_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: TAMP_IN2 is on PA0 (value: 0)
     *          - B_0x1: TAMP_IN2 is on PI8 (value: 1)
     */
        /** @brief TAMP_IN2 is on PA0 */
    constexpr std::uint32_t TAMP_OR_IN2_RMP_B_0x0 = 0;
        /** @brief TAMP_IN2 is on PI8 */
    constexpr std::uint32_t TAMP_OR_IN2_RMP_B_0x1 = 1;

    /** @brief TAMP_IN3 mapping */
    using TAMP_OR_IN3_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: TAMP_IN3 is on PC1 (value: 0)
     *          - B_0x1: TAMP_IN3 is on PE6 (value: 1)
     */
        /** @brief TAMP_IN3 is on PC1 */
    constexpr std::uint32_t TAMP_OR_IN3_RMP_B_0x0 = 0;
        /** @brief TAMP_IN3 is on PE6 */
    constexpr std::uint32_t TAMP_OR_IN3_RMP_B_0x1 = 1;

    /** @brief TAMP_IN4 mapping */
    using TAMP_OR_IN4_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: TAMP_IN4 is on PA2 (value: 0)
     *          - B_0x1: TAMP_IN4 is on PI11 (value: 1)
     */
        /** @brief TAMP_IN4 is on PA2 */
    constexpr std::uint32_t TAMP_OR_IN4_RMP_B_0x0 = 0;
        /** @brief TAMP_IN4 is on PI11 */
    constexpr std::uint32_t TAMP_OR_IN4_RMP_B_0x1 = 1;
