...
#ifndef EMBEDDED_PP_STM32H562_SEC_TIM1_HPP
#define EMBEDDED_PP_STM32H562_SEC_TIM1_HPP
...
namespace STM32H562::SEC_TIM1 {
    ...
    /** @brief Clock division This bit-field indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (t DTS )used by the dead-time generators and the digital filters (tim_etr_in, tim_tix), */
    using TIM1_CR1_CKD = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: t DTS =t tim_ker_ck (value: 0)
     *          - B_0x1: t DTS =2*t tim_ker_ck (value: 1)
     *          - B_0x2: t DTS =4*t tim_ker_ck (value: 2)
     *          - B_0x3: Reserved, do not program this value (value: 3)
     */
        /** @brief t DTS =t tim_ker_ck */
    constexpr std::uint16_t TIM1_CR1_CKD_B_0x0 = 0;
        /** @brief t DTS =2*t tim_ker_ck */
    constexpr std::uint16_t TIM1_CR1_CKD_B_0x1 = 1;
        /** @brief t DTS =4*t tim_ker_ck */
    ...
    /** @details Possible values:
     *          - B_0x0: No filter, sampling is done at f DTS (value: 0)
     *          - B_0x1: f SAMPLING =f tim_ker_ck , N=2 (value: 1)
     *          - B_0x2: f SAMPLING =f tim_ker_ck , N=4 (value: 2)
     *          - B_0x3: f SAMPLING =f tim_ker_ck , N=8 (value: 3)
     *          - B_0x4: f SAMPLING =f DTS /2, N=6 (value: 4)
     *          - B_0x5: f SAMPLING =f DTS /2, N=8 (value: 5)
     *          - B_0x6: f SAMPLING =f DTS /4, N=6 (value: 6)
     *          - B_0x7: f SAMPLING =f DTS /4, N=8 (value: 7)
     *          - B_0x8: f SAMPLING =f DTS /8, N=6 (value: 8)
     *          - B_0x9: f SAMPLING =f DTS /8, N=8 (value: 9)
     *          - B_0xA: f SAMPLING =f DTS /16, N=5 (value: 10)
     *          - B_0xB: f SAMPLING =f DTS /16, N=6 (value: 11)
     *          - B_0xC: f SAMPLING =f DTS /16, N=8 (value: 12)
     *          - B_0xD: f SAMPLING =f DTS /32, N=5 (value: 13)
     *          - B_0xE: f SAMPLING =f DTS /32, N=6 (value: 14)
     *          - B_0xF: f SAMPLING =f DTS /32, N=8 (value: 15)
     */
        /** @brief No filter, sampling is done at f DTS */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x0 = 0;
        /** @brief f SAMPLING =f tim_ker_ck , N=2 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x1 = 1;
        /** @brief f SAMPLING =f tim_ker_ck , N=4 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x2 = 2;
        /** @brief f SAMPLING =f tim_ker_ck , N=8 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x3 = 3;
        /** @brief f SAMPLING =f DTS /2, N=6 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x4 = 4;
        /** @brief f SAMPLING =f DTS /2, N=8 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x5 = 5;
        /** @brief f SAMPLING =f DTS /4, N=6 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x6 = 6;
        /** @brief f SAMPLING =f DTS /4, N=8 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x7 = 7;
        /** @brief f SAMPLING =f DTS /8, N=6 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x8 = 8;
        /** @brief f SAMPLING =f DTS /8, N=8 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x9 = 9;
        /** @brief f SAMPLING =f DTS /16, N=5 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0xA = 10;
        /** @brief f SAMPLING =f DTS /16, N=6 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0xB = 11;
        /** @brief f SAMPLING =f DTS /16, N=8 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0xC = 12;
        /** @brief f SAMPLING =f DTS /32, N=5 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0xD = 13;
        /** @brief f SAMPLING =f DTS /32, N=6 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0xE = 14;
        /** @brief f SAMPLING =f DTS /32, N=8 */
     ...
     *          - B_0x6: PWM mode 1 In upcounting, channel 3 is active as long as TIMx_CNTTIMx_CCR3 else inactive. In downcounting, channel 3 is inactive (tim_oc3ref='0') as long as TIMx_CNT TIMx_CCR3 else active (tim_oc3ref='1'). (value: 6)
     *          - B_0x7: PWM mode 2 In upcounting, channel 3 is inactive as long as TIMx_CNTTIMx_CCR3 else active. In downcounting, channel 3 is active as long as TIMx_CNT TIMx_CCR3 else inactive. (value: 7)
     */
    ...
    constexpr std::uint32_t TIM1_CCMR2_Output_OC3M_B_0x5 = 5;
        /** @brief PWM mode 1 In upcounting, channel 3 is active as long as TIMx_CNTTIMx_CCR3 else inactive. In downcounting, channel 3 is inactive (tim_oc3ref='0') as long as TIMx_CNT TIMx_CCR3 else active (tim_oc3ref='1'). */
    constexpr std::uint32_t TIM1_CCMR2_Output_OC3M_B_0x6 = 6;
        /** @brief PWM mode 2 In upcounting, channel 3 is inactive as long as TIMx_CNTTIMx_CCR3 else active. In downcounting, channel 3 is active as long as TIMx_CNT TIMx_CCR3 else inactive. */
    ...
    /** @brief Pulse width This bitfield defines the pulse duration, as following: t PW = PW[7:0] x t PWG */
    using TIM1_ECR_PW = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: t PWG = (2sup (PWPRSC[2:0])/sup ) x t tim_ker_ck */
