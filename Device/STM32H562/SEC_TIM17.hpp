...
#ifndef EMBEDDED_PP_STM32H562_SEC_TIM17_HPP
#define EMBEDDED_PP_STM32H562_SEC_TIM17_HPP
...
namespace STM32H562::SEC_TIM17 {
    ...
    using TIM17_DIER_COMDE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COM DMA request disabled (value: 0)
     *          - B_0x1: COM DMA request enabled (value: 1)
     */
        /** @brief COM DMA request disabled */
    constexpr std::uint16_t TIM17_DIER_COMDE_B_0x0 = 0;
        /** @brief COM DMA request enabled */
    constexpr std::uint16_t TIM17_DIER_COMDE_B_0x1 = 1;
    ...
    using TIM17_CCMR1_Output_OC1M1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_CCMR1_Output_OC1M1_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM17_CCMR1_Output_OC1M1_B_0x1 = 1;
    ...
    constexpr std::uint32_t TIM17_CCMR1_Output_OC1M1_B_0x2 = 2;
        /** @brief Toggle tim_oc1ref toggles when TIMx_CNT=TIMx_CCR1. */
    constexpr std::uint32_t TIM17_CCMR1_Output_OC1M1_B_0x3 = 3;
        /** @brief Force inactive level tim_oc1ref is forced low. */
    constexpr std::uint32_t TIM17_CCMR1_Output_OC1M1_B_0x4 = 4;
        /** @brief Force active level tim_oc1ref is forced high. */
    constexpr std::uint32_t TIM17_CCMR1_Output_OC1M1_B_0x5 = 5;
        /** @brief PWM mode 1 Channel 1 is active as long as TIMx_CNTTIMx_CCR1 else inactive. */
    constexpr std::uint32_t TIM17_CCMR1_Output_OC1M1_B_0x6 = 6;
        /** @brief PWM mode 2 Channel 1 is inactive as long as TIMx_CNTTIMx_CCR1 else active. */
    constexpr std::uint32_t TIM17_CCMR1_Output_OC1M1_B_0x7 = 7;
    ...
    /** @brief Output Compare 1 mode These bits define the behavior of the output reference signal tim_oc1ref from which tim_oc1 and tim_oc1n are derived. tim_oc1ref is active high whereas tim_oc1 and tim_oc1n active level depends on CC1P and CC1NP bits. Others: Reserved Note: These bits can not be modified as long as LOCK level 3 has been programmed (LOCK bits in TIMx_BDTR register) and CC1S='00' (the channel is configured in output). In PWM mode 1 or 2, the tim_oc1ref level changes only when the result of the comparison changes or when the output compare mode switches from 'frozen' mode to 'PWM' mode. */
    using TIM17_CCMR1_Output_OC1M2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Frozen The comparison between the output compare register TIMx_CCR1 and the counter TIMx_CNT has no effect on the outputs. (value: 0)
     *          - B_0x1: Set channel 1 to active level on match. tim_oc1ref signal is forced high when the counter TIMx_CNT matches the capture/compare register 1 (TIMx_CCR1). (value: 1)
     */
        /** @brief Frozen The comparison between the output compare register TIMx_CCR1 and the counter TIMx_CNT has no effect on the outputs. */
    constexpr std::uint32_t TIM17_CCMR1_Output_OC1M2_B_0x0 = 0;
        /** @brief Set channel 1 to active level on match. tim_oc1ref signal is forced high when the counter TIMx_CNT matches the capture/compare register 1 (TIMx_CCR1). */
    constexpr std::uint32_t TIM17_CCMR1_Output_OC1M2_B_0x1 = 1;
    ...
    /** @brief RTCPRE divider enable */
    using TIM17_OR1_RTCPREEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    constexpr std::uint32_t TIM17_DCR_DBSS_B_0x2 = 2;
        /** @brief CC2 */
    constexpr std::uint32_t TIM17_DCR_DBSS_B_0x3 = 3;
        /** @brief CC3 */
    constexpr std::uint32_t TIM17_DCR_DBSS_B_0x4 = 4;
        /** @brief CC4 */
    constexpr std::uint32_t TIM17_DCR_DBSS_B_0x5 = 5;
        /** @brief COM */
    constexpr std::uint32_t TIM17_DCR_DBSS_B_0x6 = 6;
        /** @brief Trigger */
    constexpr std::uint32_t TIM17_DCR_DBSS_B_0x7 = 7;
