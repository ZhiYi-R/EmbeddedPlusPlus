...
#ifndef EMBEDDED_PP_STM32H562_SEC_TIM4_HPP
#define EMBEDDED_PP_STM32H562_SEC_TIM4_HPP
...
namespace STM32H562::SEC_TIM4 {
     ...
     *          - B_0x6: PWM mode 1 In upcounting, channel 1 is active as long as TIMx_CNTTIMx_CCR1 else inactive. In downcounting, channel 1 is inactive (tim_oc1ref=0) as long as TIMx_CNT TIMx_CCR1 else active (tim_oc1ref=1). (value: 6)
     *          - B_0x7: PWM mode 2 In upcounting, channel 1 is inactive as long as TIMx_CNTTIMx_CCR1 else active. In downcounting, channel 1 is active as long as TIMx_CNT TIMx_CCR1 else inactive. (value: 7)
     */
    ...
    constexpr std::uint32_t TIM4_CCMR1_Output_OC1M1_B_0x5 = 5;
        /** @brief PWM mode 1 In upcounting, channel 1 is active as long as TIMx_CNTTIMx_CCR1 else inactive. In downcounting, channel 1 is inactive (tim_oc1ref=0) as long as TIMx_CNT TIMx_CCR1 else active (tim_oc1ref=1). */
    constexpr std::uint32_t TIM4_CCMR1_Output_OC1M1_B_0x6 = 6;
        /** @brief PWM mode 2 In upcounting, channel 1 is inactive as long as TIMx_CNTTIMx_CCR1 else active. In downcounting, channel 1 is active as long as TIMx_CNT TIMx_CCR1 else inactive. */
