...
#ifndef EMBEDDED_PP_STM32H562_SEC_WWDG_HPP
#define EMBEDDED_PP_STM32H562_SEC_WWDG_HPP
...
namespace STM32H562::SEC_WWDG {
    ...
    /** @brief 7-bit counter (MSB to LSB) These bits contain the value of the watchdog counter, decremented every (4096 x 2WDGTB[2:0]) PCLK cycles. A reset is produced when it is decremented from 0x40 to 0x3F (T6 becomes cleared). */
