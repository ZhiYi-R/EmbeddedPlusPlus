...
#ifndef EMBEDDED_PP_STM32H563_DBGMCU_HPP
#define EMBEDDED_PP_STM32H563_DBGMCU_HPP
...
namespace STM32H563::DBGMCU {
     ...
     *          - B_0x484: STM32H563/H573 and STM32H562 (value: 1156)
     */
        /** @brief STM32H563/H573 and STM32H562 */
    ...
    /** @details Possible values:
     *          - B_0x0: disabledtrace pins not assigned (value: 0)
     *          - B_0x1: enabledtrace pins assigned according to the value of TRACE_MODE field (value: 1)
     */
        /** @brief disabledtrace pins not assigned */
    constexpr std::uint32_t DBGMCU_CR_TRACE_IOEN_B_0x0 = 0;
        /** @brief enabledtrace pins assigned according to the value of TRACE_MODE field */
     ...
     *          - B_0x1: stop in debug. TIM4 is frozen while CPU is in debug mode. (value: 1)
     */
    ...
    constexpr std::uint32_t DBGMCU_APB1LFZR_DBG_TIM4_STOP_B_0x0 = 0;
        /** @brief stop in debug. TIM4 is frozen while CPU is in debug mode. */
    ...
    /** @details Possible values:
     *          - B_0x0: normal operation. TIM5 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: Stop in debug. TIM5 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. TIM5 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_APB1LFZR_DBG_TIM5_STOP_B_0x0 = 0;
        /** @brief Stop in debug. TIM5 is frozen while CPU is in debug mode. */
    ...
    /** @details Possible values:
     *          - B_0x0: normal operation. TIM12 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. TIM12 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. TIM12 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_APB1LFZR_DBG_TIM12_STOP_B_0x0 = 0;
        /** @brief stop in debug. TIM12 is frozen while CPU is in debug mode. */
    ...
    /** @details Possible values:
     *          - B_0x0: normal operation. TIM13 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. TIM13 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. TIM13 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_APB1LFZR_DBG_TIM13_STOP_B_0x0 = 0;
        /** @brief stop in debug. TIM13 is frozen while CPU is in debug mode. */
    ...
    /** @details Possible values:
     *          - B_0x0: normal operation. TIM8 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. TIM8 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. TIM8 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_APB2FZR_DBG_TIM8_STOP_B_0x0 = 0;
        /** @brief stop in debug. TIM8 is frozen while CPU is in debug mode. */
    ...
    /** @details Possible values:
     *          - B_0x0: normal operation. I2C3 SMBUS timeout counter continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. I2C3 SMBUS timeout counter is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. I2C3 SMBUS timeout counter continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_APB3FZR_DBG_I2C3_STOP_B_0x0 = 0;
        /** @brief stop in debug. I2C3 SMBUS timeout counter is frozen while CPU is in debug mode. */
    ...
    /** @details Possible values:
     *          - B_0x0: normal operation. I2C4 SMBUS timeout counter continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. I2C4 SMBUS timeout counter is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. I2C4 SMBUS timeout counter continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_APB3FZR_DBG_I2C4_STOP_B_0x0 = 0;
        /** @brief stop in debug. I2C4 SMBUS timeout counter is frozen while CPU is in debug mode. */
    ...
    /** @details Possible values:
     *          - B_0x0: normal operation. LPTIM4 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. LPTIM4 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. LPTIM4 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_APB3FZR_DBG_LPTIM4_STOP_B_0x0 = 0;
        /** @brief stop in debug. LPTIM4 is frozen while CPU is in debug mode. */
    ...
    /** @details Possible values:
     *          - B_0x0: normal operation. LPTIM5 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. LPTIM5 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. LPTIM5 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_APB3FZR_DBG_LPTIM5_STOP_B_0x0 = 0;
        /** @brief stop in debug. LPTIM5 is frozen while CPU is in debug mode. */
    ...
    /** @details Possible values:
     *          - B_0x0: normal operation. LPTIM6 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. LPTIM6 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. LPTIM6 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_APB3FZR_DBG_LPTIM6_STOP_B_0x0 = 0;
        /** @brief stop in debug. LPTIM6 is frozen while CPU is in debug mode. */
    ...
    /** @brief GPDMA1 channel 8 stop in debug */
    using DBGMCU_AHB1FZR_DBG_GPDMA1_8_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: normal operation. GPDMA1 channel 8 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. GPDMA1 channel 8 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. GPDMA1 channel 8 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA1_8_STOP_B_0x0 = 0;
        /** @brief stop in debug. GPDMA1 channel 8 is frozen while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA1_8_STOP_B_0x1 = 1;

    /** @brief GPDMA1 channel 9 stop in debug */
    using DBGMCU_AHB1FZR_DBG_GPDMA1_9_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: normal operation. GPDMA1 channel 9 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. GPDMA1 channel 9 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. GPDMA1 channel 9 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA1_9_STOP_B_0x0 = 0;
        /** @brief stop in debug. GPDMA1 channel 9 is frozen while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA1_9_STOP_B_0x1 = 1;

    /** @brief GPDMA1 channel 10 stop in debug */
    using DBGMCU_AHB1FZR_DBG_GPDMA1_10_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: normal operation. GPDMA1 channel 10 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. GPDMA1 channel 10 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. GPDMA1 channel 10 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA1_10_STOP_B_0x0 = 0;
        /** @brief stop in debug. GPDMA1 channel 10 is frozen while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA1_10_STOP_B_0x1 = 1;

    /** @brief GPDMA1 channel 11 stop in debug */
    using DBGMCU_AHB1FZR_DBG_GPDMA1_11_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: normal operation. GPDMA1 channel 11 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. GPDMA1 channel 11 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. GPDMA1 channel 11 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA1_11_STOP_B_0x0 = 0;
        /** @brief stop in debug. GPDMA1 channel 11 is frozen while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA1_11_STOP_B_0x1 = 1;

    /** @brief GPDMA1 channel 12 stop in debug */
    using DBGMCU_AHB1FZR_DBG_GPDMA1_12_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: normal operation. GPDMA1 channel 12 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. GPDMA1 channel 12 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. GPDMA1 channel 12 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA1_12_STOP_B_0x0 = 0;
        /** @brief stop in debug. GPDMA1 channel 12 is frozen while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA1_12_STOP_B_0x1 = 1;

    /** @brief GPDMA1 channel 13 stop in debug */
    using DBGMCU_AHB1FZR_DBG_GPDMA1_13_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: normal operation. GPDMA1 channel 13 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. GPDMA1 channel 13 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. GPDMA1 channel 13 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA1_13_STOP_B_0x0 = 0;
        /** @brief stop in debug. GPDMA1 channel 13 is frozen while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA1_13_STOP_B_0x1 = 1;

    /** @brief GPDMA1 channel 14 stop in debug */
    using DBGMCU_AHB1FZR_DBG_GPDMA1_14_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: normal operation. GPDMA1 channel 14 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. GPDMA1 channel 14 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. GPDMA1 channel 14 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA1_14_STOP_B_0x0 = 0;
        /** @brief stop in debug. GPDMA1 channel 14 is frozen while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA1_14_STOP_B_0x1 = 1;

    /** @brief GPDMA1 channel 15 stop in debug */
    using DBGMCU_AHB1FZR_DBG_GPDMA1_15_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: normal operation. GPDMA1 channel 15 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. GPDMA1 channel 15 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. GPDMA1 channel 15 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA1_15_STOP_B_0x0 = 0;
        /** @brief stop in debug. GPDMA1 channel 15 is frozen while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA1_15_STOP_B_0x1 = 1;
    ...
    /** @brief GPDMA2 channel 8 stop in debug */
    using DBGMCU_AHB1FZR_DBG_GPDMA2_8_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: normal operation. GPDMA2 channel 8 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. GPDMA2 channel 8 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. GPDMA2 channel 8 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA2_8_STOP_B_0x0 = 0;
        /** @brief stop in debug. GPDMA2 channel 8 is frozen while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA2_8_STOP_B_0x1 = 1;

    /** @brief GPDMA2 channel 9 stop in debug */
    using DBGMCU_AHB1FZR_DBG_GPDMA2_9_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: normal operation. GPDMA2 channel 9 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. GPDMA2 channel 9 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. GPDMA2 channel 9 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA2_9_STOP_B_0x0 = 0;
        /** @brief stop in debug. GPDMA2 channel 9 is frozen while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA2_9_STOP_B_0x1 = 1;

    /** @brief GPDMA2 channel 10 stop in debug */
    using DBGMCU_AHB1FZR_DBG_GPDMA2_10_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: normal operation. GPDMA2 channel 10 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. GPDMA2 channel 10 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. GPDMA2 channel 10 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA2_10_STOP_B_0x0 = 0;
        /** @brief stop in debug. GPDMA2 channel 10 is frozen while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA2_10_STOP_B_0x1 = 1;

    /** @brief GPDMA2 channel 11 stop in debug */
    using DBGMCU_AHB1FZR_DBG_GPDMA2_11_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: normal operation. GPDMA2 channel 11 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. GPDMA2 channel 11 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. GPDMA2 channel 11 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA2_11_STOP_B_0x0 = 0;
        /** @brief stop in debug. GPDMA2 channel 11 is frozen while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA2_11_STOP_B_0x1 = 1;

    /** @brief GPDMA2 channel 12 stop in debug */
    using DBGMCU_AHB1FZR_DBG_GPDMA2_12_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: normal operation. GPDMA2 channel 12 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. GPDMA2 channel 12 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. GPDMA2 channel 12 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA2_12_STOP_B_0x0 = 0;
        /** @brief stop in debug. GPDMA2 channel 12 is frozen while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA2_12_STOP_B_0x1 = 1;

    /** @brief GPDMA2 channel 13 stop in debug */
    using DBGMCU_AHB1FZR_DBG_GPDMA2_13_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: normal operation. GPDMA2 channel 13 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. GPDMA2 channel 13 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. GPDMA2 channel 13 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA2_13_STOP_B_0x0 = 0;
        /** @brief stop in debug. GPDMA2 channel 13 is frozen while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA2_13_STOP_B_0x1 = 1;

    /** @brief GPDMA2 channel 14 stop in debug */
    using DBGMCU_AHB1FZR_DBG_GPDMA2_14_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: normal operation. GPDMA2 channel 14 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. GPDMA2 channel 14 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. GPDMA2 channel 14 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA2_14_STOP_B_0x0 = 0;
        /** @brief stop in debug. GPDMA2 channel 14 is frozen while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA2_14_STOP_B_0x1 = 1;

    /** @brief GPDMA2 channel 15 stop in debug */
    using DBGMCU_AHB1FZR_DBG_GPDMA2_15_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: normal operation. GPDMA2 channel 15 continues to operate while CPU is in debug mode. (value: 0)
     *          - B_0x1: stop in debug. GPDMA2 channel 15 is frozen while CPU is in debug mode. (value: 1)
     */
        /** @brief normal operation. GPDMA2 channel 15 continues to operate while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA2_15_STOP_B_0x0 = 0;
        /** @brief stop in debug. GPDMA2 channel 15 is frozen while CPU is in debug mode. */
    constexpr std::uint32_t DBGMCU_AHB1FZR_DBG_GPDMA2_15_STOP_B_0x1 = 1;
