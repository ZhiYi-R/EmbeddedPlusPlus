...
#ifndef EMBEDDED_PP_STM32H563_SEC_DCMI_HPP
#define EMBEDDED_PP_STM32H563_SEC_DCMI_HPP
...
namespace STM32H563::SEC_DCMI {
    ...
    /** @details Possible values:
     *          - B_0x0: Continuous grab modeThe received data are transferred into the destination memory through the DMA. The buffer location and mode (linear or circular buffer) is controlled through the system DMA. (value: 0)
     ...
     */
        /** @brief Continuous grab modeThe received data are transferred into the destination memory through the DMA. The buffer location and mode (linear or circular buffer) is controlled through the system DMA. */
