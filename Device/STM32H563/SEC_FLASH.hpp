...
#ifndef EMBEDDED_PP_STM32H563_SEC_FLASH_HPP
#define EMBEDDED_PP_STM32H563_SEC_FLASH_HPP
...
namespace STM32H563::SEC_FLASH {
    ...
    /** @brief High-speed IO at low Vsub DD/sub voltage configuration bit. This bit can be set only with Vsub DD/sub below 2.7V. */
    ...
    /** @details Possible values:
     *          - B_0x0: High-speed IO at low Vsub DD/sub voltage feature disabled (Vsub DD/sub can exceed 2.7V) (value: 0)
     *          - B_0x1: High-speed IO at low Vsub DD/sub voltage feature enabled (Vsub DD/sub remains below 2.7V) (value: 1)
     */
        /** @brief High-speed IO at low Vsub DD/sub voltage feature disabled (Vsub DD/sub can exceed 2.7V) */
    constexpr std::uint32_t FLASH_OPTSR_CUR_IO_VDD_HSLV_B_0x0 = 0;
        /** @brief High-speed IO at low Vsub DD/sub voltage feature enabled (Vsub DD/sub remains below 2.7V) */
    constexpr std::uint32_t FLASH_OPTSR_CUR_IO_VDD_HSLV_B_0x1 = 1;

    /** @brief High-speed IO at low Vsub DDIO2/sub voltage configuration bit. This bit can be set only with Vsub DDIO2/sub below 2.7V. */
    ...
    /** @details Possible values:
     *          - B_0x0: High-speed IO at low Vsub DDIO2/sub voltage feature disabled (Vsub DDIO2/sub can exceed 2.7V) (value: 0)
     *          - B_0x1: High-speed IO at low Vsub DDIO2/sub voltage feature enabled (Vsub DDIO2/sub remains below 2.7V) (value: 1)
     */
        /** @brief High-speed IO at low Vsub DDIO2/sub voltage feature disabled (Vsub DDIO2/sub can exceed 2.7V) */
    constexpr std::uint32_t FLASH_OPTSR_CUR_IO_VDDIO2_HSLV_B_0x0 = 0;
        /** @brief High-speed IO at low Vsub DDIO2/sub voltage feature enabled (Vsub DDIO2/sub remains below 2.7V) */
