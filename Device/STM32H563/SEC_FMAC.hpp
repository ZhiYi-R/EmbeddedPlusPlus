...
#ifndef EMBEDDED_PP_STM32H563_SEC_FMAC_HPP
#define EMBEDDED_PP_STM32H563_SEC_FMAC_HPP
...
namespace STM32H563::SEC_FMAC {
    ...
    /** @brief Allocated size of X1 buffer in 16-bit words The minimum buffer size is the number of feed-forward taps in the filter (+ the watermark threshold1). */
