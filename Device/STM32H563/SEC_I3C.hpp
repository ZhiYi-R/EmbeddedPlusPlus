...
#ifndef EMBEDDED_PP_STM32H563_SEC_I3C_HPP
#define EMBEDDED_PP_STM32H563_SEC_I3C_HPP
...
namespace STM32H563::SEC_I3C {
     ...
     *          - B_0xFFFF: 64 Kbytes1 byte (value: 65535)
     */
    ...
    /** @brief activity state of the new controller (when I3C is acting asactive- controller) This field indicates the time to wait before being accessed as new target, refer to the other field AVAL[7:0]. This field can be modified only when the I3C is acting as controller. */
