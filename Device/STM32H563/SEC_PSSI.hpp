...
#ifndef EMBEDDED_PP_STM32H563_SEC_PSSI_HPP
#define EMBEDDED_PP_STM32H563_SEC_PSSI_HPP
...
namespace STM32H563::SEC_PSSI {
     ...
     *          - B_0x4: Both PSSI_RDY and PSSI_DE features enabledbidirectional on PSSI_RDY pin (see ) (value: 4)
     ...
     *          - B_0x7: Both PSSI_RDY and PSSI_DE features enabledbidirectional on PSSI_DE pin (see ) (value: 7)
     */
    ...
    constexpr std::uint32_t PSSI_CR_DERDYCFG_B_0x3 = 3;
        /** @brief Both PSSI_RDY and PSSI_DE features enabledbidirectional on PSSI_RDY pin (see ) */
    ...
    constexpr std::uint32_t PSSI_CR_DERDYCFG_B_0x6 = 6;
        /** @brief Both PSSI_RDY and PSSI_DE features enabledbidirectional on PSSI_DE pin (see ) */
