...
#ifndef EMBEDDED_PP_STM32H563_SEC_TIM1_HPP
#define EMBEDDED_PP_STM32H563_SEC_TIM1_HPP
...
namespace STM32H563::SEC_TIM1 {
    ...
    /** @brief Clock division This bit-field indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (tsub DTS/sub )used by the dead-time generators and the digital filters (tim_etr_in, tim_tix), */
    using TIM1_CR1_CKD = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: tsub DTS/sub =tsub tim_ker_ck/sub (value: 0)
     *          - B_0x1: tsub DTS/sub =2*tsub tim_ker_ck/sub (value: 1)
     *          - B_0x2: tsub DTS/sub =4*tsub tim_ker_ck/sub (value: 2)
     *          - B_0x3: Reserved, do not program this value (value: 3)
     */
        /** @brief tsub DTS/sub =tsub tim_ker_ck/sub */
    constexpr std::uint16_t TIM1_CR1_CKD_B_0x0 = 0;
        /** @brief tsub DTS/sub =2*tsub tim_ker_ck/sub */
    constexpr std::uint16_t TIM1_CR1_CKD_B_0x1 = 1;
        /** @brief tsub DTS/sub =4*tsub tim_ker_ck/sub */
    ...
    /** @details Possible values:
     *          - B_0x0: Resetthe UG bit from the TIMx_EGR register is used as trigger output (tim_trgo2). If the reset is generated by the trigger input (slave mode controller configured in reset mode), the signal on tim_trgo2 is delayed compared to the actual reset. (value: 0)
     ...
     *          - B_0x2: Updatethe update event is selected as trigger output (tim_trgo2). For instance, a master timer can then be used as a prescaler for a slave timer. (value: 2)
     *          - B_0x3: Compare pulsethe trigger output sends a positive pulse when the CC1IF flag is to be set (even if it was already high), as soon as a capture or compare match occurs (tim_trgo2). (value: 3)
     *          - B_0x4: Comparetim_oc1refc signal is used as trigger output (tim_trgo2) (value: 4)
     *          - B_0x5: Comparetim_oc2refc signal is used as trigger output (tim_trgo2) (value: 5)
     *          - B_0x6: Comparetim_oc3refc signal is used as trigger output (tim_trgo2) (value: 6)
     *          - B_0x7: Comparetim_oc4refc signal is used as trigger output (tim_trgo2) (value: 7)
     *          - B_0x8: Comparetim_oc5refc signal is used as trigger output (tim_trgo2) (value: 8)
     *          - B_0x9: Comparetim_oc6refc signal is used as trigger output (tim_trgo2) (value: 9)
     *          - B_0xA: Compare Pulsetim_oc4refc rising or falling edges generate pulses on tim_trgo2 (value: 10)
     *          - B_0xB: Compare pulsetim_oc6refc rising or falling edges generate pulses on tim_trgo2 (value: 11)
     *          - B_0xC: Compare pulsetim_oc4refc or tim_oc6refc rising edges generate pulses on tim_trgo2 (value: 12)
     *          - B_0xD: Compare pulsetim_oc4refc rising or tim_oc6refc falling edges generate pulses on tim_trgo2 (value: 13)
     *          - B_0xE: Compare pulsetim_oc5refc or tim_oc6refc rising edges generate pulses on tim_trgo2 (value: 14)
     *          - B_0xF: Compare pulsetim_oc5refc rising or tim_oc6refc falling edges generate pulses on tim_trgo2 (value: 15)
     */
        /** @brief Resetthe UG bit from the TIMx_EGR register is used as trigger output (tim_trgo2). If the reset is generated by the trigger input (slave mode controller configured in reset mode), the signal on tim_trgo2 is delayed compared to the actual reset. */
    constexpr std::uint32_t TIM1_CR2_MMS2_B_0x0 = 0;
        /** @brief Enablethe Counter Enable signal CNT_EN is used as trigger output (tim_trgo2). It is useful to start several timers at the same time or to control a window in which a slave timer is enabled. The Counter Enable signal is generated by a logic AND between the CEN control bit and the trigger input when configured in Gated mode. When the Counter Enable signal is controlled by the trigger input, there is a delay on tim_trgo2, except if the Master/Slave mode is selected (see the MSM bit description in TIMx_SMCR register). */
    constexpr std::uint32_t TIM1_CR2_MMS2_B_0x1 = 1;
        /** @brief Updatethe update event is selected as trigger output (tim_trgo2). For instance, a master timer can then be used as a prescaler for a slave timer. */
    constexpr std::uint32_t TIM1_CR2_MMS2_B_0x2 = 2;
        /** @brief Compare pulsethe trigger output sends a positive pulse when the CC1IF flag is to be set (even if it was already high), as soon as a capture or compare match occurs (tim_trgo2). */
    constexpr std::uint32_t TIM1_CR2_MMS2_B_0x3 = 3;
        /** @brief Comparetim_oc1refc signal is used as trigger output (tim_trgo2) */
    constexpr std::uint32_t TIM1_CR2_MMS2_B_0x4 = 4;
        /** @brief Comparetim_oc2refc signal is used as trigger output (tim_trgo2) */
    constexpr std::uint32_t TIM1_CR2_MMS2_B_0x5 = 5;
        /** @brief Comparetim_oc3refc signal is used as trigger output (tim_trgo2) */
    constexpr std::uint32_t TIM1_CR2_MMS2_B_0x6 = 6;
        /** @brief Comparetim_oc4refc signal is used as trigger output (tim_trgo2) */
    constexpr std::uint32_t TIM1_CR2_MMS2_B_0x7 = 7;
        /** @brief Comparetim_oc5refc signal is used as trigger output (tim_trgo2) */
    constexpr std::uint32_t TIM1_CR2_MMS2_B_0x8 = 8;
        /** @brief Comparetim_oc6refc signal is used as trigger output (tim_trgo2) */
    constexpr std::uint32_t TIM1_CR2_MMS2_B_0x9 = 9;
        /** @brief Compare Pulsetim_oc4refc rising or falling edges generate pulses on tim_trgo2 */
    constexpr std::uint32_t TIM1_CR2_MMS2_B_0xA = 10;
        /** @brief Compare pulsetim_oc6refc rising or falling edges generate pulses on tim_trgo2 */
    constexpr std::uint32_t TIM1_CR2_MMS2_B_0xB = 11;
        /** @brief Compare pulsetim_oc4refc or tim_oc6refc rising edges generate pulses on tim_trgo2 */
    constexpr std::uint32_t TIM1_CR2_MMS2_B_0xC = 12;
        /** @brief Compare pulsetim_oc4refc rising or tim_oc6refc falling edges generate pulses on tim_trgo2 */
    constexpr std::uint32_t TIM1_CR2_MMS2_B_0xD = 13;
        /** @brief Compare pulsetim_oc5refc or tim_oc6refc rising edges generate pulses on tim_trgo2 */
    constexpr std::uint32_t TIM1_CR2_MMS2_B_0xE = 14;
        /** @brief Compare pulsetim_oc5refc rising or tim_oc6refc falling edges generate pulses on tim_trgo2 */
     ...
     *          - B_0x2: Quadrature encoder mode 2, x2 modeCounter counts up/down on tim_ti2fp2 edge depending on tim_ti1fp1 level. (value: 2)
     *          - B_0x3: Quadrature encoder mode 3, x4 modeCounter counts up/down on both tim_ti1fp1 and tim_ti2fp2 edges depending on the level of the other input. (value: 3)
    ...
    constexpr std::uint32_t TIM1_SMCR_SMS_B_0x1 = 1;
        /** @brief Quadrature encoder mode 2, x2 modeCounter counts up/down on tim_ti2fp2 edge depending on tim_ti1fp1 level. */
    constexpr std::uint32_t TIM1_SMCR_SMS_B_0x2 = 2;
        /** @brief Quadrature encoder mode 3, x4 modeCounter counts up/down on both tim_ti1fp1 and tim_ti2fp2 edges depending on the level of the other input. */
    ...
    /** @details Possible values:
     *          - B_0x0: No filter, sampling is done at fsub DTS/sub (value: 0)
     *          - B_0x1: fsub SAMPLING/sub =fsub tim_ker_ck/sub , N=2 (value: 1)
     *          - B_0x2: fsub SAMPLING/sub =fsub tim_ker_ck/sub , N=4 (value: 2)
     *          - B_0x3: fsub SAMPLING/sub =fsub tim_ker_ck/sub , N=8 (value: 3)
     *          - B_0x4: fsub SAMPLING/sub =fsub DTS/sub /2, N=6 (value: 4)
     *          - B_0x5: fsub SAMPLING/sub =fsub DTS/sub /2, N=8 (value: 5)
     *          - B_0x6: fsub SAMPLING/sub =fsub DTS/sub /4, N=6 (value: 6)
     *          - B_0x7: fsub SAMPLING/sub =fsub DTS/sub /4, N=8 (value: 7)
     *          - B_0x8: fsub SAMPLING/sub =fsub DTS/sub /8, N=6 (value: 8)
     *          - B_0x9: fsub SAMPLING/sub =fsub DTS/sub /8, N=8 (value: 9)
     *          - B_0xA: fsub SAMPLING/sub =fsub DTS/sub /16, N=5 (value: 10)
     *          - B_0xB: fsub SAMPLING/sub =fsub DTS/sub /16, N=6 (value: 11)
     *          - B_0xC: fsub SAMPLING/sub =fsub DTS/sub /16, N=8 (value: 12)
     *          - B_0xD: fsub SAMPLING/sub =fsub DTS/sub /32, N=5 (value: 13)
     *          - B_0xE: fsub SAMPLING/sub =fsub DTS/sub /32, N=6 (value: 14)
     *          - B_0xF: fsub SAMPLING/sub =fsub DTS/sub /32, N=8 (value: 15)
     */
        /** @brief No filter, sampling is done at fsub DTS/sub */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x0 = 0;
        /** @brief fsub SAMPLING/sub =fsub tim_ker_ck/sub , N=2 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x1 = 1;
        /** @brief fsub SAMPLING/sub =fsub tim_ker_ck/sub , N=4 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x2 = 2;
        /** @brief fsub SAMPLING/sub =fsub tim_ker_ck/sub , N=8 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x3 = 3;
        /** @brief fsub SAMPLING/sub =fsub DTS/sub /2, N=6 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x4 = 4;
        /** @brief fsub SAMPLING/sub =fsub DTS/sub /2, N=8 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x5 = 5;
        /** @brief fsub SAMPLING/sub =fsub DTS/sub /4, N=6 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x6 = 6;
        /** @brief fsub SAMPLING/sub =fsub DTS/sub /4, N=8 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x7 = 7;
        /** @brief fsub SAMPLING/sub =fsub DTS/sub /8, N=6 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x8 = 8;
        /** @brief fsub SAMPLING/sub =fsub DTS/sub /8, N=8 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0x9 = 9;
        /** @brief fsub SAMPLING/sub =fsub DTS/sub /16, N=5 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0xA = 10;
        /** @brief fsub SAMPLING/sub =fsub DTS/sub /16, N=6 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0xB = 11;
        /** @brief fsub SAMPLING/sub =fsub DTS/sub /16, N=8 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0xC = 12;
        /** @brief fsub SAMPLING/sub =fsub DTS/sub /32, N=5 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0xD = 13;
        /** @brief fsub SAMPLING/sub =fsub DTS/sub /32, N=6 */
    constexpr std::uint32_t TIM1_SMCR_ETF_B_0xE = 14;
        /** @brief fsub SAMPLING/sub =fsub DTS/sub /32, N=8 */
    ...
    /** @brief COM interrupt flag This flag is set by hardware on COM event (when capture/compare Control bitsCCxE, CCxNE, OCxMhave been updated). It is cleared by software. */
    ...
    /** @details Possible values:
     *          - B_0x0: FrozenThe comparison between the output compare register TIMx_CCR3 and the counter TIMx_CNT has no effect on the outputs.(this mode is used to generate a timing base). (value: 0)
     ...
     *          - B_0x3: Toggletim_oc3ref toggles when TIMx_CNT=TIMx_CCR3. (value: 3)
     *          - B_0x4: Force inactive leveltim_oc3ref is forced low. (value: 4)
     *          - B_0x5: Force active leveltim_oc3ref is forced high. (value: 5)
     *          - B_0x6: PWM mode 1In upcounting, channel 3 is active as long as TIMx_CNTTIMx_CCR3 else inactive. In downcounting, channel 3 is inactive (tim_oc3ref='0') as long as TIMx_CNT TIMx_CCR3 else active (tim_oc3ref='1'). (value: 6)
     *          - B_0x7: PWM mode 2In upcounting, channel 3 is inactive as long as TIMx_CNTTIMx_CCR3 else active. In downcounting, channel 3 is active as long as TIMx_CNT TIMx_CCR3 else inactive. (value: 7)
     */
        /** @brief FrozenThe comparison between the output compare register TIMx_CCR3 and the counter TIMx_CNT has no effect on the outputs.(this mode is used to generate a timing base). */
    constexpr std::uint32_t TIM1_CCMR2_Output_OC3M_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM1_CCMR2_Output_OC3M_B_0x1 = 1;
    ...
    constexpr std::uint32_t TIM1_CCMR2_Output_OC3M_B_0x2 = 2;
        /** @brief Toggletim_oc3ref toggles when TIMx_CNT=TIMx_CCR3. */
    constexpr std::uint32_t TIM1_CCMR2_Output_OC3M_B_0x3 = 3;
        /** @brief Force inactive leveltim_oc3ref is forced low. */
    constexpr std::uint32_t TIM1_CCMR2_Output_OC3M_B_0x4 = 4;
        /** @brief Force active leveltim_oc3ref is forced high. */
    constexpr std::uint32_t TIM1_CCMR2_Output_OC3M_B_0x5 = 5;
        /** @brief PWM mode 1In upcounting, channel 3 is active as long as TIMx_CNTTIMx_CCR3 else inactive. In downcounting, channel 3 is inactive (tim_oc3ref='0') as long as TIMx_CNT TIMx_CCR3 else active (tim_oc3ref='1'). */
    constexpr std::uint32_t TIM1_CCMR2_Output_OC3M_B_0x6 = 6;
        /** @brief PWM mode 2In upcounting, channel 3 is inactive as long as TIMx_CNTTIMx_CCR3 else active. In downcounting, channel 3 is active as long as TIMx_CNT TIMx_CCR3 else inactive. */
    constexpr std::uint32_t TIM1_CCMR2_Output_OC3M_B_0x7 = 7;
    ...
    /** @brief Pulse width This bitfield defines the pulse duration, as following: tsub PW/sub = PW[7:0] x tsub PWG/sub */
    using TIM1_ECR_PW = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: tsub PWG/sub = (2sup (PWPRSC[2:0])/sup ) x tsub tim_ker_ck/sub */
