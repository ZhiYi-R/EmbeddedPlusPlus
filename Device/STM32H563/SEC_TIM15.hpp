...
#ifndef EMBEDDED_PP_STM32H563_SEC_TIM15_HPP
#define EMBEDDED_PP_STM32H563_SEC_TIM15_HPP
...
namespace STM32H563::SEC_TIM15 {
    ...
    /** @details Possible values:
     *          - B_0x0: Resetthe UG bit from the TIM15_EGR register is used as trigger output (tim_trgo). If the reset is generated by the trigger input (slave mode controller configured in reset mode) then the signal on tim_trgo is delayed compared to the actual reset. (value: 0)
     ...
     */
        /** @brief Resetthe UG bit from the TIM15_EGR register is used as trigger output (tim_trgo). If the reset is generated by the trigger input (slave mode controller configured in reset mode) then the signal on tim_trgo is delayed compared to the actual reset. */
    ...
    /** @details Possible values:
     *          - B_0x0: FrozenThe comparison between the output compare register TIM15_CCR1 and the counter TIM15_CNT has no effect on the outputs. (value: 0)
     ...
     *          - B_0x3: Toggletim_oc1ref toggles when TIM15_CNT=TIM15_CCR1. (value: 3)
     *          - B_0x4: Force inactive leveltim_oc1ref is forced low. (value: 4)
     *          - B_0x5: Force active leveltim_oc1ref is forced high. (value: 5)
     *          - B_0x6: PWM mode 1Channel 1 is active as long as TIM15_CNTTIM15_CCR1 else inactive. (value: 6)
     *          - B_0x7: PWM mode 2Channel 1 is inactive as long as TIM15_CNTTIM15_CCR1 else active. (value: 7)
     */
        /** @brief FrozenThe comparison between the output compare register TIM15_CCR1 and the counter TIM15_CNT has no effect on the outputs. */
    ...
    constexpr std::uint32_t TIM15_CCMR1_Output_OC1M1_B_0x2 = 2;
        /** @brief Toggletim_oc1ref toggles when TIM15_CNT=TIM15_CCR1. */
    ...
    constexpr std::uint32_t TIM15_CCMR1_Output_OC1M1_B_0x5 = 5;
        /** @brief PWM mode 1Channel 1 is active as long as TIM15_CNTTIM15_CCR1 else inactive. */
    constexpr std::uint32_t TIM15_CCMR1_Output_OC1M1_B_0x6 = 6;
        /** @brief PWM mode 2Channel 1 is inactive as long as TIM15_CNTTIM15_CCR1 else active. */
