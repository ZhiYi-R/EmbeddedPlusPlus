...
#ifndef EMBEDDED_PP_STM32H563_SEC_UCPD1_HPP
#define EMBEDDED_PP_STM32H563_SEC_UCPD1_HPP
...
namespace STM32H563::SEC_UCPD1 {
    ...
    /** @details Possible values:
     *          - B_0x2: 2 bytesthe size of Control message from the protocol layer (value: 2)
     *          - B_0x6: 6 bytesthe shortest Data message allowed from the protocol layer) (value: 6)
     *          - B_0x1E: 30 bytesthe longest non-extended Data message allowed from the protocol layer (value: 30)
     *          - B_0x106: 262 bytesthe longest possible extended message (value: 262)
     *          - B_0x3FF: 1024 bytesthe longest possible payload (for future expansion) (value: 1023)
     */
        /** @brief 2 bytesthe size of Control message from the protocol layer */
    constexpr std::uint32_t UCPD_TX_PAYSZR_TXPAYSZ_B_0x2 = 2;
        /** @brief 6 bytesthe shortest Data message allowed from the protocol layer) */
    constexpr std::uint32_t UCPD_TX_PAYSZR_TXPAYSZ_B_0x6 = 6;
        /** @brief 30 bytesthe longest non-extended Data message allowed from the protocol layer */
    constexpr std::uint32_t UCPD_TX_PAYSZR_TXPAYSZ_B_0x1E = 30;
        /** @brief 262 bytesthe longest possible extended message */
    constexpr std::uint32_t UCPD_TX_PAYSZR_TXPAYSZ_B_0x106 = 262;
        /** @brief 1024 bytesthe longest possible payload (for future expansion) */
