...
#ifndef EMBEDDED_PP_STM32H563_SEC_USART10_HPP
#define EMBEDDED_PP_STM32H563_SEC_USART10_HPP
...
namespace STM32H563::SEC_USART10 {
    ...
    /** @details Possible values:
     *          - B_0x0: retransmission disabledNo automatic retransmission in Transmission mode. (value: 0)
     ...
     */
        /** @brief retransmission disabledNo automatic retransmission in Transmission mode. */
    ...
    /** @brief Wakeup from low-power mode interrupt enable This bit is set and cleared by software. Note: WUFIE must be set before entering in low-power mode. If the USART does not support the wakeup from Stop feature, this bit is reserved and must be kept at reset value. Refer to page 2297. */
    ...
    /** @details Possible values:
     *          - B_0x0_IRDA_LOW_POWER_AND_NORMAL_IRDA_MODE: Reserveddo not program this value (value: 0)
     ...
     */
        /** @brief Reserveddo not program this value */
    ...
    /** @brief Receiver timeout clear flag Writing 1 to this bit clears the RTOF flag in the USART_ISR register. Note: If the USART does not support the Receiver timeout feature, this bit is reserved and must be kept at reset value. Refer to page 2297. */
    ...
    /** @brief Wakeup from low-power mode clear flag Writing 1 to this bit clears the WUF flag in the USART_ISR register. Note: If the USART does not support the wakeup from Stop feature, this bit is reserved and must be kept at reset value. Refer to page 2297. */
