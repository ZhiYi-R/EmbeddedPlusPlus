...
#ifndef EMBEDDED_PP_STM32H573_SEC_PKA_HPP
#define EMBEDDED_PP_STM32H573_SEC_PKA_HPP
...
namespace STM32H573::SEC_PKA {
    ...
    /** @brief PKA enable. When an illegal operation is selected while EN=1 OPERRF bit is set in PKA_SR. See PKA_CR.MODE bitfield for details. When EN=0 PKA RAM can still be accessed by the application. */
