...
#ifndef EMBEDDED_PP_STM32H573_SEC_PWR_HPP
#define EMBEDDED_PP_STM32H573_SEC_PWR_HPP
...
namespace STM32H573::SEC_PWR {
    ...
    /** @brief system Stop mode voltage scaling selection These bits control the V sub CORE /sub voltage level in system Stop mode, to obtain the best trade-off between power consumption and performance. */
    ...
    /** @details Possible values:
     *          - B_0x0: peripheral analog voltage V sub DDA /sub not ready (default) (value: 0)
     *          - B_0x1: peripheral analog voltage V sub DDA /sub ready. (value: 1)
     */
        /** @brief peripheral analog voltage V sub DDA /sub not ready (default) */
    constexpr std::uint32_t PWR_PMCR_AVD_READY_B_0x0 = 0;
        /** @brief peripheral analog voltage V sub DDA /sub ready. */
    ...
    /** @brief Ready bit for V sub CORE /sub voltage scaling output selection. */
    ...
    /** @details Possible values:
     *          - B_0x0: V sub CORE /sub is above or below the current voltage scaling provided by ACTVOS[1:0]. (value: 0)
     *          - B_0x1: V sub CORE /sub is equal to the current voltage scaling provided by ACTVOS[1:0] (value: 1)
     */
        /** @brief V sub CORE /sub is above or below the current voltage scaling provided by ACTVOS[1:0]. */
    constexpr std::uint32_t PWR_VOSSR_ACTVOSRDY_B_0x0 = 0;
        /** @brief V sub CORE /sub is equal to the current voltage scaling provided by ACTVOS[1:0] */
    constexpr std::uint32_t PWR_VOSSR_ACTVOSRDY_B_0x1 = 1;

    /** @brief voltage output scaling currently applied to V sub CORE /sub This field provides the last VOS value. */
    ...
    /** @brief V sub BAT /sub charging enable Note: Reset only by POR,. */
    using PWR_BDCR_VBE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V sub BAT /sub battery charging disabled. (value: 0)
     *          - B_0x1: V sub BAT /sub battery charging enabled. (value: 1)
     */
        /** @brief V sub BAT /sub battery charging disabled. */
    constexpr std::uint32_t PWR_BDCR_VBE_B_0x0 = 0;
        /** @brief V sub BAT /sub battery charging enabled. */
    constexpr std::uint32_t PWR_BDCR_VBE_B_0x1 = 1;

    /** @brief V sub BAT /sub charging resistor selection */
    using PWR_BDCR_VBRS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Charge V sub BAT /sub through a 5 kohm resistor. (value: 0)
     *          - B_0x1: Charge V sub BAT /sub through a 1.5 kohm resistor. (value: 1)
     */
        /** @brief Charge V sub BAT /sub through a 5 kohm resistor. */
    constexpr std::uint32_t PWR_BDCR_VBRS_B_0x0 = 0;
        /** @brief Charge V sub BAT /sub through a 1.5 kohm resistor. */
    ...
    /** @brief peripheral voltage monitor on V sub DDA /sub enable */
    using PWR_VMCR_AVDEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: peripheral voltage monitor on V sub DDA /sub disabled (value: 0)
     *          - B_0x1: peripheral voltage monitor on V sub DDA /sub enabled (value: 1)
     */
        /** @brief peripheral voltage monitor on V sub DDA /sub disabled */
    constexpr std::uint32_t PWR_VMCR_AVDEN_B_0x0 = 0;
        /** @brief peripheral voltage monitor on V sub DDA /sub enabled */
    ...
    /** @brief V sub DDUSB /sub voltage level detector enable */
    using PWR_USBSCR_USB33DEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V sub DDUSB /sub voltage level detector disabled (value: 0)
     *          - B_0x1: V sub DDUSB /sub voltage level detector enabled (value: 1)
     */
        /** @brief V sub DDUSB /sub voltage level detector disabled */
    constexpr std::uint32_t PWR_USBSCR_USB33DEN_B_0x0 = 0;
        /** @brief V sub DDUSB /sub voltage level detector enabled */
    constexpr std::uint32_t PWR_USBSCR_USB33DEN_B_0x1 = 1;

    /** @brief independent USB supply valid This bit is used to validate the V sub DDUSB /sub supply for electrical and logical isolation purpose. Setting this bit is mandatory to use the USBFS peripheral. If V sub DDUSB /sub is not always present in the application, the V sub DDUSB /sub voltage monitor can be used to determine whether this supply is ready or not. */
    ...
    /** @brief analog voltage detector output on V sub DDA /sub This bit is set and cleared by hardware. It is valid only if AVD on VDDA is enabled by the AVDEN bit. Note: Since the AVD is disabled in Standby mode, this bit is equal to 0 after standby or reset until the AVDEN bit is set. */
    using PWR_VMSR_AVDO = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V sub DDA /sub is equal or higher than the AVD threshold selected with the ALS[2:0] bits. (value: 0)
     *          - B_0x1: V sub DDA /sub is lower than the AVD threshold selected with the ALS[2:0] bits. (value: 1)
     */
        /** @brief V sub DDA /sub is equal or higher than the AVD threshold selected with the ALS[2:0] bits. */
    constexpr std::uint32_t PWR_VMSR_AVDO_B_0x0 = 0;
        /** @brief V sub DDA /sub is lower than the AVD threshold selected with the ALS[2:0] bits. */
    constexpr std::uint32_t PWR_VMSR_AVDO_B_0x1 = 1;

    /** @brief voltage detector output on V sub DDIO2 /sub This bit is set and cleared by hardware. */
    using PWR_VMSR_VDDIO2RDY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V sub DDIO2 /sub is below 1.2 V. (value: 0)
     *          - B_0x1: V sub DDIO2 /sub is above or equal to 1.2 V. (value: 1)
     */
        /** @brief V sub DDIO2 /sub is below 1.2 V. */
    constexpr std::uint32_t PWR_VMSR_VDDIO2RDY_B_0x0 = 0;
        /** @brief V sub DDIO2 /sub is above or equal to 1.2 V. */
    ...
    /** @details Possible values:
     *          - B_0x0: V sub DD /sub is equal or higher than the PVD threshold selected through the PLS[2:0] bits. (value: 0)
     *          - B_0x1: V sub DD /sub is lower than the PVD threshold selected through the PLS[2:0] bits. (value: 1)
     */
        /** @brief V sub DD /sub is equal or higher than the PVD threshold selected through the PLS[2:0] bits. */
    constexpr std::uint32_t PWR_VMSR_PVDO_B_0x0 = 0;
        /** @brief V sub DD /sub is lower than the PVD threshold selected through the PLS[2:0] bits. */
    constexpr std::uint32_t PWR_VMSR_PVDO_B_0x1 = 1;

    /** @brief V sub DDUSB /sub ready */
    using PWR_VMSR_USB33RDY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V sub DDUSB /sub is below the threshold of the V sub DDUSB /sub voltage monitor. (value: 0)
     *          - B_0x1: V sub DDUSB /sub is equal or above the threshold of the V sub DDUSB /sub voltage monitor. (value: 1)
     */
        /** @brief V sub DDUSB /sub is below the threshold of the V sub DDUSB /sub voltage monitor. */
    constexpr std::uint32_t PWR_VMSR_USB33RDY_B_0x0 = 0;
        /** @brief V sub DDUSB /sub is equal or above the threshold of the V sub DDUSB /sub voltage monitor. */
