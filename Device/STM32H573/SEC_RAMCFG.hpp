...
#ifndef EMBEDDED_PP_STM32H573_SEC_RAMCFG_HPP
#define EMBEDDED_PP_STM32H573_SEC_RAMCFG_HPP
...
namespace STM32H573::SEC_RAMCFG {
    ...
    /** @brief SRAM busy with erase operation Note: Depending on the SRAM, the erase operation can be performed due to software request, system reset if the option bit is enabled, tamper detection or readout protection regression. Refer to Table 18: Internal SRAMs features. */
