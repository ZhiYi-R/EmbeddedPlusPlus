...
#ifndef EMBEDDED_PP_STM32H573_SEC_RCC_HPP
#define EMBEDDED_PP_STM32H573_SEC_RCC_HPP
...
namespace STM32H573::SEC_RCC {
    ...
    using RCC_PLL1CFGR_DIVM1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 6, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: prescaler disabled (default after reset) (value: 0)
     *          - B_0x1: division by 1 (bypass) (value: 1)
     *          - B_0x2: division by 2 (value: 2)
     ...
     */
        /** @brief prescaler disabled (default after reset) */
    constexpr std::uint32_t RCC_PLL1CFGR_DIVM1_B_0x0 = 0;
        /** @brief division by 1 (bypass) */
    constexpr std::uint32_t RCC_PLL1CFGR_DIVM1_B_0x1 = 1;
        /** @brief division by 2 */
    constexpr std::uint32_t RCC_PLL1CFGR_DIVM1_B_0x2 = 2;
        /** @brief division by 3 */
    constexpr std::uint32_t RCC_PLL1CFGR_DIVM1_B_0x3 = 3;
        /** @brief division by 32 */
    constexpr std::uint32_t RCC_PLL1CFGR_DIVM1_B_0x20 = 32;
        /** @brief division by 63 */
    constexpr std::uint32_t RCC_PLL1CFGR_DIVM1_B_0x3F = 63;
    ...
    using RCC_PLL2CFGR_DIVM2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 6, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: prescaler disabled (default after reset) (value: 0)
     *          - B_0x1: division by 1 (bypass) (value: 1)
     *          - B_0x2: division by 2 (value: 2)
     ...
     */
        /** @brief prescaler disabled (default after reset) */
    constexpr std::uint32_t RCC_PLL2CFGR_DIVM2_B_0x0 = 0;
        /** @brief division by 1 (bypass) */
    constexpr std::uint32_t RCC_PLL2CFGR_DIVM2_B_0x1 = 1;
        /** @brief division by 2 */
    constexpr std::uint32_t RCC_PLL2CFGR_DIVM2_B_0x2 = 2;
        /** @brief division by 3 */
    constexpr std::uint32_t RCC_PLL2CFGR_DIVM2_B_0x3 = 3;
        /** @brief division by 32 */
    constexpr std::uint32_t RCC_PLL2CFGR_DIVM2_B_0x20 = 32;
        /** @brief division by 63 */
    constexpr std::uint32_t RCC_PLL2CFGR_DIVM2_B_0x3F = 63;
    ...
    /** @brief DIVMx and PLLs clock source selection Set and reset by software to select the PLL clock source. These bits can be written only when all PLLs are disabled. In order to save power, when no PLL is used, the value of PLL3SRC must be set to '00'. */
    ...
    /** @brief PLL3 input frequency range Set and reset by software to select the proper reference frequency range used for PLL3. This bit must be written before enabling the PLL3. */
    ...
    /** @brief prescaler for PLL3 Set and cleared by software to configure the prescaler of the PLL3. The hardware does not allow any modification of this prescaler when PLL3 is enabled (PLL3ON = 1 or PLL3RDY = 1). In order to save power when PLL3 is not used, the value of DIVM2 must be set to 0. ... ... */
    using RCC_PLL3CFGR_DIVM3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 6, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: prescaler disabled (default after reset) (value: 0)
     *          - B_0x1: division by 1 (bypass) (value: 1)
     *          - B_0x2: division by 2 (value: 2)
     ...
     */
        /** @brief prescaler disabled (default after reset) */
    constexpr std::uint32_t RCC_PLL3CFGR_DIVM3_B_0x0 = 0;
        /** @brief division by 1 (bypass) */
    constexpr std::uint32_t RCC_PLL3CFGR_DIVM3_B_0x1 = 1;
        /** @brief division by 2 */
    constexpr std::uint32_t RCC_PLL3CFGR_DIVM3_B_0x2 = 2;
        /** @brief division by 3 */
    constexpr std::uint32_t RCC_PLL3CFGR_DIVM3_B_0x3 = 3;
        /** @brief division by 32 */
    constexpr std::uint32_t RCC_PLL3CFGR_DIVM3_B_0x20 = 32;
        /** @brief division by 63 */
    constexpr std::uint32_t RCC_PLL3CFGR_DIVM3_B_0x3F = 63;

    /** @brief PLL3 DIVP divider output enable Set and reset by software to enable the pll3_p_ck output of the PLL3. To save power, when the pll3_p_ck output of the PLL3 is not used, the pll3_p_ck must be disabled. */
    ...
    /** @brief PLL3 DIVQ divider output enable Set and reset by software to enable the pll3_q_ck output of the PLL3. To save power, when the pll3_q_ck output of the PLL3 is not used, the pll3_q_ck must be disabled. */
    ...
    /** @brief PLL3 DIVR divider output enable Set and reset by software to enable the pll3_r_ck output of the PLL3. To save power, DIVR2EN and DIVR2 bits must be set to 0 when the pll3_r_ck is not used. */
    ...
    /** @brief Multiplication factor for PLL3VCO Set and reset by software to control the multiplication factor of the VCO. These bits can be written only when the PLL is disabled (PLL3ON = 0 and PLL3RDY = 0). ... ... Others: reserved */
    ...
    /** @brief PLL3 DIVR division factor Set and reset by software to control the frequency of the pll3_r_ck clock. These bits can be written only when the PLL1 is disabled (PLL3ON = 0 and PLL3RDY = 0). ... */
    ...
    /** @brief CORDIC block reset Set and reset by software. */
    ...
    /** @brief FMAC block reset Set and reset by software. */
    ...
    /** @brief ETHRST block reset Set and reset by software */
    ...
    /** @brief TZSC1 reset Set and reset by software */
    using RCC_AHB1RSTR_TZSC1RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: does not reset the TZSC1 (default after reset) (value: 0)
     *          - B_0x1: resets the TZSC1 (value: 1)
     */
        /** @brief does not reset the TZSC1 (default after reset) */
    constexpr std::uint32_t RCC_AHB1RSTR_TZSC1RST_B_0x0 = 0;
        /** @brief resets the TZSC1 */
    constexpr std::uint32_t RCC_AHB1RSTR_TZSC1RST_B_0x1 = 1;
    ...
    using RCC_AHB2RSTR_ADC12RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    /** @brief digital camera interface block reset (DCMI or PSSI depending which interface is active) Set and reset by software. */
    ...
    /** @brief AES block reset Set and reset by software. */
    ...
    /** @brief PKA block reset Set and reset by software. */
    ...
    /** @brief SAES block reset Set and reset by software. */
    ...
    /** @brief OTFDEC1 block reset Set and reset by software. */
    ...
    using RCC_AHB4RSTR_SDMMC2RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t RCC_AHB4RSTR_SDMMC2RST_B_0x0 = 0;
        /** @brief resets SDMMC2 and SDMMC2 delay blocks */
    constexpr std::uint32_t RCC_AHB4RSTR_SDMMC2RST_B_0x1 = 1;
    ...
    /** @brief OCTOSPI1 block reset Set and reset by software. */
    ...
    /** @brief TIM13 block reset t Set and reset by software. */
    ...
    /** @brief USART11 block reset Set and reset by software. */
    ...
    /** @brief UART12 block reset Set and reset by software. */
    ...
    /** @brief FDCAN1 and FDCAN2 blocks reset Set and reset by software. */
    using RCC_APB1HRSTR_FDCAN12RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t RCC_APB1HRSTR_FDCAN12RST_B_0x0 = 0;
        /** @brief resets the FDCAN1 and FDCAN2 blocks */
    constexpr std::uint32_t RCC_APB1HRSTR_FDCAN12RST_B_0x1 = 1;

    /** @brief UCPD block reset Set and reset by software. */
    using RCC_APB1HRSTR_UCPDRST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t RCC_APB1HRSTR_UCPDRST_B_0x0 = 0;
        /** @brief resets the UCPD block */
    constexpr std::uint32_t RCC_APB1HRSTR_UCPDRST_B_0x1 = 1;
    ...
    using RCC_APB3RSTR_SPI5RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t RCC_APB3RSTR_SPI5RST_B_0x0 = 0;
        /** @brief resets the SPI5 block */
    constexpr std::uint32_t RCC_APB3RSTR_SPI5RST_B_0x1 = 1;
    ...
    using RCC_APB3RSTR_I2C4RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t RCC_APB3RSTR_I2C4RST_B_0x0 = 0;
        /** @brief resets the I2C4 block */
    constexpr std::uint32_t RCC_APB3RSTR_I2C4RST_B_0x1 = 1;
    ...
    /** @brief LPTIM4 block reset Set and reset by software. */
    ...
    /** @brief LPTIM5 block reset Set and reset by software. */
    ...
    /** @brief LPTIM6 block reset Set and reset by software. */
    ...
    /** @brief ETH clock enable Set and reset by software */
    ...
    /** @brief ETHTX clock enable Set and reset by software */
    ...
    /** @brief ETHRX clock enable Set and reset by software */
    ...
    /** @brief TZSC1 clock enable Set and reset by software */
    ...
    /** @brief DCACHE clock enable Set and reset by software */
    ...
    /** @brief GPIOE clock enable Set and reset by software. */
    ...
    /** @brief GPIOF clock enable Set and reset by software. */
    ...
    /** @brief GPIOG clock enable Set and reset by software. */
    ...
    /** @brief GPIOI clock enable Set and reset by software. */
    ...
    /** @brief ADC1 and 2 peripherals clock enabled Set and reset by software. */
    using RCC_AHB2ENR_ADC12EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    /** @brief digital camera interface clock enable (DCMI or PSSI depending which interface is active) Set and reset by software. */
    ...
    /** @brief AES clock enable Set and reset by software. */
    ...
    /** @brief PKA clock enable Set and reset by software. */
    ...
    /** @brief SAES clock enable Set and reset by software. */
    ...
    using RCC_AHB2ENR_SRAM3EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    using RCC_AHB2ENR_SRAM2EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    /** @brief OTFDEC1 clock enable Set and reset by software. */
    ...
    /** @brief SDMMC2 and SDMMC2 delay peripheral clock enabled Set and reset by software. */
    using RCC_AHB4ENR_SDMMC2EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: SDMMC2 and SDMMC2 delay peripherals clock disabled (default after reset) (value: 0)
     *          - B_0x1: SDMMC2 and SDMMC2 delay peripherals clock enabled (value: 1)
     */
        /** @brief SDMMC2 and SDMMC2 delay peripherals clock disabled (default after reset) */
    constexpr std::uint32_t RCC_AHB4ENR_SDMMC2EN_B_0x0 = 0;
        /** @brief SDMMC2 and SDMMC2 delay peripherals clock enabled */
    constexpr std::uint32_t RCC_AHB4ENR_SDMMC2EN_B_0x1 = 1;

    /** @brief FMC clock enable Set and reset by software. */
    ...
    /** @brief OCTOSPI1 clock enable Set and reset by software. */
    ...
    /** @brief TIM4 clock enable Set and reset by software. */
    ...
    /** @brief TIM5 clock enable Set and reset by software. */
    ...
    /** @brief TIM12 clock enable Set and reset by software. */
    ...
    /** @brief TIM13 clock enable Set and reset by software. */
    ...
    /** @brief TIM14 clock enable Set and reset by software. */
    ...
    /** @brief UART4 clock enable Set and reset by software. */
    ...
    /** @brief UART5 clock enable Set and reset by software. */
    ...
    /** @brief USART6 clock enable Set and reset by software. */
    ...
    /** @brief USART10 clock enable Set and reset by software. */
    ...
    /** @brief HDMI-CEC clock enable Set and reset by software. */
    ...
    /** @brief UART7 clock enable Set and reset by software. */
    ...
    /** @brief UART8 clock enable Set and reset by software. */
    ...
    /** @brief UART9 clock enable Set and reset by software. */
    ...
    /** @brief UART12 clock enable Set and reset by software. */
    ...
    /** @brief FDCAN1 and FDCAN2 peripheral clock enable Set and reset by software. */
    using RCC_APB1HENR_FDCAN12EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t RCC_APB1HENR_FDCAN12EN_B_0x0 = 0;
        /** @brief FDCAN1 and FDCAN2 peripheral clock enabled */
    constexpr std::uint32_t RCC_APB1HENR_FDCAN12EN_B_0x1 = 1;

    /** @brief UCPD clock enable Set and reset by software. */
    using RCC_APB1HENR_UCPDEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t RCC_APB1HENR_UCPDEN_B_0x0 = 0;
        /** @brief UCPD peripheral clock enabled */
    constexpr std::uint32_t RCC_APB1HENR_UCPDEN_B_0x1 = 1;
    ...
    /** @brief TIM8 clock enable Set and reset by software. */
    ...
    /** @brief TIM15 clock enable Set and reset by software. */
    ...
    /** @brief TIM16 clock enable Set and reset by software. */
    ...
    /** @brief TIM17 clock enable Set and reset by software. */
    ...
    /** @brief SPI4 clock enable Set and reset by software. */
    ...
    /** @brief SPI6 clock enable Set and reset by software. */
    ...
    /** @brief SAI1 clock enable Set and reset by software. */
    ...
    /** @brief SPI5 clock enable Set and reset by software. */
    using RCC_APB3ENR_SPI5EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: SPI5 peripheral clock disabled (default after reset) (value: 0)
     *          - B_0x1: SPI5 peripheral clock enabled (value: 1)
     */
        /** @brief SPI5 peripheral clock disabled (default after reset) */
    constexpr std::uint32_t RCC_APB3ENR_SPI5EN_B_0x0 = 0;
        /** @brief SPI5 peripheral clock enabled */
    constexpr std::uint32_t RCC_APB3ENR_SPI5EN_B_0x1 = 1;
    ...
    /** @brief I2C3 clock enable Set and reset by software. */
    ...
    /** @brief I2C4 clock enable Set and reset by software. */
    using RCC_APB3ENR_I2C4EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: I2C4 peripheral clock disabled (default after reset) (value: 0)
     *          - B_0x1: I2C4 peripheral clock enabled (value: 1)
     */
        /** @brief I2C4 peripheral clock disabled (default after reset) */
    constexpr std::uint32_t RCC_APB3ENR_I2C4EN_B_0x0 = 0;
        /** @brief I2C4 peripheral clock enabled */
    constexpr std::uint32_t RCC_APB3ENR_I2C4EN_B_0x1 = 1;
    ...
    /** @brief LPTIM3 clock enable Set and reset by software. */
    ...
    /** @brief LPTIM4 clock enable Set and reset by software. */
    ...
    /** @brief LPTIM5 clock enable Set and reset by software. */
    ...
    /** @brief LPTIM6 clock enable Set and reset by software. */
    ...
    /** @brief CORDIC clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief FMAC clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief ETH clock enable during Sleep mode Set and reset by software */
    ...
    /** @brief ETHTX clock enable during sleep mode Set and reset by software */
    ...
    /** @brief ETHRX clock enable during sleep mode Set and reset by software */
    ...
    /** @brief TZSC1 clock enable during sleep mode Set and reset by software */
    ...
    /** @brief DCACHE clock enable during sleep mode Set and reset by software */
    ...
    /** @brief GPIOE clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief GPIOF clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief GPIOG clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief GPIOI clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief ADC1 and 2 peripherals clock enable during sleep mode Set and reset by software. */
    using RCC_AHB2LPENR_ADC12LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t RCC_AHB2LPENR_ADC12LPEN_B_0x0 = 0;
        /** @brief ADC1 and 2 peripherals clock enabled during sleep mode (default after reset) */
    constexpr std::uint32_t RCC_AHB2LPENR_ADC12LPEN_B_0x1 = 1;
    ...
    /** @brief digital camera interface clock enable during sleep mode (DCMI or PSSI depending which interface is active) Set and reset by software. */
    ...
    /** @brief AES clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief PKA clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief SAES clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief SRAM3 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief OTFDEC1 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief SDMMC1 and SDMMC1 delay peripheral clock enable during sleep mode Set and reset by software */
    ...
    /** @brief SDMMC2 and SDMMC2 delay peripheral clock enable during sleep mode Set and reset by software. */
    using RCC_AHB4LPENR_SDMMC2LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: SDMMC2 and SDMMC2 delay peripherals clock disabled during sleep mode (value: 0)
     *          - B_0x1: SDMMC2 and SDMMC2 delay peripherals clock enabled during sleep mode (default after reset) (value: 1)
     */
        /** @brief SDMMC2 and SDMMC2 delay peripherals clock disabled during sleep mode */
    constexpr std::uint32_t RCC_AHB4LPENR_SDMMC2LPEN_B_0x0 = 0;
        /** @brief SDMMC2 and SDMMC2 delay peripherals clock enabled during sleep mode (default after reset) */
    constexpr std::uint32_t RCC_AHB4LPENR_SDMMC2LPEN_B_0x1 = 1;

    /** @brief FMC clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief OCTOSPI1 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief TIM4 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief TIM5 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief TIM12 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief TIM13 clock enable during sleep mode Set and reset by software. */
    using RCC_APB1LLPENR_TIM13LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: TIM13 peripheral clock disabled during sleep mode (value: 0)
     *          - B_0x1: TIM13 peripheral clock enabled during sleep mode (default after reset) (value: 1)
     */
        /** @brief TIM13 peripheral clock disabled during sleep mode */
    constexpr std::uint32_t RCC_APB1LLPENR_TIM13LPEN_B_0x0 = 0;
        /** @brief TIM13 peripheral clock enabled during sleep mode (default after reset) */
    constexpr std::uint32_t RCC_APB1LLPENR_TIM13LPEN_B_0x1 = 1;

    /** @brief TIM14 clock enable during sleep mode Set and reset by software. */
    using RCC_APB1LLPENR_TIM14LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: TIM14 peripheral clock disabled during sleep mode (value: 0)
     *          - B_0x1: TIM14 peripheral clock enabled during sleep mode (default after reset) (value: 1)
     */
        /** @brief TIM14 peripheral clock disabled during sleep mode */
    constexpr std::uint32_t RCC_APB1LLPENR_TIM14LPEN_B_0x0 = 0;
        /** @brief TIM14 peripheral clock enabled during sleep mode (default after reset) */
    ...
    /** @brief UART4 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief UART5 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief USART6 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief USART10 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief USART11 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief HDMI-CEC clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief UART7 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief UART8 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief UART9 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief UART12 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief FDCAN1 and FDCAN2 peripheral clock enable during sleep mode Set and reset by software. */
    using RCC_APB1HLPENR_FDCAN12LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t RCC_APB1HLPENR_FDCAN12LPEN_B_0x0 = 0;
        /** @brief FDCAN1 and FDCAN2 peripheral clock enabled during sleep mode (default after reset) */
    constexpr std::uint32_t RCC_APB1HLPENR_FDCAN12LPEN_B_0x1 = 1;

    /** @brief UCPD clock enable during sleep mode Set and reset by software. */
    using RCC_APB1HLPENR_UCPDLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t RCC_APB1HLPENR_UCPDLPEN_B_0x0 = 0;
        /** @brief UCPD peripheral clock enabled during sleep mode (default after reset) */
    constexpr std::uint32_t RCC_APB1HLPENR_UCPDLPEN_B_0x1 = 1;
    ...
    /** @brief TIM8 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief TIM15 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief TIM16 clock enable during sleep mode Set and reset by software. */
    using RCC_APB2LPENR_TIM16LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: TIM16 peripheral clock disabled during sleep mode (value: 0)
     *          - B_0x1: TIM16 peripheral clock enabled during sleep mode (default after reset) (value: 1)
     */
        /** @brief TIM16 peripheral clock disabled during sleep mode */
    constexpr std::uint32_t RCC_APB2LPENR_TIM16LPEN_B_0x0 = 0;
        /** @brief TIM16 peripheral clock enabled during sleep mode (default after reset) */
    constexpr std::uint32_t RCC_APB2LPENR_TIM16LPEN_B_0x1 = 1;

    /** @brief TIM17 clock enable during sleep mode Set and reset by software. */
    using RCC_APB2LPENR_TIM17LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: TIM17 peripheral clock disabled during sleep mode (value: 0)
     *          - B_0x1: TIM17 peripheral clock enabled during sleep mode (default after reset) (value: 1)
     */
        /** @brief TIM17 peripheral clock disabled during sleep mode */
    constexpr std::uint32_t RCC_APB2LPENR_TIM17LPEN_B_0x0 = 0;
        /** @brief TIM17 peripheral clock enabled during sleep mode (default after reset) */
    constexpr std::uint32_t RCC_APB2LPENR_TIM17LPEN_B_0x1 = 1;

    /** @brief SPI4 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief SPI6 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief SAI1 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief SAI2 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief SPI5 clock enable during Slsleepeep mode Set and reset by software. */
    using RCC_APB3LPENR_SPI5LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: SPI5 peripheral clock disabled during sleep mode (value: 0)
     *          - B_0x1: SPI5 peripheral clock enabled during Slesleepep mode (default after reset) (value: 1)
     */
        /** @brief SPI5 peripheral clock disabled during sleep mode */
    constexpr std::uint32_t RCC_APB3LPENR_SPI5LPEN_B_0x0 = 0;
        /** @brief SPI5 peripheral clock enabled during Slesleepep mode (default after reset) */
    constexpr std::uint32_t RCC_APB3LPENR_SPI5LPEN_B_0x1 = 1;
    ...
    /** @brief I2C3 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief I2C4 clock enable during sleep mode Set and reset by software. */
    using RCC_APB3LPENR_I2C4LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: I2C4 peripheral clock disabled during sleep mode (value: 0)
     *          - B_0x1: I2C4 peripheral clock enabled during sleep mode (default after reset) (value: 1)
     */
        /** @brief I2C4 peripheral clock disabled during sleep mode */
    constexpr std::uint32_t RCC_APB3LPENR_I2C4LPEN_B_0x0 = 0;
        /** @brief I2C4 peripheral clock enabled during sleep mode (default after reset) */
    constexpr std::uint32_t RCC_APB3LPENR_I2C4LPEN_B_0x1 = 1;
    ...
    /** @brief LPTIM3 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief LPTIM4 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief LPTIM5 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief LPTIM6 clock enable during sleep mode Set and reset by software. */
    ...
    /** @brief UART4 kernel clock source selection others: reserved, the kernel clock is disabled */
    ...
    /** @brief UART5 kernel clock source selection others: reserved, the kernel clock is disabled */
    ...
    /** @brief USART6 kernel clock source selection others: reserved, the kernel clock is disabled */
    ...
    /** @brief UART7 kernel clock source selection others: reserved, the kernel clock is disabled */
    ...
    /** @brief UART8 kernel clock source selection others: reserved, the kernel clock is disabled */
    ...
    /** @brief UART9 kernel clock source selection others: reserved, the kernel clock is disabled */
    ...
    /** @brief USART10 kernel clock source selection others: reserved, the kernel clock is disabled */
    ...
    /** @brief TIM12, TIM15 and LPTIM2 input capture source selection Set and reset by software. */
    ...
    /** @brief USART11 kernel clock source selection Set and reset by software. others: reserved, the kernel clock is disabled */
    ...
    /** @brief USART12 kernel clock source selection Set and reset by software. others: reserved, the kernel clock is disabled */
    using RCC_CCIPR2_USART12SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: rcc_pclk1 selected as kernel clock (default after reset) (value: 0)
     *          - B_0x1: pll2_q_ck selected as kernel clock (value: 1)
     *          - B_0x2: pll3_q_ck selected as kernel clock (value: 2)
     ...
     */
        /** @brief rcc_pclk1 selected as kernel clock (default after reset) */
    constexpr std::uint32_t RCC_CCIPR2_USART12SEL_B_0x0 = 0;
        /** @brief pll2_q_ck selected as kernel clock */
    constexpr std::uint32_t RCC_CCIPR2_USART12SEL_B_0x1 = 1;
        /** @brief pll3_q_ck selected as kernel clock */
    constexpr std::uint32_t RCC_CCIPR2_USART12SEL_B_0x2 = 2;
        /** @brief hsi_ker_ck selected as kernel clock */
    constexpr std::uint32_t RCC_CCIPR2_USART12SEL_B_0x3 = 3;
        /** @brief csi_ker_ck selected as kernel clock */
    constexpr std::uint32_t RCC_CCIPR2_USART12SEL_B_0x4 = 4;
        /** @brief lse_ck selected as kernel clock */
    constexpr std::uint32_t RCC_CCIPR2_USART12SEL_B_0x5 = 5;
    ...
    /** @brief LPTIM3 kernel clock source selection others: reserved, the kernel clock is disabled */
    ...
    /** @brief LPTIM4 kernel clock source selection others: reserved, the kernel clock is disabled */
    ...
    /** @brief LPTIM5 kernel clock source selection others: reserved, the kernel clock is disabled */
    ...
    /** @brief LPTIM6 kernel clock source selection others: reserved, the kernel clock is disabled */
    ...
    /** @brief SPI4 kernel clock source selection others: reserved, the kernel clock is disabled */
    ...
    /** @brief SPI5 kernel clock source selection others: reserved, the kernel clock is disabled */
    using RCC_CCIPR3_SPI5SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: rcc_pclk3 selected as kernel clock (default after reset) (value: 0)
     *          - B_0x1: pll2_q_ck selected as kernel clock (value: 1)
     *          - B_0x2: pll3_q_ck selected as kernel clock (value: 2)
     ...
     */
        /** @brief rcc_pclk3 selected as kernel clock (default after reset) */
    constexpr std::uint32_t RCC_CCIPR3_SPI5SEL_B_0x0 = 0;
        /** @brief pll2_q_ck selected as kernel clock */
    constexpr std::uint32_t RCC_CCIPR3_SPI5SEL_B_0x1 = 1;
        /** @brief pll3_q_ck selected as kernel clock */
    constexpr std::uint32_t RCC_CCIPR3_SPI5SEL_B_0x2 = 2;
        /** @brief hsi_ker_ck selected as kernel clock */
    constexpr std::uint32_t RCC_CCIPR3_SPI5SEL_B_0x3 = 3;
        /** @brief csi_ker_ck selected as kernel clock */
    constexpr std::uint32_t RCC_CCIPR3_SPI5SEL_B_0x4 = 4;
        /** @brief hse_ck selected as kernel clock */
    constexpr std::uint32_t RCC_CCIPR3_SPI5SEL_B_0x5 = 5;

    /** @brief SPI6 kernel clock source selection others: reserved, the kernel clock is disabled */
    ...
    /** @brief OCTOSPI1 kernel clock source selection Set and reset by software. */
    ...
    /** @brief SDMMC2 kernel clock source selection */
    using RCC_CCIPR4_SDMMC2SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: pll1_q_ck selected as kernel clock (default after reset) (value: 0)
     *          - B_0x1: pll2_r_ck selected as kernel clock (value: 1)
     */
        /** @brief pll1_q_ck selected as kernel clock (default after reset) */
    constexpr std::uint32_t RCC_CCIPR4_SDMMC2SEL_B_0x0 = 0;
        /** @brief pll2_r_ck selected as kernel clock */
    constexpr std::uint32_t RCC_CCIPR4_SDMMC2SEL_B_0x1 = 1;
    ...
    using RCC_CCIPR4_I2C4SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: rcc_pclk3 selected as kernel clock (default after reset) (value: 0)
     *          - B_0x1: pll3_r_ck selected as kernel clock (value: 1)
     *          - B_0x2: hsi_ker_ck selected as kernel clock (value: 2)
    ...
    constexpr std::uint32_t RCC_CCIPR5_CECSEL_B_0x2 = 2;
        /** @brief reserved, the kernel clock is disabled */
    constexpr std::uint32_t RCC_CCIPR5_CECSEL_B_0x3 = 3;

    /** @brief FDCAN1 and FDCAN2 kernel clock source selection */
    using RCC_CCIPR5_FDCAN12SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t RCC_CCIPR5_FDCAN12SEL_B_0x0 = 0;
        /** @brief pll1_q_ck selected as kernel clock */
    constexpr std::uint32_t RCC_CCIPR5_FDCAN12SEL_B_0x1 = 1;
        /** @brief pll2_q_ck selected as kernel clock */
    constexpr std::uint32_t RCC_CCIPR5_FDCAN12SEL_B_0x2 = 2;
        /** @brief reserved, the kernel clock is disabled */
    constexpr std::uint32_t RCC_CCIPR5_FDCAN12SEL_B_0x3 = 3;

    /** @brief SAI1 kernel clock source selection others: reserved, the kernel clock is disabled */
    ...
    /** @brief SAI2 kernel clock source selection others: reserved, the kernel clock is disabled */
    ...
    /** @brief CSI clock configuration and status bits security Set and reset by software. */
    ...
    /** @brief per_ck selection security Set and reset by software. */
