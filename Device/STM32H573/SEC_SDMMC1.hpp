...
#ifndef EMBEDDED_PP_STM32H573_SEC_SDMMC1_HPP
#define EMBEDDED_PP_STM32H573_SEC_SDMMC1_HPP
...
namespace STM32H573::SEC_SDMMC1 {

    /** @brief SDMMC_POWER */
    using SDMMC_POWER = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SDMMC state control bits These bits can only be written when the SDMMC is not in the power-on state (PWRCTRL different 11). These bits are used to define the functional state of the SDMMC signals: stopped, SDMMC_D[7:0], SDMMC_CMD and SDMMC_CK are driven high. Any further write is ignored, PWRCTRL value keeps 11. */
    using SDMMC_POWER_PWRCTRL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: After reset, Reset: the SDMMC is disabled and the clock to the Card is stopped, SDMMC_D[7:0], and SDMMC_CMD are HiZ and SDMMC_CK is driven low.When written 00, power-off: the SDMMC is disabled and the clock to the card is (value: 0)
     ...
     */
        /** @brief After reset, Reset: the SDMMC is disabled and the clock to the Card is stopped, SDMMC_D[7:0], and SDMMC_CMD are HiZ and SDMMC_CK is driven low.When written 00, power-off: the SDMMC is disabled and the clock to the card is */
    ...
    /** @details Possible values:
     *          - B_0x0: SDMMC_CK frequency = sdmmc_ker_ck / 1 (Does not support DDR) (value: 0)
     *          - B_0x1: SDMMC_CK frequency = sdmmc_ker_ck / 2 (value: 1)
     *          - B_0x2: SDMMC_CK frequency = sdmmc_ker_ck / 4 (value: 2)
     *          - B_0x80: SDMMC_CK frequency = sdmmc_ker_ck / 256 (value: 128)
     *          - B_0x3FF: SDMMC_CK frequency = sdmmc_ker_ck / 2046 (value: 1023)
     */
        /** @brief SDMMC_CK frequency = sdmmc_ker_ck / 1 (Does not support DDR) */
    constexpr std::uint32_t SDMMC_CLKCR_CLKDIV_B_0x0 = 0;
        /** @brief SDMMC_CK frequency = sdmmc_ker_ck / 2 */
    constexpr std::uint32_t SDMMC_CLKCR_CLKDIV_B_0x1 = 1;
        /** @brief SDMMC_CK frequency = sdmmc_ker_ck / 4 */
    constexpr std::uint32_t SDMMC_CLKCR_CLKDIV_B_0x2 = 2;
        /** @brief SDMMC_CK frequency = sdmmc_ker_ck / 256 */
    constexpr std::uint32_t SDMMC_CLKCR_CLKDIV_B_0x80 = 128;
    ...
    /** @brief Hardware flow control enable This bit can only be written when the CPSM and DPSM are not active (CPSMACT = 0 and DPSMACT = 0) When Hardware flow control is enabled, the meaning of the TXFIFOE and RXFIFOF flags change, please see SDMMC status register definition in . */
    ...
    /** @brief Card status x See . */
    using SDMMC_RESP1R_CARDSTATUSx = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Card status x See . */
    using SDMMC_RESP2R_CARDSTATUSx = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Card status x See . */
    using SDMMC_RESP3R_CARDSTATUSx = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Card status x See . */
    using SDMMC_RESP4R_CARDSTATUSx = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Data transfer enable bit This bit can only be written by firmware when DPSM is inactive (DPSMACT = 0). This bit is cleared by Hardware when data transfer completes. This bit must only be used to transfer data when no associated data transfer command is used, i.e. must not be used with SD or eMMC cards. */
     ...
     *          - B_0x2: eMMC Stream data transfer. (WIDBUS must select 1-bit wide bus mode) (value: 2)
    ...
    constexpr std::uint32_t SDMMC_DCTRL_DTMODE_B_0x1 = 1;
        /** @brief eMMC Stream data transfer. (WIDBUS must select 1-bit wide bus mode) */
    ...
    /** @details Possible values:
     *          - B_0x0: Block length = 20 = 1 byte (value: 0)
     *          - B_0x1: Block length = 21 = 2 bytes (value: 1)
     *          - B_0x2: Block length = 22 = 4 bytes (value: 2)
     *          - B_0x3: Block length = 23 = 8 bytes (value: 3)
     *          - B_0x4: Block length = 24 = 16 bytes (value: 4)
     *          - B_0x5: Block length = 25 = 32 bytes (value: 5)
     *          - B_0x6: Block length = 26 = 64 bytes (value: 6)
     *          - B_0x7: Block length = 27 = 128 bytes (value: 7)
     *          - B_0x8: Block length = 28 = 256 bytes (value: 8)
     *          - B_0x9: Block length = 29 = 512 bytes (value: 9)
     *          - B_0xA: Block length = 210 = 1024 bytes (value: 10)
     *          - B_0xB: Block length = 211 = 2048 bytes (value: 11)
     *          - B_0xC: Block length = 212 = 4096 bytes (value: 12)
     *          - B_0xD: Block length = 213 = 8192 bytes (value: 13)
     *          - B_0xE: Block length = 214 = 16384 bytes (value: 14)
     */
        /** @brief Block length = 20 = 1 byte */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x0 = 0;
        /** @brief Block length = 21 = 2 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x1 = 1;
        /** @brief Block length = 22 = 4 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x2 = 2;
        /** @brief Block length = 23 = 8 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x3 = 3;
        /** @brief Block length = 24 = 16 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x4 = 4;
        /** @brief Block length = 25 = 32 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x5 = 5;
        /** @brief Block length = 26 = 64 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x6 = 6;
        /** @brief Block length = 27 = 128 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x7 = 7;
        /** @brief Block length = 28 = 256 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x8 = 8;
        /** @brief Block length = 29 = 512 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x9 = 9;
        /** @brief Block length = 210 = 1024 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0xA = 10;
        /** @brief Block length = 211 = 2048 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0xB = 11;
        /** @brief Block length = 212 = 4096 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0xC = 12;
        /** @brief Block length = 213 = 8192 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0xD = 13;
        /** @brief Block length = 214 = 16384 bytes */
