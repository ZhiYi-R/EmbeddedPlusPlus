...
#ifndef EMBEDDED_PP_STM32H573_SEC_TIM15_HPP
#define EMBEDDED_PP_STM32H573_SEC_TIM15_HPP
...
namespace STM32H573::SEC_TIM15 {
    ...
    /** @brief COM interrupt flag This flag is set by hardware on a COM event (once the capture/compare control bits CCxE, CCxNE, OCxMhave been updated). It is cleared by software. */
