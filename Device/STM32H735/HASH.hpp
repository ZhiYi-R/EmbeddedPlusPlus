...
#ifndef EMBEDDED_PP_STM32H735_HASH_HPP
#define EMBEDDED_PP_STM32H735_HASH_HPP
...
namespace STM32H735::HASH {
    ...
    using HASH_CR_ALGO0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: SHA-1 (value: 0)
     *          - B_0x1: MD5 (value: 1)
     */
        /** @brief SHA-1 */
    constexpr std::uint32_t HASH_CR_ALGO0_B_0x0 = 0;
        /** @brief MD5 */
    constexpr std::uint32_t HASH_CR_ALGO0_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: if DINNE=0, no word has been pushed into the DIN buffer (both HASH_DIN register and IN FIFO are empty), otherwise one word has been pushed into the DIN buffer (HASH_DIN register contains one word and IN FIFO is empty) (value: 0)
     *          - B_0x1: two words have been pushed into the DIN buffer (that is HASH_DIN register and the IN FIFO contain one word each) (value: 1)
     *          - B_0xF: 16 words have been pushed into the DIN buffer. (value: 15)
     */
        /** @brief if DINNE=0, no word has been pushed into the DIN buffer (both HASH_DIN register and IN FIFO are empty), otherwise one word has been pushed into the DIN buffer (HASH_DIN register contains one word and IN FIFO is empty) */
    constexpr std::uint32_t HASH_CR_NBW_B_0x0 = 0;
        /** @brief two words have been pushed into the DIN buffer (that is HASH_DIN register and the IN FIFO contain one word each) */
    constexpr std::uint32_t HASH_CR_NBW_B_0x1 = 1;
        /** @brief 16 words have been pushed into the DIN buffer. */
    constexpr std::uint32_t HASH_CR_NBW_B_0xF = 15;
    ...
    constexpr std::uint32_t HASH_CR_DINNE_B_0x0 = 0;
        /** @brief The input buffer contains at least one word of data */
    constexpr std::uint32_t HASH_CR_DINNE_B_0x1 = 1;
    ...
    /** @brief Algorithm selection */
    using HASH_CR_ALGO1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: SHA-1 (value: 0)
     *          - B_0x1: MD5 (value: 1)
     */
        /** @brief SHA-1 */
    constexpr std::uint32_t HASH_CR_ALGO1_B_0x0 = 0;
        /** @brief MD5 */
    constexpr std::uint32_t HASH_CR_ALGO1_B_0x1 = 1;
