...
#ifndef EMBEDDED_PP_STM32H73X_ADC2_HPP
#define EMBEDDED_PP_STM32H73X_ADC2_HPP
...
namespace STM32H73x::ADC2 {
     ...
     *          - B_0x1: used when 6.25 MHz < ADC clock frequencyless than or equal 12.5 MHz (value: 1)
     *          - B_0x2: used when 12.5 MHz < ADC clock less than or equal25.0 MHz (value: 2)
    ...
    constexpr std::uint32_t ADC_CR_BOOST_B_0x0 = 0;
        /** @brief used when 6.25 MHz < ADC clock frequencyless than or equal 12.5 MHz */
    constexpr std::uint32_t ADC_CR_BOOST_B_0x1 = 1;
        /** @brief used when 12.5 MHz < ADC clock less than or equal25.0 MHz */
