...
#ifndef EMBEDDED_PP_STM32H742X_CRC_HPP
#define EMBEDDED_PP_STM32H742X_CRC_HPP
...
namespace STM32H742x::CRC {
    ...
    /** @brief Independent Data register */
    using IDR_IDR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using INIT = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0xC, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Programmable initial CRC value */
    using INIT_CRC_INIT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CRC polynomial */
    using POL = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x10, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
