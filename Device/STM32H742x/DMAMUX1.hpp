...
#ifndef EMBEDDED_PP_STM32H742X_DMAMUX1_HPP
#define EMBEDDED_PP_STM32H742X_DMAMUX1_HPP
...
namespace STM32H742x::DMAMUX1 {
    ...
    /** @brief Input DMA request line selected */
    using C14CR_DMAREQ_ID = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Interrupt enable at synchronization event overrun */
    ...
    /** @brief Input DMA request line selected */
    using C15CR_DMAREQ_ID = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Interrupt enable at synchronization event overrun */
    ...
    using RGSR_OF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using RGCFR_COF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
