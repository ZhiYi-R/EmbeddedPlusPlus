...
#ifndef EMBEDDED_PP_STM32H742X_ETHERNET_MAC_HPP
#define EMBEDDED_PP_STM32H742X_ETHERNET_MAC_HPP
...
namespace STM32H742x::Ethernet_MAC {
    ...
    /** @brief MACRWKPFR */
    using MACRWKPFR_MACRWKPFR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief ADDR64 */
    using MACHWF1R_ADDR64 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DCBEN */
