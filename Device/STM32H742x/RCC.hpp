...
#ifndef EMBEDDED_PP_STM32H742X_RCC_HPP
#define EMBEDDED_PP_STM32H742X_RCC_HPP
...
namespace STM32H742x::RCC {
    ...
    using D3AMR_BKPRAMAMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Enable USB_PHY2 clocks */
    using AHB1ENR_USB2OTGHSULPIEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using AHB1LPENR_USB2OTGHSLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USB_PHY2 clocks enable during CSleep mode */
    using AHB1LPENR_USB2OTGHSULPILPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RCC AHB1 Sleep Clock Register */
