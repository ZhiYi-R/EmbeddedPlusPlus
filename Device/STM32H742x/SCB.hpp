...
#ifndef EMBEDDED_PP_STM32H742X_SCB_HPP
#define EMBEDDED_PP_STM32H742X_SCB_HPP
...
namespace STM32H742x::SCB {
    ...
    /** @brief IACCVIOL */
    using CFSR_UFSR_BFSR_MMFSR_IACCVIOL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DACCVIOL */
    using CFSR_UFSR_BFSR_MMFSR_DACCVIOL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief MUNSTKERR */
