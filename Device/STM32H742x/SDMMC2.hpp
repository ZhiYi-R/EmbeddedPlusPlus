...
#ifndef EMBEDDED_PP_STM32H742X_SDMMC2_HPP
#define EMBEDDED_PP_STM32H742X_SDMMC2_HPP
...
namespace STM32H742x::SDMMC2 {
    ...
    using VER_MINREV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief IP major revision number. */
    using VER_MAJREV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using ID_IP_ID = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
