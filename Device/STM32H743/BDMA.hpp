...
#ifndef EMBEDDED_PP_STM32H743_BDMA_HPP
#define EMBEDDED_PP_STM32H743_BDMA_HPP
...
/** @brief BDMA */
namespace STM32H743::BDMA {

    /** @brief BDMA interrupt status register */
    using BDMA_ISR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief global interrupt flag for channel 0 */
    using BDMA_ISR_GIF0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TE, HT or TC event (value: 0)
     *          - B_0x1: a TE, HT or TC event occurred (value: 1)
     */
        /** @brief no TE, HT or TC event */
    constexpr std::uint32_t BDMA_ISR_GIF0_B_0x0 = 0;
        /** @brief a TE, HT or TC event occurred */
    constexpr std::uint32_t BDMA_ISR_GIF0_B_0x1 = 1;

    /** @brief transfer complete (TC) flag for channel 0 */
    using BDMA_ISR_TCIF0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TC event (value: 0)
     *          - B_0x1: a TC event occurred (value: 1)
     */
        /** @brief no TC event */
    constexpr std::uint32_t BDMA_ISR_TCIF0_B_0x0 = 0;
        /** @brief a TC event occurred */
    constexpr std::uint32_t BDMA_ISR_TCIF0_B_0x1 = 1;

    /** @brief half transfer (HT) flag for channel 0 */
    using BDMA_ISR_HTIF0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no HT event (value: 0)
     *          - B_0x1: a HT event occurred (value: 1)
     */
        /** @brief no HT event */
    constexpr std::uint32_t BDMA_ISR_HTIF0_B_0x0 = 0;
        /** @brief a HT event occurred */
    constexpr std::uint32_t BDMA_ISR_HTIF0_B_0x1 = 1;

    /** @brief transfer error (TE) flag for channel 0 */
    using BDMA_ISR_TEIF0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TE event (value: 0)
     *          - B_0x1: a TE event occurred (value: 1)
     */
        /** @brief no TE event */
    constexpr std::uint32_t BDMA_ISR_TEIF0_B_0x0 = 0;
        /** @brief a TE event occurred */
    constexpr std::uint32_t BDMA_ISR_TEIF0_B_0x1 = 1;

    /** @brief global interrupt flag for channel 1 */
    using BDMA_ISR_GIF1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TE, HT or TC event (value: 0)
     *          - B_0x1: a TE, HT or TC event occurred (value: 1)
     */
        /** @brief no TE, HT or TC event */
    constexpr std::uint32_t BDMA_ISR_GIF1_B_0x0 = 0;
        /** @brief a TE, HT or TC event occurred */
    constexpr std::uint32_t BDMA_ISR_GIF1_B_0x1 = 1;

    /** @brief transfer complete (TC) flag for channel 1 */
    using BDMA_ISR_TCIF1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TC event (value: 0)
     *          - B_0x1: a TC event occurred (value: 1)
     */
        /** @brief no TC event */
    constexpr std::uint32_t BDMA_ISR_TCIF1_B_0x0 = 0;
        /** @brief a TC event occurred */
    constexpr std::uint32_t BDMA_ISR_TCIF1_B_0x1 = 1;

    /** @brief half transfer (HT) flag for channel 1 */
    using BDMA_ISR_HTIF1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no HT event (value: 0)
     *          - B_0x1: a HT event occurred (value: 1)
     */
        /** @brief no HT event */
    constexpr std::uint32_t BDMA_ISR_HTIF1_B_0x0 = 0;
        /** @brief a HT event occurred */
    constexpr std::uint32_t BDMA_ISR_HTIF1_B_0x1 = 1;

    /** @brief transfer error (TE) flag for channel 1 */
    using BDMA_ISR_TEIF1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TE event (value: 0)
     *          - B_0x1: a TE event occurred (value: 1)
     */
        /** @brief no TE event */
    constexpr std::uint32_t BDMA_ISR_TEIF1_B_0x0 = 0;
        /** @brief a TE event occurred */
    constexpr std::uint32_t BDMA_ISR_TEIF1_B_0x1 = 1;

    /** @brief global interrupt flag for channel 2 */
    using BDMA_ISR_GIF2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TE, HT or TC event (value: 0)
     *          - B_0x1: a TE, HT or TC event occurred (value: 1)
     */
        /** @brief no TE, HT or TC event */
    constexpr std::uint32_t BDMA_ISR_GIF2_B_0x0 = 0;
        /** @brief a TE, HT or TC event occurred */
    constexpr std::uint32_t BDMA_ISR_GIF2_B_0x1 = 1;

    /** @brief transfer complete (TC) flag for channel 2 */
    using BDMA_ISR_TCIF2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TC event (value: 0)
     *          - B_0x1: a TC event occurred (value: 1)
     */
        /** @brief no TC event */
    constexpr std::uint32_t BDMA_ISR_TCIF2_B_0x0 = 0;
        /** @brief a TC event occurred */
    constexpr std::uint32_t BDMA_ISR_TCIF2_B_0x1 = 1;

    /** @brief half transfer (HT) flag for channel 2 */
    using BDMA_ISR_HTIF2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no HT event (value: 0)
     *          - B_0x1: a HT event occurred (value: 1)
     */
        /** @brief no HT event */
    constexpr std::uint32_t BDMA_ISR_HTIF2_B_0x0 = 0;
        /** @brief a HT event occurred */
    constexpr std::uint32_t BDMA_ISR_HTIF2_B_0x1 = 1;

    /** @brief transfer error (TE) flag for channel 2 */
    using BDMA_ISR_TEIF2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TE event (value: 0)
     *          - B_0x1: a TE event occurred (value: 1)
     */
        /** @brief no TE event */
    constexpr std::uint32_t BDMA_ISR_TEIF2_B_0x0 = 0;
        /** @brief a TE event occurred */
    constexpr std::uint32_t BDMA_ISR_TEIF2_B_0x1 = 1;

    /** @brief global interrupt flag for channel 3 */
    using BDMA_ISR_GIF3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TE, HT or TC event (value: 0)
     *          - B_0x1: a TE, HT or TC event occurred (value: 1)
     */
        /** @brief no TE, HT or TC event */
    constexpr std::uint32_t BDMA_ISR_GIF3_B_0x0 = 0;
        /** @brief a TE, HT or TC event occurred */
    constexpr std::uint32_t BDMA_ISR_GIF3_B_0x1 = 1;

    /** @brief transfer complete (TC) flag for channel 3 */
    using BDMA_ISR_TCIF3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TC event (value: 0)
     *          - B_0x1: a TC event occurred (value: 1)
     */
        /** @brief no TC event */
    constexpr std::uint32_t BDMA_ISR_TCIF3_B_0x0 = 0;
        /** @brief a TC event occurred */
    constexpr std::uint32_t BDMA_ISR_TCIF3_B_0x1 = 1;

    /** @brief half transfer (HT) flag for channel 3 */
    using BDMA_ISR_HTIF3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no HT event (value: 0)
     *          - B_0x1: a HT event occurred (value: 1)
     */
        /** @brief no HT event */
    constexpr std::uint32_t BDMA_ISR_HTIF3_B_0x0 = 0;
        /** @brief a HT event occurred */
    constexpr std::uint32_t BDMA_ISR_HTIF3_B_0x1 = 1;

    /** @brief transfer error (TE) flag for channel 3 */
    using BDMA_ISR_TEIF3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TE event (value: 0)
     *          - B_0x1: a TE event occurred (value: 1)
     */
        /** @brief no TE event */
    constexpr std::uint32_t BDMA_ISR_TEIF3_B_0x0 = 0;
        /** @brief a TE event occurred */
    constexpr std::uint32_t BDMA_ISR_TEIF3_B_0x1 = 1;

    /** @brief global interrupt flag for channel 4 */
    using BDMA_ISR_GIF4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TE, HT or TC event (value: 0)
     *          - B_0x1: a TE, HT or TC event occurred (value: 1)
     */
        /** @brief no TE, HT or TC event */
    constexpr std::uint32_t BDMA_ISR_GIF4_B_0x0 = 0;
        /** @brief a TE, HT or TC event occurred */
    constexpr std::uint32_t BDMA_ISR_GIF4_B_0x1 = 1;

    /** @brief transfer complete (TC) flag for channel 4 */
    using BDMA_ISR_TCIF4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TC event (value: 0)
     *          - B_0x1: a TC event occurred (value: 1)
     */
        /** @brief no TC event */
    constexpr std::uint32_t BDMA_ISR_TCIF4_B_0x0 = 0;
        /** @brief a TC event occurred */
    constexpr std::uint32_t BDMA_ISR_TCIF4_B_0x1 = 1;

    /** @brief half transfer (HT) flag for channel 4 */
    using BDMA_ISR_HTIF4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no HT event (value: 0)
     *          - B_0x1: a HT event occurred (value: 1)
     */
        /** @brief no HT event */
    constexpr std::uint32_t BDMA_ISR_HTIF4_B_0x0 = 0;
        /** @brief a HT event occurred */
    constexpr std::uint32_t BDMA_ISR_HTIF4_B_0x1 = 1;

    /** @brief transfer error (TE) flag for channel 4 */
    using BDMA_ISR_TEIF4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TE event (value: 0)
     *          - B_0x1: a TE event occurred (value: 1)
     */
        /** @brief no TE event */
    constexpr std::uint32_t BDMA_ISR_TEIF4_B_0x0 = 0;
        /** @brief a TE event occurred */
    constexpr std::uint32_t BDMA_ISR_TEIF4_B_0x1 = 1;

    /** @brief global interrupt flag for channel 5 */
    using BDMA_ISR_GIF5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TE, HT or TC event (value: 0)
     *          - B_0x1: a TE, HT or TC event occurred (value: 1)
     */
        /** @brief no TE, HT or TC event */
    constexpr std::uint32_t BDMA_ISR_GIF5_B_0x0 = 0;
        /** @brief a TE, HT or TC event occurred */
    constexpr std::uint32_t BDMA_ISR_GIF5_B_0x1 = 1;

    /** @brief transfer complete (TC) flag for channel 5 */
    using BDMA_ISR_TCIF5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TC event (value: 0)
     *          - B_0x1: a TC event occurred (value: 1)
     */
        /** @brief no TC event */
    constexpr std::uint32_t BDMA_ISR_TCIF5_B_0x0 = 0;
        /** @brief a TC event occurred */
    constexpr std::uint32_t BDMA_ISR_TCIF5_B_0x1 = 1;

    /** @brief half transfer (HT) flag for channel 5 */
    using BDMA_ISR_HTIF5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no HT event (value: 0)
     *          - B_0x1: a HT event occurred (value: 1)
     */
        /** @brief no HT event */
    constexpr std::uint32_t BDMA_ISR_HTIF5_B_0x0 = 0;
        /** @brief a HT event occurred */
    constexpr std::uint32_t BDMA_ISR_HTIF5_B_0x1 = 1;

    /** @brief transfer error (TE) flag for channel 5 */
    using BDMA_ISR_TEIF5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TE event (value: 0)
     *          - B_0x1: a TE event occurred (value: 1)
     */
        /** @brief no TE event */
    constexpr std::uint32_t BDMA_ISR_TEIF5_B_0x0 = 0;
        /** @brief a TE event occurred */
    constexpr std::uint32_t BDMA_ISR_TEIF5_B_0x1 = 1;

    /** @brief global interrupt flag for channel 6 */
    using BDMA_ISR_GIF6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TE, HT or TC event (value: 0)
     *          - B_0x1: a TE, HT or TC event occurred (value: 1)
     */
        /** @brief no TE, HT or TC event */
    constexpr std::uint32_t BDMA_ISR_GIF6_B_0x0 = 0;
        /** @brief a TE, HT or TC event occurred */
    constexpr std::uint32_t BDMA_ISR_GIF6_B_0x1 = 1;

    /** @brief transfer complete (TC) flag for channel 6 */
    using BDMA_ISR_TCIF6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TC event (value: 0)
     *          - B_0x1: a TC event occurred (value: 1)
     */
        /** @brief no TC event */
    constexpr std::uint32_t BDMA_ISR_TCIF6_B_0x0 = 0;
        /** @brief a TC event occurred */
    constexpr std::uint32_t BDMA_ISR_TCIF6_B_0x1 = 1;

    /** @brief half transfer (HT) flag for channel 6 */
    using BDMA_ISR_HTIF6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no HT event (value: 0)
     *          - B_0x1: a HT event occurred (value: 1)
     */
        /** @brief no HT event */
    constexpr std::uint32_t BDMA_ISR_HTIF6_B_0x0 = 0;
        /** @brief a HT event occurred */
    constexpr std::uint32_t BDMA_ISR_HTIF6_B_0x1 = 1;

    /** @brief transfer error (TE) flag for channel 6 */
    using BDMA_ISR_TEIF6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TE event (value: 0)
     *          - B_0x1: a TE event occurred (value: 1)
     */
        /** @brief no TE event */
    constexpr std::uint32_t BDMA_ISR_TEIF6_B_0x0 = 0;
        /** @brief a TE event occurred */
    constexpr std::uint32_t BDMA_ISR_TEIF6_B_0x1 = 1;

    /** @brief global interrupt flag for channel 7 */
    using BDMA_ISR_GIF7 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TE, HT or TC event (value: 0)
     *          - B_0x1: a TE, HT or TC event occurred (value: 1)
     */
        /** @brief no TE, HT or TC event */
    constexpr std::uint32_t BDMA_ISR_GIF7_B_0x0 = 0;
        /** @brief a TE, HT or TC event occurred */
    constexpr std::uint32_t BDMA_ISR_GIF7_B_0x1 = 1;

    /** @brief transfer complete (TC) flag for channel 7 */
    using BDMA_ISR_TCIF7 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TC event (value: 0)
     *          - B_0x1: a TC event occurred (value: 1)
     */
        /** @brief no TC event */
    constexpr std::uint32_t BDMA_ISR_TCIF7_B_0x0 = 0;
        /** @brief a TC event occurred */
    constexpr std::uint32_t BDMA_ISR_TCIF7_B_0x1 = 1;

    /** @brief half transfer (HT) flag for channel 7 */
    using BDMA_ISR_HTIF7 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no HT event (value: 0)
     *          - B_0x1: a HT event occurred (value: 1)
     */
        /** @brief no HT event */
    constexpr std::uint32_t BDMA_ISR_HTIF7_B_0x0 = 0;
        /** @brief a HT event occurred */
    constexpr std::uint32_t BDMA_ISR_HTIF7_B_0x1 = 1;

    /** @brief transfer error (TE) flag for channel 7 */
    using BDMA_ISR_TEIF7 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no TE event (value: 0)
     *          - B_0x1: a TE event occurred (value: 1)
     */
        /** @brief no TE event */
    constexpr std::uint32_t BDMA_ISR_TEIF7_B_0x0 = 0;
        /** @brief a TE event occurred */
    constexpr std::uint32_t BDMA_ISR_TEIF7_B_0x1 = 1;

    /** @brief BDMA interrupt flag clear register */
    using BDMA_IFCR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief global interrupt flag clear for channel 0 */
    using BDMA_IFCR_CGIF0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief transfer complete flag clear for channel 0 */
    using BDMA_IFCR_CTCIF0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief half transfer flag clear for channel 0 */
    using BDMA_IFCR_CHTIF0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief transfer error flag clear for channel 0 */
    using BDMA_IFCR_CTEIF0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief global interrupt flag clear for channel 0 */
    using BDMA_IFCR_CGIF1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief transfer complete flag clear for channel 1 */
    using BDMA_IFCR_CTCIF1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief half transfer flag clear for channel 1 */
    using BDMA_IFCR_CHTIF1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief transfer error flag clear for channel 1 */
    using BDMA_IFCR_CTEIF1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief global interrupt flag clear for channel 2 */
    using BDMA_IFCR_CGIF2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief transfer complete flag clear for channel 2 */
    using BDMA_IFCR_CTCIF2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief half transfer flag clear for channe2 */
    using BDMA_IFCR_CHTIF2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief transfer error flag clear for channel 2 */
    using BDMA_IFCR_CTEIF2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief global interrupt flag clear for channel 3 */
    using BDMA_IFCR_CGIF3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief transfer complete flag clear for channel 3 */
    using BDMA_IFCR_CTCIF3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief half transfer flag clear for channel 3 */
    using BDMA_IFCR_CHTIF3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief transfer error flag clear for channel 3 */
    using BDMA_IFCR_CTEIF3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief global interrupt flag clear for channel 4 */
    using BDMA_IFCR_CGIF4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief transfer complete flag clear for channel 4 */
    using BDMA_IFCR_CTCIF4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief half transfer flag clear for channel 4 */
    using BDMA_IFCR_CHTIF4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief transfer error flag clear for channel 4 */
    using BDMA_IFCR_CTEIF4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief global interrupt flag clear for channel 5 */
    using BDMA_IFCR_CGIF5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief transfer complete flag clear for channel 5 */
    using BDMA_IFCR_CTCIF5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief half transfer flag clear for channel 5 */
    using BDMA_IFCR_CHTIF5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief transfer error flag clear for channel 5 */
    using BDMA_IFCR_CTEIF5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief global interrupt flag clear for channel 6 */
    using BDMA_IFCR_CGIF6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief transfer complete flag clear for channel 6 */
    using BDMA_IFCR_CTCIF6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief half transfer flag clear for channel 6 */
    using BDMA_IFCR_CHTIF6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief transfer error flag clear for channel 6 */
    using BDMA_IFCR_CTEIF6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief global interrupt flag clear for channel 7 */
    using BDMA_IFCR_CGIF7 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief transfer complete flag clear for channel 7 */
    using BDMA_IFCR_CTCIF7 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief half transfer flag clear for channel 7 */
    using BDMA_IFCR_CHTIF7 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief transfer error flag clear for channel 7 */
    using BDMA_IFCR_CTEIF7 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief BDMA channel 0 configuration register */
    using BDMA_CCR0 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief channel enable When a channel transfer error occurs, this bit is cleared by hardware. It can not be set again by software (channel x re-activated) until the TEIFx bit of the BDMA_ISR register is cleared (by setting the CTEIFx bit of the BDMA_IFCR register). Note: this bit is set and cleared by software. */
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR0_EN_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR0_EN_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR0_TCIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR0_TCIE_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR0_HTIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR0_HTIE_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR0_TEIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR0_TEIE_B_0x1 = 1;
    ...
    constexpr std::uint32_t BDMA_CCR0_DIR_B_0x0 = 0;
        /** @brief read from memory */
    constexpr std::uint32_t BDMA_CCR0_DIR_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR0_CIRC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR0_CIRC_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR0_PINC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR0_PINC_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR0_MINC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR0_MINC_B_0x1 = 1;
     ...
     */
        /** @brief 8 bits */
    constexpr std::uint32_t BDMA_CCR0_PSIZE_B_0x0 = 0;
        /** @brief 16 bits */
    constexpr std::uint32_t BDMA_CCR0_PSIZE_B_0x1 = 1;
        /** @brief 32 bits */
    constexpr std::uint32_t BDMA_CCR0_PSIZE_B_0x2 = 2;
     ...
     */
        /** @brief 8 bits */
    constexpr std::uint32_t BDMA_CCR0_MSIZE_B_0x0 = 0;
        /** @brief 16 bits */
    constexpr std::uint32_t BDMA_CCR0_MSIZE_B_0x1 = 1;
        /** @brief 32 bits */
    constexpr std::uint32_t BDMA_CCR0_MSIZE_B_0x2 = 2;
     ...
     */
        /** @brief low */
    constexpr std::uint32_t BDMA_CCR0_PL_B_0x0 = 0;
        /** @brief medium */
    constexpr std::uint32_t BDMA_CCR0_PL_B_0x1 = 1;
        /** @brief high */
    constexpr std::uint32_t BDMA_CCR0_PL_B_0x2 = 2;
        /** @brief very high */
    constexpr std::uint32_t BDMA_CCR0_PL_B_0x3 = 3;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR0_MEM2MEM_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR0_MEM2MEM_B_0x1 = 1;

    /** @brief double-buffer mode This bit must be set only in memory-to-peripheral and peripheral-to-memory transfers (MEM2MEM=0). The CIRC bit must also be set in double buffer mode. Note: this bit is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is not read-only when the channel is enabled (EN = 1). */
    using BDMA_CCR0_DBM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: disabled (no memory address switch at the end of the BDMA transfer) (value: 0)
     *          - B_0x1: enabled (memory address switched at the end of the BDMA transfer) (value: 1)
     */
        /** @brief disabled (no memory address switch at the end of the BDMA transfer) */
    constexpr std::uint32_t BDMA_CCR0_DBM_B_0x0 = 0;
        /** @brief enabled (memory address switched at the end of the BDMA transfer) */
    constexpr std::uint32_t BDMA_CCR0_DBM_B_0x1 = 1;

    /** @brief current target memory of DMA transfer in double-buffer mode This bit is toggled by hardware at the end of each channel transfer in double-buffer mode. Note: this bit is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is read-only when the channel is enabled (EN = 1). */
    using BDMA_CCR0_CT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: memory 0 (addressed by the BDMA_CM0AR pointer) (value: 0)
     *          - B_0x1: memory 1 (addressed by the BDMA_CM1AR pointer) (value: 1)
     */
        /** @brief memory 0 (addressed by the BDMA_CM0AR pointer) */
    constexpr std::uint32_t BDMA_CCR0_CT_B_0x0 = 0;
        /** @brief memory 1 (addressed by the BDMA_CM1AR pointer) */
    constexpr std::uint32_t BDMA_CCR0_CT_B_0x1 = 1;

    /** @brief BDMA_CNDTR0 register */
    using BDMA_CNDTR0 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0xC, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief number of data to transfer (0 to 216 - 1) This field is updated by hardware when the channel is enabled: It is decremented after each single BDMA 'read followed by write' transfer, indicating the remaining amount of data items to transfer. It is kept at zero when the programmed amount of data to transfer is reached, if the channel is not in circular mode (CIRC = 0 in the BDMA_CCRx register). It is reloaded automatically by the previously programmed value, when the transfer is complete, if the channel is in circular mode (CIRC = 1). If this field is zero, no transfer can be served whatever the channel status (enabled or not). Note: this field is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is read-only when the channel is enabled (EN = 1). */
    using BDMA_CNDTR0_NDT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief BDMA_CPAR0 register */
    ...
    /** @brief BDMA_CM1AR0 register */
    using BDMA_CM1AR0 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x18, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief peripheral address It contains the base address of the memory from/to which the data is read/written. When MSIZE[1:0] = 01 (16 bits), bit 0 of MA[31:0] is ignored. Access is automatically aligned to a half-word address. When MSIZE = 10 (32 bits), bits 1 and 0 of MA[31:0] are ignored. Access is automatically aligned to a word address. In memory-to-memory mode, this register identifies the memory source address if DIR = 1 and the memory destination address if DIR = 0. In peripheral-to-peripheral mode, this register identifies the peripheral source address DIR = 1 and the peripheral destination address if DIR = 0. Note: this register is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is not read-only when the channel is enabled (EN = 1). */
    using BDMA_CM1AR0_MA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief BDMA channel 1 configuration register */
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR1_EN_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR1_EN_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR1_TCIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR1_TCIE_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR1_HTIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR1_HTIE_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR1_TEIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR1_TEIE_B_0x1 = 1;
     ...
     */
        /** @brief read from peripheral */
    constexpr std::uint32_t BDMA_CCR1_DIR_B_0x0 = 0;
        /** @brief read from memory */
    constexpr std::uint32_t BDMA_CCR1_DIR_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR1_CIRC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR1_CIRC_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR1_PINC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR1_PINC_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR1_MINC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR1_MINC_B_0x1 = 1;
     ...
     */
        /** @brief 8 bits */
    constexpr std::uint32_t BDMA_CCR1_PSIZE_B_0x0 = 0;
        /** @brief 16 bits */
    constexpr std::uint32_t BDMA_CCR1_PSIZE_B_0x1 = 1;
        /** @brief 32 bits */
    constexpr std::uint32_t BDMA_CCR1_PSIZE_B_0x2 = 2;
     ...
     */
        /** @brief 8 bits */
    constexpr std::uint32_t BDMA_CCR1_MSIZE_B_0x0 = 0;
        /** @brief 16 bits */
    constexpr std::uint32_t BDMA_CCR1_MSIZE_B_0x1 = 1;
        /** @brief 32 bits */
    constexpr std::uint32_t BDMA_CCR1_MSIZE_B_0x2 = 2;
     ...
     */
        /** @brief low */
    constexpr std::uint32_t BDMA_CCR1_PL_B_0x0 = 0;
        /** @brief medium */
    constexpr std::uint32_t BDMA_CCR1_PL_B_0x1 = 1;
        /** @brief high */
    constexpr std::uint32_t BDMA_CCR1_PL_B_0x2 = 2;
        /** @brief very high */
    constexpr std::uint32_t BDMA_CCR1_PL_B_0x3 = 3;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR1_MEM2MEM_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR1_MEM2MEM_B_0x1 = 1;
     ...
     */
        /** @brief disabled (no memory address switch at the end of the BDMA transfer) */
    constexpr std::uint32_t BDMA_CCR1_DBM_B_0x0 = 0;
        /** @brief enabled (memory address switched at the end of the BDMA transfer) */
    constexpr std::uint32_t BDMA_CCR1_DBM_B_0x1 = 1;
     ...
     */
        /** @brief memory 0 (addressed by the BDMA_CM0AR pointer) */
    constexpr std::uint32_t BDMA_CCR1_CT_B_0x0 = 0;
        /** @brief memory 1 (addressed by the BDMA_CM1AR pointer) */
    constexpr std::uint32_t BDMA_CCR1_CT_B_0x1 = 1;

    /** @brief BDMA_CNDTR1 register */
    ...
    /** @brief BDMA_CM1AR1 register */
    using BDMA_CM1AR1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x2C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief peripheral address It contains the base address of the memory from/to which the data is read/written. When MSIZE[1:0] = 01 (16 bits), bit 0 of MA[31:0] is ignored. Access is automatically aligned to a half-word address. When MSIZE = 10 (32 bits), bits 1 and 0 of MA[31:0] are ignored. Access is automatically aligned to a word address. In memory-to-memory mode, this register identifies the memory source address if DIR = 1 and the memory destination address if DIR = 0. In peripheral-to-peripheral mode, this register identifies the peripheral source address DIR = 1 and the peripheral destination address if DIR = 0. Note: this register is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is not read-only when the channel is enabled (EN = 1). */
    using BDMA_CM1AR1_MA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief BDMA channel 2 configuration register */
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR2_EN_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR2_EN_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR2_TCIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR2_TCIE_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR2_HTIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR2_HTIE_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR2_TEIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR2_TEIE_B_0x1 = 1;
     ...
     */
        /** @brief read from peripheral */
    constexpr std::uint32_t BDMA_CCR2_DIR_B_0x0 = 0;
        /** @brief read from memory */
    constexpr std::uint32_t BDMA_CCR2_DIR_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR2_CIRC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR2_CIRC_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR2_PINC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR2_PINC_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR2_MINC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR2_MINC_B_0x1 = 1;
     ...
     */
        /** @brief 8 bits */
    constexpr std::uint32_t BDMA_CCR2_PSIZE_B_0x0 = 0;
        /** @brief 16 bits */
    constexpr std::uint32_t BDMA_CCR2_PSIZE_B_0x1 = 1;
        /** @brief 32 bits */
    constexpr std::uint32_t BDMA_CCR2_PSIZE_B_0x2 = 2;
     ...
     */
        /** @brief 8 bits */
    constexpr std::uint32_t BDMA_CCR2_MSIZE_B_0x0 = 0;
        /** @brief 16 bits */
    constexpr std::uint32_t BDMA_CCR2_MSIZE_B_0x1 = 1;
        /** @brief 32 bits */
    constexpr std::uint32_t BDMA_CCR2_MSIZE_B_0x2 = 2;
     ...
     */
        /** @brief low */
    constexpr std::uint32_t BDMA_CCR2_PL_B_0x0 = 0;
        /** @brief medium */
    constexpr std::uint32_t BDMA_CCR2_PL_B_0x1 = 1;
        /** @brief high */
    constexpr std::uint32_t BDMA_CCR2_PL_B_0x2 = 2;
        /** @brief very high */
    constexpr std::uint32_t BDMA_CCR2_PL_B_0x3 = 3;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR2_MEM2MEM_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR2_MEM2MEM_B_0x1 = 1;
     ...
     */
        /** @brief disabled (no memory address switch at the end of the BDMA transfer) */
    constexpr std::uint32_t BDMA_CCR2_DBM_B_0x0 = 0;
        /** @brief enabled (memory address switched at the end of the BDMA transfer) */
    constexpr std::uint32_t BDMA_CCR2_DBM_B_0x1 = 1;
     ...
     */
        /** @brief memory 0 (addressed by the BDMA_CM0AR pointer) */
    constexpr std::uint32_t BDMA_CCR2_CT_B_0x0 = 0;
        /** @brief memory 1 (addressed by the BDMA_CM1AR pointer) */
    constexpr std::uint32_t BDMA_CCR2_CT_B_0x1 = 1;

    /** @brief BDMA_CNDTR2 register */
    ...
    /** @brief BDMA_CM1AR2 register */
    using BDMA_CM1AR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x40, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief peripheral address It contains the base address of the memory from/to which the data is read/written. When MSIZE[1:0] = 01 (16 bits), bit 0 of MA[31:0] is ignored. Access is automatically aligned to a half-word address. When MSIZE = 10 (32 bits), bits 1 and 0 of MA[31:0] are ignored. Access is automatically aligned to a word address. In memory-to-memory mode, this register identifies the memory source address if DIR = 1 and the memory destination address if DIR = 0. In peripheral-to-peripheral mode, this register identifies the peripheral source address DIR = 1 and the peripheral destination address if DIR = 0. Note: this register is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is not read-only when the channel is enabled (EN = 1). */
    using BDMA_CM1AR2_MA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief BDMA channel 3 configuration register */
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR3_EN_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR3_EN_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR3_TCIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR3_TCIE_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR3_HTIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR3_HTIE_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR3_TEIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR3_TEIE_B_0x1 = 1;
     ...
     */
        /** @brief read from peripheral */
    constexpr std::uint32_t BDMA_CCR3_DIR_B_0x0 = 0;
        /** @brief read from memory */
    constexpr std::uint32_t BDMA_CCR3_DIR_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR3_CIRC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR3_CIRC_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR3_PINC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR3_PINC_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR3_MINC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR3_MINC_B_0x1 = 1;
     ...
     */
        /** @brief 8 bits */
    constexpr std::uint32_t BDMA_CCR3_PSIZE_B_0x0 = 0;
        /** @brief 16 bits */
    constexpr std::uint32_t BDMA_CCR3_PSIZE_B_0x1 = 1;
        /** @brief 32 bits */
    constexpr std::uint32_t BDMA_CCR3_PSIZE_B_0x2 = 2;
     ...
     */
        /** @brief 8 bits */
    constexpr std::uint32_t BDMA_CCR3_MSIZE_B_0x0 = 0;
        /** @brief 16 bits */
    constexpr std::uint32_t BDMA_CCR3_MSIZE_B_0x1 = 1;
        /** @brief 32 bits */
    constexpr std::uint32_t BDMA_CCR3_MSIZE_B_0x2 = 2;
     ...
     */
        /** @brief low */
    constexpr std::uint32_t BDMA_CCR3_PL_B_0x0 = 0;
        /** @brief medium */
    constexpr std::uint32_t BDMA_CCR3_PL_B_0x1 = 1;
        /** @brief high */
    constexpr std::uint32_t BDMA_CCR3_PL_B_0x2 = 2;
        /** @brief very high */
    constexpr std::uint32_t BDMA_CCR3_PL_B_0x3 = 3;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR3_MEM2MEM_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR3_MEM2MEM_B_0x1 = 1;
     ...
     */
        /** @brief disabled (no memory address switch at the end of the BDMA transfer) */
    constexpr std::uint32_t BDMA_CCR3_DBM_B_0x0 = 0;
        /** @brief enabled (memory address switched at the end of the BDMA transfer) */
    constexpr std::uint32_t BDMA_CCR3_DBM_B_0x1 = 1;
     ...
     */
        /** @brief memory 0 (addressed by the BDMA_CM0AR pointer) */
    constexpr std::uint32_t BDMA_CCR3_CT_B_0x0 = 0;
        /** @brief memory 1 (addressed by the BDMA_CM1AR pointer) */
    constexpr std::uint32_t BDMA_CCR3_CT_B_0x1 = 1;

    /** @brief BDMA_CNDTR3 register */
    ...
    /** @brief BDMA_CM1AR3 register */
    using BDMA_CM1AR3 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x54, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief peripheral address It contains the base address of the memory from/to which the data is read/written. When MSIZE[1:0] = 01 (16 bits), bit 0 of MA[31:0] is ignored. Access is automatically aligned to a half-word address. When MSIZE = 10 (32 bits), bits 1 and 0 of MA[31:0] are ignored. Access is automatically aligned to a word address. In memory-to-memory mode, this register identifies the memory source address if DIR = 1 and the memory destination address if DIR = 0. In peripheral-to-peripheral mode, this register identifies the peripheral source address DIR = 1 and the peripheral destination address if DIR = 0. Note: this register is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is not read-only when the channel is enabled (EN = 1). */
    using BDMA_CM1AR3_MA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief BDMA channel 4 configuration register */
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR4_EN_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR4_EN_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR4_TCIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR4_TCIE_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR4_HTIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR4_HTIE_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR4_TEIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR4_TEIE_B_0x1 = 1;
     ...
     */
        /** @brief read from peripheral */
    constexpr std::uint32_t BDMA_CCR4_DIR_B_0x0 = 0;
        /** @brief read from memory */
    constexpr std::uint32_t BDMA_CCR4_DIR_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR4_CIRC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR4_CIRC_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR4_PINC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR4_PINC_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR4_MINC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR4_MINC_B_0x1 = 1;
     ...
     */
        /** @brief 8 bits */
    constexpr std::uint32_t BDMA_CCR4_PSIZE_B_0x0 = 0;
        /** @brief 16 bits */
    constexpr std::uint32_t BDMA_CCR4_PSIZE_B_0x1 = 1;
        /** @brief 32 bits */
    constexpr std::uint32_t BDMA_CCR4_PSIZE_B_0x2 = 2;
     ...
     */
        /** @brief 8 bits */
    constexpr std::uint32_t BDMA_CCR4_MSIZE_B_0x0 = 0;
        /** @brief 16 bits */
    constexpr std::uint32_t BDMA_CCR4_MSIZE_B_0x1 = 1;
        /** @brief 32 bits */
    constexpr std::uint32_t BDMA_CCR4_MSIZE_B_0x2 = 2;
     ...
     */
        /** @brief low */
    constexpr std::uint32_t BDMA_CCR4_PL_B_0x0 = 0;
        /** @brief medium */
    constexpr std::uint32_t BDMA_CCR4_PL_B_0x1 = 1;
        /** @brief high */
    constexpr std::uint32_t BDMA_CCR4_PL_B_0x2 = 2;
        /** @brief very high */
    constexpr std::uint32_t BDMA_CCR4_PL_B_0x3 = 3;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR4_MEM2MEM_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR4_MEM2MEM_B_0x1 = 1;
     ...
     */
        /** @brief disabled (no memory address switch at the end of the BDMA transfer) */
    constexpr std::uint32_t BDMA_CCR4_DBM_B_0x0 = 0;
        /** @brief enabled (memory address switched at the end of the BDMA transfer) */
    constexpr std::uint32_t BDMA_CCR4_DBM_B_0x1 = 1;
     ...
     */
        /** @brief memory 0 (addressed by the BDMA_CM0AR pointer) */
    constexpr std::uint32_t BDMA_CCR4_CT_B_0x0 = 0;
        /** @brief memory 1 (addressed by the BDMA_CM1AR pointer) */
    constexpr std::uint32_t BDMA_CCR4_CT_B_0x1 = 1;

    /** @brief BDMA_CNDTR4 register */
    ...
    /** @brief BDMA_CM1AR4 register */
    using BDMA_CM1AR4 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x68, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief peripheral address It contains the base address of the memory from/to which the data is read/written. When MSIZE[1:0] = 01 (16 bits), bit 0 of MA[31:0] is ignored. Access is automatically aligned to a half-word address. When MSIZE = 10 (32 bits), bits 1 and 0 of MA[31:0] are ignored. Access is automatically aligned to a word address. In memory-to-memory mode, this register identifies the memory source address if DIR = 1 and the memory destination address if DIR = 0. In peripheral-to-peripheral mode, this register identifies the peripheral source address DIR = 1 and the peripheral destination address if DIR = 0. Note: this register is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is not read-only when the channel is enabled (EN = 1). */
    using BDMA_CM1AR4_MA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief BDMA channel 5 configuration register */
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR5_EN_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR5_EN_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR5_TCIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR5_TCIE_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR5_HTIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR5_HTIE_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR5_TEIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR5_TEIE_B_0x1 = 1;
     ...
     */
        /** @brief read from peripheral */
    constexpr std::uint32_t BDMA_CCR5_DIR_B_0x0 = 0;
        /** @brief read from memory */
    constexpr std::uint32_t BDMA_CCR5_DIR_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR5_CIRC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR5_CIRC_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR5_PINC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR5_PINC_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR5_MINC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR5_MINC_B_0x1 = 1;
     ...
     */
        /** @brief 8 bits */
    constexpr std::uint32_t BDMA_CCR5_PSIZE_B_0x0 = 0;
        /** @brief 16 bits */
    constexpr std::uint32_t BDMA_CCR5_PSIZE_B_0x1 = 1;
        /** @brief 32 bits */
    constexpr std::uint32_t BDMA_CCR5_PSIZE_B_0x2 = 2;
     ...
     */
        /** @brief 8 bits */
    constexpr std::uint32_t BDMA_CCR5_MSIZE_B_0x0 = 0;
        /** @brief 16 bits */
    constexpr std::uint32_t BDMA_CCR5_MSIZE_B_0x1 = 1;
        /** @brief 32 bits */
    constexpr std::uint32_t BDMA_CCR5_MSIZE_B_0x2 = 2;
     ...
     */
        /** @brief low */
    constexpr std::uint32_t BDMA_CCR5_PL_B_0x0 = 0;
        /** @brief medium */
    constexpr std::uint32_t BDMA_CCR5_PL_B_0x1 = 1;
        /** @brief high */
    constexpr std::uint32_t BDMA_CCR5_PL_B_0x2 = 2;
        /** @brief very high */
    constexpr std::uint32_t BDMA_CCR5_PL_B_0x3 = 3;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR5_MEM2MEM_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR5_MEM2MEM_B_0x1 = 1;
     ...
     */
        /** @brief disabled (no memory address switch at the end of the BDMA transfer) */
    constexpr std::uint32_t BDMA_CCR5_DBM_B_0x0 = 0;
        /** @brief enabled (memory address switched at the end of the BDMA transfer) */
    constexpr std::uint32_t BDMA_CCR5_DBM_B_0x1 = 1;
     ...
     */
        /** @brief memory 0 (addressed by the BDMA_CM0AR pointer) */
    constexpr std::uint32_t BDMA_CCR5_CT_B_0x0 = 0;
        /** @brief memory 1 (addressed by the BDMA_CM1AR pointer) */
    constexpr std::uint32_t BDMA_CCR5_CT_B_0x1 = 1;

    /** @brief BDMA_CNDTR5 register */
    ...
    /** @brief BDMA_CM1AR5 register */
    using BDMA_CM1AR5 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x7C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief peripheral address It contains the base address of the memory from/to which the data is read/written. When MSIZE[1:0] = 01 (16 bits), bit 0 of MA[31:0] is ignored. Access is automatically aligned to a half-word address. When MSIZE = 10 (32 bits), bits 1 and 0 of MA[31:0] are ignored. Access is automatically aligned to a word address. In memory-to-memory mode, this register identifies the memory source address if DIR = 1 and the memory destination address if DIR = 0. In peripheral-to-peripheral mode, this register identifies the peripheral source address DIR = 1 and the peripheral destination address if DIR = 0. Note: this register is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is not read-only when the channel is enabled (EN = 1). */
    using BDMA_CM1AR5_MA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief BDMA channel 6 configuration register */
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR6_EN_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR6_EN_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR6_TCIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR6_TCIE_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR6_HTIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR6_HTIE_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR6_TEIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR6_TEIE_B_0x1 = 1;
     ...
     */
        /** @brief read from peripheral */
    constexpr std::uint32_t BDMA_CCR6_DIR_B_0x0 = 0;
        /** @brief read from memory */
    constexpr std::uint32_t BDMA_CCR6_DIR_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR6_CIRC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR6_CIRC_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR6_PINC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR6_PINC_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR6_MINC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR6_MINC_B_0x1 = 1;
     ...
     */
        /** @brief 8 bits */
    constexpr std::uint32_t BDMA_CCR6_PSIZE_B_0x0 = 0;
        /** @brief 16 bits */
    constexpr std::uint32_t BDMA_CCR6_PSIZE_B_0x1 = 1;
        /** @brief 32 bits */
    constexpr std::uint32_t BDMA_CCR6_PSIZE_B_0x2 = 2;
     ...
     */
        /** @brief 8 bits */
    constexpr std::uint32_t BDMA_CCR6_MSIZE_B_0x0 = 0;
        /** @brief 16 bits */
    constexpr std::uint32_t BDMA_CCR6_MSIZE_B_0x1 = 1;
        /** @brief 32 bits */
    constexpr std::uint32_t BDMA_CCR6_MSIZE_B_0x2 = 2;
     ...
     */
        /** @brief low */
    constexpr std::uint32_t BDMA_CCR6_PL_B_0x0 = 0;
        /** @brief medium */
    constexpr std::uint32_t BDMA_CCR6_PL_B_0x1 = 1;
        /** @brief high */
    constexpr std::uint32_t BDMA_CCR6_PL_B_0x2 = 2;
        /** @brief very high */
    constexpr std::uint32_t BDMA_CCR6_PL_B_0x3 = 3;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR6_MEM2MEM_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR6_MEM2MEM_B_0x1 = 1;
     ...
     */
        /** @brief disabled (no memory address switch at the end of the BDMA transfer) */
    constexpr std::uint32_t BDMA_CCR6_DBM_B_0x0 = 0;
        /** @brief enabled (memory address switched at the end of the BDMA transfer) */
    constexpr std::uint32_t BDMA_CCR6_DBM_B_0x1 = 1;
     ...
     */
        /** @brief memory 0 (addressed by the BDMA_CM0AR pointer) */
    constexpr std::uint32_t BDMA_CCR6_CT_B_0x0 = 0;
        /** @brief memory 1 (addressed by the BDMA_CM1AR pointer) */
    constexpr std::uint32_t BDMA_CCR6_CT_B_0x1 = 1;

    /** @brief BDMA_CNDTR6 register */
    ...
    /** @brief BDMA_CM1AR6 register */
    using BDMA_CM1AR6 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x90, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief peripheral address It contains the base address of the memory from/to which the data is read/written. When MSIZE[1:0] = 01 (16 bits), bit 0 of MA[31:0] is ignored. Access is automatically aligned to a half-word address. When MSIZE = 10 (32 bits), bits 1 and 0 of MA[31:0] are ignored. Access is automatically aligned to a word address. In memory-to-memory mode, this register identifies the memory source address if DIR = 1 and the memory destination address if DIR = 0. In peripheral-to-peripheral mode, this register identifies the peripheral source address DIR = 1 and the peripheral destination address if DIR = 0. Note: this register is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is not read-only when the channel is enabled (EN = 1). */
    using BDMA_CM1AR6_MA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief BDMA channel 7 configuration register */
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR7_EN_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR7_EN_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR7_TCIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR7_TCIE_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR7_HTIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR7_HTIE_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR7_TEIE_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR7_TEIE_B_0x1 = 1;
     ...
     */
        /** @brief read from peripheral */
    constexpr std::uint32_t BDMA_CCR7_DIR_B_0x0 = 0;
        /** @brief read from memory */
    constexpr std::uint32_t BDMA_CCR7_DIR_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR7_CIRC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR7_CIRC_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR7_PINC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR7_PINC_B_0x1 = 1;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR7_MINC_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR7_MINC_B_0x1 = 1;
     ...
     */
        /** @brief 8 bits */
    constexpr std::uint32_t BDMA_CCR7_PSIZE_B_0x0 = 0;
        /** @brief 16 bits */
    constexpr std::uint32_t BDMA_CCR7_PSIZE_B_0x1 = 1;
        /** @brief 32 bits */
    constexpr std::uint32_t BDMA_CCR7_PSIZE_B_0x2 = 2;
     ...
     */
        /** @brief 8 bits */
    constexpr std::uint32_t BDMA_CCR7_MSIZE_B_0x0 = 0;
        /** @brief 16 bits */
    constexpr std::uint32_t BDMA_CCR7_MSIZE_B_0x1 = 1;
        /** @brief 32 bits */
    constexpr std::uint32_t BDMA_CCR7_MSIZE_B_0x2 = 2;
     ...
     */
        /** @brief low */
    constexpr std::uint32_t BDMA_CCR7_PL_B_0x0 = 0;
        /** @brief medium */
    constexpr std::uint32_t BDMA_CCR7_PL_B_0x1 = 1;
        /** @brief high */
    constexpr std::uint32_t BDMA_CCR7_PL_B_0x2 = 2;
        /** @brief very high */
    constexpr std::uint32_t BDMA_CCR7_PL_B_0x3 = 3;
     ...
     */
        /** @brief disabled */
    constexpr std::uint32_t BDMA_CCR7_MEM2MEM_B_0x0 = 0;
        /** @brief enabled */
    constexpr std::uint32_t BDMA_CCR7_MEM2MEM_B_0x1 = 1;
     ...
     */
        /** @brief disabled (no memory address switch at the end of the BDMA transfer) */
    constexpr std::uint32_t BDMA_CCR7_DBM_B_0x0 = 0;
        /** @brief enabled (memory address switched at the end of the BDMA transfer) */
    constexpr std::uint32_t BDMA_CCR7_DBM_B_0x1 = 1;
     ...
     */
        /** @brief memory 0 (addressed by the BDMA_CM0AR pointer) */
    constexpr std::uint32_t BDMA_CCR7_CT_B_0x0 = 0;
        /** @brief memory 1 (addressed by the BDMA_CM1AR pointer) */
    constexpr std::uint32_t BDMA_CCR7_CT_B_0x1 = 1;

    /** @brief BDMA_CNDTR7 register */
    ...
    /** @brief BDMA_CM1AR7 register */
    using BDMA_CM1AR7 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0xA4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief peripheral address It contains the base address of the memory from/to which the data is read/written. When MSIZE[1:0] = 01 (16 bits), bit 0 of MA[31:0] is ignored. Access is automatically aligned to a half-word address. When MSIZE = 10 (32 bits), bits 1 and 0 of MA[31:0] are ignored. Access is automatically aligned to a word address. In memory-to-memory mode, this register identifies the memory source address if DIR = 1 and the memory destination address if DIR = 0. In peripheral-to-peripheral mode, this register identifies the peripheral source address DIR = 1 and the peripheral destination address if DIR = 0. Note: this register is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is not read-only when the channel is enabled (EN = 1). */
    using BDMA_CM1AR7_MA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
