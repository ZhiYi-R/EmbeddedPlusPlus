...
#ifndef EMBEDDED_PP_STM32H743_DBGMCU_HPP
#define EMBEDDED_PP_STM32H743_DBGMCU_HPP
...
namespace STM32H743::DBGMCU {
    ...
    using CR_DBGSLEEP_D1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Allow D1 domain debug in Stop mode */
    using CR_DBGSTOP_D1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Allow D1 domain debug in Standby mode */
    using CR_DBGSTBY_D1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Allow D2 domain debug in Sleep mode */
    using CR_DBGSLEEP_D2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Allow D2 domain debug in Stop mode */
    using CR_DBGSTOP_D2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Allow D2 domain debug in Standby mode */
    using CR_DBGSTBY_D2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Allow debug in D3 Stop mode */
    using CR_DBGSTOP_D3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Allow debug in D3 Standby mode */
    using CR_DBGSTBY_D3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using APB4FZ1_DBG_IWDG1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
