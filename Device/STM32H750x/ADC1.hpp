...
#ifndef EMBEDDED_PP_STM32H750X_ADC1_HPP
#define EMBEDDED_PP_STM32H750X_ADC1_HPP
...
namespace STM32H750x::ADC1 {
    ...
    using CFGR_RES = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
