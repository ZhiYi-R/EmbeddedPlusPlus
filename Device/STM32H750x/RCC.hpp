...
#ifndef EMBEDDED_PP_STM32H750X_RCC_HPP
#define EMBEDDED_PP_STM32H750X_RCC_HPP
...
namespace STM32H750x::RCC {
    ...
    using ICSCR_HSICAL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief HSI clock trimming */
    using ICSCR_HSITRIM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 6, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CSI clock calibration */
    using ICSCR_CSICAL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CSI clock trimming */
    using ICSCR_CSITRIM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CRRCR_RC48CAL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 10, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief High Resolution Timer clock prescaler selection */
    using CFGR_HRTIMSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CFGR_MCO1SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CFGR_MCO2SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Multiplication factor for PLL1 VCO */
    using PLL2DIVR_DIVN1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 9, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief PLL1 DIVP division factor */
    using PLL2DIVR_DIVP1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief PLL1 DIVQ division factor */
    using PLL2DIVR_DIVQ1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief PLL1 DIVR division factor */
    using PLL2DIVR_DIVR1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using D1CCIPR_FMCSRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief QUADSPI kernel clock source selection */
    using D1CCIPR_QSPISRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SDMMC kernel clock source selection */
    using D1CCIPR_SDMMCSRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief per_ck clock source selection */
    using D1CCIPR_CKPERSRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using D2CCIP1R_SAI1SRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SAI2 and SAI3 kernel clock source selection */
    using D2CCIP1R_SAI23SRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SPI/I2S1,2 and 3 kernel clock source selection */
    using D2CCIP1R_SPI123SRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SPI4 and 5 kernel clock source selection */
    using D2CCIP1R_SPI45SRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SPDIFRX kernel clock source selection */
    using D2CCIP1R_SPDIFSRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DFSDM1 kernel Clk clock source selection */
    using D2CCIP1R_DFSDM1SRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FDCAN kernel clock source selection */
    using D2CCIP1R_FDCANSRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SWPMI kernel clock source selection */
    using D2CCIP1R_SWPSRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RCC Domain 2 Kernel Clock Configuration Register */
    ...
    using D2CCIP2R_USART234578SRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USART1 and 6 kernel clock source selection */
    using D2CCIP2R_USART16SRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RNG kernel clock source selection */
    using D2CCIP2R_RNGSRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief I2C1,2,3 kernel clock source selection */
    using D2CCIP2R_I2C123SRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USBOTG 1 and 2 kernel clock source selection */
    using D2CCIP2R_USBSRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief HDMI-CEC kernel clock source selection */
    using D2CCIP2R_CECSRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief LPTIM1 kernel clock source selection */
    using D2CCIP2R_LPTIM1SRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using D3CCIPR_LPUART1SRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief I2C4 kernel clock source selection */
    using D3CCIPR_I2C4SRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief LPTIM2 kernel clock source selection */
    using D3CCIPR_LPTIM2SRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief LPTIM3,4,5 kernel clock source selection */
    using D3CCIPR_LPTIM345SRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SAR ADC kernel clock source selection */
    using D3CCIPR_ADCSRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Sub-Block A of SAI4 kernel clock source selection */
    using D3CCIPR_SAI4ASRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Sub-Block B of SAI4 kernel clock source selection */
    using D3CCIPR_SAI4BSRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SPI6 kernel clock source selection */
    using D3CCIPR_SPI6SRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using BDCR_RTCSRC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using BDCR_VSWRST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief JPGDEC block reset */
    using AHB3RSTR_JPGDECRST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using AHB3RSTR_QSPIRST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief USB2OTG block reset */
    using AHB1RSTR_USB2OTGRST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief CAMITF block reset */
    using AHB2RSTR_CAMITFRST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief GPIO block reset */
    using AHB4RSTR_GPIOIRST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief GPIO block reset */
    ...
    using APB1LRSTR_HDMICECRST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using APB1HRSTR_SWPRST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using APB2RSTR_SAI2RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SAI3 block reset */
    using APB2RSTR_SAI3RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DFSDM1 block reset */
    using APB2RSTR_DFSDM1RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief HRTIM block reset */
    using APB2RSTR_HRTIMRST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief JPGDEC Peripheral Clock Enable */
    using C1_AHB3ENR_JPGDECEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief QUADSPI and QUADSPI Delay Clock Enable */
    using C1_AHB3ENR_QSPIEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief JPGDEC Peripheral Clock Enable */
    using AHB3ENR_JPGDECEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FMC Peripheral Clocks Enable */
    using AHB3ENR_FMCEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief QUADSPI and QUADSPI Delay Clock Enable */
    using AHB3ENR_QSPIEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SDMMC1 and SDMMC1 Delay Clock Enable */
    ...
    using AHB1ENR_USB1OTGEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USB_PHY1 Clocks Enable */
    using AHB1ENR_USB1ULPIEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USB2OTG Peripheral Clocks Enable */
    using AHB1ENR_USB2OTGEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USB_PHY2 Clocks Enable */
    using AHB1ENR_USB2ULPIEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RCC AHB1 Clock Register */
    ...
    /** @brief USB1OTG Peripheral Clocks Enable */
    using C1_AHB1ENR_USB1OTGEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USB_PHY1 Clocks Enable */
    using C1_AHB1ENR_USB1ULPIEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USB2OTG Peripheral Clocks Enable */
    using C1_AHB1ENR_USB2OTGEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USB_PHY2 Clocks Enable */
    using C1_AHB1ENR_USB2ULPIEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using C1_AHB2ENR_CAMITFEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief SRAM3 block enable */
    using C1_AHB2ENR_SRAM3EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RCC AHB2 Clock Register */
    using AHB2ENR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0xDC, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CAMITF peripheral clock enable */
    using AHB2ENR_CAMITFEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CRYPT peripheral clock enable */
    ...
    /** @brief 0GPIO peripheral clock enable */
    using AHB4ENR_GPIOIEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief 0GPIO peripheral clock enable */
    ...
    /** @brief 0GPIO peripheral clock enable */
    using C1_AHB4ENR_GPIOIEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief 0GPIO peripheral clock enable */
    ...
    using APB1LENR_HDMICECEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DAC1&2 peripheral clock enable */
    using APB1LENR_DAC12EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USART7 Peripheral Clocks Enable */
    using APB1LENR_USART7EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USART8 Peripheral Clocks Enable */
    using APB1LENR_USART8EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RCC APB1 Clock Register */
    ...
    /** @brief HDMI-CEC peripheral clock enable */
    using C1_APB1LENR_HDMICECEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DAC1&2 peripheral clock enable */
    using C1_APB1LENR_DAC12EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USART7 Peripheral Clocks Enable */
    using C1_APB1LENR_USART7EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USART8 Peripheral Clocks Enable */
    using C1_APB1LENR_USART8EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RCC APB1 Clock Register */
    ...
    using APB1HENR_SWPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief SWPMI Peripheral Clocks Enable */
    using C1_APB1HENR_SWPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OPAMP peripheral clock enable */
    ...
    using C1_APB2ENR_SAI2EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SAI3 Peripheral Clocks Enable */
    using C1_APB2ENR_SAI3EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DFSDM1 Peripheral Clocks Enable */
    using C1_APB2ENR_DFSDM1EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief HRTIM peripheral clock enable */
    using C1_APB2ENR_HRTIMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RCC APB2 Clock Register */
    ...
    /** @brief SAI2 Peripheral Clocks Enable */
    using APB2ENR_SAI2EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SAI3 Peripheral Clocks Enable */
    using APB2ENR_SAI3EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DFSDM1 Peripheral Clocks Enable */
    using APB2ENR_DFSDM1EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief HRTIM peripheral clock enable */
    using APB2ENR_HRTIMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief JPGDEC Clock Enable During CSleep Mode */
    using C1_AHB3LPENR_JPGDECLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FLITF Clock Enable During CSleep Mode */
    using C1_AHB3LPENR_FLITFLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using C1_AHB3LPENR_QSPILPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using C1_AHB3LPENR_D1DTCM1LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief JPGDEC Clock Enable During CSleep Mode */
    using AHB3LPENR_JPGDECLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FLITF Clock Enable During CSleep Mode */
    using AHB3LPENR_FLITFLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FMC Peripheral Clocks Enable During CSleep Mode */
    using AHB3LPENR_FMCLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief QUADSPI and QUADSPI Delay Clock Enable During CSleep Mode */
    using AHB3LPENR_QSPILPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SDMMC1 and SDMMC1 Delay Clock Enable During CSleep Mode */
    using AHB3LPENR_SDMMC1LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief D1DTCM1 Block Clock Enable During CSleep mode */
    using AHB3LPENR_D1DTCM1LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief D1 DTCM2 Block Clock Enable During CSleep mode */
    ...
    using AHB1LPENR_USB1OTGLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USB_PHY1 clock enable during CSleep mode */
    using AHB1LPENR_USB1ULPILPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USB2OTG peripheral clock enable during CSleep mode */
    using AHB1LPENR_USB2OTGLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USB_PHY2 clocks enable during CSleep mode */
    using AHB1LPENR_USB2ULPILPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RCC AHB1 Sleep Clock Register */
    ...
    /** @brief USB1OTG peripheral clock enable during CSleep mode */
    using C1_AHB1LPENR_USB1OTGLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USB_PHY1 clock enable during CSleep mode */
    using C1_AHB1LPENR_USB1ULPILPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USB2OTG peripheral clock enable during CSleep mode */
    using C1_AHB1LPENR_USB2OTGLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USB_PHY2 clocks enable during CSleep mode */
    using C1_AHB1LPENR_USB2ULPILPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief CAMITF peripheral clock enable during CSleep mode */
    using C1_AHB2LPENR_CAMITFLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief SRAM3 Clock Enable During CSleep Mode */
    using C1_AHB2LPENR_SRAM3LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RCC AHB2 Sleep Clock Register */
    using AHB2LPENR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x104, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CAMITF peripheral clock enable during CSleep mode */
    using AHB2LPENR_CAMITFLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CRYPT peripheral clock enable during CSleep mode */
    ...
    /** @brief SRAM3 Clock Enable During CSleep Mode */
    using AHB2LPENR_SRAM3LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief GPIO peripheral clock enable during CSleep mode */
    using AHB4LPENR_GPIOILPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief GPIO peripheral clock enable during CSleep mode */
    ...
    /** @brief GPIO peripheral clock enable during CSleep mode */
    using C1_AHB4LPENR_GPIOILPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief GPIO peripheral clock enable during CSleep mode */
    ...
    /** @brief HDMI-CEC Peripheral Clocks Enable During CSleep Mode */
    using APB1LLPENR_HDMICECLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief HDMI-CEC Peripheral Clocks Enable During CSleep Mode */
    using C1_APB1LLPENR_HDMICECLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DAC1/2 peripheral clock enable during CSleep mode */
    ...
    using C1_APB1HLPENR_SWPLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief SWPMI Peripheral Clocks Enable During CSleep Mode */
    using APB1HLPENR_SWPLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OPAMP peripheral clock enable during CSleep mode */
    ...
    /** @brief SAI2 Peripheral Clocks Enable During CSleep Mode */
    using APB2LPENR_SAI2LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SAI3 Peripheral Clocks Enable During CSleep Mode */
    using APB2LPENR_SAI3LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DFSDM1 Peripheral Clocks Enable During CSleep Mode */
    using APB2LPENR_DFSDM1LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief HRTIM peripheral clock enable during CSleep mode */
    using APB2LPENR_HRTIMLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RCC APB2 Sleep Clock Register */
    ...
    /** @brief SAI2 Peripheral Clocks Enable During CSleep Mode */
    using C1_APB2LPENR_SAI2LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SAI3 Peripheral Clocks Enable During CSleep Mode */
    using C1_APB2LPENR_SAI3LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DFSDM1 Peripheral Clocks Enable During CSleep Mode */
    using C1_APB2LPENR_DFSDM1LPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief HRTIM peripheral clock enable during CSleep mode */
    using C1_APB2LPENR_HRTIMLPEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
