...
#ifndef EMBEDDED_PP_STM32H753_FLASH_HPP
#define EMBEDDED_PP_STM32H753_FLASH_HPP
...
namespace STM32H753::Flash {
    ...
    using KEYR1_KEY1R = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CR1_SNECCERR1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CR1_CRCRDERRIE1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using SR1_SNECCERR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using SR1_CRCRDERR1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CCR1_CLR_CRCRDERR1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CRCSADD1R_CRC_START_ADDR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 18, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CRCEADD1R_CRC_END_ADDR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 18, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Read latency */
    using ACR__LATENCY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Flash signal delay */
    ...
    /** @brief Bank 2 special sector selection bit */
    using CR2_SPSS2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Bank 2 CRC read error interrupt enable bit */
    using CR2_CRCRDERRIE2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief IWDG1 control option status bit */
    using OPTSR_CUR__IWDG1_SW = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief D1 DStop entry reset option status bit */
    ...
    /** @brief IWDG Stop mode freeze option status bit */
    using OPTSR_CUR__IWDG_FZ_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief IWDG Standby mode freeze option status bit */
    using OPTSR_CUR__IWDG_FZ_SDBY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DTCM RAM size option status */
    ...
    /** @brief IWDG1 option configuration bit */
    using OPTSR_PRG__IWDG1_SW = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Option byte erase after D1 DStop option configuration bit */
    using OPTSR_PRG__nRST_STOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Option byte erase after D1 DStandby option configuration bit */
    using OPTSR_PRG__nRST_STDY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Readout protection level option configuration byte */
    ...
    using PRAR_PRG2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x12C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief FLASH register with boot address */
    using BOOT_CURR_ = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x140, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Boot address 0 */
    using BOOT_CURR__BOOT_ADD0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Boot address 1 */
    using BOOT_CURR__BOOT_ADD1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FLASH register with boot address */
    using BOOT_PRGR_ = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x144, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Boot address 0 */
    using BOOT_PRGR__BOOT_ADD0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Boot address 1 */
    using BOOT_PRGR__BOOT_ADD1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FLASH CRC control register for bank 1 */
    ...
    using CRCSADD2R_CRC_START_ADDR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 18, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CRCEADD2R_CRC_END_ADDR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 18, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FLASH CRC data register */
    using CRCDATAR_ = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x15C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CRC result */
    using CRCDATAR__CRC_DATA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
