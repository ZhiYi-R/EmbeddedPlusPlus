...
#ifndef EMBEDDED_PP_STM32H755_CM4_OTG1_HS_DEVICE_HPP
#define EMBEDDED_PP_STM32H755_CM4_OTG1_HS_DEVICE_HPP
...
namespace STM32H755_CM4::OTG1_HS_DEVICE {
    ...
    /** @brief OTG_HS device endpoint transfer size register */
    using OTG_HS_DIEPTSIZ6 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1A0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Transfer size */
    ...
    /** @brief OTG_HS device IN endpoint transmit FIFO status register */
    using OTG_HS_DTXFSTS6 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1A4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief IN endpoint TxFIFO space avail */
    ...
    /** @brief OTG_HS device endpoint transfer size register */
    using OTG_HS_DIEPTSIZ7 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1A8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Transfer size */
    ...
    /** @brief OTG_HS device IN endpoint transmit FIFO status register */
    using OTG_HS_DTXFSTS7 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1AC, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief IN endpoint TxFIFO space avail */
