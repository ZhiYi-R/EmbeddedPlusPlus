...
#ifndef EMBEDDED_PP_STM32H755_CM7_RCC_HPP
#define EMBEDDED_PP_STM32H755_CM7_RCC_HPP
...
namespace STM32H755_CM7::RCC {
    ...
    using D1CCIPR_QSPISEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DSI kernel clock source selection */
    using D1CCIPR_DSISEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using D2CCIP1R_SAI23SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using D2CCIP1R_SPDIFSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using D2CCIP1R_SWPSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RCC Domain 2 Kernel Clock Configuration Register */
    ...
    using D2CCIP2R_USART16SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief D1 DTCM1 block enable */
    using C1_AHB3ENR_DTCM1EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief D1 DTCM2 block enable */
    using C1_AHB3ENR_DTCM2EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief D1 DTCM2 block enable */
    using C1_AHB3ENR_ITCM1EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief AXISRAM block enable */
    using C1_AHB3ENR_AXISRAMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RCC AHB3 Clock Register */
    ...
    /** @brief D1 FLASH Interface Enable */
    using AHB3ENR_FLITFEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FMC Peripheral Clocks Enable */
    ...
    /** @brief D1 DTCM1 block enable */
    using AHB3ENR_DTCM1EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief D1 DTCM2 block enable */
    using AHB3ENR_DTCM2EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief D1 DTCM2 block enable */
    using AHB3ENR_ITCM1EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief AXISRAM block enable */
    using AHB3ENR_AXISRAMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief ART Clock enable */
    using AHB1ENR_ARTEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Enable of USB1OTG (OTG_HS1) peripheral clocks */
    ...
    using AHB1ENR_USB2OTGHSEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USB_PHY2 Clocks Enable */
    using AHB1ENR_USB2OTGHSULPIEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RCC AHB1 Clock Register */
    ...
    /** @brief ART Clock enable */
    using C1_AHB1ENR_ARTEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Ethernet MAC bus interface Clock Enable */
    ...
    /** @brief USB2OTG Peripheral Clocks Enable */
    using C1_AHB1ENR_USB2OTGHSEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USB_PHY2 Clocks Enable */
    using C1_AHB1ENR_USB2OTGHSULPIEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief DCMI peripheral clock enable */
    using C1_AHB2ENR_DCMIEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
