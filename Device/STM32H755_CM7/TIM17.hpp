...
#ifndef EMBEDDED_PP_STM32H755_CM7_TIM17_HPP
#define EMBEDDED_PP_STM32H755_CM7_TIM17_HPP
...
namespace STM32H755_CM7::TIM17 {
    ...
    /** @brief BRK dfsdm1_break[1] enable */
    using TIM17_AF1_BKDFBK1E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
