...
#ifndef EMBEDDED_PP_STM32H757_CM7_USART2_HPP
#define EMBEDDED_PP_STM32H757_CM7_USART2_HPP
...
namespace STM32H757_CM7::USART2 {
    ...
    /** @brief When the DSI_NSS bit is set, the NSS pin input is ignored */
    ...
    /** @brief DIV_Mantissa */
    using BRR_BRR_4_15 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DIV_Fraction */
    using BRR_BRR_0_3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using ICR_TCBGTC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
