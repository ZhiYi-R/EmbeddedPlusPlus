...
#ifndef EMBEDDED_PP_STM32H7A3X_SYSCFG_HPP
#define EMBEDDED_PP_STM32H7A3X_SYSCFG_HPP
...
namespace STM32H7A3x::SYSCFG {
    ...
    /** @brief CortexÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â®-M7 LOCKUP (HardFault) output enable bit */
