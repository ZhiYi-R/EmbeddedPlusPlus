...
#ifndef EMBEDDED_PP_STM32H7A3X_TIM8_HPP
#define EMBEDDED_PP_STM32H7A3X_TIM8_HPP
...
namespace STM32H7A3x::TIM8 {
    ...
    /** @brief Trigger selection - bit 4:3 */
    ...
    using CCMR2_Output_OC4M_4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Output Compare 5 mode */
    using CCMR3_Output_OC5M3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output Compare 6 mode */
    using CCMR3_Output_OC6M3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CRR6 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x5C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 6 value */
    using CRR6_CCR6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief BRK dfsdm1_break[0] enable */
    using AF1_BKDF1BK0E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief BRK2 dfsdm1_break[1] enable */
    using AF2_BK2DF1BK1E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief BRK2 COMP1 input polarit */
