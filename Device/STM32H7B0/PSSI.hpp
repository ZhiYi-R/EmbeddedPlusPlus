...
#ifndef EMBEDDED_PP_STM32H7B0_PSSI_HPP
#define EMBEDDED_PP_STM32H7B0_PSSI_HPP
...
namespace STM32H7B0::PSSI {

    /** @brief PSSI_CR register */
     ...
     *          - B_0x4: Both PSSI_RDY and PSSI_DE features enabled - bidirectional on PSSI_RDY pin (see ) (value: 4)
     ...
     *          - B_0x7: Both PSSI_RDY and PSSI_DE features enabled - bidirectional on PSSI_DE pin (see ) (value: 7)
     */
    ...
    constexpr std::uint32_t PSSI_CR_DERDYCFG_B_0x3 = 3;
        /** @brief Both PSSI_RDY and PSSI_DE features enabled - bidirectional on PSSI_RDY pin (see ) */
    ...
    constexpr std::uint32_t PSSI_CR_DERDYCFG_B_0x6 = 6;
        /** @brief Both PSSI_RDY and PSSI_DE features enabled - bidirectional on PSSI_DE pin (see ) */
