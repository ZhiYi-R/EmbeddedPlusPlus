...
#ifndef EMBEDDED_PP_STM32H7B0_SYSCFG_HPP
#define EMBEDDED_PP_STM32H7B0_SYSCFG_HPP
...
namespace STM32H7B0::SYSCFG {
    ...
    /** @brief Cortex-M7 LOCKUP (HardFault) output enable bit */
