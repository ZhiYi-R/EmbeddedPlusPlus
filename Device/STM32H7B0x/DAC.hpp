...
#ifndef EMBEDDED_PP_STM32H7B0X_DAC_HPP
#define EMBEDDED_PP_STM32H7B0X_DAC_HPP
...
namespace STM32H7B0x::DAC {
    ...
    using DAC_CR_TSEL1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using DAC_CR_TSEL2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
