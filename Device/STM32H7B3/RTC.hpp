...
#ifndef EMBEDDED_PP_STM32H7B3_RTC_HPP
#define EMBEDDED_PP_STM32H7B3_RTC_HPP
...
namespace STM32H7B3::RTC {
    ...
    /** @brief Clear alarm A flag Writing 1 in this bit clears the ALRBF bit in the RTC_SR register. */
    ...
    using RTC_CFGR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x60, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RTC_OUT2 mapping */
    using RTC_CFGR_OUT2_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: RTC_OUT2 is mapped on PB2 (value: 0)
     *          - B_0x1: RTC_OUT2 is mapped on PI8 (value: 1)
     */
        /** @brief RTC_OUT2 is mapped on PB2 */
    constexpr std::uint32_t RTC_CFGR_OUT2_RMP_B_0x0 = 0;
        /** @brief RTC_OUT2 is mapped on PI8 */
    constexpr std::uint32_t RTC_CFGR_OUT2_RMP_B_0x1 = 1;
