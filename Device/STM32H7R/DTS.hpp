...
#ifndef EMBEDDED_PP_STM32H7R_DTS_HPP
#define EMBEDDED_PP_STM32H7R_DTS_HPP
...
namespace STM32H7R::DTS {
    ...
    /** @brief Input trigger selection bit for temperature sensor 1 These bits are set and cleared by software. They select which input triggers a temperature measurement. Refer to Section 30.3.10: Trigger input. */
