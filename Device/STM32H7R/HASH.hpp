...
#ifndef EMBEDDED_PP_STM32H7R_HASH_HPP
#define EMBEDDED_PP_STM32H7R_HASH_HPP
...
namespace STM32H7R::HASH {
    ...
    /** @brief Hash data x Refer to Section 34.7.4: HASH digest registers introduction. */
    ...
    /** @brief Context swap x Refer to Section 34.7.7: HASH context swap registers introduction. */
