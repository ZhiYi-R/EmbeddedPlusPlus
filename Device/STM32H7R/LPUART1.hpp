...
#ifndef EMBEDDED_PP_STM32H7R_LPUART1_HPP
#define EMBEDDED_PP_STM32H7R_LPUART1_HPP
...
namespace STM32H7R::LPUART1 {
    ...
    constexpr std::uint32_t LPUART_CR2_STOP_B_0x3 = 3;
    ...
    /** @brief Wakeup from low-power mode clear flag Writing 1 to this bit clears the WUF flag in the USART_ISR register. Note: If the USART does not support the wakeup from Stop feature, this bit is reserved and must be kept at reset value. Refer to Section 79.3: LPUART implementation on page 4637. */
    ...
    /** @brief Receive data value Contains the received data character. The RDR register provides the parallel interface between the input shift register and the internal bus (see Figure 938). When receiving with the parity enabled, the value read in the MSB bit is the received parity bit. */
