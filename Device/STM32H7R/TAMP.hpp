...
#ifndef EMBEDDED_PP_STM32H7R_TAMP_HPP
#define EMBEDDED_PP_STM32H7R_TAMP_HPP
...
namespace STM32H7R::TAMP {
    ...
    /** @brief Tamper detection on TAMP_IN6 enable<sup>(1)</sup> */
    ...
    /** @brief Tamper detection on TAMP_IN7 enable<sup>(1)</sup> */
    ...
    /** @brief Tamper detection on TAMP_IN8 enable<sup>(1)</sup> */
    ...
    /** @brief Internal tamper 15 enable */
    using TAMP_CR1_ITAMP15E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Internal tamper 15 disabled. (value: 0)
     *          - B_0x1: Internal tamper 15 enabled. (value: 1)
     */
        /** @brief Internal tamper 15 disabled. */
    constexpr std::uint32_t TAMP_CR1_ITAMP15E_B_0x0 = 0;
        /** @brief Internal tamper 15 enabled. */
    constexpr std::uint32_t TAMP_CR1_ITAMP15E_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: Tamper 2 event erases the backup registers and all device secrets<sup>(1)</sup>. (value: 0)
     *          - B_0x1: Tamper 2 event does not erase the backup registers and device secrets<sup>(2)</sup>. (value: 1)
     */
        /** @brief Tamper 2 event erases the backup registers and all device secrets<sup>(1)</sup>. */
    constexpr std::uint32_t TAMP_CR2_TAMP2NOER_B_0x0 = 0;
        /** @brief Tamper 2 event does not erase the backup registers and device secrets<sup>(2)</sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Tamper 3 event erases the backup registers and all device secrets<sup>(1)</sup>. (value: 0)
     *          - B_0x1: Tamper 3 event does not erase the backup registers and device secrets<sup>(2)</sup>. (value: 1)
     */
        /** @brief Tamper 3 event erases the backup registers and all device secrets<sup>(1)</sup>. */
    constexpr std::uint32_t TAMP_CR2_TAMP3NOER_B_0x0 = 0;
        /** @brief Tamper 3 event does not erase the backup registers and device secrets<sup>(2)</sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Tamper 4 event erases the backup registers and all device secrets<sup>(1)</sup>. (value: 0)
     *          - B_0x1: Tamper 4 event does not erase the backup registers and device secrets<sup>(2)</sup>. (value: 1)
     */
        /** @brief Tamper 4 event erases the backup registers and all device secrets<sup>(1)</sup>. */
    constexpr std::uint32_t TAMP_CR2_TAMP4NOER_B_0x0 = 0;
        /** @brief Tamper 4 event does not erase the backup registers and device secrets<sup>(2)</sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Tamper 5 event erases the backup registers and all device secrets<sup>(1)</sup>. (value: 0)
     *          - B_0x1: Tamper 5 event does not erase the backup registers and device secrets<sup>(2)</sup>. (value: 1)
     */
        /** @brief Tamper 5 event erases the backup registers and all device secrets<sup>(1)</sup>. */
    constexpr std::uint32_t TAMP_CR2_TAMP5NOER_B_0x0 = 0;
        /** @brief Tamper 5 event does not erase the backup registers and device secrets<sup>(2)</sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Tamper 6 event erases the backup registers and all device secrets<sup>(1)</sup>. (value: 0)
     *          - B_0x1: Tamper 6 event does not erase the backup registers and device secrets<sup>(2)</sup>. (value: 1)
     */
        /** @brief Tamper 6 event erases the backup registers and all device secrets<sup>(1)</sup>. */
    constexpr std::uint32_t TAMP_CR2_TAMP6NOER_B_0x0 = 0;
        /** @brief Tamper 6 event does not erase the backup registers and device secrets<sup>(2)</sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Tamper 7 event erases the backup registers and all device secrets<sup>(1)</sup>. (value: 0)
     *          - B_0x1: Tamper 7 event does not erase the backup registers and device secrets<sup>(2)</sup>. (value: 1)
     */
        /** @brief Tamper 7 event erases the backup registers and all device secrets<sup>(1)</sup>. */
    constexpr std::uint32_t TAMP_CR2_TAMP7NOER_B_0x0 = 0;
        /** @brief Tamper 7 event does not erase the backup registers and device secrets<sup>(2)</sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Tamper 8 event erases the backup registers and all device secrets<sup>(1)</sup>. (value: 0)
     *          - B_0x1: Tamper 8 event does not erase the backup registers and device secrets<sup>(2)</sup>. (value: 1)
     */
        /** @brief Tamper 8 event erases the backup registers and all device secrets<sup>(1)</sup>. */
    constexpr std::uint32_t TAMP_CR2_TAMP8NOER_B_0x0 = 0;
        /** @brief Tamper 8 event does not erase the backup registers and device secrets<sup>(2)</sup>. */
     ...
     *          - B_0x1: If TAMPFLT different from 00 Tamper 1 input staying high triggers a tamper detection event. (value: 1)
     */
    ...
    constexpr std::uint32_t TAMP_CR2_TAMP1TRG_B_0x0 = 0;
        /** @brief If TAMPFLT different from 00 Tamper 1 input staying high triggers a tamper detection event. */
     ...
     *          - B_0x1: If TAMPFLT different from 00 Tamper 2 input staying high triggers a tamper detection event. (value: 1)
     */
    ...
    constexpr std::uint32_t TAMP_CR2_TAMP2TRG_B_0x0 = 0;
        /** @brief If TAMPFLT different from 00 Tamper 2 input staying high triggers a tamper detection event. */
     ...
     *          - B_0x1: If TAMPFLT different from 00 Tamper 3 input staying high triggers a tamper detection event. (value: 1)
     */
    ...
    constexpr std::uint32_t TAMP_CR2_TAMP3TRG_B_0x0 = 0;
        /** @brief If TAMPFLT different from 00 Tamper 3 input staying high triggers a tamper detection event. */
     ...
     *          - B_0x1: If TAMPFLT different from 00 Tamper 4 input staying high triggers a tamper detection event. (value: 1)
     */
    ...
    constexpr std::uint32_t TAMP_CR2_TAMP4TRG_B_0x0 = 0;
        /** @brief If TAMPFLT different from 00 Tamper 4 input staying high triggers a tamper detection event. */
     ...
     *          - B_0x1: If TAMPFLT different from 00 Tamper 5 input staying high triggers a tamper detection event. (value: 1)
     */
    ...
    constexpr std::uint32_t TAMP_CR2_TAMP5TRG_B_0x0 = 0;
        /** @brief If TAMPFLT different from 00 Tamper 5 input staying high triggers a tamper detection event. */
    ...
    /** @details Possible values:
     *          - B_0x0: If TAMPFLT different from 00 Tamper 6 input staying low triggers a tamper detection event. (value: 0)
     *          - B_0x1: If TAMPFLT different from 00 Tamper 6 input staying high triggers a tamper detection event. (value: 1)
     */
        /** @brief If TAMPFLT different from 00 Tamper 6 input staying low triggers a tamper detection event. */
    constexpr std::uint32_t TAMP_CR2_TAMP6TRG_B_0x0 = 0;
        /** @brief If TAMPFLT different from 00 Tamper 6 input staying high triggers a tamper detection event. */
    constexpr std::uint32_t TAMP_CR2_TAMP6TRG_B_0x1 = 1;

    /** @brief Active level for tamper 7 input (active mode disabled) If TAMPFLT = 00 Tamper 7 input rising edge triggers a tamper detection event. If TAMPFLT = 00 Tamper 7 input falling edge triggers a tamper detection event. */
    using TAMP_CR2_TAMP7TRG = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: If TAMPFLT different from 00 Tamper 7 input staying low triggers a tamper detection event. (value: 0)
     *          - B_0x1: If TAMPFLT different from 00 Tamper 7 input staying high triggers a tamper detection event. (value: 1)
     */
        /** @brief If TAMPFLT different from 00 Tamper 7 input staying low triggers a tamper detection event. */
    constexpr std::uint32_t TAMP_CR2_TAMP7TRG_B_0x0 = 0;
        /** @brief If TAMPFLT different from 00 Tamper 7 input staying high triggers a tamper detection event. */
    constexpr std::uint32_t TAMP_CR2_TAMP7TRG_B_0x1 = 1;

    /** @brief Active level for tamper 8 input (active mode disabled) If TAMPFLT = 00 Tamper 8 input rising edge triggers a tamper detection event. If TAMPFLT = 00 Tamper 8 input falling edge triggers a tamper detection event. */
    using TAMP_CR2_TAMP8TRG = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: If TAMPFLT different from 00 Tamper 8 input staying low triggers a tamper detection event. (value: 0)
     *          - B_0x1: If TAMPFLT different from 00 Tamper 8 input staying high triggers a tamper detection event. (value: 1)
     */
        /** @brief If TAMPFLT different from 00 Tamper 8 input staying low triggers a tamper detection event. */
    constexpr std::uint32_t TAMP_CR2_TAMP8TRG_B_0x0 = 0;
        /** @brief If TAMPFLT different from 00 Tamper 8 input staying high triggers a tamper detection event. */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal Tamper 1 event erases the backup registers and all device secrets<sup>(1)</sup>. (value: 0)
     *          - B_0x1: Internal Tamper 1 event does not erase the backup registers and device secrets<sup>(2)</sup>. (value: 1)
     */
        /** @brief Internal Tamper 1 event erases the backup registers and all device secrets<sup>(1)</sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP1NOER_B_0x0 = 0;
        /** @brief Internal Tamper 1 event does not erase the backup registers and device secrets<sup>(2)</sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal Tamper 2 event erases the backup registers and all device secrets<sup>(1)</sup>. (value: 0)
     *          - B_0x1: Internal Tamper 2 event does not erase the backup registers and device secrets<sup>(2)</sup>. (value: 1)
     */
        /** @brief Internal Tamper 2 event erases the backup registers and all device secrets<sup>(1)</sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP2NOER_B_0x0 = 0;
        /** @brief Internal Tamper 2 event does not erase the backup registers and device secrets<sup>(2)</sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal Tamper 3 event erases the backup registers and all device secrets<sup>(1)</sup>. (value: 0)
     *          - B_0x1: Internal Tamper 3 event does not erase the backup registers and device secrets<sup>(2)</sup>. (value: 1)
     */
        /** @brief Internal Tamper 3 event erases the backup registers and all device secrets<sup>(1)</sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP3NOER_B_0x0 = 0;
        /** @brief Internal Tamper 3 event does not erase the backup registers and device secrets<sup>(2)</sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP3NOER_B_0x1 = 1;

    /** @brief Internal Tamper 4 no erase */
    using TAMP_CR3_ITAMP4NOER = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Internal Tamper 4 event erases the backup registers and all device secrets<sup>(1)</sup>. (value: 0)
     *          - B_0x1: Internal Tamper 4 event does not erase the backup registers and device secrets<sup>(2)</sup>. (value: 1)
     */
        /** @brief Internal Tamper 4 event erases the backup registers and all device secrets<sup>(1)</sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP4NOER_B_0x0 = 0;
        /** @brief Internal Tamper 4 event does not erase the backup registers and device secrets<sup>(2)</sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP4NOER_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: Internal Tamper 5 event erases the backup registers and all device secrets<sup>(1)</sup>. (value: 0)
     *          - B_0x1: Internal Tamper 5 event does not erase the backup registers and device secrets<sup>(2)</sup>. (value: 1)
     */
        /** @brief Internal Tamper 5 event erases the backup registers and all device secrets<sup>(1)</sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP5NOER_B_0x0 = 0;
        /** @brief Internal Tamper 5 event does not erase the backup registers and device secrets<sup>(2)</sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal Tamper 6 event erases the backup registers and all device secrets. (value: 0)
     *          - B_0x1: Internal Tamper 6 event does not erase the backup registers and device secrets. (value: 1)
     */
        /** @brief Internal Tamper 6 event erases the backup registers and all device secrets. */
    constexpr std::uint32_t TAMP_CR3_ITAMP6NOER_B_0x0 = 0;
        /** @brief Internal Tamper 6 event does not erase the backup registers and device secrets. */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal Tamper 7 event erases the backup registers and all device secrets<sup>(1)</sup>. (value: 0)
     *          - B_0x1: Internal Tamper 7 event does not erase the backup registers and device secrets<sup>(2)</sup>. (value: 1)
     */
        /** @brief Internal Tamper 7 event erases the backup registers and all device secrets<sup>(1)</sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP7NOER_B_0x0 = 0;
        /** @brief Internal Tamper 7 event does not erase the backup registers and device secrets<sup>(2)</sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal Tamper 8 event erases the backup registers and all device secrets<sup>(1)</sup>. (value: 0)
     *          - B_0x1: Internal Tamper 8 event does not erase the backup registers and device secrets<sup>(2)</sup>. (value: 1)
     */
        /** @brief Internal Tamper 8 event erases the backup registers and all device secrets<sup>(1)</sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP8NOER_B_0x0 = 0;
        /** @brief Internal Tamper 8 event does not erase the backup registers and device secrets<sup>(2)</sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal Tamper 9 event erases the backup registers and all device secrets<sup>(1)</sup>. (value: 0)
     *          - B_0x1: Internal Tamper 9 event does not erase the backup registers and device secrets<sup>(2)</sup>. (value: 1)
     */
        /** @brief Internal Tamper 9 event erases the backup registers and all device secrets<sup>(1)</sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP9NOER_B_0x0 = 0;
        /** @brief Internal Tamper 9 event does not erase the backup registers and device secrets<sup>(2)</sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal Tamper 11 event erases the backup registers and all device secrets<sup>(1)</sup>. (value: 0)
     *          - B_0x1: Internal Tamper 11 event does not erase the backup registers and device secrets<sup>(2)</sup>. (value: 1)
     */
        /** @brief Internal Tamper 11 event erases the backup registers and all device secrets<sup>(1)</sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP11NOER_B_0x0 = 0;
        /** @brief Internal Tamper 11 event does not erase the backup registers and device secrets<sup>(2)</sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP11NOER_B_0x1 = 1;

    /** @brief Internal Tamper 15 no erase */
    using TAMP_CR3_ITAMP15NOER = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Internal Tamper 15 event erases the backup registers and all device secrets<sup>(1)</sup>. (value: 0)
     *          - B_0x1: Internal Tamper 15 event does not erase the backup registers and device secrets<sup>(2)</sup>. (value: 1)
     */
        /** @brief Internal Tamper 15 event erases the backup registers and all device secrets<sup>(1)</sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP15NOER_B_0x0 = 0;
        /** @brief Internal Tamper 15 event does not erase the backup registers and device secrets<sup>(2)</sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP15NOER_B_0x1 = 1;
    ...
    /** @brief Active tamper output change period The tamper output is changed every CK_ATPER = (2<sup>ATPER </sup>x CK_ATPRE) cycles. Refer to Table 386: Minimum ATPER value. */
    using TAMP_ATCR1_ATPER = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Active tamper output sharing TAMP_IN1 is compared with TAMPOUTSEL1 TAMP_IN2 is compared with TAMPOUTSEL2 TAMP_IN3 is compared with TAMPOUTSEL3 TAMP_IN4 is compared with TAMPOUTSEL4 TAMP_IN5 is compared with TAMPOUTSEL5 TAMP_IN6 is compared with TAMPOUTSEL6 TAMP_IN7 is compared with TAMPOUTSEL7 TAMP_IN8 is compared with TAMPOUTSEL8 */
    ...
    /** @brief Active tamper shared output 7 selection The selected output must be available in the package pinout. */
    ...
    /** @brief Active tamper shared output 8 selection The selected output must be available in the package pinout. */
    ...
    using TAMP_CFGR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x20, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Backup registers read/write protection offset BKPRW value must be from 0 to 32. Protection zone 1 is defined for backup registers from TAMP_BKP0R to TAMP_BKPxR (x = BKPRW-1, with BKPRW more or equal to 1). If BKPRW = 0: there is no protection zone 1. Refer to Figure 499: Backup registers protection zones. Note: If BKPRWPRIV is set, BKPRW[7:0] can be written only in privileged mode. */
    using TAMP_CFGR_BKPRW = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Backup registers write protection offset BKPW value must be from 0 to 32. Protection zone 2 is defined for backup registers from TAMP_BKPyR (y = BKPRW) to TAMP_BKPzR (z = BKPW-1, with BKPW > BKPRW): If BKPWSEC = 0 or if BKPWSEC UNDER OR EQUAL BKPRWSEC: there is no protection zone 2. Protection zone 3 is defined for backup registers from TAMP_BKPtR (t = BKPW if BKPWSEC more or equal to BKPRWSEC, else t = BKPRWSEC). If BKPWSEC = 32: there is no protection zone 3. Refer to Figure 499: Backup registers protection zones. Note: If BKPWPRIV is set, BKPRW[7:0] can be written only in privileged mode. */
    using TAMP_CFGR_BKPW = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TAMP_CFGR_BHKLOCK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TAMP_CFGR_BHKLOCK_B_0x0 = 0;
    ...
    constexpr std::uint32_t TAMP_CFGR_BHKLOCK_B_0x1 = 1;
    ...
    /** @brief Tamper privilege protection (excluding backup registers) Note: Refer to Section 46.3.6: TAMP privilege protection modes for details on the read protection. */
    ...
    /** @brief Internal tamper 15 interrupt enable */
    using TAMP_IER_ITAMP15IE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Internal tamper 15 interrupt disabled. (value: 0)
     *          - B_0x1: Internal tamper 15 interrupt enabled. (value: 1)
     */
        /** @brief Internal tamper 15 interrupt disabled. */
    constexpr std::uint32_t TAMP_IER_ITAMP15IE_B_0x0 = 0;
        /** @brief Internal tamper 15 interrupt enabled. */
    constexpr std::uint32_t TAMP_IER_ITAMP15IE_B_0x1 = 1;
    ...
    /** @brief TAMP7 detection flag This flag is set by hardware when a tamper detection event is detected on the TAMP7 input. */
    using TAMP_SR_TAMP7F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TAMP8 detection flag This flag is set by hardware when a tamper detection event is detected on the TAMP8 input */
    using TAMP_SR_TAMP8F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Internal tamper 1 flag This flag is set by hardware when a tamper detection event is detected on the internal tamper 1. */
    using TAMP_SR_ITAMP1F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Internal tamper 2 flag This flag is set by hardware when a tamper detection event is detected on the internal tamper 2. */
    ...
    /** @brief Internal tamper 15 flag This flag is set by hardware when a tamper detection event is detected on the internal tamper 15. */
    using TAMP_SR_ITAMP15F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief TAMP6 interrupt masked flag This flag is set by hardware when the tamper 6 interrupt is raised. */
    using TAMP_MISR_TAMP6MF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TAMP7 interrupt masked flag This flag is set by hardware when the tamper 7 interrupt is raised. */
    using TAMP_MISR_TAMP7MF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TAMP8 interrupt masked flag This flag is set by hardware when the tamper 8 interrupt is raised. */
    using TAMP_MISR_TAMP8MF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Internal tamper 1 interrupt masked flag This flag is set by hardware when the internal tamper 1 interrupt is raised. */
    using TAMP_MISR_ITAMP1MF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Internal tamper 2 interrupt masked flag This flag is set by hardware when the internal tamper 2 interrupt is raised. */
    ...
    /** @brief Internal tamper 7 tamper interrupt masked flag This flag is set by hardware when the internal tamper 7 interrupt is raised. */
    using TAMP_MISR_ITAMP7MF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Internal tamper 8 interrupt masked flag This flag is set by hardware when the internal tamper 8 interrupt is raised. */
    using TAMP_MISR_ITAMP8MF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief internal tamper 9 interrupt masked flag This flag is set by hardware when the internal tamper 9 interrupt is raised. */
    using TAMP_MISR_ITAMP9MF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief internal tamper 11 interrupt masked flag This flag is set by hardware when the internal tamper 11 interrupt is raised. */
    using TAMP_MISR_ITAMP11MF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief internal tamper 15 interrupt masked flag This flag is set by hardware when the internal tamper 15 interrupt is raised. */
    using TAMP_MISR_ITAMP15MF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Clear TAMP7 detection flag Writing 1 in this bit clears the TAMP7F bit in the TAMP_SR register. */
    using TAMP_SCR_CTAMP7F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Clear TAMP8 detection flag Writing 1 in this bit clears the TAMP8F bit in the TAMP_SR register. */
    ...
    /** @brief Clear ITAMP15 detection flag Writing 1 in this bit clears the ITAMP15F bit in the TAMP_SR register. */
    using TAMP_SCR_CITAMP15F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
