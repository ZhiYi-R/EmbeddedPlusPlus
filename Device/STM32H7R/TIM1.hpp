...
#ifndef EMBEDDED_PP_STM32H7R_TIM1_HPP
#define EMBEDDED_PP_STM32H7R_TIM1_HPP
...
namespace STM32H7R::TIM1 {
    ...
    /** @brief Index blanking This bit indicates if the Index event is conditioned by the tim_ti3 or tim_ti4 input */
    ...
    /** @brief Selects tim_ti1[15:0] input ... Refer to Section 64.3.2: TIM1 pins and internal signals for interconnects list. */
    ...
    /** @brief Selects tim_ti2[15:0] input ... Refer to Section 64.3.2: TIM1 pins and internal signals for interconnects list. */
    ...
    /** @brief Selects tim_ti3[15:0] input ... Refer to Section 64.3.2: TIM1 pins and internal signals for interconnects list. */
    ...
    /** @brief Selects tim_ti4[15:0] input ... Refer to Section 64.3.2: TIM1 pins and internal signals for interconnects list. */
    ...
    /** @brief tim_brk_cmp8 enable This bit enables the tim_brk_cmp8 for the timers tim_brk input. tim_brk_cmp8 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief etr_in source selection These bits select the etr_in input source. ... Refer to Section 64.3.2: TIM1 pins and internal signals for product specific implementation. Note: These bits can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief TIMx_BKIN2 input enable This bit enables the TIMx_BKIN2 alternate function input for the timers tim_brk2 input. TIMx_BKIN2 input is ORed with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief tim_brk2_cmp1 enable This bit enables the tim_brk2_cmp1 for the timers tim_brk2 input. tim_brk2_cmp1 output is ORed with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief tim_brk2_cmp2 enable This bit enables the tim_brk2_cmp2 for the timers tim_brk2 input. tim_brk2_cmp2 output is ORed with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief tim_brk2_cmp3 enable This bit enables the tim_brk2_cmp3 for the timers tim_brk2 input. tim_brk2_cmp3 output is ORed with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief tim_brk2_cmp4 enable This bit enables the tim_brk2_cmp4 for the timers tim_brk2 input. tim_brk2_cmp4 output is ORed with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief tim_brk2_cmp5 enable This bit enables the tim_brk2_cmp5 for the timers tim_brk2 input. tim_brk2_cmp5 output is ORed with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief tim_brk2_cmp6 enable This bit enables the tim_brk2_cmp6 for the timers tim_brk2 input. tim_brk2_cmp6 output is ORed with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief tim_brk2_cmp7 enable This bit enables the tim_brk2_cmp7 for the timers tim_brk2 input. tim_brk2_cmp7 output is ORed with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief tim_brk2_cmp8 enable This bit enables the tim_brk2_cmp8 for the timers tim_brk2 input. tim_brk2_cmp8 output is ORed with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief ocref_clr source selection These bits select the ocref_clr input source. ... Refer to Section 64.3.2: TIM1 pins and internal signals for product specific information. Note: These bits can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
