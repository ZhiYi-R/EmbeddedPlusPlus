...
#ifndef EMBEDDED_PP_STM32H7S_CORDIC_HPP
#define EMBEDDED_PP_STM32H7S_CORDIC_HPP
...
namespace STM32H7S::CORDIC {
    ...
    constexpr std::uint32_t CORDIC_CSR_PRECISION_B_0x0 = 0;
