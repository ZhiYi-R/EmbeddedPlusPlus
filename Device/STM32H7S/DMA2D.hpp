...
#ifndef EMBEDDED_PP_STM32H7S_DMA2D_HPP
#define EMBEDDED_PP_STM32H7S_DMA2D_HPP
...
namespace STM32H7S::DMA2D {
    ...
    /** @brief Abort This bit can be used to abort the current transfer. This bit is set by software, and is automatically reset by hardware when START = 0. */
    ...
    /** @brief Line offset mode This bit configures how the line offset is expressed (pixels or bytes) for the foreground, background and output. This bit is set and cleared by software. It can not be modified while a transfer is ongoing. */
    ...
    /** @brief Transfer error (TE) interrupt enable This bit is set and cleared by software. */
    ...
    /** @brief Transfer complete (TC) interrupt enable This bit is set and cleared by software. */
    ...
    /** @brief Transfer watermark (TW) interrupt enable This bit is set and cleared by software. */
    ...
    /** @brief CLUT access error (CAE) interrupt enable This bit is set and cleared by software. */
    ...
    /** @brief CLUT transfer complete (CTC) interrupt enable This bit is set and cleared by software. */
    ...
    /** @brief Configuration error (CE) interrupt enable This bit is set and cleared by software. */
    ...
    /** @brief DMA2D mode This bit is set and cleared by software. It cannot be modified while a transfer is ongoing. Others: Reserved */
    ...
    /** @brief Configuration error interrupt flag This bit is set when START is set in DMA2D_CR, DMA2DFGPFCCR or DMA2D_BGPFCCR, and a wrong configuration has been programmed. */
    ...
    /** @brief Clear transfer error interrupt flag Programming this bit to 1 clears the TEIF flag in DMA2D_ISR. */
    using DMA2D_IFCR_CTEIF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Clear transfer complete interrupt flag Programming this bit to 1 clears the TCIF flag in DMA2D_ISR. */
    using DMA2D_IFCR_CTCIF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Clear transfer watermark interrupt flag Programming this bit to 1 clears the TWIF flag in DMA2D_ISR. */
    using DMA2D_IFCR_CTWIF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Clear CLUT access error interrupt flag Programming this bit to 1 clears the CAEIF flag in DMA2D_ISR. */
    using DMA2D_IFCR_CAECIF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Clear CLUT transfer complete interrupt flag Programming this bit to 1 clears the CTCIF flag in DMA2D_ISR. */
    using DMA2D_IFCR_CCTCIF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Clear configuration error interrupt flag Programming this bit to 1 clears the CEIF flag in DMA2D_ISR. */
    ...
    /** @brief Memory address, address of the data used for the foreground image The address alignment must match the image format selected: a 32-bit per pixel format must be 32-bit aligned, a 16-bit per pixel format must be 16-bit aligned, and a 4-bit per pixel format must be 8-bit aligned. */
    ...
    /** @brief Memory address, address of the data used for the background image The address alignment must match the image format selected: a 32-bit per pixel format must be 32-bit aligned, a 16-bit per pixel format must be 16-bit aligned and a 4-bit per pixel format must be 8-bit aligned. */
    ...
    /** @brief Line offset This field gives the line offset used for the background image, expressed: in pixels when LOM = 0 in DMA2D_CR. Only LO[13:0] bits are considered, LO[15:14] bits are ignored. in bytes when LOM = 1 This value is used for the address generation. It is added at the end of each line to determine the starting address of the next line. If the image format is 4-bit per pixel, the line offset must be even. */
    ...
    /** @brief Color mode These bits defines the color format of the foreground image. Others: Reserved */
    ...
    /** @brief CLUT color mode This bit defines the color format of the CLUT. */
    ...
    /** @brief CLUT size These bits define the size of the CLUT used for the foreground image. The number of CLUT entries is equal to CS[7:0] + 1. */
    using DMA2D_FGPFCCR_CS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Alpha mode These bits select the alpha channel value to be used for the foreground image. Others: Reserved */
    ...
    /** @brief Chroma subsampling These bits define the chroma subsampling mode for YCbCr color mode. Others: Reserved */
    ...
    /** @brief Alpha inverted This bit inverts the alpha value. */
    ...
    /** @brief Red/Blue swap This bit allows to swap Red and Blue to support BGR or ABGR color formats. */
    ...
    /** @brief Alpha value These bits define a fixed alpha channel value which can replace the original alpha value, or be multiplied by the original alpha value, according to the alpha mode selected through AM[1:0] in this register. */
    ...
    /** @brief Blue value for the A4 or A8 mode of the foreground image Used also for fixed color FG in memory-to-memory mode with blending and fixed color FG (BG fetch only with FG and BG PFC active). */
    using DMA2D_FGCOLR_BLUE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Green value for the A4 or A8 mode of the foreground image Used also for fixed color FG in memory-to-memory mode with blending and fixed color FG (BG fetch only with FG and BG PFC active). */
    using DMA2D_FGCOLR_GREEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Red value for the A4 or A8 mode of the foreground image Used also for fixed color FG in memory-to-memory mode with blending and fixed color FG (BG fetch only with FG and BG PFC active). */
    ...
    /** @brief Color mode These bits define the color format of the foreground image. Others: Reserved */
    ...
    /** @brief CLUT color mode These bits define the color format of the CLUT. */
    ...
    /** @brief CLUT size These bits define the size of the CLUT used for the BG. The number of CLUT entries is equal to CS[7:0] + 1. */
    using DMA2D_BGPFCCR_CS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Alpha mode These bits define which alpha channel value to be used for the background image. Others: Reserved */
    ...
    /** @brief Alpha value These bits define a fixed alpha channel value which can replace the original alpha value, or be multiplied with the original alpha value according to the alpha mode selected with AM[1:0]. */
    ...
    /** @brief Blue value for the A4 or A8 mode of the background Used also for fixed color BG in memory-to-memory mode with blending and fixed color BG (FG fetch only with FG and BG PFC active). */
    using DMA2D_BGCOLR_BLUE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Green value for the A4 or A8 mode of the background Used also for fixed color BG in memory-to-memory mode with blending and fixed color BG (FG fetch only with FG and BG PFC active). */
    using DMA2D_BGCOLR_GREEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Red value for the A4 or A8 mode of the background Used also for fixed color BG in memory-to-memory mode with blending and fixed color BG (FG fetch only with FG and BG PFC active). */
    ...
    /** @brief Memory address Address of the data used for the CLUT address dedicated to the foreground image. If the foreground CLUT format is 32-bit, the address must be 32-bit aligned. */
    ...
    /** @brief Memory address Address of the data used for the CLUT address dedicated to the background image. If the background CLUT format is 32-bit, the address must be 32-bit aligned. */
    ...
    /** @brief Color mode These bits define the color format of the output image. Others: Reserved */
    ...
    /** @brief Swap bytes When this bit is set, the bytes in the output FIFO are swapped two by two. The number of pixels per line (PL) must be even, and the output memory address (OMAR) must be even. */
    ...
    using DMA2D_OCOLR_ARGB8888 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x38, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Blue value of the output image in ARGB8888 or RGB888 */
    using DMA2D_OCOLR_ARGB8888_BLUE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Green value of the output image in ARGB8888 or RGB888 */
    using DMA2D_OCOLR_ARGB8888_GREEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Red value of the output image in ARGB8888 or RGB888 mode */
    using DMA2D_OCOLR_ARGB8888_RED = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Alpha channel value of the output color in ARGB8888 mode (otherwise reserved) */
    using DMA2D_OCOLR_ARGB8888_ALPHA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DMA2D output color register */
    ...
    /** @brief Memory address Address of the data used for the output FIFO. The address alignment must match the image format selected: a 32-bit per pixel format must be 32-bit aligned and a 16-bit per pixel format must be 16-bit aligned. */
    ...
    /** @brief Line offset This field gives the line offset used for the output, expressed: in pixels when LOM = 0 in DMA2D_CR. Only LO[13:0] bits are considered, LO[15:14] bits are ignored. in bytes when LOM = 1 This value is used for the address generation. It is added at the end of each line to determine the starting address of the next line. */
    ...
    /** @brief Pixel per lines per lines of the area to be transferred If any of the input image format is 4-bit per pixel, pixel per lines must be even. */
    ...
    /** @brief Line watermark for interrupt generation An interrupt is raised when the last pixel of the watermarked line has been transferred. */
