...
#ifndef EMBEDDED_PP_STM32H7S_FMC_HPP
#define EMBEDDED_PP_STM32H7S_FMC_HPP
...
namespace STM32H7S::FMC {
    ...
    /** @details Possible values:
     *          - B_0x0: SRAM (default after reset for Bank 2...4) (value: 0)
     *          - B_0x1: PSRAM (CRAM) (value: 1)
     *          - B_0x2: NOR flash/OneNAND flash (default after reset for Bank 1) (value: 2)
     *          - B_0x3: FIELD Reserved (value: 3)
     */
        /** @brief SRAM (default after reset for Bank 2...4) */
    ...
    constexpr std::uint32_t FMC_BCR1_MTYP_B_0x3 = 3;
    ...
    constexpr std::uint32_t FMC_BCR1_MWID_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BCR1_MWID_B_0x3 = 3;
    ...
    /** @details Possible values:
     *          - B_0x0: Write operations are disabled in the bank by the FMC, an AXI slave error is reported (value: 0)
     *          - B_0x1: Write operations are enabled for the bank by the FMC (default after reset). (value: 1)
     */
        /** @brief Write operations are disabled in the bank by the FMC, an AXI slave error is reported */
    ...
    /** @brief Write FIFO Disable This bit disables the Write FIFO used by the FMC. Note: The WFDIS bit of the FMC_BCR2..4 registers is dont care. It is only enabled through the FMC_BCR1 register. */
    ...
    /** @brief FMC bank mapping These bits allow different remap or swap of the FMC NOR/PSRAM and SDRAM banks (refer to Table 144). Note: The BMAP bits of the FMC_BCR2..4 registers are dont care. It is only enabled through the FMC_BCR1 register. */
    using FMC_BCR1_BMAP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Default mapping (refer to Figure 108 and Table 144). (value: 0)
     *          - B_0x1: NOR/PSRAM bank and SDRAM bank 1 are swapped. (value: 1)
     *          - B_0x2: FIELD Reserved (value: 2)
     *          - B_0x3: Reserved. (value: 3)
     */
        /** @brief Default mapping (refer to Figure 108 and Table 144). */
    constexpr std::uint32_t FMC_BCR1_BMAP_B_0x0 = 0;
        /** @brief NOR/PSRAM bank and SDRAM bank 1 are swapped. */
    constexpr std::uint32_t FMC_BCR1_BMAP_B_0x1 = 1;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BCR1_BMAP_B_0x2 = 2;
        /** @brief Reserved. */
    constexpr std::uint32_t FMC_BCR1_BMAP_B_0x3 = 3;

    /** @brief FMC Enable This bit enables/disables the FMC. Note: The FMCEN bit of the FMC_BCR2..4 registers is dont care. It is only enabled through the FMC_BCR1 register. */
    using FMC_BCR1_FMCEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Disable the FMC (value: 0)
     *          - B_0x1: Enable the FMC (value: 1)
     */
        /** @brief Disable the FMC */
    constexpr std::uint32_t FMC_BCR1_FMCEN_B_0x0 = 0;
        /** @brief Enable the FMC */
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BTR1_ADDHLD_B_0x0 = 0;
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BTR1_DATAST_B_0x0 = 0;
    ...
    /** @details Possible values:
     *          - B_0x0: BUSTURN phase duration = 0 fmc_ker_ck clock cycle added (value: 0)
     *          - B_0xF: BUSTURN phase duration = 15 x fmc_ker_ck clock cycles added (default value after reset) (value: 15)
     */
        /** @brief BUSTURN phase duration = 0 fmc_ker_ck clock cycle added */
    constexpr std::uint32_t FMC_BTR1_BUSTURN_B_0x0 = 0;
        /** @brief BUSTURN phase duration = 15 x fmc_ker_ck clock cycles added (default value after reset) */
    ...
    /** @details Possible values:
     *          - B_0x0: FMC_CLK period = 1 x fmc_ker_ck period (value: 0)
     ...
     */
        /** @brief FMC_CLK period = 1 x fmc_ker_ck period */
    ...
    constexpr std::uint32_t FMC_BCR2_MTYP_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BCR2_MTYP_B_0x3 = 3;
    ...
    constexpr std::uint32_t FMC_BCR2_MWID_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BCR2_MWID_B_0x3 = 3;
    ...
    /** @brief FMC bank mapping These bits allow different remap or swap of the FMC NOR/PSRAM and SDRAM banks (refer to Table 144). Note: The BMAP bits of the FMC_BCR2..4 registers are dont care. It is only enabled through the FMC_BCR1 register. */
    using FMC_BCR2_BMAP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Default mapping (refer to Figure 108 and Table 144). (value: 0)
     *          - B_0x1: NOR/PSRAM bank and SDRAM bank 1 are swapped. (value: 1)
     *          - B_0x2: FIELD Reserved (value: 2)
     ...
     */
        /** @brief Default mapping (refer to Figure 108 and Table 144). */
    constexpr std::uint32_t FMC_BCR2_BMAP_B_0x0 = 0;
        /** @brief NOR/PSRAM bank and SDRAM bank 1 are swapped. */
    constexpr std::uint32_t FMC_BCR2_BMAP_B_0x1 = 1;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BCR2_BMAP_B_0x2 = 2;
        /** @brief Reserved. */
    constexpr std::uint32_t FMC_BCR2_BMAP_B_0x3 = 3;
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BTR2_ADDHLD_B_0x0 = 0;
        /** @brief ADDHLD phase duration =1 fmc_ker_ck clock cycle */
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BTR2_DATAST_B_0x0 = 0;
        /** @brief DATAST phase duration = 1 fmc_ker_ck clock cycles */
    ...
    constexpr std::uint32_t FMC_BCR3_MTYP_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BCR3_MTYP_B_0x3 = 3;
    ...
    constexpr std::uint32_t FMC_BCR3_MWID_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BCR3_MWID_B_0x3 = 3;
    ...
    /** @brief FMC bank mapping These bits allow different remap or swap of the FMC NOR/PSRAM and SDRAM banks (refer to Table 144). Note: The BMAP bits of the FMC_BCR2..4 registers are dont care. It is only enabled through the FMC_BCR1 register. */
    using FMC_BCR3_BMAP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Default mapping (refer to Figure 108 and Table 144). (value: 0)
     *          - B_0x1: NOR/PSRAM bank and SDRAM bank 1 are swapped. (value: 1)
     *          - B_0x2: FIELD Reserved (value: 2)
     ...
     */
        /** @brief Default mapping (refer to Figure 108 and Table 144). */
    constexpr std::uint32_t FMC_BCR3_BMAP_B_0x0 = 0;
        /** @brief NOR/PSRAM bank and SDRAM bank 1 are swapped. */
    constexpr std::uint32_t FMC_BCR3_BMAP_B_0x1 = 1;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BCR3_BMAP_B_0x2 = 2;
        /** @brief Reserved. */
    constexpr std::uint32_t FMC_BCR3_BMAP_B_0x3 = 3;
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BTR3_ADDHLD_B_0x0 = 0;
        /** @brief ADDHLD phase duration =1 fmc_ker_ck clock cycle */
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BTR3_DATAST_B_0x0 = 0;
        /** @brief DATAST phase duration = 1 fmc_ker_ck clock cycles */
    ...
    constexpr std::uint32_t FMC_BCR4_MTYP_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BCR4_MTYP_B_0x3 = 3;
    ...
    constexpr std::uint32_t FMC_BCR4_MWID_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BCR4_MWID_B_0x3 = 3;
    ...
    /** @brief FMC bank mapping These bits allow different remap or swap of the FMC NOR/PSRAM and SDRAM banks (refer to Table 144). Note: The BMAP bits of the FMC_BCR2..4 registers are dont care. It is only enabled through the FMC_BCR1 register. */
    using FMC_BCR4_BMAP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Default mapping (refer to Figure 108 and Table 144). (value: 0)
     *          - B_0x1: NOR/PSRAM bank and SDRAM bank 1 are swapped. (value: 1)
     *          - B_0x2: FIELD Reserved (value: 2)
     ...
     */
        /** @brief Default mapping (refer to Figure 108 and Table 144). */
    constexpr std::uint32_t FMC_BCR4_BMAP_B_0x0 = 0;
        /** @brief NOR/PSRAM bank and SDRAM bank 1 are swapped. */
    constexpr std::uint32_t FMC_BCR4_BMAP_B_0x1 = 1;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BCR4_BMAP_B_0x2 = 2;
        /** @brief Reserved. */
    constexpr std::uint32_t FMC_BCR4_BMAP_B_0x3 = 3;
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BTR4_ADDHLD_B_0x0 = 0;
        /** @brief ADDHLD phase duration =1 fmc_ker_ck clock cycle */
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BTR4_DATAST_B_0x0 = 0;
        /** @brief DATAST phase duration = 1 fmc_ker_ck clock cycles */
    ...
    /** @brief CLE to RE delay. These bits set time from CLE low to RE low in number of fmc_ker_ck clock cycles. The time is give by the following formula: t_clr = (TCLR + SET + 2) t<sub>fmc_ker_ck</sub> where t<sub>fmc_ker_ck</sub> is the fmc_ker_ck clock period Note: Set is MEMSET or ATTSET according to the addressed space. */
    using FMC_PCR_TCLR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: 1 x fmc_ker_ck cycle (default) (value: 0)
     *          - B_0xF: 16 x fmc_ker_ck cycles (value: 15)
     */
        /** @brief 1 x fmc_ker_ck cycle (default) */
    constexpr std::uint32_t FMC_PCR_TCLR_B_0x0 = 0;
        /** @brief 16 x fmc_ker_ck cycles */
    constexpr std::uint32_t FMC_PCR_TCLR_B_0xF = 15;

    /** @brief ALE to RE delay. These bits set time from ALE low to RE low in number of fmc_ker_ck clock cycles. Time is: t_ar = (TAR + SET + 2) t<sub>fmc_ker_ck</sub> where t<sub>fmc_ker_ck</sub> is the FMC clock period Note: Set is MEMSET or ATTSET according to the addressed space. */
    using FMC_PCR_TAR0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: 1 x fmc_ker_ck cycle (default) (value: 0)
     */
        /** @brief 1 x fmc_ker_ck cycle (default) */
    constexpr std::uint32_t FMC_PCR_TAR0_B_0x0 = 0;

    /** @brief ALE to RE delay. These bits set time from ALE low to RE low in number of fmc_ker_ck clock cycles. Time is: t_ar = (TAR + SET + 2) t<sub>fmc_ker_ck</sub> where t<sub>fmc_ker_ck</sub> is the FMC clock period Note: Set is MEMSET or ATTSET according to the addressed space. */
    using FMC_PCR_TAR1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: 1 x fmc_ker_ck cycle (default) (value: 0)
     */
        /** @brief 1 x fmc_ker_ck cycle (default) */
    constexpr std::uint32_t FMC_PCR_TAR1_B_0x0 = 0;

    /** @brief ALE to RE delay. These bits set time from ALE low to RE low in number of fmc_ker_ck clock cycles. Time is: t_ar = (TAR + SET + 2) t<sub>fmc_ker_ck</sub> where t<sub>fmc_ker_ck</sub> is the FMC clock period Note: Set is MEMSET or ATTSET according to the addressed space. */
    using FMC_PCR_TAR2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: 1 x fmc_ker_ck cycle (default) (value: 0)
     */
        /** @brief 1 x fmc_ker_ck cycle (default) */
    constexpr std::uint32_t FMC_PCR_TAR2_B_0x0 = 0;
     ...
     *          - B_0x1: 1 fmc_ker_ck cycle for write access / 3 fmc_ker_ck cycle for read access (value: 1)
     *          - B_0xFE: 254 fmc_ker_ck cycles for write access / 257 fmc_ker_ck cycles for read access (value: 254)
     *          - B_0xFF: reserved. (value: 255)
     */
        /** @brief reserved. */
    constexpr std::uint32_t FMC_PMEM_MEMHOLD_B_0x0 = 0;
        /** @brief 1 fmc_ker_ck cycle for write access / 3 fmc_ker_ck cycle for read access */
    constexpr std::uint32_t FMC_PMEM_MEMHOLD_B_0x1 = 1;
        /** @brief 254 fmc_ker_ck cycles for write access / 257 fmc_ker_ck cycles for read access */
    constexpr std::uint32_t FMC_PMEM_MEMHOLD_B_0xFE = 254;
        /** @brief reserved. */
    constexpr std::uint32_t FMC_PMEM_MEMHOLD_B_0xFF = 255;

    /** @brief Common memory x data bus Hi-Z time These bits define the number of fmc_ker_ck clock cycles during which the data bus is kept Hi-Z after the start of a NAND flash write access to common memory space. This is only valid for write transactions: */
    using FMC_PMEM_MEMHIZ = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: 0 x fmc_ker_ck cycle (value: 0)
     *          - B_0xFE: 254 x fmc_ker_ck cycles (value: 254)
     *          - B_0xFF: reserved. (value: 255)
     */
        /** @brief 0 x fmc_ker_ck cycle */
    constexpr std::uint32_t FMC_PMEM_MEMHIZ_B_0x0 = 0;
        /** @brief 254 x fmc_ker_ck cycles */
    ...
    /** @brief Attribute memory setup time These bits define the number of fmc_ker_ck (+1) clock cycles to set up address before the command assertion (NWE, NOE), for NAND flash read or write access to attribute memory space: */
    using FMC_PATT_ATTSET = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: 1 x fmc_ker_ck cycle (value: 0)
     *          - B_0xFE: 255 x fmc_ker_ck cycles (value: 254)
     *          - B_0xFF: reserved. (value: 255)
     */
        /** @brief 1 x fmc_ker_ck cycle */
    ...
    /** @brief Attribute memory hold time These bits define the number of fmc_ker_ck clock cycles during which the address is held (and data for write access) after the command deassertion (NWE, NOE), for NAND flash read or write access to attribute memory space: */
    using FMC_PATT_ATTHOLD = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: FIELD Reserved (value: 0)
     *          - B_0x1: 1 x fmc_ker_ck cycle (value: 1)
     *          - B_0xFE: 254 x fmc_ker_ck cycles (value: 254)
     *          - B_0xFF: reserved. (value: 255)
     */
        /** @brief FIELD Reserved */
    ...
    /** @brief Attribute memory data bus Hi-Z time These bits define the number of fmc_ker_ck clock cycles during which the data bus is kept in Hi-Z after the start of a NAND flash write access to attribute memory space on socket. Only valid for writ transaction: */
    ...
    /** @brief ECC result This field contains the value computed by the ECC computation logic. Table 184 describes the contents of these bitfields. */
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BWTR1_ADDHLD_B_0x0 = 0;
        /** @brief ADDHLD phase duration = 1 fmc_ker_ck clock cycle */
    ...
    /** @brief Data-phase duration. These bits are written by software to define the duration of the data phase (refer to Figure 109 to Figure 121), used in asynchronous SRAM, PSRAM and NOR flash memory accesses: ... */
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BWTR1_DATAST_B_0x0 = 0;
        /** @brief DATAST phase duration = 1 fmc_ker_ck clock cycles */
    ...
    /** @details Possible values:
     *          - B_0x0: BUSTURN phase duration = 0 fmc_ker_ck clock cycle added (value: 0)
     *          - B_0xF: BUSTURN phase duration = 15 fmc_ker_ck clock cycles added (default value after reset) (value: 15)
     */
        /** @brief BUSTURN phase duration = 0 fmc_ker_ck clock cycle added */
    constexpr std::uint32_t FMC_BWTR1_BUSTURN_B_0x0 = 0;
        /** @brief BUSTURN phase duration = 15 fmc_ker_ck clock cycles added (default value after reset) */
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BWTR2_ADDHLD_B_0x0 = 0;
        /** @brief ADDHLD phase duration = 1 fmc_ker_ck clock cycle */
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BWTR2_DATAST_B_0x0 = 0;
        /** @brief DATAST phase duration = 1 fmc_ker_ck clock cycles */
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BWTR3_ADDHLD_B_0x0 = 0;
        /** @brief ADDHLD phase duration = 1 fmc_ker_ck clock cycle */
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BWTR3_DATAST_B_0x0 = 0;
        /** @brief DATAST phase duration = 1 fmc_ker_ck clock cycles */
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BWTR4_ADDHLD_B_0x0 = 0;
        /** @brief ADDHLD phase duration = 1 fmc_ker_ck clock cycle */
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_BWTR4_DATAST_B_0x0 = 0;
        /** @brief DATAST phase duration = 1 fmc_ker_ck clock cycles */
     ...
     *          - B_0x2: SDCLK period = 2 x fmc_ker_ck periods (value: 2)
     *          - B_0x3: SDCLK period = 3 x fmc_ker_ck periods (value: 3)
     */
        /** @brief SDCLK clock disabled */
    constexpr std::uint32_t FMC_SDCR1_SDCLK_B_0x0 = 0;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_SDCR1_SDCLK_B_0x1 = 1;
        /** @brief SDCLK period = 2 x fmc_ker_ck periods */
    constexpr std::uint32_t FMC_SDCR1_SDCLK_B_0x2 = 2;
        /** @brief SDCLK period = 3 x fmc_ker_ck periods */
    ...
    /** @brief Read pipe These bits define the delay, in fmc_ker_ck clock cycles, for reading data after CAS latency. Note: The corresponding bits in the FMC_SDCR2 register is read only. */
    using FMC_SDCR1_RPIPE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No fmc_ker_ck clock cycle delay (value: 0)
     *          - B_0x1: One fmc_ker_ck clock cycle delay (value: 1)
     *          - B_0x2: Two fmc_ker_ck clock cycle delay (value: 2)
     *          - B_0x3: reserved. (value: 3)
     */
        /** @brief No fmc_ker_ck clock cycle delay */
    ...
    constexpr std::uint32_t FMC_SDCMR_MODE_B_0x6 = 6;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t FMC_SDCMR_MODE_B_0x7 = 7;
