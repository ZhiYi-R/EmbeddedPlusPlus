...
#ifndef EMBEDDED_PP_STM32H7S_LTDC_HPP
#define EMBEDDED_PP_STM32H7S_LTDC_HPP
...
namespace STM32H7S::LTDC {
    ...
    /** @brief color look-up table enable This bit is set and cleared by software. The CLUT is only meaningful for L8, AL44 and AL88 pixel format. Refer to Color look-up table (CLUT) */
    ...
    /** @brief window horizontal start position These bits configure the first visible pixel of a line of the layer window. WHSTPOS[11:0] must be UNDER OR EQUAL AAW[11:0] bits (programmed in LTDC_AWCR register). */
    using LTDC_L1WHPCR_WHSTPOS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief window horizontal stop position These bits configure the last visible pixel of a line of the layer window. WHSPPOS[11:0] must be more or equal to AHBP[11:0] bits + 1 (programmed in LTDC_BPCR register). */
    ...
    /** @brief window vertical start position These bits configure the first visible line of the layer window. WVSTPOS[10:0] must be UNDER OR EQUAL AAH[10:0] bits (programmed in LTDC_AWCR register). */
    using LTDC_L1WVPCR_WVSTPOS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 11, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief window vertical stop position These bits configure the last visible line of the layer window. WVSPPOS[10:0] must be more or equal to AVBP[10:0] bits + 1 (programmed in LTDC_BPCR register). */
    ...
    constexpr std::uint32_t LTDC_L1BFCR_BF2_B_0x0 = 0;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L1BFCR_BF2_B_0x1 = 1;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L1BFCR_BF2_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L1BFCR_BF2_B_0x3 = 3;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L1BFCR_BF2_B_0x4 = 4;
        /** @brief 1 - constant alpha */
    constexpr std::uint32_t LTDC_L1BFCR_BF2_B_0x5 = 5;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L1BFCR_BF2_B_0x6 = 6;
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L1BFCR_BF1_B_0x0 = 0;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L1BFCR_BF1_B_0x1 = 1;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L1BFCR_BF1_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L1BFCR_BF1_B_0x3 = 3;
        /** @brief constant alpha */
    constexpr std::uint32_t LTDC_L1BFCR_BF1_B_0x4 = 4;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L1BFCR_BF1_B_0x5 = 5;
        /** @brief pixel alpha x constant alpha */
    constexpr std::uint32_t LTDC_L1BFCR_BF1_B_0x6 = 6;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L1BFCR_BF1_B_0x7 = 7;
    ...
    /** @brief color frame buffer line length These bits define the length of one line of pixels in bytes + 7. The line length is computed as follows: active high width * number of bytes per pixel + 7. */
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L2BFCR_BF2_B_0x0 = 0;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L2BFCR_BF2_B_0x1 = 1;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L2BFCR_BF2_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L2BFCR_BF2_B_0x3 = 3;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L2BFCR_BF2_B_0x4 = 4;
        /** @brief 1 - constant alpha */
    constexpr std::uint32_t LTDC_L2BFCR_BF2_B_0x5 = 5;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L2BFCR_BF2_B_0x6 = 6;
        /** @brief 1 - (pixel alpha x constant alpha) */
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L2BFCR_BF1_B_0x0 = 0;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L2BFCR_BF1_B_0x1 = 1;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L2BFCR_BF1_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L2BFCR_BF1_B_0x3 = 3;
        /** @brief constant alpha */
    constexpr std::uint32_t LTDC_L2BFCR_BF1_B_0x4 = 4;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L2BFCR_BF1_B_0x5 = 5;
        /** @brief pixel alpha x constant alpha */
    constexpr std::uint32_t LTDC_L2BFCR_BF1_B_0x6 = 6;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t LTDC_L2BFCR_BF1_B_0x7 = 7;
