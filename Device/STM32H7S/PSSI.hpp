...
#ifndef EMBEDDED_PP_STM32H7S_PSSI_HPP
#define EMBEDDED_PP_STM32H7S_PSSI_HPP
...
namespace STM32H7S::PSSI {
     ...
     *          - B_0x1: Reserved, must not be selected (value: 1)
     *          - B_0x2: Reserved, must not be selected (value: 2)
    ...
    constexpr std::uint32_t PSSI_CR_EDM_B_0x0 = 0;
        /** @brief Reserved, must not be selected */
    constexpr std::uint32_t PSSI_CR_EDM_B_0x1 = 1;
        /** @brief Reserved, must not be selected */
    constexpr std::uint32_t PSSI_CR_EDM_B_0x2 = 2;
     ...
     *          - B_0x4: Both PSSI_RDY and PSSI_DE features enabled - bidirectional on PSSI_RDY pin (see Bidirectional PSSI_DE/PSSI_RDY signal on page 2965) (value: 4)
     ...
     *          - B_0x7: Both PSSI_RDY and PSSI_DE features enabled - bidirectional on PSSI_DE pin (see Bidirectional PSSI_DE/PSSI_RDY signal on page 2965) (value: 7)
     */
    ...
    constexpr std::uint32_t PSSI_CR_DERDYCFG_B_0x3 = 3;
        /** @brief Both PSSI_RDY and PSSI_DE features enabled - bidirectional on PSSI_RDY pin (see Bidirectional PSSI_DE/PSSI_RDY signal on page 2965) */
    ...
    constexpr std::uint32_t PSSI_CR_DERDYCFG_B_0x6 = 6;
        /** @brief Both PSSI_RDY and PSSI_DE features enabled - bidirectional on PSSI_DE pin (see Bidirectional PSSI_DE/PSSI_RDY signal on page 2965) */
    constexpr std::uint32_t PSSI_CR_DERDYCFG_B_0x7 = 7;

    /** @brief Clock source This bit configures the clock source of the PSSI_PDCK. */
    ...
    /** @brief Data buffer overrun/underrun raw interrupt status This bit is cleared by writing a 1 to the OVR_ISC bit in PSSI_ICR. */
    ...
    /** @brief Data buffer overrun/underrun masked interrupt status This bit is set to 1 only when PSSI_IER/OVR_IE and PSSI_RIS/OVR_RIS are both set to 1. */
    ...
    /** @brief Data buffer overrun/underrun interrupt status clear Writing this bit to 1 clears the OVR_RIS bit in PSSI_RIS. */
