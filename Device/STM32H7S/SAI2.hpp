...
#ifndef EMBEDDED_PP_STM32H7S_SAI2_HPP
#define EMBEDDED_PP_STM32H7S_SAI2_HPP
...
namespace STM32H7S::SAI2 {
    ...
    constexpr std::uint32_t SAI_ACR1_PRTCFG_B_0x3 = 3;
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t SAI_ACR1_DS_B_0x0 = 0;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t SAI_ACR1_DS_B_0x1 = 1;
        /** @brief 8 bits */
    ...
    constexpr std::uint32_t SAI_ACR1_SYNCEN_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t SAI_ACR1_SYNCEN_B_0x3 = 3;
    ...
    /** @brief Master clock divider These bits are set and cleared by software. Otherwise, The master clock frequency is calculated according to the formula given in Section 55.4.8: SAI clock generator. These bits have no meaning when the audio block is slave. They have to be configured when the audio block is disabled. */
    ...
    /** @details Possible values:
     *          - B_0x0: Master clock frequency = F<sub>FS</sub> x 256 (value: 0)
     *          - B_0x1: Master clock frequency = F<sub>FS</sub> x 512 (value: 1)
     */
        /** @brief Master clock frequency = F<sub>FS</sub> x 256 */
    constexpr std::uint32_t SAI_ACR1_OSR_B_0x0 = 0;
        /** @brief Master clock frequency = F<sub>FS</sub> x 512 */
     ...
     *          - B_0x5: FIELD Reserved (value: 5)
     *          - B_0x6: FIELD Reserved (value: 6)
    ...
    constexpr std::uint32_t SAI_ACR2_FTH_B_0x4 = 4;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t SAI_ACR2_FTH_B_0x5 = 5;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t SAI_ACR2_FTH_B_0x6 = 6;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t SAI_ACR2_FTH_B_0x7 = 7;
    ...
    /** @brief Mute counter. These bits are set and cleared by software. They are used only in reception mode. The value set in these bits is compared to the number of consecutive mute frames detected in reception. When the number of mute frames is equal to this value, the flag MUTEDET is set and an interrupt is generated if bit MUTEDETIE is set. Refer to Section : Mute mode for more details. */
    ...
    /** @details Possible values:
     *          - B_0x0: 1s complement representation. (value: 0)
     *          - B_0x1: 2s complement representation. (value: 1)
     */
        /** @brief 1s complement representation. */
    constexpr std::uint32_t SAI_ACR2_CPL_B_0x0 = 0;
        /** @brief 2s complement representation. */
    ...
    constexpr std::uint32_t SAI_ACR2_COMP_B_0x0 = 0;
        /** @brief Reserved. */
    constexpr std::uint32_t SAI_ACR2_COMP_B_0x1 = 1;
        /** @brief -Law algorithm */
    ...
    constexpr std::uint32_t SAI_ASLOTR_SLOTSZ_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t SAI_ASLOTR_SLOTSZ_B_0x3 = 3;
    ...
    /** @brief Anticipated frame synchronization detection interrupt enable. This bit is set and cleared by software. When this bit is set, an interrupt is generated if the AFSDET bit in the SAI_xSR register is set. This bit is meaningless in AC97, SPDIF mode or when the audio block operates as a master. */
    ...
    /** @brief Late frame synchronization detection interrupt enable. This bit is set and cleared by software. When this bit is set, an interrupt is generated if the LFSDET bit is set in the SAI_xSR register. This bit is meaningless in AC97, SPDIF mode or when the audio block operates as a master. */
     ...
     *          - B_0x1: Clock configuration does not respect the rule concerning the frame length specification defined in Section 55.4.6: Frame synchronization (configuration of FRL[7:0] bit in the SAI_xFRCR register) (value: 1)
     */
        /** @brief Clock configuration is correct */
    constexpr std::uint32_t SAI_ASR_WCKCFG_B_0x0 = 0;
        /** @brief Clock configuration does not respect the rule concerning the frame length specification defined in Section 55.4.6: Frame synchronization (configuration of FRL[7:0] bit in the SAI_xFRCR register) */
    ...
    /** @details Possible values:
     *          - B_0x0: External AC97 Codec is ready (value: 0)
     *          - B_0x1: External AC97 Codec is not ready (value: 1)
     */
        /** @brief External AC97 Codec is ready */
    constexpr std::uint32_t SAI_ASR_CNRDY_B_0x0 = 0;
        /** @brief External AC97 Codec is not ready */
     ...
     *          - B_0x1: FIFO UNDER OR EQUAL 1/4 but not empty (transmitter mode), FIFO < 1/4 but not empty (receiver mode) (value: 1)
     *          - B_0x2: 1/4 < FIFO UNDER OR EQUAL 1/2 (transmitter mode), 1/4 UNDER OR EQUAL FIFO < 1/2 (receiver mode) (value: 2)
     *          - B_0x3: 1/2 < FIFO UNDER OR EQUAL 3/4 (transmitter mode), 1/2 UNDER OR EQUAL FIFO < 3/4 (receiver mode) (value: 3)
     *          - B_0x4: 3/4 < FIFO but not full (transmitter mode), 3/4 UNDER OR EQUAL FIFO but not full (receiver mode) (value: 4)
    ...
    constexpr std::uint32_t SAI_ASR_FLVL_B_0x0 = 0;
        /** @brief FIFO UNDER OR EQUAL 1/4 but not empty (transmitter mode), FIFO < 1/4 but not empty (receiver mode) */
    constexpr std::uint32_t SAI_ASR_FLVL_B_0x1 = 1;
        /** @brief 1/4 < FIFO UNDER OR EQUAL 1/2 (transmitter mode), 1/4 UNDER OR EQUAL FIFO < 1/2 (receiver mode) */
    constexpr std::uint32_t SAI_ASR_FLVL_B_0x2 = 2;
        /** @brief 1/2 < FIFO UNDER OR EQUAL 3/4 (transmitter mode), 1/2 UNDER OR EQUAL FIFO < 3/4 (receiver mode) */
    constexpr std::uint32_t SAI_ASR_FLVL_B_0x3 = 3;
        /** @brief 3/4 < FIFO but not full (transmitter mode), 3/4 UNDER OR EQUAL FIFO but not full (receiver mode) */
    ...
    /** @brief Clear anticipated frame synchronization detection flag. This bit is write only. Programming this bit to 1 clears the AFSDET flag in the SAI_xSR register. It is not used in AC97 or SPDIF mode. Reading this bit always returns the value 0. */
    using SAI_ACLRFR_CAFSDET = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Clear late frame synchronization detection flag. This bit is write only. Programming this bit to 1 clears the LFSDET flag in the SAI_xSR register. This bit is not used in AC97 or SPDIF mode Reading this bit always returns the value 0. */
    ...
    constexpr std::uint32_t SAI_BCR1_PRTCFG_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t SAI_BCR1_PRTCFG_B_0x3 = 3;
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t SAI_BCR1_DS_B_0x0 = 0;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t SAI_BCR1_DS_B_0x1 = 1;
        /** @brief 8 bits */
    ...
    constexpr std::uint32_t SAI_BCR1_SYNCEN_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t SAI_BCR1_SYNCEN_B_0x3 = 3;
    ...
    constexpr std::uint32_t SAI_BCR2_FTH_B_0x4 = 4;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t SAI_BCR2_FTH_B_0x5 = 5;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t SAI_BCR2_FTH_B_0x6 = 6;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t SAI_BCR2_FTH_B_0x7 = 7;
    ...
    constexpr std::uint32_t SAI_BCR2_COMP_B_0x0 = 0;
        /** @brief Reserved. */
    constexpr std::uint32_t SAI_BCR2_COMP_B_0x1 = 1;
        /** @brief -Law algorithm */
    ...
    constexpr std::uint32_t SAI_BSLOTR_SLOTSZ_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t SAI_BSLOTR_SLOTSZ_B_0x3 = 3;
    ...
    /** @brief PDM enable This bit is set and cleared by software. This bit enables to control the state of the PDM interface block. Make sure that the SAI in already operating in TDM master mode before enabling the PDM interface. */
    ...
    /** @brief Number of microphones This bit is set and cleared by software. Note: It is not recommended to configure this field when PDMEN = 1.* Note: The complete set of data lines might not be available for all SAI instances. Refer to Section 55.3: SAI implementation for details. */
    ...
    /** @brief Clock enable of bitstream clock number 1 This bit is set and cleared by software. Note: It is not recommended to configure this bit when PDMEN = 1. Note: SAI_CK1 might not be available for all SAI instances. Refer to Section 55.3: SAI implementation for details. */
    ...
    /** @brief Clock enable of bitstream clock number 2 This bit is set and cleared by software. Note: It is not recommended to configure this bit when PDMEN = 1. Note: SAI_CK2 might not be available for all SAI instances. Refer to Section 55.3: SAI implementation for details. */
    ...
    /** @brief Delay line adjust for first microphone of pair 1 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D1 line is available.Refer to Section 55.3: SAI implementation to check if it is available. */
     ...
     *          - B_0x1: Delay of 1 T<sub>SAI_CK </sub>period (value: 1)
     *          - B_0x2: Delay of 2 T<sub>SAI_CK </sub>periods (value: 2)
     *          - B_0x7: Delay of 7 T<sub>SAI_CK </sub>periods (value: 7)
     */
        /** @brief No delay */
    constexpr std::uint32_t SAI_PDMDLY_DLYM1L_B_0x0 = 0;
        /** @brief Delay of 1 T<sub>SAI_CK </sub>period */
    constexpr std::uint32_t SAI_PDMDLY_DLYM1L_B_0x1 = 1;
        /** @brief Delay of 2 T<sub>SAI_CK </sub>periods */
    constexpr std::uint32_t SAI_PDMDLY_DLYM1L_B_0x2 = 2;
        /** @brief Delay of 7 T<sub>SAI_CK </sub>periods */
    constexpr std::uint32_t SAI_PDMDLY_DLYM1L_B_0x7 = 7;

    /** @brief Delay line adjust for second microphone of pair 1 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D1 line is available.Refer to Section 55.3: SAI implementation to check if it is available. */
    ...
    /** @brief Delay line for first microphone of pair 2 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D2 line is available.Refer to Section 55.3: SAI implementation to check if it is available. */
    ...
    /** @brief Delay line for second microphone of pair 2 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D2 line is available.Refer to Section 55.3: SAI implementation to check if it is available. */
    ...
    /** @brief Delay line for first microphone of pair 3 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D3 line is available.Refer to Section 55.3: SAI implementation to check if it is available. */
    ...
    /** @brief Delay line for second microphone of pair 3 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D3 line is available.Refer to Section 55.3: SAI implementation to check if it is available. */
    ...
    /** @brief Delay line for first microphone of pair 4 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D4 line is available.Refer to Section 55.3: SAI implementation to check if it is available. */
    using SAI_PDMDLY_DLYM4L = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No delay (value: 0)
     *          - B_0x1: Delay of 1 T<sub>SAI_CK </sub>period (value: 1)
     *          - B_0x2: Delay of 2 T<sub>SAI_CK </sub>periods (value: 2)
     *          - B_0x7: Delay of 7 of T<sub>SAI_CK </sub>periods (value: 7)
     */
        /** @brief No delay */
    ...
    constexpr std::uint32_t SAI_PDMDLY_DLYM4L_B_0x2 = 2;
        /** @brief Delay of 7 of T<sub>SAI_CK </sub>periods */
    constexpr std::uint32_t SAI_PDMDLY_DLYM4L_B_0x7 = 7;

    /** @brief Delay line for second microphone of pair 4 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D4 line is available.Refer to Section 55.3: SAI implementation to check if it is available. */
