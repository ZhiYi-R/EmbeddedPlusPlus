...
#ifndef EMBEDDED_PP_STM32H7S_SDMMC2_HPP
#define EMBEDDED_PP_STM32H7S_SDMMC2_HPP
...
namespace STM32H7S::SDMMC2 {
    ...
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0xF = 15;
