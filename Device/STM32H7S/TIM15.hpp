...
#ifndef EMBEDDED_PP_STM32H7S_TIM15_HPP
#define EMBEDDED_PP_STM32H7S_TIM15_HPP
...
namespace STM32H7S::TIM15 {
    ...
    /** @brief Clock division This bitfield indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (t<sub>DTS</sub>) used by the dead-time generators and the digital filters (tim_tix) */
    ...
    /** @brief Master mode selection These bits are used to select the information to be sent in master mode to slave timers for synchronization (tim_trgo). The combination is as follows: */
    ...
    constexpr std::uint32_t TIM15_SMCR_SMS_B_0x0 = 0;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t TIM15_SMCR_SMS_B_0x1 = 1;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t TIM15_SMCR_SMS_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t TIM15_SMCR_SMS_B_0x3 = 3;
    ...
    constexpr std::uint32_t TIM15_SMCR_TS_B_0x6 = 6;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t TIM15_SMCR_TS_B_0x7 = 7;
    ...
    using TIM15_DIER_CC2DE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC2 DMA request disabled (value: 0)
     *          - B_0x1: CC2 DMA request enabled (value: 1)
     */
        /** @brief CC2 DMA request disabled */
    constexpr std::uint16_t TIM15_DIER_CC2DE_B_0x0 = 0;
        /** @brief CC2 DMA request enabled */
    constexpr std::uint16_t TIM15_DIER_CC2DE_B_0x1 = 1;
    ...
    using TIM15_CCMR1_OUTPUT_OC1M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM15_CCMR1_OUTPUT_OC1M_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM15_CCMR1_OUTPUT_OC1M_B_0x1 = 1;
    ...
    constexpr std::uint32_t TIM15_CCMR1_OUTPUT_OC1M_B_0x2 = 2;
        /** @brief Toggle - tim_oc1ref toggles when TIM15_CNT=TIM15_CCR1. */
    constexpr std::uint32_t TIM15_CCMR1_OUTPUT_OC1M_B_0x3 = 3;
        /** @brief Force inactive level - tim_oc1ref is forced low. */
    constexpr std::uint32_t TIM15_CCMR1_OUTPUT_OC1M_B_0x4 = 4;
        /** @brief Force active level - tim_oc1ref is forced high. */
    constexpr std::uint32_t TIM15_CCMR1_OUTPUT_OC1M_B_0x5 = 5;
        /** @brief PWM mode 1 - Channel 1 is active as long as TIM15_CNT<TIM15_CCR1 else inactive. */
    constexpr std::uint32_t TIM15_CCMR1_OUTPUT_OC1M_B_0x6 = 6;
        /** @brief PWM mode 2 - Channel 1 is inactive as long as TIM15_CNT<TIM15_CCR1 else active. */
    constexpr std::uint32_t TIM15_CCMR1_OUTPUT_OC1M_B_0x7 = 7;
    ...
    using TIM15_CCMR1_OUTPUT_OC2M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief OC1M[3] */
    using TIM15_CCMR1_OUTPUT_OC1M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC2M[3] */
    using TIM15_CCMR1_OUTPUT_OC2M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Capture/Compare 1 output enable When CC1 channel is configured as output, the OC1 level depends on MOE, OSSI, OSSR, OIS1, OIS1N and CC1NE bits, regardless of the CC1E bits state. Refer to Table 678 for details. */
    ...
    /** @brief Break polarity Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register). Note: Any write operation to this bit takes a delay of 1 APB clock cycle to become effective. */
    ...
    /** @brief selects tim_ti2_in[15:0] input ... Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for interconnects list. */
    ...
    /** @brief TIMx_BKIN input enable This bit enables the TIMx_BKIN alternate function input for the timers tim_brk input. TIMx_BKIN input is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register). */
    ...
    /** @brief tim_brk_cmp1 enable This bit enables the tim_brk_cmp1 for the timers tim_brk input. tim_brk_cmp1 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register). */
    ...
    /** @brief tim_brk_cmp2 enable This bit enables the tim_brk_cmp2 for the timers tim_brk input. tim_brk_cmp2 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register). */
    ...
    /** @brief tim_brk_cmp3 enable This bit enables the tim_brk_cmp3 for the timers tim_brk input. tim_brk_cmp3 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register). */
    ...
    /** @brief tim_brk_cmp4 enable This bit enables the tim_brk_cmp4 for the timers tim_brk input. tim_brk_cmp4 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register). */
    ...
    /** @brief tim_brk_cmp5 enable This bit enables the tim_brk_cmp5 for the timers tim_brk input. tim_brk_cmp5 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register). */
    ...
    /** @brief tim_brk_cmp6 enable This bit enables the tim_brk_cmp6 for the timers tim_brk input. tim_brk_cmp6 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register). */
    ...
    /** @brief tim_brk_cmp7 enable This bit enables the tim_brk_cmp7 for the timers tim_brk input. COMP7 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register). */
    ...
    /** @brief tim_brk_cmp8 enable This bit enables the tim_brk_cmp8 for the timers tim_brk input. mdf_brkx output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register). */
    ...
    /** @brief ocref_clr source selection These bits select the ocref_clr input source. Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for product specific implementation. Note: These bits can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register). */
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t TIM15_DCR_DBSS_B_0x0 = 0;
        /** @brief Update */
