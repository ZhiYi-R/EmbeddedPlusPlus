...
#ifndef EMBEDDED_PP_STM32H7S_TIM17_HPP
#define EMBEDDED_PP_STM32H7S_TIM17_HPP
...
namespace STM32H7S::TIM17 {
    ...
    /** @brief Clock division This bit-field indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (t<sub>DTS</sub>)used by the dead-time generators and the digital filters (tim_tix), */
    ...
    using TIM17_CCMR1_INPUT = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x18, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM17_CCMR1_INPUT_CC1S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_CCMR1_INPUT_CC1S_B_0x0 = 0;
        /** @brief CC1 channel is configured as input, tim_ic1 is mapped on tim_ti1 */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_CC1S_B_0x1 = 1;
    ...
    using TIM17_CCMR1_INPUT_IC1PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1PSC_B_0x0 = 0;
        /** @brief capture is done once every 2 events */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1PSC_B_0x1 = 1;
        /** @brief capture is done once every 4 events */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1PSC_B_0x2 = 2;
        /** @brief capture is done once every 8 events */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1PSC_B_0x3 = 3;
    ...
    using TIM17_CCMR1_INPUT_IC1F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1F_B_0x0 = 0;
        /** @brief f<sub>SAMPLING</sub>=f<sub>tim_ker_ck</sub>, N=2 */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1F_B_0x1 = 1;
        /** @brief f<sub>SAMPLING</sub>=f<sub>tim_ker_ck</sub>, N=4 */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1F_B_0x2 = 2;
        /** @brief f<sub>SAMPLING</sub>=f<sub>tim_ker_ck</sub>, N=8 */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1F_B_0x3 = 3;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/2, N= */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1F_B_0x4 = 4;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/2, N=8 */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1F_B_0x5 = 5;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/4, N=6 */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1F_B_0x6 = 6;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/4, N=8 */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1F_B_0x7 = 7;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/8, N=6 */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1F_B_0x8 = 8;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/8, N=8 */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1F_B_0x9 = 9;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/16, N=5 */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1F_B_0xA = 10;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/16, N=6 */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1F_B_0xB = 11;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/16, N=8 */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1F_B_0xC = 12;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/32, N=5 */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1F_B_0xD = 13;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/32, N=6 */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1F_B_0xE = 14;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/32, N=8 */
    constexpr std::uint32_t TIM17_CCMR1_INPUT_IC1F_B_0xF = 15;

    /** @brief TIM17 capture/compare mode register 1 [alternate] */
    using TIM17_CCMR1_OUTPUT = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x18, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM17_CCMR1_OUTPUT_CC1S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC1 channel is configured as output. (value: 0)
     *          - B_0x1: CC1 channel is configured as input, tim_ic1 is mapped on tim_ti1. (value: 1)
     ...
     */
        /** @brief CC1 channel is configured as output. */
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_CC1S_B_0x0 = 0;
        /** @brief CC1 channel is configured as input, tim_ic1 is mapped on tim_ti1. */
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_CC1S_B_0x1 = 1;
        /** @brief CC1 channel is configured as input, tim_ic1 is mapped on tim_ti2. */
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_CC1S_B_0x2 = 2;
    ...
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_CC1S_B_0x3 = 3;
    ...
    using TIM17_CCMR1_OUTPUT_OC1FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_OC1FE_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_OC1FE_B_0x1 = 1;

    /** @brief Output Compare 1 preload enable Note: These bits can not be modified as long as LOCK level 3 has been programmed (LOCK bits in TIM15_BDTR register) and CC1S=00 (the channel is configured in output). */
    using TIM17_CCMR1_OUTPUT_OC1PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_OC1PE_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_OC1PE_B_0x1 = 1;
    ...
    using TIM17_CCMR1_OUTPUT_OC1M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     ...
     *          - B_0x6: PWM mode 1 - Channel 1 is active as long as TIM15_CNT<TIM15_CCR1 else inactive. (value: 6)
     *          - B_0x7: PWM mode 2 - Channel 1 is inactive as long as TIM15_CNT<TIM15_CCR1 else active. (value: 7)
     */
    ...
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_OC1M_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_OC1M_B_0x1 = 1;
    ...
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_OC1M_B_0x2 = 2;
        /** @brief Toggle - tim_oc1ref toggles when TIM15_CNT=TIM15_CCR1. */
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_OC1M_B_0x3 = 3;
        /** @brief Force inactive level - tim_oc1ref is forced low. */
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_OC1M_B_0x4 = 4;
        /** @brief Force active level - tim_oc1ref is forced high. */
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_OC1M_B_0x5 = 5;
        /** @brief PWM mode 1 - Channel 1 is active as long as TIM15_CNT<TIM15_CCR1 else inactive. */
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_OC1M_B_0x6 = 6;
        /** @brief PWM mode 2 - Channel 1 is inactive as long as TIM15_CNT<TIM15_CCR1 else active. */
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_OC1M_B_0x7 = 7;

    /** @brief Output compare 1 clear enable */
    using TIM17_CCMR1_OUTPUT_OC1CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_OC1CE_B_0x0 = 0;
        /** @brief tim_oc1ref is cleared as soon as a High level is detected on tim_ocref_clr_int input. */
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_OC1CE_B_0x1 = 1;
    ...
    using TIM17_CCMR1_OUTPUT_CC2S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_CC2S_B_0x0 = 0;
        /** @brief CC2 channel is configured as input, tim_ic2 is mapped on tim_ti2. */
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_CC2S_B_0x1 = 1;
        /** @brief C2 channel is configured as input, tim_ic2 is mapped on tim_ti1. */
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_CC2S_B_0x2 = 2;
    ...
    constexpr std::uint32_t TIM17_CCMR1_OUTPUT_CC2S_B_0x3 = 3;

    /** @brief Output compare 2 fast enable */
    using TIM17_CCMR1_OUTPUT_OC2FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 2 preload enable */
    using TIM17_CCMR1_OUTPUT_OC2PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC2M[2:0]: Output compare 2 mode */
    using TIM17_CCMR1_OUTPUT_OC2M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 2 clear enable */
    using TIM17_CCMR1_OUTPUT_OC2CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC1M[3] */
    using TIM17_CCMR1_OUTPUT_OC1M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC2M[3] */
    using TIM17_CCMR1_OUTPUT_OC2M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Capture/Compare 1 output enable When CC1 channel is configured as output, the OC1 level depends on MOE, OSSI, OSSR, OIS1, OIS1N and CC1NE bits, regardless of the CC1E bits state. Refer to Table 680 for details. */
    ...
    /** @brief selects tim_ti1_in[15:0] input ... Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for interconnects list. */
    ...
    /** @brief TIMx_BKIN input enable This bit enables the TIMx_BKIN alternate function input for the timers tim_brk input. TIMx_BKIN input is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief tim_brk_cmp1 enable This bit enables the tim_brk_cmp1 for the timers tim_brk input. tim_brk_cmp1 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief tim_brk_cmp2 enable This bit enables the tim_brk_cmp2 for the timers tim_brk input. tim_brk_cmp2 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief tim_brk_cmp3 enable This bit enables the tim_brk_cmp3 for the timers tim_brk input. tim_brk_cmp3 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief tim_brk_cmp4 enable This bit enables the tim_brk_cmp4 for the timers tim_brk input. tim_brk_cmp4 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief tim_brk_cmp5 enable This bit enables the tim_brk_cmp5 for the timers tim_brk input. tim_brk_cmp5 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief tim_brk_cmp6 enable This bit enables the tim_brk_cmp6 for the timers tim_brk input. tim_brk_cmp6 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief tim_brk_cmp7 enable This bit enables the tim_brk_cmp7 for the timers tim_brk input. tim_brk_cmp7 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief tim_brk_cmp8 enable This bit enables the tim_brk_cmp8 for the timers tim_brk input. mdf_brkx output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief tim_ocref_clr source selection These bits select the tim_ocref_clr input source. Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for product specific implementation. Note: These bits can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t TIM17_DCR_DBSS_B_0x0 = 0;
        /** @brief Update */
