...
#ifndef EMBEDDED_PP_STM32H7S_TIM4_HPP
#define EMBEDDED_PP_STM32H7S_TIM4_HPP
...
namespace STM32H7S::TIM4 {
    ...
    constexpr std::uint16_t TIM4_CR1_CKD_B_0x3 = 3;
     ...
     *          - B_0x1: The tim_ti1_in[15:0], tim_ti2_in[15:0] and tim_ti3_in[15:0] multiplexers outputs are XORed and connected to the tim_ti1 input. See also Section 64.3.29: Interfacing with Hall sensors on page 3758. (value: 1)
     */
        /** @brief The tim_ti1_in[15:0] multiplexer output is to tim_ti1 input */
    constexpr std::uint32_t TIM4_CR2_TI1S_B_0x0 = 0;
        /** @brief The tim_ti1_in[15:0], tim_ti2_in[15:0] and tim_ti3_in[15:0] multiplexers outputs are XORed and connected to the tim_ti1 input. See also Section 64.3.29: Interfacing with Hall sensors on page 3758. */
    ...
    /** @brief OCREF clear selection This bit is used to select the OCREF clear source Note: If the OCREF clear selection feature is not supported, this bit is reserved and forced by hardware to 0. Section 65.3: TIM2/TIM3/TIM4/TIM5 implementation. */
    ...
    /** @details Possible values:
     *          - B_0x0: The transfer is triggered by the Timers Update event (value: 0)
     *          - B_0x1: The transfer is triggered by the Index event (value: 1)
     */
        /** @brief The transfer is triggered by the Timers Update event */
    ...
    /** @brief Value depends on IUFREMAP in TIMx_CR1. If UIFREMAP = 0 CNT[31]: Most significant bit of counter value If UIFREMAP = 1 UIFCPY: UIF Copy This bit is a read-only copy of the UIF bit of the TIMx_ISR register */
    ...
    constexpr std::uint32_t TIM4_ECR_IDIR_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t TIM4_ECR_IDIR_B_0x3 = 3;
    ...
    constexpr std::uint32_t TIM4_ECR_IBLK_B_0x2 = 2;
        /** @brief FIELD Reserved */
    constexpr std::uint32_t TIM4_ECR_IBLK_B_0x3 = 3;
    ...
    /** @brief Selects tim_ti1[15:0] input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation. */
    ...
    /** @brief Selects tim_ti2[15:0] input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation. */
    ...
    /** @brief Selects tim_ti3[15:0] input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation. */
    ...
    /** @brief Selects tim_ti4[15:0] input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation. */
    ...
    /** @brief etr_in source selection These bits select the etr_in input source. ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation. */
    ...
    /** @brief ocref_clr source selection These bits select the ocref_clr input source. ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation. */
     ...
     */
        /** @brief FIELD Reserved */
    constexpr std::uint32_t TIM4_DCR_DBSS_B_0x0 = 0;
        /** @brief Update */
