...
#ifndef EMBEDDED_PP_STM32H7S_TIM7_HPP
#define EMBEDDED_PP_STM32H7S_TIM7_HPP
...
namespace STM32H7S::TIM7 {
    ...
    /** @brief Prescaler value The counter clock frequency f<sub>tim_cnt_ck</sub> is equal to f<sub>tim_psc_ck</sub> / (PSC[15:0] + 1). PSC contains the value to be loaded into the active prescaler register at each update event. (including when the counter is cleared through UG bit of TIMx_EGR register. */
