...
#ifndef EMBEDDED_PP_STM32H7S_VREFBUF_HPP
#define EMBEDDED_PP_STM32H7S_VREFBUF_HPP
...
namespace STM32H7S::VREFBUF {
    ...
    /** @brief High impedance mode This bit controls the analog switch to connect or not the V<sub>REF+</sub> pin. Refer to Table 229: VREF buffer modes for the mode descriptions depending on ENVR bit configuration. */
