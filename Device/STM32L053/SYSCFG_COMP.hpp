...
#ifndef EMBEDDED_PP_STM32L053_SYSCFG_COMP_HPP
#define EMBEDDED_PP_STM32L053_SYSCFG_COMP_HPP
...
namespace STM32L053::SYSCFG_COMP {
    ...
    using COMP2_CSR_COMP2VALUE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
