...
#ifndef EMBEDDED_PP_STM32L053_TIM21_HPP
#define EMBEDDED_PP_STM32L053_TIM21_HPP
...
namespace STM32L053::TIM21 {
    ...
    /** @brief Timer21 ETR remap */
    using OR_ETR_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Timer21 TI1 */
    using OR_TI1_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Timer21 TI2 */
    using OR_TI2_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
