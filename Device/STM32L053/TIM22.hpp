...
#ifndef EMBEDDED_PP_STM32L053_TIM22_HPP
#define EMBEDDED_PP_STM32L053_TIM22_HPP
...
namespace STM32L053::TIM22 {
    ...
    /** @brief Timer22 ETR remap */
    using OR_ETR_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Timer22 TI1 */
    using OR_TI1_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
