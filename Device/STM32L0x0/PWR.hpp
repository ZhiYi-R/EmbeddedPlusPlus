...
#ifndef EMBEDDED_PP_STM32L0X0_PWR_HPP
#define EMBEDDED_PP_STM32L0X0_PWR_HPP
...
namespace STM32L0x0::PWR {
    ...
    /** @brief Regulator in Low-power deepsleep mode */
    ...
    /** @brief Internal voltage reference (VREFINT) ready flag */
