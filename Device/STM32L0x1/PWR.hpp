...
#ifndef EMBEDDED_PP_STM32L0X1_PWR_HPP
#define EMBEDDED_PP_STM32L0X1_PWR_HPP
...
namespace STM32L0x1::PWR {
    ...
    /** @brief Regulator in Low-power deepsleep mode This bit allows switching the regulator to low-power mode when the CPU enters Stop mode. Its behavior depends on LPSDSR bit */
    using CR_LPDS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
