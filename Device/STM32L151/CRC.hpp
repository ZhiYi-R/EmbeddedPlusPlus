...
#ifndef EMBEDDED_PP_STM32L151_CRC_HPP
#define EMBEDDED_PP_STM32L151_CRC_HPP
...
namespace STM32L151::CRC {

    /** @brief Data register */
    using DR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Data Register */
    using DR_Data_register = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Independent data register */
    using IDR_Independent_data_register = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
