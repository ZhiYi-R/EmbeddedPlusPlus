...
#ifndef EMBEDDED_PP_STM32L151_TIM11_HPP
#define EMBEDDED_PP_STM32L151_TIM11_HPP
...
namespace STM32L151::TIM11 {
    ...
    /** @brief TIM11 Input 1 remapping capability */
    using OR_TI1_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Timer11 ETR remap */
    using OR_ETR_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Timer11 Input 1 remap for Routing Interface (RI) */
    using OR_TI1_RMP_RI = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
