...
#ifndef EMBEDDED_PP_STM32L151_TIM9_HPP
#define EMBEDDED_PP_STM32L151_TIM9_HPP
...
namespace STM32L151::TIM9 {
    ...
    using CR1_OMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CCMR1_Output_CC2S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief TIM9 Input 1 remapping capability */
