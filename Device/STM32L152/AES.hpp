...
#ifndef EMBEDDED_PP_STM32L152_AES_HPP
#define EMBEDDED_PP_STM32L152_AES_HPP
...
namespace STM32L152::AES {
    ...
    /** @brief AES key */
    using KEYR0_KEYR0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
