...
#ifndef EMBEDDED_PP_STM32L162_SDIO_HPP
#define EMBEDDED_PP_STM32L162_SDIO_HPP
...
namespace STM32L162::SDIO {
    ...
    /** @brief Data transfer enabled bit */
    ...
    /** @brief FIF0Data */
    using FIFO_FIF0Data = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
