...
#ifndef EMBEDDED_PP_STM32L162_SYSCFG_HPP
#define EMBEDDED_PP_STM32L162_SYSCFG_HPP
...
namespace STM32L162::SYSCFG {
    ...
    /** @brief MEM_MODE */
    using MEMRMP_MEM_MODE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief BOOT_MODE */
    using MEMRMP_BOOT_MODE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief USB pull-up */
    using PMC_USB_PU = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief decoupling capacitance connection */
    using PMC_LCD_CAPA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
