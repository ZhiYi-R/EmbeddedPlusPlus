...
#ifndef EMBEDDED_PP_STM32L162_TIM2_HPP
#define EMBEDDED_PP_STM32L162_TIM2_HPP
...
namespace STM32L162::TIM2 {
    ...
    using CCMR2_Output_CC4S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Capture/Compare 1 value */
    using CCR3_CCR1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief capture/compare register 1 */
