...
#ifndef EMBEDDED_PP_STM32L412_PWR_HPP
#define EMBEDDED_PP_STM32L412_PWR_HPP
...
namespace STM32L412::PWR {
    ...
    /** @brief Enable ULP sampling of BOR and PVD */
    using CR3_ENULP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief External SMPS On */
    using CR4_EXT_SMPS_ON = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief External SMPS Ready */
    using SR1_EXT_SMPS_RDY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Standby flag */
