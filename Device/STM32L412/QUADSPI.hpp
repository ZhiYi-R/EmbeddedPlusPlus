...
#ifndef EMBEDDED_PP_STM32L412_QUADSPI_HPP
#define EMBEDDED_PP_STM32L412_QUADSPI_HPP
...
namespace STM32L412::QUADSPI {
    ...
    using CR_FTHRES = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Sample shift */
    ...
    /** @brief FIFO level */
    using SR_FLEVEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Busy */
