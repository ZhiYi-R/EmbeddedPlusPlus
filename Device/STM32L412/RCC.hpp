...
#ifndef EMBEDDED_PP_STM32L412_RCC_HPP
#define EMBEDDED_PP_STM32L412_RCC_HPP
...
namespace STM32L412::RCC {
    ...
    using CCIPR2_I2C4SEL_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief I2C4 clock source selection */
    using CCIPR2_I2C4SEL_0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
