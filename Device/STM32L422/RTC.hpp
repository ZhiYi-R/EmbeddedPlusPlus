...
#ifndef EMBEDDED_PP_STM32L422_RTC_HPP
#define EMBEDDED_PP_STM32L422_RTC_HPP
...
namespace STM32L422::RTC {
    ...
    using CALR_LPCAL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
