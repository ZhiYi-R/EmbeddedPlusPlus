...
#ifndef EMBEDDED_PP_STM32L422_TIM2_HPP
#define EMBEDDED_PP_STM32L422_TIM2_HPP
...
namespace STM32L422::TIM2 {
    ...
    /** @brief Most significant part counter value */
    using CNT_CNT_M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 15, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CNT_CNT_31 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief prescaler */
    ...
    using OR1_ETR1_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Input Capture 4 remap */
    using OR1_TI4_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Internal trigger 1 remap */
    using OR1_ITR1_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
