...
#ifndef EMBEDDED_PP_STM32L433_OPAMP_HPP
#define EMBEDDED_PP_STM32L433_OPAMP_HPP
...
namespace STM32L433::OPAMP {
    ...
    /** @brief allows to switch from factory AOP offset trimmed values to AOP offset user trimmed values */
