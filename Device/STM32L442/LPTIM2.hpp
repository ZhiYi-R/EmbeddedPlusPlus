...
#ifndef EMBEDDED_PP_STM32L442_LPTIM2_HPP
#define EMBEDDED_PP_STM32L442_LPTIM2_HPP
...
namespace STM32L442::LPTIM2 {
    ...
    /** @brief REPOKIE */
    using IER_REPOKIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief UEIE */
    using IER_UEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Option register bit 0 */
    using OR_OR_0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Option register bit 1 */
    using OR_OR_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
