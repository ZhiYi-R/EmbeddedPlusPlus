...
#ifndef EMBEDDED_PP_STM32L451_FLASH_HPP
#define EMBEDDED_PP_STM32L451_FLASH_HPP
...
namespace STM32L451::FLASH {
    ...
    /** @brief ECC fail bank */
    using ECCR_BK_ECC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Dual-Bank on 512 KB or 256 KB Flash memory devices */
    ...
    using PCROP1SR_PCROP1_STRT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using PCROP1ER_PCROP1_END = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Bank 1 WRP first area tart offset */
    ...
    /** @brief Bank 2 PCROP area start offset */
    using PCROP2SR_PCROP2_STRT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using PCROP2ER_PCROP2_END = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
