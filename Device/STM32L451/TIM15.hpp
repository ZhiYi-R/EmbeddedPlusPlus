...
#ifndef EMBEDDED_PP_STM32L451_TIM15_HPP
#define EMBEDDED_PP_STM32L451_TIM15_HPP
...
namespace STM32L451::TIM15 {
    ...
    using OR1_TI1_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Encoder mode */
    using OR1_ENCODER_MODE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief BRK DFSDM_BREAK[0] enablee */
