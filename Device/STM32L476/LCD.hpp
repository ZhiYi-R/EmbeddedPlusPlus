...
#ifndef EMBEDDED_PP_STM32L476_LCD_HPP
#define EMBEDDED_PP_STM32L476_LCD_HPP
...
namespace STM32L476::LCD {
    ...
    /** @brief Mux segment enable This bit is used to enable SEG pin remapping. Four SEG pins can be multiplexed with SEG[31:28] or SEG[15:12]. See Sectionm19.3.7. */
     ...
     *          - B_0x1: Permanent high drive enabled. When HD=1, then the PON bits have to be programmed tom001. (value: 1)
     */
        /** @brief Permanent high drive disabled */
    constexpr std::uint32_t LCD_FCR_HD_B_0x0 = 0;
        /** @brief Permanent high drive enabled. When HD=1, then the PON bits have to be programmed tom001. */
    ...
    /** @details Possible values:
     *          - B_0x0: 0 ms (value: 0)
     *          - B_0x1: 244 ms (value: 1)
     *          - B_0x2: 488 ms (value: 2)
     *          - B_0x3: 782 ms (value: 3)
