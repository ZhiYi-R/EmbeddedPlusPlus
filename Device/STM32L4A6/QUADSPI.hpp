...
#ifndef EMBEDDED_PP_STM32L4A6_QUADSPI_HPP
#define EMBEDDED_PP_STM32L4A6_QUADSPI_HPP
...
namespace STM32L4A6::QUADSPI {
    ...
    /** @brief FIFO level */
    using SR_FLEVEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Busy */
