...
#ifndef EMBEDDED_PP_STM32L4P5_LPUART1_HPP
#define EMBEDDED_PP_STM32L4P5_LPUART1_HPP
...
namespace STM32L4P5::LPUART1 {
    ...
    constexpr std::uint32_t LPUART_ISR_TC_B_0x0 = 0;
        /** @brief Transmission is complete */
    constexpr std::uint32_t LPUART_ISR_TC_B_0x1 = 1;
    ...
    /** @brief Parity error This bit is set by hardware when a parity error occurs in receiver mode. It is cleared by software, writing 1 to the PECF in the LPUART_ICR register. An interrupt is generated if PEIE = 1 in the LPUART_CR1 register. */
     ...
     */
        /** @brief No overrun error */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE_ORE_B_0x0 = 0;
        /** @brief Overrun error is detected */
    ...
    /** @brief Wakeup from low-power mode clear flag Writing 1 to this bit clears the WUF flag in the LPUART_ISR register. Note: If the LPUART does not support the wakeup from Stop feature, this bit is reserved and kept at reset value. Refer to Section 33.4: USART implementation. */
    ...
    /** @brief Receive data value Contains the received data character. The RDR register provides the parallel interface between the input shift register and the internal bus (see Figure 347). When receiving with the parity enabled, the value read in the MSB bit is the received parity bit. */
