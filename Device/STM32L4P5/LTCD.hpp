...
#ifndef EMBEDDED_PP_STM32L4P5_LTCD_HPP
#define EMBEDDED_PP_STM32L4P5_LTCD_HPP
...
namespace STM32L4P5::LTCD {
    ...
    /** @brief LTDC Layer Blending Factors Configuration Register */
    using L2BFCR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x124, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Blending Factor 2 */
