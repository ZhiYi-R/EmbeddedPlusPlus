...
#ifndef EMBEDDED_PP_STM32L4P5_RTC_HPP
#define EMBEDDED_PP_STM32L4P5_RTC_HPP
...
namespace STM32L4P5::RTC {
    ...
    using CR_WCKSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Reference clock detection enable (50 or 60 Hz) */
    ...
    /** @brief Clear synchronous counter on alarm */
    ...
    /** @brief ALRMF */
    using MISR_ALRMF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ALRBMF */
