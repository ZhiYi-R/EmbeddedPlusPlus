...
#ifndef EMBEDDED_PP_STM32L4Q5_ADC_HPP
#define EMBEDDED_PP_STM32L4Q5_ADC_HPP
...
namespace STM32L4Q5::ADC {
    ...
    /** @brief EXTSEL3 */
    using CFGR_EXTSEL3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief EXTSEL2 */
    using CFGR_EXTSEL2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief EXTSEL1 */
    using CFGR_EXTSEL1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief EXTSEL0 */
    using CFGR_EXTSEL0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ALIGN */
    ...
    /** @brief DFSDM mode configuration */
    using CFGR_DFSDMCFG = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DMACFG */
    ...
    /** @brief Differential mode for channels 18 to 16 */
