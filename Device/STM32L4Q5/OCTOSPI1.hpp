...
#ifndef EMBEDDED_PP_STM32L4Q5_OCTOSPI1_HPP
#define EMBEDDED_PP_STM32L4Q5_OCTOSPI1_HPP
...
namespace STM32L4Q5::OCTOSPI1 {
    ...
    using DCR1_CSHT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Device size */
    using DCR1_DEVSIZE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Memory type */
    using DCR1_MTYP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Send instruction only once mode */
    using WCCR_SIOO = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief AXI interface */
    using HWCFGR_AXI = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FIFO depth */
    using HWCFGR_FIFO = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Prescaler */
    using HWCFGR_PRES = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ID Length */
    using HWCFGR_IDL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Memory map write */
    using HWCFGR_MMW = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Master */
    using HWCFGR_MST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief version register */
    using VER = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x3F4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Version */
    using VER_VER = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief identification */
    using ID = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x3F8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Identification */
    using ID_ID = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief magic ID */
    using MID = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x3FC, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Magic ID */
    using MID_MID = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
