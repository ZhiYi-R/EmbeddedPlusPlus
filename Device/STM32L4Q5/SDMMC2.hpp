...
#ifndef EMBEDDED_PP_STM32L4Q5_SDMMC2_HPP
#define EMBEDDED_PP_STM32L4Q5_SDMMC2_HPP
...
namespace STM32L4Q5::SDMMC2 {
    ...
    /** @brief Bus speed mode selection between DS, HS, SDR12, SDR25 and SDR50,DDR50 */
    ...
    /** @brief Double buffer mode active buffer indication */
    ...
    /** @brief Buffer 0 memory base address bits [31:2], shall be word aligned (bit [1:0] are always 0 and read only) */
    ...
    /** @brief Buffer 1 memory base address, shall be word aligned (bit [1:0] are always 0 and read only) */
