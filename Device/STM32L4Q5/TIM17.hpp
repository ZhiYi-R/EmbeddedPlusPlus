...
#ifndef EMBEDDED_PP_STM32L4Q5_TIM17_HPP
#define EMBEDDED_PP_STM32L4Q5_TIM17_HPP
...
namespace STM32L4Q5::TIM17 {
    ...
    /** @brief TIM17 capture/compare mode register 1 */
    using TIM17_CCMR1_ALTERNATE = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x18, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Others: Reserved Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIMx_CCER). */
    using TIM17_CCMR1_ALTERNATE_CC1S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC1 channel is configured as output (value: 0)
     *          - B_0x1: CC1 channel is configured as input, IC1 is mapped on TI1 (value: 1)
     */
        /** @brief CC1 channel is configured as output */
    constexpr std::uint32_t TIM17_CCMR1_ALTERNATE_CC1S_B_0x0 = 0;
        /** @brief CC1 channel is configured as input, IC1 is mapped on TI1 */
    constexpr std::uint32_t TIM17_CCMR1_ALTERNATE_CC1S_B_0x1 = 1;
    ...
    using TIM17_CCMR1_ALTERNATE_OC1FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_CCMR1_ALTERNATE_OC1FE_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM17_CCMR1_ALTERNATE_OC1FE_B_0x1 = 1;
    ...
    using TIM17_CCMR1_ALTERNATE_OC1PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_CCMR1_ALTERNATE_OC1PE_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM17_CCMR1_ALTERNATE_OC1PE_B_0x1 = 1;
    ...
    using TIM17_CCMR1_ALTERNATE_OC1M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_CCMR1_ALTERNATE_OC1M_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM17_CCMR1_ALTERNATE_OC1M_B_0x1 = 1;
    ...
    constexpr std::uint32_t TIM17_CCMR1_ALTERNATE_OC1M_B_0x2 = 2;
        /** @brief Toggle - OC1REF toggles when TIMx_CNT=TIMx_CCR1. */
    constexpr std::uint32_t TIM17_CCMR1_ALTERNATE_OC1M_B_0x3 = 3;
        /** @brief Force inactive level - OC1REF is forced low. */
    constexpr std::uint32_t TIM17_CCMR1_ALTERNATE_OC1M_B_0x4 = 4;
        /** @brief Force active level - OC1REF is forced high. */
    constexpr std::uint32_t TIM17_CCMR1_ALTERNATE_OC1M_B_0x5 = 5;
        /** @brief PWM mode 1 - Channel 1 is active as long as TIMx_CNT<TIMx_CCR1 else inactive. */
    constexpr std::uint32_t TIM17_CCMR1_ALTERNATE_OC1M_B_0x6 = 6;
        /** @brief PWM mode 2 - Channel 1 is inactive as long as TIMx_CNT<TIMx_CCR1 else active. */
    constexpr std::uint32_t TIM17_CCMR1_ALTERNATE_OC1M_B_0x7 = 7;

    /** @brief OC1M[3] */
    using TIM17_CCMR1_ALTERNATE_OC1M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Capture/Compare 1 output enable When CC1 channel is configured as output, the OC1 level depends on MOE, OSSI, OSSR, OIS1, OIS1N and CC1NE bits, regardless of the CC1E bits state. Refer to Table 186 for details. */
    ...
    /** @brief TIM17 option register 2 */
    using TIM17_OR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x60, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM17_OR2_BKINE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: BKIN input disabled (value: 0)
     *          - B_0x1: BKIN input enabled (value: 1)
     */
        /** @brief BKIN input disabled */
    constexpr std::uint32_t TIM17_OR2_BKINE_B_0x0 = 0;
        /** @brief BKIN input enabled */
    constexpr std::uint32_t TIM17_OR2_BKINE_B_0x1 = 1;
    ...
    using TIM17_OR2_BKCMP1E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COMP1 input disabled (value: 0)
     *          - B_0x1: COMP1 input enabled (value: 1)
     */
        /** @brief COMP1 input disabled */
    constexpr std::uint32_t TIM17_OR2_BKCMP1E_B_0x0 = 0;
        /** @brief COMP1 input enabled */
    constexpr std::uint32_t TIM17_OR2_BKCMP1E_B_0x1 = 1;
    ...
    using TIM17_OR2_BKCMP2E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COMP2 input disabled (value: 0)
     *          - B_0x1: COMP2 input enabled (value: 1)
     */
        /** @brief COMP2 input disabled */
    constexpr std::uint32_t TIM17_OR2_BKCMP2E_B_0x0 = 0;
        /** @brief COMP2 input enabled */
    constexpr std::uint32_t TIM17_OR2_BKCMP2E_B_0x1 = 1;
    ...
    using TIM17_OR2_BKDF1BK2E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: dfsdm1_break[2] input disabled (value: 0)
     *          - B_0x1: dfsdm1_break[2] input enabled (value: 1)
     */
        /** @brief dfsdm1_break[2] input disabled */
    constexpr std::uint32_t TIM17_OR2_BKDF1BK2E_B_0x0 = 0;
        /** @brief dfsdm1_break[2] input enabled */
    constexpr std::uint32_t TIM17_OR2_BKDF1BK2E_B_0x1 = 1;
    ...
    using TIM17_OR2_BKINP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: BKIN input is active low (value: 0)
     *          - B_0x1: BKIN input is active high (value: 1)
     */
        /** @brief BKIN input is active low */
    constexpr std::uint32_t TIM17_OR2_BKINP_B_0x0 = 0;
        /** @brief BKIN input is active high */
    constexpr std::uint32_t TIM17_OR2_BKINP_B_0x1 = 1;
    ...
    using TIM17_OR2_BKCMP1P = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COMP1 input is active low (value: 0)
     *          - B_0x1: COMP1 input is active high (value: 1)
     */
        /** @brief COMP1 input is active low */
    constexpr std::uint32_t TIM17_OR2_BKCMP1P_B_0x0 = 0;
        /** @brief COMP1 input is active high */
    constexpr std::uint32_t TIM17_OR2_BKCMP1P_B_0x1 = 1;
    ...
    using TIM17_OR2_BKCMP2P = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COMP2 input is active low (value: 0)
     *          - B_0x1: COMP2 input is active high (value: 1)
     */
        /** @brief COMP2 input is active low */
    constexpr std::uint32_t TIM17_OR2_BKCMP2P_B_0x0 = 0;
        /** @brief COMP2 input is active high */
    constexpr std::uint32_t TIM17_OR2_BKCMP2P_B_0x1 = 1;
