...
#ifndef EMBEDDED_PP_STM32L4R5_TIM8_HPP
#define EMBEDDED_PP_STM32L4R5_TIM8_HPP
...
namespace STM32L4R5::TIM8 {
    ...
    /** @brief Center-aligned mode selection Note: Switch from edge-aligned mode to center-aligned mode as long as the counter is enabled (CEN=1) is not allowed */
    ...
    /** @brief Clock division This bit-field indicates the division ratio between the timer clock (CK_INT) frequency and the dead-time and sampling clock (t<sub>DTS</sub>)used by the dead-time generators and the digital filters (ETR, TIx): Note: t<sub>DTS</sub> = 1/f<sub>DTS</sub>, t<sub>CK_INT</sub> = 1/f<sub>CK_INT</sub>. */
    ...
    /** @brief Master mode selection These bits allow selected information to be sent in master mode to slave timers for synchronization (TRGO). The combination is as follows: Note: The clock of the slave timer or ADC must be enabled prior to receive events from the master timer, and must not be changed on-the-fly while triggers are received from the master timer. */
     ...
     *          - B_0x1: The TIMx_CH1, CH2 and CH3 pins are connected to the TI1 input (XOR combination) (value: 1)
     */
        /** @brief The TIMx_CH1 pin is connected to TI1 input */
    constexpr std::uint32_t TIM8_CR2_TI1S_B_0x0 = 0;
        /** @brief The TIMx_CH1, CH2 and CH3 pins are connected to the TI1 input (XOR combination) */
    ...
    /** @brief Output Idle state 2 (OC2 output) Refer to OIS1 bit */
    using TIM8_CR2_OIS2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output Idle state 2 (OC2N output) Refer to OIS1N bit */
    using TIM8_CR2_OIS2N = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output Idle state 3 (OC3 output) Refer to OIS1 bit */
    using TIM8_CR2_OIS3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output Idle state 3 (OC3N output) Refer to OIS1N bit */
    using TIM8_CR2_OIS3N = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output Idle state 4 (OC4 output) Refer to OIS1 bit */
    using TIM8_CR2_OIS4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output Idle state 5 (OC5 output) Refer to OIS1 bit */
    using TIM8_CR2_OIS5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output Idle state 6 (OC6 output) Refer to OIS1 bit */
    using TIM8_CR2_OIS6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Master mode selection 2 These bits allow the information to be sent to ADC for synchronization (TRGO2) to be selected. The combination is as follows: Note: The clock of the slave timer or ADC must be enabled prior to receive events from the master timer, and must not be changed on-the-fly while triggers are received from the master timer. */
    using TIM8_CR2_MMS2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Reset - the UG bit from the TIMx_EGR register is used as trigger output (TRGO2). If the reset is generated by the trigger input (slave mode controller configured in reset mode), the signal on TRGO2 is delayed compared to the actual reset. (value: 0)
     *          - B_0x1: Enable - the Counter Enable signal CNT_EN is used as trigger output (TRGO2). It is useful to start several timers at the same time or to control a window in which a slave timer is enabled. The Counter Enable signal is generated by a logic AND between the CEN control bit and the trigger input when configured in Gated mode. When the Counter Enable signal is controlled by the trigger input, there is a delay on TRGO2, except if the Master/Slave mode is selected (see the MSM bit description in TIMx_SMCR register). (value: 1)
     *          - B_0x2: Update - the update event is selected as trigger output (TRGO2). For instance, a master timer can then be used as a prescaler for a slave timer. (value: 2)
     *          - B_0x3: Compare pulse - the trigger output sends a positive pulse when the CC1IF flag is to be set (even if it was already high), as soon as a capture or compare match occurs (TRGO2). (value: 3)
     *          - B_0x4: Compare - OC1REFC signal is used as trigger output (TRGO2) (value: 4)
     *          - B_0x5: Compare - OC2REFC signal is used as trigger output (TRGO2) (value: 5)
     *          - B_0x6: Compare - OC3REFC signal is used as trigger output (TRGO2) (value: 6)
     *          - B_0x7: Compare - OC4REFC signal is used as trigger output (TRGO2) (value: 7)
     *          - B_0x8: Compare - OC5REFC signal is used as trigger output (TRGO2) (value: 8)
     *          - B_0x9: Compare - OC6REFC signal is used as trigger output (TRGO2) (value: 9)
     *          - B_0xA: Compare Pulse - OC4REFC rising or falling edges generate pulses on TRGO2 (value: 10)
     *          - B_0xB: Compare Pulse - OC6REFC rising or falling edges generate pulses on TRGO2 (value: 11)
     *          - B_0xC: Compare Pulse - OC4REFC or OC6REFC rising edges generate pulses on TRGO2 (value: 12)
     *          - B_0xD: Compare Pulse - OC4REFC rising or OC6REFC falling edges generate pulses on TRGO2 (value: 13)
     *          - B_0xE: Compare Pulse - OC5REFC or OC6REFC rising edges generate pulses on TRGO2 (value: 14)
     *          - B_0xF: Compare Pulse - OC5REFC rising or OC6REFC falling edges generate pulses on TRGO2 (value: 15)
     */
        /** @brief Reset - the UG bit from the TIMx_EGR register is used as trigger output (TRGO2). If the reset is generated by the trigger input (slave mode controller configured in reset mode), the signal on TRGO2 is delayed compared to the actual reset. */
    constexpr std::uint32_t TIM8_CR2_MMS2_B_0x0 = 0;
        /** @brief Enable - the Counter Enable signal CNT_EN is used as trigger output (TRGO2). It is useful to start several timers at the same time or to control a window in which a slave timer is enabled. The Counter Enable signal is generated by a logic AND between the CEN control bit and the trigger input when configured in Gated mode. When the Counter Enable signal is controlled by the trigger input, there is a delay on TRGO2, except if the Master/Slave mode is selected (see the MSM bit description in TIMx_SMCR register). */
    constexpr std::uint32_t TIM8_CR2_MMS2_B_0x1 = 1;
        /** @brief Update - the update event is selected as trigger output (TRGO2). For instance, a master timer can then be used as a prescaler for a slave timer. */
    constexpr std::uint32_t TIM8_CR2_MMS2_B_0x2 = 2;
        /** @brief Compare pulse - the trigger output sends a positive pulse when the CC1IF flag is to be set (even if it was already high), as soon as a capture or compare match occurs (TRGO2). */
    constexpr std::uint32_t TIM8_CR2_MMS2_B_0x3 = 3;
        /** @brief Compare - OC1REFC signal is used as trigger output (TRGO2) */
    constexpr std::uint32_t TIM8_CR2_MMS2_B_0x4 = 4;
        /** @brief Compare - OC2REFC signal is used as trigger output (TRGO2) */
    constexpr std::uint32_t TIM8_CR2_MMS2_B_0x5 = 5;
        /** @brief Compare - OC3REFC signal is used as trigger output (TRGO2) */
    constexpr std::uint32_t TIM8_CR2_MMS2_B_0x6 = 6;
        /** @brief Compare - OC4REFC signal is used as trigger output (TRGO2) */
    constexpr std::uint32_t TIM8_CR2_MMS2_B_0x7 = 7;
        /** @brief Compare - OC5REFC signal is used as trigger output (TRGO2) */
    constexpr std::uint32_t TIM8_CR2_MMS2_B_0x8 = 8;
        /** @brief Compare - OC6REFC signal is used as trigger output (TRGO2) */
    constexpr std::uint32_t TIM8_CR2_MMS2_B_0x9 = 9;
        /** @brief Compare Pulse - OC4REFC rising or falling edges generate pulses on TRGO2 */
    constexpr std::uint32_t TIM8_CR2_MMS2_B_0xA = 10;
        /** @brief Compare Pulse - OC6REFC rising or falling edges generate pulses on TRGO2 */
    constexpr std::uint32_t TIM8_CR2_MMS2_B_0xB = 11;
        /** @brief Compare Pulse - OC4REFC or OC6REFC rising edges generate pulses on TRGO2 */
    constexpr std::uint32_t TIM8_CR2_MMS2_B_0xC = 12;
        /** @brief Compare Pulse - OC4REFC rising or OC6REFC falling edges generate pulses on TRGO2 */
    constexpr std::uint32_t TIM8_CR2_MMS2_B_0xD = 13;
        /** @brief Compare Pulse - OC5REFC or OC6REFC rising edges generate pulses on TRGO2 */
    constexpr std::uint32_t TIM8_CR2_MMS2_B_0xE = 14;
        /** @brief Compare Pulse - OC5REFC rising or OC6REFC falling edges generate pulses on TRGO2 */
    ...
    /** @brief External trigger prescaler External trigger signal ETRP frequency must be at most 1/4 of f<sub>CK_INT</sub> frequency. A prescaler can be enabled to reduce ETRP frequency. It is useful when inputting fast external clocks. */
    ...
    using TIM8_DIER = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0xC, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Update interrupt enable */
    using TIM8_DIER_UIE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Update interrupt disabled (value: 0)
     *          - B_0x1: Update interrupt enabled (value: 1)
     */
        /** @brief Update interrupt disabled */
    constexpr std::uint16_t TIM8_DIER_UIE_B_0x0 = 0;
        /** @brief Update interrupt enabled */
    constexpr std::uint16_t TIM8_DIER_UIE_B_0x1 = 1;

    /** @brief Capture/Compare 1 interrupt enable */
    using TIM8_DIER_CC1IE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC1 interrupt disabled (value: 0)
     *          - B_0x1: CC1 interrupt enabled (value: 1)
     */
        /** @brief CC1 interrupt disabled */
    constexpr std::uint16_t TIM8_DIER_CC1IE_B_0x0 = 0;
        /** @brief CC1 interrupt enabled */
    constexpr std::uint16_t TIM8_DIER_CC1IE_B_0x1 = 1;

    /** @brief Capture/Compare 2 interrupt enable */
    using TIM8_DIER_CC2IE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC2 interrupt disabled (value: 0)
     *          - B_0x1: CC2 interrupt enabled (value: 1)
     */
        /** @brief CC2 interrupt disabled */
    constexpr std::uint16_t TIM8_DIER_CC2IE_B_0x0 = 0;
        /** @brief CC2 interrupt enabled */
    constexpr std::uint16_t TIM8_DIER_CC2IE_B_0x1 = 1;

    /** @brief Capture/Compare 3 interrupt enable */
    using TIM8_DIER_CC3IE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC3 interrupt disabled (value: 0)
     *          - B_0x1: CC3 interrupt enabled (value: 1)
     */
        /** @brief CC3 interrupt disabled */
    constexpr std::uint16_t TIM8_DIER_CC3IE_B_0x0 = 0;
        /** @brief CC3 interrupt enabled */
    constexpr std::uint16_t TIM8_DIER_CC3IE_B_0x1 = 1;

    /** @brief Capture/Compare 4 interrupt enable */
    using TIM8_DIER_CC4IE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC4 interrupt disabled (value: 0)
     *          - B_0x1: CC4 interrupt enabled (value: 1)
     */
        /** @brief CC4 interrupt disabled */
    constexpr std::uint16_t TIM8_DIER_CC4IE_B_0x0 = 0;
        /** @brief CC4 interrupt enabled */
    constexpr std::uint16_t TIM8_DIER_CC4IE_B_0x1 = 1;

    /** @brief COM interrupt enable */
    using TIM8_DIER_COMIE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COM interrupt disabled (value: 0)
     *          - B_0x1: COM interrupt enabled (value: 1)
     */
        /** @brief COM interrupt disabled */
    constexpr std::uint16_t TIM8_DIER_COMIE_B_0x0 = 0;
        /** @brief COM interrupt enabled */
    constexpr std::uint16_t TIM8_DIER_COMIE_B_0x1 = 1;

    /** @brief Trigger interrupt enable */
    using TIM8_DIER_TIE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Trigger interrupt disabled (value: 0)
     *          - B_0x1: Trigger interrupt enabled (value: 1)
     */
        /** @brief Trigger interrupt disabled */
    constexpr std::uint16_t TIM8_DIER_TIE_B_0x0 = 0;
        /** @brief Trigger interrupt enabled */
    constexpr std::uint16_t TIM8_DIER_TIE_B_0x1 = 1;

    /** @brief Break interrupt enable */
    using TIM8_DIER_BIE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Break interrupt disabled (value: 0)
     *          - B_0x1: Break interrupt enabled (value: 1)
     */
        /** @brief Break interrupt disabled */
    constexpr std::uint16_t TIM8_DIER_BIE_B_0x0 = 0;
        /** @brief Break interrupt enabled */
    constexpr std::uint16_t TIM8_DIER_BIE_B_0x1 = 1;

    /** @brief Update DMA request enable */
    using TIM8_DIER_UDE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Update DMA request disabled (value: 0)
     *          - B_0x1: Update DMA request enabled (value: 1)
     */
        /** @brief Update DMA request disabled */
    constexpr std::uint16_t TIM8_DIER_UDE_B_0x0 = 0;
        /** @brief Update DMA request enabled */
    constexpr std::uint16_t TIM8_DIER_UDE_B_0x1 = 1;

    /** @brief Capture/Compare 1 DMA request enable */
    using TIM8_DIER_CC1DE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC1 DMA request disabled (value: 0)
     *          - B_0x1: CC1 DMA request enabled (value: 1)
     */
        /** @brief CC1 DMA request disabled */
    constexpr std::uint16_t TIM8_DIER_CC1DE_B_0x0 = 0;
        /** @brief CC1 DMA request enabled */
    constexpr std::uint16_t TIM8_DIER_CC1DE_B_0x1 = 1;

    /** @brief Capture/Compare 2 DMA request enable */
    using TIM8_DIER_CC2DE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC2 DMA request disabled (value: 0)
     *          - B_0x1: CC2 DMA request enabled (value: 1)
     */
        /** @brief CC2 DMA request disabled */
    constexpr std::uint16_t TIM8_DIER_CC2DE_B_0x0 = 0;
        /** @brief CC2 DMA request enabled */
    constexpr std::uint16_t TIM8_DIER_CC2DE_B_0x1 = 1;

    /** @brief Capture/Compare 3 DMA request enable */
    using TIM8_DIER_CC3DE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC3 DMA request disabled (value: 0)
     *          - B_0x1: CC3 DMA request enabled (value: 1)
     */
        /** @brief CC3 DMA request disabled */
    constexpr std::uint16_t TIM8_DIER_CC3DE_B_0x0 = 0;
        /** @brief CC3 DMA request enabled */
    constexpr std::uint16_t TIM8_DIER_CC3DE_B_0x1 = 1;

    /** @brief Capture/Compare 4 DMA request enable */
    using TIM8_DIER_CC4DE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC4 DMA request disabled (value: 0)
     *          - B_0x1: CC4 DMA request enabled (value: 1)
     */
        /** @brief CC4 DMA request disabled */
    constexpr std::uint16_t TIM8_DIER_CC4DE_B_0x0 = 0;
        /** @brief CC4 DMA request enabled */
    constexpr std::uint16_t TIM8_DIER_CC4DE_B_0x1 = 1;

    /** @brief COM DMA request enable */
    using TIM8_DIER_COMDE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COM DMA request disabled (value: 0)
     *          - B_0x1: COM DMA request enabled (value: 1)
     */
        /** @brief COM DMA request disabled */
    constexpr std::uint16_t TIM8_DIER_COMDE_B_0x0 = 0;
        /** @brief COM DMA request enabled */
    constexpr std::uint16_t TIM8_DIER_COMDE_B_0x1 = 1;

    /** @brief Trigger DMA request enable */
    using TIM8_DIER_TDE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Trigger DMA request disabled (value: 0)
     *          - B_0x1: Trigger DMA request enabled (value: 1)
     */
        /** @brief Trigger DMA request disabled */
    constexpr std::uint16_t TIM8_DIER_TDE_B_0x0 = 0;
        /** @brief Trigger DMA request enabled */
    constexpr std::uint16_t TIM8_DIER_TDE_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: No action (value: 0)
     *          - B_0x1: When CCPC bit is set, it allows CCxE, CCxNE and OCxM bits to be updated. (value: 1)
     */
        /** @brief No action */
    constexpr std::uint16_t TIM8_EGR_COMG_B_0x0 = 0;
        /** @brief When CCPC bit is set, it allows CCxE, CCxNE and OCxM bits to be updated. */
    ...
    /** @brief Input capture 2 prescaler Refer to IC1PSC[1:0] description. */
    using TIM8_CCMR1_IC2PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Input capture 2 filter Refer to IC1F[3:0] description. */
    using TIM8_CCMR1_IC2F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM8 capture/compare mode register 1 */
    using TIM8_CCMR1_ALTERNATE = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x18, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIMx_CCER). */
    using TIM8_CCMR1_ALTERNATE_CC1S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC1 channel is configured as output (value: 0)
     *          - B_0x1: CC1 channel is configured as input, IC1 is mapped on TI1 (value: 1)
     *          - B_0x2: CC1 channel is configured as input, IC1 is mapped on TI2 (value: 2)
     ...
     */
        /** @brief CC1 channel is configured as output */
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_CC1S_B_0x0 = 0;
        /** @brief CC1 channel is configured as input, IC1 is mapped on TI1 */
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_CC1S_B_0x1 = 1;
        /** @brief CC1 channel is configured as input, IC1 is mapped on TI2 */
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_CC1S_B_0x2 = 2;
        /** @brief CC1 channel is configured as input, IC1 is mapped on TRC. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register) */
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_CC1S_B_0x3 = 3;
    ...
    using TIM8_CCMR1_ALTERNATE_OC1FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_OC1FE_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_OC1FE_B_0x1 = 1;
    ...
    using TIM8_CCMR1_ALTERNATE_OC1PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_OC1PE_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_OC1PE_B_0x1 = 1;
    ...
    using TIM8_CCMR1_ALTERNATE_OC1M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_OC1M_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_OC1M_B_0x1 = 1;
    ...
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_OC1M_B_0x2 = 2;
        /** @brief Toggle - OC1REF toggles when TIMx_CNT=TIMx_CCR1. */
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_OC1M_B_0x3 = 3;
        /** @brief Force inactive level - OC1REF is forced low. */
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_OC1M_B_0x4 = 4;
        /** @brief Force active level - OC1REF is forced high. */
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_OC1M_B_0x5 = 5;
    ...
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_OC1M_B_0x6 = 6;
    ...
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_OC1M_B_0x7 = 7;

    /** @brief Output Compare 1 clear enable */
    using TIM8_CCMR1_ALTERNATE_OC1CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_OC1CE_B_0x0 = 0;
        /** @brief OC1Ref is cleared as soon as a High level is detected on ETRF input */
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_OC1CE_B_0x1 = 1;

    /** @brief Capture/Compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = 0 in TIMx_CCER). */
    using TIM8_CCMR1_ALTERNATE_CC2S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC2 channel is configured as output (value: 0)
     *          - B_0x1: CC2 channel is configured as input, IC2 is mapped on TI2 (value: 1)
     *          - B_0x2: CC2 channel is configured as input, IC2 is mapped on TI1 (value: 2)
     ...
     */
        /** @brief CC2 channel is configured as output */
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_CC2S_B_0x0 = 0;
        /** @brief CC2 channel is configured as input, IC2 is mapped on TI2 */
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_CC2S_B_0x1 = 1;
        /** @brief CC2 channel is configured as input, IC2 is mapped on TI1 */
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_CC2S_B_0x2 = 2;
    ...
    constexpr std::uint32_t TIM8_CCMR1_ALTERNATE_CC2S_B_0x3 = 3;

    /** @brief Output Compare 2 fast enable Refer to OC1FE description. */
    using TIM8_CCMR1_ALTERNATE_OC2FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output Compare 2 preload enable Refer to OC1PE description. */
    using TIM8_CCMR1_ALTERNATE_OC2PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC2M[2:0]: Output Compare 2 mode Refer to OC1M[3:0] description. */
    using TIM8_CCMR1_ALTERNATE_OC2M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output Compare 2 clear enable Refer to OC1CE description. */
    using TIM8_CCMR1_ALTERNATE_OC2CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC1M[3] */
    using TIM8_CCMR1_ALTERNATE_OC1M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC2M[3] */
    using TIM8_CCMR1_ALTERNATE_OC2M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Input capture 3 prescaler Refer to IC1PSC[1:0] description. */
    using TIM8_CCMR2_IC3PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Input capture 3 filter Refer to IC1F[3:0] description. */
    ...
    /** @brief Input capture 4 prescaler Refer to IC1PSC[1:0] description. */
    using TIM8_CCMR2_IC4PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Input capture 4 filter Refer to IC1F[3:0] description. */
    using TIM8_CCMR2_IC4F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM8 capture/compare mode register 2 */
    using TIM8_CCMR2_ALTERNATE = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = 0 in TIMx_CCER). */
    using TIM8_CCMR2_ALTERNATE_CC3S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC3 channel is configured as output (value: 0)
     *          - B_0x1: CC3 channel is configured as input, IC3 is mapped on TI3 (value: 1)
     *          - B_0x2: CC3 channel is configured as input, IC3 is mapped on TI4 (value: 2)
     ...
     */
        /** @brief CC3 channel is configured as output */
    constexpr std::uint32_t TIM8_CCMR2_ALTERNATE_CC3S_B_0x0 = 0;
        /** @brief CC3 channel is configured as input, IC3 is mapped on TI3 */
    constexpr std::uint32_t TIM8_CCMR2_ALTERNATE_CC3S_B_0x1 = 1;
        /** @brief CC3 channel is configured as input, IC3 is mapped on TI4 */
    constexpr std::uint32_t TIM8_CCMR2_ALTERNATE_CC3S_B_0x2 = 2;
        /** @brief CC3 channel is configured as input, IC3 is mapped on TRC. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register) */
    constexpr std::uint32_t TIM8_CCMR2_ALTERNATE_CC3S_B_0x3 = 3;

    /** @brief Output compare 3 fast enable Refer to OC1FE description. */
    using TIM8_CCMR2_ALTERNATE_OC3FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 3 preload enable Refer to OC1PE description. */
    using TIM8_CCMR2_ALTERNATE_OC3PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC3M[2:0]: Output compare 3 mode Refer to OC1M[3:0] description. */
    using TIM8_CCMR2_ALTERNATE_OC3M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 3 clear enable Refer to OC1CE description. */
    using TIM8_CCMR2_ALTERNATE_OC3CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = 0 in TIMx_CCER). */
    using TIM8_CCMR2_ALTERNATE_CC4S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC4 channel is configured as output (value: 0)
     *          - B_0x1: CC4 channel is configured as input, IC4 is mapped on TI4 (value: 1)
     *          - B_0x2: CC4 channel is configured as input, IC4 is mapped on TI3 (value: 2)
     ...
     */
        /** @brief CC4 channel is configured as output */
    constexpr std::uint32_t TIM8_CCMR2_ALTERNATE_CC4S_B_0x0 = 0;
        /** @brief CC4 channel is configured as input, IC4 is mapped on TI4 */
    constexpr std::uint32_t TIM8_CCMR2_ALTERNATE_CC4S_B_0x1 = 1;
        /** @brief CC4 channel is configured as input, IC4 is mapped on TI3 */
    constexpr std::uint32_t TIM8_CCMR2_ALTERNATE_CC4S_B_0x2 = 2;
        /** @brief CC4 channel is configured as input, IC4 is mapped on TRC. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register) */
    constexpr std::uint32_t TIM8_CCMR2_ALTERNATE_CC4S_B_0x3 = 3;

    /** @brief Output compare 4 fast enable Refer to OC1FE description. */
    using TIM8_CCMR2_ALTERNATE_OC4FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 4 preload enable Refer to OC1PE description. */
    using TIM8_CCMR2_ALTERNATE_OC4PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC4M[2:0]: Output compare 4 mode Refer to OC3M[3:0] description. */
    using TIM8_CCMR2_ALTERNATE_OC4M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 4 clear enable Refer to OC1CE description. */
    using TIM8_CCMR2_ALTERNATE_OC4CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC3M[3] */
    using TIM8_CCMR2_ALTERNATE_OC3M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC4M[3] */
    using TIM8_CCMR2_ALTERNATE_OC4M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Capture/Compare 1 complementary output enable On channels having a complementary output, this bit is preloaded. If the CCPC bit is set in the TIMx_CR2 register then the CC1NE active bit takes the new value from the preloaded bit only when a Commutation event is generated. */
    ...
    using TIM8_ARR = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x2C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 24.3.1: Time-base unit on page 691 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null. */
    using TIM8_ARR_ARR = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM8_CCR1 = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x34, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM8_CCR1_CCR1 = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM8 capture/compare register 2 */
    using TIM8_CCR2 = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x38, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM8_CCR2_CCR2 = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM8 capture/compare register 3 */
    using TIM8_CCR3 = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x3C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM8_CCR3_CCR3 = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM8 capture/compare register 4 */
    using TIM8_CCR4 = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x40, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM8_CCR4_CCR4 = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
     ...
     *          - B_0x1: MOE can be set by software or automatically at the next update event (if none of the break inputs BRK and BRK2 is active) (value: 1)
     */
        /** @brief MOE can be set only by software */
    constexpr std::uint32_t TIM8_BDTR_AOE_B_0x0 = 0;
        /** @brief MOE can be set by software or automatically at the next update event (if none of the break inputs BRK and BRK2 is active) */
    constexpr std::uint32_t TIM8_BDTR_AOE_B_0x1 = 1;

    /** @brief Main output enable This bit is cleared asynchronously by hardware as soon as one of the break inputs is active (BRK or BRK2). It is set by software or automatically depending on the AOE bit. It is acting only on the channels which are configured in output. In response to a break event or if MOE is written to 0: OC and OCN outputs are disabled or forced to idle state depending on the OSSI bit. See OC/OCN enable description for more details (Section 24.4.11: TIMx capture/compare enable register (TIM1_CCERTIMx_CCER)(x = 1, 8)). */
    ...
    /** @details Possible values:
     *          - B_0x0: No filter, BRK2 acts asynchronously (value: 0)
     *          - B_0x1: f<sub>SAMPLING</sub>=f<sub>CK_INT</sub>, N=2 (value: 1)
     *          - B_0x2: f<sub>SAMPLING</sub>=f<sub>CK_INT</sub>, N=4 (value: 2)
     *          - B_0x3: f<sub>SAMPLING</sub>=f<sub>CK_INT</sub>, N=8 (value: 3)
     *          - B_0x4: f<sub>SAMPLING</sub>=f<sub>DTS</sub>/2, N=6 (value: 4)
     ...
     *          - B_0xF: f<sub>SAMPLING</sub>=f<sub>DTS</sub>/32, N=8 (value: 15)
     */
        /** @brief No filter, BRK2 acts asynchronously */
    ...
    /** @details Possible values:
     *          - B_0x0: Break input BRK2 is active low (value: 0)
     *          - B_0x1: Break input BRK2 is active high (value: 1)
     */
        /** @brief Break input BRK2 is active low */
    constexpr std::uint32_t TIM8_BDTR_BK2P_B_0x0 = 0;
        /** @brief Break input BRK2 is active high */
    constexpr std::uint32_t TIM8_BDTR_BK2P_B_0x1 = 1;

    /** @brief TIM8 DMA control register */
    using TIM8_DCR = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x48, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM8_DCR_DBA = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     ...
     */
        /** @brief TIMx_CR1, */
    constexpr std::uint16_t TIM8_DCR_DBA_B_0x0 = 0;
        /** @brief TIMx_CR2, */
    constexpr std::uint16_t TIM8_DCR_DBA_B_0x1 = 1;
        /** @brief TIMx_SMCR, */
    constexpr std::uint16_t TIM8_DCR_DBA_B_0x2 = 2;
    ...
    using TIM8_DCR_DBL = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 8, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     ...
     */
        /** @brief 1 transfer */
    constexpr std::uint16_t TIM8_DCR_DBL_B_0x0 = 0;
        /** @brief 2 transfers */
    constexpr std::uint16_t TIM8_DCR_DBL_B_0x1 = 1;
        /** @brief 3 transfers */
    constexpr std::uint16_t TIM8_DCR_DBL_B_0x2 = 2;
        /** @brief 18 transfers */
    constexpr std::uint16_t TIM8_DCR_DBL_B_0x11 = 17;

    /** @brief TIM8 DMA address for full transfer */
    using TIM8_DMAR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x4C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM8_OR1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x50, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief External trigger remap on ADC2 analog watchdog 00: TIM8_ETR is not connected to ADC2 AWDx. This configuration must be selected when the ETR comes from the I/O. */
    using TIM8_OR1_ETR_ADC2_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Input Capture 1 remap 0: TIM8 input capture 1 is connected to I/O 1: TIM8 input capture 1 is connected to COMP2 outpu */
    using TIM8_OR1_TI1_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM8 capture/compare mode register 3 */
    using TIM8_CCMR3 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x54, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 5 fast enable Refer to OC1FE description. */
    using TIM8_CCMR3_OC5FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 5 preload enable Refer to OC1PE description. */
    using TIM8_CCMR3_OC5PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC5M[0]: Output compare 5 mode Refer to OC1M description. */
    using TIM8_CCMR3_OC5M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 5 clear enable Refer to OC1CE description. */
    using TIM8_CCMR3_OC5CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 6 fast enable Refer to OC1FE description. */
    using TIM8_CCMR3_OC6FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 6 preload enable Refer to OC1PE description. */
    using TIM8_CCMR3_OC6PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC6M[0]: Output compare 6 mode Refer to OC1M description. */
    using TIM8_CCMR3_OC6M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 6 clear enable Refer to OC1CE description. */
    ...
    using TIM8_CCR5 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x58, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM8_CCR5_CCR5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @details Possible values:
     *          - B_0x0: No effect of OC5REF on OC1REFC5 (value: 0)
     *          - B_0x1: OC1REFC is the logical AND of OC1REFC and OC5REF (value: 1)
     */
        /** @brief No effect of OC5REF on OC1REFC5 */
    constexpr std::uint32_t TIM8_CCR5_GC5C1_B_0x0 = 0;
        /** @brief OC1REFC is the logical AND of OC1REFC and OC5REF */
    ...
    /** @details Possible values:
     *          - B_0x0: No effect of OC5REF on OC2REFC (value: 0)
     *          - B_0x1: OC2REFC is the logical AND of OC2REFC and OC5REF (value: 1)
     */
        /** @brief No effect of OC5REF on OC2REFC */
    constexpr std::uint32_t TIM8_CCR5_GC5C2_B_0x0 = 0;
        /** @brief OC2REFC is the logical AND of OC2REFC and OC5REF */
    ...
    /** @details Possible values:
     *          - B_0x0: No effect of OC5REF on OC3REFC (value: 0)
     *          - B_0x1: OC3REFC is the logical AND of OC3REFC and OC5REF (value: 1)
     */
        /** @brief No effect of OC5REF on OC3REFC */
    constexpr std::uint32_t TIM8_CCR5_GC5C3_B_0x0 = 0;
        /** @brief OC3REFC is the logical AND of OC3REFC and OC5REF */
    constexpr std::uint32_t TIM8_CCR5_GC5C3_B_0x1 = 1;

    /** @brief TIM8 capture/compare register 6 */
    using TIM8_CCR6 = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x5C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM8_CCR6_CCR6 = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM8 option register 2 */
    using TIM8_OR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x60, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM8_OR2_BKINE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: BKIN input disabled (value: 0)
     *          - B_0x1: BKIN input enabled (value: 1)
     */
        /** @brief BKIN input disabled */
    constexpr std::uint32_t TIM8_OR2_BKINE_B_0x0 = 0;
        /** @brief BKIN input enabled */
    constexpr std::uint32_t TIM8_OR2_BKINE_B_0x1 = 1;
    ...
    using TIM8_OR2_BKCMP1E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COMP1 input disabled (value: 0)
     *          - B_0x1: COMP1 input enabled (value: 1)
     */
        /** @brief COMP1 input disabled */
    constexpr std::uint32_t TIM8_OR2_BKCMP1E_B_0x0 = 0;
        /** @brief COMP1 input enabled */
    constexpr std::uint32_t TIM8_OR2_BKCMP1E_B_0x1 = 1;
    ...
    using TIM8_OR2_BKCMP2E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COMP2 input disabled (value: 0)
     *          - B_0x1: COMP2 input enabled (value: 1)
     */
        /** @brief COMP2 input disabled */
    constexpr std::uint32_t TIM8_OR2_BKCMP2E_B_0x0 = 0;
        /** @brief COMP2 input enabled */
    constexpr std::uint32_t TIM8_OR2_BKCMP2E_B_0x1 = 1;

    /** @brief BRK dfsdm1_break[2] enable This bit enables the dfsdm1_break[2] for the timer s BRK input. dfsdm1_break[2] output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    using TIM8_OR2_BKDF1BK2E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: dfsdm1_break[2] input disabled (value: 0)
     *          - B_0x1: dfsdm1_break[2] input enabled (value: 1)
     */
        /** @brief dfsdm1_break[2] input disabled */
    constexpr std::uint32_t TIM8_OR2_BKDF1BK2E_B_0x0 = 0;
        /** @brief dfsdm1_break[2] input enabled */
    constexpr std::uint32_t TIM8_OR2_BKDF1BK2E_B_0x1 = 1;
    ...
    using TIM8_OR2_BKINP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: BKIN input polarity is not inverted (active low if BKP=0, active high if BKP=1) (value: 0)
     *          - B_0x1: BKIN input polarity is inverted (active high if BKP=0, active low if BKP=1) (value: 1)
     */
        /** @brief BKIN input polarity is not inverted (active low if BKP=0, active high if BKP=1) */
    constexpr std::uint32_t TIM8_OR2_BKINP_B_0x0 = 0;
        /** @brief BKIN input polarity is inverted (active high if BKP=0, active low if BKP=1) */
    constexpr std::uint32_t TIM8_OR2_BKINP_B_0x1 = 1;
    ...
    using TIM8_OR2_BKCMP1P = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COMP1 input polarity is not inverted (active low if BKP=0, active high if BKP=1) (value: 0)
     *          - B_0x1: COMP1 input polarity is inverted (active high if BKP=0, active low if BKP=1) (value: 1)
     */
        /** @brief COMP1 input polarity is not inverted (active low if BKP=0, active high if BKP=1) */
    constexpr std::uint32_t TIM8_OR2_BKCMP1P_B_0x0 = 0;
        /** @brief COMP1 input polarity is inverted (active high if BKP=0, active low if BKP=1) */
    constexpr std::uint32_t TIM8_OR2_BKCMP1P_B_0x1 = 1;
    ...
    using TIM8_OR2_BKCMP2P = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COMP2 input polarity is not inverted (active low if BKP=0, active high if BKP=1) (value: 0)
     *          - B_0x1: COMP2 input polarity is inverted (active high if BKP=0, active low if BKP=1) (value: 1)
     */
        /** @brief COMP2 input polarity is not inverted (active low if BKP=0, active high if BKP=1) */
    constexpr std::uint32_t TIM8_OR2_BKCMP2P_B_0x0 = 0;
        /** @brief COMP2 input polarity is inverted (active high if BKP=0, active low if BKP=1) */
    constexpr std::uint32_t TIM8_OR2_BKCMP2P_B_0x1 = 1;
    ...
    using TIM8_OR2_ETRSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: ETR input is connected to I/O (value: 0)
     *          - B_0x1: COMP1 output (value: 1)
     *          - B_0x2: COMP2 output (value: 2)
     *          - B_0x3: ADC2 AWD1 (value: 3)
     *          - B_0x4: ADC2 AWD2 (value: 4)
     *          - B_0x5: ADC2 AWD3 (value: 5)
     *          - B_0x6: ADC3 AWD1 (value: 6)
     *          - B_0x7: ADC3 AWD2 (value: 7)
     *          - B_0x8: ADC3 AWD3 (value: 8)
     */
        /** @brief ETR input is connected to I/O */
    constexpr std::uint32_t TIM8_OR2_ETRSEL_B_0x0 = 0;
        /** @brief COMP1 output */
    constexpr std::uint32_t TIM8_OR2_ETRSEL_B_0x1 = 1;
        /** @brief COMP2 output */
    constexpr std::uint32_t TIM8_OR2_ETRSEL_B_0x2 = 2;
        /** @brief ADC2 AWD1 */
    constexpr std::uint32_t TIM8_OR2_ETRSEL_B_0x3 = 3;
        /** @brief ADC2 AWD2 */
    constexpr std::uint32_t TIM8_OR2_ETRSEL_B_0x4 = 4;
        /** @brief ADC2 AWD3 */
    constexpr std::uint32_t TIM8_OR2_ETRSEL_B_0x5 = 5;
        /** @brief ADC3 AWD1 */
    constexpr std::uint32_t TIM8_OR2_ETRSEL_B_0x6 = 6;
        /** @brief ADC3 AWD2 */
    constexpr std::uint32_t TIM8_OR2_ETRSEL_B_0x7 = 7;
        /** @brief ADC3 AWD3 */
    constexpr std::uint32_t TIM8_OR2_ETRSEL_B_0x8 = 8;

    /** @brief TIM8 option register 3 */
    using TIM8_OR3 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x64, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief BRK2 BKIN input enable This bit enables the BKIN2 alternate function input for the timer s BRK2 input. BKIN2 input is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    using TIM8_OR3_BK2INE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: BKIN2 input disabled (value: 0)
     *          - B_0x1: BKIN2 input enabled (value: 1)
     */
        /** @brief BKIN2 input disabled */
    constexpr std::uint32_t TIM8_OR3_BK2INE_B_0x0 = 0;
        /** @brief BKIN2 input enabled */
    constexpr std::uint32_t TIM8_OR3_BK2INE_B_0x1 = 1;

    /** @brief BRK2 COMP1 enable This bit enables the COMP1 for the timer s BRK2 input. COMP1 output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    using TIM8_OR3_BK2CMP1E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COMP1 input disabled (value: 0)
     *          - B_0x1: COMP1 input enabled (value: 1)
     */
        /** @brief COMP1 input disabled */
    constexpr std::uint32_t TIM8_OR3_BK2CMP1E_B_0x0 = 0;
        /** @brief COMP1 input enabled */
    constexpr std::uint32_t TIM8_OR3_BK2CMP1E_B_0x1 = 1;

    /** @brief BRK2 COMP2 enable This bit enables the COMP2 for the timer s BRK2 input. COMP2 output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    using TIM8_OR3_BK2CMP2E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COMP2 input disabled (value: 0)
     *          - B_0x1: COMP2 input enabled (value: 1)
     */
        /** @brief COMP2 input disabled */
    constexpr std::uint32_t TIM8_OR3_BK2CMP2E_B_0x0 = 0;
        /** @brief COMP2 input enabled */
    constexpr std::uint32_t TIM8_OR3_BK2CMP2E_B_0x1 = 1;

    /** @brief BRK2 dfsdm1_break[3] enable This bit enables the dfsdm1_break[3] for the timer s BRK2 input. dfsdm1_break[3] output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    using TIM8_OR3_BK2DF1BK3E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: dfsdm1_break[3] input disabled (value: 0)
     *          - B_0x1: dfsdm1_break[3] input enabled (value: 1)
     */
        /** @brief dfsdm1_break[3] input disabled */
    constexpr std::uint32_t TIM8_OR3_BK2DF1BK3E_B_0x0 = 0;
        /** @brief dfsdm1_break[3] input enabled */
    constexpr std::uint32_t TIM8_OR3_BK2DF1BK3E_B_0x1 = 1;

    /** @brief BRK2 BKIN2 input polarity This bit selects the BKIN2 alternate function input sensitivity. It must be programmed together with the BK2P polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    using TIM8_OR3_BK2INP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: BKIN2 input polarity is not inverted (active low if BK2P=0, active high if BK2P=1) (value: 0)
     *          - B_0x1: BKIN2 input polarity is inverted (active high if BK2P=0, active low if BK2P=1) (value: 1)
     */
        /** @brief BKIN2 input polarity is not inverted (active low if BK2P=0, active high if BK2P=1) */
    constexpr std::uint32_t TIM8_OR3_BK2INP_B_0x0 = 0;
        /** @brief BKIN2 input polarity is inverted (active high if BK2P=0, active low if BK2P=1) */
    constexpr std::uint32_t TIM8_OR3_BK2INP_B_0x1 = 1;

    /** @brief BRK2 COMP1 input polarity This bit selects the COMP1 input sensitivity. It must be programmed together with the BK2P polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    using TIM8_OR3_BK2CMP1P = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COMP1 input polarity is not inverted (active low if BK2P=0, active high if BK2P=1) (value: 0)
     *          - B_0x1: COMP1 input polarity is inverted (active high if BK2P=0, active low if BK2P=1) (value: 1)
     */
        /** @brief COMP1 input polarity is not inverted (active low if BK2P=0, active high if BK2P=1) */
    constexpr std::uint32_t TIM8_OR3_BK2CMP1P_B_0x0 = 0;
        /** @brief COMP1 input polarity is inverted (active high if BK2P=0, active low if BK2P=1) */
    constexpr std::uint32_t TIM8_OR3_BK2CMP1P_B_0x1 = 1;

    /** @brief BRK2 COMP2 input polarity This bit selects the COMP2 input sensitivity. It must be programmed together with the BK2P polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    using TIM8_OR3_BK2CMP2P = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COMP2 input polarity is not inverted (active low if BK2P=0, active high if BK2P=1) (value: 0)
     *          - B_0x1: COMP2 input polarity is inverted (active high if BK2P=0, active low if BK2P=1) (value: 1)
     */
        /** @brief COMP2 input polarity is not inverted (active low if BK2P=0, active high if BK2P=1) */
    constexpr std::uint32_t TIM8_OR3_BK2CMP2P_B_0x0 = 0;
        /** @brief COMP2 input polarity is inverted (active high if BK2P=0, active low if BK2P=1) */
    constexpr std::uint32_t TIM8_OR3_BK2CMP2P_B_0x1 = 1;
