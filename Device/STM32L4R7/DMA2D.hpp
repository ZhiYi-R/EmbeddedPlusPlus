...
#ifndef EMBEDDED_PP_STM32L4R7_DMA2D_HPP
#define EMBEDDED_PP_STM32L4R7_DMA2D_HPP
...
namespace STM32L4R7::DMA2D {
    ...
    using OCOLR_APLHA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Red Value */
