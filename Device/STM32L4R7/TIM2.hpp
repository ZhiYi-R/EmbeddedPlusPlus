...
#ifndef EMBEDDED_PP_STM32L4R7_TIM2_HPP
#define EMBEDDED_PP_STM32L4R7_TIM2_HPP
...
namespace STM32L4R7::TIM2 {
    ...
    /** @brief TIM2 counter */
    using TIM2_CNT_ALTERNATE = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x24, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Least significant part of counter value */
    using TIM2_CNT_ALTERNATE_CNT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 31, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief UIF Copy This bit is a read-only copy of the UIF bit of the TIMx_ISR register */
    using TIM2_CNT_ALTERNATE_UIFCPY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM2_OR1_ITR1_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM2_OR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x60, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ETR source selection These bits select the ETR input source. Others: Reserved */
    using TIM2_OR2_ETRSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: ETR input is connected to I/O (value: 0)
     *          - B_0x1: COMP1 output (value: 1)
     *          - B_0x2: COMP2 output (value: 2)
     *          - B_0x3: LSE (value: 3)
     *          - B_0x4: SAI1 FS_A (value: 4)
     *          - B_0x5: SAI1 FS_B (value: 5)
     */
        /** @brief ETR input is connected to I/O */
    constexpr std::uint32_t TIM2_OR2_ETRSEL_B_0x0 = 0;
        /** @brief COMP1 output */
    constexpr std::uint32_t TIM2_OR2_ETRSEL_B_0x1 = 1;
        /** @brief COMP2 output */
    constexpr std::uint32_t TIM2_OR2_ETRSEL_B_0x2 = 2;
        /** @brief LSE */
    constexpr std::uint32_t TIM2_OR2_ETRSEL_B_0x3 = 3;
        /** @brief SAI1 FS_A */
    constexpr std::uint32_t TIM2_OR2_ETRSEL_B_0x4 = 4;
        /** @brief SAI1 FS_B */
    constexpr std::uint32_t TIM2_OR2_ETRSEL_B_0x5 = 5;
