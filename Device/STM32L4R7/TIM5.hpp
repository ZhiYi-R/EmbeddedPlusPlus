...
#ifndef EMBEDDED_PP_STM32L4R7_TIM5_HPP
#define EMBEDDED_PP_STM32L4R7_TIM5_HPP
...
namespace STM32L4R7::TIM5 {
    ...
    using TIM5_CR2 = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/compare DMA selection */
    using TIM5_CR2_CCDS = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint16_t TIM5_CR2_CCDS_B_0x0 = 0;
        /** @brief CCx DMA requests sent when update event occurs */
    constexpr std::uint16_t TIM5_CR2_CCDS_B_0x1 = 1;
    ...
    using TIM5_CR2_MMS = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint16_t TIM5_CR2_MMS_B_0x0 = 0;
        /** @brief Enable - the Counter enable signal, CNT_EN, is used as trigger output (TRGO). It is useful to start several timers at the same time or to control a window in which a slave timer is enabled. The Counter Enable signal is generated by a logic AND between CEN control bit and the trigger input when configured in gated mode. */
    constexpr std::uint16_t TIM5_CR2_MMS_B_0x1 = 1;
    ...
    constexpr std::uint16_t TIM5_CR2_MMS_B_0x2 = 2;
    ...
    constexpr std::uint16_t TIM5_CR2_MMS_B_0x3 = 3;
        /** @brief Compare - OC1REFC signal is used as trigger output (TRGO) */
    constexpr std::uint16_t TIM5_CR2_MMS_B_0x4 = 4;
        /** @brief Compare - OC2REFC signal is used as trigger output (TRGO) */
    constexpr std::uint16_t TIM5_CR2_MMS_B_0x5 = 5;
        /** @brief Compare - OC3REFC signal is used as trigger output (TRGO) */
    constexpr std::uint16_t TIM5_CR2_MMS_B_0x6 = 6;
        /** @brief Compare - OC4REFC signal is used as trigger output (TRGO) */
    constexpr std::uint16_t TIM5_CR2_MMS_B_0x7 = 7;

    /** @brief TI1 selection */
    using TIM5_CR2_TI1S = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint16_t TIM5_CR2_TI1S_B_0x0 = 0;
    ...
    constexpr std::uint16_t TIM5_CR2_TI1S_B_0x1 = 1;
    ...
    using TIM5_DIER = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0xC, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Update interrupt enable */
    using TIM5_DIER_UIE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Update interrupt disabled. (value: 0)
     *          - B_0x1: Update interrupt enabled. (value: 1)
     */
        /** @brief Update interrupt disabled. */
    constexpr std::uint16_t TIM5_DIER_UIE_B_0x0 = 0;
        /** @brief Update interrupt enabled. */
    constexpr std::uint16_t TIM5_DIER_UIE_B_0x1 = 1;

    /** @brief Capture/Compare 1 interrupt enable */
    using TIM5_DIER_CC1IE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC1 interrupt disabled. (value: 0)
     *          - B_0x1: CC1 interrupt enabled. (value: 1)
     */
        /** @brief CC1 interrupt disabled. */
    constexpr std::uint16_t TIM5_DIER_CC1IE_B_0x0 = 0;
        /** @brief CC1 interrupt enabled. */
    constexpr std::uint16_t TIM5_DIER_CC1IE_B_0x1 = 1;

    /** @brief Capture/Compare 2 interrupt enable */
    using TIM5_DIER_CC2IE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC2 interrupt disabled. (value: 0)
     *          - B_0x1: CC2 interrupt enabled. (value: 1)
     */
        /** @brief CC2 interrupt disabled. */
    constexpr std::uint16_t TIM5_DIER_CC2IE_B_0x0 = 0;
        /** @brief CC2 interrupt enabled. */
    constexpr std::uint16_t TIM5_DIER_CC2IE_B_0x1 = 1;

    /** @brief Capture/Compare 3 interrupt enable */
    using TIM5_DIER_CC3IE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC3 interrupt disabled. (value: 0)
     *          - B_0x1: CC3 interrupt enabled. (value: 1)
     */
        /** @brief CC3 interrupt disabled. */
    constexpr std::uint16_t TIM5_DIER_CC3IE_B_0x0 = 0;
        /** @brief CC3 interrupt enabled. */
    constexpr std::uint16_t TIM5_DIER_CC3IE_B_0x1 = 1;

    /** @brief Capture/Compare 4 interrupt enable */
    using TIM5_DIER_CC4IE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC4 interrupt disabled. (value: 0)
     *          - B_0x1: CC4 interrupt enabled. (value: 1)
     */
        /** @brief CC4 interrupt disabled. */
    constexpr std::uint16_t TIM5_DIER_CC4IE_B_0x0 = 0;
        /** @brief CC4 interrupt enabled. */
    constexpr std::uint16_t TIM5_DIER_CC4IE_B_0x1 = 1;

    /** @brief Trigger interrupt enable */
    using TIM5_DIER_TIE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Trigger interrupt disabled. (value: 0)
     *          - B_0x1: Trigger interrupt enabled. (value: 1)
     */
        /** @brief Trigger interrupt disabled. */
    constexpr std::uint16_t TIM5_DIER_TIE_B_0x0 = 0;
        /** @brief Trigger interrupt enabled. */
    constexpr std::uint16_t TIM5_DIER_TIE_B_0x1 = 1;

    /** @brief Update DMA request enable */
    using TIM5_DIER_UDE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Update DMA request disabled. (value: 0)
     *          - B_0x1: Update DMA request enabled. (value: 1)
     */
        /** @brief Update DMA request disabled. */
    constexpr std::uint16_t TIM5_DIER_UDE_B_0x0 = 0;
        /** @brief Update DMA request enabled. */
    constexpr std::uint16_t TIM5_DIER_UDE_B_0x1 = 1;

    /** @brief Capture/Compare 1 DMA request enable */
    using TIM5_DIER_CC1DE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC1 DMA request disabled. (value: 0)
     *          - B_0x1: CC1 DMA request enabled. (value: 1)
     */
        /** @brief CC1 DMA request disabled. */
    constexpr std::uint16_t TIM5_DIER_CC1DE_B_0x0 = 0;
        /** @brief CC1 DMA request enabled. */
    constexpr std::uint16_t TIM5_DIER_CC1DE_B_0x1 = 1;

    /** @brief Capture/Compare 2 DMA request enable */
    using TIM5_DIER_CC2DE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC2 DMA request disabled. (value: 0)
     *          - B_0x1: CC2 DMA request enabled. (value: 1)
     */
        /** @brief CC2 DMA request disabled. */
    constexpr std::uint16_t TIM5_DIER_CC2DE_B_0x0 = 0;
        /** @brief CC2 DMA request enabled. */
    constexpr std::uint16_t TIM5_DIER_CC2DE_B_0x1 = 1;

    /** @brief Capture/Compare 3 DMA request enable */
    using TIM5_DIER_CC3DE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC3 DMA request disabled. (value: 0)
     *          - B_0x1: CC3 DMA request enabled. (value: 1)
     */
        /** @brief CC3 DMA request disabled. */
    constexpr std::uint16_t TIM5_DIER_CC3DE_B_0x0 = 0;
        /** @brief CC3 DMA request enabled. */
    constexpr std::uint16_t TIM5_DIER_CC3DE_B_0x1 = 1;

    /** @brief Capture/Compare 4 DMA request enable */
    using TIM5_DIER_CC4DE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC4 DMA request disabled. (value: 0)
     *          - B_0x1: CC4 DMA request enabled. (value: 1)
     */
        /** @brief CC4 DMA request disabled. */
    constexpr std::uint16_t TIM5_DIER_CC4DE_B_0x0 = 0;
        /** @brief CC4 DMA request enabled. */
    constexpr std::uint16_t TIM5_DIER_CC4DE_B_0x1 = 1;

    /** @brief Trigger DMA request enable */
    using TIM5_DIER_TDE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Trigger DMA request disabled. (value: 0)
     *          - B_0x1: Trigger DMA request enabled. (value: 1)
     */
        /** @brief Trigger DMA request disabled. */
    constexpr std::uint16_t TIM5_DIER_TDE_B_0x0 = 0;
        /** @brief Trigger DMA request enabled. */
    constexpr std::uint16_t TIM5_DIER_TDE_B_0x1 = 1;

    /** @brief TIM5 status register */
    using TIM5_SR = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x10, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM5_SR_UIF = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    using TIM5_SR_CC1IF = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint16_t TIM5_SR_CC1IF_B_0x0 = 0;
        /** @brief A compare match or an input capture occurred */
    constexpr std::uint16_t TIM5_SR_CC1IF_B_0x1 = 1;

    /** @brief Capture/Compare 2 interrupt flag Refer to CC1IF description */
    using TIM5_SR_CC2IF = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 3 interrupt flag Refer to CC1IF description */
    using TIM5_SR_CC3IF = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 4 interrupt flag Refer to CC1IF description */
    using TIM5_SR_CC4IF = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM5_SR_TIF = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No trigger event occurred. (value: 0)
     *          - B_0x1: Trigger interrupt pending. (value: 1)
     */
        /** @brief No trigger event occurred. */
    constexpr std::uint16_t TIM5_SR_TIF_B_0x0 = 0;
        /** @brief Trigger interrupt pending. */
    constexpr std::uint16_t TIM5_SR_TIF_B_0x1 = 1;
    ...
    using TIM5_SR_CC1OF = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint16_t TIM5_SR_CC1OF_B_0x0 = 0;
        /** @brief The counter value has been captured in TIMx_CCR1 register while CC1IF flag was already set */
    constexpr std::uint16_t TIM5_SR_CC1OF_B_0x1 = 1;

    /** @brief Capture/compare 2 overcapture flag refer to CC1OF description */
    using TIM5_SR_CC2OF = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 3 overcapture flag refer to CC1OF description */
    using TIM5_SR_CC3OF = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 4 overcapture flag refer to CC1OF description */
    using TIM5_SR_CC4OF = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief TIM5 counter */
    using TIM5_CNT_ALTERNATE = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x24, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Least significant part of counter value */
    using TIM5_CNT_ALTERNATE_CNT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 31, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief UIF Copy This bit is a read-only copy of the UIF bit of the TIMx_ISR register */
    using TIM5_CNT_ALTERNATE_UIFCPY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM5_DCR = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x48, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM5_DCR_DBA = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     ...
     */
        /** @brief TIMx_CR1 */
    constexpr std::uint16_t TIM5_DCR_DBA_B_0x0 = 0;
        /** @brief TIMx_CR2 */
    constexpr std::uint16_t TIM5_DCR_DBA_B_0x1 = 1;
        /** @brief TIMx_SMCR */
    constexpr std::uint16_t TIM5_DCR_DBA_B_0x2 = 2;
    ...
    using TIM5_DCR_DBL = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 8, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     ...
     */
        /** @brief 1 transfer, */
    constexpr std::uint16_t TIM5_DCR_DBL_B_0x0 = 0;
        /** @brief 2 transfers, */
    constexpr std::uint16_t TIM5_DCR_DBL_B_0x1 = 1;
        /** @brief 3 transfers, */
    constexpr std::uint16_t TIM5_DCR_DBL_B_0x2 = 2;
        /** @brief 18 transfers. */
    constexpr std::uint16_t TIM5_DCR_DBL_B_0x11 = 17;

    /** @brief TIM5 DMA address for full transfer */
    using TIM5_DMAR = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x4C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DMA register for burst accesses A read or write operation to the DMAR register accesses the register located at the address (TIMx_CR1 address) + (DBA + DMA index) x 4 where TIMx_CR1 address is the address of the control register 1, DBA is the DMA base address configured in TIMx_DCR register, DMA index is automatically controlled by the DMA transfer, and ranges from 0 to DBL (DBL configured in TIMx_DCR). */
    using TIM5_DMAR_DMAB = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
