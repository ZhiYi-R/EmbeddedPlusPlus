...
#ifndef EMBEDDED_PP_STM32L4R9_DSI_HPP
#define EMBEDDED_PP_STM32L4R9_DSI_HPP
...
namespace STM32L4R9::DSI {
    ...
    using DSI_DLTRC = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x9C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Maximum Read Time */
    using DSI_DLTRC_MRD_TIME = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 15, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Low-Power To High-Speed Time */
    using DSI_DLTRC_LP2HS_TIME = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief High-Speed To Low-Power Time */
    using DSI_DLTRC_HS2LP_TIME = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief SDD Control */
    using DSI_WPCR1_SDCC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Low-Power transmission Slew Rate Compensation on Data Lanes */
    using DSI_WPCR1_LPSRDL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Low-Power transmission Slew Rate Compensation on Clock Lane */
    using DSI_WPCR1_LPSRCL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief High-Speed Transmission Delay on Data Lanes */
    using DSI_WPCR1_HSTXDLL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief tCLK-ZERO */
    using DSI_WPCR2_TCLKZEO = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief tCLK-PREPARE */
