...
#ifndef EMBEDDED_PP_STM32L4R9_TIM7_HPP
#define EMBEDDED_PP_STM32L4R9_TIM7_HPP
...
namespace STM32L4R9::TIM7 {
    ...
    using TIM7_ARR = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x2C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM7_ARR_ARR = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
