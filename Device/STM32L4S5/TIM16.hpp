...
#ifndef EMBEDDED_PP_STM32L4S5_TIM16_HPP
#define EMBEDDED_PP_STM32L4S5_TIM16_HPP
...
namespace STM32L4S5::TIM16 {
    ...
    using TIM16_OR1_TI1_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM16 option register 2 */
    using TIM16_OR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x60, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM16_OR2_BKINE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: BKIN input disabled (value: 0)
     *          - B_0x1: BKIN input enabled (value: 1)
     */
        /** @brief BKIN input disabled */
    constexpr std::uint32_t TIM16_OR2_BKINE_B_0x0 = 0;
        /** @brief BKIN input enabled */
    constexpr std::uint32_t TIM16_OR2_BKINE_B_0x1 = 1;
    ...
    using TIM16_OR2_BKCMP1E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COMP1 input disabled (value: 0)
     *          - B_0x1: COMP1 input enabled (value: 1)
     */
        /** @brief COMP1 input disabled */
    constexpr std::uint32_t TIM16_OR2_BKCMP1E_B_0x0 = 0;
        /** @brief COMP1 input enabled */
    constexpr std::uint32_t TIM16_OR2_BKCMP1E_B_0x1 = 1;
    ...
    using TIM16_OR2_BKCMP2E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COMP2 input disabled (value: 0)
     *          - B_0x1: COMP2 input enabled (value: 1)
     */
        /** @brief COMP2 input disabled */
    constexpr std::uint32_t TIM16_OR2_BKCMP2E_B_0x0 = 0;
        /** @brief COMP2 input enabled */
    constexpr std::uint32_t TIM16_OR2_BKCMP2E_B_0x1 = 1;

    /** @brief BRK dfsdm1_break[1] enable This bit enables the dfsdm1_break[1] for the timer s BRK input. dfsdm1_break[1] output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    using TIM16_OR2_BKDF1BK1E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: dfsdm1_break[1] input disabled (value: 0)
     *          - B_0x1: dfsdm1_break[1] input enabled (value: 1)
     */
        /** @brief dfsdm1_break[1] input disabled */
    constexpr std::uint32_t TIM16_OR2_BKDF1BK1E_B_0x0 = 0;
        /** @brief dfsdm1_break[1] input enabled */
    constexpr std::uint32_t TIM16_OR2_BKDF1BK1E_B_0x1 = 1;
    ...
    using TIM16_OR2_BKINP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: BKIN input is active low (value: 0)
     *          - B_0x1: BKIN input is active high (value: 1)
     */
        /** @brief BKIN input is active low */
    constexpr std::uint32_t TIM16_OR2_BKINP_B_0x0 = 0;
        /** @brief BKIN input is active high */
    constexpr std::uint32_t TIM16_OR2_BKINP_B_0x1 = 1;
    ...
    using TIM16_OR2_BKCMP1P = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COMP1 input is active low (value: 0)
     *          - B_0x1: COMP1 input is active high (value: 1)
     */
        /** @brief COMP1 input is active low */
    constexpr std::uint32_t TIM16_OR2_BKCMP1P_B_0x0 = 0;
        /** @brief COMP1 input is active high */
    constexpr std::uint32_t TIM16_OR2_BKCMP1P_B_0x1 = 1;
    ...
    using TIM16_OR2_BKCMP2P = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COMP2 input is active low (value: 0)
     *          - B_0x1: COMP2 input is active high (value: 1)
     */
        /** @brief COMP2 input is active low */
    constexpr std::uint32_t TIM16_OR2_BKCMP2P_B_0x0 = 0;
        /** @brief COMP2 input is active high */
    constexpr std::uint32_t TIM16_OR2_BKCMP2P_B_0x1 = 1;
