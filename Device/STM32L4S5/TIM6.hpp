...
#ifndef EMBEDDED_PP_STM32L4S5_TIM6_HPP
#define EMBEDDED_PP_STM32L4S5_TIM6_HPP
...
namespace STM32L4S5::TIM6 {
    ...
    using TIM6_ARR = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x2C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Prescaler value ARR is the value to be loaded into the actual auto-reload register. Refer to Section 46.3.1: Time-base unit on page 1760 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null. */
    using TIM6_ARR_ARR = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
