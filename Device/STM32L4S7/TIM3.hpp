...
#ifndef EMBEDDED_PP_STM32L4S7_TIM3_HPP
#define EMBEDDED_PP_STM32L4S7_TIM3_HPP
...
namespace STM32L4S7::TIM3 {
    ...
    /** @brief Least significant part of counter value */
    using TIM3_CNT_ALTERNATE_CNT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 31, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM3_OR1_TI1_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM3 option register 2 */
    using TIM3_OR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x60, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ETR source selection These bits select the ETR input source. Others: Reserved */
    using TIM3_OR2_ETRSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: ETR input is connected to I/O (value: 0)
     *          - B_0x1: COMP1 output (value: 1)
     */
        /** @brief ETR input is connected to I/O */
    constexpr std::uint32_t TIM3_OR2_ETRSEL_B_0x0 = 0;
        /** @brief COMP1 output */
    constexpr std::uint32_t TIM3_OR2_ETRSEL_B_0x1 = 1;
