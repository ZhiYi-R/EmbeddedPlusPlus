...
#ifndef EMBEDDED_PP_STM32L4X1_TIM17_HPP
#define EMBEDDED_PP_STM32L4X1_TIM17_HPP
...
namespace STM32L4x1::TIM17 {
    ...
    /** @brief BRK DFSDM_BREAK[1] enable */
    using OR2_BKDFBK1E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
