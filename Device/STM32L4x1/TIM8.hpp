...
#ifndef EMBEDDED_PP_STM32L4X1_TIM8_HPP
#define EMBEDDED_PP_STM32L4X1_TIM8_HPP
...
namespace STM32L4x1::TIM8 {
    ...
    /** @brief External trigger remap on ADC2 analog watchdog */
    using OR1_ETR_ADC2_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief BRK DFSDM_BREAK[2] enable */
    using OR2_BKDFBK2E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief BRK2 DFSDM_BREAK[3] enable */
    using OR3_BK2DFBK3E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
