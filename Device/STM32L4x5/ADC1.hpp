...
#ifndef EMBEDDED_PP_STM32L4X5_ADC1_HPP
#define EMBEDDED_PP_STM32L4X5_ADC1_HPP
...
namespace STM32L4x5::ADC1 {
    ...
    /** @brief AUTOFF */
    using CFGR_AUTOFF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief AUTDLY */
