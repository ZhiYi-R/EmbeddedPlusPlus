...
#ifndef EMBEDDED_PP_STM32L4X5_OTG_FS_PWRCLK_HPP
#define EMBEDDED_PP_STM32L4X5_OTG_FS_PWRCLK_HPP
...
namespace STM32L4x5::OTG_FS_PWRCLK {
    ...
    using FS_PCGCCTL_ENL1GTG = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief PHY in Sleep */
    using FS_PCGCCTL_PHYSLEEP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Deep Sleepp */
    using FS_PCGCCTL_SUSP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
