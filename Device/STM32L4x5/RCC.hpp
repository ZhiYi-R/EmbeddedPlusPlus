...
#ifndef EMBEDDED_PP_STM32L4X5_RCC_HPP
#define EMBEDDED_PP_STM32L4X5_RCC_HPP
...
namespace STM32L4x5::RCC {
    ...
    using AHB1ENR_CRCEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief CRCSMEN */
    using AHB1SMENR_CRCSMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
