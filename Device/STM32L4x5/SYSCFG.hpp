...
#ifndef EMBEDDED_PP_STM32L4X5_SYSCFG_HPP
#define EMBEDDED_PP_STM32L4X5_SYSCFG_HPP
...
namespace STM32L4x5::SYSCFG {
    ...
    /** @brief Cortex LOCKUP (Hardfault) output enable bit */
