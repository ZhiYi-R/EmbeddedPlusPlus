...
#ifndef EMBEDDED_PP_STM32L4X5_TIM4_HPP
#define EMBEDDED_PP_STM32L4X5_TIM4_HPP
...
namespace STM32L4x5::TIM4 {
    ...
    /** @brief Timer2 ETR remap */
    using OR_ETR_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Internal trigger */
    using OR_TI4_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
