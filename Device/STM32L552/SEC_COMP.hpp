...
#ifndef EMBEDDED_PP_STM32L552_SEC_COMP_HPP
#define EMBEDDED_PP_STM32L552_SEC_COMP_HPP
...
namespace STM32L552::SEC_COMP {
    ...
    using COMP1_CSR_COMP1_INPSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using COMP2_CSR_COMP2_INPSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
