...
#ifndef EMBEDDED_PP_STM32L552_SEC_TIM15_HPP
#define EMBEDDED_PP_STM32L552_SEC_TIM15_HPP
...
namespace STM32L552::SEC_TIM15 {
    ...
    using OR2_BKDF1BK0E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CCR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x28, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
