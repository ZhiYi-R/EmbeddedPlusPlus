...
#ifndef EMBEDDED_PP_STM32L552_SEC_TIM7_HPP
#define EMBEDDED_PP_STM32L552_SEC_TIM7_HPP
...
namespace STM32L552::SEC_TIM7 {
    ...
    using CR1_UIFREMA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief CNT */
    using CNT_CNT_bit0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief UIFCPY or Res */
    ...
    /** @brief ARR_bit0 */
    using ARR_ARR_bit0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
