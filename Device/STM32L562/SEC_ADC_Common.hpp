...
#ifndef EMBEDDED_PP_STM32L562_SEC_ADC_COMMON_HPP
#define EMBEDDED_PP_STM32L562_SEC_ADC_COMMON_HPP
...
namespace STM32L562::SEC_ADC_Common {
    ...
    /** @brief DELAY */
    using CCR_DELAY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DUAL */
