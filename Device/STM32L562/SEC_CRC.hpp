...
#ifndef EMBEDDED_PP_STM32L562_SEC_CRC_HPP
#define EMBEDDED_PP_STM32L562_SEC_CRC_HPP
...
namespace STM32L562::SEC_CRC {
    ...
    using POL_Polynomialcoefficients = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
