...
#ifndef EMBEDDED_PP_STM32L562_SEC_FDCAN1_HPP
#define EMBEDDED_PP_STM32L562_SEC_FDCAN1_HPP
...
/** @brief FDCAN1 */
namespace STM32L562::SEC_FDCAN1 {
    ...
    using FDCAN_IE_MRAFE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Timeout Occurred Enable */
    using FDCAN_IE_TOOE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Error Logging Overflow Enable */
    using FDCAN_IE_ELOE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Error Passive Enable */
    using FDCAN_IE_EPE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Warning Status Enable */
    using FDCAN_IE_EWE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Bus_Off Status Enable */
    using FDCAN_IE_BOE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Watchdog Interrupt Enable */
    using FDCAN_IE_WDIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Protocol Error in Arbitration Phase Enable */
    using FDCAN_IE_PEAE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Protocol Error in Data Phase Enable */
    using FDCAN_IE_PEDE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Access to Reserved Address Enable */
    using FDCAN_IE_ARAE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using FDCAN_TXBCIE_CF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
