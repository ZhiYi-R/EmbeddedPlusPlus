...
#ifndef EMBEDDED_PP_STM32L562_SEC_LPTIM2_HPP
#define EMBEDDED_PP_STM32L562_SEC_LPTIM2_HPP
...
namespace STM32L562::SEC_LPTIM2 {
    ...
    /** @brief Counter reset */
    using CR_COUNTRST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Reset after read enable */
    using CR_RSTARE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
