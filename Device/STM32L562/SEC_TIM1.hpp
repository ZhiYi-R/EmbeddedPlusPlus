...
#ifndef EMBEDDED_PP_STM32L562_SEC_TIM1_HPP
#define EMBEDDED_PP_STM32L562_SEC_TIM1_HPP
...
namespace STM32L562::SEC_TIM1 {
    ...
    using CR2_OIS5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output Idle state 6 */
    using CR2_OIS6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CCMR3_Output_OC5M_bit3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using OR3_BK2DFBK0E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
