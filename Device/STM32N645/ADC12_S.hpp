...
#ifndef EMBEDDED_PP_STM32N645_ADC12_S_HPP
#define EMBEDDED_PP_STM32N645_ADC12_S_HPP
...
namespace STM32N645::ADC12_S {
    ...
    /** @brief V less than sub>REFINT less than /sub> enable */
    using ADC12_CCR_VREFEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>REFINT less than /sub> channel disabled (value: 0)
     *          - B_0x1: V less than sub>REFINT less than /sub> channel enabled (value: 1)
     */
        /** @brief V less than sub>REFINT less than /sub> channel disabled */
    constexpr std::uint32_t ADC12_CCR_VREFEN_B_0x0 = 0;
        /** @brief V less than sub>REFINT less than /sub> channel enabled */
    ...
    /** @details Possible values:
     *          - B_0x0: V less than sub>BAT less than /sub> channel disabled (value: 0)
     *          - B_0x1: V less than sub>BAT less than /sub> channel enabled (value: 1)
     */
        /** @brief V less than sub>BAT less than /sub> channel disabled */
    constexpr std::uint32_t ADC12_CCR_VBATEN_B_0x0 = 0;
        /** @brief V less than sub>BAT less than /sub> channel enabled */
