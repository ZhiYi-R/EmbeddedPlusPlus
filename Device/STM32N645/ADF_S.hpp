...
#ifndef EMBEDDED_PP_STM32N645_ADF_S_HPP
#define EMBEDDED_PP_STM32N645_ADF_S_HPP
...
namespace STM32N645::ADF_S {
    ...
    /** @details Possible values:
     *          - B_0x4: MCIC configured in single Sinc less than sup>4 less than /sup> filter (value: 4)
     *          - B_0x5: MCIC configured in single Sinc less than sup>5 less than /sup> filter (value: 5)
     */
        /** @brief MCIC configured in single Sinc less than sup>4 less than /sup> filter */
    constexpr std::uint32_t ADF_DFLT0CICR_CICMOD_B_0x4 = 4;
        /** @brief MCIC configured in single Sinc less than sup>5 less than /sup> filter */
    ...
    /** @details Possible values:
     *          - B_0x0: Hysteresis function disabled. THR less than sub>H less than /sub> is always used. (value: 0)
     *          - B_0x1: Hysteresis function enabled. THR less than sub>H less than /sub> is used for MONITOR to DETECT transition and THR less than sub>L less than /sub> is used for DETECT to MONITOR transition. (value: 1)
     */
        /** @brief Hysteresis function disabled. THR less than sub>H less than /sub> is always used. */
    constexpr std::uint32_t ADF_SADCR_HYSTEN_B_0x0 = 0;
        /** @brief Hysteresis function enabled. THR less than sub>H less than /sub> is used for MONITOR to DETECT transition and THR less than sub>L less than /sub> is used for DETECT to MONITOR transition. */
    ...
    /** @details Possible values:
     *          - B_0x0: THR less than sub>H less than /sub>is 3.5 dB higher than ANLVL (value: 0)
     *          - B_0x1: THR less than sub>H less than /sub>is 6.0 dB higher than ANLVL (value: 1)
     *          - B_0x2: THR less than sub>H less than /sub>is 9.5 dB higher than ANLVL (value: 2)
     *          - B_0x3: THR less than sub>H less than /sub>is 12 dB higher than ANLVL (value: 3)
     *          - B_0x4: THR less than sub>H less than /sub>is 15.6 dB higher than ANLVL (value: 4)
     *          - B_0x5: THR less than sub>H less than /sub>is 18 dB higher than ANLVL (value: 5)
     *          - B_0x6: THR less than sub>H less than /sub>is 21.6 dB higher than ANLVL (value: 6)
     *          - B_0x7: THR less than sub>H less than /sub>is 24.1 dB higher than ANLVL (value: 7)
     *          - B_0x8: THR less than sub>H less than /sub>is 27.6 dB higher than ANLVL (value: 8)
     *          - B_0x9: THR less than sub>H less than /sub>is 30.1dB higher than ANLVL (value: 9)
     */
        /** @brief THR less than sub>H less than /sub>is 3.5 dB higher than ANLVL */
    constexpr std::uint32_t ADF_SADCFGR_SNTHR_B_0x0 = 0;
        /** @brief THR less than sub>H less than /sub>is 6.0 dB higher than ANLVL */
    constexpr std::uint32_t ADF_SADCFGR_SNTHR_B_0x1 = 1;
        /** @brief THR less than sub>H less than /sub>is 9.5 dB higher than ANLVL */
    constexpr std::uint32_t ADF_SADCFGR_SNTHR_B_0x2 = 2;
        /** @brief THR less than sub>H less than /sub>is 12 dB higher than ANLVL */
    constexpr std::uint32_t ADF_SADCFGR_SNTHR_B_0x3 = 3;
        /** @brief THR less than sub>H less than /sub>is 15.6 dB higher than ANLVL */
    constexpr std::uint32_t ADF_SADCFGR_SNTHR_B_0x4 = 4;
        /** @brief THR less than sub>H less than /sub>is 18 dB higher than ANLVL */
    constexpr std::uint32_t ADF_SADCFGR_SNTHR_B_0x5 = 5;
        /** @brief THR less than sub>H less than /sub>is 21.6 dB higher than ANLVL */
    constexpr std::uint32_t ADF_SADCFGR_SNTHR_B_0x6 = 6;
        /** @brief THR less than sub>H less than /sub>is 24.1 dB higher than ANLVL */
    constexpr std::uint32_t ADF_SADCFGR_SNTHR_B_0x7 = 7;
        /** @brief THR less than sub>H less than /sub>is 27.6 dB higher than ANLVL */
    constexpr std::uint32_t ADF_SADCFGR_SNTHR_B_0x8 = 8;
        /** @brief THR less than sub>H less than /sub>is 30.1dB higher than ANLVL */
