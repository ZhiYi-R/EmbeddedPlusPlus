...
#ifndef EMBEDDED_PP_STM32N645_DBGMCU_S_HPP
#define EMBEDDED_PP_STM32N645_DBGMCU_S_HPP
...
namespace STM32N645::DBGMCU_S {
    ...
    /** @details Possible values:
     *          - B_0x0: Normal operation. All clocks are disabled and the V less than sub>DD less than /sub> domain powered down automatically in Standby mode. (value: 0)
     *          - B_0x1: Automatic clock stop/power down disabled. All active clocks and oscillators continue to run during Standby mode, and the V less than sub>DD less than /sub> domain supply is maintained, allowing full debug capability. (value: 1)
     */
        /** @brief Normal operation. All clocks are disabled and the V less than sub>DD less than /sub> domain powered down automatically in Standby mode. */
    constexpr std::uint32_t DBGMCU_CR_DBG_STANDBY_B_0x0 = 0;
        /** @brief Automatic clock stop/power down disabled. All active clocks and oscillators continue to run during Standby mode, and the V less than sub>DD less than /sub> domain supply is maintained, allowing full debug capability. */
