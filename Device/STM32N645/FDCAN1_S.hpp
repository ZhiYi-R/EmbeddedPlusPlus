...
#ifndef EMBEDDED_PP_STM32N645_FDCAN1_S_HPP
#define EMBEDDED_PP_STM32N645_FDCAN1_S_HPP
...
namespace STM32N645::FDCAN1_S {
     ...
     *          - B_0x1: Synchronization deviation less than or equal SDL (value: 1)
     */
        /** @brief Local clock speed not synchronized to time master clock speed */
    constexpr std::uint32_t FDCAN_TTOST_QCS_B_0x0 = 0;
        /** @brief Synchronization deviation less than or equal SDL */
