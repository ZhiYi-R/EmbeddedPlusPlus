...
#ifndef EMBEDDED_PP_STM32N645_FMC1_S_HPP
#define EMBEDDED_PP_STM32N645_FMC1_S_HPP
...
namespace STM32N645::FMC1_S {
    ...
    /** @brief Chip Select (CS) counter */
    using FMC_BCR2_CSCOUNT0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Counter disabled (value: 0)
     *          - B_0x1: NEx deasserted after fmc_ker_ck clock cycle (value: 1)
     *          - B_0x2: NEx deasserted after 64 fmc_ker_ck clock cycles (value: 2)
    ...
    constexpr std::uint32_t FMC_BCR2_CSCOUNT0_B_0x1 = 1;
        /** @brief NEx deasserted after 64 fmc_ker_ck clock cycles */
    constexpr std::uint32_t FMC_BCR2_CSCOUNT0_B_0x2 = 2;
        /** @brief NEx deasserted after 256 fmc_ker_ck clock cycles */
    constexpr std::uint32_t FMC_BCR2_CSCOUNT0_B_0x3 = 3;
    ...
    /** @brief Chip Select (CS) counter */
    using FMC_BCR3_CSCOUNT0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Counter disabled (value: 0)
     *          - B_0x1: NEx deasserted after fmc_ker_ck clock cycle (value: 1)
     *          - B_0x2: NEx deasserted after 64 fmc_ker_ck clock cycles (value: 2)
    ...
    constexpr std::uint32_t FMC_BCR3_CSCOUNT0_B_0x1 = 1;
        /** @brief NEx deasserted after 64 fmc_ker_ck clock cycles */
    constexpr std::uint32_t FMC_BCR3_CSCOUNT0_B_0x2 = 2;
        /** @brief NEx deasserted after 256 fmc_ker_ck clock cycles */
    constexpr std::uint32_t FMC_BCR3_CSCOUNT0_B_0x3 = 3;
    ...
    /** @brief Chip Select (CS) counter */
    using FMC_BCR4_CSCOUNT0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Counter disabled (value: 0)
     *          - B_0x1: NEx deasserted after fmc_ker_ck clock cycle (value: 1)
     *          - B_0x2: NEx deasserted after 64 fmc_ker_ck clock cycles (value: 2)
    ...
    constexpr std::uint32_t FMC_BCR4_CSCOUNT0_B_0x1 = 1;
        /** @brief NEx deasserted after 64 fmc_ker_ck clock cycles */
    constexpr std::uint32_t FMC_BCR4_CSCOUNT0_B_0x2 = 2;
        /** @brief NEx deasserted after 256 fmc_ker_ck clock cycles */
    constexpr std::uint32_t FMC_BCR4_CSCOUNT0_B_0x3 = 3;
