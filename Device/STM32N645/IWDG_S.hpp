...
#ifndef EMBEDDED_PP_STM32N645_IWDG_S_HPP
#define EMBEDDED_PP_STM32N645_IWDG_S_HPP
...
namespace STM32N645::IWDG_S {
    ...
    using IWDG_SR_EWIF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using IWDG_ICR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x18, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Watchdog early interrupt acknowledge */
    using IWDG_ICR_EWIC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
