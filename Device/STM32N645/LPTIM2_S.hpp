...
#ifndef EMBEDDED_PP_STM32N645_LPTIM2_S_HPP
#define EMBEDDED_PP_STM32N645_LPTIM2_S_HPP
...
namespace STM32N645::LPTIM2_S {
    ...
    constexpr std::uint32_t LPTIM2_CCMR1_CC1P_B_0x0_CC1_AS_INPUT = 0;
        /** @brief falling edge, circuit is sensitive to IC1 falling edge */
    constexpr std::uint32_t LPTIM2_CCMR1_CC1P_B_0x1_CC1_AS_INPUT = 1;
    ...
    constexpr std::uint32_t LPTIM2_CCMR1_CC2P_B_0x0_CC2_AS_INPUT = 0;
        /** @brief falling edge, circuit is sensitive to IC2 falling edge */
    constexpr std::uint32_t LPTIM2_CCMR1_CC2P_B_0x1_CC2_AS_INPUT = 1;
