...
#ifndef EMBEDDED_PP_STM32N645_LPUART1_S_HPP
#define EMBEDDED_PP_STM32N645_LPUART1_S_HPP
...
namespace STM32N645::LPUART1_S {
    ...
    /** @details Possible values:
     *          - B_0x0: RX pin signal works using the standard logic levels (V less than sub>DD less than /sub> =1/idle, Gnd=0/mark) (value: 0)
     *          - B_0x1: RX pin signal values are inverted. ((V less than sub>DD less than /sub> =0/mark, Gnd=1/idle). (value: 1)
     */
        /** @brief RX pin signal works using the standard logic levels (V less than sub>DD less than /sub> =1/idle, Gnd=0/mark) */
    constexpr std::uint32_t LPUART_CR2_RXINV_B_0x0 = 0;
        /** @brief RX pin signal values are inverted. ((V less than sub>DD less than /sub> =0/mark, Gnd=1/idle). */
    ...
    /** @details Possible values:
     *          - B_0x0: TX pin signal works using the standard logic levels (V less than sub>DD less than /sub> =1/idle, Gnd=0/mark) (value: 0)
     *          - B_0x1: TX pin signal values are inverted. ((V less than sub>DD less than /sub> =0/mark, Gnd=1/idle). (value: 1)
     */
        /** @brief TX pin signal works using the standard logic levels (V less than sub>DD less than /sub> =1/idle, Gnd=0/mark) */
    constexpr std::uint32_t LPUART_CR2_TXINV_B_0x0 = 0;
        /** @brief TX pin signal values are inverted. ((V less than sub>DD less than /sub> =0/mark, Gnd=1/idle). */
