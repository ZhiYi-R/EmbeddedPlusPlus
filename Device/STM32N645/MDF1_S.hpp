...
#ifndef EMBEDDED_PP_STM32N645_MDF1_S_HPP
#define EMBEDDED_PP_STM32N645_MDF1_S_HPP
...
namespace STM32N645::MDF1_S {
     ...
     *          - B_0x1: CIC split in two filters and MCIC configured in Sinc less than sup>1 less than /sup> filter (value: 1)
     *          - B_0x2: CIC split in two filters and MCIC configured in Sinc less than sup>2 less than /sup> filter (value: 2)
     *          - B_0x3: CIC split in two filters and MCIC configured in Sinc less than sup>3 less than /sup> filter (value: 3)
     *          - B_0x4: CIC configured in single Sinc less than sup>4 less than /sup> filter (value: 4)
     */
        /** @brief CIC split in two filters and MCIC configured in FastSinc filter */
    constexpr std::uint32_t MDF_DFLT0CICR_CICMOD_B_0x0 = 0;
        /** @brief CIC split in two filters and MCIC configured in Sinc less than sup>1 less than /sup> filter */
    constexpr std::uint32_t MDF_DFLT0CICR_CICMOD_B_0x1 = 1;
        /** @brief CIC split in two filters and MCIC configured in Sinc less than sup>2 less than /sup> filter */
    constexpr std::uint32_t MDF_DFLT0CICR_CICMOD_B_0x2 = 2;
        /** @brief CIC split in two filters and MCIC configured in Sinc less than sup>3 less than /sup> filter */
    constexpr std::uint32_t MDF_DFLT0CICR_CICMOD_B_0x3 = 3;
        /** @brief CIC configured in single Sinc less than sup>4 less than /sup> filter */
    ...
    /** @details Possible values:
     *          - B_0x0: Cut-off frequency = 0.000625 x F less than sub>PCM less than /sub> (value: 0)
     *          - B_0x1: Cut-off frequency = 0.00125 x F less than sub>PCM less than /sub> (value: 1)
     *          - B_0x2: Cut-off frequency = 0.00250 x F less than sub>PCM less than /sub> (value: 2)
     *          - B_0x3: Cut-off frequency = 0.00950 x F less than sub>PCM less than /sub> (value: 3)
     */
        /** @brief Cut-off frequency = 0.000625 x F less than sub>PCM less than /sub> */
    constexpr std::uint32_t MDF_DFLT0RSFR_HPFC_B_0x0 = 0;
        /** @brief Cut-off frequency = 0.00125 x F less than sub>PCM less than /sub> */
    constexpr std::uint32_t MDF_DFLT0RSFR_HPFC_B_0x1 = 1;
        /** @brief Cut-off frequency = 0.00250 x F less than sub>PCM less than /sub> */
    constexpr std::uint32_t MDF_DFLT0RSFR_HPFC_B_0x2 = 2;
        /** @brief Cut-off frequency = 0.00950 x F less than sub>PCM less than /sub> */
     ...
     *          - B_0x1: Sinc less than sup>1 less than /sup> filter type (value: 1)
     *          - B_0x2: Sinc less than sup>2 less than /sup> filter type (value: 2)
     *          - B_0x3: Sinc less than sup>3 less than /sup> filter type (value: 3)
     */
        /** @brief FastSinc filter type */
    constexpr std::uint32_t MDF_OLD0CR_ACICN_B_0x0 = 0;
        /** @brief Sinc less than sup>1 less than /sup> filter type */
    constexpr std::uint32_t MDF_OLD0CR_ACICN_B_0x1 = 1;
        /** @brief Sinc less than sup>2 less than /sup> filter type */
    constexpr std::uint32_t MDF_OLD0CR_ACICN_B_0x2 = 2;
        /** @brief Sinc less than sup>3 less than /sup> filter type */
