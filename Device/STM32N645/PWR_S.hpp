...
#ifndef EMBEDDED_PP_STM32N645_PWR_S_HPP
#define EMBEDDED_PP_STM32N645_PWR_S_HPP
...
namespace STM32N645::PWR_S {
    ...
    /** @brief V less than sub>DDCORE less than /sub> monitoring enable */
    using PWR_CR3_VCOREMONEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDCORE less than /sub> monitoring disabled (value: 0)
     *          - B_0x1: V less than sub>DDCORE less than /sub> monitoring enabled (value: 1)
     */
        /** @brief V less than sub>DDCORE less than /sub> monitoring disabled */
    constexpr std::uint32_t PWR_CR3_VCOREMONEN_B_0x0 = 0;
        /** @brief V less than sub>DDCORE less than /sub> monitoring enabled */
    constexpr std::uint32_t PWR_CR3_VCOREMONEN_B_0x1 = 1;

    /** @brief V less than sub>DDCORE less than /sub> voltage detector low-level selection */
    using PWR_CR3_VCORELLS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDCORE less than /sub> low-voltage threshold 1 selected (VOS low) (value: 0)
     *          - B_0x1: V less than sub>DDCORE less than /sub> low-voltage threshold 2 selected (VOS high) (value: 1)
     */
        /** @brief V less than sub>DDCORE less than /sub> low-voltage threshold 1 selected (VOS low) */
    constexpr std::uint32_t PWR_CR3_VCORELLS_B_0x0 = 0;
        /** @brief V less than sub>DDCORE less than /sub> low-voltage threshold 2 selected (VOS high) */
    constexpr std::uint32_t PWR_CR3_VCORELLS_B_0x1 = 1;

    /** @brief Monitored V less than sub>DDCORE less than /sub> level above low threshold */
    using PWR_CR3_VCOREL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDCORE less than /sub> level above low threshold level, or monitor disabled (value: 0)
     *          - B_0x1: V less than sub>DDCORE less than /sub> level equal or below low threshold level (value: 1)
     */
        /** @brief V less than sub>DDCORE less than /sub> level above low threshold level, or monitor disabled */
    constexpr std::uint32_t PWR_CR3_VCOREL_B_0x0 = 0;
        /** @brief V less than sub>DDCORE less than /sub> level equal or below low threshold level */
    constexpr std::uint32_t PWR_CR3_VCOREL_B_0x1 = 1;

    /** @brief Monitored V less than sub>DDCORE less than /sub> level above high threshold */
    using PWR_CR3_VCOREH = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDCORE less than /sub> level below high threshold level, or monitor disabled (value: 0)
     *          - B_0x1: V less than sub>DDCORE less than /sub> level equal or above high threshold level (value: 1)
     */
        /** @brief V less than sub>DDCORE less than /sub> level below high threshold level, or monitor disabled */
    constexpr std::uint32_t PWR_CR3_VCOREH_B_0x0 = 0;
        /** @brief V less than sub>DDCORE less than /sub> level equal or above high threshold level */
    ...
    /** @brief VOS ready bit for V less than sub>CORE less than /sub> voltage scaling output selection */
    ...
    /** @brief VOS currently applied for V less than sub>CORE less than /sub> voltage scaling selection */
    ...
    /** @brief V less than sub>BAT less than /sub> and temperature monitoring enable */
    using PWR_BDCR1_MONEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>BAT less than /sub> and temperature monitoring disabled (value: 0)
     *          - B_0x1: V less than sub>BAT less than /sub> and temperature monitoring enabled (value: 1)
     */
        /** @brief V less than sub>BAT less than /sub> and temperature monitoring disabled */
    constexpr std::uint32_t PWR_BDCR1_MONEN_B_0x0 = 0;
        /** @brief V less than sub>BAT less than /sub> and temperature monitoring enabled */
    constexpr std::uint32_t PWR_BDCR1_MONEN_B_0x1 = 1;

    /** @brief V less than sub>BAT less than /sub> level monitoring versus low threshold */
    using PWR_BDCR1_VBATL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>BAT less than /sub> level above low threshold level (value: 0)
     *          - B_0x1: V less than sub>BAT less than /sub> level equal or below low threshold level (value: 1)
     */
        /** @brief V less than sub>BAT less than /sub> level above low threshold level */
    constexpr std::uint32_t PWR_BDCR1_VBATL_B_0x0 = 0;
        /** @brief V less than sub>BAT less than /sub> level equal or below low threshold level */
    constexpr std::uint32_t PWR_BDCR1_VBATL_B_0x1 = 1;

    /** @brief V less than sub>BAT less than /sub> level monitoring versus high threshold */
    using PWR_BDCR1_VBATH = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>BAT less than /sub> level below high threshold level. (value: 0)
     *          - B_0x1: V less than sub>BAT less than /sub> level equal or above high threshold level (value: 1)
     */
        /** @brief V less than sub>BAT less than /sub> level below high threshold level. */
    constexpr std::uint32_t PWR_BDCR1_VBATH_B_0x0 = 0;
        /** @brief V less than sub>BAT less than /sub> level equal or above high threshold level */
    ...
    /** @brief Backup RAM backup supply enable (used to maintain BKPRAM content in Standby and V less than sub>BAT less than /sub> modes). */
    ...
    /** @brief V less than sub>DDIO4 less than /sub>independent I/O voltage monitor enable */
    using PWR_SVMCR1_VDDIO4VMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDIO4 less than /sub> voltage monitor disabled (value: 0)
     *          - B_0x1: V less than sub>DDIO4 less than /sub> voltage monitor enabled (value: 1)
     */
        /** @brief V less than sub>DDIO4 less than /sub> voltage monitor disabled */
    constexpr std::uint32_t PWR_SVMCR1_VDDIO4VMEN_B_0x0 = 0;
        /** @brief V less than sub>DDIO4 less than /sub> voltage monitor enabled */
    constexpr std::uint32_t PWR_SVMCR1_VDDIO4VMEN_B_0x1 = 1;

    /** @brief V less than sub>DDIO4 less than /sub>independent I/O supply valid. */
    using PWR_SVMCR1_VDDIO4SV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDIO4 less than /sub> is not present. Logical and electrical isolation is applied to ignore this supply. (value: 0)
     *          - B_0x1: V less than sub>DDIO4 less than /sub> is valid. (value: 1)
     */
        /** @brief V less than sub>DDIO4 less than /sub> is not present. Logical and electrical isolation is applied to ignore this supply. */
    constexpr std::uint32_t PWR_SVMCR1_VDDIO4SV_B_0x0 = 0;
        /** @brief V less than sub>DDIO4 less than /sub> is valid. */
    constexpr std::uint32_t PWR_SVMCR1_VDDIO4SV_B_0x1 = 1;

    /** @brief V less than sub>DDIO4 less than /sub>ready */
    using PWR_SVMCR1_VDDIO4RDY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDIO4 less than /sub> is below the threshold of the V less than sub>DDIO4 less than /sub> voltage monitor. (value: 0)
     *          - B_0x1: V less than sub>DDIO4 less than /sub> is equal or above the threshold of the V less than sub>DDIO4 less than /sub> voltage monitor. (value: 1)
     */
        /** @brief V less than sub>DDIO4 less than /sub> is below the threshold of the V less than sub>DDIO4 less than /sub> voltage monitor. */
    constexpr std::uint32_t PWR_SVMCR1_VDDIO4RDY_B_0x0 = 0;
        /** @brief V less than sub>DDIO4 less than /sub> is equal or above the threshold of the V less than sub>DDIO4 less than /sub> voltage monitor. */
    constexpr std::uint32_t PWR_SVMCR1_VDDIO4RDY_B_0x1 = 1;

    /** @brief V less than sub>DDIO4 less than /sub> I/O voltage range selection */
    using PWR_SVMCR1_VDDIO4VRSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: 3v3 voltage range selected. If V less than sub>DDIO4 less than /sub> is in 1v8 range with this setting, I/Os work in degraded mode. (value: 0)
     *          - B_0x1: 1v8 voltage range selected. HSLV_VDDIO4 option bit must be set to allow 1v8 voltage range operation. Setting this configuration while V less than sub>DDIO4 less than /sub> is in 3v3 range damages the device. (value: 1)
     */
        /** @brief 3v3 voltage range selected. If V less than sub>DDIO4 less than /sub> is in 1v8 range with this setting, I/Os work in degraded mode. */
    constexpr std::uint32_t PWR_SVMCR1_VDDIO4VRSEL_B_0x0 = 0;
        /** @brief 1v8 voltage range selected. HSLV_VDDIO4 option bit must be set to allow 1v8 voltage range operation. Setting this configuration while V less than sub>DDIO4 less than /sub> is in 3v3 range damages the device. */
    constexpr std::uint32_t PWR_SVMCR1_VDDIO4VRSEL_B_0x1 = 1;

    /** @brief V less than sub>DDIO4 less than /sub> I/O voltage range Standby mode */
    ...
    /** @brief V less than sub>DDIO5 less than /sub>independent voltage monitor enable */
    using PWR_SVMCR2_VDDIO5VMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDIO5 less than /sub>voltage monitor disabled (value: 0)
     *          - B_0x1: V less than sub>DDIO5 less than /sub>voltage monitor enabled (value: 1)
     */
        /** @brief V less than sub>DDIO5 less than /sub>voltage monitor disabled */
    constexpr std::uint32_t PWR_SVMCR2_VDDIO5VMEN_B_0x0 = 0;
        /** @brief V less than sub>DDIO5 less than /sub>voltage monitor enabled */
    constexpr std::uint32_t PWR_SVMCR2_VDDIO5VMEN_B_0x1 = 1;

    /** @brief V less than sub>DDIO5 less than /sub>independent supply valid */
    using PWR_SVMCR2_VDDIO5SV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDIO5 less than /sub> is not present. Logical and electrical isolation is applied to ignore this supply. (value: 0)
     *          - B_0x1: V less than sub>DDIO5 less than /sub> is valid. (value: 1)
     */
        /** @brief V less than sub>DDIO5 less than /sub> is not present. Logical and electrical isolation is applied to ignore this supply. */
    constexpr std::uint32_t PWR_SVMCR2_VDDIO5SV_B_0x0 = 0;
        /** @brief V less than sub>DDIO5 less than /sub> is valid. */
    constexpr std::uint32_t PWR_SVMCR2_VDDIO5SV_B_0x1 = 1;

    /** @brief V less than sub>DDIO5 less than /sub>ready */
    using PWR_SVMCR2_VDDIO5RDY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDIO5 less than /sub> is below the threshold of the V less than sub>DDIO5 less than /sub> voltage monitor. (value: 0)
     *          - B_0x1: V less than sub>DDIO5 less than /sub> is equal or above the threshold of the V less than sub>DDIO5 less than /sub> voltage monitor. (value: 1)
     */
        /** @brief V less than sub>DDIO5 less than /sub> is below the threshold of the V less than sub>DDIO5 less than /sub> voltage monitor. */
    constexpr std::uint32_t PWR_SVMCR2_VDDIO5RDY_B_0x0 = 0;
        /** @brief V less than sub>DDIO5 less than /sub> is equal or above the threshold of the V less than sub>DDIO5 less than /sub> voltage monitor. */
    constexpr std::uint32_t PWR_SVMCR2_VDDIO5RDY_B_0x1 = 1;

    /** @brief V less than sub>DDIO5 less than /sub> I/O voltage range selection */
    using PWR_SVMCR2_VDDIO5VRSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: 3v3 voltage range selected. If V less than sub>DDIO5 less than /sub> is in 1v8 range with this setting, I/Os work in degraded mode. (value: 0)
     *          - B_0x1: 1v8 voltage range selected. HSLV_VDDIO5 option bit must be set to allow 1v8 voltage range operation. Setting this configuration while V less than sub>DDIO5 less than /sub> is in 3v3 range damages the device. (value: 1)
     */
        /** @brief 3v3 voltage range selected. If V less than sub>DDIO5 less than /sub> is in 1v8 range with this setting, I/Os work in degraded mode. */
    constexpr std::uint32_t PWR_SVMCR2_VDDIO5VRSEL_B_0x0 = 0;
        /** @brief 1v8 voltage range selected. HSLV_VDDIO5 option bit must be set to allow 1v8 voltage range operation. Setting this configuration while V less than sub>DDIO5 less than /sub> is in 3v3 range damages the device. */
    constexpr std::uint32_t PWR_SVMCR2_VDDIO5VRSEL_B_0x1 = 1;

    /** @brief V less than sub>DDIO5 less than /sub> I/O voltage range Standby mode */
    ...
    /** @brief V less than sub>DDIO2 less than /sub>independent voltage monitor enable */
    using PWR_SVMCR3_VDDIO2VMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDIO2 less than /sub> voltage monitor disabled (value: 0)
     *          - B_0x1: V less than sub>DDIO2 less than /sub> voltage monitor enabled (value: 1)
     */
        /** @brief V less than sub>DDIO2 less than /sub> voltage monitor disabled */
    constexpr std::uint32_t PWR_SVMCR3_VDDIO2VMEN_B_0x0 = 0;
        /** @brief V less than sub>DDIO2 less than /sub> voltage monitor enabled */
    constexpr std::uint32_t PWR_SVMCR3_VDDIO2VMEN_B_0x1 = 1;

    /** @brief V less than sub>DDIO3 less than /sub>independent voltage monitor enable */
    using PWR_SVMCR3_VDDIO3VMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDIO3 less than /sub> voltage monitor disabled (value: 0)
     *          - B_0x1: V less than sub>DDIO3 less than /sub> voltage monitor enabled (value: 1)
     */
        /** @brief V less than sub>DDIO3 less than /sub> voltage monitor disabled */
    constexpr std::uint32_t PWR_SVMCR3_VDDIO3VMEN_B_0x0 = 0;
        /** @brief V less than sub>DDIO3 less than /sub> voltage monitor enabled */
    constexpr std::uint32_t PWR_SVMCR3_VDDIO3VMEN_B_0x1 = 1;

    /** @brief V less than sub>DD33USB less than /sub>independent USB 33 voltage monitor enable. */
    using PWR_SVMCR3_USB33VMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DD33USB less than /sub> voltage monitor disabled (value: 0)
     *          - B_0x1: V less than sub>DD33USB less than /sub> voltage monitor enabled (value: 1)
     */
        /** @brief V less than sub>DD33USB less than /sub> voltage monitor disabled */
    constexpr std::uint32_t PWR_SVMCR3_USB33VMEN_B_0x0 = 0;
        /** @brief V less than sub>DD33USB less than /sub> voltage monitor enabled */
    constexpr std::uint32_t PWR_SVMCR3_USB33VMEN_B_0x1 = 1;

    /** @brief V less than sub>DDA18ADC less than /sub>independent ADC voltage monitor enable */
    using PWR_SVMCR3_AVMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDA18ADC less than /sub> voltage monitor disabled (value: 0)
     *          - B_0x1: V less than sub>DDA18ADC less than /sub> voltage monitor enabled (value: 1)
     */
        /** @brief V less than sub>DDA18ADC less than /sub> voltage monitor disabled */
    constexpr std::uint32_t PWR_SVMCR3_AVMEN_B_0x0 = 0;
        /** @brief V less than sub>DDA18ADC less than /sub> voltage monitor enabled */
    constexpr std::uint32_t PWR_SVMCR3_AVMEN_B_0x1 = 1;

    /** @brief V less than sub>DDIO2 less than /sub>independent supply valid. */
    using PWR_SVMCR3_VDDIO2SV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDIO2 less than /sub> is not present. Logical and electrical isolation is applied to ignore this supply. (value: 0)
     *          - B_0x1: V less than sub>DDIO2 less than /sub> is valid. (value: 1)
     */
        /** @brief V less than sub>DDIO2 less than /sub> is not present. Logical and electrical isolation is applied to ignore this supply. */
    constexpr std::uint32_t PWR_SVMCR3_VDDIO2SV_B_0x0 = 0;
        /** @brief V less than sub>DDIO2 less than /sub> is valid. */
    constexpr std::uint32_t PWR_SVMCR3_VDDIO2SV_B_0x1 = 1;

    /** @brief V less than sub>DDIO3 less than /sub>independent supply valid */
    using PWR_SVMCR3_VDDIO3SV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDIO3 less than /sub> is not present. Logical and electrical isolation is applied to ignore this supply. (value: 0)
     *          - B_0x1: V less than sub>DDIO3 less than /sub> is valid. (value: 1)
     */
        /** @brief V less than sub>DDIO3 less than /sub> is not present. Logical and electrical isolation is applied to ignore this supply. */
    constexpr std::uint32_t PWR_SVMCR3_VDDIO3SV_B_0x0 = 0;
        /** @brief V less than sub>DDIO3 less than /sub> is valid. */
    constexpr std::uint32_t PWR_SVMCR3_VDDIO3SV_B_0x1 = 1;

    /** @brief V less than sub>DD33USB less than /sub>independent supply valid */
    using PWR_SVMCR3_USB33SV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DD33USB less than /sub> is not present. Logical and electrical isolation is applied to ignore this supply. (value: 0)
     *          - B_0x1: V less than sub>DD33USB less than /sub> is valid. (value: 1)
     */
        /** @brief V less than sub>DD33USB less than /sub> is not present. Logical and electrical isolation is applied to ignore this supply. */
    constexpr std::uint32_t PWR_SVMCR3_USB33SV_B_0x0 = 0;
        /** @brief V less than sub>DD33USB less than /sub> is valid. */
    constexpr std::uint32_t PWR_SVMCR3_USB33SV_B_0x1 = 1;

    /** @brief V less than sub>DDA18ADC less than /sub>independent supply valid */
    using PWR_SVMCR3_ASV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDA18ADC less than /sub> is not present. Logical and electrical isolation is applied to ignore this supply. (value: 0)
     *          - B_0x1: V less than sub>DDA18ADC less than /sub> is valid. (value: 1)
     */
        /** @brief V less than sub>DDA18ADC less than /sub> is not present. Logical and electrical isolation is applied to ignore this supply. */
    constexpr std::uint32_t PWR_SVMCR3_ASV_B_0x0 = 0;
        /** @brief V less than sub>DDA18ADC less than /sub> is valid. */
    constexpr std::uint32_t PWR_SVMCR3_ASV_B_0x1 = 1;

    /** @brief V less than sub>DDIO2 less than /sub>ready */
    using PWR_SVMCR3_VDDIO2RDY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDIO2 less than /sub> is below the threshold of the VDDIO2 voltage monitor. (value: 0)
     *          - B_0x1: V less than sub>DDIO2 less than /sub> is equal or above the threshold of the VDDIO2 voltage monitor. (value: 1)
     */
        /** @brief V less than sub>DDIO2 less than /sub> is below the threshold of the VDDIO2 voltage monitor. */
    constexpr std::uint32_t PWR_SVMCR3_VDDIO2RDY_B_0x0 = 0;
        /** @brief V less than sub>DDIO2 less than /sub> is equal or above the threshold of the VDDIO2 voltage monitor. */
    constexpr std::uint32_t PWR_SVMCR3_VDDIO2RDY_B_0x1 = 1;

    /** @brief V less than sub>DDIO3 less than /sub>ready */
    using PWR_SVMCR3_VDDIO3RDY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDIO3 less than /sub> is below the threshold of the VDDIO3 voltage monitor. (value: 0)
     *          - B_0x1: V less than sub>DDIO3 less than /sub> is equal or above the threshold of the VDDIO3 voltage monitor. (value: 1)
     */
        /** @brief V less than sub>DDIO3 less than /sub> is below the threshold of the VDDIO3 voltage monitor. */
    constexpr std::uint32_t PWR_SVMCR3_VDDIO3RDY_B_0x0 = 0;
        /** @brief V less than sub>DDIO3 less than /sub> is equal or above the threshold of the VDDIO3 voltage monitor. */
    constexpr std::uint32_t PWR_SVMCR3_VDDIO3RDY_B_0x1 = 1;

    /** @brief V less than sub>DD33USB less than /sub>ready */
    using PWR_SVMCR3_USB33RDY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DD33USB less than /sub> is below the threshold of the USB33 voltage monitor. (value: 0)
     *          - B_0x1: V less than sub>DD33USB less than /sub> is equal or above the threshold of the USB33 voltage monitor. (value: 1)
     */
        /** @brief V less than sub>DD33USB less than /sub> is below the threshold of the USB33 voltage monitor. */
    constexpr std::uint32_t PWR_SVMCR3_USB33RDY_B_0x0 = 0;
        /** @brief V less than sub>DD33USB less than /sub> is equal or above the threshold of the USB33 voltage monitor. */
    constexpr std::uint32_t PWR_SVMCR3_USB33RDY_B_0x1 = 1;

    /** @brief V less than sub>DDA18ADC less than /sub>ready */
    using PWR_SVMCR3_ARDY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>DDA18ADC less than /sub> is below the threshold of the VDDA18ADC voltage monitor. (value: 0)
     *          - B_0x1: V less than sub>DDA18ADC less than /sub> is equal or above the threshold of the VDDA18ADC voltage monitor. (value: 1)
     */
        /** @brief V less than sub>DDA18ADC less than /sub> is below the threshold of the VDDA18ADC voltage monitor. */
    constexpr std::uint32_t PWR_SVMCR3_ARDY_B_0x0 = 0;
        /** @brief V less than sub>DDA18ADC less than /sub> is equal or above the threshold of the VDDA18ADC voltage monitor. */
    constexpr std::uint32_t PWR_SVMCR3_ARDY_B_0x1 = 1;

    /** @brief V less than sub>DD less than /sub> I/O voltage range selection */
    using PWR_SVMCR3_VDDIOVRSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: 3v3 voltage range selected. If V less than sub>DD less than /sub> is in 1v8 range with this setting, I/Os work in degraded mode. (value: 0)
     *          - B_0x1: 1v8 voltage range selected. HSLV_VDD option bit must be set to allow 1v8 voltage range operation. Setting this configuration while V less than sub>DD less than /sub> is in 3v3 range damages the device. (value: 1)
     */
        /** @brief 3v3 voltage range selected. If V less than sub>DD less than /sub> is in 1v8 range with this setting, I/Os work in degraded mode. */
    constexpr std::uint32_t PWR_SVMCR3_VDDIOVRSEL_B_0x0 = 0;
        /** @brief 1v8 voltage range selected. HSLV_VDD option bit must be set to allow 1v8 voltage range operation. Setting this configuration while V less than sub>DD less than /sub> is in 3v3 range damages the device. */
    constexpr std::uint32_t PWR_SVMCR3_VDDIOVRSEL_B_0x1 = 1;

    /** @brief V less than sub>DDIO2 less than /sub> I/O voltage range selection */
    using PWR_SVMCR3_VDDIO2VRSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: 3v3 voltage range selected. If V less than sub>DDIO2 less than /sub> is in 1v8 range with this setting, I/Os work in degraded mode. (value: 0)
     *          - B_0x1: 1v8 voltage range selected. HSLV_VDDIO2 option bit must be set to allow 1v8 voltage range operation. Setting this configuration while V less than sub>DDIO2 less than /sub> is in 3v3 range damages the device. (value: 1)
     */
        /** @brief 3v3 voltage range selected. If V less than sub>DDIO2 less than /sub> is in 1v8 range with this setting, I/Os work in degraded mode. */
    constexpr std::uint32_t PWR_SVMCR3_VDDIO2VRSEL_B_0x0 = 0;
        /** @brief 1v8 voltage range selected. HSLV_VDDIO2 option bit must be set to allow 1v8 voltage range operation. Setting this configuration while V less than sub>DDIO2 less than /sub> is in 3v3 range damages the device. */
    constexpr std::uint32_t PWR_SVMCR3_VDDIO2VRSEL_B_0x1 = 1;

    /** @brief V less than sub>DDIO3 less than /sub> I/O voltage range selection */
    using PWR_SVMCR3_VDDIO3VRSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: 3v3 voltage range selected. If V less than sub>DDIO3 less than /sub> is in 1v8 range with this setting, I/Os work in degraded mode. (value: 0)
     *          - B_0x1: 1v8 voltage range selected. HSLV_VDDIO3 option bit must be set to allow 1v8 voltage range operation. Setting this configuration while V less than sub>DDIO3 less than /sub> is in 3v3 range damages the device. (value: 1)
     */
        /** @brief 3v3 voltage range selected. If V less than sub>DDIO3 less than /sub> is in 1v8 range with this setting, I/Os work in degraded mode. */
    constexpr std::uint32_t PWR_SVMCR3_VDDIO3VRSEL_B_0x0 = 0;
        /** @brief 1v8 voltage range selected. HSLV_VDDIO3 option bit must be set to allow 1v8 voltage range operation. Setting this configuration while V less than sub>DDIO3 less than /sub> is in 3v3 range damages the device. */
    ...
    /** @brief V less than sub>DDCORE less than /sub> monitor secure protection */
    ...
    /** @brief V less than sub>DDCORE less than /sub> monitor privileged protection */
