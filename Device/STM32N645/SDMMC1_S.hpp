...
#ifndef EMBEDDED_PP_STM32N645_SDMMC1_S_HPP
#define EMBEDDED_PP_STM32N645_SDMMC1_S_HPP
...
namespace STM32N645::SDMMC1_S {
    ...
    /** @details Possible values:
     *          - B_0x0: Block length = 2 less than sup>0 less than /sup> = 1 byte (value: 0)
     *          - B_0x1: Block length = 2 less than sup>1 less than /sup> = 2 bytes (value: 1)
     *          - B_0x2: Block length = 2 less than sup>2 less than /sup>= 4 bytes (value: 2)
     *          - B_0x3: Block length = 2 less than sup>3 less than /sup> = 8 bytes (value: 3)
     *          - B_0x4: Block length = 2 less than sup>4 less than /sup> = 16 bytes (value: 4)
     *          - B_0x5: Block length = 2 less than sup>5 less than /sup> = 32 bytes (value: 5)
     *          - B_0x6: Block length = 2 less than sup>6 less than /sup> = 64 bytes (value: 6)
     *          - B_0x7: Block length = 2 less than sup>7 less than /sup> = 128 bytes (value: 7)
     *          - B_0x8: Block length = 2 less than sup>8 less than /sup> = 256 bytes (value: 8)
     *          - B_0x9: Block length = 2 less than sup>9 less than /sup> = 512 bytes (value: 9)
     *          - B_0xA: Block length = 2 less than sup>10 less than /sup> = 1024 bytes (value: 10)
     *          - B_0xB: Block length = 2 less than sup>11 less than /sup> = 2048 bytes (value: 11)
     *          - B_0xC: Block length = 2 less than sup>12 less than /sup> = 4096 bytes (value: 12)
     *          - B_0xD: Block length = 2 less than sup>13 less than /sup> = 8192 bytes (value: 13)
     *          - B_0xE: Block length = 2 less than sup>14 less than /sup> = 16384 bytes (value: 14)
     */
        /** @brief Block length = 2 less than sup>0 less than /sup> = 1 byte */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x0 = 0;
        /** @brief Block length = 2 less than sup>1 less than /sup> = 2 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x1 = 1;
        /** @brief Block length = 2 less than sup>2 less than /sup>= 4 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x2 = 2;
        /** @brief Block length = 2 less than sup>3 less than /sup> = 8 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x3 = 3;
        /** @brief Block length = 2 less than sup>4 less than /sup> = 16 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x4 = 4;
        /** @brief Block length = 2 less than sup>5 less than /sup> = 32 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x5 = 5;
        /** @brief Block length = 2 less than sup>6 less than /sup> = 64 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x6 = 6;
        /** @brief Block length = 2 less than sup>7 less than /sup> = 128 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x7 = 7;
        /** @brief Block length = 2 less than sup>8 less than /sup> = 256 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x8 = 8;
        /** @brief Block length = 2 less than sup>9 less than /sup> = 512 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0x9 = 9;
        /** @brief Block length = 2 less than sup>10 less than /sup> = 1024 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0xA = 10;
        /** @brief Block length = 2 less than sup>11 less than /sup> = 2048 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0xB = 11;
        /** @brief Block length = 2 less than sup>12 less than /sup> = 4096 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0xC = 12;
        /** @brief Block length = 2 less than sup>13 less than /sup> = 8192 bytes */
    constexpr std::uint32_t SDMMC_DCTRL_DBLOCKSIZE_B_0xD = 13;
        /** @brief Block length = 2 less than sup>14 less than /sup> = 16384 bytes */
