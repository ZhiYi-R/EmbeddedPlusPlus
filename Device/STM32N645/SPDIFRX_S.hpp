...
#ifndef EMBEDDED_PP_STM32N645_SPDIFRX_S_HPP
#define EMBEDDED_PP_STM32N645_SPDIFRX_S_HPP
...
namespace STM32N645::SPDIFRX_S {
    ...
    /** @brief Peripheral block enable less than sup>(1) less than /sup> */
    ...
    /** @brief Receiver DMA enable for data flow less than sup>(1) less than /sup> */
    ...
    /** @brief Stereo mode less than sup>(1) less than /sup> */
    ...
    /** @brief RX data format less than sup>(1) less than /sup> */
    ...
    /** @brief Mask parity error bit less than sup>(1) less than /sup> */
    ...
    /** @brief Mask of validity bit less than sup>(1) less than /sup> */
    ...
    /** @brief Mask of channel status and user bits less than sup>(1) less than /sup> */
    ...
    /** @brief Mask of preamble type bits less than sup>(1) less than /sup> */
    ...
    /** @brief Control buffer DMA enable for control flow less than sup>(1) less than /sup> */
    ...
    /** @brief Channel selection less than sup>(1) less than /sup> */
    ...
    /** @brief Maximum allowed re-tries during synchronization phase less than sup>(1) less than /sup> */
    ...
    /** @brief Wait for activity less than sup>(1) less than /sup> */
    ...
    /** @brief threshold HIGH (THI = 2.5 x UI / T less than sub>spdifrx_ker_ck less than /sub>) */
    using SPDIFRX_DIR_THI = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 13, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief threshold LOW (TLO = 1.5 x UI / T less than sub>spdifrx_ker_ck less than /sub>) */
