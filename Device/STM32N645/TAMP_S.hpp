...
#ifndef EMBEDDED_PP_STM32N645_TAMP_S_HPP
#define EMBEDDED_PP_STM32N645_TAMP_S_HPP
...
namespace STM32N645::TAMP_S {
    ...
    /** @brief Tamper detection on TAMP_IN2 enable less than sup>(1) less than /sup> */
    ...
    /** @brief Tamper detection on TAMP_IN3 enable less than sup>(1) less than /sup> */
    ...
    /** @brief Tamper detection on TAMP_IN4 enable less than sup>(1) less than /sup> */
    ...
    /** @brief Tamper detection on TAMP_IN5 enable less than sup>(1) less than /sup> */
    ...
    /** @brief Tamper detection on TAMP_IN6 enable less than sup>(1) less than /sup> */
    ...
    /** @brief Tamper detection on TAMP_IN7 enable less than sup>(1) less than /sup> */
    ...
    /** @details Possible values:
     *          - B_0x0: Tamper 2 event detection is in confirmed mode less than sup>(1) less than /sup>. (value: 0)
     *          - B_0x1: Tamper 2 event detection is in potential mode less than sup>(2) less than /sup>. (value: 1)
     */
        /** @brief Tamper 2 event detection is in confirmed mode less than sup>(1) less than /sup>. */
    constexpr std::uint32_t TAMP_CR2_TAMP2POM_B_0x0 = 0;
        /** @brief Tamper 2 event detection is in potential mode less than sup>(2) less than /sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Tamper 3 event detection is in confirmed mode less than sup>(1) less than /sup>. (value: 0)
     *          - B_0x1: Tamper 3 event detection is in potential mode less than sup>(2) less than /sup>. (value: 1)
     */
        /** @brief Tamper 3 event detection is in confirmed mode less than sup>(1) less than /sup>. */
    constexpr std::uint32_t TAMP_CR2_TAMP3POM_B_0x0 = 0;
        /** @brief Tamper 3 event detection is in potential mode less than sup>(2) less than /sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Tamper 4 event detection is in confirmed mode less than sup>(1) less than /sup>. (value: 0)
     *          - B_0x1: Tamper 4 event detection is in potential mode less than sup>(2) less than /sup>. (value: 1)
     */
        /** @brief Tamper 4 event detection is in confirmed mode less than sup>(1) less than /sup>. */
    constexpr std::uint32_t TAMP_CR2_TAMP4POM_B_0x0 = 0;
        /** @brief Tamper 4 event detection is in potential mode less than sup>(2) less than /sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Tamper 5 event detection is in confirmed mode less than sup>(1) less than /sup>. (value: 0)
     *          - B_0x1: Tamper 5 event detection is in potential mode less than sup>(2) less than /sup>. (value: 1)
     */
        /** @brief Tamper 5 event detection is in confirmed mode less than sup>(1) less than /sup>. */
    constexpr std::uint32_t TAMP_CR2_TAMP5POM_B_0x0 = 0;
        /** @brief Tamper 5 event detection is in potential mode less than sup>(2) less than /sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Tamper 6 event detection is in confirmed mode less than sup>(1) less than /sup>. (value: 0)
     *          - B_0x1: Tamper 6 event detection is in potential mode less than sup>(2) less than /sup>. (value: 1)
     */
        /** @brief Tamper 6 event detection is in confirmed mode less than sup>(1) less than /sup>. */
    constexpr std::uint32_t TAMP_CR2_TAMP6POM_B_0x0 = 0;
        /** @brief Tamper 6 event detection is in potential mode less than sup>(2) less than /sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Tamper 7 event detection is in confirmed mode less than sup>(1) less than /sup>. (value: 0)
     *          - B_0x1: Tamper 7 event detection is in potential mode less than sup>(2) less than /sup>. (value: 1)
     */
        /** @brief Tamper 7 event detection is in confirmed mode less than sup>(1) less than /sup>. */
    constexpr std::uint32_t TAMP_CR2_TAMP7POM_B_0x0 = 0;
        /** @brief Tamper 7 event detection is in potential mode less than sup>(2) less than /sup>. */
     ...
     *          - B_0x1: Tamper 1 event generates a trigger event. TAMP1F is masked and internally cleared by hardware. The backup registers and device secrets less than sup>(1) less than /sup> are not erased. (value: 1)
     */
    ...
    constexpr std::uint32_t TAMP_CR2_TAMP1MSK_B_0x0 = 0;
        /** @brief Tamper 1 event generates a trigger event. TAMP1F is masked and internally cleared by hardware. The backup registers and device secrets less than sup>(1) less than /sup> are not erased. */
     ...
     *          - B_0x1: Tamper 2 event generates a trigger event. TAMP2F is masked and internally cleared by hardware. The backup registers and device secrets less than sup>(1) less than /sup> are not erased. (value: 1)
     */
    ...
    constexpr std::uint32_t TAMP_CR2_TAMP2MSK_B_0x0 = 0;
        /** @brief Tamper 2 event generates a trigger event. TAMP2F is masked and internally cleared by hardware. The backup registers and device secrets less than sup>(1) less than /sup> are not erased. */
     ...
     *          - B_0x1: Tamper 3 event generates a trigger event. TAMP3F is masked and internally cleared by hardware. The backup registers and device secrets less than sup>(1) less than /sup> are not erased. (value: 1)
     */
    ...
    constexpr std::uint32_t TAMP_CR2_TAMP3MSK_B_0x0 = 0;
        /** @brief Tamper 3 event generates a trigger event. TAMP3F is masked and internally cleared by hardware. The backup registers and device secrets less than sup>(1) less than /sup> are not erased. */
    constexpr std::uint32_t TAMP_CR2_TAMP3MSK_B_0x1 = 1;

    /** @brief Backup registers and device secrets less than sup>(1) less than /sup> access blocked */
    using TAMP_CR2_BKBLOCK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: backup registers and device secrets less than sup>(1) less than /sup> can be accessed if no tamper flag is set (value: 0)
     *          - B_0x1: backup registers and device secrets less than sup>(1) less than /sup> cannot be accessed (value: 1)
     */
        /** @brief backup registers and device secrets less than sup>(1) less than /sup> can be accessed if no tamper flag is set */
    constexpr std::uint32_t TAMP_CR2_BKBLOCK_B_0x0 = 0;
        /** @brief backup registers and device secrets less than sup>(1) less than /sup> cannot be accessed */
    constexpr std::uint32_t TAMP_CR2_BKBLOCK_B_0x1 = 1;

    /** @brief Backup registers and device secrets less than sup>(1) less than /sup> erase */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal tamper 1 event detection is in confirmed mode less than sup>(1) less than /sup>. (value: 0)
     *          - B_0x1: Internal tamper 1 event detection is in potential mode less than sup>(2) less than /sup>. (value: 1)
     */
        /** @brief Internal tamper 1 event detection is in confirmed mode less than sup>(1) less than /sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP1POM_B_0x0 = 0;
        /** @brief Internal tamper 1 event detection is in potential mode less than sup>(2) less than /sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal tamper 2 event detection is in confirmed mode less than sup>(1) less than /sup>. (value: 0)
     *          - B_0x1: Internal tamper 2 event detection is in potential mode less than sup>(2) less than /sup>. (value: 1)
     */
        /** @brief Internal tamper 2 event detection is in confirmed mode less than sup>(1) less than /sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP2POM_B_0x0 = 0;
        /** @brief Internal tamper 2 event detection is in potential mode less than sup>(2) less than /sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal tamper 3 event detection is in confirmed mode less than sup>(1) less than /sup>. (value: 0)
     *          - B_0x1: Internal tamper 3 event detection is in potential mode less than sup>(2) less than /sup>. (value: 1)
     */
        /** @brief Internal tamper 3 event detection is in confirmed mode less than sup>(1) less than /sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP3POM_B_0x0 = 0;
        /** @brief Internal tamper 3 event detection is in potential mode less than sup>(2) less than /sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal tamper 4 event detection is in confirmed mode less than sup>(1) less than /sup>. (value: 0)
     *          - B_0x1: Internal tamper 4 event detection is in potential mode less than sup>(2) less than /sup>. (value: 1)
     */
        /** @brief Internal tamper 4 event detection is in confirmed mode less than sup>(1) less than /sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP4POM_B_0x0 = 0;
        /** @brief Internal tamper 4 event detection is in potential mode less than sup>(2) less than /sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal tamper 5 event detection is in confirmed mode less than sup>(1) less than /sup>. (value: 0)
     *          - B_0x1: Internal tamper 5 event detection is in potential mode less than sup>(2) less than /sup>. (value: 1)
     */
        /** @brief Internal tamper 5 event detection is in confirmed mode less than sup>(1) less than /sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP5POM_B_0x0 = 0;
        /** @brief Internal tamper 5 event detection is in potential mode less than sup>(2) less than /sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal tamper 7 event detection is in confirmed mode less than sup>(1) less than /sup>. (value: 0)
     *          - B_0x1: Internal tamper 7 event detection is in potential mode less than sup>(2) less than /sup>. (value: 1)
     */
        /** @brief Internal tamper 7 event detection is in confirmed mode less than sup>(1) less than /sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP7POM_B_0x0 = 0;
        /** @brief Internal tamper 7 event detection is in potential mode less than sup>(2) less than /sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal tamper 8 event detection is in confirmed mode less than sup>(1) less than /sup>. (value: 0)
     *          - B_0x1: Internal tamper 8 event detection is in potential mode less than sup>(2) less than /sup>. (value: 1)
     */
        /** @brief Internal tamper 8 event detection is in confirmed mode less than sup>(1) less than /sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP8POM_B_0x0 = 0;
        /** @brief Internal tamper 8 event detection is in potential mode less than sup>(2) less than /sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal tamper 9 event detection is in confirmed mode less than sup>(1) less than /sup>. (value: 0)
     *          - B_0x1: Internal tamper 9 event detection is in potential mode less than sup>(2) less than /sup>. (value: 1)
     */
        /** @brief Internal tamper 9 event detection is in confirmed mode less than sup>(1) less than /sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP9POM_B_0x0 = 0;
        /** @brief Internal tamper 9 event detection is in potential mode less than sup>(2) less than /sup>. */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal tamper 11 event detection is in confirmed mode less than sup>(1) less than /sup>. (value: 0)
     *          - B_0x1: Internal tamper 11 event detection is in potential mode less than sup>(2) less than /sup>. (value: 1)
     */
        /** @brief Internal tamper 11 event detection is in confirmed mode less than sup>(1) less than /sup>. */
    constexpr std::uint32_t TAMP_CR3_ITAMP11POM_B_0x0 = 0;
        /** @brief Internal tamper 11 event detection is in potential mode less than sup>(2) less than /sup>. */
    ...
    /** @brief V less than sub>CORE less than /sub> monitoring */
    using TAMP_OR_VCOREMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: V less than sub>CORE less than /sub> monitoring disable (value: 0)
     *          - B_0x1: V less than sub>CORE less than /sub> monitoring enable (value: 1)
     */
        /** @brief V less than sub>CORE less than /sub> monitoring disable */
    constexpr std::uint32_t TAMP_OR_VCOREMEN_B_0x0 = 0;
        /** @brief V less than sub>CORE less than /sub> monitoring enable */
