...
#ifndef EMBEDDED_PP_STM32N645_TIM12_S_HPP
#define EMBEDDED_PP_STM32N645_TIM12_S_HPP
...
namespace STM32N645::TIM12_S {
    ...
    using TIM12_CR2_MMS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM12_CR2_MMS_B_0x0 = 0;
        /** @brief Enable - the Counter Enable signal CNT_EN is used as trigger output (tim_trgo). It is useful to start several timers at the same time or to control a window in which a slave timer is enable. The Counter Enable signal is generated by a logic AND between CEN control bit and the trigger input when configured in gated mode. When the Counter Enable signal is controlled by the trigger input, there is a delay on tim_trgo, except if the master/slave mode is selected (see the MSM bit description in TIMx_SMCR register). */
    constexpr std::uint32_t TIM12_CR2_MMS_B_0x1 = 1;
    ...
    constexpr std::uint32_t TIM12_CR2_MMS_B_0x2 = 2;
    ...
    using TIM12_CR2_ADSYNC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: The timer operates independently from the ADC (value: 0)
     *          - B_0x1: The timer operation is synchronized with the ADC clock to provide jitter-free sampling point. This mode can be enabled only with specific ADC / timer clock relationship. Refer to Section 49.4.23 for requirements. (value: 1)
     */
        /** @brief The timer operates independently from the ADC */
    constexpr std::uint32_t TIM12_CR2_ADSYNC_B_0x0 = 0;
        /** @brief The timer operation is synchronized with the ADC clock to provide jitter-free sampling point. This mode can be enabled only with specific ADC / timer clock relationship. Refer to Section 49.4.23 for requirements. */
    constexpr std::uint32_t TIM12_CR2_ADSYNC_B_0x1 = 1;
    ...
    using TIM12_CCMR1_Output_OC1M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     ...
     *          - B_0x6: PWM mode 1 - channel 1 is active as long as TIMx_CNT less than TIMx_CCR1 else it is inactive (value: 6)
     *          - B_0x7: PWM mode 2 - channel 1 is inactive as long as TIMx_CNT less than TIMx_CCR1 else it is active (value: 7)
     */
    ...
    constexpr std::uint32_t TIM12_CCMR1_Output_OC1M_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM12_CCMR1_Output_OC1M_B_0x1 = 1;
    ...
    constexpr std::uint32_t TIM12_CCMR1_Output_OC1M_B_0x2 = 2;
        /** @brief Toggle - tim_oc1ref toggles when TIMx_CNT=TIMx_CCR1 */
    constexpr std::uint32_t TIM12_CCMR1_Output_OC1M_B_0x3 = 3;
        /** @brief Force inactive level - tim_oc1ref is forced low */
    constexpr std::uint32_t TIM12_CCMR1_Output_OC1M_B_0x4 = 4;
        /** @brief Force active level - tim_oc1ref is forced high */
    constexpr std::uint32_t TIM12_CCMR1_Output_OC1M_B_0x5 = 5;
        /** @brief PWM mode 1 - channel 1 is active as long as TIMx_CNT less than TIMx_CCR1 else it is inactive */
    constexpr std::uint32_t TIM12_CCMR1_Output_OC1M_B_0x6 = 6;
        /** @brief PWM mode 2 - channel 1 is inactive as long as TIMx_CNT less than TIMx_CCR1 else it is active */
    constexpr std::uint32_t TIM12_CCMR1_Output_OC1M_B_0x7 = 7;
    ...
    using TIM12_CCMR1_Output_OC2M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC1M[3] */
    using TIM12_CCMR1_Output_OC1M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC2M[3] */
    using TIM12_CCMR1_Output_OC2M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
