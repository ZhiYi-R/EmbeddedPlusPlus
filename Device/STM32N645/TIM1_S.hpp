...
#ifndef EMBEDDED_PP_STM32N645_TIM1_S_HPP
#define EMBEDDED_PP_STM32N645_TIM1_S_HPP
...
namespace STM32N645::TIM1_S {
     ...
     *          - B_0x1: The timer operation is synchronized with the ADC clock to provide jitter-free sampling point. This mode can be enabled only with specific ADC / timer clock relationship. Refer to Section 46.3.32 for requirements. (value: 1)
     */
        /** @brief The timer operates independently from the ADC */
    constexpr std::uint32_t TIM1_CR2_ADSYNC_B_0x0 = 0;
        /** @brief The timer operation is synchronized with the ADC clock to provide jitter-free sampling point. This mode can be enabled only with specific ADC / timer clock relationship. Refer to Section 46.3.32 for requirements. */
     ...
     *          - B_0x6: PWM mode 1 - In upcounting, channel 3 is active as long as TIMx_CNT less than TIMx_CCR3 else inactive. In downcounting, channel 3 is inactive (tim_oc3ref=0') as long as TIMx_CNT>TIMx_CCR3 else active (tim_oc3ref='1'). (value: 6)
     *          - B_0x7: PWM mode 2 - In upcounting, channel 3 is inactive as long as TIMx_CNT less than TIMx_CCR3 else active. In downcounting, channel 3 is active as long as TIMx_CNT>TIMx_CCR3 else inactive. (value: 7)
     */
    ...
    constexpr std::uint32_t TIM1_CCMR2_Output_OC3M_B_0x5 = 5;
        /** @brief PWM mode 1 - In upcounting, channel 3 is active as long as TIMx_CNT less than TIMx_CCR3 else inactive. In downcounting, channel 3 is inactive (tim_oc3ref=0') as long as TIMx_CNT>TIMx_CCR3 else active (tim_oc3ref='1'). */
    constexpr std::uint32_t TIM1_CCMR2_Output_OC3M_B_0x6 = 6;
        /** @brief PWM mode 2 - In upcounting, channel 3 is inactive as long as TIMx_CNT less than TIMx_CCR3 else active. In downcounting, channel 3 is active as long as TIMx_CNT>TIMx_CCR3 else inactive. */
