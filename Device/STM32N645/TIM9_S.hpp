...
#ifndef EMBEDDED_PP_STM32N645_TIM9_S_HPP
#define EMBEDDED_PP_STM32N645_TIM9_S_HPP
...
namespace STM32N645::TIM9_S {
    ...
    using TIM9_CR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Master mode selection */
    using TIM9_CR2_MMS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM9_CR2_MMS_B_0x0 = 0;
        /** @brief Enable - the Counter Enable signal CNT_EN is used as trigger output (tim_trgo). It is useful to start several timers at the same time or to control a window in which a slave timer is enable. The Counter Enable signal is generated by a logic AND between CEN control bit and the trigger input when configured in gated mode. When the Counter Enable signal is controlled by the trigger input, there is a delay on tim_trgo, except if the master/slave mode is selected (see the MSM bit description in TIMx_SMCR register). */
    constexpr std::uint32_t TIM9_CR2_MMS_B_0x1 = 1;
    ...
    constexpr std::uint32_t TIM9_CR2_MMS_B_0x2 = 2;
    ...
    constexpr std::uint32_t TIM9_CR2_MMS_B_0x3 = 3;
        /** @brief Compare - tim_oc1refc signal is used as trigger output (tim_trgo). */
    constexpr std::uint32_t TIM9_CR2_MMS_B_0x4 = 4;
        /** @brief Compare - tim_oc2refc signal is used as trigger output (tim_trgo). */
    constexpr std::uint32_t TIM9_CR2_MMS_B_0x5 = 5;

    /** @brief tim_ti1 selection */
    using TIM9_CR2_TI1S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM9_CR2_TI1S_B_0x0 = 0;
        /** @brief The tim_ti1_in[15:0] and tim_ti2_in[15:0] multiplexers output are connected to the tim_ti1 input (XOR combination) */
    constexpr std::uint32_t TIM9_CR2_TI1S_B_0x1 = 1;

    /** @brief ADC synchronization */
    using TIM9_CR2_ADSYNC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM9_CR2_ADSYNC_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM9_CR2_ADSYNC_B_0x1 = 1;
