...
#ifndef EMBEDDED_PP_STM32N645_VREFBUF_S_HPP
#define EMBEDDED_PP_STM32N645_VREFBUF_S_HPP
...
namespace STM32N645::VREFBUF_S {
    ...
    /** @details Possible values:
     *          - B_0x0: V less than sub>REF+ less than /sub> pin is internally connected to the voltage reference buffer output. (value: 0)
     *          - B_0x1: V less than sub>REF+ less than /sub> pin is high impedance. (value: 1)
     */
        /** @brief V less than sub>REF+ less than /sub> pin is internally connected to the voltage reference buffer output. */
    constexpr std::uint32_t VREFBUF_CSR_HIZ_B_0x0 = 0;
        /** @brief V less than sub>REF+ less than /sub> pin is high impedance. */
