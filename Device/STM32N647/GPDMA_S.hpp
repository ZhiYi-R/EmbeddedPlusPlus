...
#ifndef EMBEDDED_PP_STM32N647_GPDMA_S_HPP
#define EMBEDDED_PP_STM32N647_GPDMA_S_HPP
...
namespace STM32N647::GPDMA_S {
     ...
     */
        /** @brief non-secure */
    constexpr std::uint32_t GPDMA_SECCFGR_SEC12_B_0x0 = 0;
        /** @brief secure */
    constexpr std::uint32_t GPDMA_SECCFGR_SEC12_B_0x1 = 1;
     ...
     */
        /** @brief non-secure */
    constexpr std::uint32_t GPDMA_SECCFGR_SEC13_B_0x0 = 0;
        /** @brief secure */
    constexpr std::uint32_t GPDMA_SECCFGR_SEC13_B_0x1 = 1;
     ...
     */
        /** @brief non-secure */
    constexpr std::uint32_t GPDMA_SECCFGR_SEC14_B_0x0 = 0;
        /** @brief secure */
    constexpr std::uint32_t GPDMA_SECCFGR_SEC14_B_0x1 = 1;
     ...
     */
        /** @brief non-secure */
    constexpr std::uint32_t GPDMA_SECCFGR_SEC15_B_0x0 = 0;
        /** @brief secure */
    constexpr std::uint32_t GPDMA_SECCFGR_SEC15_B_0x1 = 1;
     ...
     */
        /** @brief unprivileged */
    constexpr std::uint32_t GPDMA_PRIVCFGR_PRIV12_B_0x0 = 0;
        /** @brief privileged */
    constexpr std::uint32_t GPDMA_PRIVCFGR_PRIV12_B_0x1 = 1;
     ...
     */
        /** @brief unprivileged */
    constexpr std::uint32_t GPDMA_PRIVCFGR_PRIV13_B_0x0 = 0;
        /** @brief privileged */
    constexpr std::uint32_t GPDMA_PRIVCFGR_PRIV13_B_0x1 = 1;
     ...
     */
        /** @brief unprivileged */
    constexpr std::uint32_t GPDMA_PRIVCFGR_PRIV14_B_0x0 = 0;
        /** @brief privileged */
    constexpr std::uint32_t GPDMA_PRIVCFGR_PRIV14_B_0x1 = 1;
     ...
     */
        /** @brief unprivileged */
    constexpr std::uint32_t GPDMA_PRIVCFGR_PRIV15_B_0x0 = 0;
        /** @brief privileged */
    constexpr std::uint32_t GPDMA_PRIVCFGR_PRIV15_B_0x1 = 1;
    ...
    /** @brief lock the configuration of GPDMA_SECCFGR.SECx and GPDMA_PRIVCFGR.PRIVx, until a global GPDMA reset */
     ...
     */
        /** @brief secure privilege configuration of the channel x is writable. */
    constexpr std::uint32_t GPDMA_RCFGLOCKR_LOCK12_B_0x0 = 0;
        /** @brief secure privilege configuration of the channel x is not writable. */
    constexpr std::uint32_t GPDMA_RCFGLOCKR_LOCK12_B_0x1 = 1;
     ...
     */
        /** @brief secure privilege configuration of the channel x is writable. */
    constexpr std::uint32_t GPDMA_RCFGLOCKR_LOCK13_B_0x0 = 0;
        /** @brief secure privilege configuration of the channel x is not writable. */
    constexpr std::uint32_t GPDMA_RCFGLOCKR_LOCK13_B_0x1 = 1;
     ...
     */
        /** @brief secure privilege configuration of the channel x is writable. */
    constexpr std::uint32_t GPDMA_RCFGLOCKR_LOCK14_B_0x0 = 0;
        /** @brief secure privilege configuration of the channel x is not writable. */
    constexpr std::uint32_t GPDMA_RCFGLOCKR_LOCK14_B_0x1 = 1;
     ...
     */
        /** @brief secure privilege configuration of the channel x is writable. */
    constexpr std::uint32_t GPDMA_RCFGLOCKR_LOCK15_B_0x0 = 0;
        /** @brief secure privilege configuration of the channel x is not writable. */
    constexpr std::uint32_t GPDMA_RCFGLOCKR_LOCK15_B_0x1 = 1;
     ...
     */
        /** @brief no interrupt occurred on channel x */
    constexpr std::uint32_t GPDMA_MISR_MIS12_B_0x0 = 0;
        /** @brief an interrupt occurred on channel x */
    constexpr std::uint32_t GPDMA_MISR_MIS12_B_0x1 = 1;
     ...
     */
        /** @brief no interrupt occurred on channel x */
    constexpr std::uint32_t GPDMA_MISR_MIS13_B_0x0 = 0;
        /** @brief an interrupt occurred on channel x */
    constexpr std::uint32_t GPDMA_MISR_MIS13_B_0x1 = 1;
     ...
     */
        /** @brief no interrupt occurred on channel x */
    constexpr std::uint32_t GPDMA_MISR_MIS14_B_0x0 = 0;
        /** @brief an interrupt occurred on channel x */
    constexpr std::uint32_t GPDMA_MISR_MIS14_B_0x1 = 1;
     ...
     */
        /** @brief no interrupt occurred on channel x */
    constexpr std::uint32_t GPDMA_MISR_MIS15_B_0x0 = 0;
        /** @brief an interrupt occurred on channel x */
    constexpr std::uint32_t GPDMA_MISR_MIS15_B_0x1 = 1;
     ...
     */
        /** @brief no interrupt occurred on the secure channel x */
    constexpr std::uint32_t GPDMA_SMISR_MIS12_B_0x0 = 0;
        /** @brief an interrupt occurred on the secure channel x */
    constexpr std::uint32_t GPDMA_SMISR_MIS12_B_0x1 = 1;
     ...
     */
        /** @brief no interrupt occurred on the secure channel x */
    constexpr std::uint32_t GPDMA_SMISR_MIS13_B_0x0 = 0;
        /** @brief an interrupt occurred on the secure channel x */
    constexpr std::uint32_t GPDMA_SMISR_MIS13_B_0x1 = 1;
     ...
     */
        /** @brief no interrupt occurred on the secure channel x */
    constexpr std::uint32_t GPDMA_SMISR_MIS14_B_0x0 = 0;
        /** @brief an interrupt occurred on the secure channel x */
    constexpr std::uint32_t GPDMA_SMISR_MIS14_B_0x1 = 1;
     ...
     */
        /** @brief no interrupt occurred on the secure channel x */
    constexpr std::uint32_t GPDMA_SMISR_MIS15_B_0x0 = 0;
        /** @brief an interrupt occurred on the secure channel x */
    constexpr std::uint32_t GPDMA_SMISR_MIS15_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: channel executed for the full linked-list and completed at the end of the last LLI (GPDMA_CxLLR = 0). The 16 low-significant bits of the link address are null (LA[15:0] = 0) and all the update bits are null (UT1 = UB1 = UT2 = USA = UDA = ULL = 0 and (value: 0)
     *          - B_0x1: channel executed once for the current LLI (value: 1)
     */
        /** @brief channel executed for the full linked-list and completed at the end of the last LLI (GPDMA_CxLLR = 0). The 16 low-significant bits of the link address are null (LA[15:0] = 0) and all the update bits are null (UT1 = UB1 = UT2 = USA = UDA = ULL = 0 and */
    ...
    constexpr std::uint32_t GPDMA_C0TR1_PAM_B_0x2_PAM_1 = 2;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C0TR1_PAM_B_0x3_PAM_1 = 3;
     ...
     *          - B_0x1: the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol at a block level (see Section 19.3.3). (value: 1)
     */
    ...
    constexpr std::uint32_t GPDMA_C0TR2_BREQ_B_0x0 = 0;
        /** @brief the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol at a block level (see Section 19.3.3). */
    ...
    /** @details Possible values:
     *          - B_0x0: the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in GPDMA control mode. The GPDMA is programmed with GPDMA_CxTR1.BNDT[15:0] and this is internally used by the hardware for the block transfer completion. (value: 0)
     *          - B_0x1: the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in peripheral control mode. The GPDMA block transfer can be early completed by the peripheral itself (see Section 19.3.5 for more details). (value: 1)
     */
        /** @brief the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in GPDMA control mode. The GPDMA is programmed with GPDMA_CxTR1.BNDT[15:0] and this is internally used by the hardware for the block transfer completion. */
    constexpr std::uint32_t GPDMA_C0TR2_PFREQ_B_0x0 = 0;
        /** @brief the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in peripheral control mode. The GPDMA block transfer can be early completed by the peripheral itself (see Section 19.3.5 for more details). */
     ...
     *          - B_0x1: channel x (x = 0 to 11), same as 00; channel x (x =12 to 15), at 2D/repeated block level. The first burst read of a 2D/repeated block transfer is conditioned by one hit trigger. (value: 1)
     *          - B_0x2: at link level: a LLI link transfer is conditioned by one hit trigger. The LLI data transfer (value: 2)
    ...
    constexpr std::uint32_t GPDMA_C0TR2_TRIGM_B_0x0 = 0;
        /** @brief channel x (x = 0 to 11), same as 00; channel x (x =12 to 15), at 2D/repeated block level. The first burst read of a 2D/repeated block transfer is conditioned by one hit trigger. */
    constexpr std::uint32_t GPDMA_C0TR2_TRIGM_B_0x1 = 1;
        /** @brief at link level: a LLI link transfer is conditioned by one hit trigger. The LLI data transfer */
    ...
    using GPDMA_C0TR2_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
     ...
     *          - B_0x1: channel x (x = 0 to 11), same as 00, channel x (x =12 to 15), at 2D/repeated block level (when GPDMA_CxBR1.BRC[10:0] = 0 and GPDMA_CxBR1.BNDT[15:0] = 0). The complete (and the half) transfer event is generated at the end (respectively half of the end) of the 2D/repeated block. (value: 1)
     *          - B_0x2: at LLI level: the complete transfer event is generated at the end of the LLI transfer, including the update of the LLI if any. The half transfer event is generated at the half of the LLI data transfer The LLI data transfer is a block transfer or a 2D/repeated block transfer for channel x (x =12 to 15), if any data transfer. (value: 2)
     *          - B_0x3: at channel level: the complete transfer event is generated at the end of the last LLI transfer. The half transfer event is generated at the half of the data transfer of the last LLI. The last LLI updates the link address GPDMA_CxLLR.LA[15:2] to zero and clears all the GPDMA_CxLLR update bits (UT1, UT2, UB1, USA, UDA and ULL, plus UT3 and UB2). If the channel transfer is continuous/infinite, no event is generated. (value: 3)
     */
    ...
    constexpr std::uint32_t GPDMA_C0TR2_TCEM_B_0x0 = 0;
        /** @brief channel x (x = 0 to 11), same as 00, channel x (x =12 to 15), at 2D/repeated block level (when GPDMA_CxBR1.BRC[10:0] = 0 and GPDMA_CxBR1.BNDT[15:0] = 0). The complete (and the half) transfer event is generated at the end (respectively half of the end) of the 2D/repeated block. */
    constexpr std::uint32_t GPDMA_C0TR2_TCEM_B_0x1 = 1;
        /** @brief at LLI level: the complete transfer event is generated at the end of the LLI transfer, including the update of the LLI if any. The half transfer event is generated at the half of the LLI data transfer The LLI data transfer is a block transfer or a 2D/repeated block transfer for channel x (x =12 to 15), if any data transfer. */
    ...
    constexpr std::uint32_t GPDMA_C1TR1_PAM_B_0x1_PAM_1 = 1;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C1TR1_PAM_B_0x2_PAM_1 = 2;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C1TR1_PAM_B_0x3_PAM_1 = 3;
    ...
    /** @brief trigger event input selection */
    using GPDMA_C1TR2_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief trigger event polarity */
    ...
    constexpr std::uint32_t GPDMA_C2TR1_PAM_B_0x1_PAM_1 = 1;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C2TR1_PAM_B_0x2_PAM_1 = 2;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C2TR1_PAM_B_0x3_PAM_1 = 3;
    ...
    /** @brief trigger event input selection */
    using GPDMA_C2TR2_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief trigger event polarity */
    ...
    constexpr std::uint32_t GPDMA_C3TR1_PAM_B_0x1_PAM_1 = 1;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C3TR1_PAM_B_0x2_PAM_1 = 2;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C3TR1_PAM_B_0x3_PAM_1 = 3;
    ...
    /** @brief trigger event input selection */
    using GPDMA_C3TR2_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief trigger event polarity */
    ...
    constexpr std::uint32_t GPDMA_C4TR1_PAM_B_0x1_PAM_1 = 1;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C4TR1_PAM_B_0x2_PAM_1 = 2;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C4TR1_PAM_B_0x3_PAM_1 = 3;
    ...
    /** @brief trigger event input selection */
    using GPDMA_C4TR2_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief trigger event polarity */
    ...
    constexpr std::uint32_t GPDMA_C5TR1_PAM_B_0x1_PAM_1 = 1;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C5TR1_PAM_B_0x2_PAM_1 = 2;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C5TR1_PAM_B_0x3_PAM_1 = 3;
    ...
    /** @brief trigger event input selection */
    using GPDMA_C5TR2_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief trigger event polarity */
    ...
    constexpr std::uint32_t GPDMA_C6TR1_PAM_B_0x1_PAM_1 = 1;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C6TR1_PAM_B_0x2_PAM_1 = 2;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C6TR1_PAM_B_0x3_PAM_1 = 3;
    ...
    /** @brief trigger event input selection */
    using GPDMA_C6TR2_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief trigger event polarity */
    ...
    constexpr std::uint32_t GPDMA_C7TR1_PAM_B_0x1_PAM_1 = 1;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C7TR1_PAM_B_0x2_PAM_1 = 2;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C7TR1_PAM_B_0x3_PAM_1 = 3;
    ...
    /** @brief trigger event input selection */
    using GPDMA_C7TR2_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief trigger event polarity */
     ...
     */
        /** @brief source data is transferred as right aligned, padded with 0s up to the destination data width */
    constexpr std::uint32_t GPDMA_C8TR1_PAM_B_0x0_PAM_1 = 0;
        /** @brief source data is transferred as right aligned, sign extended up to the destination data width */
    constexpr std::uint32_t GPDMA_C8TR1_PAM_B_0x1_PAM_1 = 1;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C8TR1_PAM_B_0x2_PAM_1 = 2;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C8TR1_PAM_B_0x3_PAM_1 = 3;
    ...
    /** @brief GPDMA hardware request selection */
    using GPDMA_C8TR2_REQSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief software request */
    ...
    /** @brief trigger event input selection */
    using GPDMA_C8TR2_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief trigger event polarity */
     ...
     */
        /** @brief source data is transferred as right aligned, padded with 0s up to the destination data width */
    constexpr std::uint32_t GPDMA_C9TR1_PAM_B_0x0_PAM_1 = 0;
        /** @brief source data is transferred as right aligned, sign extended up to the destination data width */
    constexpr std::uint32_t GPDMA_C9TR1_PAM_B_0x1_PAM_1 = 1;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C9TR1_PAM_B_0x2_PAM_1 = 2;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C9TR1_PAM_B_0x3_PAM_1 = 3;
    ...
    /** @brief GPDMA hardware request selection */
    using GPDMA_C9TR2_REQSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief software request */
    ...
    /** @brief trigger event input selection */
    using GPDMA_C9TR2_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief trigger event polarity */
     ...
     */
        /** @brief source data is transferred as right aligned, padded with 0s up to the destination data width */
    constexpr std::uint32_t GPDMA_C10TR1_PAM_B_0x0_PAM_1 = 0;
        /** @brief source data is transferred as right aligned, sign extended up to the destination data width */
    constexpr std::uint32_t GPDMA_C10TR1_PAM_B_0x1_PAM_1 = 1;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C10TR1_PAM_B_0x2_PAM_1 = 2;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C10TR1_PAM_B_0x3_PAM_1 = 3;
    ...
    /** @brief GPDMA hardware request selection */
    using GPDMA_C10TR2_REQSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief software request */
    ...
    /** @brief trigger event input selection */
    using GPDMA_C10TR2_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief trigger event polarity */
     ...
     */
        /** @brief source data is transferred as right aligned, padded with 0s up to the destination data width */
    constexpr std::uint32_t GPDMA_C11TR1_PAM_B_0x0_PAM_1 = 0;
        /** @brief source data is transferred as right aligned, sign extended up to the destination data width */
    constexpr std::uint32_t GPDMA_C11TR1_PAM_B_0x1_PAM_1 = 1;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C11TR1_PAM_B_0x2_PAM_1 = 2;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C11TR1_PAM_B_0x3_PAM_1 = 3;
    ...
    /** @brief GPDMA hardware request selection */
    using GPDMA_C11TR2_REQSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief software request */
    ...
    /** @brief trigger event input selection */
    using GPDMA_C11TR2_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief trigger event polarity */
     ...
     */
        /** @brief source data is transferred as right aligned, padded with 0s up to the destination data width */
    constexpr std::uint32_t GPDMA_C12TR1_PAM_B_0x0_PAM_1 = 0;
        /** @brief source data is transferred as right aligned, sign extended up to the destination data width */
    constexpr std::uint32_t GPDMA_C12TR1_PAM_B_0x1_PAM_1 = 1;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C12TR1_PAM_B_0x2_PAM_1 = 2;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C12TR1_PAM_B_0x3_PAM_1 = 3;
    ...
    /** @brief GPDMA hardware request selection */
    using GPDMA_C12TR2_REQSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief software request */
    ...
    /** @brief Hardware request in peripheral flow control mode */
    using GPDMA_C12TR2_PFREQ = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in GPDMA control mode. The GPDMA is programmed with GPDMA_CxTR1.BNDT[15:0] and this is internally used by the hardware for the block transfer completion. (value: 0)
     *          - B_0x1: the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in peripheral control mode. The GPDMA block transfer can be early completed by the peripheral itself (see Section 19.3.5 for more details). (value: 1)
     */
        /** @brief the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in GPDMA control mode. The GPDMA is programmed with GPDMA_CxTR1.BNDT[15:0] and this is internally used by the hardware for the block transfer completion. */
    constexpr std::uint32_t GPDMA_C12TR2_PFREQ_B_0x0 = 0;
        /** @brief the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in peripheral control mode. The GPDMA block transfer can be early completed by the peripheral itself (see Section 19.3.5 for more details). */
    constexpr std::uint32_t GPDMA_C12TR2_PFREQ_B_0x1 = 1;
    ...
    /** @brief trigger event input selection */
    using GPDMA_C12TR2_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief trigger event polarity */
     ...
     */
        /** @brief source data is transferred as right aligned, padded with 0s up to the destination data width */
    constexpr std::uint32_t GPDMA_C13TR1_PAM_B_0x0_PAM_1 = 0;
        /** @brief source data is transferred as right aligned, sign extended up to the destination data width */
    constexpr std::uint32_t GPDMA_C13TR1_PAM_B_0x1_PAM_1 = 1;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C13TR1_PAM_B_0x2_PAM_1 = 2;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C13TR1_PAM_B_0x3_PAM_1 = 3;
    ...
    /** @brief GPDMA hardware request selection */
    using GPDMA_C13TR2_REQSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief software request */
    ...
    /** @brief Hardware request in peripheral flow control mode */
    using GPDMA_C13TR2_PFREQ = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in GPDMA control mode. The GPDMA is programmed with GPDMA_CxTR1.BNDT[15:0] and this is internally used by the hardware for the block transfer completion. (value: 0)
     *          - B_0x1: the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in peripheral control mode. The GPDMA block transfer can be early completed by the peripheral itself (see Section 19.3.5 for more details). (value: 1)
     */
        /** @brief the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in GPDMA control mode. The GPDMA is programmed with GPDMA_CxTR1.BNDT[15:0] and this is internally used by the hardware for the block transfer completion. */
    constexpr std::uint32_t GPDMA_C13TR2_PFREQ_B_0x0 = 0;
        /** @brief the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in peripheral control mode. The GPDMA block transfer can be early completed by the peripheral itself (see Section 19.3.5 for more details). */
    constexpr std::uint32_t GPDMA_C13TR2_PFREQ_B_0x1 = 1;
    ...
    /** @brief trigger event input selection */
    using GPDMA_C13TR2_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief trigger event polarity */
     ...
     */
        /** @brief source data is transferred as right aligned, padded with 0s up to the destination data width */
    constexpr std::uint32_t GPDMA_C14TR1_PAM_B_0x0_PAM_1 = 0;
        /** @brief source data is transferred as right aligned, sign extended up to the destination data width */
    constexpr std::uint32_t GPDMA_C14TR1_PAM_B_0x1_PAM_1 = 1;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C14TR1_PAM_B_0x2_PAM_1 = 2;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C14TR1_PAM_B_0x3_PAM_1 = 3;
    ...
    /** @brief GPDMA hardware request selection */
    using GPDMA_C14TR2_REQSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief software request */
    ...
    /** @brief Hardware request in peripheral flow control mode */
    using GPDMA_C14TR2_PFREQ = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in GPDMA control mode. The GPDMA is programmed with GPDMA_CxTR1.BNDT[15:0] and this is internally used by the hardware for the block transfer completion. (value: 0)
     *          - B_0x1: the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in peripheral control mode. The GPDMA block transfer can be early completed by the peripheral itself (see Section 19.3.5 for more details). (value: 1)
     */
        /** @brief the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in GPDMA control mode. The GPDMA is programmed with GPDMA_CxTR1.BNDT[15:0] and this is internally used by the hardware for the block transfer completion. */
    constexpr std::uint32_t GPDMA_C14TR2_PFREQ_B_0x0 = 0;
        /** @brief the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in peripheral control mode. The GPDMA block transfer can be early completed by the peripheral itself (see Section 19.3.5 for more details). */
    constexpr std::uint32_t GPDMA_C14TR2_PFREQ_B_0x1 = 1;
    ...
    /** @brief trigger event input selection */
    using GPDMA_C14TR2_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief trigger event polarity */
     ...
     */
        /** @brief source data is transferred as right aligned, padded with 0s up to the destination data width */
    constexpr std::uint32_t GPDMA_C15TR1_PAM_B_0x0_PAM_1 = 0;
        /** @brief source data is transferred as right aligned, sign extended up to the destination data width */
    constexpr std::uint32_t GPDMA_C15TR1_PAM_B_0x1_PAM_1 = 1;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C15TR1_PAM_B_0x2_PAM_1 = 2;
        /** @brief successive source data are FIFO queued and packed at the destination data width, in a left (LSB) to right (MSB) order (named little endian), before a destination transfer */
    constexpr std::uint32_t GPDMA_C15TR1_PAM_B_0x3_PAM_1 = 3;
    ...
    /** @brief GPDMA hardware request selection */
    using GPDMA_C15TR2_REQSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief software request */
    ...
    /** @brief Hardware request in peripheral flow control mode */
    using GPDMA_C15TR2_PFREQ = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in GPDMA control mode. The GPDMA is programmed with GPDMA_CxTR1.BNDT[15:0] and this is internally used by the hardware for the block transfer completion. (value: 0)
     *          - B_0x1: the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in peripheral control mode. The GPDMA block transfer can be early completed by the peripheral itself (see Section 19.3.5 for more details). (value: 1)
     */
        /** @brief the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in GPDMA control mode. The GPDMA is programmed with GPDMA_CxTR1.BNDT[15:0] and this is internally used by the hardware for the block transfer completion. */
    constexpr std::uint32_t GPDMA_C15TR2_PFREQ_B_0x0 = 0;
        /** @brief the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol in peripheral control mode. The GPDMA block transfer can be early completed by the peripheral itself (see Section 19.3.5 for more details). */
    constexpr std::uint32_t GPDMA_C15TR2_PFREQ_B_0x1 = 1;
    ...
    /** @brief trigger event input selection */
    using GPDMA_C15TR2_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief trigger event polarity */
