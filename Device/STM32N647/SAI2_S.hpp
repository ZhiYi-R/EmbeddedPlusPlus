...
#ifndef EMBEDDED_PP_STM32N647_SAI2_S_HPP
#define EMBEDDED_PP_STM32N647_SAI2_S_HPP
...
namespace STM32N647::SAI2_S {
     ...
     *          - B_0x1: FIFO less than or equal to 1/4 but not empty (transmitter mode), FIFO less than 1/4 but not empty (receiver mode) (value: 1)
     *          - B_0x2: 1/4 less than FIFO less than or equal to 1/2 (transmitter mode), 1/4 less than or equal to FIFO less than 1/2 (receiver mode) (value: 2)
     *          - B_0x3: 1/2 less than FIFO less than or equal to 3/4 (transmitter mode), 1/2 less than or equal to FIFO less than 3/4 (receiver mode) (value: 3)
     *          - B_0x4: 3/4 less than FIFO but not full (transmitter mode), 3/4 less than or equal to FIFO but not full (receiver mode) (value: 4)
    ...
    constexpr std::uint32_t SAI_ASR_FLVL_B_0x0 = 0;
        /** @brief FIFO less than or equal to 1/4 but not empty (transmitter mode), FIFO less than 1/4 but not empty (receiver mode) */
    constexpr std::uint32_t SAI_ASR_FLVL_B_0x1 = 1;
        /** @brief 1/4 less than FIFO less than or equal to 1/2 (transmitter mode), 1/4 less than or equal to FIFO less than 1/2 (receiver mode) */
    constexpr std::uint32_t SAI_ASR_FLVL_B_0x2 = 2;
        /** @brief 1/2 less than FIFO less than or equal to 3/4 (transmitter mode), 1/2 less than or equal to FIFO less than 3/4 (receiver mode) */
    constexpr std::uint32_t SAI_ASR_FLVL_B_0x3 = 3;
        /** @brief 3/4 less than FIFO but not full (transmitter mode), 3/4 less than or equal to FIFO but not full (receiver mode) */
