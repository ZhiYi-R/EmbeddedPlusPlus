...
#ifndef EMBEDDED_PP_STM32N647_TIM1_S_HPP
#define EMBEDDED_PP_STM32N647_TIM1_S_HPP
...
namespace STM32N647::TIM1_S {
     ...
     *          - B_0x6: PWM mode 1 - In upcounting, channel 3 is active as long as TIMx_CNTless thanTIMx_CCR3 else inactive. In downcounting, channel 3 is inactive (tim_oc3ref=0') as long as TIMx_CNT>TIMx_CCR3 else active (tim_oc3ref='1'). (value: 6)
     *          - B_0x7: PWM mode 2 - In upcounting, channel 3 is inactive as long as TIMx_CNTless thanTIMx_CCR3 else active. In downcounting, channel 3 is active as long as TIMx_CNT>TIMx_CCR3 else inactive. (value: 7)
     */
    ...
    constexpr std::uint32_t TIM1_CCMR2_Output_OC3M_B_0x5 = 5;
        /** @brief PWM mode 1 - In upcounting, channel 3 is active as long as TIMx_CNTless thanTIMx_CCR3 else inactive. In downcounting, channel 3 is inactive (tim_oc3ref=0') as long as TIMx_CNT>TIMx_CCR3 else active (tim_oc3ref='1'). */
    constexpr std::uint32_t TIM1_CCMR2_Output_OC3M_B_0x6 = 6;
        /** @brief PWM mode 2 - In upcounting, channel 3 is inactive as long as TIMx_CNTless thanTIMx_CCR3 else active. In downcounting, channel 3 is active as long as TIMx_CNT>TIMx_CCR3 else inactive. */
