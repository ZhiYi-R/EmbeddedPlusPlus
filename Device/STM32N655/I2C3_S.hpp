...
#ifndef EMBEDDED_PP_STM32N655_I2C3_S_HPP
#define EMBEDDED_PP_STM32N655_I2C3_S_HPP
...
namespace STM32N655::I2C3_S {
     ...
     *          - B_0x1: Digital filter enabled and filtering capability up to 1 tless thansub>I2CCLKless than/sub> (value: 1)
     *          - B_0xF: digital filter enabled and filtering capability up to15 tless thansub>I2CCLKless than/sub> (value: 15)
     */
        /** @brief Digital filter disabled */
    constexpr std::uint32_t I2C_CR1_DNF_B_0x0 = 0;
        /** @brief Digital filter enabled and filtering capability up to 1 tless thansub>I2CCLKless than/sub> */
    constexpr std::uint32_t I2C_CR1_DNF_B_0x1 = 1;
        /** @brief digital filter enabled and filtering capability up to15 tless thansub>I2CCLKless than/sub> */
     ...
     *          - B_0x1: SCL timeout detection is enabled: when SCL is low for more than tless thansub>TIMEOUTless than/sub> (TIDLE=0) or high for more than tless thansub>IDLE less than/sub>(TIDLE=1), a timeout error is detected (TIMEOUT=1). (value: 1)
     */
        /** @brief SCL timeout detection is disabled */
    constexpr std::uint32_t I2C_TIMEOUTR_TIMOUTEN_B_0x0 = 0;
        /** @brief SCL timeout detection is enabled: when SCL is low for more than tless thansub>TIMEOUTless than/sub> (TIDLE=0) or high for more than tless thansub>IDLE less than/sub>(TIDLE=1), a timeout error is detected (TIMEOUT=1). */
     ...
     *          - B_0x1: Extended clock timeout detection is enabled. When a cumulative SCL stretch for more than tless thansub>LOW:EXT less than/sub>is done by the I2C interface, a timeout error is detected (TIMEOUT=1). (value: 1)
     */
        /** @brief Extended clock timeout detection is disabled */
    constexpr std::uint32_t I2C_TIMEOUTR_TEXTEN_B_0x0 = 0;
        /** @brief Extended clock timeout detection is enabled. When a cumulative SCL stretch for more than tless thansub>LOW:EXT less than/sub>is done by the I2C interface, a timeout error is detected (TIMEOUT=1). */
