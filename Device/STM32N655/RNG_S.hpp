...
#ifndef EMBEDDED_PP_STM32N655_RNG_S_HPP
#define EMBEDDED_PP_STM32N655_RNG_S_HPP
...
namespace STM32N655::RNG_S {
     ...
     *          - B_0xF: 2less thansup>15less than/sup> RNG clock cycles per internal clock (for example. an incoming 48 MHz RNG clock becomes a 1.5 kHz internal RNG clock) (value: 15)
     */
    ...
    constexpr std::uint32_t RNG_CR_CLKDIV_B_0x2 = 2;
        /** @brief 2less thansup>15less than/sup> RNG clock cycles per internal clock (for example. an incoming 48 MHz RNG clock becomes a 1.5 kHz internal RNG clock) */
    ...
    /** @details Possible values:
     *          - B_0x0: The RNG clock is correct (fless thansub>RNGCLKless than/sub>> fless thansub>HCLKless than/sub>/32). If the CEIS bit is set, this means that a slow clock was detected and the situation has been recovered. (value: 0)
     *          - B_0x1: The RNG clock is too slow (fless thansub>RNGCLKless than/sub>less than fless thansub>HCLKless than/sub>/32). (value: 1)
     */
        /** @brief The RNG clock is correct (fless thansub>RNGCLKless than/sub>> fless thansub>HCLKless than/sub>/32). If the CEIS bit is set, this means that a slow clock was detected and the situation has been recovered. */
