...
#ifndef EMBEDDED_PP_STM32N657_ADC2_S_HPP
#define EMBEDDED_PP_STM32N657_ADC2_S_HPP
...
namespace STM32N657::ADC2_S {
    ...
    /** @details Possible values:
     *          - B_0x0: Vless thansub>DDCOREless than/sub> channel disabled (value: 0)
     *          - B_0x1: Vless thansub>DDCOREless than/sub> channel enabled (value: 1)
     */
        /** @brief Vless thansub>DDCOREless than/sub> channel disabled */
    constexpr std::uint32_t ADC_OR_VDDCOREEN_B_0x0 = 0;
        /** @brief Vless thansub>DDCOREless than/sub> channel enabled */
