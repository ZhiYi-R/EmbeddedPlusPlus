...
#ifndef EMBEDDED_PP_STM32N657_ADF_S_HPP
#define EMBEDDED_PP_STM32N657_ADF_S_HPP
...
namespace STM32N657::ADF_S {
    ...
    /** @details Possible values:
     *          - B_0x0: Hysteresis function disabled. THRless thansub>Hless than/sub> is always used. (value: 0)
     *          - B_0x1: Hysteresis function enabled. THRless thansub>Hless than/sub> is used for MONITOR to DETECT transition and THRless thansub>Lless than/sub> is used for DETECT to MONITOR transition. (value: 1)
     */
        /** @brief Hysteresis function disabled. THRless thansub>Hless than/sub> is always used. */
    constexpr std::uint32_t ADF_SADCR_HYSTEN_B_0x0 = 0;
        /** @brief Hysteresis function enabled. THRless thansub>Hless than/sub> is used for MONITOR to DETECT transition and THRless thansub>Lless than/sub> is used for DETECT to MONITOR transition. */
    ...
    /** @details Possible values:
     *          - B_0x0: THRless thansub>H less than/sub>is 3.5 dB higher than ANLVL (value: 0)
     *          - B_0x1: THRless thansub>H less than/sub>is 6.0 dB higher than ANLVL (value: 1)
     *          - B_0x2: THRless thansub>H less than/sub>is 9.5 dB higher than ANLVL (value: 2)
     *          - B_0x3: THRless thansub>H less than/sub>is 12 dB higher than ANLVL (value: 3)
     *          - B_0x4: THRless thansub>H less than/sub>is 15.6 dB higher than ANLVL (value: 4)
     *          - B_0x5: THRless thansub>H less than/sub>is 18 dB higher than ANLVL (value: 5)
     *          - B_0x6: THRless thansub>H less than/sub>is 21.6 dB higher than ANLVL (value: 6)
     *          - B_0x7: THRless thansub>H less than/sub>is 24.1 dB higher than ANLVL (value: 7)
     *          - B_0x8: THRless thansub>H less than/sub>is 27.6 dB higher than ANLVL (value: 8)
     *          - B_0x9: THRless thansub>H less than/sub>is 30.1dB higher than ANLVL (value: 9)
     */
        /** @brief THRless thansub>H less than/sub>is 3.5 dB higher than ANLVL */
    constexpr std::uint32_t ADF_SADCFGR_SNTHR_B_0x0 = 0;
        /** @brief THRless thansub>H less than/sub>is 6.0 dB higher than ANLVL */
    constexpr std::uint32_t ADF_SADCFGR_SNTHR_B_0x1 = 1;
        /** @brief THRless thansub>H less than/sub>is 9.5 dB higher than ANLVL */
    ...
    constexpr std::uint32_t ADF_SADCFGR_SNTHR_B_0x3 = 3;
        /** @brief THRless thansub>H less than/sub>is 15.6 dB higher than ANLVL */
    ...
    constexpr std::uint32_t ADF_SADCFGR_SNTHR_B_0x5 = 5;
        /** @brief THRless thansub>H less than/sub>is 21.6 dB higher than ANLVL */
    constexpr std::uint32_t ADF_SADCFGR_SNTHR_B_0x6 = 6;
        /** @brief THRless thansub>H less than/sub>is 24.1 dB higher than ANLVL */
    constexpr std::uint32_t ADF_SADCFGR_SNTHR_B_0x7 = 7;
        /** @brief THRless thansub>H less than/sub>is 27.6 dB higher than ANLVL */
    constexpr std::uint32_t ADF_SADCFGR_SNTHR_B_0x8 = 8;
        /** @brief THRless thansub>H less than/sub>is 30.1dB higher than ANLVL */
