...
#ifndef EMBEDDED_PP_STM32N657_I3C2_S_HPP
#define EMBEDDED_PP_STM32N657_I3C2_S_HPP
...
namespace STM32N657::I3C2_S {
     ...
     *          - B_0x4_WHEN_I3C_ACTS_AS_I3C_CONTROLLER: legacy Iless thansup>2less than/sup>C message (refer to Figure 803) (value: 4)
    ...
    constexpr std::uint32_t I3C_CR_MTYPE_B_0x3_WHEN_I3C_ACTS_AS_I3C_CONTROLLER = 3;
        /** @brief legacy Iless thansup>2less than/sup>C message (refer to Figure 803) */
