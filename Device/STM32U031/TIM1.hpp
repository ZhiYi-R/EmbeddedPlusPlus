...
#ifndef EMBEDDED_PP_STM32U031_TIM1_HPP
#define EMBEDDED_PP_STM32U031_TIM1_HPP
...
namespace STM32U031::TIM1 {
    ...
    /** @details Possible values:
     *          - B_0x0: OCREF_CLR_INT is connected to COMP1 or COMP2 output depending on TIM1_OR1.OCREF_CLR (value: 0)
     *          - B_0x1: OCREF_CLR_INT is connected to ETRF (value: 1)
     */
        /** @brief OCREF_CLR_INT is connected to COMP1 or COMP2 output depending on TIM1_OR1.OCREF_CLR */
    ...
    using TIM1_DIER = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0xC, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Update interrupt enable */
    using TIM1_DIER_UIE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Update interrupt disabled (value: 0)
     *          - B_0x1: Update interrupt enabled (value: 1)
     */
        /** @brief Update interrupt disabled */
    constexpr std::uint16_t TIM1_DIER_UIE_B_0x0 = 0;
        /** @brief Update interrupt enabled */
    constexpr std::uint16_t TIM1_DIER_UIE_B_0x1 = 1;

    /** @brief Capture/Compare 1 interrupt enable */
    using TIM1_DIER_CC1IE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC1 interrupt disabled (value: 0)
     *          - B_0x1: CC1 interrupt enabled (value: 1)
     */
        /** @brief CC1 interrupt disabled */
    constexpr std::uint16_t TIM1_DIER_CC1IE_B_0x0 = 0;
        /** @brief CC1 interrupt enabled */
    constexpr std::uint16_t TIM1_DIER_CC1IE_B_0x1 = 1;

    /** @brief Capture/Compare 2 interrupt enable */
    using TIM1_DIER_CC2IE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC2 interrupt disabled (value: 0)
     *          - B_0x1: CC2 interrupt enabled (value: 1)
     */
        /** @brief CC2 interrupt disabled */
    constexpr std::uint16_t TIM1_DIER_CC2IE_B_0x0 = 0;
        /** @brief CC2 interrupt enabled */
    constexpr std::uint16_t TIM1_DIER_CC2IE_B_0x1 = 1;

    /** @brief Capture/Compare 3 interrupt enable */
    using TIM1_DIER_CC3IE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC3 interrupt disabled (value: 0)
     *          - B_0x1: CC3 interrupt enabled (value: 1)
     */
        /** @brief CC3 interrupt disabled */
    constexpr std::uint16_t TIM1_DIER_CC3IE_B_0x0 = 0;
        /** @brief CC3 interrupt enabled */
    constexpr std::uint16_t TIM1_DIER_CC3IE_B_0x1 = 1;

    /** @brief Capture/Compare 4 interrupt enable */
    using TIM1_DIER_CC4IE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC4 interrupt disabled (value: 0)
     *          - B_0x1: CC4 interrupt enabled (value: 1)
     */
        /** @brief CC4 interrupt disabled */
    constexpr std::uint16_t TIM1_DIER_CC4IE_B_0x0 = 0;
        /** @brief CC4 interrupt enabled */
    constexpr std::uint16_t TIM1_DIER_CC4IE_B_0x1 = 1;

    /** @brief COM interrupt enable */
    using TIM1_DIER_COMIE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COM interrupt disabled (value: 0)
     *          - B_0x1: COM interrupt enabled (value: 1)
     */
        /** @brief COM interrupt disabled */
    constexpr std::uint16_t TIM1_DIER_COMIE_B_0x0 = 0;
        /** @brief COM interrupt enabled */
    constexpr std::uint16_t TIM1_DIER_COMIE_B_0x1 = 1;

    /** @brief Trigger interrupt enable */
    using TIM1_DIER_TIE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Trigger interrupt disabled (value: 0)
     *          - B_0x1: Trigger interrupt enabled (value: 1)
     */
        /** @brief Trigger interrupt disabled */
    constexpr std::uint16_t TIM1_DIER_TIE_B_0x0 = 0;
        /** @brief Trigger interrupt enabled */
    constexpr std::uint16_t TIM1_DIER_TIE_B_0x1 = 1;

    /** @brief Break interrupt enable */
    using TIM1_DIER_BIE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Break interrupt disabled (value: 0)
     *          - B_0x1: Break interrupt enabled (value: 1)
     */
        /** @brief Break interrupt disabled */
    constexpr std::uint16_t TIM1_DIER_BIE_B_0x0 = 0;
        /** @brief Break interrupt enabled */
    constexpr std::uint16_t TIM1_DIER_BIE_B_0x1 = 1;

    /** @brief Update DMA request enable */
    using TIM1_DIER_UDE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Update DMA request disabled (value: 0)
     *          - B_0x1: Update DMA request enabled (value: 1)
     */
        /** @brief Update DMA request disabled */
    constexpr std::uint16_t TIM1_DIER_UDE_B_0x0 = 0;
        /** @brief Update DMA request enabled */
    constexpr std::uint16_t TIM1_DIER_UDE_B_0x1 = 1;

    /** @brief Capture/Compare 1 DMA request enable */
    using TIM1_DIER_CC1DE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC1 DMA request disabled (value: 0)
     *          - B_0x1: CC1 DMA request enabled (value: 1)
     */
        /** @brief CC1 DMA request disabled */
    constexpr std::uint16_t TIM1_DIER_CC1DE_B_0x0 = 0;
        /** @brief CC1 DMA request enabled */
    constexpr std::uint16_t TIM1_DIER_CC1DE_B_0x1 = 1;

    /** @brief Capture/Compare 2 DMA request enable */
    using TIM1_DIER_CC2DE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC2 DMA request disabled (value: 0)
     *          - B_0x1: CC2 DMA request enabled (value: 1)
     */
        /** @brief CC2 DMA request disabled */
    constexpr std::uint16_t TIM1_DIER_CC2DE_B_0x0 = 0;
        /** @brief CC2 DMA request enabled */
    constexpr std::uint16_t TIM1_DIER_CC2DE_B_0x1 = 1;

    /** @brief Capture/Compare 3 DMA request enable */
    using TIM1_DIER_CC3DE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC3 DMA request disabled (value: 0)
     *          - B_0x1: CC3 DMA request enabled (value: 1)
     */
        /** @brief CC3 DMA request disabled */
    constexpr std::uint16_t TIM1_DIER_CC3DE_B_0x0 = 0;
        /** @brief CC3 DMA request enabled */
    constexpr std::uint16_t TIM1_DIER_CC3DE_B_0x1 = 1;

    /** @brief Capture/Compare 4 DMA request enable */
    using TIM1_DIER_CC4DE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC4 DMA request disabled (value: 0)
     *          - B_0x1: CC4 DMA request enabled (value: 1)
     */
        /** @brief CC4 DMA request disabled */
    constexpr std::uint16_t TIM1_DIER_CC4DE_B_0x0 = 0;
        /** @brief CC4 DMA request enabled */
    constexpr std::uint16_t TIM1_DIER_CC4DE_B_0x1 = 1;

    /** @brief COM DMA request enable */
    using TIM1_DIER_COMDE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: COM DMA request disabled (value: 0)
     *          - B_0x1: COM DMA request enabled (value: 1)
     */
        /** @brief COM DMA request disabled */
    constexpr std::uint16_t TIM1_DIER_COMDE_B_0x0 = 0;
        /** @brief COM DMA request enabled */
    constexpr std::uint16_t TIM1_DIER_COMDE_B_0x1 = 1;

    /** @brief Trigger DMA request enable */
    using TIM1_DIER_TDE = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Trigger DMA request disabled (value: 0)
     *          - B_0x1: Trigger DMA request enabled (value: 1)
     */
        /** @brief Trigger DMA request disabled */
    constexpr std::uint16_t TIM1_DIER_TDE_B_0x0 = 0;
        /** @brief Trigger DMA request enabled */
    constexpr std::uint16_t TIM1_DIER_TDE_B_0x1 = 1;
    ...
    using TIM1_CCMR1_INPUT = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x18, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM1_CCMR1_INPUT_CC1S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM1_CCMR1_INPUT_CC1S_B_0x0 = 0;
        /** @brief CC1 channel is configured as input, IC1 is mapped on TI1 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_CC1S_B_0x1 = 1;
        /** @brief CC1 channel is configured as input, IC1 is mapped on TI2 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_CC1S_B_0x2 = 2;
    ...
    constexpr std::uint32_t TIM1_CCMR1_INPUT_CC1S_B_0x3 = 3;
    ...
    using TIM1_CCMR1_INPUT_IC1PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1PSC_B_0x0 = 0;
        /** @brief capture is done once every 2 events */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1PSC_B_0x1 = 1;
        /** @brief capture is done once every 4 events */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1PSC_B_0x2 = 2;
        /** @brief capture is done once every 8 events */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1PSC_B_0x3 = 3;
    ...
    using TIM1_CCMR1_INPUT_IC1F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No filter, sampling is done at f<sub>DTS</sub> (value: 0)
     *          - B_0x1: f<sub>SAMPLING</sub>=f<sub>CK_INT</sub>, N=2 (value: 1)
     *          - B_0x2: f<sub>SAMPLING</sub>=f<sub>CK_INT</sub>, N=4 (value: 2)
     ...
     */
        /** @brief No filter, sampling is done at f<sub>DTS</sub> */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1F_B_0x0 = 0;
        /** @brief f<sub>SAMPLING</sub>=f<sub>CK_INT</sub>, N=2 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1F_B_0x1 = 1;
        /** @brief f<sub>SAMPLING</sub>=f<sub>CK_INT</sub>, N=4 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1F_B_0x2 = 2;
        /** @brief f<sub>SAMPLING</sub>=f<sub>CK_INT</sub>, N=8 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1F_B_0x3 = 3;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/2, N=6 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1F_B_0x4 = 4;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/2, N=8 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1F_B_0x5 = 5;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/4, N=6 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1F_B_0x6 = 6;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/4, N=8 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1F_B_0x7 = 7;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/8, N=6 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1F_B_0x8 = 8;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/8, N=8 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1F_B_0x9 = 9;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/16, N=5 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1F_B_0xA = 10;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/16, N=6 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1F_B_0xB = 11;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/16, N=8 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1F_B_0xC = 12;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/32, N=5 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1F_B_0xD = 13;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/32, N=6 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1F_B_0xE = 14;
        /** @brief f<sub>SAMPLING</sub>=f<sub>DTS</sub>/32, N=8 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_IC1F_B_0xF = 15;
    ...
    using TIM1_CCMR1_INPUT_CC2S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM1_CCMR1_INPUT_CC2S_B_0x0 = 0;
        /** @brief CC2 channel is configured as input, IC2 is mapped on TI2 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_CC2S_B_0x1 = 1;
        /** @brief CC2 channel is configured as input, IC2 is mapped on TI1 */
    constexpr std::uint32_t TIM1_CCMR1_INPUT_CC2S_B_0x2 = 2;
    ...
    constexpr std::uint32_t TIM1_CCMR1_INPUT_CC2S_B_0x3 = 3;

    /** @brief Input capture 2 prescaler Refer to IC1PSC[1:0] description. */
    using TIM1_CCMR1_INPUT_IC2PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Input capture 2 filter Refer to IC1F[3:0] description. */
    using TIM1_CCMR1_INPUT_IC2F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM1 capture/compare mode register 1 */
    using TIM1_CCMR1_OUTPUT = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x18, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIMx_CCER). */
    using TIM1_CCMR1_OUTPUT_CC1S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC1 channel is configured as output (value: 0)
     *          - B_0x1: CC1 channel is configured as input, IC1 is mapped on TI1 (value: 1)
     *          - B_0x2: CC1 channel is configured as input, IC1 is mapped on TI2 (value: 2)
     ...
     */
        /** @brief CC1 channel is configured as output */
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_CC1S_B_0x0 = 0;
        /** @brief CC1 channel is configured as input, IC1 is mapped on TI1 */
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_CC1S_B_0x1 = 1;
        /** @brief CC1 channel is configured as input, IC1 is mapped on TI2 */
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_CC1S_B_0x2 = 2;
        /** @brief CC1 channel is configured as input, IC1 is mapped on TRC. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register) */
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_CC1S_B_0x3 = 3;
    ...
    using TIM1_CCMR1_OUTPUT_OC1FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_OC1FE_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_OC1FE_B_0x1 = 1;
    ...
    using TIM1_CCMR1_OUTPUT_OC1PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_OC1PE_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_OC1PE_B_0x1 = 1;
    ...
    using TIM1_CCMR1_OUTPUT_OC1M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_OC1M_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_OC1M_B_0x1 = 1;
    ...
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_OC1M_B_0x2 = 2;
        /** @brief Toggle - OC1REF toggles when TIMx_CNT=TIMx_CCR1. */
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_OC1M_B_0x3 = 3;
        /** @brief Force inactive level - OC1REF is forced low. */
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_OC1M_B_0x4 = 4;
        /** @brief Force active level - OC1REF is forced high. */
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_OC1M_B_0x5 = 5;
    ...
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_OC1M_B_0x6 = 6;
    ...
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_OC1M_B_0x7 = 7;

    /** @brief Output Compare 1 clear enable */
    using TIM1_CCMR1_OUTPUT_OC1CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: OC1Ref is not affected by the ocref_clr_int signal (value: 0)
     *          - B_0x1: OC1Ref is cleared as soon as a High level is detected on ocref_clr_int signal (OCREF_CLR input or ETRF input) (value: 1)
     */
        /** @brief OC1Ref is not affected by the ocref_clr_int signal */
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_OC1CE_B_0x0 = 0;
        /** @brief OC1Ref is cleared as soon as a High level is detected on ocref_clr_int signal (OCREF_CLR input or ETRF input) */
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_OC1CE_B_0x1 = 1;

    /** @brief Capture/Compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = 0 in TIMx_CCER). */
    using TIM1_CCMR1_OUTPUT_CC2S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC2 channel is configured as output (value: 0)
     *          - B_0x1: CC2 channel is configured as input, IC2 is mapped on TI2 (value: 1)
     *          - B_0x2: CC2 channel is configured as input, IC2 is mapped on TI1 (value: 2)
     ...
     */
        /** @brief CC2 channel is configured as output */
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_CC2S_B_0x0 = 0;
        /** @brief CC2 channel is configured as input, IC2 is mapped on TI2 */
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_CC2S_B_0x1 = 1;
        /** @brief CC2 channel is configured as input, IC2 is mapped on TI1 */
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_CC2S_B_0x2 = 2;
    ...
    constexpr std::uint32_t TIM1_CCMR1_OUTPUT_CC2S_B_0x3 = 3;

    /** @brief Output Compare 2 fast enable Refer to OC1FE description. */
    using TIM1_CCMR1_OUTPUT_OC2FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output Compare 2 preload enable Refer to OC1PE description. */
    using TIM1_CCMR1_OUTPUT_OC2PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC2M[2:0]: Output Compare 2 mode Refer to OC1M[3:0] description. */
    using TIM1_CCMR1_OUTPUT_OC2M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output Compare 2 clear enable Refer to OC1CE description. */
    using TIM1_CCMR1_OUTPUT_OC2CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC1M[3] */
    using TIM1_CCMR1_OUTPUT_OC1M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC2M[3] */
    using TIM1_CCMR1_OUTPUT_OC2M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM1 capture/compare mode register 2 */
    using TIM1_CCMR2_INPUT = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM1_CCMR2_INPUT_CC3S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM1_CCMR2_INPUT_CC3S_B_0x0 = 0;
        /** @brief CC3 channel is configured as input, IC3 is mapped on TI3 */
    constexpr std::uint32_t TIM1_CCMR2_INPUT_CC3S_B_0x1 = 1;
        /** @brief CC3 channel is configured as input, IC3 is mapped on TI4 */
    constexpr std::uint32_t TIM1_CCMR2_INPUT_CC3S_B_0x2 = 2;
    ...
    constexpr std::uint32_t TIM1_CCMR2_INPUT_CC3S_B_0x3 = 3;

    /** @brief Input capture 3 prescaler Refer to IC1PSC[1:0] description. */
    using TIM1_CCMR2_INPUT_IC3PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Input capture 3 filter Refer to IC1F[3:0] description. */
    using TIM1_CCMR2_INPUT_IC3F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM1_CCMR2_INPUT_CC4S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM1_CCMR2_INPUT_CC4S_B_0x0 = 0;
        /** @brief CC4 channel is configured as input, IC4 is mapped on TI4 */
    constexpr std::uint32_t TIM1_CCMR2_INPUT_CC4S_B_0x1 = 1;
        /** @brief CC4 channel is configured as input, IC4 is mapped on TI3 */
    constexpr std::uint32_t TIM1_CCMR2_INPUT_CC4S_B_0x2 = 2;
    ...
    constexpr std::uint32_t TIM1_CCMR2_INPUT_CC4S_B_0x3 = 3;

    /** @brief Input capture 4 prescaler Refer to IC1PSC[1:0] description. */
    using TIM1_CCMR2_INPUT_IC4PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Input capture 4 filter Refer to IC1F[3:0] description. */
    using TIM1_CCMR2_INPUT_IC4F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM1 capture/compare mode register 1 */
    using TIM1_CCMR2_OUTPUT = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = 0 in TIMx_CCER). */
    using TIM1_CCMR2_OUTPUT_CC3S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC3 channel is configured as output (value: 0)
     *          - B_0x1: CC3 channel is configured as input, IC3 is mapped on TI3 (value: 1)
     *          - B_0x2: CC3 channel is configured as input, IC3 is mapped on TI4 (value: 2)
     ...
     */
        /** @brief CC3 channel is configured as output */
    constexpr std::uint32_t TIM1_CCMR2_OUTPUT_CC3S_B_0x0 = 0;
        /** @brief CC3 channel is configured as input, IC3 is mapped on TI3 */
    constexpr std::uint32_t TIM1_CCMR2_OUTPUT_CC3S_B_0x1 = 1;
        /** @brief CC3 channel is configured as input, IC3 is mapped on TI4 */
    constexpr std::uint32_t TIM1_CCMR2_OUTPUT_CC3S_B_0x2 = 2;
        /** @brief CC3 channel is configured as input, IC3 is mapped on TRC. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register) */
    constexpr std::uint32_t TIM1_CCMR2_OUTPUT_CC3S_B_0x3 = 3;

    /** @brief Output compare 3 fast enable Refer to OC1FE description. */
    using TIM1_CCMR2_OUTPUT_OC3FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 3 preload enable Refer to OC1PE description. */
    using TIM1_CCMR2_OUTPUT_OC3PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC3M[2:0]: Output compare 3 mode Refer to OC1M[3:0] description. */
    using TIM1_CCMR2_OUTPUT_OC3M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 3 clear enable Refer to OC1CE description. */
    using TIM1_CCMR2_OUTPUT_OC3CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = 0 in TIMx_CCER). */
    using TIM1_CCMR2_OUTPUT_CC4S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC4 channel is configured as output (value: 0)
     *          - B_0x1: CC4 channel is configured as input, IC4 is mapped on TI4 (value: 1)
     *          - B_0x2: CC4 channel is configured as input, IC4 is mapped on TI3 (value: 2)
     ...
     */
        /** @brief CC4 channel is configured as output */
    constexpr std::uint32_t TIM1_CCMR2_OUTPUT_CC4S_B_0x0 = 0;
        /** @brief CC4 channel is configured as input, IC4 is mapped on TI4 */
    constexpr std::uint32_t TIM1_CCMR2_OUTPUT_CC4S_B_0x1 = 1;
        /** @brief CC4 channel is configured as input, IC4 is mapped on TI3 */
    constexpr std::uint32_t TIM1_CCMR2_OUTPUT_CC4S_B_0x2 = 2;
        /** @brief CC4 channel is configured as input, IC4 is mapped on TRC. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register) */
    constexpr std::uint32_t TIM1_CCMR2_OUTPUT_CC4S_B_0x3 = 3;

    /** @brief Output compare 4 fast enable Refer to OC1FE description. */
    using TIM1_CCMR2_OUTPUT_OC4FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 4 preload enable Refer to OC1PE description. */
    using TIM1_CCMR2_OUTPUT_OC4PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC4M[2:0]: Output compare 4 mode Refer to OC3M[3:0] description. */
    using TIM1_CCMR2_OUTPUT_OC4M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 4 clear enable Refer to OC1CE description. */
    using TIM1_CCMR2_OUTPUT_OC4CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC3M[3] */
    using TIM1_CCMR2_OUTPUT_OC3M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC4M[3] */
    using TIM1_CCMR2_OUTPUT_OC4M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM1_ARR = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x2C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section122.3.1: Time-base unit on page1497 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null. */
    using TIM1_ARR_ARR = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM1_CCR1 = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x34, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM1_CCR1_CCR1 = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM1 capture/compare register 2 */
    using TIM1_CCR2 = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x38, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM1_CCR2_CCR2 = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM1 capture/compare register 3 */
    using TIM1_CCR3 = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x3C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM1_CCR3_CCR3 = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM1 capture/compare register 4 */
    using TIM1_CCR4 = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x40, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM1_CCR4_CCR4 = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
     ...
     *          - B_0x1: LOCK Level 1 = DTG bits in TIMx_BDTR register, OISx and OISxN bits in TIMx_CR2 register and BK2BID, BKBID, BK2DSRM, BKDSRM, BK2P, BK2E, BK2F[3:0], BKF[3:0], AOE, BKP, BKE, OSSI, OSSR and DTG[7:0] bits in TIMx_BDTR register can no longer be written. (value: 1)
    ...
    constexpr std::uint32_t TIM1_BDTR_LOCK_B_0x0 = 0;
        /** @brief LOCK Level 1 = DTG bits in TIMx_BDTR register, OISx and OISxN bits in TIMx_CR2 register and BK2BID, BKBID, BK2DSRM, BKDSRM, BK2P, BK2E, BK2F[3:0], BKF[3:0], AOE, BKP, BKE, OSSI, OSSR and DTG[7:0] bits in TIMx_BDTR register can no longer be written. */
    ...
    /** @brief Break 2 enable Note: The BRK2 must only be used with OSSR = OSSI = 1. Note: This bit cannot be modified when LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). Note: Any write operation to this bit takes a delay of 1 APB clock cycle to become effective. */
    using TIM1_BDTR_BK2E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Break input BRK2 disabled (value: 0)
     *          - B_0x1: Break input BRK2 enabled (value: 1)
     */
        /** @brief Break input BRK2 disabled */
    constexpr std::uint32_t TIM1_BDTR_BK2E_B_0x0 = 0;
        /** @brief Break input BRK2 enabled */
    ...
    using TIM1_DCR = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x48, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM1_DCR_DBA = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     ...
     */
        /** @brief TIMx_CR1, */
    constexpr std::uint16_t TIM1_DCR_DBA_B_0x0 = 0;
        /** @brief TIMx_CR2, */
    constexpr std::uint16_t TIM1_DCR_DBA_B_0x1 = 1;
        /** @brief TIMx_SMCR, */
    constexpr std::uint16_t TIM1_DCR_DBA_B_0x2 = 2;
    ...
    using TIM1_DCR_DBL = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 8, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     ...
     */
        /** @brief 1 transfer */
    constexpr std::uint16_t TIM1_DCR_DBL_B_0x0 = 0;
        /** @brief 2 transfers */
    constexpr std::uint16_t TIM1_DCR_DBL_B_0x1 = 1;
        /** @brief 3 transfers */
    constexpr std::uint16_t TIM1_DCR_DBL_B_0x2 = 2;
        /** @brief 18 transfers */
    constexpr std::uint16_t TIM1_DCR_DBL_B_0x11 = 17;

    /** @brief TIM1 DMA address for full transfer */
    using TIM1_DMAR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x4C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM1_OR1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x50, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Ocref_clr source selection This bit selects the ocref_clr input source. Others: Reserved Note: COMP3 is available on STM32G0B1xx and STM32G0C1xx salestypes only. */
    using TIM1_OR1_OCREF_CLR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM1_OR1_OCREF_CLR_B_0x0 = 0;
        /** @brief COMP2 output is connected to the OCREF_CLR input */
    constexpr std::uint32_t TIM1_OR1_OCREF_CLR_B_0x1 = 1;

    /** @brief TIM1 capture/compare mode register 3 */
    using TIM1_CCMR3 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x54, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM1_CCR5 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x58, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM1_CCR5_CCR5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM1_CCR6 = ::EmbeddedPP::LowLevel::Register<std::uint16_t, 0x5C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM1_CCR6_CCR6 = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief BRK BKIN input enable This bit enables the BKIN alternate function input for the timers BRK input. BKIN input is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief BRK COMP1 enable This bit enables the COMP1 for the timers BRK input. COMP1 output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief BRK COMP2 enable This bit enables the COMP2 for the timers BRK input. COMP2 output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
     ...
     *          - B_0x3: ADC1 AWD1 (value: 3)
     *          - B_0x4: ADC1 AWD2 (value: 4)
     *          - B_0x5: ADC1 AWD3 (value: 5)
     *          - B_0x6: COMP3 output (available on STM32G0B1xx and STM32G0C1xx salestypes only) (value: 6)
     */
    ...
    constexpr std::uint32_t TIM1_AF1_ETRSEL_B_0x1 = 1;
        /** @brief COMP2 output */
    constexpr std::uint32_t TIM1_AF1_ETRSEL_B_0x2 = 2;
        /** @brief ADC1 AWD1 */
    constexpr std::uint32_t TIM1_AF1_ETRSEL_B_0x3 = 3;
        /** @brief ADC1 AWD2 */
    constexpr std::uint32_t TIM1_AF1_ETRSEL_B_0x4 = 4;
        /** @brief ADC1 AWD3 */
    constexpr std::uint32_t TIM1_AF1_ETRSEL_B_0x5 = 5;
        /** @brief COMP3 output (available on STM32G0B1xx and STM32G0C1xx salestypes only) */
    constexpr std::uint32_t TIM1_AF1_ETRSEL_B_0x6 = 6;
    ...
    /** @brief BRK2 BKIN input enable This bit enables the BKIN2 alternate function input for the timers BRK2 input. BKIN2 input is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief BRK2 COMP1 enable This bit enables the COMP1 for the timers BRK2 input. COMP1 output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief BRK2 COMP2 enable This bit enables the COMP2 for the timers BRK2 input. COMP2 output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    using TIM1_TISEL = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x68, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @details Possible values:
     *          - B_0x0: TIM1_CH1 input (value: 0)
     *          - B_0x1: COMP1 output (value: 1)
     */
        /** @brief TIM1_CH1 input */
