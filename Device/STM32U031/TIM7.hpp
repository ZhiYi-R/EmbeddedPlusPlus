...
#ifndef EMBEDDED_PP_STM32U031_TIM7_HPP
#define EMBEDDED_PP_STM32U031_TIM7_HPP
...
namespace STM32U031::TIM7 {
    ...
    /** @brief Prescaler value ARR is the value to be loaded into the actual auto-reload register. Refer to Section123.3.1: Time-base unit on page1596 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null. */
