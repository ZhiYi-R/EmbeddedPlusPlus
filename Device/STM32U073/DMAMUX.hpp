...
#ifndef EMBEDDED_PP_STM32U073_DMAMUX_HPP
#define EMBEDDED_PP_STM32U073_DMAMUX_HPP
...
namespace STM32U073::DMAMUX {
    ...
    /** @brief Synchronization identification Selects the synchronization input (see Table137: DMAMUX: assignment of synchronization inputs to resources). */
