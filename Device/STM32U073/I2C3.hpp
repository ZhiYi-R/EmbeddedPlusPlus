...
#ifndef EMBEDDED_PP_STM32U073_I2C3_HPP
#define EMBEDDED_PP_STM32U073_I2C3_HPP
...
namespace STM32U073::I2C3 {
    ...
    /** @brief Error interrupts enable Note: Any of these errors generate an interrupt: Note: Arbitration loss (ARLO) Note: Bus error detection (BERR) Note: Overrun/Underrun (OVR) */
    ...
    /** @details Possible values:
     *          - B_0x0: Wake-up from Stop mode disable. (value: 0)
     *          - B_0x1: Wake-up from Stop mode enable. (value: 1)
     */
        /** @brief Wake-up from Stop mode disable. */
     ...
     *          - B_0x1: The master only sends the first seven bits of the 10-bit address, followed by Read direction. (value: 1)
     */
    ...
    constexpr std::uint32_t I2C_CR2_HEAD10R_B_0x0 = 0;
        /** @brief The master only sends the first seven bits of the 10-bit address, followed by Read direction. */
