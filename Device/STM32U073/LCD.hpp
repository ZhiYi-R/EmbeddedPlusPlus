...
#ifndef EMBEDDED_PP_STM32U073_LCD_HPP
#define EMBEDDED_PP_STM32U073_LCD_HPP
...
namespace STM32U073::LCD {
    ...
    /** @brief Voltage source selection This bit determines the voltage source for the LCD. */
    using LCD_CR_VSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Internal source (voltage stepup converter) (value: 0)
     *          - B_0x1: External source (VLCD pin) (value: 1)
     */
        /** @brief Internal source (voltage stepup converter) */
    constexpr std::uint32_t LCD_CR_VSEL_B_0x0 = 0;
        /** @brief External source (VLCD pin) */
    constexpr std::uint32_t LCD_CR_VSEL_B_0x1 = 1;

    /** @brief Duty selection These bits determine the duty cycle. Values 101, 110 and 111 are forbidden. Others: Reserved */
    ...
    /** @brief Mux segment enable This bit is used to enable SEG pin remapping. Four SEG pins can be multiplexed with1SEG[31:28] or SEG[15:12]. See Section118.3.7. */
     ...
     *          - B_0x1: SEG[31:28] multiplexed with SEG[43:40] (value: 1)
     */
        /** @brief SEG pin multiplexing disabled */
    constexpr std::uint32_t LCD_CR_MUX_SEG_B_0x0 = 0;
        /** @brief SEG[31:28] multiplexed with SEG[43:40] */
     ...
     *          - B_0x1: Permanent high drive enabled. When HD = 1, PON[2:0] must be programmed to 001. (value: 1)
     */
        /** @brief Permanent high drive disabled */
    constexpr std::uint32_t LCD_FCR_HD_B_0x0 = 0;
        /** @brief Permanent high drive enabled. When HD = 1, PON[2:0] must be programmed to 001. */
    ...
    /** @details Possible values:
     *          - B_0x0: 0 1s (value: 0)
     *          - B_0x1: 244 1s (value: 1)
     *          - B_0x2: 488 1s (value: 2)
     *          - B_0x3: 782 1s (value: 3)
     *          - B_0x4: 976 1s (value: 4)
    ...
    /** @brief Contrast control These bits specify one of the V<sub>LCD </sub>maximum voltages (independent of V<sub>DD</sub>). It ranges from12.60 V to 3.51V. Note: Refer to the datasheet for the V<sub>LCDx</sub> values. */
    ...
    /** @brief DIV clock divider These bits are written by software to define the division factor of the DIV divider (see1Section118.3.2.) ... */
    ...
    /** @brief PS 16-bit prescaler These bits are written by software to define the division factor of the PS 16-bit prescaler. ck_ps = LCDCLK/(2<sup>PS[3:0]</sup>). See<sub> </sub>Section118.3.2. ... */
    ...
    /** @brief LCD enabled status This bit is set and cleared by hardware. It indicates the LCD controller status. Note: This bit is set immediately when LCDEN in LCD_CR goes from 0 to 1. On deactivation, it reflects the real LCD status. It becomes 0 at the end of the last displayed frame. */
    ...
    /** @brief Start-of-frame flag This bit is set by hardware at the beginning of a new frame, at the same time as the display data is updated. It is cleared by writing a 1 to SOFC in LCD_CLR. The bit clear has priority over the set. */
    ...
    /** @details Possible values:
     *          - B_0x0: No event (value: 0)
     *          - B_0x1: Update display request done. A UDD interrupt is generated if UDDIE = 1 in LCD_FCR. (value: 1)
     */
        /** @brief No event */
    constexpr std::uint32_t LCD_SR_UDD_B_0x0 = 0;
        /** @brief Update display request done. A UDD interrupt is generated if UDDIE = 1 in LCD_FCR. */
    constexpr std::uint32_t LCD_SR_UDD_B_0x1 = 1;

    /** @brief Ready flag This bit is set and cleared by hardware. It indicates the status of the stepup converter. */
     ...
     *          - B_0x1: Stepup converter enabled and ready to provide the correct voltage (value: 1)
     */
        /** @brief Not ready */
    constexpr std::uint32_t LCD_SR_RDY_B_0x0 = 0;
        /** @brief Stepup converter enabled and ready to provide the correct voltage */
    ...
    /** @brief Start-of-frame flag clear This bit is written by software to clear SOF in LCD_SR. */
    ...
    /** @brief Update display done clear This bit is written by software to clear UDD in LCD_SR. */
    ...
    /** @brief Each bit corresponds to one pixel of the LCD display. */
    using LCD_RAM1_SEGMENT_DATA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 20, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Pixel inactive (value: 0)
     *          - B_0x1: Pixel active (value: 1)
     */
    ...
    /** @brief Each bit corresponds to one pixel of the LCD display. */
    using LCD_RAM3_SEGMENT_DATA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 20, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Pixel inactive (value: 0)
     *          - B_0x1: Pixel active (value: 1)
     */
    ...
    /** @brief Each bit corresponds to one pixel of the LCD display. */
    using LCD_RAM5_SEGMENT_DATA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 20, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Pixel inactive (value: 0)
     *          - B_0x1: Pixel active (value: 1)
     */
    ...
    /** @brief Each bit corresponds to one pixel of the LCD display. */
    using LCD_RAM7_SEGMENT_DATA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 20, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Pixel inactive (value: 0)
     *          - B_0x1: Pixel active (value: 1)
     */
    ...
    /** @brief Each bit corresponds to one pixel of the LCD display. */
    using LCD_RAM9_SEGMENT_DATA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Pixel inactive (value: 0)
     *          - B_0x1: Pixel active (value: 1)
     */
    ...
    /** @brief Each bit corresponds to one pixel of the LCD display. */
    using LCD_RAM11_SEGMENT_DATA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Pixel inactive (value: 0)
     *          - B_0x1: Pixel active (value: 1)
     */
    ...
    /** @brief Each bit corresponds to one pixel of the LCD display. */
    using LCD_RAM13_SEGMENT_DATA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Pixel inactive (value: 0)
     *          - B_0x1: Pixel active (value: 1)
     */
    ...
    /** @brief Each bit corresponds to one pixel of the LCD display. */
    using LCD_RAM15_SEGMENT_DATA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Pixel inactive (value: 0)
     *          - B_0x1: Pixel active (value: 1)
     */
