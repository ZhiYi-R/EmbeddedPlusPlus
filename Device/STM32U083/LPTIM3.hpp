...
#ifndef EMBEDDED_PP_STM32U083_LPTIM3_HPP
#define EMBEDDED_PP_STM32U083_LPTIM3_HPP
...
namespace STM32U083::LPTIM3 {
    ...
    using LPTIM3_ISR_OUTPUT_CC3IF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No match (value: 0)
     *          - B_0x1: The content of the counter LPTIM_CNT register value has matched the LPTIM_CCR3 register's value. (value: 1)
     */
        /** @brief No match */
    constexpr std::uint32_t LPTIM3_ISR_OUTPUT_CC3IF_B_0x0 = 0;
        /** @brief The content of the counter LPTIM_CNT register value has matched the LPTIM_CCR3 register's value. */
    constexpr std::uint32_t LPTIM3_ISR_OUTPUT_CC3IF_B_0x1 = 1;
    ...
    using LPTIM3_ISR_OUTPUT_CC4IF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No match (value: 0)
     *          - B_0x1: The content of the counter LPTIM_CNT register value has matched the LPTIM_CCR4 register's value (value: 1)
     */
        /** @brief No match */
    constexpr std::uint32_t LPTIM3_ISR_OUTPUT_CC4IF_B_0x0 = 0;
        /** @brief The content of the counter LPTIM_CNT register value has matched the LPTIM_CCR4 register's value */
    constexpr std::uint32_t LPTIM3_ISR_OUTPUT_CC4IF_B_0x1 = 1;
    ...
    using LPTIM3_ISR_OUTPUT_CMP3OK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPTIM3_ISR_OUTPUT_CMP4OK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPTIM3_ISR_INPUT_CC3IF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No input capture occurred (value: 0)
     ...
     */
        /** @brief No input capture occurred */
    constexpr std::uint32_t LPTIM3_ISR_INPUT_CC3IF_B_0x0 = 0;
        /** @brief The counter value has been captured in the LPTIM_CCR3 register. (An edge has been detected on IC3 which matches the selected polarity). The CC3IF flag is automatically cleared by hardware once the captured value is read (CPU or DMA). The CC3IF flag can be cleared by writing 1 to the CC3CF bit in the LPTIM_ICR register. */
    constexpr std::uint32_t LPTIM3_ISR_INPUT_CC3IF_B_0x1 = 1;
    ...
    using LPTIM3_ISR_INPUT_CC4IF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No input capture occurred (value: 0)
     ...
     */
        /** @brief No input capture occurred */
    constexpr std::uint32_t LPTIM3_ISR_INPUT_CC4IF_B_0x0 = 0;
        /** @brief The counter value has been captured in the LPTIM_CCR4 register. (An edge has been detected on IC4 which matches the selected polarity). The CC4IF flag is automatically cleared by hardware once the captured value is read (CPU or DMA). The CC4IF flag can be cleared by writing 1 to the CC4CF bit in the LPTIM_ICR register. */
    constexpr std::uint32_t LPTIM3_ISR_INPUT_CC4IF_B_0x1 = 1;
    ...
    using LPTIM3_ISR_INPUT_CC3OF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No over-capture has been detected. (value: 0)
     *          - B_0x1: The counter value has been captured in LPTIM_CCR3 register while CC3IF flag was already set (value: 1)
     */
        /** @brief No over-capture has been detected. */
    constexpr std::uint32_t LPTIM3_ISR_INPUT_CC3OF_B_0x0 = 0;
        /** @brief The counter value has been captured in LPTIM_CCR3 register while CC3IF flag was already set */
    constexpr std::uint32_t LPTIM3_ISR_INPUT_CC3OF_B_0x1 = 1;
    ...
    using LPTIM3_ISR_INPUT_CC4OF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No over-capture has been detected. (value: 0)
     *          - B_0x1: The counter value has been captured in LPTIM_CCR4 register while CC4IF flag was already set (value: 1)
     */
        /** @brief No over-capture has been detected. */
    constexpr std::uint32_t LPTIM3_ISR_INPUT_CC4OF_B_0x0 = 0;
        /** @brief The counter value has been captured in LPTIM_CCR4 register while CC4IF flag was already set */
    constexpr std::uint32_t LPTIM3_ISR_INPUT_CC4OF_B_0x1 = 1;
    ...
    using LPTIM3_ICR_OUTPUT_CC3CF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPTIM3_ICR_OUTPUT_CC4CF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPTIM3_ICR_OUTPUT_CMP3OKCF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPTIM3_ICR_OUTPUT_CMP4OKCF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Capture/compare 3 clear flag Writing 1 to this bit clears the CC3IF flag in the LPTIM_ISR register. Note: If LPTIM does not implement at least 3 channels this bit is reserved. Refer to Section125.3. */
    using LPTIM3_ICR_INPUT_CC3CF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/compare 4 clear flag Writing 1 to this bit clears the CC4IF flag in the LPTIM_ISR register. Note: If LPTIM does not implement at least 4 channels this bit is reserved. Refer to Section125.3. */
    using LPTIM3_ICR_INPUT_CC4CF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPTIM3_ICR_INPUT_CC3OCF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPTIM3_ICR_INPUT_CC4OCF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Interrupt enable register update OK clear flag Writing 1 to this bit clears the DIEROK flag in the LPTIM_ISR register. */
    ...
    using LPTIM3_DIER_OUTPUT_CC3IE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPTIM3_DIER_OUTPUT_CC3IE_B_0x0 = 0;
        /** @brief Capture/compare 3 interrupt enabled */
    constexpr std::uint32_t LPTIM3_DIER_OUTPUT_CC3IE_B_0x1 = 1;
    ...
    using LPTIM3_DIER_OUTPUT_CC4IE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPTIM3_DIER_OUTPUT_CC4IE_B_0x0 = 0;
        /** @brief Capture/compare 4 interrupt enabled */
    constexpr std::uint32_t LPTIM3_DIER_OUTPUT_CC4IE_B_0x1 = 1;
    ...
    using LPTIM3_DIER_OUTPUT_CMP3OKIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPTIM3_DIER_OUTPUT_CMP3OKIE_B_0x0 = 0;
        /** @brief CMPOK register 3 interrupt enabled */
    constexpr std::uint32_t LPTIM3_DIER_OUTPUT_CMP3OKIE_B_0x1 = 1;
    ...
    using LPTIM3_DIER_OUTPUT_CMP4OKIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPTIM3_DIER_OUTPUT_CMP4OKIE_B_0x0 = 0;
        /** @brief CMPOK register 4 interrupt enabled */
    constexpr std::uint32_t LPTIM3_DIER_OUTPUT_CMP4OKIE_B_0x1 = 1;
    ...
    /** @brief Capture/compare 3 interrupt enable Note: If LPTIM does not implement at least 3 channels this bit is reserved. Refer to Section125.3. */
    using LPTIM3_DIER_INPUT_CC3IE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Capture/compare 3 interrupt disabled (value: 0)
     *          - B_0x1: Capture/compare 3 interrupt enabled (value: 1)
     */
        /** @brief Capture/compare 3 interrupt disabled */
    constexpr std::uint32_t LPTIM3_DIER_INPUT_CC3IE_B_0x0 = 0;
        /** @brief Capture/compare 3 interrupt enabled */
    constexpr std::uint32_t LPTIM3_DIER_INPUT_CC3IE_B_0x1 = 1;

    /** @brief Capture/compare 4 interrupt enable Note: If LPTIM does not implement at least 4 channels this bit is reserved. Refer to Section125.3. */
    using LPTIM3_DIER_INPUT_CC4IE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Capture/compare 4 interrupt disabled (value: 0)
     *          - B_0x1: Capture/compare 4 interrupt enabled (value: 1)
     */
        /** @brief Capture/compare 4 interrupt disabled */
    constexpr std::uint32_t LPTIM3_DIER_INPUT_CC4IE_B_0x0 = 0;
        /** @brief Capture/compare 4 interrupt enabled */
    constexpr std::uint32_t LPTIM3_DIER_INPUT_CC4IE_B_0x1 = 1;
    ...
    using LPTIM3_DIER_INPUT_CC3OIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPTIM3_DIER_INPUT_CC3OIE_B_0x0 = 0;
        /** @brief CC3 over-capture interrupt enabled */
    constexpr std::uint32_t LPTIM3_DIER_INPUT_CC3OIE_B_0x1 = 1;
    ...
    using LPTIM3_DIER_INPUT_CC4OIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPTIM3_DIER_INPUT_CC4OIE_B_0x0 = 0;
        /** @brief CC4 over-capture interrupt enabled */
    constexpr std::uint32_t LPTIM3_DIER_INPUT_CC4OIE_B_0x1 = 1;
    ...
    using LPTIM3_DIER_INPUT_CC3DE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPTIM3_DIER_INPUT_CC3DE_B_0x0 = 0;
        /** @brief CC3 DMA request enabled */
    constexpr std::uint32_t LPTIM3_DIER_INPUT_CC3DE_B_0x1 = 1;
    ...
    using LPTIM3_DIER_INPUT_CC4DE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPTIM3_DIER_INPUT_CC4DE_B_0x0 = 0;
        /** @brief CC4 DMA request enabled */
    constexpr std::uint32_t LPTIM3_DIER_INPUT_CC4DE_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: LPTIM3_ext_trig0 (value: 0)
     *          - B_0x1: LPTIM3_ext_trig1 (value: 1)
     *          - B_0x2: LPTIM3_ext_trig2 (value: 2)
     *          - B_0x3: LPTIM3_ext_trig3 (value: 3)
     *          - B_0x4: LPTIM3_ext_trig4 (value: 4)
     *          - B_0x5: LPTIM3_ext_trig5 (value: 5)
     *          - B_0x6: LPTIM3_ext_trig6 (value: 6)
     *          - B_0x7: LPTIM3_ext_trig7 (value: 7)
     */
        /** @brief LPTIM3_ext_trig0 */
    constexpr std::uint32_t LPTIM3_CFGR_TRIGSEL_B_0x0 = 0;
        /** @brief LPTIM3_ext_trig1 */
    constexpr std::uint32_t LPTIM3_CFGR_TRIGSEL_B_0x1 = 1;
        /** @brief LPTIM3_ext_trig2 */
    constexpr std::uint32_t LPTIM3_CFGR_TRIGSEL_B_0x2 = 2;
        /** @brief LPTIM3_ext_trig3 */
    constexpr std::uint32_t LPTIM3_CFGR_TRIGSEL_B_0x3 = 3;
        /** @brief LPTIM3_ext_trig4 */
    constexpr std::uint32_t LPTIM3_CFGR_TRIGSEL_B_0x4 = 4;
        /** @brief LPTIM3_ext_trig5 */
    constexpr std::uint32_t LPTIM3_CFGR_TRIGSEL_B_0x5 = 5;
        /** @brief LPTIM3_ext_trig6 */
    constexpr std::uint32_t LPTIM3_CFGR_TRIGSEL_B_0x6 = 6;
        /** @brief LPTIM3_ext_trig7 */
    ...
    /** @brief Registers update mode The PRELOAD bit controls the LPTIM3_ARR, LPTIM3_RCR and the LPTIM3_CCRx registers update modality */
    ...
    /** @brief Reset after read enable This bit is set and cleared by software. When RSTARE is set to '1', any read access to LPTIM3_CNT register asynchronously resets LPTIM3_CNT register content. This bit can be set only when the LPTIM is enabled. */
    ...
    /** @brief Counter value When the LPTIM is running with an asynchronous clock, reading the LPTIM3_CNT register may return unreliable values. So in this case it is necessary to perform two consecutive read accesses and verify that the two returned values are identical. */
    ...
    /** @details Possible values:
     *          - B_0x0: LPTIM3_in1_mux0 (value: 0)
     *          - B_0x1: LPTIM3_in1_mux1 (value: 1)
     *          - B_0x2: LPTIM3_in1_mux2 (value: 2)
     *          - B_0x3: LPTIM3_in1_mux3 (value: 3)
     */
        /** @brief LPTIM3_in1_mux0 */
    constexpr std::uint32_t LPTIM3_CFGR2_IN1SEL_B_0x0 = 0;
        /** @brief LPTIM3_in1_mux1 */
    constexpr std::uint32_t LPTIM3_CFGR2_IN1SEL_B_0x1 = 1;
        /** @brief LPTIM3_in1_mux2 */
    constexpr std::uint32_t LPTIM3_CFGR2_IN1SEL_B_0x2 = 2;
        /** @brief LPTIM3_in1_mux3 */
    ...
    /** @details Possible values:
     *          - B_0x0: LPTIM3_in2_mux0 (value: 0)
     *          - B_0x1: LPTIM3_in2_mux1 (value: 1)
     *          - B_0x2: LPTIM3_in2_mux2 (value: 2)
     *          - B_0x3: LPTIM3_in2_mux3 (value: 3)
     */
        /** @brief LPTIM3_in2_mux0 */
    constexpr std::uint32_t LPTIM3_CFGR2_IN2SEL_B_0x0 = 0;
        /** @brief LPTIM3_in2_mux1 */
    constexpr std::uint32_t LPTIM3_CFGR2_IN2SEL_B_0x1 = 1;
        /** @brief LPTIM3_in2_mux2 */
    constexpr std::uint32_t LPTIM3_CFGR2_IN2SEL_B_0x2 = 2;
        /** @brief LPTIM3_in2_mux3 */
    ...
    /** @details Possible values:
     *          - B_0x0: LPTIM3_ic1_mux0 (value: 0)
     *          - B_0x1: LPTIM3_ic1_mux1 (value: 1)
     *          - B_0x2: LPTIM3_ic1_mux2 (value: 2)
     *          - B_0x3: LPTIM3_ic1_mux3 (value: 3)
     */
        /** @brief LPTIM3_ic1_mux0 */
    constexpr std::uint32_t LPTIM3_CFGR2_IC1SEL_B_0x0 = 0;
        /** @brief LPTIM3_ic1_mux1 */
    constexpr std::uint32_t LPTIM3_CFGR2_IC1SEL_B_0x1 = 1;
        /** @brief LPTIM3_ic1_mux2 */
    constexpr std::uint32_t LPTIM3_CFGR2_IC1SEL_B_0x2 = 2;
        /** @brief LPTIM3_ic1_mux3 */
    ...
    /** @details Possible values:
     *          - B_0x0: LPTIM3_ic2_mux0 (value: 0)
     *          - B_0x1: LPTIM3_ic2_mux1 (value: 1)
     *          - B_0x2: LPTIM3_ic2_mux2 (value: 2)
     *          - B_0x3: LPTIM3_ic2_mux3 (value: 3)
     */
        /** @brief LPTIM3_ic2_mux0 */
    constexpr std::uint32_t LPTIM3_CFGR2_IC2SEL_B_0x0 = 0;
        /** @brief LPTIM3_ic2_mux1 */
    constexpr std::uint32_t LPTIM3_CFGR2_IC2SEL_B_0x1 = 1;
        /** @brief LPTIM3_ic2_mux2 */
    constexpr std::uint32_t LPTIM3_CFGR2_IC2SEL_B_0x2 = 2;
        /** @brief LPTIM3_ic2_mux3 */
    ...
    /** @brief Capture/compare 1 output enable. This bit determines if a capture of the counter value can actually be done into the input capture/compare register 1 (LPTIM3_CCR1) or not. */
    ...
    /** @brief Capture/compare 2 output enable. This bit determines if a capture of the counter value can actually be done into the input capture/compare register 2 (LPTIM3_CCR2) or not. */
    ...
    using LPTIM3_CCMR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x30, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/compare 3 selection This bitfield defines the direction of the channel input (capture) or output mode. */
    using LPTIM3_CCMR2_CC3SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPTIM3_CCMR2_CC3SEL_B_0x0 = 0;
        /** @brief CC3 channel is configured in input capture mode */
    constexpr std::uint32_t LPTIM3_CCMR2_CC3SEL_B_0x1 = 1;

    /** @brief Capture/compare 3 output enable. Condition: CC3 as output: Condition: CC3 as input: This bit determines if a capture of the counter value can actually be done into the input capture/compare register 3 (LPTIM3_CCR3) or not. */
    using LPTIM3_CCMR2_CC3E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPTIM3_CCMR2_CC3E_B_0x0 = 0;
        /** @brief Capture enabled. */
    constexpr std::uint32_t LPTIM3_CCMR2_CC3E_B_0x1 = 1;
    ...
    using LPTIM3_CCMR2_CC3P = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPTIM3_CCMR2_CC3P_B_0x0 = 0;
        /** @brief falling edge, circuit is sensitive to IC3 falling edge */
    constexpr std::uint32_t LPTIM3_CCMR2_CC3P_B_0x1 = 1;
        /** @brief reserved, do not use this configuration. */
    constexpr std::uint32_t LPTIM3_CCMR2_CC3P_B_0x2 = 2;
        /** @brief both edges, circuit is sensitive to both IC3 rising and falling edges. */
    constexpr std::uint32_t LPTIM3_CCMR2_CC3P_B_0x3 = 3;

    /** @brief Input capture 3 prescaler This bitfield defines the ratio of the prescaler acting on the CC3 input (IC3). */
    using LPTIM3_CCMR2_IC3PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no prescaler, capture is done each time an edge is detected on the capture input (value: 0)
     *          - B_0x1: capture is done once every 2 events (value: 1)
     *          - B_0x2: capture is done once every 4 events (value: 2)
     ...
     */
        /** @brief no prescaler, capture is done each time an edge is detected on the capture input */
    constexpr std::uint32_t LPTIM3_CCMR2_IC3PSC_B_0x0 = 0;
        /** @brief capture is done once every 2 events */
    constexpr std::uint32_t LPTIM3_CCMR2_IC3PSC_B_0x1 = 1;
        /** @brief capture is done once every 4 events */
    constexpr std::uint32_t LPTIM3_CCMR2_IC3PSC_B_0x2 = 2;
        /** @brief capture is done once every 8 events */
    constexpr std::uint32_t LPTIM3_CCMR2_IC3PSC_B_0x3 = 3;
    ...
    using LPTIM3_CCMR2_IC3F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: any external input capture signal level change is considered as a valid transition (value: 0)
     *          - B_0x1: external input capture signal level change must be stable for at least 2 clock periods before it is considered as valid transition. (value: 1)
     *          - B_0x2: external input capture signal level change must be stable for at least 4 clock periods before it is considered as valid transition. (value: 2)
     ...
     */
        /** @brief any external input capture signal level change is considered as a valid transition */
    constexpr std::uint32_t LPTIM3_CCMR2_IC3F_B_0x0 = 0;
        /** @brief external input capture signal level change must be stable for at least 2 clock periods before it is considered as valid transition. */
    constexpr std::uint32_t LPTIM3_CCMR2_IC3F_B_0x1 = 1;
        /** @brief external input capture signal level change must be stable for at least 4 clock periods before it is considered as valid transition. */
    constexpr std::uint32_t LPTIM3_CCMR2_IC3F_B_0x2 = 2;
        /** @brief external input capture signal level change must be stable for at least 8 clock periods before it is considered as valid transition. */
    constexpr std::uint32_t LPTIM3_CCMR2_IC3F_B_0x3 = 3;

    /** @brief Capture/compare 4 selection This bitfield defines the direction of the channel, input (capture) or output mode. */
    using LPTIM3_CCMR2_CC4SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPTIM3_CCMR2_CC4SEL_B_0x0 = 0;
        /** @brief CC4 channel is configured in input capture mode */
    constexpr std::uint32_t LPTIM3_CCMR2_CC4SEL_B_0x1 = 1;

    /** @brief Capture/compare 4 output enable. Condition: CC4 as output: Condition: CC4 as input: This bit determines if a capture of the counter value can actually be done into the input capture/compare register 4 (LPTIM3_CCR4) or not. */
    using LPTIM3_CCMR2_CC4E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPTIM3_CCMR2_CC4E_B_0x0 = 0;
        /** @brief Capture enabled. */
    constexpr std::uint32_t LPTIM3_CCMR2_CC4E_B_0x1 = 1;
    ...
    using LPTIM3_CCMR2_CC4P = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPTIM3_CCMR2_CC4P_B_0x0 = 0;
        /** @brief falling edge, circuit is sensitive to IC4 falling edge */
    constexpr std::uint32_t LPTIM3_CCMR2_CC4P_B_0x1 = 1;
        /** @brief reserved, do not use this configuration. */
    constexpr std::uint32_t LPTIM3_CCMR2_CC4P_B_0x2 = 2;
        /** @brief both edges, circuit is sensitive to both IC4 rising and falling edges. */
    constexpr std::uint32_t LPTIM3_CCMR2_CC4P_B_0x3 = 3;

    /** @brief Input capture 4 prescaler This bitfield defines the ratio of the prescaler acting on the CC4 input (IC4). */
    using LPTIM3_CCMR2_IC4PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no prescaler, capture is done each time an edge is detected on the capture input (value: 0)
     *          - B_0x1: capture is done once every 2 events (value: 1)
     *          - B_0x2: capture is done once every 4 events (value: 2)
     ...
     */
        /** @brief no prescaler, capture is done each time an edge is detected on the capture input */
    constexpr std::uint32_t LPTIM3_CCMR2_IC4PSC_B_0x0 = 0;
        /** @brief capture is done once every 2 events */
    constexpr std::uint32_t LPTIM3_CCMR2_IC4PSC_B_0x1 = 1;
        /** @brief capture is done once every 4 events */
    constexpr std::uint32_t LPTIM3_CCMR2_IC4PSC_B_0x2 = 2;
        /** @brief capture is done once every 8 events */
    constexpr std::uint32_t LPTIM3_CCMR2_IC4PSC_B_0x3 = 3;
    ...
    using LPTIM3_CCMR2_IC4F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: any external input capture signal level change is considered as a valid transition (value: 0)
     *          - B_0x1: external input capture signal level change must be stable for at least 2 clock periods before it is considered as valid transition. (value: 1)
     *          - B_0x2: external input capture signal level change must be stable for at least 4 clock periods before it is considered as valid transition. (value: 2)
     ...
     */
        /** @brief any external input capture signal level change is considered as a valid transition */
    constexpr std::uint32_t LPTIM3_CCMR2_IC4F_B_0x0 = 0;
        /** @brief external input capture signal level change must be stable for at least 2 clock periods before it is considered as valid transition. */
    constexpr std::uint32_t LPTIM3_CCMR2_IC4F_B_0x1 = 1;
        /** @brief external input capture signal level change must be stable for at least 4 clock periods before it is considered as valid transition. */
    constexpr std::uint32_t LPTIM3_CCMR2_IC4F_B_0x2 = 2;
        /** @brief external input capture signal level change must be stable for at least 8 clock periods before it is considered as valid transition. */
    constexpr std::uint32_t LPTIM3_CCMR2_IC4F_B_0x3 = 3;
    ...
    using LPTIM3_CCR3 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x38, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPTIM3_CCR3_CCR3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief LPTIM compare register 4 */
    using LPTIM3_CCR4 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x3C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPTIM3_CCR4_CCR4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
