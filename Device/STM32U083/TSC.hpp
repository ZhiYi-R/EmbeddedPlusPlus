...
#ifndef EMBEDDED_PP_STM32U083_TSC_HPP
#define EMBEDDED_PP_STM32U083_TSC_HPP
...
namespace STM32U083::TSC {
    ...
    /** @details Possible values:
     *          - B_0x0: f<sub>HCLK</sub> (value: 0)
     *          - B_0x1: f<sub>HCLK</sub> /2 (value: 1)
     *          - B_0x2: f<sub>HCLK</sub> /4 (value: 2)
     *          - B_0x3: f<sub>HCLK</sub> /8 (value: 3)
     *          - B_0x4: f<sub>HCLK</sub> /16 (value: 4)
     *          - B_0x5: f<sub>HCLK</sub> /32 (value: 5)
     *          - B_0x6: f<sub>HCLK</sub> /64 (value: 6)
     *          - B_0x7: f<sub>HCLK</sub> /128 (value: 7)
     */
        /** @brief f<sub>HCLK</sub> */
    constexpr std::uint32_t TSC_CR_PGPSC_B_0x0 = 0;
        /** @brief f<sub>HCLK</sub> /2 */
    constexpr std::uint32_t TSC_CR_PGPSC_B_0x1 = 1;
        /** @brief f<sub>HCLK</sub> /4 */
    constexpr std::uint32_t TSC_CR_PGPSC_B_0x2 = 2;
        /** @brief f<sub>HCLK</sub> /8 */
    constexpr std::uint32_t TSC_CR_PGPSC_B_0x3 = 3;
        /** @brief f<sub>HCLK</sub> /16 */
    constexpr std::uint32_t TSC_CR_PGPSC_B_0x4 = 4;
        /** @brief f<sub>HCLK</sub> /32 */
    constexpr std::uint32_t TSC_CR_PGPSC_B_0x5 = 5;
        /** @brief f<sub>HCLK</sub> /64 */
    constexpr std::uint32_t TSC_CR_PGPSC_B_0x6 = 6;
        /** @brief f<sub>HCLK</sub> /128 */
    ...
    /** @details Possible values:
     *          - B_0x0: 1x t<sub>SSCLK</sub> (value: 0)
     *          - B_0x1: 2x t<sub>SSCLK</sub> (value: 1)
     *          - B_0x7F: 128x t<sub>SSCLK</sub> (value: 127)
     */
        /** @brief 1x t<sub>SSCLK</sub> */
    constexpr std::uint32_t TSC_CR_SSD_B_0x0 = 0;
        /** @brief 2x t<sub>SSCLK</sub> */
    constexpr std::uint32_t TSC_CR_SSD_B_0x1 = 1;
        /** @brief 128x t<sub>SSCLK</sub> */
    constexpr std::uint32_t TSC_CR_SSD_B_0x7F = 127;

    /** @brief Charge transfer pulse low These bits are set and cleared by software. They define the duration of the low state of the charge transfer pulse (transfer of charge from C<sub>X</sub> to C<sub>S</sub>). ... Note: These bits must not be modified when an acquisition is ongoing. Note: Some configurations are forbidden. Refer to the Section119.4.4: Charge transfer acquisition sequence for details. */
    using TSC_CR_CTPL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: 1x t<sub>PGCLK</sub> (value: 0)
     *          - B_0x1: 2x t<sub>PGCLK</sub> (value: 1)
     *          - B_0xF: 16x t<sub>PGCLK</sub> (value: 15)
     */
        /** @brief 1x t<sub>PGCLK</sub> */
    constexpr std::uint32_t TSC_CR_CTPL_B_0x0 = 0;
        /** @brief 2x t<sub>PGCLK</sub> */
    constexpr std::uint32_t TSC_CR_CTPL_B_0x1 = 1;
        /** @brief 16x t<sub>PGCLK</sub> */
    constexpr std::uint32_t TSC_CR_CTPL_B_0xF = 15;

    /** @brief Charge transfer pulse high These bits are set and cleared by software. They define the duration of the high state of the charge transfer pulse (charge of C<sub>X</sub>). ... Note: These bits must not be modified when an acquisition is ongoing. */
    ...
    /** @brief Gx_IOy Schmitt trigger hysteresis mode These bits are set and cleared by software to enable/disable the Gx_IOy Schmitt trigger hysteresis. Note: These bits control the I/O Schmitt trigger hysteresis whatever the I/O control mode is (even if controlled by standard GPIO registers). */
    ...
    /** @brief Counter value These bits represent the number of charge transfer cycles generated on the analog I/O group x to complete its acquisition (voltage across C<sub>S</sub> has reached the threshold). */
