...
#ifndef EMBEDDED_PP_STM32U3B5_SEC_ADC1_HPP
#define EMBEDDED_PP_STM32U3B5_SEC_ADC1_HPP
...
namespace STM32U3B5::SEC_ADC1 {
    ...
    /** @brief ADC internal voltage regulator output ready flag */
    using ADC_ISR_LDORDY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: ADC LDO internal voltage regulator disabled (value: 0)
     *          - B_0x1: ADC LDO internal voltage regulator enabled (value: 1)
     */
        /** @brief ADC LDO internal voltage regulator disabled */
    constexpr std::uint32_t ADC_ISR_LDORDY_B_0x0 = 0;
        /** @brief ADC LDO internal voltage regulator enabled */
    ...
    /** @brief ADC internal voltage regulator interrupt enable */
    using ADC_IER_LDORDYIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Internal voltage regulator interrupt disabled (value: 0)
     *          - B_0x1: Internal voltage regulator interrupt enabled (value: 1)
     */
        /** @brief Internal voltage regulator interrupt disabled */
    constexpr std::uint32_t ADC_IER_LDORDYIE_B_0x0 = 0;
        /** @brief Internal voltage regulator interrupt enabled */
     ...
     *          - B_0x1: Write 1 to stop ongoing regular conversions. (value: 1)
     */
        /** @brief No ADC stop regular conversion command ongoing */
    constexpr std::uint32_t ADC_CR_ADSTP_B_0x0 = 0;
        /** @brief Write 1 to stop ongoing regular conversions. */
    ...
    /** @brief ADC internal voltage regulator enable */
    using ADC_CR_ADVREGEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: ADC internal voltage regulator disabled (value: 0)
     *          - B_0x1: ADC internal voltage regulator enabled. (value: 1)
     */
        /** @brief ADC internal voltage regulator disabled */
    constexpr std::uint32_t ADC_CR_ADVREGEN_B_0x0 = 0;
        /** @brief ADC internal voltage regulator enabled. */
    ...
    /** @details Possible values:
     *          - B_0x0: Single-ended input calibration mode when ADCAL=1 (value: 0)
     *          - B_0x1: Differential input calibration mode when ADCAL=1 (value: 1)
     */
        /** @brief Single-ended input calibration mode when ADCAL=1 */
    constexpr std::uint32_t ADC_CR_ADCALDIF_B_0x0 = 0;
        /** @brief Differential input calibration mode when ADCAL=1 */
    ...
    /** @details Possible values:
     *          - B_0x0: JSQR mode 0: The Queue is never empty and maintains the last written configuration to JSQR. (value: 0)
     ...
     */
        /** @brief JSQR mode 0: The Queue is never empty and maintains the last written configuration to JSQR. */
    ...
    using ADC_CFGR2_OVSR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 10, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    /** @brief Channel i (Vless thansub>INPless than/sub>[i]) preselection */
    using ADC_PCSEL_PCSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 19, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input channel i (Vless thansub>INPless than/sub>[i]) is not preselected for conversion, the result of the ADC conversion for this channel is wrong (value: 0)
     *          - B_0x1: Input channel i (Vless thansub>INPless than/sub>[i]) is preselected for conversion (value: 1)
     */
        /** @brief Input channel i (Vless thansub>INPless than/sub>[i]) is not preselected for conversion, the result of the ADC conversion for this channel is wrong */
    constexpr std::uint32_t ADC_PCSEL_PCSEL_B_0x0 = 0;
        /** @brief Input channel i (Vless thansub>INPless than/sub>[i]) is preselected for conversion */
    ...
    /** @brief Data offset y for the channel programmed in OFFSETy_CH[4:0] bits */
    ...
    using ADC_AWD2CR_AWDCH = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 19, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using ADC_AWD3CR_AWDCH = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 19, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Differential mode for channels 18 to 0. */
    ...
    /** @details Possible values:
     *          - B_0x0: Vless thansub>COREless than/sub> disabled (value: 0)
     *          - B_0x1: Vless thansub>COREless than/sub> enabled (value: 1)
     */
        /** @brief Vless thansub>COREless than/sub> disabled */
    constexpr std::uint32_t ADC_OR_OP0_B_0x0 = 0;
        /** @brief Vless thansub>COREless than/sub> enabled */
