...
#ifndef EMBEDDED_PP_STM32U3B5_SEC_FDCAN2_HPP
#define EMBEDDED_PP_STM32U3B5_SEC_FDCAN2_HPP
...
namespace STM32U3B5::SEC_FDCAN2 {
     ...
     *          - B_0x1: The CPU has write access to the protected configuration registers (while INIT set in FDCAN_CCCR). (value: 1)
     */
        /** @brief The CPU has no write access to the protected configuration registers. */
    constexpr std::uint32_t FDCAN_CCCR_CCE_B_0x0 = 0;
        /** @brief The CPU has write access to the protected configuration registers (while INIT set in FDCAN_CCCR). */
     ...
     *          - B_0x1: FDCAN can be set in power-down by stopping APB clock and kernel clock. (value: 1)
     */
        /** @brief No clock stop acknowledged */
    constexpr std::uint32_t FDCAN_CCCR_CSA_B_0x0 = 0;
        /** @brief FDCAN can be set in power-down by stopping APB clock and kernel clock. */
    ...
    /** @details Possible values:
     *          - B_0x0: Normal operation, FDCAN_TEST holds reset values (value: 0)
     *          - B_0x1: Test mode, write access to FDCAN_TEST enabled (value: 1)
     */
        /** @brief Normal operation, FDCAN_TEST holds reset values */
    constexpr std::uint32_t FDCAN_CCCR_TEST_B_0x0 = 0;
        /** @brief Test mode, write access to FDCAN_TEST enabled */
     ...
     *          - B_0x1: Two consecutive dominant tless thansub>qless than/sub> required to detect an edge for hard synchronization (value: 1)
     */
        /** @brief Edge filtering disabled */
    constexpr std::uint32_t FDCAN_CCCR_EFBI_B_0x0 = 0;
        /** @brief Two consecutive dominant tless thansub>qless than/sub> required to detect an edge for hard synchronization */
     ...
     *          - B_0x1: CAN FD frame format according to Bosch CAN FD Specification V1. (value: 1)
     */
        /** @brief CAN FD frame format according to ISO11898-1 */
    constexpr std::uint32_t FDCAN_CCCR_NISO_B_0x0 = 0;
        /** @brief CAN FD frame format according to Bosch CAN FD Specification V1. */
    ...
    /** @details Possible values:
     *          - B_0x0: No error occurred since LEC[2:0] has been cleared by successful reception or transmission. (value: 0)
     *          - B_0x1: Stuff error. (value: 1)
     *          - B_0x2: Form error. (value: 2)
     *          - B_0x3: Ack error. (value: 3)
     *          - B_0x4: Bit1 error. (value: 4)
     *          - B_0x5: Bit0 error. (value: 5)
     *          - B_0x6: CRC error. (value: 6)
     *          - B_0x7: No change. (value: 7)
     */
        /** @brief No error occurred since LEC[2:0] has been cleared by successful reception or transmission. */
    ...
    /** @details Possible values:
     *          - B_0x0: The FDCAN is in the error-active state. (value: 0)
     *          - B_0x1: The FDCAN is in the error-passive state. (value: 1)
     */
        /** @brief The FDCAN is in the error-active state. */
    constexpr std::uint32_t FDCAN_PSR_EP_B_0x0 = 0;
        /** @brief The FDCAN is in the error-passive state. */
    ...
    /** @details Possible values:
     *          - B_0x0: Both error counters are below the error-warning limit of 96. (value: 0)
     *          - B_0x1: At least one of error counter has reached the error-warning limit of 96. (value: 1)
     */
        /** @brief Both error counters are below the error-warning limit of 96. */
    constexpr std::uint32_t FDCAN_PSR_EW_B_0x0 = 0;
        /** @brief At least one of error counter has reached the error-warning limit of 96. */
    ...
    /** @details Possible values:
     *          - B_0x0: The FDCAN is not in bus-off state. (value: 0)
     *          - B_0x1: The FDCAN is in bus-off state. (value: 1)
     */
        /** @brief The FDCAN is not in bus-off state. */
    constexpr std::uint32_t FDCAN_PSR_BO_B_0x0 = 0;
        /** @brief The FDCAN is in bus-off state. */
    ...
    /** @details Possible values:
     *          - B_0x0: Since this bit was cleared by the CPU, no FDCAN message has been received. (value: 0)
     *          - B_0x1: Message in FDCAN format with EDL flag set has been received. (value: 1)
     */
        /** @brief Since this bit was cleared by the CPU, no FDCAN message has been received. */
    ...
    /** @details Possible values:
     *          - B_0x0: Error-passive status unchanged (value: 0)
     *          - B_0x1: Error-passive status changed (value: 1)
     */
        /** @brief Error-passive status unchanged */
    constexpr std::uint32_t FDCAN_IR_EP_B_0x0 = 0;
        /** @brief Error-passive status changed */
    ...
    /** @details Possible values:
     *          - B_0x0: Error-warning status unchanged (value: 0)
     *          - B_0x1: Error-warning status changed (value: 1)
     */
        /** @brief Error-warning status unchanged */
    constexpr std::uint32_t FDCAN_IR_EW_B_0x0 = 0;
        /** @brief Error-warning status changed */
    ...
    /** @details Possible values:
     *          - B_0x0: Bus-off status unchanged (value: 0)
     *          - B_0x1: Bus-off status changed (value: 1)
     */
        /** @brief Bus-off status unchanged */
    constexpr std::uint32_t FDCAN_IR_BO_B_0x0 = 0;
        /** @brief Bus-off status changed */
     ...
     *          - B_0x1: Protocol error in arbitration phase detected (LEC[2:0] different from 0 and 7 in FDCAN_PSR) (value: 1)
     */
        /** @brief No protocol error in arbitration phase */
    constexpr std::uint32_t FDCAN_IR_PEA_B_0x0 = 0;
        /** @brief Protocol error in arbitration phase detected (LEC[2:0] different from 0 and 7 in FDCAN_PSR) */
     ...
     *          - B_0x1: Protocol error in data phase detected (DLEC[2:0] different from 0 and 7 in FDCAN_PSR) (value: 1)
     */
        /** @brief No protocol error in data phase */
    constexpr std::uint32_t FDCAN_IR_PED_B_0x0 = 0;
        /** @brief Protocol error in data phase detected (DLEC[2:0] different from 0 and 7 in FDCAN_PSR) */
    ...
    /** @brief Rx FIFO bit grouping the following interruption */
    ...
    /** @brief Number of extended filter elements in the list */
