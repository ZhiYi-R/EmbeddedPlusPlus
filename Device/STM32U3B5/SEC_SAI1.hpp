...
#ifndef EMBEDDED_PP_STM32U3B5_SEC_SAI1_HPP
#define EMBEDDED_PP_STM32U3B5_SEC_SAI1_HPP
...
/** @brief SAI register block */
namespace STM32U3B5::SEC_SAI1 {
     ...
     *          - B_0x1: Clock configuration does not respect the rule concerning the frame length specification defined in Section50. (value: 1)
     */
        /** @brief Clock configuration is correct */
    constexpr std::uint32_t SAI_ASR_WCKCFG_B_0x0 = 0;
        /** @brief Clock configuration does not respect the rule concerning the frame length specification defined in Section50. */
     ...
     *          - B_0x2: 1/4 less than FIFO less than or equal 1/2 (transmitter mode), 1/4 less than or equal FIFO less than 1/2 (receiver mode) (value: 2)
     *          - B_0x3: 1/2 less than FIFO less than or equal 3/4 (transmitter mode), 1/2 less than or equal FIFO less than 3/4 (receiver mode) (value: 3)
    ...
    constexpr std::uint32_t SAI_ASR_FLVL_B_0x1 = 1;
        /** @brief 1/4 less than FIFO less than or equal 1/2 (transmitter mode), 1/4 less than or equal FIFO less than 1/2 (receiver mode) */
    constexpr std::uint32_t SAI_ASR_FLVL_B_0x2 = 2;
        /** @brief 1/2 less than FIFO less than or equal 3/4 (transmitter mode), 1/2 less than or equal FIFO less than 3/4 (receiver mode) */
    ...
    /** @details Possible values:
     *          - B_0x0: SAI_CK3 clock disabled (value: 0)
     *          - B_0x1: SAI_CK3 clock enabled (value: 1)
     */
        /** @brief SAI_CK3 clock disabled */
    constexpr std::uint32_t SAI_PDMCR_CKEN3_B_0x0 = 0;
        /** @brief SAI_CK3 clock enabled */
    constexpr std::uint32_t SAI_PDMCR_CKEN3_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: SAI_CK4 clock disabled (value: 0)
     *          - B_0x1: SAI_CK4 clock enabled (value: 1)
     */
        /** @brief SAI_CK4 clock disabled */
    constexpr std::uint32_t SAI_PDMCR_CKEN4_B_0x0 = 0;
        /** @brief SAI_CK4 clock enabled */
    constexpr std::uint32_t SAI_PDMCR_CKEN4_B_0x1 = 1;
