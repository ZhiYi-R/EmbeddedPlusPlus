...
#ifndef EMBEDDED_PP_STM32U3B5_SEC_SPI4_HPP
#define EMBEDDED_PP_STM32U3B5_SEC_SPI4_HPP
...
namespace STM32U3B5::SEC_SPI4 {
     ...
     *          - B_0x2: 2 frames are availablex (value: 2)
     *          - B_0x3: 3 frames are availablex (value: 3)
     */
    ...
    constexpr std::uint32_t SPI_SR_RxPLVL_B_0x1 = 1;
        /** @brief 2 frames are availablex */
    constexpr std::uint32_t SPI_SR_RxPLVL_B_0x2 = 2;
        /** @brief 3 frames are availablex */
