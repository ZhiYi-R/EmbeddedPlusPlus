...
#ifndef EMBEDDED_PP_STM32U3B5_SEC_TIM1_HPP
#define EMBEDDED_PP_STM32U3B5_SEC_TIM1_HPP
...
namespace STM32U3B5::SEC_TIM1 {
    ...
    using TIM1_CR2_ADSYNC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    /** @brief TIM1 autoreload register */
