...
#ifndef EMBEDDED_PP_STM32U3B5_SEC_TIM3_HPP
#define EMBEDDED_PP_STM32U3B5_SEC_TIM3_HPP
...
namespace STM32U3B5::SEC_TIM3 {
    ...
    using TIM3_CR2_ADSYNC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM3_CCMR2_ALTERNATE1_OC3M_B_0x0 = 0;
        /** @brief Set channel 3 to active level on match. */
    constexpr std::uint32_t TIM3_CCMR2_ALTERNATE1_OC3M_B_0x1 = 1;
        /** @brief Set channel 3 to inactive level on match. */
    constexpr std::uint32_t TIM3_CCMR2_ALTERNATE1_OC3M_B_0x2 = 2;
        /** @brief Toggle-tim_oc3ref toggles when TIMx_CNT = TIMx_CCR3. */
    constexpr std::uint32_t TIM3_CCMR2_ALTERNATE1_OC3M_B_0x3 = 3;
        /** @brief Force inactive level-tim_oc3ref is forced low. */
    constexpr std::uint32_t TIM3_CCMR2_ALTERNATE1_OC3M_B_0x4 = 4;
        /** @brief Force active level-tim_oc3ref is forced high. */
    constexpr std::uint32_t TIM3_CCMR2_ALTERNATE1_OC3M_B_0x5 = 5;
        /** @brief PWM mode 1-In up-counting, channel 3 is active as long as TIMx_CNTless thanTIMx_CCR3 else inactive. */
    constexpr std::uint32_t TIM3_CCMR2_ALTERNATE1_OC3M_B_0x6 = 6;
        /** @brief PWM mode 2-In up-counting, channel 3 is inactive as long as TIMx_CNTless thanTIMx_CCR3 else active. */
    constexpr std::uint32_t TIM3_CCMR2_ALTERNATE1_OC3M_B_0x7 = 7;
    ...
    using TIM3_CNT_CNT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 31, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Value depends on IUFREMAP in TIMx_CR1. */
    using TIM3_CNT_UIFCPY_CNT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief TIM3 autoreload register */
