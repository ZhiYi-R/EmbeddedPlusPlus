...
#ifndef EMBEDDED_PP_STM32U3B5_SEC_TIM6_HPP
#define EMBEDDED_PP_STM32U3B5_SEC_TIM6_HPP
...
namespace STM32U3B5::SEC_TIM6 {
    ...
    using TIM6_CR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Master mode selection */
    using TIM6_CR2_MMS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM6_CR2_MMS_B_0x0 = 0;
        /** @brief Enable-the Counter enable signal, tim_cnt_en, is used as a trigger output (tim_trgo). */
    constexpr std::uint32_t TIM6_CR2_MMS_B_0x1 = 1;
        /** @brief Update-The update event is selected as a trigger output (tim_trgo). */
    constexpr std::uint32_t TIM6_CR2_MMS_B_0x2 = 2;

    /** @brief ADC synchronization */
    using TIM6_CR2_ADSYNC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    /** @brief TIM6 autoreload register */
