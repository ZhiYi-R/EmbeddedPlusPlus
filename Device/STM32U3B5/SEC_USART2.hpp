...
#ifndef EMBEDDED_PP_STM32U3B5_SEC_USART2_HPP
#define EMBEDDED_PP_STM32U3B5_SEC_USART2_HPP
...
/** @brief USART1 address block description */
namespace STM32U3B5::SEC_USART2 {
    ...
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated when TxFIFO reaches the threshold programmed in TxFTCFG[2:0]. (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t USART_CR3_TxFTIE_B_0x0 = 0;
        /** @brief USART interrupt generated when TxFIFO reaches the threshold programmed in TxFTCFG[2:0]. */
    ...
    /** @details Possible values:
     *          - B_0x0: Interrupt inhibited (value: 0)
     *          - B_0x1: USART interrupt generated when Receive FIFO reaches the threshold programmed in RxFTCFG[2:0]. (value: 1)
     */
        /** @brief Interrupt inhibited */
    constexpr std::uint32_t USART_CR3_RxFTIE_B_0x0 = 0;
        /** @brief USART interrupt generated when Receive FIFO reaches the threshold programmed in RxFTCFG[2:0]. */
    ...
    /** @details Possible values:
     *          - B_0x0: Transmission has not completed, or transmission has completed unsuccessfully (that is, a NACK is received from the card) (value: 0)
     *          - B_0x1: Transmission has completed successfully (before Guard time completion and there is no NACK from the smart card). (value: 1)
     */
        /** @brief Transmission has not completed, or transmission has completed unsuccessfully (that is, a NACK is received from the card) */
    constexpr std::uint32_t USART_ISR_TCBGT_B_0x0 = 0;
        /** @brief Transmission has completed successfully (before Guard time completion and there is no NACK from the smart card). */
    ...
    /** @details Possible values:
     *          - B_0x0: Transmission has not completed or transmission has completed unsuccessfully (that is, a NACK is received from the card) (value: 0)
     *          - B_0x1: Transmission has not completed successfully (before Guard time completion and there is no NACK from the smart card). (value: 1)
     */
        /** @brief Transmission has not completed or transmission has completed unsuccessfully (that is, a NACK is received from the card) */
    constexpr std::uint32_t USART_ISR_ALTERNATE1_TCBGT_B_0x0 = 0;
        /** @brief Transmission has not completed successfully (before Guard time completion and there is no NACK from the smart card). */
    ...
    /** @brief TDN transmission data number */
