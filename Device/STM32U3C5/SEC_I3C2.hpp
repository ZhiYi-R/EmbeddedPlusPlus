...
#ifndef EMBEDDED_PP_STM32U3C5_SEC_I3C2_HPP
#define EMBEDDED_PP_STM32U3C5_SEC_I3C2_HPP
...
namespace STM32U3C5::SEC_I3C2 {
     ...
     *          - B_0x2_WHEN_I3C_ACTS_AS_I3C_CONTROLLER: private message (refer to Figure585) (value: 2)
     *          - B_0x3_WHEN_I3C_ACTS_AS_I3C_CONTROLLER: direct message (second part of an I3C SDR direct CCC command) (refer to Figure578) (value: 3)
     *          - B_0x4_WHEN_I3C_ACTS_AS_I3C_CONTROLLER: legacy Iless thansup>2less than/sup>C message (refer to Figure587) (value: 4)
     *          - B_0x8_WHEN_I3C_ACTS_AS_I3C_TARGET: hot-join request (W) (refer to Figure589) (value: 8)
     *          - B_0x9_WHEN_I3C_ACTS_AS_I3C_TARGET: controller-role request (W) (refer to Figure590) (value: 9)
     *          - B_0xA_WHEN_I3C_ACTS_AS_I3C_TARGET: IBI (in-band interrupt) request (R) (refer to Figure588) (value: 10)
     */
    ...
    /** @details Possible values:
     *          - B_0x6_WHEN_I3C_ACTS_AS_I3C_CONTROLLER: broadcast/direct CCC command (refer to Table483, Figure578, Figure579, Figure580) (value: 6)
     */
        /** @brief broadcast/direct CCC command (refer to Table483, Figure578, Figure579, Figure580) */
    ...
    /** @brief FCF generation disable (when I3C acts as controller) */
    using I3C_CFGR_FCFDIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: enable the generation of the flag FCF in the I3C_EVR register (value: 0)
     *          - B_0x1: disable the generation of the flag FCF in the I3C_EVR register (value: 1)
     */
        /** @brief enable the generation of the flag FCF in the I3C_EVR register */
    constexpr std::uint32_t I3C_CFGR_FCFDIS_B_0x0 = 0;
        /** @brief disable the generation of the flag FCF in the I3C_EVR register */
    constexpr std::uint32_t I3C_CFGR_FCFDIS_B_0x1 = 1;

    /** @brief Hardware trigger signal selection (when IP acts as controller) */
    using I3C_CFGR_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Hardware trigger signal polarity (when IP acts as controller) */
    using I3C_CFGR_TRIGPOL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: rising edge (value: 0)
     *          - B_0x1: falling edge (value: 1)
     */
        /** @brief rising edge */
    constexpr std::uint32_t I3C_CFGR_TRIGPOL_B_0x0 = 0;
        /** @brief falling edge */
    constexpr std::uint32_t I3C_CFGR_TRIGPOL_B_0x1 = 1;

    /** @brief Hardware trigger enable (when IP acts as controller) */
    using I3C_CFGR_TRIGHWEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: hardware trigger mode is disabled (value: 0)
     *          - B_0x1: hardware trigger mode is enabled (value: 1)
     */
        /** @brief hardware trigger mode is disabled */
    constexpr std::uint32_t I3C_CFGR_TRIGHWEN_B_0x0 = 0;
        /** @brief hardware trigger mode is enabled */
    constexpr std::uint32_t I3C_CFGR_TRIGHWEN_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: no detected error (value: 0)
     *          - B_0x1: target detected that SCL was stable for more than 125 us during an I3C SDR data read (during a direct CCC read, a private read, or an IB) (value: 1)
     */
        /** @brief no detected error */
    constexpr std::uint32_t I3C_SER_STALL_B_0x0 = 0;
        /** @brief target detected that SCL was stable for more than 125 us during an I3C SDR data read (during a direct CCC read, a private read, or an IB) */
    ...
    /** @brief I3C masked interrupt status register */
    using I3C_MISR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x5C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief C-FIFO not full masked interrupt status (when the I3C acts as controller) */
    using I3C_MISR_CFNFMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief S-FIFO not empty masked interrupt status (when the I3C acts as controller) */
    using I3C_MISR_SFNEMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Tx-FIFO not full masked interrupt status (whatever the I3C acts as controller/target) */
    using I3C_MISR_TxFNFMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Rx-FIFO not empty masked interrupt status (whatever the I3C acts as controller/target) */
    using I3C_MISR_RxFNEMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief frame complete masked interrupt status (whatever the I3C acts as controller/target) */
    using I3C_MISR_FCMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief target-initiated read end masked interrupt status (when the I3C acts as controller) */
    using I3C_MISR_RxTGTENDMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief error masked interrupt status (whatever the I3C acts as controller/target) */
    using I3C_MISR_ERRMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief IBI request masked interrupt status (when the I3C acts as controller) */
    using I3C_MISR_IBIMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief IBI end masked interrupt status (when the I3C acts as target) */
    using I3C_MISR_IBIENDMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Controller-role request masked interrupt status (when the I3C acts as controller) */
    using I3C_MISR_CRMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Controller-role update masked interrupt status (when the I3C acts as target) */
    using I3C_MISR_CRUPDMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Hot-join masked interrupt status (when the I3C acts as controller) */
    using I3C_MISR_HJMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Wake-up/missed start masked interrupt status (when the I3C acts as target) */
    using I3C_MISR_WKPMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief GETxxx CCC masked interrupt status, except GETSTATUS of format 1 (when the I3C acts as target) */
    using I3C_MISR_GETMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief format 1 GETSTATUS CCC masked interrupt status (when the I3C acts as target) */
    using I3C_MISR_STAMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ENTDAA/RSTDAA/SETNEWDA CCC masked interrupt status (when the I3C acts as target) */
    using I3C_MISR_DAUPDMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SETMWL CCC masked interrupt status (when the I3C acts as target) */
    using I3C_MISR_MWLUPDMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SETMRL CCC masked interrupt status (when the I3C acts as target) */
    using I3C_MISR_MRLUPDMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief reset pattern masked interrupt status (when the I3C acts as target) */
    using I3C_MISR_RSTMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ENTASx CCC masked interrupt status (when the I3C acts as target) */
    using I3C_MISR_ASUPDMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ENEC/DISEC CCC masked interrupt status (when the I3C acts as target) */
    using I3C_MISR_INTUPDMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DEFTGTS CCC masked interrupt status (when the I3C acts as target) */
    using I3C_MISR_DEFMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DEFGRPA CCC masked interrupt status (when the I3C acts as target) */
    using I3C_MISR_GRPMIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Disables writes to DA[6:0] (when the I3C acts as controller) */
    ...
    /** @brief Number of kernel clock cycles to set a time unit of 1 us, whatever I3C acts as controller or target. */
    ...
    using I3C_TIMINGR1_SDA_HD = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Controller clock stall enable on T-bit phase of data */
    ...
    /** @brief Controller clock stall enable in the data ACK/NACK phase of a legacy I2C read message. */
    using I3C_TIMINGR2_STALLR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no stall (value: 0)
     *          - B_0x1: stall enabled (value: 1)
     */
        /** @brief no stall */
    constexpr std::uint32_t I3C_TIMINGR2_STALLR_B_0x0 = 0;
        /** @brief stall enabled */
    constexpr std::uint32_t I3C_TIMINGR2_STALLR_B_0x1 = 1;

    /** @brief Controller clock stall enable in the data ACK/NACK phase of a legacy I2C write message. */
    using I3C_TIMINGR2_STALLS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no stall (value: 0)
     *          - B_0x1: stall enabled (value: 1)
     */
        /** @brief no stall */
    constexpr std::uint32_t I3C_TIMINGR2_STALLS_B_0x0 = 0;
        /** @brief stall enabled */
    constexpr std::uint32_t I3C_TIMINGR2_STALLS_B_0x1 = 1;

    /** @brief Controller clock stall enable in the address ACK/NACK phase (before the ninth bit) of a legacy I2C read/write message. */
    using I3C_TIMINGR2_STALLL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no stall (value: 0)
     *          - B_0x1: stall enabled (value: 1)
     */
        /** @brief no stall */
    constexpr std::uint32_t I3C_TIMINGR2_STALLL_B_0x0 = 0;
        /** @brief stall enabled */
    constexpr std::uint32_t I3C_TIMINGR2_STALLL_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: tless thansub>SCOless than/sub> less than or equal 12 ns (value: 0)
     *          - B_0x1: tless thansub>SCOless than/sub> > 12 ns (refer to the datasheet for more details) (value: 1)
     */
        /** @brief tless thansub>SCOless than/sub> less than or equal 12 ns */
