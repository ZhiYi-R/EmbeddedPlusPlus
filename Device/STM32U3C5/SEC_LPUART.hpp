...
#ifndef EMBEDDED_PP_STM32U3C5_SEC_LPUART_HPP
#define EMBEDDED_PP_STM32U3C5_SEC_LPUART_HPP
...
namespace STM32U3C5::SEC_LPUART {
    ...
    /** @details Possible values:
     *          - B_0x0: Interrupt is inhibited (value: 0)
     *          - B_0x1: A LPUART interrupt is generated when TxFIFO reaches the threshold programmed in TxFTCFG[2:0]. (value: 1)
     */
        /** @brief Interrupt is inhibited */
    constexpr std::uint32_t LPUART_CR3_TxFTIE_B_0x0 = 0;
        /** @brief A LPUART interrupt is generated when TxFIFO reaches the threshold programmed in TxFTCFG[2:0]. */
    ...
    /** @details Possible values:
     *          - B_0x0: Interrupt is inhibited (value: 0)
     *          - B_0x1: An LPUART interrupt is generated when Receive FIFO reaches the threshold programmed in RxFTCFG[2:0]. (value: 1)
     */
        /** @brief Interrupt is inhibited */
    constexpr std::uint32_t LPUART_CR3_RxFTIE_B_0x0 = 0;
        /** @brief An LPUART interrupt is generated when Receive FIFO reaches the threshold programmed in RxFTCFG[2:0]. */
    ...
    /** @brief LPUART control register 3 */
    using LPUART_CR3_ALTERNATE1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Error interrupt enable */
    using LPUART_CR3_ALTERNATE1_EIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt is inhibited (value: 0)
     *          - B_0x1: An interrupt is generated when FE=1 or ORE=1 or NE=1 in the LPUART_ISR register. (value: 1)
     */
        /** @brief Interrupt is inhibited */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_EIE_B_0x0 = 0;
        /** @brief An interrupt is generated when FE=1 or ORE=1 or NE=1 in the LPUART_ISR register. */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_EIE_B_0x1 = 1;

    /** @brief Half-duplex selection */
    using LPUART_CR3_ALTERNATE1_HDSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Half-duplex mode is not selected (value: 0)
     *          - B_0x1: Half-duplex mode is selected (value: 1)
     */
        /** @brief Half-duplex mode is not selected */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_HDSEL_B_0x0 = 0;
        /** @brief Half-duplex mode is selected */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_HDSEL_B_0x1 = 1;

    /** @brief DMA enable receiver */
    using LPUART_CR3_ALTERNATE1_DMAR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x1: DMA mode is enabled for reception (value: 1)
     *          - B_0x0: DMA mode is disabled for reception (value: 0)
     */
        /** @brief DMA mode is enabled for reception */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_DMAR_B_0x1 = 1;
        /** @brief DMA mode is disabled for reception */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_DMAR_B_0x0 = 0;

    /** @brief DMA enable transmitter */
    using LPUART_CR3_ALTERNATE1_DMAT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x1: DMA mode is enabled for transmission (value: 1)
     *          - B_0x0: DMA mode is disabled for transmission (value: 0)
     */
        /** @brief DMA mode is enabled for transmission */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_DMAT_B_0x1 = 1;
        /** @brief DMA mode is disabled for transmission */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_DMAT_B_0x0 = 0;

    /** @brief RTS enable */
    using LPUART_CR3_ALTERNATE1_RTSE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: RTS hardware flow control disabled (value: 0)
     *          - B_0x1: RTS output enabled, data is only requested when there is space in the receive buffer. (value: 1)
     */
        /** @brief RTS hardware flow control disabled */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_RTSE_B_0x0 = 0;
        /** @brief RTS output enabled, data is only requested when there is space in the receive buffer. */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_RTSE_B_0x1 = 1;

    /** @brief CTS enable */
    using LPUART_CR3_ALTERNATE1_CTSE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CTS hardware flow control disabled (value: 0)
     *          - B_0x1: CTS mode enabled, data is only transmitted when the CTS input is deasserted (tied to 0). (value: 1)
     */
        /** @brief CTS hardware flow control disabled */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_CTSE_B_0x0 = 0;
        /** @brief CTS mode enabled, data is only transmitted when the CTS input is deasserted (tied to 0). */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_CTSE_B_0x1 = 1;

    /** @brief CTS interrupt enable */
    using LPUART_CR3_ALTERNATE1_CTSIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt is inhibited (value: 0)
     *          - B_0x1: An interrupt is generated whenever CTSIF=1 in the LPUART_ISR register (value: 1)
     */
        /** @brief Interrupt is inhibited */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_CTSIE_B_0x0 = 0;
        /** @brief An interrupt is generated whenever CTSIF=1 in the LPUART_ISR register */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_CTSIE_B_0x1 = 1;

    /** @brief Overrun Disable */
    using LPUART_CR3_ALTERNATE1_OVRDIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Overrun Error Flag, ORE is set when received data is not read before receiving new data. (value: 0)
     *          - B_0x1: Overrun functionality is disabled. (value: 1)
     */
        /** @brief Overrun Error Flag, ORE is set when received data is not read before receiving new data. */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_OVRDIS_B_0x0 = 0;
        /** @brief Overrun functionality is disabled. */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_OVRDIS_B_0x1 = 1;

    /** @brief DMA Disable on reception Error */
    using LPUART_CR3_ALTERNATE1_DDRE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: DMA is not disabled in case of reception error. (value: 0)
     *          - B_0x1: DMA is disabled following a reception error. (value: 1)
     */
        /** @brief DMA is not disabled in case of reception error. */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_DDRE_B_0x0 = 0;
        /** @brief DMA is disabled following a reception error. */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_DDRE_B_0x1 = 1;

    /** @brief Driver enable mode */
    using LPUART_CR3_ALTERNATE1_DEM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: DE function is disabled. (value: 0)
     *          - B_0x1: DE function is enabled. (value: 1)
     */
        /** @brief DE function is disabled. */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_DEM_B_0x0 = 0;
        /** @brief DE function is enabled. */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_DEM_B_0x1 = 1;

    /** @brief Driver enable polarity selection */
    using LPUART_CR3_ALTERNATE1_DEP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: DE signal is active high. (value: 0)
     *          - B_0x1: DE signal is active low. (value: 1)
     */
        /** @brief DE signal is active high. */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_DEP_B_0x0 = 0;
        /** @brief DE signal is active low. */
    constexpr std::uint32_t LPUART_CR3_ALTERNATE1_DEP_B_0x1 = 1;
