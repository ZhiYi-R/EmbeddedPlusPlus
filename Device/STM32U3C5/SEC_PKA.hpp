...
#ifndef EMBEDDED_PP_STM32U3C5_SEC_PKA_HPP
#define EMBEDDED_PP_STM32U3C5_SEC_PKA_HPP
...
namespace STM32U3C5::SEC_PKA {
    ...
    /** @brief Chaining mode flags interrupt enable */
    using PKA_CR_CMFIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No interrupt is generated when any flag in bits 8 to 15 is set in PKA_SR. (value: 0)
     *          - B_0x1: An interrupt is generated when any flag in bits 8 to 15 is set in PKA_SR. (value: 1)
     */
        /** @brief No interrupt is generated when any flag in bits 8 to 15 is set in PKA_SR. */
    constexpr std::uint32_t PKA_CR_CMFIE_B_0x0 = 0;
        /** @brief An interrupt is generated when any flag in bits 8 to 15 is set in PKA_SR. */
    constexpr std::uint32_t PKA_CR_CMFIE_B_0x1 = 1;
    ...
    /** @brief Coupling and chaining mode enable */
    using PKA_SR_CCEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Access to PKA RAM and programming of PKA_CR has no extra limitation. (value: 0)
     *          - B_0x1: PKA RAM is write-only until START is set (it is no access then), and the MODE value written in PKA_CR must correspond to the CCOP mode selected in the CCB peripheral. (value: 1)
     */
        /** @brief Access to PKA RAM and programming of PKA_CR has no extra limitation. */
    constexpr std::uint32_t PKA_SR_CCEN_B_0x0 = 0;
        /** @brief PKA RAM is write-only until START is set (it is no access then), and the MODE value written in PKA_CR must correspond to the CCOP mode selected in the CCB peripheral. */
    constexpr std::uint32_t PKA_SR_CCEN_B_0x1 = 1;

    /** @brief RNG OK flag */
    using PKA_SR_RNGOKF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Random number not OK (if applicable). (value: 0)
     *          - B_0x1: Sequential writes to PKA RAM successfully transfered the expected amount of random data from the RNG. (value: 1)
     */
        /** @brief Random number not OK (if applicable). */
    constexpr std::uint32_t PKA_SR_RNGOKF_B_0x0 = 0;
        /** @brief Sequential writes to PKA RAM successfully transfered the expected amount of random data from the RNG. */
    constexpr std::uint32_t PKA_SR_RNGOKF_B_0x1 = 1;

    /** @brief Data OK flag */
    using PKA_SR_DATAOKF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Data not OK (if applicable), otherwise no event. (value: 0)
     *          - B_0x1: Sequential writes to / read from PKA RAM successfully transfered the expected amount of data from / to the SAES. (value: 1)
     */
        /** @brief Data not OK (if applicable), otherwise no event. */
    constexpr std::uint32_t PKA_SR_DATAOKF_B_0x0 = 0;
        /** @brief Sequential writes to / read from PKA RAM successfully transfered the expected amount of data from / to the SAES. */
    constexpr std::uint32_t PKA_SR_DATAOKF_B_0x1 = 1;

    /** @brief Increment error flag */
    using PKA_SR_INCRERRF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No increment error (value: 0)
     *          - B_0x1: During the reading or writing of protected parameters in PKA RAM the application did not properly incremented the address. (value: 1)
     */
        /** @brief No increment error */
    constexpr std::uint32_t PKA_SR_INCRERRF_B_0x0 = 0;
        /** @brief During the reading or writing of protected parameters in PKA RAM the application did not properly incremented the address. */
    constexpr std::uint32_t PKA_SR_INCRERRF_B_0x1 = 1;

    /** @brief Data 0-ed error flag */
    using PKA_SR_DATAZF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Trailing 0s error flag */
    using PKA_SR_TRZERRF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No trailing 0s error (value: 0)
     *          - B_0x1: Clear-text coming from CPU, or decrypted data coming from SAES does not have the required trailing 0s. (value: 1)
     */
        /** @brief No trailing 0s error */
    constexpr std::uint32_t PKA_SR_TRZERRF_B_0x0 = 0;
        /** @brief Clear-text coming from CPU, or decrypted data coming from SAES does not have the required trailing 0s. */
    constexpr std::uint32_t PKA_SR_TRZERRF_B_0x1 = 1;

    /** @brief Mode error flag */
    using PKA_SR_MDERRF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No mode error (value: 0)
     *          - B_0x1: The value written in MODE of PKA_CR registers is different from the expected value corresponding to the CCOP mode selected in the CCB peripheral. (value: 1)
     */
        /** @brief No mode error */
    constexpr std::uint32_t PKA_SR_MDERRF_B_0x0 = 0;
        /** @brief The value written in MODE of PKA_CR registers is different from the expected value corresponding to the CCOP mode selected in the CCB peripheral. */
    constexpr std::uint32_t PKA_SR_MDERRF_B_0x1 = 1;

    /** @brief RNG error flag */
    using PKA_SR_RNGERRF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No random number drawn from RNG, or generated ECC private key is NIST compliant. (value: 0)
     *          - B_0x1: Random number drawn from RNG did not pass NIST key pair generation by testing candidates equivalent algorithm (see FIPS 186-4 annex B. (value: 1)
     */
        /** @brief No random number drawn from RNG, or generated ECC private key is NIST compliant. */
    constexpr std::uint32_t PKA_SR_RNGERRF_B_0x0 = 0;
        /** @brief Random number drawn from RNG did not pass NIST key pair generation by testing candidates equivalent algorithm (see FIPS 186-4 annex B. */
    constexpr std::uint32_t PKA_SR_RNGERRF_B_0x1 = 1;
    ...
    /** @brief Chaining mode flags */
    using PKA_SR_CMF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No chaining mode events. (value: 0)
     *          - B_0x1: Running chaining mode sequence triggered at least one flag status in bits 8 to 15 of this register. (value: 1)
     */
        /** @brief No chaining mode events. */
    constexpr std::uint32_t PKA_SR_CMF_B_0x0 = 0;
        /** @brief Running chaining mode sequence triggered at least one flag status in bits 8 to 15 of this register. */
    constexpr std::uint32_t PKA_SR_CMF_B_0x1 = 1;
    ...
    using PKA_CLRFR_CMFC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No action (value: 0)
     *          - B_0x1: Clear the CMF flag and the chaining mode status bits in 8 to 15 in PKA_SR (value: 1)
     */
        /** @brief No action */
    constexpr std::uint32_t PKA_CLRFR_CMFC_B_0x0 = 0;
        /** @brief Clear the CMF flag and the chaining mode status bits in 8 to 15 in PKA_SR */
    constexpr std::uint32_t PKA_CLRFR_CMFC_B_0x1 = 1;
