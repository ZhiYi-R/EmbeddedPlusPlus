...
#ifndef EMBEDDED_PP_STM32U3C5_SEC_SDMMC1_HPP
#define EMBEDDED_PP_STM32U3C5_SEC_SDMMC1_HPP
...
/** @brief SDMMC1 address block description */
namespace STM32U3C5::SEC_SDMMC1 {
     ...
     *          - B_0x3: Power-on: the card is clocked, The first 74 SDMMC_CK cycles the SDMMC is still disabled. (value: 3)
     */
    ...
    constexpr std::uint32_t SDMMC_POWER_PWRCTRL_B_0x2 = 2;
        /** @brief Power-on: the card is clocked, The first 74 SDMMC_CK cycles the SDMMC is still disabled. */
    ...
    /** @details Possible values:
     *          - B_0x0: Voltage transceiver I/Os driven as output when direction signal is low. (value: 0)
     *          - B_0x1: Voltage transceiver I/Os driven as output when direction signal is high. (value: 1)
     */
        /** @brief Voltage transceiver I/Os driven as output when direction signal is low. */
    constexpr std::uint32_t SDMMC_POWER_DIRPOL_B_0x0 = 0;
        /** @brief Voltage transceiver I/Os driven as output when direction signal is high. */
     ...
     *          - B_0x2: e MMC Stream data transfer. (value: 2)
    ...
    constexpr std::uint32_t SDMMC_DCTRL_DTMODE_B_0x1 = 1;
        /** @brief e MMC Stream data transfer. */
     ...
     *          - B_0x1: Flush any remaining data and reset the FIFO pointers. (value: 1)
     */
        /** @brief FIFO not affected. */
    constexpr std::uint32_t SDMMC_DCTRL_FIFORST_B_0x0 = 0;
        /** @brief Flush any remaining data and reset the FIFO pointers. */
     ...
     *          - B_0x1: Loaded linked list buffer ready acknowledge. (value: 1)
     */
    ...
    constexpr std::uint32_t SDMMC_IDMALAR_ABR_B_0x0 = 0;
        /** @brief Loaded linked list buffer ready acknowledge. */
    constexpr std::uint32_t SDMMC_IDMALAR_ABR_B_0x1 = 1;

    /** @brief Update SDMMC_IDMABSIZE from the next linked list when in linked list mode (SDMMC_IDMACTRLR. */
    ...
    /** @brief Update SDMMC_IDMALAR from linked list when in linked list mode (SDMMC_IDMACTRLR. */
