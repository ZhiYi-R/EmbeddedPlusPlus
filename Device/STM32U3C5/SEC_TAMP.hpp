...
#ifndef EMBEDDED_PP_STM32U3C5_SEC_TAMP_HPP
#define EMBEDDED_PP_STM32U3C5_SEC_TAMP_HPP
...
namespace STM32U3C5::SEC_TAMP {
    ...
    /** @brief Tamper detection on TAMP_INi enable */
    using TAMP_CR1_TAMP1E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Tamper detection on TAMP_INi disabled (value: 0)
     *          - B_0x1: Tamper detection on TAMP_INi enabled (value: 1)
     */
        /** @brief Tamper detection on TAMP_INi disabled */
    constexpr std::uint32_t TAMP_CR1_TAMP1E_B_0x0 = 0;
        /** @brief Tamper detection on TAMP_INi enabled */
    ...
    /** @brief Internal tamper i enable */
    using TAMP_CR1_ITAMP5E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Internal tamper i disabled (value: 0)
     *          - B_0x1: Internal tamper i enabled (value: 1)
     */
        /** @brief Internal tamper i disabled */
    constexpr std::uint32_t TAMP_CR1_ITAMP5E_B_0x0 = 0;
        /** @brief Internal tamper i enabled */
    ...
    /** @brief Tamper i potential mode */
    using TAMP_CR2_TAMP1POM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Tamper i event detection is in confirmed mode. (value: 0)
     *          - B_0x1: Tamper i event detection is in potential mode. (value: 1)
     */
        /** @brief Tamper i event detection is in confirmed mode. */
    constexpr std::uint32_t TAMP_CR2_TAMP1POM_B_0x0 = 0;
        /** @brief Tamper i event detection is in potential mode. */
    ...
    /** @details Possible values:
     *          - B_0x0: Tamper i event generates a trigger event and TAMPiF must be cleared by software to allow next tamper event detection. (value: 0)
     *          - B_0x1: Tamper i event generates a trigger event. (value: 1)
     */
        /** @brief Tamper i event generates a trigger event and TAMPiF must be cleared by software to allow next tamper event detection. */
    constexpr std::uint32_t TAMP_CR2_TAMP1MSK_B_0x0 = 0;
        /** @brief Tamper i event generates a trigger event. */
    ...
    /** @brief Software potential tamper */
    using TAMP_CR2_BKBLOCK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Backup registers and device secrets can be accessed if no tamper flag is set. (value: 0)
     *          - B_0x1: Backup registers and device secrets cannot be accessed. (value: 1)
     */
        /** @brief Backup registers and device secrets can be accessed if no tamper flag is set. */
    constexpr std::uint32_t TAMP_CR2_BKBLOCK_B_0x0 = 0;
        /** @brief Backup registers and device secrets cannot be accessed. */
    constexpr std::uint32_t TAMP_CR2_BKBLOCK_B_0x1 = 1;

    /** @brief Software confirmed tamper */
    using TAMP_CR2_BKERASE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Active level for tamper 5 input */
    using TAMP_CR2_TAMP1TRG = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: If TAMPFLT[1:0] different 00, the tamper i input staying low triggers a tamper detection event. (value: 0)
     *          - B_0x1: If TAMPFLT[1:0] different 00 the tamper i input staying high triggers a tamper detection event. (value: 1)
     */
        /** @brief If TAMPFLT[1:0] different 00, the tamper i input staying low triggers a tamper detection event. */
    constexpr std::uint32_t TAMP_CR2_TAMP1TRG_B_0x0 = 0;
        /** @brief If TAMPFLT[1:0] different 00 the tamper i input staying high triggers a tamper detection event. */
    ...
    /** @details Possible values:
     *          - B_0x0: Internal tamper 3 event detection is in confirmed mode. (value: 0)
     *          - B_0x1: Internal tamper 3 event detection is in potential mode. (value: 1)
     */
        /** @brief Internal tamper 3 event detection is in confirmed mode. */
    constexpr std::uint32_t TAMP_CR3_ITAMP3POM_B_0x0 = 0;
        /** @brief Internal tamper 3 event detection is in potential mode. */
    constexpr std::uint32_t TAMP_CR3_ITAMP3POM_B_0x1 = 1;

    /** @brief Internal tamper i potential mode */
    using TAMP_CR3_ITAMP5POM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Internal tamper i event detection is in confirmed mode. (value: 0)
     *          - B_0x1: Internal tamper i event detection is in potential mode. (value: 1)
     */
        /** @brief Internal tamper i event detection is in confirmed mode. */
    constexpr std::uint32_t TAMP_CR3_ITAMP5POM_B_0x0 = 0;
        /** @brief Internal tamper i event detection is in potential mode. */
    ...
    /** @brief Internal tamper i potential mode */
    using TAMP_CR3_ITAMP12POM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Internal tamper i event detection is in confirmed mode. (value: 0)
     *          - B_0x1: Internal tamper i event detection is in potential mode. (value: 1)
     */
        /** @brief Internal tamper i event detection is in confirmed mode. */
    constexpr std::uint32_t TAMP_CR3_ITAMP12POM_B_0x0 = 0;
        /** @brief Internal tamper i event detection is in potential mode. */
    constexpr std::uint32_t TAMP_CR3_ITAMP12POM_B_0x1 = 1;

    /** @brief Internal tamper i potential mode */
    using TAMP_CR3_ITAMP13POM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Internal tamper i event detection is in confirmed mode. (value: 0)
     *          - B_0x1: Internal tamper i event detection is in potential mode. (value: 1)
     */
        /** @brief Internal tamper i event detection is in confirmed mode. */
    constexpr std::uint32_t TAMP_CR3_ITAMP13POM_B_0x0 = 0;
        /** @brief Internal tamper i event detection is in potential mode. */
    constexpr std::uint32_t TAMP_CR3_ITAMP13POM_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: Tamper event is activated on edge of TAMP_INx input transitions to the active level (nointernal pull-up on TAMP_INx input). (value: 0)
     *          - B_0x1: Tamper event is activated after two consecutive samples at the active level. (value: 1)
     *          - B_0x2: Tamper event is activated after four consecutive samples at the active level. (value: 2)
     *          - B_0x3: Tamper event is activated after eight consecutive samples at the active level. (value: 3)
     */
        /** @brief Tamper event is activated on edge of TAMP_INx input transitions to the active level (nointernal pull-up on TAMP_INx input). */
    constexpr std::uint32_t TAMP_FLTCR_TAMPFLT_B_0x0 = 0;
        /** @brief Tamper event is activated after two consecutive samples at the active level. */
    constexpr std::uint32_t TAMP_FLTCR_TAMPFLT_B_0x1 = 1;
        /** @brief Tamper event is activated after four consecutive samples at the active level. */
    constexpr std::uint32_t TAMP_FLTCR_TAMPFLT_B_0x2 = 2;
        /** @brief Tamper event is activated after eight consecutive samples at the active level. */
    ...
    /** @details Possible values:
     *          - B_0x0: Precharges TAMP_INx pins before sampling (enable internal pull-up) (value: 0)
     *          - B_0x1: Disables precharge of TAMP_INx pins. (value: 1)
     */
        /** @brief Precharges TAMP_INx pins before sampling (enable internal pull-up) */
    constexpr std::uint32_t TAMP_FLTCR_TAMPPUDIS_B_0x0 = 0;
        /** @brief Disables precharge of TAMP_INx pins. */
    ...
    /** @brief Backup register read/write protection offset */
    ...
    /** @details Possible values:
     *          - B_0x0: Monotonic counter 1 (TAMP_COUNT1R) can be read and written when the APB access is secure or nonsecure. (value: 0)
     *          - B_0x1: Monotonic counter 1 (TAMP_COUNT1R) can be read and written only when the APB access is secure. (value: 1)
     */
        /** @brief Monotonic counter 1 (TAMP_COUNT1R) can be read and written when the APB access is secure or nonsecure. */
    ...
    /** @brief Backup register write protection offset */
    ...
    /** @details Possible values:
     *          - B_0x0: Backup registers from TAMP_BKP0R to TAMP_BKP7R can be accessed according to the protection zone they belong to. (value: 0)
     *          - B_0x1: Backup registers from TAMP_BKP0R to TAMP_BKP7R cannot be accessed neither in read, nor in write (they are read as 0, and write is ignored). (value: 1)
     */
        /** @brief Backup registers from TAMP_BKP0R to TAMP_BKP7R can be accessed according to the protection zone they belong to. */
    constexpr std::uint32_t TAMP_SECCFGR_BHKLOCK_B_0x0 = 0;
        /** @brief Backup registers from TAMP_BKP0R to TAMP_BKP7R cannot be accessed neither in read, nor in write (they are read as 0, and write is ignored). */
    ...
    /** @details Possible values:
     *          - B_0x0: Tamper configuration and interrupt can be written when the APB access is secure or nonsecure. (value: 0)
     *          - B_0x1: Tamper configuration and interrupt can be written only when the APB access is secure. (value: 1)
     */
        /** @brief Tamper configuration and interrupt can be written when the APB access is secure or nonsecure. */
    ...
    /** @brief TAMP privileged configuration register */
    using TAMP_PRIVCFGR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x24, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Monotonic counter 1 privileged protection */
    using TAMP_PRIVCFGR_CNT1PRIV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Monotonic counter 1 (TAMP_COUNT1R) can be read and written with privileged or unprivileged access. (value: 0)
     *          - B_0x1: Monotonic counter 1 (TAMP_COUNT1R) can be read and written with privileged access. (value: 1)
     */
        /** @brief Monotonic counter 1 (TAMP_COUNT1R) can be read and written with privileged or unprivileged access. */
    constexpr std::uint32_t TAMP_PRIVCFGR_CNT1PRIV_B_0x0 = 0;
        /** @brief Monotonic counter 1 (TAMP_COUNT1R) can be read and written with privileged access. */
    constexpr std::uint32_t TAMP_PRIVCFGR_CNT1PRIV_B_0x1 = 1;

    /** @brief Backup registers zone 1 privileged protection */
    using TAMP_PRIVCFGR_BKPRWPRIV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Backup registers zone 1 can be written with privileged or unprivileged access. (value: 0)
     *          - B_0x1: Backup registers zone 1 can be written only with privileged access. (value: 1)
     */
        /** @brief Backup registers zone 1 can be written with privileged or unprivileged access. */
    constexpr std::uint32_t TAMP_PRIVCFGR_BKPRWPRIV_B_0x0 = 0;
        /** @brief Backup registers zone 1 can be written only with privileged access. */
    constexpr std::uint32_t TAMP_PRIVCFGR_BKPRWPRIV_B_0x1 = 1;

    /** @brief Backup registers zone 2 privileged protection */
    ...
    /** @brief Tamper privileged protection (excluding backup registers) */
    ...
    /** @brief Tamper i interrupt enable */
    using TAMP_IER_TAMP1IE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Tamper i interrupt disabled (value: 0)
     *          - B_0x1: Tamper i interrupt enabled (value: 1)
     */
        /** @brief Tamper i interrupt disabled */
    constexpr std::uint32_t TAMP_IER_TAMP1IE_B_0x0 = 0;
        /** @brief Tamper i interrupt enabled */
    ...
    /** @brief Internal tamper i interrupt enable */
    using TAMP_IER_ITAMP5IE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Internal tamper i interrupt disabled (value: 0)
     *          - B_0x1: Internal tamper i interrupt enabled (value: 1)
     */
        /** @brief Internal tamper i interrupt disabled */
    constexpr std::uint32_t TAMP_IER_ITAMP5IE_B_0x0 = 0;
        /** @brief Internal tamper i interrupt enabled */
    ...
    /** @brief Tamper i nonsecure interrupt masked flag */
    ...
    using TAMP_SMISR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x34, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Tamper i secure interrupt masked flag */
    ...
    /** @brief Internal tamper i secure interrupt masked flag */
    ...
    /** @brief Tamper i detection flag clear */
    ...
    /** @brief TAMP resource protection register */
    using TAMP_RPCFGR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x54, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Configurable resource i protection */
    using TAMP_RPCFGR_RPCFG1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Resource i is not included in device secrets protected by the TAMP. (value: 0)
     *          - B_0x1: Resource i is included in device secrets protected by the TAMP. (value: 1)
     */
        /** @brief Resource i is not included in device secrets protected by the TAMP. */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG1_B_0x0 = 0;
        /** @brief Resource i is included in device secrets protected by the TAMP. */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG1_B_0x1 = 1;

    /** @brief Configurable resource i protection */
    using TAMP_RPCFGR_RPCFG2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Resource i is not included in device secrets protected by the TAMP. (value: 0)
     *          - B_0x1: Resource i is included in device secrets protected by the TAMP. (value: 1)
     */
        /** @brief Resource i is not included in device secrets protected by the TAMP. */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG2_B_0x0 = 0;
        /** @brief Resource i is included in device secrets protected by the TAMP. */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG2_B_0x1 = 1;

    /** @brief Configurable resource i protection */
    using TAMP_RPCFGR_RPCFG3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Resource i is not included in device secrets protected by the TAMP. (value: 0)
     *          - B_0x1: Resource i is included in device secrets protected by the TAMP. (value: 1)
     */
        /** @brief Resource i is not included in device secrets protected by the TAMP. */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG3_B_0x0 = 0;
        /** @brief Resource i is included in device secrets protected by the TAMP. */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG3_B_0x1 = 1;

    /** @brief Configurable resource i protection */
    using TAMP_RPCFGR_RPCFG4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Resource i is not included in device secrets protected by the TAMP. (value: 0)
     *          - B_0x1: Resource i is included in device secrets protected by the TAMP. (value: 1)
     */
        /** @brief Resource i is not included in device secrets protected by the TAMP. */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG4_B_0x0 = 0;
        /** @brief Resource i is included in device secrets protected by the TAMP. */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG4_B_0x1 = 1;

    /** @brief Configurable resource i protection */
    using TAMP_RPCFGR_RPCFG5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Resource i is not included in device secrets protected by the TAMP. (value: 0)
     *          - B_0x1: Resource i is included in device secrets protected by the TAMP. (value: 1)
     */
        /** @brief Resource i is not included in device secrets protected by the TAMP. */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG5_B_0x0 = 0;
        /** @brief Resource i is included in device secrets protected by the TAMP. */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG5_B_0x1 = 1;

    /** @brief Backup register protection */
    using TAMP_RPCFGR_RPCFG31 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Backup registers and BHKLOCK are not included in device secrets protected by the TAMP. (value: 0)
     *          - B_0x1: Backup registers and BHKLOCK are included in device secrets protected by the TAMP. (value: 1)
     */
        /** @brief Backup registers and BHKLOCK are not included in device secrets protected by the TAMP. */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG31_B_0x0 = 0;
        /** @brief Backup registers and BHKLOCK are included in device secrets protected by the TAMP. */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG31_B_0x1 = 1;
