...
#ifndef EMBEDDED_PP_STM32U3C5_SEC_TIM15_HPP
#define EMBEDDED_PP_STM32U3C5_SEC_TIM15_HPP
...
namespace STM32U3C5::SEC_TIM15 {
    ...
    /** @details Possible values:
     *          - B_0x0: tless thansub>DTS less than/sub>= tless thansub>tim_ker_ckless than/sub> (value: 0)
     ...
     */
        /** @brief tless thansub>DTS less than/sub>= tless thansub>tim_ker_ckless than/sub> */
    ...
    using TIM15_CR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/compare preloaded control */
    using TIM15_CR2_CCPC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM15_CR2_CCPC_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM15_CR2_CCPC_B_0x1 = 1;

    /** @brief Capture/compare control update selection */
    using TIM15_CR2_CCUS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM15_CR2_CCUS_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM15_CR2_CCUS_B_0x1 = 1;

    /** @brief Capture/compare DMA selection */
    using TIM15_CR2_CCDS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM15_CR2_CCDS_B_0x0 = 0;
        /** @brief CCx DMA requests sent when update event occurs */
    constexpr std::uint32_t TIM15_CR2_CCDS_B_0x1 = 1;

    /** @brief Master mode selection */
    using TIM15_CR2_MMS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Reset-the UG bit from the TIM15_EGR register is used as trigger output (tim_trgo). (value: 0)
     ...
     */
        /** @brief Reset-the UG bit from the TIM15_EGR register is used as trigger output (tim_trgo). */
    constexpr std::uint32_t TIM15_CR2_MMS_B_0x0 = 0;
        /** @brief Enable-the Counter Enable signal CNT_EN is used as trigger output (tim_trgo). */
    constexpr std::uint32_t TIM15_CR2_MMS_B_0x1 = 1;
        /** @brief Update-The update event is selected as trigger output (tim_trgo). */
    constexpr std::uint32_t TIM15_CR2_MMS_B_0x2 = 2;
    ...
    constexpr std::uint32_t TIM15_CR2_MMS_B_0x3 = 3;
        /** @brief Compare-tim_oc1refc signal is used as trigger output (tim_trgo). */
    constexpr std::uint32_t TIM15_CR2_MMS_B_0x4 = 4;
        /** @brief Compare-tim_oc2refc signal is used as trigger output (tim_trgo). */
    constexpr std::uint32_t TIM15_CR2_MMS_B_0x5 = 5;

    /** @brief tim_ti1 selection */
    using TIM15_CR2_TI1S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM15_CR2_TI1S_B_0x0 = 0;
        /** @brief The tim_ti1_in[15:0] and tim_ti2_in[15:0] multiplexers output are connected to the tim_ti1 input (xOR combination) */
    constexpr std::uint32_t TIM15_CR2_TI1S_B_0x1 = 1;

    /** @brief Output Idle state 1 (tim_oc1 output) */
    using TIM15_CR2_OIS1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM15_CR2_OIS1_B_0x0 = 0;
        /** @brief tim_oc1 = 1 after a dead-time when MOE = 0 */
    constexpr std::uint32_t TIM15_CR2_OIS1_B_0x1 = 1;

    /** @brief Output Idle state 1 (tim_oc1n output) */
    using TIM15_CR2_OIS1N = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM15_CR2_OIS1N_B_0x0 = 0;
        /** @brief tim_oc1n = 1 after a dead-time when MOE = 0 */
    constexpr std::uint32_t TIM15_CR2_OIS1N_B_0x1 = 1;

    /** @brief Output idle state 2 (tim_oc2 output) */
    using TIM15_CR2_OIS2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: tim_oc2 = 0 when MOE = 0 (value: 0)
     *          - B_0x1: tim_oc2 = 1 when MOE = 0 (value: 1)
     */
        /** @brief tim_oc2 = 0 when MOE = 0 */
    constexpr std::uint32_t TIM15_CR2_OIS2_B_0x0 = 0;
        /** @brief tim_oc2 = 1 when MOE = 0 */
    constexpr std::uint32_t TIM15_CR2_OIS2_B_0x1 = 1;

    /** @brief ADC synchronization */
    using TIM15_CR2_ADSYNC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    using TIM15_SMCR_SMSPE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM15_SMCR_SMSPE_B_0x0 = 0;
        /** @brief SMS[3:0] preload is enabled */
    constexpr std::uint32_t TIM15_SMCR_SMSPE_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: No action (value: 0)
     *          - B_0x1: The TIF flag is set in TIM15_SR register. (value: 1)
     */
        /** @brief No action */
    constexpr std::uint16_t TIM15_EGR_TG_B_0x0 = 0;
        /** @brief The TIF flag is set in TIM15_SR register. */
    ...
    /** @details Possible values:
     *          - B_0x0: Preload register on TIM15_CCR1 disabled. (value: 0)
     *          - B_0x1: Preload register on TIM15_CCR1 enabled. (value: 1)
     */
        /** @brief Preload register on TIM15_CCR1 disabled. */
    constexpr std::uint32_t TIM15_CCMR1_ALTERNATE1_OC1PE_B_0x0 = 0;
        /** @brief Preload register on TIM15_CCR1 enabled. */
     ...
     *          - B_0x6: PWM mode 1-Channel 1 is active as long as TIM15_CNTless thanTIM15_CCR1 else inactive. (value: 6)
     *          - B_0x7: PWM mode 2-Channel 1 is inactive as long as TIM15_CNTless thanTIM15_CCR1 else active. (value: 7)
     */
    ...
    constexpr std::uint32_t TIM15_CCMR1_ALTERNATE1_OC1M_B_0x5 = 5;
        /** @brief PWM mode 1-Channel 1 is active as long as TIM15_CNTless thanTIM15_CCR1 else inactive. */
    constexpr std::uint32_t TIM15_CCMR1_ALTERNATE1_OC1M_B_0x6 = 6;
        /** @brief PWM mode 2-Channel 1 is inactive as long as TIM15_CNTless thanTIM15_CCR1 else active. */
    constexpr std::uint32_t TIM15_CCMR1_ALTERNATE1_OC1M_B_0x7 = 7;

    /** @brief Output compare 1 clear enable */
    using TIM15_CCMR1_ALTERNATE1_OC1CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM15_CCMR1_ALTERNATE1_OC1CE_B_0x0 = 0;
        /** @brief tim_oc1ref is cleared as soon as a High level is detected on tim_ocref_clr_int input. */
    constexpr std::uint32_t TIM15_CCMR1_ALTERNATE1_OC1CE_B_0x1 = 1;
    ...
    using TIM15_CCMR1_ALTERNATE1_OC2CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC1M[3] */
    ...
    /** @brief TIM15 autoreload register */
     ...
     *          - B_0x1: When inactive, tim_ocx/tim_ocxn outputs are forced first with their idle level as soon as CCxE = 1 or CCxNE = 1. (value: 1)
     */
    ...
    constexpr std::uint32_t TIM15_BDTR_OSSI_B_0x0 = 0;
        /** @brief When inactive, tim_ocx/tim_ocxn outputs are forced first with their idle level as soon as CCxE = 1 or CCxNE = 1. */
