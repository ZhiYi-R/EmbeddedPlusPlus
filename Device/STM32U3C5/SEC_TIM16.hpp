...
#ifndef EMBEDDED_PP_STM32U3C5_SEC_TIM16_HPP
#define EMBEDDED_PP_STM32U3C5_SEC_TIM16_HPP
...
namespace STM32U3C5::SEC_TIM16 {
    ...
    using TIM16_CCMR1_ALTERNATE1_OC1CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM16_CCMR1_ALTERNATE1_OC1CE_B_0x0 = 0;
        /** @brief tim_oc1ref is cleared as soon as a High level is detected on tim_ocref_clr input. */
    constexpr std::uint32_t TIM16_CCMR1_ALTERNATE1_OC1CE_B_0x1 = 1;
    ...
    /** @brief TIM16 auto-reautoreload register */
    ...
    using TIM16_OR1_HSE32EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
