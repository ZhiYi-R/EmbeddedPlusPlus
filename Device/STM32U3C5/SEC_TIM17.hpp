...
#ifndef EMBEDDED_PP_STM32U3C5_SEC_TIM17_HPP
#define EMBEDDED_PP_STM32U3C5_SEC_TIM17_HPP
...
namespace STM32U3C5::SEC_TIM17 {
     ...
     *          - B_0x1: tless thansub>DTSless than/sub> = 2xtless thansub>tim_ker_ckless than/sub> (value: 1)
     *          - B_0x2: tless thansub>DTSless than/sub> = 4xtless thansub>tim_ker_ckless than/sub> (value: 2)
     */
        /** @brief tless thansub>DTSless than/sub> = tless thansub>tim_ker_ckless than/sub> */
    constexpr std::uint16_t TIM17_CR1_CKD_B_0x0 = 0;
        /** @brief tless thansub>DTSless than/sub> = 2xtless thansub>tim_ker_ckless than/sub> */
    constexpr std::uint16_t TIM17_CR1_CKD_B_0x1 = 1;
        /** @brief tless thansub>DTSless than/sub> = 4xtless thansub>tim_ker_ckless than/sub> */
    ...
    using TIM17_CR1_DITHEN = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Dithering disabled (value: 0)
     *          - B_0x1: Dithering enabled (value: 1)
     */
        /** @brief Dithering disabled */
    constexpr std::uint16_t TIM17_CR1_DITHEN_B_0x0 = 0;
        /** @brief Dithering enabled */
    constexpr std::uint16_t TIM17_CR1_DITHEN_B_0x1 = 1;
    ...
    using TIM17_CCMR1_ALTERNATE1_OC1CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_CCMR1_ALTERNATE1_OC1CE_B_0x0 = 0;
        /** @brief tim_oc1ref is cleared as soon as a High level is detected on tim_ocref_clr input. */
    constexpr std::uint32_t TIM17_CCMR1_ALTERNATE1_OC1CE_B_0x1 = 1;
    ...
    /** @brief TIM17 auto-reautoreload register */
    using TIM17_ARR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x2C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Auto-reload value */
    using TIM17_ARR_ARR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 20, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM17_CCR1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x34, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 1 value */
    using TIM17_CCR1_CCR1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 20, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM17_DTR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x54, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Dead-time falling edge generator setup */
    using TIM17_DTR2_DTGF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Deadtime asymmetric enable */
    using TIM17_DTR2_DTAE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_DTR2_DTAE_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM17_DTR2_DTAE_B_0x1 = 1;

    /** @brief Deadtime preload enable */
    using TIM17_DTR2_DTPE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_DTR2_DTPE_B_0x0 = 0;
        /** @brief Deadtime value preload is enabled */
    constexpr std::uint32_t TIM17_DTR2_DTPE_B_0x1 = 1;

    /** @brief TIM17 input selection register */
    using TIM17_TISEL = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x5C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    constexpr std::uint32_t TIM17_TISEL_TI1SEL_B_0x0 = 0;
        /** @brief tim_ti1_in1 */
    constexpr std::uint32_t TIM17_TISEL_TI1SEL_B_0x1 = 1;
        /** @brief tim_ti1_in15 */
    constexpr std::uint32_t TIM17_TISEL_TI1SEL_B_0xF = 15;
    ...
    using TIM17_AF1_BKCMP1E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: tim_brk_cmp1 input disabled (value: 0)
     *          - B_0x1: tim_brk_cmp1 input enabled (value: 1)
     */
        /** @brief tim_brk_cmp1 input disabled */
    constexpr std::uint32_t TIM17_AF1_BKCMP1E_B_0x0 = 0;
        /** @brief tim_brk_cmp1 input enabled */
    constexpr std::uint32_t TIM17_AF1_BKCMP1E_B_0x1 = 1;

    /** @brief tim_brk_cmp2 enable */
    using TIM17_AF1_BKCMP2E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: tim_brk_cmp2 input disabled (value: 0)
     *          - B_0x1: tim_brk_cmp2 input enabled (value: 1)
     */
        /** @brief tim_brk_cmp2 input disabled */
    constexpr std::uint32_t TIM17_AF1_BKCMP2E_B_0x0 = 0;
        /** @brief tim_brk_cmp2 input enabled */
    constexpr std::uint32_t TIM17_AF1_BKCMP2E_B_0x1 = 1;

    /** @brief tim_brk_cmp3 enable */
    using TIM17_AF1_BKCMP3E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: tim_brk_cmp3 input disabled (value: 0)
     *          - B_0x1: tim_brk_cmp3 input enabled (value: 1)
     */
        /** @brief tim_brk_cmp3 input disabled */
    constexpr std::uint32_t TIM17_AF1_BKCMP3E_B_0x0 = 0;
        /** @brief tim_brk_cmp3 input enabled */
    constexpr std::uint32_t TIM17_AF1_BKCMP3E_B_0x1 = 1;

    /** @brief tim_brk_cmp4 enable */
    using TIM17_AF1_BKCMP4E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: tim_brk_cmp4 input disabled (value: 0)
     *          - B_0x1: tim_brk_cmp4 input enabled (value: 1)
     */
        /** @brief tim_brk_cmp4 input disabled */
    constexpr std::uint32_t TIM17_AF1_BKCMP4E_B_0x0 = 0;
        /** @brief tim_brk_cmp4 input enabled */
    constexpr std::uint32_t TIM17_AF1_BKCMP4E_B_0x1 = 1;

    /** @brief tim_brk_cmp5 enable */
    using TIM17_AF1_BKCMP5E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: tim_brk_cmp5 input disabled (value: 0)
     *          - B_0x1: tim_brk_cmp5 input enabled (value: 1)
     */
        /** @brief tim_brk_cmp5 input disabled */
    constexpr std::uint32_t TIM17_AF1_BKCMP5E_B_0x0 = 0;
        /** @brief tim_brk_cmp5 input enabled */
    constexpr std::uint32_t TIM17_AF1_BKCMP5E_B_0x1 = 1;

    /** @brief tim_brk_cmp6 enable */
    using TIM17_AF1_BKCMP6E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: tim_brk_cmp6 input disabled (value: 0)
     *          - B_0x1: tim_brk_cmp6 input enabled (value: 1)
     */
        /** @brief tim_brk_cmp6 input disabled */
    constexpr std::uint32_t TIM17_AF1_BKCMP6E_B_0x0 = 0;
        /** @brief tim_brk_cmp6 input enabled */
    constexpr std::uint32_t TIM17_AF1_BKCMP6E_B_0x1 = 1;

    /** @brief tim_brk_cmp7 enable */
    using TIM17_AF1_BKCMP7E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: tim_brk_cmp7 input disabled (value: 0)
     *          - B_0x1: tim_brk_cmp7 input enabled (value: 1)
     */
        /** @brief tim_brk_cmp7 input disabled */
    constexpr std::uint32_t TIM17_AF1_BKCMP7E_B_0x0 = 0;
        /** @brief tim_brk_cmp7 input enabled */
    constexpr std::uint32_t TIM17_AF1_BKCMP7E_B_0x1 = 1;

    /** @brief tim_brk_cmp8 enable */
    using TIM17_AF1_BKCMP8E = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: tim_brk_cmp8 input disabled (value: 0)
     *          - B_0x1: tim_brk_cmp8 input enabled (value: 1)
     */
        /** @brief tim_brk_cmp8 input disabled */
    constexpr std::uint32_t TIM17_AF1_BKCMP8E_B_0x0 = 0;
        /** @brief tim_brk_cmp8 input enabled */
    constexpr std::uint32_t TIM17_AF1_BKCMP8E_B_0x1 = 1;
    ...
    using TIM17_AF1_BKCMP1P = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_AF1_BKCMP1P_B_0x0 = 0;
        /** @brief tim_brk_cmp1 input is active low */
    constexpr std::uint32_t TIM17_AF1_BKCMP1P_B_0x1 = 1;

    /** @brief tim_brk_cmp2 input polarity */
    using TIM17_AF1_BKCMP2P = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_AF1_BKCMP2P_B_0x0 = 0;
        /** @brief tim_brk_cmp2 input is active low */
    constexpr std::uint32_t TIM17_AF1_BKCMP2P_B_0x1 = 1;

    /** @brief tim_brk_cmp3 input polarity */
    using TIM17_AF1_BKCMP3P = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_AF1_BKCMP3P_B_0x0 = 0;
        /** @brief tim_brk_cmp3 input is active low */
    constexpr std::uint32_t TIM17_AF1_BKCMP3P_B_0x1 = 1;

    /** @brief tim_brk_cmp4 input polarity */
    using TIM17_AF1_BKCMP4P = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_AF1_BKCMP4P_B_0x0 = 0;
        /** @brief tim_brk_cmp4 input is active low */
    constexpr std::uint32_t TIM17_AF1_BKCMP4P_B_0x1 = 1;

    /** @brief TIM17 alternate function register 2 */
    using TIM17_AF2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x64, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief tim_ocref_clr source selection */
    using TIM17_AF2_OCRSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM17_AF2_OCRSEL_B_0x0 = 0;
        /** @brief tim_ocref_clr1 */
    constexpr std::uint32_t TIM17_AF2_OCRSEL_B_0x1 = 1;
        /** @brief tim_ocref_clr2 */
    constexpr std::uint32_t TIM17_AF2_OCRSEL_B_0x2 = 2;
        /** @brief tim_ocref_clr3 */
    constexpr std::uint32_t TIM17_AF2_OCRSEL_B_0x3 = 3;
        /** @brief tim_ocref_clr4 */
    constexpr std::uint32_t TIM17_AF2_OCRSEL_B_0x4 = 4;
        /** @brief tim_ocref_clr5 */
    constexpr std::uint32_t TIM17_AF2_OCRSEL_B_0x5 = 5;
        /** @brief tim_ocref_clr6 */
    constexpr std::uint32_t TIM17_AF2_OCRSEL_B_0x6 = 6;
        /** @brief tim_ocref_clr7 */
    constexpr std::uint32_t TIM17_AF2_OCRSEL_B_0x7 = 7;

    /** @brief TIM17 option register 1 */
    using TIM17_OR1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x68, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief HSE Divided by 32 enable */
    using TIM17_OR1_HSE32EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: HSE divided by 32 disabled (value: 0)
     *          - B_0x1: HSE divided by 32 enabled (value: 1)
     */
        /** @brief HSE divided by 32 disabled */
    constexpr std::uint32_t TIM17_OR1_HSE32EN_B_0x0 = 0;
        /** @brief HSE divided by 32 enabled */
    constexpr std::uint32_t TIM17_OR1_HSE32EN_B_0x1 = 1;

    /** @brief TIM17 DMA control register */
    using TIM17_DCR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x3DC, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DMA base address */
    using TIM17_DCR_DBA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     ...
     */
        /** @brief TIMx_CR1, */
    constexpr std::uint32_t TIM17_DCR_DBA_B_0x0 = 0;
        /** @brief TIMx_CR2, */
    constexpr std::uint32_t TIM17_DCR_DBA_B_0x1 = 1;
        /** @brief TIMx_SMCR, */
    constexpr std::uint32_t TIM17_DCR_DBA_B_0x2 = 2;

    /** @brief DMA burst length */
    using TIM17_DCR_DBL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     ...
     */
        /** @brief 1 transfer, */
    constexpr std::uint32_t TIM17_DCR_DBL_B_0x0 = 0;
        /** @brief 2 transfers, */
    constexpr std::uint32_t TIM17_DCR_DBL_B_0x1 = 1;
        /** @brief 3 transfers, */
    constexpr std::uint32_t TIM17_DCR_DBL_B_0x2 = 2;
        /** @brief 18 transfers. */
    constexpr std::uint32_t TIM17_DCR_DBL_B_0x11 = 17;

    /** @brief DMA burst source selection */
    using TIM17_DCR_DBSS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x1: Update (value: 1)
     *          - B_0x2: CC1 (value: 2)
     */
        /** @brief Update */
    constexpr std::uint32_t TIM17_DCR_DBSS_B_0x1 = 1;
        /** @brief CC1 */
    constexpr std::uint32_t TIM17_DCR_DBSS_B_0x2 = 2;

    /** @brief TIM16/TIM17 DMA address for full transfer */
    using TIM17_DMAR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x3E0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DMA register for burst accesses */
    using TIM17_DMAR_DMAB = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
