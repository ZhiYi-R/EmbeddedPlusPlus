...
#ifndef EMBEDDED_PP_STM32U535_SEC_TIM15_HPP
#define EMBEDDED_PP_STM32U535_SEC_TIM15_HPP
...
namespace STM32U535::SEC_TIM15 {
    ...
    constexpr std::uint32_t SMCR_TS_2_0_B_0x0 = 0;
        /** @brief Internal trigger 1 (tim_itr1) */
    constexpr std::uint32_t SMCR_TS_2_0_B_0x1 = 1;
        /** @brief Internal trigger 2 (tim_itr2) */
    constexpr std::uint32_t SMCR_TS_2_0_B_0x2 = 2;
        /** @brief Internal trigger 3 (tim_itr3) */
    constexpr std::uint32_t SMCR_TS_2_0_B_0x3 = 3;
        /** @brief tim_ti1 edge detector (tim_ti1f_ed) */
    constexpr std::uint32_t SMCR_TS_2_0_B_0x4 = 4;
        /** @brief Filtered timer input 1 (tim_ti1fp1) */
    constexpr std::uint32_t SMCR_TS_2_0_B_0x5 = 5;
        /** @brief Filtered timer input 2 (tim_ti2fp2) */
    constexpr std::uint32_t SMCR_TS_2_0_B_0x6 = 6;
        /** @brief External trigger input (tim_etrf) */
    constexpr std::uint32_t SMCR_TS_2_0_B_0x7 = 7;
