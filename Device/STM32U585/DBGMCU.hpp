...
#ifndef EMBEDDED_PP_STM32U585_DBGMCU_HPP
#define EMBEDDED_PP_STM32U585_DBGMCU_HPP
...
namespace STM32U585::DBGMCU {
    ...
    /** @brief DECLARATION TO BE CONFIRMED by PRODUCT OWNER! Bit n identifies whether access port AP n is open (can be accessed via the debug port) or locked (debug access to the AP is blocked) */
