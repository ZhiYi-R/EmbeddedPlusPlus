...
#ifndef EMBEDDED_PP_STM32U585_SEC_DCACHE_HPP
#define EMBEDDED_PP_STM32U585_SEC_DCACHE_HPP
...
/** @brief DCACHE */
namespace STM32U585::SEC_DCACHE {
    ...
    /** @brief RMISSMON */
    using DCACHE_RMMONR_MRISSMON = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief CMDSTARTADDR */
    using DCACHE_CMDRSADDRR_CMDSTARTADDR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief command range start address register */
    using DCACHE_CMDREADDRR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x2C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CMDENDADDR */
    using DCACHE_CMDREADDRR_CMDENDADDR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
