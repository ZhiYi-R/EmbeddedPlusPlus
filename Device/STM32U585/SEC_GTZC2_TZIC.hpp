...
#ifndef EMBEDDED_PP_STM32U585_SEC_GTZC2_TZIC_HPP
#define EMBEDDED_PP_STM32U585_SEC_GTZC2_TZIC_HPP
...
/** @brief GTZC2_TZIC */
namespace STM32U585::SEC_GTZC2_TZIC {
    ...
    using IER1_ADC4IE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using SR1_ADC4F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using FCR1_CADC4F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
