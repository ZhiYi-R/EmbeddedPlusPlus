...
#ifndef EMBEDDED_PP_STM32U599_SEC_FMC_HPP
#define EMBEDDED_PP_STM32U599_SEC_FMC_HPP
...
namespace STM32U599::SEC_FMC {
    ...
    /** @brief Wait signal during asynchronous */
    ...
    /** @brief Data latency for synchronous memory */
    ...
    using PCR_TAR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ECC page size */
