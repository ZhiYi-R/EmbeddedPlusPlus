...
#ifndef EMBEDDED_PP_STM32U59X_SEC_TIM17_HPP
#define EMBEDDED_PP_STM32U59X_SEC_TIM17_HPP
...
namespace STM32U59x::SEC_TIM17 {
    ...
    using OR1_HSE32EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
