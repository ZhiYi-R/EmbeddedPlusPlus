...
#ifndef EMBEDDED_PP_STM32U5F7_SEC_SPI2_HPP
#define EMBEDDED_PP_STM32U5F7_SEC_SPI2_HPP
...
namespace STM32U5F7::SEC_SPI2 {
    ...
    /** @brief TCRCINI */
    using CR1_TCRCINI = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RCRCINI */
    using CR1_RCRCINI = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CRC33_17 */
    ...
    /** @brief TSIZE */
    using CR2_TSIZE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 11, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief configuration register 1 */
    using CFG1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief BPASS */
    using CFG1_BPASS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Behavior of slave transmitter at */
    using CFG1_UDRCFG = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Number of bits in at single SPI data */
    ...
    /** @brief Software management of SS signal */
    ...
    /** @brief Swap functionality of MISO and MOSI */
    using CFG2_IOSWP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RDIOP */
    using CFG2_RDIOP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RDIMM */
    using CFG2_RDIMM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief EOT, SUSP and TXC interrupt */
    ...
    /** @brief Number of data frames remaining in */
    ...
    /** @brief Interrupt/Status Flags Clear */
    ...
    /** @brief TI frame format error flag */
    ...
    /** @brief Transmission Transfer Filled flag */
    ...
    using AUTOCR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TRIGEN */
    using AUTOCR_TRIGEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TRIGPOL */
    using AUTOCR_TRIGPOL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TRIGSEL */
    using AUTOCR_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
