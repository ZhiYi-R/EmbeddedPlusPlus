...
#ifndef EMBEDDED_PP_STM32U5FX_SEC_DSI_HPP
#define EMBEDDED_PP_STM32U5FX_SEC_DSI_HPP
...
namespace STM32U5Fx::SEC_DSI {
    ...
    /** @brief EoTp transmission in low-power enable This bit enables the EoTP transmission in low-power. */
    ...
    /** @brief Virtual channel ID for reception This field indicates the generic interface read-back virtual channel identification. */
    using DSI_GVCIDR_VCIDRX = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Virtual channel ID for transmission This field indicates the generic interface virtual channel identification where the generic packet is automatically generated and transmitted. */
    ...
    /** @brief WordCount MSB This field configures the most significant byte of the header packet's word count for long packets, or data 1 for short packets. */
    ...
    /** @brief Command buffer empty This bit indicates the empty status of the generic payload internal buffer: */
    ...
    /** @brief Command buffer full This bit indicates the full status of the generic command internal buffer: */
    ...
    /** @brief Payload buffer empty This bit indicates the empty status of the generic payload internal buffer: */
    ...
    /** @brief Payload buffer full This bit indicates the full status of the generic payload internal buffer: */
    ...
    /** @brief Bus-turn-around timeout counter This field sets a period for which the DSI Host keeps the link still, after completing a bus-turn-around. This period is measured in cycles of lanebyteclk. The counting starts when the DâPHY enters the Stop state and causes no interrupts. */
    ...
    /** @brief Low-power to high-speed time This field configures the maximum time that the D-PHY clock lane takes to go from lowâpower to high-speed transmission measured in lane byte clock cycles. */
    using DSI_CLTCR_LP2HS_TIME = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 10, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief High-speed to low-power time This field configures the maximum time that the D-PHY clock lane takes to go from highâspeed to low-power transmission measured in lane byte clock cycles. */
    ...
    /** @brief Payload buffer underflow error This bit indicates that underflow has occurred when reading payload to build DSI packet for video mode. */
    ...
    /** @brief Payload buffer underflow error interrupt enable This bit enables the interrupt generation on payload buffer underflow error. */
    ...
    /** @brief Force payload buffer underflow error Writing one to this bit forces a payload undrflow error. */
    ...
    /** @brief Color coding This field returns the current LTDC interface color coding. 0110-1111: reserved If LTDC interface in command mode is chosen and currently works in the command mode (CMDM=1), then 0110-1111: 24-bit */
    ...
    /** @brief Video mode command write FIFO empty This bit indicates the empty status of the video mode write command FIFO: */
    ...
    /** @brief Video mode command write FIFO full This bit indicates the full status of the video mode write command FIFO: */
    ...
    /** @brief Video mode payload write FIFO empty This bit indicates the empty status of the video mode write payload FIFO: */
    ...
    /** @brief Video mode payload write FIFO full This bit indicates the full status of the video mode write payload FIFO: */
    ...
    /** @brief Adapted command mode command write FIFO empty This bit indicates the empty status of the adapted command mode write command FIFO: */
    ...
    /** @brief Adapted command mode command write FIFO full This bit indicates the full status of the adapted command mode write command FIFO: */
    ...
    /** @brief Adapted command mode payload write FIFO empty This bit indicates the empty status of the adapted command mode write payload FIFO: */
    ...
    /** @brief Adapted command mode payload write FIFO full This bit indicates the full status of the adapted command mode write payload FIFO: */
    ...
    /** @brief Video mode payload buffer empty This bit indicates the empty status of the video mode payload internal buffer: */
    ...
    /** @brief Video mode payload buffer full This bit indicates the full status of the video mode payload internal buffer: */
    ...
    /** @brief Adapted command mode command buffer empty This bit indicates the empty status of the adapted command mode command internal buffer: */
    ...
    /** @brief Adapted command mode command buffer full This bit indicates the full status of the adapted command mode command internal buffer: */
    ...
    /** @brief Adapted command mode payload buffer empty This bit indicates the empty status of the adapted command mode payload internal buffer: */
    ...
    /** @brief Adapted command mode payload buffer full This bit indicates the full status of the adapted command mode payload internal buffer: */
    ...
    /** @brief Color multiplexing This bit selects the color multiplexing used by DSI Host. This field must only be changed when DSI is stopped (DSI_WCR.DSIEN = 0 and DSI_CR.ENÂ =Â 0). */
    ...
    /** @brief VSync polarity This bit selects the VSync edge on which the LTDC is halted. This bit must only be changed when DSI is stopped (DSI_WCR.DSIEN = 0 and DSI_CR.ENÂ =Â 0). */
    ...
    /** @brief PLL loop division factor This field configures the PLL loop division factor. 2: PLL loop divided by 2x2 ... 511: PLL loop divided by 511x2 */
    ...
    /** @brief PLL input division factor This field configures the PLL input division factor. 2: PLL input divided by 2 ... 511: PLL input divided by 511 */
    ...
    /** @brief PLL output division factor This field configures the PLL output division factor. 2: PLL output divided by 2 ... 511: PLL output divided by 511 */
    ...
    /** @brief Power-up This bit powers-up the reference bias for the MIPI D-PHY */
    ...
    /** @brief Band control This field selects the frequency band used by the D-PHY. Others: Reserved */
    ...
    /** @brief Slew rate control This field selects the slew rate for HS-TX speed. Others: Reserved */
