...
#ifndef EMBEDDED_PP_STM32U5FX_SEC_GFXTIM_HPP
#define EMBEDDED_PP_STM32U5FX_SEC_GFXTIM_HPP
...
namespace STM32U5Fx::SEC_GFXTIM {
    ...
    /** @brief tearing source This field selects the tearing-effect source. */
    ...
    /** @brief tearing--effect polarity This bit selects the tearing-effect polarity. */
    ...
    /** @brief synchronization source This field selects the synchronization signals (HSYNC and VSYNC) sources. */
    ...
    /** @brief frame-clock calibration output enable This bit enables the frame-clock output. */
    ...
    /** @brief line-clock calibration output enable This bit enables the line-clock output. */
    ...
    /** @brief line clock source This field configures the line clock source. */
    ...
    /** @brief line clock counter clock source This bit configures the clock source for the line clock counter. */
    ...
    /** @brief line clock counter force reload This bit forces line clock counter reload. */
    ...
    /** @brief line clock counter hardware reload source This field configures the hardware reload source for the line clock counter. */
    ...
    /** @brief frame clock source This field configures the frame clock source */
    ...
    /** @brief frame clock counter clock source This field configures the clock source for the frame clock counter. */
    ...
    /** @brief frame clock counter force reload This bit forces frame clock counter reload */
    ...
    /** @brief frame- -clock counter hardware reload source This field configures the hardware reload source for the frame- -clock counter. */
    ...
    /** @brief absolute frame counter enable This bit enables the absolute frame counter. */
    ...
    /** @brief force absolute frame counter reset This bit forces the reset of the absolute frame counter. */
    ...
    /** @brief absolute line counter enable This bit enables the absolute line counter. */
    ...
    /** @brief force absolute line counter reset This bit forces the reset of the absolute line counter. */
    ...
    /** @brief relative frame counter 1 enable This bit enables the relative frame counter 1. */
    ...
    /** @brief relative frame counter 1 continuous mode This bit enables the continuous mode of the relative frame counter 1. */
    ...
    /** @brief force relative frame counter 1 reload This bit forces the reload of the relative frame counter 1. */
    ...
    /** @brief relative frame counter 2 enable This bit enables the relative frame counter 2. */
    ...
    /** @brief relative frame counter 2 continuous mode This bit enables the continuous mode of the relative frame counter 2. */
    ...
    /** @brief force relative frame counter 2 reload This bit forces the reload of the relative frame counter 2. */
    ...
    /** @brief absolute frame counter disable This bit disables the absolute frame counter. */
    ...
    /** @brief absolute line counter disable This bit disables the absolute line counter. */
    ...
    /** @brief relative frame counter 1 disable This bit disables the relative frame counter 1. */
    ...
    /** @brief relative frame counter 2 disable This bit disables the relative frame counter 2. */
    ...
    /** @brief event 1 enable This bit enables the complex event 1 generation. */
    ...
    /** @brief event 2 enable This bit enables the complex event 2 generation. */
    ...
    /** @brief event 3 enable This bit enables the complex event 3 generation. */
    ...
    /** @brief event 4 enable This bit enables the complex event 4 generation. */
    ...
    /** @brief line-event selection 1 This field defines the line-event selection for complex event 1 generation. others: reserved */
    ...
    /** @brief frame-event selection 1 This field defines the frame-event selection for complex event 1 generation. others: reserved */
    ...
    /** @brief line-event selection 2 This field defines the line-event selection for complex event 2 generation. others: reserved */
    ...
    /** @brief frame-event selection 2 This field defines the frame-event selection for complex event 2 generation. others: reserved */
    ...
    /** @brief line-event selection 3 This field defines the line-event selection for complex event 3 generation. others: reserved */
    ...
    /** @brief frame-event selection 3 This field defines the frame-event selection for complex event 3 generation. others: reserved */
    ...
    /** @brief line-event selection 4 This field defines the line-event selection for complex event 4 generation. others: Reserved */
    ...
    /** @brief frame-event selection 4 This field defines the frame-event selection for complex event 4 generation. others: reserved */
    ...
    /** @brief watchdog enable This bit enables the graphic watchdog. */
    ...
    /** @brief watchdog disable This bit disables the graphic watchdog. */
    ...
    /** @brief watchdog status This bit returns the status of the graphic watchdog. */
    ...
    /** @brief watchdog hardware reload configuration This field configures the watchdog hardware reload. */
    ...
    constexpr std::uint32_t GFXTIM_WDGTCR_WDGHRC_B_0x2 = 2;
        /** @brief reserved */
    constexpr std::uint32_t GFXTIM_WDGTCR_WDGHRC_B_0x3 = 3;

    /** @brief watchdog clock source This field selects the watchdog clock source. others: reserved */
    ...
    /** @brief force watchdog reload This bit forces the reload of the graphic watchdog. */
    ...
    /** @brief absolute frame counter overflow flag This bit indicates an overflow occurred on the absolute frame counter. */
    ...
    /** @brief absolute line counter overflow flag This bit indicates an overflow occurred on the absolute line counter. */
    ...
    /** @brief tearing-effect flag This bit indicates a tearing effect event occurred. */
    ...
    /** @brief absolute frame counter compare 1 flag This bit indicates match on compare 1 of the absolute frame counter. */
    ...
    /** @brief absolute line counter compare 1 flag This bit indicates match on compare 1 of the absolute line counter. */
    ...
    /** @brief absolute line counter compare 2 flag This bit indicates match on compare 2 of the absolute line counter. */
    ...
    /** @brief relative frame counter 1 reload flag This bit indicates relative frame counter 1 has been reloaded. */
    ...
    /** @brief relative frame counter 2 reload flag This bit indicates relative frame counter 2 has been reloaded. */
    ...
    /** @brief event 1 flag This bit indicates a complex event 1 occurred. */
    ...
    /** @brief event 2 flag This bit indicates a complex event 2 occurred. */
    ...
    /** @brief event 3 flag This bit indicates a complex event 3 occurred. */
    ...
    /** @brief event 4 flag This bit indicates a complex event 4 occurred. */
    ...
    /** @brief watchdog alarm flag This bit indicates that a graphic watchdog alarm occurred. */
    ...
    /** @brief watchdog pre-alarm flag This bit indicates that a graphic watchdog pre-alarm occurred. */
    ...
    /** @brief clear absolute frame counter overflow flag This bit clears AFCOF in GXTIM_ISR. */
    ...
    /** @brief clear absolute line counter overflow flag This bit clears ALCOF in GXTIM_ISR. */
    ...
    /** @brief clear tearing-effect flag This bit clears TEF in GXTIM_ISR. */
    ...
    /** @brief clear absolute frame counter compare 1 flag This bit clears AFCC1F in GXTIM_ISR. */
    ...
    /** @brief clear absolute line counter compare 1 flag This bit clears ALCC1F in GXTIM_ISR. */
    ...
    /** @brief clear absolute line counter compare 2 flag This bit clears ALCC2F in GXTIM_ISR. */
    ...
    /** @brief clear relative frame counter 1 reload flag This bit clears RFC1RF in GXTIM_ISR. */
    ...
    /** @brief clear relative frame counter 2 reload flag This bit clears RFC2RF in GXFXTIM_ISR. */
    ...
    /** @brief clear event 1 flag This bit EV1F in GXFXTIM_ISR. */
    ...
    /** @brief clear event 2 flag This bit clears EV2F in GXFXTIM_ISR. */
    ...
    /** @brief clear event 3 flag This bit clears EV3F in GXFXTIM_ISR. */
    ...
    /** @brief clear event 4 flag This bit clears EV4F in GXFXTIM_ISR. */
    ...
    /** @brief clear watchdog alarm flag This bit clears WDGAF in GXFXTIM_ISR. */
    ...
    /** @brief clear watchdog pre-alarm flag This bit clears WDGPF in GXFXTIM_ISR. */
    ...
    /** @brief absolute frame counter overflow interrupt enable This bit enables the absolute frame counter overflow interrupt generation. */
    ...
    /** @brief absolute line counter overflow interrupt enable This bit enables the absolute line counter overflow interrupt generation. */
    ...
    /** @brief tearing-effect interrupt enable This bit enables the Tearing Effect interrupt generation. */
    ...
    /** @brief absolute frame counter compare 1 interrupt enable This bit enables the absolute frame counter compare interrupt generation. */
    ...
    /** @brief absolute line counter compare 1 interrupt enable This bit enables the absolute line counter compare 1 interrupt generation. */
    ...
    /** @brief absolute line counter compare 2 interrupt enable This bit enables the absolute line counter compare 2 interrupt generation. */
    ...
    /** @brief relative frame counter 1 reload interrupt enable This bit enables the relative frame counter 1 reload interrupt generation. */
    ...
    /** @brief relative frame counter 2 reload interrupt enable This bit enables the relative frame counter 2 reload interrupt generation. */
    ...
    /** @brief event 1 interrupt enable This bit enables the complex event 1 interrupt generation. */
    ...
    /** @brief event 2 interrupt enable This bit enables the complex event 2 interrupt generation. */
    ...
    /** @brief event 3 interrupt enable This bit enables the complex event 3 interrupt generation. */
    ...
    /** @brief event 4 interrupt enable This bit enables the complex event 4 interrupt generation. */
    ...
    /** @brief watchdog alarm interrupt enable This bit enables the watchdog alarm interrupt generation. */
    ...
    /** @brief watchdog pre-alarm interrupt enable This bit enables the watchdog pre-alarm interrupt generation. */
    ...
    /** @brief absolute frame counter status This bit returns the status of the absolute frame counter. */
    ...
    /** @brief absolute line counter status This bit returns the status of the absolute line counter. */
    ...
    /** @brief relative frame counter 1 status This bit returns the status of the relative frame counter 1. */
    ...
    /** @brief relative frame counter 2 status This bit returns the status of the relative frame counter 2. */
    ...
    /** @brief reload value Reload value of the line clock counter. */
    ...
    /** @brief reload value Reload value of the frame clock counter. */
    ...
    /** @brief line number Current value of the absolute line counter. */
    using GFXTIM_ATR_LINE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief fame number Current value of the absolute frame counter. */
    ...
    /** @brief frame number Current value of the absolute frame counter. Note: This field can only be written when the absolute frame counter is disabled. */
    ...
    /** @brief line number Current value of the absolute line counter. Note: This field can only be written when the absolute frame counter is disabled. */
    ...
    /** @brief frame number Compare 1 value for the absolute frame counter. */
    ...
    /** @brief line number Compare value 1 for the absolute line counter. */
    ...
    /** @brief line number Compare value 2 for the absolute line counter. */
    ...
    /** @brief frame number Current value of the relative frame counter 1. */
    ...
    /** @brief frame reload value Reload value for the relative frame counter 1. */
    ...
    /** @brief frame number Current value of the relative frame counter 2. */
    ...
    /** @brief frame reload value Reload value for the relative frame counter 2. */
    ...
    /** @brief value Current value of the watchdog counter. */
    ...
    /** @brief reload value Reload value of the watchdog counter. */
    ...
    /** @brief pre-alarm value Pre-alarm value of the watchdog counter. */
