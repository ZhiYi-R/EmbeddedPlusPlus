...
#ifndef EMBEDDED_PP_STM32U5FX_SEC_TIM8_HPP
#define EMBEDDED_PP_STM32U5FX_SEC_TIM8_HPP
...
namespace STM32U5Fx::SEC_TIM8 {
    ...
    constexpr std::uint16_t TIM1_CR1_CKD_B_0x3 = 3;
     ...
     *          - B_0x8: Encoder Clock output - The encoder clock signal is used as trigger output (tim_trgo). (value: 8)
     */
    ...
    constexpr std::uint32_t TIM1_CR2_MMS_B_0x7 = 7;
        /** @brief Encoder Clock output - The encoder clock signal is used as trigger output (tim_trgo). */
    constexpr std::uint32_t TIM1_CR2_MMS_B_0x8 = 8;
     ...
     *          - B_0x8: Retrigerrable OPM mode 1 - In up-counting mode, the channel is active until a trigger event is detected (on tim_trgi signal). (value: 8)
     *          - B_0x9: Retrigerrable OPM mode 2 - In up-counting mode, the channel is inactive until a trigger event is detected (on tim_trgi signal). (value: 9)
     *          - B_0xA: Reserved, (value: 10)
     *          - B_0xB: Reserved, (value: 11)
     *          - B_0xC: Combined PWM mode 1 - tim_oc1ref has the same behavior as in PWM mode 1. (value: 12)
     *          - B_0xD: Combined PWM mode 2 - tim_oc1ref has the same behavior as in PWM mode 2. (value: 13)
     *          - B_0xE: Asymmetric PWM mode 1 - tim_oc1ref has the same behavior as in PWM mode 1. (value: 14)
     *          - B_0xF: Asymmetric PWM mode 2 - tim_oc1ref has the same behavior as in PWM mode 2. (value: 15)
     */
    ...
    constexpr std::uint32_t TIM1_CCMR1_ALTERNATE1_OC1M_B_0x7 = 7;
        /** @brief Retrigerrable OPM mode 1 - In up-counting mode, the channel is active until a trigger event is detected (on tim_trgi signal). */
    constexpr std::uint32_t TIM1_CCMR1_ALTERNATE1_OC1M_B_0x8 = 8;
        /** @brief Retrigerrable OPM mode 2 - In up-counting mode, the channel is inactive until a trigger event is detected (on tim_trgi signal). */
    constexpr std::uint32_t TIM1_CCMR1_ALTERNATE1_OC1M_B_0x9 = 9;
        /** @brief Reserved, */
    constexpr std::uint32_t TIM1_CCMR1_ALTERNATE1_OC1M_B_0xA = 10;
        /** @brief Reserved, */
    constexpr std::uint32_t TIM1_CCMR1_ALTERNATE1_OC1M_B_0xB = 11;
        /** @brief Combined PWM mode 1 - tim_oc1ref has the same behavior as in PWM mode 1. */
    constexpr std::uint32_t TIM1_CCMR1_ALTERNATE1_OC1M_B_0xC = 12;
        /** @brief Combined PWM mode 2 - tim_oc1ref has the same behavior as in PWM mode 2. */
    constexpr std::uint32_t TIM1_CCMR1_ALTERNATE1_OC1M_B_0xD = 13;
        /** @brief Asymmetric PWM mode 1 - tim_oc1ref has the same behavior as in PWM mode 1. */
    constexpr std::uint32_t TIM1_CCMR1_ALTERNATE1_OC1M_B_0xE = 14;
        /** @brief Asymmetric PWM mode 2 - tim_oc1ref has the same behavior as in PWM mode 2. */
    constexpr std::uint32_t TIM1_CCMR1_ALTERNATE1_OC1M_B_0xF = 15;
     ...
     *          - B_0x8: Retrigerrable OPM mode 1 - In up-counting mode, the channel is active until a trigger event is detected (on tim_trgi signal). (value: 8)
     *          - B_0x9: Retrigerrable OPM mode 2 - In up-counting mode, the channel is inactive until a trigger event is detected (on tim_trgi signal). (value: 9)
     *          - B_0xA: Pulse on compare: a pulse is generated on tim_oc3ref upon CCR3 match event, as per PWPRSC[2:0] and PW[7:0] bit fields programming in TIMxECR. (value: 10)
     *          - B_0xB: Direction output. (value: 11)
     *          - B_0xC: Combined PWM mode 1 - tim_oc3ref has the same behavior as in PWM mode 1. (value: 12)
     *          - B_0xD: Combined PWM mode 2 - tim_oc3ref has the same behavior as in PWM mode 2. (value: 13)
     *          - B_0xE: Asymmetric PWM mode 1 - tim_oc3ref has the same behavior as in PWM mode 1. (value: 14)
     *          - B_0xF: Asymmetric PWM mode 2 - tim_oc3ref has the same behavior as in PWM mode 2. (value: 15)
     */
    ...
    constexpr std::uint32_t TIM1_CCMR2_ALTERNATE1_OC3M_B_0x7 = 7;
        /** @brief Retrigerrable OPM mode 1 - In up-counting mode, the channel is active until a trigger event is detected (on tim_trgi signal). */
    constexpr std::uint32_t TIM1_CCMR2_ALTERNATE1_OC3M_B_0x8 = 8;
        /** @brief Retrigerrable OPM mode 2 - In up-counting mode, the channel is inactive until a trigger event is detected (on tim_trgi signal). */
    constexpr std::uint32_t TIM1_CCMR2_ALTERNATE1_OC3M_B_0x9 = 9;
        /** @brief Pulse on compare: a pulse is generated on tim_oc3ref upon CCR3 match event, as per PWPRSC[2:0] and PW[7:0] bit fields programming in TIMxECR. */
    constexpr std::uint32_t TIM1_CCMR2_ALTERNATE1_OC3M_B_0xA = 10;
        /** @brief Direction output. */
    constexpr std::uint32_t TIM1_CCMR2_ALTERNATE1_OC3M_B_0xB = 11;
        /** @brief Combined PWM mode 1 - tim_oc3ref has the same behavior as in PWM mode 1. */
    constexpr std::uint32_t TIM1_CCMR2_ALTERNATE1_OC3M_B_0xC = 12;
        /** @brief Combined PWM mode 2 - tim_oc3ref has the same behavior as in PWM mode 2. */
    constexpr std::uint32_t TIM1_CCMR2_ALTERNATE1_OC3M_B_0xD = 13;
        /** @brief Asymmetric PWM mode 1 - tim_oc3ref has the same behavior as in PWM mode 1. */
    constexpr std::uint32_t TIM1_CCMR2_ALTERNATE1_OC3M_B_0xE = 14;
        /** @brief Asymmetric PWM mode 2 - tim_oc3ref has the same behavior as in PWM mode 2. */
    constexpr std::uint32_t TIM1_CCMR2_ALTERNATE1_OC3M_B_0xF = 15;
    ...
    constexpr std::uint32_t TIM1_ECR_IDIR_B_0x2 = 2;
        /** @brief Reserved */
    constexpr std::uint32_t TIM1_ECR_IDIR_B_0x3 = 3;
    ...
    constexpr std::uint32_t TIM1_ECR_IBLK_B_0x2 = 2;
        /** @brief Reserved */
    constexpr std::uint32_t TIM1_ECR_IBLK_B_0x3 = 3;
     ...
     */
        /** @brief Reserved */
    constexpr std::uint32_t TIM1_DCR_DBSS_B_0x0 = 0;
        /** @brief Update */
