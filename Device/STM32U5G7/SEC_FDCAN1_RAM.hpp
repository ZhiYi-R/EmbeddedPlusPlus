...
#ifndef EMBEDDED_PP_STM32U5G7_SEC_FDCAN1_RAM_HPP
#define EMBEDDED_PP_STM32U5G7_SEC_FDCAN1_RAM_HPP
...
/** @brief FDCAN1_RAM */
namespace STM32U5G7::SEC_FDCAN1_RAM {
    ...
    /** @brief FDCAN Data Bit Timing and Prescaler */
    ...
    /** @brief Data time segment after sample */
    ...
    /** @brief Edge Filtering during Bus */
    ...
    /** @brief FDCAN Timestamp Counter Value */
    ...
    /** @brief FDCAN Timeout Counter Configuration */
    ...
    /** @brief FDCAN Timeout Counter Value */
    ...
    /** @brief FDCAN Interrupt Line Select */
    ...
    /** @brief FDCAN Interrupt Line Enable */
    ...
    /** @brief Accept Non-matching Frames */
    ...
    /** @brief FDCAN Extended ID and Mask */
    ...
    /** @brief FDCAN High Priority Message Status */
    ...
    /** @brief CAN Rx FIFO 0 Acknowledge */
    ...
    /** @brief FDCAN Rx FIFO 1 Acknowledge */
    ...
    /** @brief FDCAN Tx FIFO/Queue Status */
    ...
    /** @brief FDCAN Tx Buffer Request Pending */
    ...
    /** @brief FDCAN Tx Buffer Add Request */
    ...
    /** @brief FDCAN Tx Buffer Cancellation Request */
    ...
    /** @brief FDCAN Tx Buffer Transmission Occurred */
    ...
    /** @brief FDCAN Tx Buffer Cancellation Finished */
