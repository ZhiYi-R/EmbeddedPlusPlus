...
#ifndef EMBEDDED_PP_STM32U5G7_SEC_ICACHE_HPP
#define EMBEDDED_PP_STM32U5G7_SEC_ICACHE_HPP
...
/** @brief ICache */
namespace STM32U5G7::SEC_ICache {
    ...
    /** @brief ICACHE region configuration */
