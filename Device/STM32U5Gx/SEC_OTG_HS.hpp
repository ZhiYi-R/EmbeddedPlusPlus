...
#ifndef EMBEDDED_PP_STM32U5GX_SEC_OTG_HS_HPP
#define EMBEDDED_PP_STM32U5GX_SEC_OTG_HS_HPP
...
/** @brief OTG_HS */
namespace STM32U5Gx::SEC_OTG_HS {
    ...
    /** @brief Hub address 			This field holds the device address of the transaction translatorâs hub. */
