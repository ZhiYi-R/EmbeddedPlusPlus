...
#ifndef EMBEDDED_PP_STM32U5GX_SEC_PWR_HPP
#define EMBEDDED_PP_STM32U5GX_SEC_PWR_HPP
...
namespace STM32U5Gx::SEC_PWR {
    ...
    /** @brief Low-power mode selection These bits select the low-power mode entered when the CPU enters the Deepsleep mode. 10x: Standby mode (Standby mode also entered if LPMS = 11X in PWR_CR1 with BREN = 1 in PWR_BDCR1) 11x: Shutdown mode if BREN = 0 in PWR_BDCR1 */
    ...
    /** @brief SRAM2 page 1 retention in Stop 3 and Standby modes This bit is used to keep the SRAM2 page 1 content in Stop 3 and Standby modes. The SRAM2 page 1 corresponds to the first 8 Kbytes of the SRAM2 (from SRAM2 base address to SRAM2 base address + 0x1FFF). Note: This bit has no effect in Shutdown mode. */
    ...
    /** @brief SRAM2 page 2 retention in Stop 3 and Standby modes This bit is used to keep the SRAM2 page 2 content in Stop 3 and Standby modes. The SRAM2 page 2 corresponds to the last 56 Kbytes of the SRAM2 (from SRAM2 base address + 0x2000 to SRAM2 base address + 0xFFFF). Note: This bit has no effect in Shutdown mode. */
    ...
    /** @brief BOR ultra-low power mode This bit is used to reduce the consumption by configuring the BOR in discontinuous mode. This bit must be set to reach the lowest power consumption in the low-power modes. */
    ...
    /** @brief SRAM1 power down This bit is used to reduce the consumption by powering off the SRAM1. */
    ...
    /** @brief SRAM2 power down This bit is used to reduce the consumption by powering off the SRAM2. */
    ...
    /** @brief SRAM3 power down This bit is used to reduce the consumption by powering off the SRAM3. */
    ...
    /** @brief SRAM4 power down This bit is used to reduce the consumption by powering off the SRAM4. */
    ...
    /** @brief SRAM5 power down This bit is used to reduce the consumption by powering off the SRAM5. Note: This bit is only available in STM32U59x/5Ax. It is reserved in STM32U575/585. */
    ...
    /** @brief SRAM2 page 1 (8 Kbytes) power-down in Stop modes (Stop 0, 1, 2) Note: The SRAM2 page 1 retention in Stop 3 is controlled by RRSB1 bit in PWR_CR1. */
    ...
    /** @brief SRAM2 page 2 (56 Kbytes) power-down in Stop modes (Stop 0, 1, 2) Note: The SRAM2 page 2 retention in Stop 3 is controlled by RRSB2 bit in PWR_CR1. */
    ...
    /** @brief DCACHE2 SRAM power-down in Stop modes (Stop 0, 1, 2, 3) Note: This bit is only available in STM32U59x/5Ax. It is reserved in STM32U575/585. */
    ...
    /** @brief FMAC, FDCAN and USB peripherals SRAM power-down in Stop modes (Stop 0, 1, 2, 3) */
    ...
    /** @brief SRAM4 fast wakeup from Stop 0, Stop 1 and Stop 2 modes This bit is used to obtain the best trade-off between low-power consumption and wakeup time. SRAM4 wakeup time increases the wakeup time when exiting Stop 0, 1 and 2 modes, and also increases the LPDMA access time to SRAM4 during Stop modes. */
    ...
    /** @brief Graphic peripherals (LTDC, GFXMMU) SRAM power-down in Stop modes (Stop 0, 1, 2, 3) Note: LTDC SRAM content is always lost in Stop 2 and Stop 3 modes. It can be retained only in Stop 0 and Stop 1 modes. This bit is only available in STM32U59x/5Ax. It is reserved in STM32U575/585. */
    ...
    /** @brief DSI SRAM power-down in Stop modes (Stop 0, 1) DSI SRAM content is always lost in Stop 2 and Stop 3 modes. Note: This bit is only available in STM32U59x/5Ax. It is reserved in STM32U575/585. */
    ...
    /** @brief Regulator selection Note: REGSEL is reserved and must be kept at reset value in packages without SMPS. */
    ...
    /** @brief USB EPOD booster ready This bit is set to 1 by hardware when the power booster startup time is reached. The USB clock can be provided only after this bit is set. Note: This bit is only available in STM32U59x/5Ax. It is reserved in STM32U575/585. */
    ...
    /** @brief EPOD booster ready This bit is set to 1 by hardware when the power booster startup time is reached. The system clock frequency can be switched higher than 50 MHz only after this bit is set. */
     ...
     *          - B_0x1: Ready, voltage level ≥ VOS selected level (value: 1)
     */
        /** @brief Not ready, voltage level < VOS selected level */
    constexpr std::uint32_t PWR_VOSR_VOSRDY_B_0x0 = 0;
        /** @brief Ready, voltage level ≥ VOS selected level */
    constexpr std::uint32_t PWR_VOSR_VOSRDY_B_0x1 = 1;

    /** @brief Voltage scaling range selection This field is protected against non-secure access when SYSCLKSEC = 1 in RCC_SECCFGR. It is protected against unprivileged access when SYSCLKSEC = 1 in RCC_SECCFGR and SPRIV = 1 in PWR_PRIVCFGR, or when SYSCLKSEC = 0 and NSPRIV = 1. */
    ...
    /** @brief Power voltage detector level selection These bits select the voltage threshold detected by the power voltage detector: */
    ...
    /** @brief VDDA independent analog supply voltage monitor 1 enable (1.6 V threshold) */
    ...
    /** @brief VDDA independent analog supply voltage monitor 2 enable (1.8 V threshold) */
    ...
    /** @brief VDDUSB independent USB supply valid This bit is used to validate the VDDUSB supply for electrical and logical isolation purpose. Setting this bit is mandatory to use the USB OTG peripheral. If VDDUSB is not always present in the application, the VDDUSB voltage monitor can be used to determine whether this supply is ready or not. */
    ...
    /** @brief VDDIO2 independent I/Os supply valid This bit is used to validate the VDDIO2 supply for electrical and logical isolation purpose. Setting this bit is mandatory to use PG[15:2]. If VDDIO2 is not always present in the application, the VDDIO2 voltage monitor can be used to determine whether this supply is ready or not. */
    ...
    /** @brief VDDA independent analog supply valid This bit is used to validate the VDDA supply for electrical and logical isolation purpose. Setting this bit is mandatory to use the analog peripherals. If VDDA is not always present in the application, the VDDA voltage monitor can be used to determine whether this supply is ready or not. */
    ...
    /** @brief Wakeup pin WKUP1 polarity. This bit must be configured when WUPEN1 = 0. */
    ...
    /** @brief Wakeup pin WKUP2 polarity This bit must be configured when WUPEN2 = 0. */
    ...
    /** @brief Wakeup pin WKUP3 polarity This bit must be configured when WUPEN3 = 0. */
    ...
    /** @brief Wakeup pin WKUP4 polarity This bit must be configured when WUPEN4 = 0. */
    ...
    /** @brief Wakeup pin WKUP5 polarity This bit must be configured when WUPEN5 = 0. */
    ...
    /** @brief Wakeup pin WKUP6 polarity This bit must be configured when WUPEN6 = 0. */
    ...
    /** @brief Wakeup pin WKUP7 polarity This bit must be configured when WUPEN7 = 0. */
    ...
    /** @brief Wakeup pin WKUP8 polarity This bit must be configured when WUPEN8 = 0. */
    ...
    /** @brief Wakeup pin WKUP1 selection This field must be configured when WUPEN1 = 0. */
    ...
    /** @brief Wakeup pin WKUP2 selection This field must be configured when WUPEN2 = 0. */
    ...
    /** @brief Wakeup pin WKUP3 selection This field must be configured when WUPEN3 = 0. */
    ...
    /** @brief Wakeup pin WKUP4 selection This field must be configured when WUPEN4 = 0. */
    ...
    /** @brief Wakeup pin WKUP5 selection This field must be configured when WUPEN5 = 0. */
    ...
    /** @brief Wakeup pin WKUP6 selection This field must be configured when WUPEN6 = 0. */
    ...
    /** @brief Wakeup pin WKUP7 selection This field must be configured when WUPEN7 = 0. */
    ...
    /** @brief Wakeup pin WKUP8 selection This field must be configured when WUPEN8 = 0. */
    ...
    /** @details Possible values:
     *          - B_0x0: Charge VBAT through a 5 kΩ resistor (value: 0)
     *          - B_0x1: Charge VBAT through a 1.5 kΩ resistor (value: 1)
     */
        /** @brief Charge VBAT through a 5 kΩ resistor */
    constexpr std::uint32_t PWR_BDCR2_VBRS_B_0x0 = 0;
        /** @brief Charge VBAT through a 1.5 kΩ resistor */
    ...
    /** @brief Clear Stop and Standby flags This bit is protected against non-secure access when LPMSEC = 1 in PWR_SECCFGR. This bit is protected against unprivileged access when LPMSEC = 1 and SPRIV = 1 in PWR_PRIVCFGR, or when LPMSEC = 0 and NSPRIV = 1. Writing 1 to this bit clears the STOPF and SBF flags. */
    using PWR_SR_CSSF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Stop flag This bit is set by hardware when the device enters a Stop mode, and is cleared by software by writing 1 to the CSSF bit. */
    ...
    /** @brief Standby flag This bit is set by hardware when the device enters the Standby mode, and is cleared by writing 1 to the CSSF bit, or by a power-on reset. It is not cleared by the system reset. */
    ...
    /** @brief VOS currently applied to VCORE This field provides the last VOS value. */
    ...
    /** @brief VDDA ready versus 1.8 V voltage monitor */
    ...
    /** @details Possible values:
     *          - B_0x0: Backup domain voltage level < high threshold (value: 0)
     *          - B_0x1: Backup domain voltage level ≥ high threshold (value: 1)
     */
        /** @brief Backup domain voltage level < high threshold */
     ...
     *          - B_0x1: Temperature ≤ low threshold (value: 1)
     */
    ...
    /** @details Possible values:
     *          - B_0x0: Temperature < high threshold (value: 0)
     *          - B_0x1: Temperature ≥ high threshold (value: 1)
     */
        /** @brief Temperature < high threshold */
    ...
    /** @brief Wakeup flag 1 This bit is set when a wakeup event is detected on WKUP1 pin. This bit is cleared by writing 1 in the CWUF1 bit of PWR_WUSCR when WUSEL ≠ 11, or by hardware when WUPEN1 = 0. */
    using PWR_WUSR_WUF1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Wakeup flag 2 This bit is set when a wakeup event is detected on WKUP2 pin. This bit is cleared by writing 1 in the CWUF2 bit of PWR_WUSCR when WUSEL ≠ 11, or by hardware when WUPEN2 = 0. */
    using PWR_WUSR_WUF2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Wakeup flag 3 This bit is set when a wakeup event is detected on WKUP3 pin. This bit is cleared by writing 1 in the CWUF3 bit of PWR_WUSCR when WUSEL ≠ 11, or by hardware when WUPEN3 = 0. */
    using PWR_WUSR_WUF3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Wakeup flag 4 This bit is set when a wakeup event is detected on WKUP4 pin. This bit is cleared by writing 1 in the CWUF4 bit of PWR_WUSCR when WUSEL ≠ 11, or by hardware when WUPEN4 = 0. */
    using PWR_WUSR_WUF4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Wakeup flag 5 This bit is set when a wakeup event is detected on WKUP5 pin. This bit is cleared by writing 1 in the CWUF5 bit of PWR_WUSCR when WUSEL ≠ 11, or by hardware when WUPEN5 = 0. */
    using PWR_WUSR_WUF5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Wakeup flag 6 This bit is set when a wakeup event is detected on WKUP6 pin. This bit is cleared by writing 1 in the CWUF6 bit of PWR_WUSCR when WUSEL ≠ 11, or by hardware when WUPEN6 = 0. If WUSEL = 11, this bit is cleared by hardware when all internal wakeup source are cleared. */
    using PWR_WUSR_WUF6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Wakeup flag 7 This bit is set when a wakeup event is detected on WKUP7 pin. This bit is cleared by writing 1 in the CWUF7 bit of PWR_WUSCR when WUSEL ≠ 11, or by hardware when WUPEN7 = 0. If WUSEL = 11, this bit is cleared by hardware when all internal wakeup source are cleared. */
    using PWR_WUSR_WUF7 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Wakeup flag 8 This bit is set when a wakeup event is detected on WKUP8 pin. This bit is cleared by writing 1 in the CWUF8 bit of PWR_WUSCR when WUSEL ≠ 11, or by hardware when WUPEN8 = 0. If WUSEL = 11, this bit is cleared by hardware when all internal wakeup source are cleared. */
    ...
    /** @brief Apply pull-up and pull-down configuration When this bit is set, the I/O pull-up and pull-down configurations defined in PWR_PUCRx and PWR_PDCRx are applied. When this bit is cleared, PWR_PUCRx and PWR_PDCRx are not applied to the I/Os. */
    ...
    /** @brief Port A pull-up bit 15 When set, this bit activates the pull-up on PA15 when the APC bit is set in PWR_APCR. The pull-up is not activated if the corresponding PD15 bit is also set. */
    ...
    /** @brief Port A pull-down bit 14 When set, this bit activates the pull-down on PA14 when the APC bit is set in PWR_APCR. */
