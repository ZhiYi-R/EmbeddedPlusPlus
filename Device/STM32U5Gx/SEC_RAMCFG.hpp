...
#ifndef EMBEDDED_PP_STM32U5GX_SEC_RAMCFG_HPP
#define EMBEDDED_PP_STM32U5GX_SEC_RAMCFG_HPP
...
/** @brief RAMCFG */
namespace STM32U5Gx::SEC_RAMCFG {
    ...
    /** @brief ECC double error detected Note: This bit is reserved and must be kept at reset value in SRAM1, SRAM4 and SRAM5 interrupt status registers. */
    ...
    /** @brief SRAM busy with erase operation Note: Depending on the SRAM, the erase operation can be performed due to software request, system reset if the option bit is enabled, tamper detection or readout protection regression. Refer to . */
