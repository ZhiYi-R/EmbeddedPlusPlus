...
#ifndef EMBEDDED_PP_STM32U5XX_SEC_ADC2_HPP
#define EMBEDDED_PP_STM32U5XX_SEC_ADC2_HPP
...
namespace STM32U5xx::SEC_ADC2 {
    ...
    /** @brief CHN0SEL */
    using ADC_OR_CHN0SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
