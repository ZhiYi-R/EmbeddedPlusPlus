...
#ifndef EMBEDDED_PP_STM32U5XX_SEC_TAMP_HPP
#define EMBEDDED_PP_STM32U5XX_SEC_TAMP_HPP
...
namespace STM32U5xx::SEC_TAMP {
    ...
    /** @brief ITAMP7NOER */
    using CR3_ITAMP7NOER = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ITAMP8NOER */
    ...
    /** @brief TAMP option registe */
    using OR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x50, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief VCOREMEN */
    using OR_VCOREMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
