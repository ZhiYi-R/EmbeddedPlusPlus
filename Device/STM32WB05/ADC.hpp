...
#ifndef EMBEDDED_PP_STM32WB05_ADC_HPP
#define EMBEDDED_PP_STM32WB05_ADC_HPP
...
namespace STM32WB05::ADC {
    ...
    /** @brief TIMER_CONF register */
    using TIMER_CONF = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x54, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ADC_LDO_DELAY[7:0]: define the duration of a waiting time to be inserted between the ADC_LDO enable and the ADC ON to let time to the LDO to stabilize before starting a conversion. The time unit is 4 us. Maximum delay is 1.02 ms (255 x 4 us). Default value is 40 = 160 us. */
    ...
    /** @brief LDO_ADC_ENABLE: 0: disable the ADC LDO 1: enable the ADC LDO */
    using TEST_CONF_LDO_ADC_ENABLE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief FSM_STATE[7:0]: show the state of the state machine. Bit 0: IDLE Bit 1: ADC_LDO setup phase Bit 2: ADC setup phase Bit 3: PGA BIAS setup phase Bit 4: ADC_START_CONV resynchronization Bit 5: Analog Audio mode or Full mode Bit 6: ADC mode or occasional mode Bit 7: sequence mode */
    using DTB_CONF_FSM_STATE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FSM_CUR_STATE[2:0]: show the last executed state by the state machine. 000: IDLE mode 001: ADC_LDO setup phase 010: ADC setup phase 011: PGA BIAS setup phase 100: ADC_START_CONV resynchronization 101: Analog Audio mode or Full mode 110: ADC mode or occasional mode 111: sequence mode */
