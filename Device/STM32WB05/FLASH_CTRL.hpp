...
#ifndef EMBEDDED_PP_STM32WB05_FLASH_CTRL_HPP
#define EMBEDDED_PP_STM32WB05_FLASH_CTRL_HPP
...
namespace STM32WB05::FLASH_CTRL {

    /** @brief COMMAND register */
    using COMMAND = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Macro commands for flash operations (may require DATA0...DATA3 to be set): - 0x11 : ERASE - 0x22 : MASSERASE - 0x33 : WRITE - 0x44 : MASSWRITE - 0x55 : MASSREAD - 0x66 : IFRERASE - 0x77 : IFRWRITE - 0x88 : IFRMASSWRITE - 0x99 : IFRMASSREAD - 0xAA : SLEEP - 0xBB : WAKEUP - 0xCC : BURSTWRITE - 0xDD : IFRBURSTWRITE - 0xEE : OTPWRITE - 0xFF : KEYWRITE */
    ...
    /** @brief Additional wait-state for flash read access: - 0 : no latency added - 1 : 1 clock cycle latency added */
    using CONFIG_LONGACCESS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief CPU access routing (it can only be set; reset only allowed by POR/PAD reset) - 0 : IFR memory addressed - 1 : MAIN flash memory addressed */
    using CONFIG_PREMAP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Maximum valid address for flash memory: - 00 : 0x03FFF (64kb) - 01 : 0x07FFF (128kb) - 10 : 0x09FFF (160kb) - 11 : 0x0BFFF (192kb) */
    ...
    /** @brief UNLOCKM register */
    using UNLOCKM = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief User flash memory protection 64-bit key MSW */
    using UNLOCKM_UNLOCKM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief UNLOCKL register */
    using UNLOCKL = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x20, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief User flash memory protection 64-bit key LSW */
    using UNLOCKL_UNLOCKL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief TIMETRIM1 register */
    using TIMETRIM1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x28, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Erase time (ms) */
    using TIMETRIM1_T_ERASE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Mass erase time (ms) */
    using TIMETRIM1_T_ME = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief NVSTR hold time (us) */
    using TIMETRIM1_T_NVH = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Recovery time (us) */
    using TIMETRIM1_T_RCV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIMETRIM2 register */
    using TIMETRIM2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x2C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief NVSTR setup time (us) */
    using TIMETRIM2_T_NVS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief NVSTR hold time for mass erase (us) */
    using TIMETRIM2_T_NVH1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Program time (us) */
    using TIMETRIM2_T_PROG = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief NVSTR to program set-up time (us) */
    using TIMETRIM2_T_PGS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIMETRIM3 register */
    using TIMETRIM3 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x30, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Wake-up time from sleep/power-down to standby (us) */
    using TIMETRIM3_T_WK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
