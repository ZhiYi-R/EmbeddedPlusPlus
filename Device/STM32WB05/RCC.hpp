...
#ifndef EMBEDDED_PP_STM32WB05_RCC_HPP
#define EMBEDDED_PP_STM32WB05_RCC_HPP
...
namespace STM32WB05::RCC {
    ...
    /** @brief Force MR_BLE active transmission status (for debug purpose) */
     ...
     *          - B_0x1: active_transmission is force to '1' whatever the HSIPLLRDY status (value: 1)
     */
        /** @brief no effect */
    constexpr std::uint32_t CR_FMRAT_B_0x0 = 0;
        /** @brief active_transmission is force to '1' whatever the HSIPLLRDY status */
    constexpr std::uint32_t CR_FMRAT_B_0x1 = 1;
    ...
    /** @brief Low Speed oscillator trimming enable Set and reset by software. Reset source only for this field: PORESETn */
    using ICSCR_LSITRIMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: LSI oscillator Bias trimming disabled (value: 0)
     *          - B_0x1: LSI oscillator Bias trimming enabled (value: 1)
     */
        /** @brief LSI oscillator Bias trimming disabled */
    constexpr std::uint32_t ICSCR_LSITRIMEN_B_0x0 = 0;
        /** @brief LSI oscillator Bias trimming enabled */
    constexpr std::uint32_t ICSCR_LSITRIMEN_B_0x1 = 1;

    /** @brief LSITRIMOK: Low Speed oscillator trimming OK Set and reset by hardware to indicate when the Low Speed Internal RC oscillator has reached an optimal trimming of its bias current; this bit is only valid when LSITRIMEN is active. */
    using ICSCR_LSITRIMOK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: LSI Bias trimming (LSIBW) is not good (value: 0)
     *          - B_0x1: LSI Bias trimming (LSIBW) value is OK (value: 1)
     */
        /** @brief LSI Bias trimming (LSIBW) is not good */
    constexpr std::uint32_t ICSCR_LSITRIMOK_B_0x0 = 0;
        /** @brief LSI Bias trimming (LSIBW) value is OK */
    constexpr std::uint32_t ICSCR_LSITRIMOK_B_0x1 = 1;
    ...
    /** @brief ICSCR[18:16] = HSITRIMOFFSET[2:0]: High Speed oscillator signed trimming offset */
    using ICSCR_HSITRIMOFFSET = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: 0 (+ 0 MHz / default) (value: 0)
     *          - B_0x1: 1 (+0.5 MHz) (value: 1)
     *          - B_0x2: 2 (+1MHz) (value: 2)
     *          - B_0x3: 3 (+1.5 MHz) (value: 3)
     *          - B_0x4: -1 (-0.5 MHz) (value: 4)
     *          - B_0x5: -2 (-1MHz) (value: 5)
     *          - B_0x6: -3 (-1.5 MHz) (value: 6)
     *          - B_0x7: -4 (-2 MHz) (value: 7)
     */
        /** @brief 0 (+ 0 MHz / default) */
    constexpr std::uint32_t ICSCR_HSITRIMOFFSET_B_0x0 = 0;
        /** @brief 1 (+0.5 MHz) */
    constexpr std::uint32_t ICSCR_HSITRIMOFFSET_B_0x1 = 1;
        /** @brief 2 (+1MHz) */
    constexpr std::uint32_t ICSCR_HSITRIMOFFSET_B_0x2 = 2;
        /** @brief 3 (+1.5 MHz) */
    constexpr std::uint32_t ICSCR_HSITRIMOFFSET_B_0x3 = 3;
        /** @brief -1 (-0.5 MHz) */
    constexpr std::uint32_t ICSCR_HSITRIMOFFSET_B_0x4 = 4;
        /** @brief -2 (-1MHz) */
    constexpr std::uint32_t ICSCR_HSITRIMOFFSET_B_0x5 = 5;
        /** @brief -3 (-1.5 MHz) */
    constexpr std::uint32_t ICSCR_HSITRIMOFFSET_B_0x6 = 6;
        /** @brief -4 (-2 MHz) */
    constexpr std::uint32_t ICSCR_HSITRIMOFFSET_B_0x7 = 7;
    ...
    /** @brief Clock source selection Status */
    ...
    /** @brief Selection of LPUART clock: */
     ...
     *          - B_0x1: LSE clock (value: 1)
     */
        /** @brief 16MHz peripheral clock (default) */
    constexpr std::uint32_t CFGR_LPUCLKSEL_B_0x0 = 0;
        /** @brief LSE clock */
    constexpr std::uint32_t CFGR_LPUCLKSEL_B_0x1 = 1;
    ...
    /** @brief IO BOOSTER clock enable as external clock Set and reset by software. */
    using CFGR_IOBOOSTCLKEXTEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: does not use rcc clock (default) (value: 0)
     *          - B_0x1: uses rcc clock (value: 1)
     */
        /** @brief does not use rcc clock (default) */
    constexpr std::uint32_t CFGR_IOBOOSTCLKEXTEN_B_0x0 = 0;
        /** @brief uses rcc clock */
    constexpr std::uint32_t CFGR_IOBOOSTCLKEXTEN_B_0x1 = 1;

    /** @brief LCO output enable */
    ...
    /** @brief Low Speed oscillator trimming by SW enable Set and reset by software. Reset source only for this field: PORESETn */
    using CSSWCR_LSISWTRIMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: LSI oscillator Bias trimming by SW disabled (value: 0)
     *          - B_0x1: LSI oscillator Bias trimming by SW enabled (value: 1)
     */
        /** @brief LSI oscillator Bias trimming by SW disabled */
    constexpr std::uint32_t CSSWCR_LSISWTRIMEN_B_0x0 = 0;
        /** @brief LSI oscillator Bias trimming by SW enabled */
    constexpr std::uint32_t CSSWCR_LSISWTRIMEN_B_0x1 = 1;
    ...
    /** @brief Maximum Crystal gm for Low Speed External XO (to connect to XTDRV of 32kHz LSE XO => into IO V33?) to amplify drinving capacity modulation Set by software. Reset source only for this field: PORESETn */
    using CSSWCR_LSEDRV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: 0.0, low drive capability (value: 0)
     *          - B_0x1: 0.1, medium low drive capability (value: 1)
     *          - B_0x2: 1.0, medium high drive capability (value: 2)
     *          - B_0x3: 1.1, highdrive capability (value: 3)
     */
        /** @brief 0.0, low drive capability */
    constexpr std::uint32_t CSSWCR_LSEDRV_B_0x0 = 0;
        /** @brief 0.1, medium low drive capability */
    constexpr std::uint32_t CSSWCR_LSEDRV_B_0x1 = 1;
        /** @brief 1.0, medium high drive capability */
    constexpr std::uint32_t CSSWCR_LSEDRV_B_0x2 = 2;
        /** @brief 1.1, highdrive capability */
    constexpr std::uint32_t CSSWCR_LSEDRV_B_0x3 = 3;

    /** @brief High Speed oscillator trimming by SW enable Set and reset by software. */
    using CSSWCR_HSISWTRIMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: HSI oscillator Bias trimming by SW disabled (value: 0)
     *          - B_0x1: HSI oscillator Bias trimming by SW enabled (value: 1)
     */
        /** @brief HSI oscillator Bias trimming by SW disabled */
    constexpr std::uint32_t CSSWCR_HSISWTRIMEN_B_0x0 = 0;
        /** @brief HSI oscillator Bias trimming by SW enabled */
    constexpr std::uint32_t CSSWCR_HSISWTRIMEN_B_0x1 = 1;
    ...
    /** @brief LPURSTIE: LPUART reset release interrupt enable. */
    using CIER_LPURSTIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: LPUART reset release interrupt is disabled (value: 0)
     *          - B_0x1: LPUART reset release interrupt is enabled (value: 1)
     */
        /** @brief LPUART reset release interrupt is disabled */
    constexpr std::uint32_t CIER_LPURSTIE_B_0x0 = 0;
        /** @brief LPUART reset release interrupt is enabled */
    constexpr std::uint32_t CIER_LPURSTIE_B_0x1 = 1;
    ...
    /** @brief LPUART reset release flag */
    using CIFR_LPURSTF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: no LPUART reset release event occurred (value: 0)
     *          - B_0x1: LPUART reset release event occurred (value: 1)
     */
        /** @brief no LPUART reset release event occurred */
    constexpr std::uint32_t CIFR_LPURSTF_B_0x0 = 0;
        /** @brief LPUART reset release event occurred */
    constexpr std::uint32_t CIFR_LPURSTF_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: TIM16 IP is not under reset (value: 0)
     *          - B_0x1: TIM16 IP is under reset (value: 1)
     */
        /** @brief TIM16 IP is not under reset */
    constexpr std::uint32_t APB0RSTR_TIM16RST_B_0x0 = 0;
        /** @brief TIM16 IP is under reset */
    constexpr std::uint32_t APB0RSTR_TIM16RST_B_0x1 = 1;

    /** @brief TIM17 reset */
    using APB0RSTR_TIM17RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: TIM17 IP is not under reset (value: 0)
     *          - B_0x1: TIM17 IP is under reset (value: 1)
     */
        /** @brief TIM17 IP is not under reset */
    constexpr std::uint32_t APB0RSTR_TIM17RST_B_0x0 = 0;
        /** @brief TIM17 IP is under reset */
    constexpr std::uint32_t APB0RSTR_TIM17RST_B_0x1 = 1;
    ...
    using APB0RSTR_WDRST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: does not reset (value: 0)
     *          - B_0x1: resets (value: 1)
     */
        /** @brief does not reset */
    constexpr std::uint32_t APB0RSTR_WDRST_B_0x0 = 0;
        /** @brief resets */
    constexpr std::uint32_t APB0RSTR_WDRST_B_0x1 = 1;
    ...
    /** @brief AUXADC reset for Aux-ADC digital clock Set and reset by software. */
    using APB1RSTR_AUXADCRST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: does not reset (value: 0)
     *          - B_0x1: resets (value: 1)
     */
        /** @brief does not reset */
    constexpr std::uint32_t APB1RSTR_AUXADCRST_B_0x0 = 0;
        /** @brief resets */
    constexpr std::uint32_t APB1RSTR_AUXADCRST_B_0x1 = 1;
    ...
    using APB1RSTR_I2C21RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: does not reset (value: 0)
     *          - B_0x1: resets (value: 1)
     */
        /** @brief does not reset */
    constexpr std::uint32_t APB1RSTR_I2C21RST_B_0x0 = 0;
        /** @brief resets */
    constexpr std::uint32_t APB1RSTR_I2C21RST_B_0x1 = 1;
    ...
    /** @brief BLE reset. */
    using APB2RSTR_BLERST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief TIM2: Advanced Timer clock enable Set and enable by software. */
     ...
     */
        /** @brief does not enable */
    constexpr std::uint32_t APB0ENR_TIM2EN_B_0x0 = 0;
        /** @brief enable */
    constexpr std::uint32_t APB0ENR_TIM2EN_B_0x1 = 1;

    /** @brief TIM16 enable */
    using APB0ENR_TIM16EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: TIM16 IP is clock gated (value: 0)
     *          - B_0x1: TIM16 IP is clocked (value: 1)
     */
        /** @brief TIM16 IP is clock gated */
    constexpr std::uint32_t APB0ENR_TIM16EN_B_0x0 = 0;
        /** @brief TIM16 IP is clocked */
    constexpr std::uint32_t APB0ENR_TIM16EN_B_0x1 = 1;

    /** @brief TIM17 enable */
    using APB0ENR_TIM17EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: TIM17 IP is clock gated (value: 0)
     *          - B_0x1: TIM17 IP is clocked (value: 1)
     */
        /** @brief TIM17 IP is clock gated */
    constexpr std::uint32_t APB0ENR_TIM17EN_B_0x0 = 0;
        /** @brief TIM17 IP is clocked */
    constexpr std::uint32_t APB0ENR_TIM17EN_B_0x1 = 1;
    ...
    /** @brief AUXADC clock enable for Aux-ADC digital clock Set and enable by software. */
    ...
    /** @brief ADC clock enable for Aux-ADC analog clock Set and enable by software. */
     ...
     */
        /** @brief does not enable */
    constexpr std::uint32_t APB1ENR_ADCANAEN_B_0x0 = 0;
        /** @brief enable */
    constexpr std::uint32_t APB1ENR_ADCANAEN_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: the bias current is confronted to a reference current with a ratio of 1/2. (value: 0)
     *          - B_0x1: the bias current is confronted to a reference current with a ratio of 3/4 (value: 1)
     */
        /** @brief the bias current is confronted to a reference current with a ratio of 1/2. */
