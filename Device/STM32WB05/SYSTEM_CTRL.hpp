...
#ifndef EMBEDDED_PP_STM32WB05_SYSTEM_CTRL_HPP
#define EMBEDDED_PP_STM32WB05_SYSTEM_CTRL_HPP
...
namespace STM32WB05::SYSTEM_CTRL {
    ...
    /** @brief VINP2_ATB0: select the analog feature on PA3 between VINP2 and ATB0 when the PA3 I/O is programmed in analog mode (in the associated GPIO_MODER register): 0: VINP2 feature is selected (default). 1: ATB0 feature is selected */
    using GPIO_SWA_CTRL_VINP2_ATB0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using BLERXTX_ISCR_TX_ISEDGE = ::EmbeddedPP::LowLevel::BitField<std::uint8_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using BLERXTX_ISCR_RX_ISEDGE = ::EmbeddedPP::LowLevel::BitField<std::uint8_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
