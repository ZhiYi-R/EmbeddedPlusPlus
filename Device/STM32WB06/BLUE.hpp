...
#ifndef EMBEDDED_PP_STM32WB06_BLUE_HPP
#define EMBEDDED_PP_STM32WB06_BLUE_HPP
...
/** @brief BLUE peripheral */
namespace STM32WB06::BLUE {
    ...
    using DEBUGCMDREG = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x74, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CLEARDEBUGINT */
    using DEBUGCMDREG_CLEARDEBUGINT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SEQDEBUGMODE */
    using DEBUGCMDREG_SEQDEBUGMODE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SEQDEBUGBUSSEL */
    using DEBUGCMDREG_SEQDEBUGBUSSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief AESDEBUGMODE */
    using DEBUGCMDREG_AESDEBUGMODE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DebugStatus register */
    using DEBUGSTATUSREG = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x78, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DEBUGSTATUSREG */
    using DEBUGSTATUSREG_DEBUGSTATUSREG = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 7, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief AESDBG_0 */
    using DEBUGSTATUSREG_AESDBG_0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief AESDBG_1 */
    using DEBUGSTATUSREG_AESDBG_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief AESDBG_2 */
    using DEBUGSTATUSREG_AESDBG_2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief AESDBG_3 */
    using DEBUGSTATUSREG_AESDBG_3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
