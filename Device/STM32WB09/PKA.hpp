...
#ifndef EMBEDDED_PP_STM32WB09_PKA_HPP
#define EMBEDDED_PP_STM32WB09_PKA_HPP
...
namespace STM32WB09::PKA {
    ...
    /** @brief Fault FSM interrupt enable 0: Interrupt is disabled. 1: An interrupt is generated when FAULTFSMF (PKA_SR[22]) is set. */
    using PKA_CR_FAULTFSMIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Fault error code interrupt enable 0: Interrupt is disabled. 1: An interrupt is generated when FAULTERRORCODEF (PKA_SR[23]) is set. */
    using PKA_CR_FAULTERRORCODEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Fault fsm error flag 0: No fault has been detected 1: A fault on fsm has been detected */
    using PKA_SR_FAULTFSMF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Fault error code error flag 0: No fault has been detected 1: A fault has altered the execution of the operation and the internal fault check has been skipped */
    using PKA_SR_FAULTERRORCODEF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
