...
#ifndef EMBEDDED_PP_STM32WB09_TIM17_HPP
#define EMBEDDED_PP_STM32WB09_TIM17_HPP
...
/** @brief TIM17 peripheral */
namespace STM32WB09::TIM17 {
    ...
    /** @brief TI1_RMP[1:0]: Timer 17 input 1 connection This bit is set and cleared by software. 00: TIM17 TI1 is connected to GPIO 01: TIM17 TI1 is connected to LCO 1x: TIM17 TI1 is connected to MCO */
    ...
    /** @brief AF1[13:12] Not used in Blue51. Not available in IUM */
    using AF1_AF1_8_3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 6, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief AF1[13:12] Not used in Blue51. Not available in IUM */
    using AF1_AF1_13_12 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
