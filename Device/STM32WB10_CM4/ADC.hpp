...
#ifndef EMBEDDED_PP_STM32WB10_CM4_ADC_HPP
#define EMBEDDED_PP_STM32WB10_CM4_ADC_HPP
...
namespace STM32WB10_CM4::ADC {
    ...
    using ADC_TR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x20, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief LT1 */
    using ADC_TR_LT1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief HT1 */
    using ADC_TR_HT1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
