...
#ifndef EMBEDDED_PP_STM32WB10_CM4_FLASH_HPP
#define EMBEDDED_PP_STM32WB10_CM4_FLASH_HPP
...
namespace STM32WB10_CM4::Flash {
    ...
    using SRRVR_SBRV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 17, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
