...
#ifndef EMBEDDED_PP_STM32WB15_CM4_ADC_HPP
#define EMBEDDED_PP_STM32WB15_CM4_ADC_HPP
...
namespace STM32WB15_CM4::ADC {
    ...
    /** @brief CHSEL */
    using CHSELR0_CHSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 19, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief channel selection register */
