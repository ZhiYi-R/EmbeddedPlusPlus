...
#ifndef EMBEDDED_PP_STM32WB15_CM4_COMP_HPP
#define EMBEDDED_PP_STM32WB15_CM4_COMP_HPP
...
namespace STM32WB15_CM4::COMP {
    ...
    using COMP2_CSR_COMP2_INMSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
