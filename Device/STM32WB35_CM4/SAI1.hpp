...
#ifndef EMBEDDED_PP_STM32WB35_CM4_SAI1_HPP
#define EMBEDDED_PP_STM32WB35_CM4_SAI1_HPP
...
namespace STM32WB35_CM4::SAI1 {
    ...
    using BCR1_SAIEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output drive */
    ...
    /** @brief Mute counter */
    using BCR2_MUTECNT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 6, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Mute value */
    ...
    /** @brief Audio block B enable */
    using ACR1_SAIEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output drive */
    ...
    /** @brief Mute counter */
    using ACR2_MUTECNT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 6, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Mute value */
