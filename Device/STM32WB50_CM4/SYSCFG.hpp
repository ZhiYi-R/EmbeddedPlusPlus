...
#ifndef EMBEDDED_PP_STM32WB50_CM4_SYSCFG_HPP
#define EMBEDDED_PP_STM32WB50_CM4_SYSCFG_HPP
...
namespace STM32WB50_CM4::SYSCFG {
    ...
    using SCSR_C2RFD = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CFGR2 */
    ...
    using SWPR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x28, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using IMR1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x100, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral TIM1 interrupt mask to CPU1 */
    using IMR1_TIM1IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral TIM16 interrupt mask to CPU1 */
    using IMR1_TIM16IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral TIM17 interrupt mask to CPU1 */
    using IMR1_TIM17IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral EXIT5 interrupt mask to CPU1 */
    using IMR1_EXIT5IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral EXIT6 interrupt mask to CPU1 */
    using IMR1_EXIT6IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral EXIT7 interrupt mask to CPU1 */
    using IMR1_EXIT7IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral EXIT8 interrupt mask to CPU1 */
    using IMR1_EXIT8IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral EXIT9 interrupt mask to CPU1 */
    using IMR1_EXIT9IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral EXIT10 interrupt mask to CPU1 */
    using IMR1_EXIT10IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 26, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral EXIT11 interrupt mask to CPU1 */
    using IMR1_EXIT11IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 27, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral EXIT12 interrupt mask to CPU1 */
    using IMR1_EXIT12IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral EXIT13 interrupt mask to CPU1 */
    using IMR1_EXIT13IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral EXIT14 interrupt mask to CPU1 */
    using IMR1_EXIT14IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral EXIT15 interrupt mask to CPU1 */
    using IMR1_EXIT15IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CPU1 interrupt mask register 2 */
    using IMR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x104, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using IMR2_PVM1IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using C2IMR1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x108, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral RTCSTAMP interrupt mask to CPU2 */
    using C2IMR1_RTCSTAMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral RTCWKUP interrupt mask to CPU2 */
    using C2IMR1_RTCWKUP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral RTCALARM interrupt mask to CPU2 */
    using C2IMR1_RTCALARM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral RCC interrupt mask to CPU2 */
    using C2IMR1_RCC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral FLASH interrupt mask to CPU2 */
    using C2IMR1_FLASH = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral PKA interrupt mask to CPU2 */
    using C2IMR1_PKA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral RNG interrupt mask to CPU2 */
    using C2IMR1_RNG = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral AES1 interrupt mask to CPU2 */
    using C2IMR1_AES1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral COMP interrupt mask to CPU2 */
    using C2IMR1_COMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral ADC interrupt mask to CPU2 */
    using C2IMR1_ADC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CPU2 interrupt mask register 1 */
    using C2IMR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x10C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral DMA1 CH1 interrupt mask to CPU2 */
    using C2IMR2_DMA1_CH1_IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral DMA1 CH2 interrupt mask to CPU2 */
    using C2IMR2_DMA1_CH2_IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral DMA1 CH3 interrupt mask to CPU2 */
    using C2IMR2_DMA1_CH3_IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral DMA1 CH4 interrupt mask to CPU2 */
    using C2IMR2_DMA1_CH4_IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral DMA1 CH5 interrupt mask to CPU2 */
    using C2IMR2_DMA1_CH5_IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral DMA1 CH6 interrupt mask to CPU2 */
    using C2IMR2_DMA1_CH6_IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral DMA1 CH7 interrupt mask to CPU2 */
    using C2IMR2_DMA1_CH7_IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral DMA2 CH1 interrupt mask to CPU1 */
    using C2IMR2_DMA2_CH1_IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral DMA2 CH2 interrupt mask to CPU1 */
    using C2IMR2_DMA2_CH2_IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral DMA2 CH3 interrupt mask to CPU1 */
    using C2IMR2_DMA2_CH3_IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral DMA2 CH4 interrupt mask to CPU1 */
    using C2IMR2_DMA2_CH4_IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral DMA2 CH5 interrupt mask to CPU1 */
    using C2IMR2_DMA2_CH5_IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral DMA2 CH6 interrupt mask to CPU1 */
    using C2IMR2_DMA2_CH6_IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral DMA2 CH7 interrupt mask to CPU1 */
    using C2IMR2_DMA2_CH7_IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral DMAM UX1 interrupt mask to CPU1 */
    using C2IMR2_DMAM_UX1_IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral PVM1IM interrupt mask to CPU1 */
    using C2IMR2_PVM1IM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using C2IMR2_TSCIM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Peripheral LCDIM interrupt mask to CPU1 */
    using C2IMR2_LCDIM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief secure IP control register */
    using SIPCR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x110, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Enable AES1 KEY[7:0] security. */
    using SIPCR_SAES1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Enable AES2 security. */
    using SIPCR_SAES2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Enable PKA security */
    using SIPCR_SPKA = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Enable True RNG security */
    using SIPCR_SRNG = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
