...
#ifndef EMBEDDED_PP_STM32WB55_CM0P_ADC_HPP
#define EMBEDDED_PP_STM32WB55_CM0P_ADC_HPP
...
namespace STM32WB55_CM0P::ADC {
    ...
    /** @brief ADC oversampling mode managing interlaced conversions of ADC group regular and group injected */
    ...
    /** @brief ADC channel 0 sampling time selection */
    ...
    /** @brief ADC analog watchdog 3 threshold low */
    ...
    /** @brief Regular Data converted 0_6 */
    using DR_RDATA_0_6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 6, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief 15 */
    using DR_RDATA_7_15 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 9, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief ADC channel differential or single-ended mode for channel 0 */
    using DIFSEL_DIFSEL_0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ADC channel differential or single-ended mode for channels 1 to 15 */
    using DIFSEL_DIFSEL_1_15 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 15, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ADC channel differential or single-ended mode for channels 18 to 16 */
    using DIFSEL_DIFSEL_16_18 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
