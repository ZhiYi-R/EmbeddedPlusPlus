...
#ifndef EMBEDDED_PP_STM32WB55_CM0P_AES1_HPP
#define EMBEDDED_PP_STM32WB55_CM0P_AES1_HPP
...
namespace STM32WB55_CM0P::AES1 {
    ...
    using HWCFR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x3F0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief HW Generic 4 */
