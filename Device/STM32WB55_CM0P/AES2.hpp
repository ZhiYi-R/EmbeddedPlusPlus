...
#ifndef EMBEDDED_PP_STM32WB55_CM0P_AES2_HPP
#define EMBEDDED_PP_STM32WB55_CM0P_AES2_HPP
...
namespace STM32WB55_CM0P::AES2 {
    ...
    /** @brief AES chaining mode Bit2 */
    using CR_CHMOD2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Used only for GCM, CCM and GMAC algorithms and has no effect when other algorithms are selected */
    ...
    /** @brief AES chaining mode Bit1 Bit0 */
    using CR_CHMOD10 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief AES key register (MSB key [159:128]) */
    using KEYR4_AES_KEYR4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief AES key register (MSB key [191:160]) */
    using KEYR5_AES_KEYR5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief AES key register (MSB key [223:192]) */
    using KEYR6_AES_KEYR6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief AES key register (MSB key [255:224]) */
    using KEYR7_AES_KEYR7 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief AES suspend register 0 */
    using SUSP0R_AES_SUSP0R = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief AES suspend register 1 */
    using SUSP1R_AES_SUSP1R = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief AES suspend register 2 */
    using SUSP2R_AES_SUSP2R = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief AES suspend register 3 */
    using SUSP3R_AES_SUSP3R = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief AES suspend register 4 */
    using SUSP4R_AES_SUSP4R = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief AES suspend register 5 */
    using SUSP5R_AES_SUSP5R = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief AES suspend register 6 */
    using SUSP6R_AES_SUSP6R = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief AES suspend register 7 */
    using SUSP7R_AES_SUSP7R = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief AES hardware configuration register */
    using HWCFR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x60, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief HW Generic 4 */
    using HWCFR_CFG4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief HW Generic 3 */
    using HWCFR_CFG3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief HW Generic 2 */
    using HWCFR_CFG2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief HW Generic 1 */
    using HWCFR_CFG1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief AES version register */
    using VERR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x64, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using IPIDR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x68, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using SIDR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x6C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Size Identification code */
    using SIDR_ID = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
