...
#ifndef EMBEDDED_PP_STM32WB55_CM0P_DMA2_HPP
#define EMBEDDED_PP_STM32WB55_CM0P_DMA2_HPP
...
namespace STM32WB55_CM0P::DMA2 {
    ...
    /** @brief DMA channel 7 selection */
    using CSELR_C7S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DMA channel 6 selection */
    using CSELR_C6S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DMA channel 5 selection */
    using CSELR_C5S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DMA channel 4 selection */
    using CSELR_C4S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DMA channel 3 selection */
    using CSELR_C3S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DMA channel 2 selection */
    using CSELR_C2S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DMA channel 1 selection */
    using CSELR_C1S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
