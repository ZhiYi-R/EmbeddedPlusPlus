...
#ifndef EMBEDDED_PP_STM32WB55_CM0P_LPUART1_HPP
#define EMBEDDED_PP_STM32WB55_CM0P_LPUART1_HPP
...
namespace STM32WB55_CM0P::LPUART1 {
    ...
    /** @brief When the DSI_NSS bit is set, the NSS pin input will be ignored */
    ...
    /** @brief Tr Complete before guard time, interrupt enable */
