...
#ifndef EMBEDDED_PP_STM32WB55_CM0P_PKA_HPP
#define EMBEDDED_PP_STM32WB55_CM0P_PKA_HPP
...
namespace STM32WB55_CM0P::PKA {
    ...
    using VERR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1FF4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using IPIDR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1FF8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using SIDR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1FFC, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Side Identification Code */
