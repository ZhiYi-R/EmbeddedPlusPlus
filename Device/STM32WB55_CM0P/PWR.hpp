...
#ifndef EMBEDDED_PP_STM32WB55_CM0P_PWR_HPP
#define EMBEDDED_PP_STM32WB55_CM0P_PWR_HPP
...
namespace STM32WB55_CM0P::PWR {
    ...
    /** @brief SMPS step-down converter supply startup current selection current selection */
    using CR5_SMPSSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SMPS step-down converter voltage output scaling */
    using CR5_SMPSVOS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
