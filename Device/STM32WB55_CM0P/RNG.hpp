...
#ifndef EMBEDDED_PP_STM32WB55_CM0P_RNG_HPP
#define EMBEDDED_PP_STM32WB55_CM0P_RNG_HPP
...
namespace STM32WB55_CM0P::RNG {
    ...
    /** @brief Bypass mode enable */
    using CR_BYP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
