...
#ifndef EMBEDDED_PP_STM32WB55_CM0P_SAI1_HPP
#define EMBEDDED_PP_STM32WB55_CM0P_SAI1_HPP
...
namespace STM32WB55_CM0P::SAI1 {
    ...
    using BCR1_MCJDIV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 6, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief No divider */
    ...
    /** @brief Master clock divider */
    using ACR1_MCJDIV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 6, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief No divider */
    ...
    /** @brief Audio block B enable */
    using ACR1_SAIBEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output drive */
