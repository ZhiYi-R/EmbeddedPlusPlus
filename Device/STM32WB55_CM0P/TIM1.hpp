...
#ifndef EMBEDDED_PP_STM32WB55_CM0P_TIM1_HPP
#define EMBEDDED_PP_STM32WB55_CM0P_TIM1_HPP
...
namespace STM32WB55_CM0P::TIM1 {
    ...
    using CCMR1_Input_C1F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CCMR2_Input_C3PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief DMA address for full transfer */
    using OR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x50, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM1_ETR_ADC1 remapping capability */
    using OR_TIM1_ETR_ADC1_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Input Capture 1 remap */
    using OR_TI1_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief capture/compare mode register 2 (output mode) */
