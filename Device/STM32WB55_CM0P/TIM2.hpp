...
#ifndef EMBEDDED_PP_STM32WB55_CM0P_TIM2_HPP
#define EMBEDDED_PP_STM32WB55_CM0P_TIM2_HPP
...
namespace STM32WB55_CM0P::TIM2 {
    ...
    /** @brief High counter value (TIM2 only) */
    ...
    /** @brief Value depends on IUFREMAP in TIM2_CR1. */
    ...
    /** @brief High Auto-reload value (TIM2 only) */
    ...
    /** @brief High Capture/Compare 1 value (TIM2 only) */
    ...
    /** @brief High Capture/Compare 2 value (TIM2 only) */
    ...
    /** @brief High Capture/Compare value (TIM2 only) */
    ...
    /** @brief Input capture 4 remap */
    using OR_TI4_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief External trigger remap */
    using OR_ETR_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Internal trigger remap */
    using OR_ITR_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM2 alternate function option register 1 */
    using AF = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x60, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief External trigger source selection */
    using AF_ETRSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
