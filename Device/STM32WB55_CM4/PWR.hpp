...
#ifndef EMBEDDED_PP_STM32WB55_CM4_PWR_HPP
#define EMBEDDED_PP_STM32WB55_CM4_PWR_HPP
...
namespace STM32WB55_CM4::PWR {
    ...
    /** @brief SMPS step-down converter supply startup current selection */
