...
#ifndef EMBEDDED_PP_STM32WBA52_SEC_IWDG_HPP
#define EMBEDDED_PP_STM32WBA52_SEC_IWDG_HPP
...
namespace STM32WBA52::SEC_IWDG {
    ...
    /** @brief Watchdog enable status bit Set to '1' by hardware as soon as the IWDG is started, remains to '1' until the IWDG is reset. */
