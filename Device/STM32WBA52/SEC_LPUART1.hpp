...
#ifndef EMBEDDED_PP_STM32WBA52_SEC_LPUART1_HPP
#define EMBEDDED_PP_STM32WBA52_SEC_LPUART1_HPP
...
namespace STM32WBA52::SEC_LPUART1 {
    ...
    /** @brief Transmitter enable This bit enables the transmitter. When the Autonomous mode is not used, TE bit is set and cleared by software. When the Autonomous mode is used, TE bit becomes a status bit, which is set and cleared by hardware. Note: During transmission, a low pulse on the TE bit (0 followed by 1) sends a preamble (idle line) after the current word, except in Smartcard mode. In order to generate an idle character, the TE must not be immediately written to 1. To ensure the required duration, the software can poll the TEACK bit in the USART_ISR register. Note: In Smartcard mode, when TE is set, there is a 1 bit-time delay before the transmission starts. */
    ...
    using LPUART_CR1_ALTERNATE1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x0, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief LPUART enable When this bit is cleared, the LPUART prescalers and outputs are stopped immediately, and current operations are discarded. The configuration of the LPUART is kept, but all the status flags, in the LPUART_ISR are reset. This bit is set and cleared by software. Note: To enter low-power mode without generating errors on the line, the TE bit must be reset before and the software must wait for the TC bit in the LPUART_ISR to be set before resetting the UE bit. Note: The DMA requests are also reset when UE = 0 so the DMA channel must be disabled before resetting the UE bit. */
    using LPUART_CR1_ALTERNATE1_UE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: LPUART prescaler and outputs disabled, low-power mode (value: 0)
     *          - B_0x1: LPUART enabled (value: 1)
     */
        /** @brief LPUART prescaler and outputs disabled, low-power mode */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_UE_B_0x0 = 0;
        /** @brief LPUART enabled */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_UE_B_0x1 = 1;

    /** @brief LPUART enable in low-power mode When this bit is cleared, the LPUART cannot request its kernel clock and is not functional in low-power mode. When this bit is set, the LPUART can wake up the MCU from low-power mode. This bit is set and cleared by software. Note: The UESM bit must be set at the initialization phase. Note: If the LPUART does not support the Wakeup from low-power mode, this bit is reserved and must be kept at reset value. Refer to Section 79.3: LPUART implementation on page 4652. */
    using LPUART_CR1_ALTERNATE1_UESM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: LPUART not functional in low-power mode. (value: 0)
     *          - B_0x1: LPUART functional in low-power mode. (value: 1)
     */
        /** @brief LPUART not functional in low-power mode. */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_UESM_B_0x0 = 0;
        /** @brief LPUART functional in low-power mode. */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_UESM_B_0x1 = 1;

    /** @brief Receiver enable This bit enables the receiver. It is set and cleared by software. */
    using LPUART_CR1_ALTERNATE1_RE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Receiver is disabled (value: 0)
     *          - B_0x1: Receiver is enabled and begins searching for a start bit (value: 1)
     */
        /** @brief Receiver is disabled */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_RE_B_0x0 = 0;
        /** @brief Receiver is enabled and begins searching for a start bit */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_RE_B_0x1 = 1;

    /** @brief Transmitter enable This bit enables the transmitter. When the Autonomous mode is disabled, TE bit is set and cleared by software. When the Autonomous mode is enabled, TE bit becomes a status bit, which is set and cleared by hardware. Note: During transmission, a low pulse on the TE bit (0 followed by 1) sends a preamble (idle line) after the current word, except in Smartcard mode. In order to generate an idle character, the TE must not be immediately written to 1. To ensure the required duration, the software can poll the TEACK bit in the LPUART_ISR register. Note: In Smartcard mode, when TE is set, there is a 1 bit-time delay before the transmission starts. */
    using LPUART_CR1_ALTERNATE1_TE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Transmitter is disabled (value: 0)
     *          - B_0x1: Transmitter is enabled (value: 1)
     */
        /** @brief Transmitter is disabled */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_TE_B_0x0 = 0;
        /** @brief Transmitter is enabled */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_TE_B_0x1 = 1;

    /** @brief IDLE interrupt enable This bit is set and cleared by software. */
    using LPUART_CR1_ALTERNATE1_IDLEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt is inhibited (value: 0)
     *          - B_0x1: An LPUART interrupt is generated whenever IDLE=1 in the LPUART_ISR register (value: 1)
     */
        /** @brief Interrupt is inhibited */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_IDLEIE_B_0x0 = 0;
        /** @brief An LPUART interrupt is generated whenever IDLE=1 in the LPUART_ISR register */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_IDLEIE_B_0x1 = 1;

    /** @brief Receive data register not empty This bit is set and cleared by software. */
    using LPUART_CR1_ALTERNATE1_RXNEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt is inhibited (value: 0)
     *          - B_0x1: A LPUART interrupt is generated whenever ORE=1 or RXNE=1 in the LPUART_ISR register (value: 1)
     */
        /** @brief Interrupt is inhibited */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_RXNEIE_B_0x0 = 0;
        /** @brief A LPUART interrupt is generated whenever ORE=1 or RXNE=1 in the LPUART_ISR register */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_RXNEIE_B_0x1 = 1;

    /** @brief Transmission complete interrupt enable This bit is set and cleared by software. */
    using LPUART_CR1_ALTERNATE1_TCIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt is inhibited (value: 0)
     *          - B_0x1: An LPUART interrupt is generated whenever TC=1 in the LPUART_ISR register (value: 1)
     */
        /** @brief Interrupt is inhibited */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_TCIE_B_0x0 = 0;
        /** @brief An LPUART interrupt is generated whenever TC=1 in the LPUART_ISR register */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_TCIE_B_0x1 = 1;

    /** @brief Transmit data register empty This bit is set and cleared by software. */
    using LPUART_CR1_ALTERNATE1_TXEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt is inhibited (value: 0)
     *          - B_0x1: A LPUART interrupt is generated whenever TXE =1 in the LPUART_ISR register (value: 1)
     */
        /** @brief Interrupt is inhibited */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_TXEIE_B_0x0 = 0;
        /** @brief A LPUART interrupt is generated whenever TXE =1 in the LPUART_ISR register */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_TXEIE_B_0x1 = 1;

    /** @brief PE interrupt enable This bit is set and cleared by software. */
    using LPUART_CR1_ALTERNATE1_PEIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt is inhibited (value: 0)
     *          - B_0x1: An LPUART interrupt is generated whenever PE=1 in the LPUART_ISR register (value: 1)
     */
        /** @brief Interrupt is inhibited */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_PEIE_B_0x0 = 0;
        /** @brief An LPUART interrupt is generated whenever PE=1 in the LPUART_ISR register */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_PEIE_B_0x1 = 1;

    /** @brief Parity selection This bit selects the odd or even parity when the parity generation/detection is enabled (PCE bit set). It is set and cleared by software. The parity is selected after the current byte. This bitfield can only be written when the LPUART is disabled (UE=0). */
    using LPUART_CR1_ALTERNATE1_PS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Even parity (value: 0)
     *          - B_0x1: Odd parity (value: 1)
     */
        /** @brief Even parity */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_PS_B_0x0 = 0;
        /** @brief Odd parity */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_PS_B_0x1 = 1;

    /** @brief Parity control enable This bit selects the hardware parity control (generation and detection). When the parity control is enabled, the computed parity is inserted at the MSB position (9th bit if M=1; 8th bit if M=0) and parity is checked on the received data. This bit is set and cleared by software. Once it is set, PCE is active after the current byte (in reception and in transmission). This bitfield can only be written when the LPUART is disabled (UE=0). */
    using LPUART_CR1_ALTERNATE1_PCE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Parity control disabled (value: 0)
     *          - B_0x1: Parity control enabled (value: 1)
     */
        /** @brief Parity control disabled */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_PCE_B_0x0 = 0;
        /** @brief Parity control enabled */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_PCE_B_0x1 = 1;

    /** @brief Receiver wakeup method This bit determines the LPUART wakeup method from Mute mode. It is set or cleared by software.	 This bitfield can only be written when the LPUART is disabled (UE=0). */
    using LPUART_CR1_ALTERNATE1_WAKE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Idle line (value: 0)
     *          - B_0x1: Address mark (value: 1)
     */
        /** @brief Idle line */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_WAKE_B_0x0 = 0;
        /** @brief Address mark */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_WAKE_B_0x1 = 1;

    /** @brief Word length This bit is used in conjunction with bit 28 (M1) to determine the word length. It is set or cleared by software (refer to bit 28 (M1) description). This bit can only be written when the LPUART is disabled (UE=0). */
    using LPUART_CR1_ALTERNATE1_M0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Mute mode enable This bit activates the Mute mode function of the LPUART. When set, the LPUART can switch between the active and Mute modes, as defined by the WAKE bit. It is set and cleared by software. */
    using LPUART_CR1_ALTERNATE1_MME = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Receiver in Active mode permanently (value: 0)
     *          - B_0x1: Receiver can switch between Mute mode and Active mode. (value: 1)
     */
        /** @brief Receiver in Active mode permanently */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_MME_B_0x0 = 0;
        /** @brief Receiver can switch between Mute mode and Active mode. */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_MME_B_0x1 = 1;

    /** @brief Character match interrupt enable This bit is set and cleared by software. */
    using LPUART_CR1_ALTERNATE1_CMIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Interrupt is inhibited (value: 0)
     *          - B_0x1: A LPUART interrupt is generated when the CMF bit is set in the LPUART_ISR register. (value: 1)
     */
        /** @brief Interrupt is inhibited */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_CMIE_B_0x0 = 0;
        /** @brief A LPUART interrupt is generated when the CMF bit is set in the LPUART_ISR register. */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_CMIE_B_0x1 = 1;

    /** @brief Driver Enable deassertion time This 5-bit value defines the time between the end of the last stop bit, in a transmitted message, and the de-activation of the DE (Driver Enable) signal.It is expressed in lpuart_ker_ck clock cycles. For more details, refer Section 79.4.14: RS232 Hardware flow control and RS485 Driver Enable. If the LPUART_TDR register is written during the DEDT time, the new data is transmitted only when the DEDT and DEAT times have both elapsed. This bitfield can only be written when the LPUART is disabled (UE=0). */
    using LPUART_CR1_ALTERNATE1_DEDT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Driver Enable assertion time This 5-bit value defines the time between the activation of the DE (Driver Enable) signal and the beginning of the start bit. It is expressed in lpuart_ker_ck clock cycles. For more details, refer Section 78.5.21: RS232 Hardware flow control and RS485 Driver Enable. This bitfield can only be written when the LPUART is disabled (UE=0). */
    using LPUART_CR1_ALTERNATE1_DEAT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Word length This bit must be used in conjunction with bit 12 (M0) to determine the word length. It is set or cleared by software. M[1:0] = 00: 1 Start bit, 8 Data bits, n Stop bit M[1:0] = 01: 1 Start bit, 9 Data bits, n Stop bit M[1:0] = '10: 1 Start bit, 7 Data bits, n Stop bit This bit can only be written when the LPUART is disabled (UE=0). Note: In 7-bit data length mode, the Smartcard mode, LIN master mode and auto baud rate (0x7F and 0x55 frames detection) are not supported. */
    using LPUART_CR1_ALTERNATE1_M1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FIFO mode enable This bit is set and cleared by software. */
    using LPUART_CR1_ALTERNATE1_FIFOEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: FIFO mode is disabled. (value: 0)
     *          - B_0x1: FIFO mode is enabled. (value: 1)
     */
        /** @brief FIFO mode is disabled. */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_FIFOEN_B_0x0 = 0;
        /** @brief FIFO mode is enabled. */
    constexpr std::uint32_t LPUART_CR1_ALTERNATE1_FIFOEN_B_0x1 = 1;
    ...
    /** @details Possible values:
     *          - B_0x0: RX pin signal works using the standard logic levels (VsubDD/sub =1/idle, Gnd=0/mark) (value: 0)
     *          - B_0x1: RX pin signal values are inverted. ((VsubDD/sub =0/mark, Gnd=1/idle). (value: 1)
     */
        /** @brief RX pin signal works using the standard logic levels (VsubDD/sub =1/idle, Gnd=0/mark) */
    constexpr std::uint32_t LPUART_CR2_RXINV_B_0x0 = 0;
        /** @brief RX pin signal values are inverted. ((VsubDD/sub =0/mark, Gnd=1/idle). */
    ...
    /** @details Possible values:
     *          - B_0x0: TX pin signal works using the standard logic levels (VsubDD/sub =1/idle, Gnd=0/mark) (value: 0)
     *          - B_0x1: TX pin signal values are inverted. ((VsubDD/sub =0/mark, Gnd=1/idle). (value: 1)
     */
        /** @brief TX pin signal works using the standard logic levels (VsubDD/sub =1/idle, Gnd=0/mark) */
    constexpr std::uint32_t LPUART_CR2_TXINV_B_0x0 = 0;
        /** @brief TX pin signal values are inverted. ((VsubDD/sub =0/mark, Gnd=1/idle). */
    ...
    constexpr std::uint32_t LPUART_ISR_ORE_B_0x0 = 0;
    ...
    using LPUART_ISR_ALTERNATE1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPUART_ISR_ALTERNATE1_PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No parity error (value: 0)
     *          - B_0x1: Parity error (value: 1)
     */
        /** @brief No parity error */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_PE_B_0x0 = 0;
        /** @brief Parity error */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_PE_B_0x1 = 1;

    /** @brief Framing error This bit is set by hardware when a de-synchronization, excessive noise or a break character is detected. It is cleared by software, writing 1 to the FECF bit in the LPUART_ICR register. When transmitting data in Smartcard mode, this bit is set when the maximum number of transmit attempts is reached without success (the card NACKs the data frame). An interrupt is generated if EIE = 1 in the LPUART_CR1 register. Note: In FIFO mode, this error is associated with the character in the LPUART_RDR. */
    using LPUART_ISR_ALTERNATE1_FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No Framing error is detected (value: 0)
     *          - B_0x1: Framing error or break character is detected (value: 1)
     */
        /** @brief No Framing error is detected */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_FE_B_0x0 = 0;
        /** @brief Framing error or break character is detected */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_FE_B_0x1 = 1;
    ...
    using LPUART_ISR_ALTERNATE1_NE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No noise is detected (value: 0)
     *          - B_0x1: Noise is detected (value: 1)
     */
        /** @brief No noise is detected */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_NE_B_0x0 = 0;
        /** @brief Noise is detected */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_NE_B_0x1 = 1;
    ...
    using LPUART_ISR_ALTERNATE1_ORE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No overrun error (value: 0)
     *          - B_0x1: Overrun error is detected (value: 1)
     */
        /** @brief No overrun error */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_ORE_B_0x0 = 0;
        /** @brief Overrun error is detected */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_ORE_B_0x1 = 1;
    ...
    using LPUART_ISR_ALTERNATE1_IDLE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No Idle line is detected (value: 0)
     *          - B_0x1: Idle line is detected (value: 1)
     */
        /** @brief No Idle line is detected */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_IDLE_B_0x0 = 0;
        /** @brief Idle line is detected */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_IDLE_B_0x1 = 1;
    ...
    using LPUART_ISR_ALTERNATE1_RXNE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Data is not received (value: 0)
     *          - B_0x1: Received data is ready to be read. (value: 1)
     */
        /** @brief Data is not received */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_RXNE_B_0x0 = 0;
        /** @brief Received data is ready to be read. */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_RXNE_B_0x1 = 1;
    ...
    using LPUART_ISR_ALTERNATE1_TC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using LPUART_ISR_ALTERNATE1_TXE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Data register is full/Transmit FIFO is full. (value: 0)
     *          - B_0x1: Data register/Transmit FIFO is not full. (value: 1)
     */
        /** @brief Data register is full/Transmit FIFO is full. */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_TXE_B_0x0 = 0;
        /** @brief Data register/Transmit FIFO is not full. */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_TXE_B_0x1 = 1;

    /** @brief CTS interrupt flag This bit is set by hardware when the CTS input toggles, if the CTSE bit is set. It is cleared by software, by writing 1 to the CTSCF bit in the LPUART_ICR register. An interrupt is generated if CTSIE=1 in the LPUART_CR3 register. Note: If the hardware flow control feature is not supported, this bit is reserved and kept at reset value. */
    using LPUART_ISR_ALTERNATE1_CTSIF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No change occurred on the CTS status line (value: 0)
     *          - B_0x1: A change occurred on the CTS status line (value: 1)
     */
        /** @brief No change occurred on the CTS status line */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_CTSIF_B_0x0 = 0;
        /** @brief A change occurred on the CTS status line */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_CTSIF_B_0x1 = 1;

    /** @brief CTS flag This bit is set/reset by hardware. It is an inverted copy of the status of the CTS input pin. Note: If the hardware flow control feature is not supported, this bit is reserved and kept at reset value. */
    using LPUART_ISR_ALTERNATE1_CTS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CTS line set (value: 0)
     *          - B_0x1: CTS line reset (value: 1)
     */
        /** @brief CTS line set */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_CTS_B_0x0 = 0;
        /** @brief CTS line reset */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_CTS_B_0x1 = 1;

    /** @brief Busy flag This bit is set and reset by hardware. It is active when a communication is ongoing on the RX line (successful start bit detected). It is reset at the end of the reception (successful or not). */
    using LPUART_ISR_ALTERNATE1_BUSY = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: LPUART is idle (no reception) (value: 0)
     *          - B_0x1: Reception on going (value: 1)
     */
        /** @brief LPUART is idle (no reception) */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_BUSY_B_0x0 = 0;
        /** @brief Reception on going */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_BUSY_B_0x1 = 1;

    /** @brief Character match flag This bit is set by hardware, when a the character defined by ADD[7:0] is received. It is cleared by software, writing 1 to the CMCF in the LPUART_ICR register. An interrupt is generated if CMIE=1in the LPUART_CR1 register. */
    using LPUART_ISR_ALTERNATE1_CMF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No Character match detected (value: 0)
     *          - B_0x1: Character match detected (value: 1)
     */
        /** @brief No Character match detected */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_CMF_B_0x0 = 0;
        /** @brief Character match detected */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_CMF_B_0x1 = 1;

    /** @brief Send break flag This bit indicates that a send break character was requested. It is set by software, by writing 1 to the SBKRQ bit in the LPUART_CR3 register. It is automatically reset by hardware during the stop bit of break transmission. */
    using LPUART_ISR_ALTERNATE1_SBKF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No break character transmitted (value: 0)
     *          - B_0x1: Break character transmitted (value: 1)
     */
        /** @brief No break character transmitted */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_SBKF_B_0x0 = 0;
        /** @brief Break character transmitted */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_SBKF_B_0x1 = 1;

    /** @brief Receiver wakeup from Mute mode This bit indicates if the LPUART is in Mute mode. It is cleared/set by hardware when a wakeup/mute sequence is recognized. The Mute mode control sequence (address or IDLE) is selected by the WAKE bit in the LPUART_CR1 register. When wakeup on IDLE mode is selected, this bit can only be set by software, writing 1 to the MMRQ bit in the LPUART_RQR register. Note: If the LPUART does not support the wakeup from Stop feature, this bit is reserved and kept at reset value. */
    using LPUART_ISR_ALTERNATE1_RWU = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Receiver in Active mode (value: 0)
     *          - B_0x1: Receiver in Mute mode (value: 1)
     */
        /** @brief Receiver in Active mode */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_RWU_B_0x0 = 0;
        /** @brief Receiver in Mute mode */
    constexpr std::uint32_t LPUART_ISR_ALTERNATE1_RWU_B_0x1 = 1;

    /** @brief Transmit enable acknowledge flag This bit is set/reset by hardware, when the Transmit Enable value is taken into account by the LPUART. It can be used when an idle frame request is generated by writing TE=0, followed by TE=1 in the LPUART_CR1 register, in order to respect the TE=0 minimum period. */
    using LPUART_ISR_ALTERNATE1_TEACK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Receive enable acknowledge flag This bit is set/reset by hardware, when the Receive Enable value is taken into account by the LPUART. It can be used to verify that the LPUART is ready for reception before entering low-power mode. Note: If the LPUART does not support the wakeup from Stop feature, this bit is reserved and kept at reset value. */
    using LPUART_ISR_ALTERNATE1_REACK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Receive data value Contains the received data character. The RDR register provides the parallel interface between the input shift register and the internal bus (see Figure 952). When receiving with the parity enabled, the value read in the MSB bit is the received parity bit. */
    ...
    using LPUART_AUTOCR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x30, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TDC transmission data number This bitfield enables the programming of the number of data to be transmitted. It can be written only when UE is cleared in LPUART_CR1. */
    using LPUART_AUTOCR_TDN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Trigger polarity bit This bitfield can be written only when the UE bit is cleared in LPUART_CR1 register. */
    using LPUART_AUTOCR_TRIGPOL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPUART_AUTOCR_TRIGPOL_B_0x0 = 0;
        /** @brief Trigger active on falling edge */
    constexpr std::uint32_t LPUART_AUTOCR_TRIGPOL_B_0x1 = 1;

    /** @brief Trigger enable bit Note: This bitfield can be written only when the UE bit of USART_CR1 register is cleared. Note: When a trigger is detected, TE is set to 1 in LPUART_CR1 and the data transfer is launched. */
    using LPUART_AUTOCR_TRIGEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Trigger disabled (value: 0)
     *          - B_0x1: Trigger enabled (value: 1)
     */
        /** @brief Trigger disabled */
    constexpr std::uint32_t LPUART_AUTOCR_TRIGEN_B_0x0 = 0;
        /** @brief Trigger enabled */
    constexpr std::uint32_t LPUART_AUTOCR_TRIGEN_B_0x1 = 1;

    /** @brief Idle frame transmission disable bit after enabling the transmitter Note: This bitfield can be written only when the UE bit of USART_CR1 register is cleared. */
    using LPUART_AUTOCR_IDLEDIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPUART_AUTOCR_IDLEDIS_B_0x0 = 0;
        /** @brief Idle frame not sent after enabling the transmitter */
    constexpr std::uint32_t LPUART_AUTOCR_IDLEDIS_B_0x1 = 1;

    /** @brief Trigger selection bits Refer to Section : Description LPUART interconnections. This bitfield can be written only when the UE bit is cleared in LPUART_CR1 register. ... Note: This bitfield can be written only when the UE bit of USART_CR1 register is cleared. */
    using LPUART_AUTOCR_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t LPUART_AUTOCR_TRIGSEL_B_0x0 = 0;
        /** @brief lpuart_trg1 selected */
    constexpr std::uint32_t LPUART_AUTOCR_TRIGSEL_B_0x1 = 1;
        /** @brief lpuart_trg15 selected */
    constexpr std::uint32_t LPUART_AUTOCR_TRIGSEL_B_0xF = 15;
