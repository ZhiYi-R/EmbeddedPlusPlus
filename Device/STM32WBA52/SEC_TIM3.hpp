...
#ifndef EMBEDDED_PP_STM32WBA52_SEC_TIM3_HPP
#define EMBEDDED_PP_STM32WBA52_SEC_TIM3_HPP
...
namespace STM32WBA52::SEC_TIM3 {
    ...
    using TIM_CR1_DIR = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Counter used as upcounter (value: 0)
     *          - B_0x1: Counter used as downcounter (value: 1)
     */
        /** @brief Counter used as upcounter */
    constexpr std::uint16_t TIM_CR1_DIR_B_0x0 = 0;
        /** @brief Counter used as downcounter */
    constexpr std::uint16_t TIM_CR1_DIR_B_0x1 = 1;
    ...
    using TIM_CR1_CMS = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 5, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint16_t TIM_CR1_CMS_B_0x0 = 0;
    ...
    constexpr std::uint16_t TIM_CR1_CMS_B_0x1 = 1;
    ...
    constexpr std::uint16_t TIM_CR1_CMS_B_0x2 = 2;
    ...
    constexpr std::uint16_t TIM_CR1_CMS_B_0x3 = 3;
    ...
    using TIM_CR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/compare DMA selection */
    using TIM_CR2_CCDS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_CR2_MMS_B_0x0 = 0;
        /** @brief Enable - the Counter enable signal, CNT_EN, is used as trigger output (tim_trgo). It is useful to start several timers at the same time or to control a window in which a slave timer is enabled. The Counter Enable signal is generated by a logic AND between CEN control bit and the trigger input when configured in gated mode. */
    constexpr std::uint32_t TIM_CR2_MMS_B_0x1 = 1;
    ...
    constexpr std::uint32_t TIM_CR2_MMS_B_0x2 = 2;
    ...
    constexpr std::uint32_t TIM_CR2_MMS_B_0x3 = 3;
        /** @brief Compare - tim_oc1refc signal is used as trigger output (tim_trgo) */
    constexpr std::uint32_t TIM_CR2_MMS_B_0x4 = 4;
        /** @brief Compare - tim_oc2refc signal is used as trigger output (tim_trgo) */
    constexpr std::uint32_t TIM_CR2_MMS_B_0x5 = 5;
        /** @brief Compare - tim_oc3refc signal is used as trigger output (tim_trgo) */
    constexpr std::uint32_t TIM_CR2_MMS_B_0x6 = 6;
        /** @brief Compare - tim_oc4refc signal is used as trigger output (tim_trgo) */
    constexpr std::uint32_t TIM_CR2_MMS_B_0x7 = 7;

    /** @brief tim_ti1 selection */
    using TIM_CR2_TI1S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: The tim_ti1_in[15:0] multiplexer output is to tim_ti1 input (value: 0)
     *          - B_0x1: The tim_ti1_in[15:0], tim_ti2_in[15:0] and tim_ti3_in[15:0] multiplexers outputs are XORed and connected to the tim_ti1 input. See also Section 42.3.25: Interfacing with Hall sensors on page 1483. (value: 1)
     */
        /** @brief The tim_ti1_in[15:0] multiplexer output is to tim_ti1 input */
    constexpr std::uint32_t TIM_CR2_TI1S_B_0x0 = 0;
        /** @brief The tim_ti1_in[15:0], tim_ti2_in[15:0] and tim_ti3_in[15:0] multiplexers outputs are XORed and connected to the tim_ti1 input. See also Section 42.3.25: Interfacing with Hall sensors on page 1483. */
    constexpr std::uint32_t TIM_CR2_TI1S_B_0x1 = 1;

    /** @brief MMS[3] */
    using TIM_CR2_MMS_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM slave mode control register */
    using TIM_SMCR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM_SMCR_SMS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_SMCR_SMS_B_0x3 = 3;
    ...
    constexpr std::uint32_t TIM_SMCR_SMS_B_0x4 = 4;
    ...
    constexpr std::uint32_t TIM_SMCR_SMS_B_0x5 = 5;
    ...
    constexpr std::uint32_t TIM_SMCR_SMS_B_0x6 = 6;
        /** @brief External Clock Mode 1 - Rising edges of the selected trigger (tim_trgi) clock the counter. */
    constexpr std::uint32_t TIM_SMCR_SMS_B_0x7 = 7;

    /** @brief OCREF clear selection This bit is used to select the OCREF clear source Note: If the OCREF clear selection feature is not supported, this bit is reserved and forced by hardware to '0'. Section 29.3: TIM2/TIM3 implementation. */
    using TIM_SMCR_OCCS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_SMCR_OCCS_B_0x0 = 0;
        /** @brief tim_ocref_clr_int is connected to tim_etrf */
    constexpr std::uint32_t TIM_SMCR_OCCS_B_0x1 = 1;
    ...
    using TIM_SMCR_TS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_SMCR_TS_B_0x0 = 0;
        /** @brief Internal trigger 1 (tim_itr1) */
    constexpr std::uint32_t TIM_SMCR_TS_B_0x1 = 1;
        /** @brief Internal trigger 2 (tim_itr2) */
    constexpr std::uint32_t TIM_SMCR_TS_B_0x2 = 2;
        /** @brief Internal trigger 3 (tim_itr3) */
    constexpr std::uint32_t TIM_SMCR_TS_B_0x3 = 3;
        /** @brief tim_ti1 edge detector (tim_ti1f_ed) */
    constexpr std::uint32_t TIM_SMCR_TS_B_0x4 = 4;
        /** @brief Filtered timer input 1 (tim_ti1fp1) */
    constexpr std::uint32_t TIM_SMCR_TS_B_0x5 = 5;
        /** @brief Filtered timer input 2 (tim_ti2fp2) */
    constexpr std::uint32_t TIM_SMCR_TS_B_0x6 = 6;
        /** @brief External trigger input (tim_etrf) */
    constexpr std::uint32_t TIM_SMCR_TS_B_0x7 = 7;

    /** @brief Master/Slave mode */
    using TIM_SMCR_MSM = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     ...
     */
        /** @brief No action */
    constexpr std::uint32_t TIM_SMCR_MSM_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM_SMCR_MSM_B_0x1 = 1;
    ...
    using TIM_SMCR_ETF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_SMCR_ETF_B_0x0 = 0;
        /** @brief fsubSAMPLING/sub=fsubtim_ker_ck/sub, N=2 */
    constexpr std::uint32_t TIM_SMCR_ETF_B_0x1 = 1;
        /** @brief fsubSAMPLING/sub=fsubtim_ker_ck/sub, N=4 */
    constexpr std::uint32_t TIM_SMCR_ETF_B_0x2 = 2;
        /** @brief fsubSAMPLING/sub=fsubtim_ker_ck/sub, N=8 */
    constexpr std::uint32_t TIM_SMCR_ETF_B_0x3 = 3;
        /** @brief fsubSAMPLING/sub=fsubDTS/sub/2, N=6 */
    constexpr std::uint32_t TIM_SMCR_ETF_B_0x4 = 4;
        /** @brief fsubSAMPLING/sub=fsubDTS/sub/2, N=8 */
    constexpr std::uint32_t TIM_SMCR_ETF_B_0x5 = 5;
        /** @brief fsubSAMPLING/sub=fsubDTS/sub/4, N=6 */
    constexpr std::uint32_t TIM_SMCR_ETF_B_0x6 = 6;
        /** @brief fsubSAMPLING/sub=fsubDTS/sub/4, N=8 */
    constexpr std::uint32_t TIM_SMCR_ETF_B_0x7 = 7;
        /** @brief fsubSAMPLING/sub=fsubDTS/sub/8, N=6 */
    constexpr std::uint32_t TIM_SMCR_ETF_B_0x8 = 8;
        /** @brief fsubSAMPLING/sub=fsubDTS/sub/8, N=8 */
    constexpr std::uint32_t TIM_SMCR_ETF_B_0x9 = 9;
        /** @brief fsubSAMPLING/sub=fsubDTS/sub/16, N=5 */
    constexpr std::uint32_t TIM_SMCR_ETF_B_0xA = 10;
        /** @brief fsubSAMPLING/sub=fsubDTS/sub/16, N=6 */
    constexpr std::uint32_t TIM_SMCR_ETF_B_0xB = 11;
        /** @brief fsubSAMPLING/sub=fsubDTS/sub/16, N=8 */
    constexpr std::uint32_t TIM_SMCR_ETF_B_0xC = 12;
        /** @brief fsubSAMPLING/sub=fsubDTS/sub/32, N=5 */
    constexpr std::uint32_t TIM_SMCR_ETF_B_0xD = 13;
        /** @brief fsubSAMPLING/sub=fsubDTS/sub/32, N=6 */
    constexpr std::uint32_t TIM_SMCR_ETF_B_0xE = 14;
        /** @brief fsubSAMPLING/sub=fsubDTS/sub/32, N=8 */
    constexpr std::uint32_t TIM_SMCR_ETF_B_0xF = 15;
    ...
    using TIM_SMCR_ETPS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_SMCR_ETP_B_0x0 = 0;
        /** @brief tim_etr_in is inverted, active at low level or falling edge */
    constexpr std::uint32_t TIM_SMCR_ETP_B_0x1 = 1;

    /** @brief SMS[3] */
    using TIM_SMCR_SMS_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TS[4:3] */
    using TIM_SMCR_TS_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SMS preload enable This bit selects whether the SMS[3:0] bitfield is preloaded */
    using TIM_SMCR_SMSPE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_SMCR_SMSPE_B_0x0 = 0;
        /** @brief SMS[3:0] preload is enabled */
    constexpr std::uint32_t TIM_SMCR_SMSPE_B_0x1 = 1;
    ...
    using TIM_SMCR_SMSPS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_SMCR_SMSPS_B_0x0 = 0;
        /** @brief The transfer is triggered by the Index event */
    constexpr std::uint32_t TIM_SMCR_SMSPS_B_0x1 = 1;

    /** @brief TIM DMA/Interrupt enable register */
    using TIM_DIER = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0xC, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Update interrupt enable */
    using TIM_DIER_UIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Update interrupt disabled. (value: 0)
     *          - B_0x1: Update interrupt enabled. (value: 1)
     */
        /** @brief Update interrupt disabled. */
    constexpr std::uint32_t TIM_DIER_UIE_B_0x0 = 0;
        /** @brief Update interrupt enabled. */
    constexpr std::uint32_t TIM_DIER_UIE_B_0x1 = 1;

    /** @brief Capture/Compare 1 interrupt enable */
    using TIM_DIER_CC1IE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC1 interrupt disabled. (value: 0)
     *          - B_0x1: CC1 interrupt enabled. (value: 1)
     */
        /** @brief CC1 interrupt disabled. */
    constexpr std::uint32_t TIM_DIER_CC1IE_B_0x0 = 0;
        /** @brief CC1 interrupt enabled. */
    constexpr std::uint32_t TIM_DIER_CC1IE_B_0x1 = 1;

    /** @brief Capture/Compare 2 interrupt enable */
    using TIM_DIER_CC2IE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC2 interrupt disabled. (value: 0)
     *          - B_0x1: CC2 interrupt enabled. (value: 1)
     */
        /** @brief CC2 interrupt disabled. */
    constexpr std::uint32_t TIM_DIER_CC2IE_B_0x0 = 0;
        /** @brief CC2 interrupt enabled. */
    constexpr std::uint32_t TIM_DIER_CC2IE_B_0x1 = 1;

    /** @brief Capture/Compare 3 interrupt enable */
    using TIM_DIER_CC3IE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC3 interrupt disabled. (value: 0)
     *          - B_0x1: CC3 interrupt enabled. (value: 1)
     */
        /** @brief CC3 interrupt disabled. */
    constexpr std::uint32_t TIM_DIER_CC3IE_B_0x0 = 0;
        /** @brief CC3 interrupt enabled. */
    constexpr std::uint32_t TIM_DIER_CC3IE_B_0x1 = 1;

    /** @brief Capture/Compare 4 interrupt enable */
    using TIM_DIER_CC4IE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC4 interrupt disabled. (value: 0)
     *          - B_0x1: CC4 interrupt enabled. (value: 1)
     */
        /** @brief CC4 interrupt disabled. */
    constexpr std::uint32_t TIM_DIER_CC4IE_B_0x0 = 0;
        /** @brief CC4 interrupt enabled. */
    constexpr std::uint32_t TIM_DIER_CC4IE_B_0x1 = 1;

    /** @brief Trigger interrupt enable */
    using TIM_DIER_TIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Trigger interrupt disabled. (value: 0)
     *          - B_0x1: Trigger interrupt enabled. (value: 1)
     */
        /** @brief Trigger interrupt disabled. */
    constexpr std::uint32_t TIM_DIER_TIE_B_0x0 = 0;
        /** @brief Trigger interrupt enabled. */
    constexpr std::uint32_t TIM_DIER_TIE_B_0x1 = 1;

    /** @brief Update DMA request enable */
    using TIM_DIER_UDE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Update DMA request disabled. (value: 0)
     *          - B_0x1: Update DMA request enabled. (value: 1)
     */
        /** @brief Update DMA request disabled. */
    constexpr std::uint32_t TIM_DIER_UDE_B_0x0 = 0;
        /** @brief Update DMA request enabled. */
    constexpr std::uint32_t TIM_DIER_UDE_B_0x1 = 1;

    /** @brief Capture/Compare 1 DMA request enable */
    using TIM_DIER_CC1DE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC1 DMA request disabled. (value: 0)
     *          - B_0x1: CC1 DMA request enabled. (value: 1)
     */
        /** @brief CC1 DMA request disabled. */
    constexpr std::uint32_t TIM_DIER_CC1DE_B_0x0 = 0;
        /** @brief CC1 DMA request enabled. */
    constexpr std::uint32_t TIM_DIER_CC1DE_B_0x1 = 1;

    /** @brief Capture/Compare 2 DMA request enable */
    using TIM_DIER_CC2DE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC2 DMA request disabled. (value: 0)
     *          - B_0x1: CC2 DMA request enabled. (value: 1)
     */
        /** @brief CC2 DMA request disabled. */
    constexpr std::uint32_t TIM_DIER_CC2DE_B_0x0 = 0;
        /** @brief CC2 DMA request enabled. */
    constexpr std::uint32_t TIM_DIER_CC2DE_B_0x1 = 1;

    /** @brief Capture/Compare 3 DMA request enable */
    using TIM_DIER_CC3DE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC3 DMA request disabled. (value: 0)
     *          - B_0x1: CC3 DMA request enabled. (value: 1)
     */
        /** @brief CC3 DMA request disabled. */
    constexpr std::uint32_t TIM_DIER_CC3DE_B_0x0 = 0;
        /** @brief CC3 DMA request enabled. */
    constexpr std::uint32_t TIM_DIER_CC3DE_B_0x1 = 1;

    /** @brief Capture/Compare 4 DMA request enable */
    using TIM_DIER_CC4DE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC4 DMA request disabled. (value: 0)
     *          - B_0x1: CC4 DMA request enabled. (value: 1)
     */
        /** @brief CC4 DMA request disabled. */
    constexpr std::uint32_t TIM_DIER_CC4DE_B_0x0 = 0;
        /** @brief CC4 DMA request enabled. */
    constexpr std::uint32_t TIM_DIER_CC4DE_B_0x1 = 1;

    /** @brief Trigger DMA request enable */
    using TIM_DIER_TDE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Trigger DMA request disabled. (value: 0)
     *          - B_0x1: Trigger DMA request enabled. (value: 1)
     */
        /** @brief Trigger DMA request disabled. */
    constexpr std::uint32_t TIM_DIER_TDE_B_0x0 = 0;
        /** @brief Trigger DMA request enabled. */
    constexpr std::uint32_t TIM_DIER_TDE_B_0x1 = 1;

    /** @brief Index interrupt enable */
    using TIM_DIER_IDXIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Index interrupt disabled (value: 0)
     *          - B_0x1: Index interrupt enabled (value: 1)
     */
        /** @brief Index interrupt disabled */
    constexpr std::uint32_t TIM_DIER_IDXIE_B_0x0 = 0;
        /** @brief Index interrupt enabled */
    constexpr std::uint32_t TIM_DIER_IDXIE_B_0x1 = 1;

    /** @brief Direction change interrupt enable */
    using TIM_DIER_DIRIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_DIER_DIRIE_B_0x0 = 0;
        /** @brief Direction change interrupt enabled */
    constexpr std::uint32_t TIM_DIER_DIRIE_B_0x1 = 1;

    /** @brief Index error interrupt enable */
    using TIM_DIER_IERRIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_DIER_IERRIE_B_0x0 = 0;
        /** @brief Index error interrupt enabled */
    constexpr std::uint32_t TIM_DIER_IERRIE_B_0x1 = 1;

    /** @brief Transition error interrupt enable */
    using TIM_DIER_TERRIE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_DIER_TERRIE_B_0x0 = 0;
        /** @brief Transition error interrupt enabled */
    constexpr std::uint32_t TIM_DIER_TERRIE_B_0x1 = 1;

    /** @brief TIM status register */
    using TIM_SR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x10, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM_SR_UIF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    using TIM_SR_CC1IF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_SR_CC1IF_B_0x0 = 0;
        /** @brief A compare match or an input capture occurred */
    constexpr std::uint32_t TIM_SR_CC1IF_B_0x1 = 1;

    /** @brief Capture/Compare 2 interrupt flag Refer to CC1IF description */
    using TIM_SR_CC2IF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 3 interrupt flag Refer to CC1IF description */
    using TIM_SR_CC3IF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 4 interrupt flag Refer to CC1IF description */
    using TIM_SR_CC4IF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM_SR_TIF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No trigger event occurred. (value: 0)
     *          - B_0x1: Trigger interrupt pending. (value: 1)
     */
        /** @brief No trigger event occurred. */
    constexpr std::uint32_t TIM_SR_TIF_B_0x0 = 0;
        /** @brief Trigger interrupt pending. */
    constexpr std::uint32_t TIM_SR_TIF_B_0x1 = 1;
    ...
    using TIM_SR_CC1OF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_SR_CC1OF_B_0x0 = 0;
        /** @brief The counter value has been captured in TIMx_CCR1 register while CC1IF flag was already set */
    constexpr std::uint32_t TIM_SR_CC1OF_B_0x1 = 1;

    /** @brief Capture/compare 2 overcapture flag refer to CC1OF description */
    using TIM_SR_CC2OF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 3 overcapture flag refer to CC1OF description */
    using TIM_SR_CC3OF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 4 overcapture flag refer to CC1OF description */
    using TIM_SR_CC4OF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM_SR_IDXF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No index event occurred. (value: 0)
     *          - B_0x1: An index event has occurred (value: 1)
     */
        /** @brief No index event occurred. */
    constexpr std::uint32_t TIM_SR_IDXF_B_0x0 = 0;
        /** @brief An index event has occurred */
    constexpr std::uint32_t TIM_SR_IDXF_B_0x1 = 1;
    ...
    using TIM_SR_DIRF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No direction change (value: 0)
     *          - B_0x1: Direction change (value: 1)
     */
        /** @brief No direction change */
    constexpr std::uint32_t TIM_SR_DIRF_B_0x0 = 0;
        /** @brief Direction change */
    constexpr std::uint32_t TIM_SR_DIRF_B_0x1 = 1;
    ...
    using TIM_SR_IERRF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_SR_IERRF_B_0x0 = 0;
        /** @brief An index error has been detected */
    constexpr std::uint32_t TIM_SR_IERRF_B_0x1 = 1;
    ...
    using TIM_SR_TERRF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_SR_TERRF_B_0x0 = 0;
        /** @brief An encoder transition error has been detected */
    constexpr std::uint32_t TIM_SR_TERRF_B_0x1 = 1;
    ...
    using TIM_EGR_CC2G = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/compare 3 generation Refer to CC1G description */
    using TIM_EGR_CC3G = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/compare 4 generation Refer to CC1G description */
    using TIM_EGR_CC4G = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    constexpr std::uint32_t TIM_CCMR1_CC1S_B_0x2 = 2;
    ...
    constexpr std::uint32_t TIM_CCMR1_CC1S_B_0x3 = 3;
    ...
    using TIM_CCMR1_CC2S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_CCMR1_CC2S_B_0x3 = 3;

    /** @brief Input capture 2 prescaler */
    using TIM_CCMR1_IC2PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Input capture 2 filter */
    using TIM_CCMR1_IC2F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM capture/compare mode register 1 [alternate] */
    using TIM_CCMR1_ALTERNATE = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x18, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIMx_CCER). */
    using TIM_CCMR1_ALTERNATE_CC1S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC1 channel is configured as output. (value: 0)
     *          - B_0x1: CC1 channel is configured as input, tim_ic1 is mapped on tim_ti1. (value: 1)
     *          - B_0x2: CC1 channel is configured as input, tim_ic1 is mapped on tim_ti2. (value: 2)
     ...
     */
        /** @brief CC1 channel is configured as output. */
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_CC1S_B_0x0 = 0;
        /** @brief CC1 channel is configured as input, tim_ic1 is mapped on tim_ti1. */
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_CC1S_B_0x1 = 1;
        /** @brief CC1 channel is configured as input, tim_ic1 is mapped on tim_ti2. */
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_CC1S_B_0x2 = 2;
        /** @brief CC1 channel is configured as input, tim_ic1 is mapped on tim_trc. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register) */
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_CC1S_B_0x3 = 3;
    ...
    using TIM_CCMR1_ALTERNATE_OC1FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_OC1FE_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_OC1FE_B_0x1 = 1;

    /** @brief Output compare 1 preload enable */
    using TIM_CCMR1_ALTERNATE_OC1PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_OC1PE_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_OC1PE_B_0x1 = 1;

    /** @brief OC1M[2:0]: Output compare 1 mode These bits define the behavior of the output reference signal tim_oc1ref from which tim_oc1 is derived. tim_oc1ref is active high whereas tim_oc1 active level depends on CC1P bit. Note: In PWM mode, the tim_ocref_clr level changes only when the result of the comparison changes or when the output compare mode switches from 'frozen' mode to 'PWM' mode. */
    using TIM_CCMR1_ALTERNATE_OC1M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     ...
     *          - B_0x6: PWM mode 1 - In upcounting, channel 1 is active as long as TIMx_CNTTIMx_CCR1 else inactive. In downcounting, channel 1 is inactive (tim_oc1ref=0) as long as TIMx_CNTTIMx_CCR1 else active (tim_oc1ref=1). (value: 6)
     *          - B_0x7: PWM mode 2 - In upcounting, channel 1 is inactive as long as TIMx_CNTTIMx_CCR1 else active. In downcounting, channel 1 is active as long as TIMx_CNTTIMx_CCR1 else inactive. (value: 7)
     */
    ...
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_OC1M_B_0x0 = 0;
    ...
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_OC1M_B_0x1 = 1;
    ...
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_OC1M_B_0x2 = 2;
        /** @brief Toggle - tim_oc1ref toggles when TIMx_CNT=TIMx_CCR1. */
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_OC1M_B_0x3 = 3;
        /** @brief Force inactive level - tim_oc1ref is forced low. */
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_OC1M_B_0x4 = 4;
        /** @brief Force active level - tim_oc1ref is forced high. */
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_OC1M_B_0x5 = 5;
        /** @brief PWM mode 1 - In upcounting, channel 1 is active as long as TIMx_CNTTIMx_CCR1 else inactive. In downcounting, channel 1 is inactive (tim_oc1ref=0) as long as TIMx_CNTTIMx_CCR1 else active (tim_oc1ref=1). */
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_OC1M_B_0x6 = 6;
        /** @brief PWM mode 2 - In upcounting, channel 1 is inactive as long as TIMx_CNTTIMx_CCR1 else active. In downcounting, channel 1 is active as long as TIMx_CNTTIMx_CCR1 else inactive. */
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_OC1M_B_0x7 = 7;

    /** @brief Output compare 1 clear enable */
    using TIM_CCMR1_ALTERNATE_OC1CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_OC1CE_B_0x0 = 0;
        /** @brief tim_oc1ref is cleared as soon as a High level is detected on tim_ocref_clr_int input */
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_OC1CE_B_0x1 = 1;

    /** @brief Capture/Compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = 0 in TIMx_CCER). */
    using TIM_CCMR1_ALTERNATE_CC2S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC2 channel is configured as output (value: 0)
     *          - B_0x1: CC2 channel is configured as input, tim_ic2 is mapped on tim_ti2 (value: 1)
     *          - B_0x2: CC2 channel is configured as input, tim_ic2 is mapped on tim_ti1 (value: 2)
     ...
     */
        /** @brief CC2 channel is configured as output */
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_CC2S_B_0x0 = 0;
        /** @brief CC2 channel is configured as input, tim_ic2 is mapped on tim_ti2 */
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_CC2S_B_0x1 = 1;
        /** @brief CC2 channel is configured as input, tim_ic2 is mapped on tim_ti1 */
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_CC2S_B_0x2 = 2;
    ...
    constexpr std::uint32_t TIM_CCMR1_ALTERNATE_CC2S_B_0x3 = 3;

    /** @brief Output compare 2 fast enable */
    using TIM_CCMR1_ALTERNATE_OC2FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 2 preload enable */
    using TIM_CCMR1_ALTERNATE_OC2PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC2M[2:0]: Output compare 2 mode refer to OC1M description on bits 6:4 */
    using TIM_CCMR1_ALTERNATE_OC2M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 2 clear enable */
    using TIM_CCMR1_ALTERNATE_OC2CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC1M[3] */
    using TIM_CCMR1_ALTERNATE_OC1M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC2M[3] */
    using TIM_CCMR1_ALTERNATE_OC2M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM capture/compare mode register 2 [alternate] */
    using TIM_CCMR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM_CCMR2_CC3S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_CCMR2_CC3S_B_0x3 = 3;

    /** @brief Input capture 3 prescaler */
    using TIM_CCMR2_IC3PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Input capture 3 filter */
    using TIM_CCMR2_IC3F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM_CCMR2_CC4S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_CCMR2_CC4S_B_0x3 = 3;

    /** @brief Input capture 4 prescaler */
    using TIM_CCMR2_IC4PSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Input capture 4 filter */
    using TIM_CCMR2_IC4F = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM capture/compare mode register 2 [alternate] */
    using TIM_CCMR2_ALTERNATE = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x1C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = 0 in TIMx_CCER). */
    using TIM_CCMR2_ALTERNATE_CC3S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC3 channel is configured as output (value: 0)
     *          - B_0x1: CC3 channel is configured as input, tim_ic3 is mapped on tim_ti3 (value: 1)
     *          - B_0x2: CC3 channel is configured as input, tim_ic3 is mapped on tim_ti4 (value: 2)
     ...
     */
        /** @brief CC3 channel is configured as output */
    constexpr std::uint32_t TIM_CCMR2_ALTERNATE_CC3S_B_0x0 = 0;
        /** @brief CC3 channel is configured as input, tim_ic3 is mapped on tim_ti3 */
    constexpr std::uint32_t TIM_CCMR2_ALTERNATE_CC3S_B_0x1 = 1;
        /** @brief CC3 channel is configured as input, tim_ic3 is mapped on tim_ti4 */
    constexpr std::uint32_t TIM_CCMR2_ALTERNATE_CC3S_B_0x2 = 2;
        /** @brief CC3 channel is configured as input, tim_ic3 is mapped on tim_trc. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register) */
    constexpr std::uint32_t TIM_CCMR2_ALTERNATE_CC3S_B_0x3 = 3;

    /** @brief Output compare 3 fast enable */
    using TIM_CCMR2_ALTERNATE_OC3FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 3 preload enable */
    using TIM_CCMR2_ALTERNATE_OC3PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC3M[2:0]: Output compare 3 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register) */
    using TIM_CCMR2_ALTERNATE_OC3M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 3 clear enable */
    using TIM_CCMR2_ALTERNATE_OC3CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = 0 in TIMx_CCER). */
    using TIM_CCMR2_ALTERNATE_CC4S = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CC4 channel is configured as output (value: 0)
     *          - B_0x1: CC4 channel is configured as input, tim_ic4 is mapped on tim_ti4 (value: 1)
     *          - B_0x2: CC4 channel is configured as input, tim_ic4 is mapped on tim_ti3 (value: 2)
     ...
     */
        /** @brief CC4 channel is configured as output */
    constexpr std::uint32_t TIM_CCMR2_ALTERNATE_CC4S_B_0x0 = 0;
        /** @brief CC4 channel is configured as input, tim_ic4 is mapped on tim_ti4 */
    constexpr std::uint32_t TIM_CCMR2_ALTERNATE_CC4S_B_0x1 = 1;
        /** @brief CC4 channel is configured as input, tim_ic4 is mapped on tim_ti3 */
    constexpr std::uint32_t TIM_CCMR2_ALTERNATE_CC4S_B_0x2 = 2;
        /** @brief CC4 channel is configured as input, tim_ic4 is mapped on tim_trc. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register) */
    constexpr std::uint32_t TIM_CCMR2_ALTERNATE_CC4S_B_0x3 = 3;

    /** @brief Output compare 4 fast enable */
    using TIM_CCMR2_ALTERNATE_OC4FE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 4 preload enable */
    using TIM_CCMR2_ALTERNATE_OC4PE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC4M[2:0]: Output compare 4 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register) */
    using TIM_CCMR2_ALTERNATE_OC4M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Output compare 4 clear enable */
    using TIM_CCMR2_ALTERNATE_OC4CE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC3M[3] */
    using TIM_CCMR2_ALTERNATE_OC3M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief OC4M[3] */
    using TIM_CCMR2_ALTERNATE_OC4M_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM_CCER_CC2E = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 2 output Polarity. refer to CC1P description */
    using TIM_CCER_CC2P = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 2 output Polarity. Refer to CC1NP description */
    using TIM_CCER_CC2NP = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 3 output enable. Refer to CC1E description */
    using TIM_CCER_CC3E = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 3 output Polarity. Refer to CC1P description */
    using TIM_CCER_CC3P = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 3 output Polarity. Refer to CC1NP description */
    using TIM_CCER_CC3NP = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 4 output enable. refer to CC1E description */
    using TIM_CCER_CC4E = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 4 output Polarity. Refer to CC1P description */
    using TIM_CCER_CC4P = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Capture/Compare 4 output Polarity. Refer to CC1NP description */
    using TIM_CCER_CC4NP = ::EmbeddedPP::LowLevel::BitField<std::uint16_t, 15, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM counter */
    using TIM_CNT = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x24, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Least significant part of counter value Non-dithering mode (DITHEN = 0) The register holds the counter value. Dithering mode (DITHEN = 1) The register holds the non-dithered part in CNT[30:0]. The fractional part is not available. */
    using TIM_CNT_CNT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 31, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief UIF copy or CNT bit 31 If TIMx_CR1.UIFREMAP = 0, thisbit means CNT[31], the most significant bit of counter value If TIMx_CRT1.UIFREMAP = 1, this bit means UIF Copy, and is a read-only copy of the UIF bit of the TIMx_ISR register */
    ...
    /** @brief Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 29.4.3: Time-base unit on page 1245 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null. Non-dithering mode (DITHEN = 0) The register holds the auto-reload value. Dithering mode (DITHEN = 1) The register holds the integer part in ARR[31:4]. The ARR[3:0] bitfield contains the dithered part. */
    using TIM_ARR_ARR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM_CCR1_CCR1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM capture/compare register 2 */
    using TIM_CCR2 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x38, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM_CCR2_CCR2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM capture/compare register 3 */
    using TIM_CCR3 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x3C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM_CCR3_CCR3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM capture/compare register 4 */
    using TIM_CCR4 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x40, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using TIM_CCR4_CCR4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 32, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM timer encoder control register */
    using TIM_ECR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x58, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Index enable This bit indicates if the Index event resets the counter. */
    using TIM_ECR_IE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Index disabled (value: 0)
     *          - B_0x1: Index enabled (value: 1)
     */
        /** @brief Index disabled */
    constexpr std::uint32_t TIM_ECR_IE_B_0x0 = 0;
        /** @brief Index enabled */
    constexpr std::uint32_t TIM_ECR_IE_B_0x1 = 1;
    ...
    using TIM_ECR_IDIR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_ECR_IDIR_B_0x0 = 0;
        /** @brief Index resets the counter when up-counting only */
    constexpr std::uint32_t TIM_ECR_IDIR_B_0x1 = 1;
        /** @brief Index resets the counter when down-counting only */
    constexpr std::uint32_t TIM_ECR_IDIR_B_0x2 = 2;

    /** @brief Index blanking This bit indicates if the Index event is conditioned by the tim_ti3 input */
    using TIM_ECR_IBLK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    using TIM_ECR_IPOS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_ECR_IPOS_B_0x0 = 0;
        /** @brief Index resets the counter when AB = 01 */
    constexpr std::uint32_t TIM_ECR_IPOS_B_0x1 = 1;
        /** @brief Index resets the counter when AB = 10 */
    constexpr std::uint32_t TIM_ECR_IPOS_B_0x2 = 2;
        /** @brief Index resets the counter when AB = 11 */
    constexpr std::uint32_t TIM_ECR_IPOS_B_0x3 = 3;

    /** @brief Pulse width This bitfield defines the pulse duration, as following: tsubPW/sub = PW[7:0] x tsubPWG/sub */
    using TIM_ECR_PW = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 8, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: tsubPWG/sub = (2sup(PWPRSC[2:0])/sup) x tsubtim_ker_ck/sub */
    using TIM_ECR_PWPRSC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Selects tim_ti1[15:0] input ... Refer to Section 29.4.2: TIM2/TIM3 pins and internal signals for product specific implementation. */
    ...
    /** @brief Selects tim_ti2[15:0] input ... Refer to Section 29.4.2: TIM2/TIM3 pins and internal signals for product specific implementation. */
    using TIM_TISEL_TI2SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_TISEL_TI2SEL_B_0x0 = 0;
        /** @brief tim_ti2_in1 */
    constexpr std::uint32_t TIM_TISEL_TI2SEL_B_0x1 = 1;
        /** @brief tim_ti2_in15 */
    constexpr std::uint32_t TIM_TISEL_TI2SEL_B_0xF = 15;

    /** @brief Selects tim_ti3[15:0] input ... Refer to Section 29.4.2: TIM2/TIM3 pins and internal signals for product specific implementation. */
    using TIM_TISEL_TI3SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_TISEL_TI3SEL_B_0x0 = 0;
        /** @brief tim_ti3_in1 */
    constexpr std::uint32_t TIM_TISEL_TI3SEL_B_0x1 = 1;
        /** @brief tim_ti3_in15 */
    constexpr std::uint32_t TIM_TISEL_TI3SEL_B_0xF = 15;

    /** @brief Selects tim_ti4[15:0] input ... Refer to Section 29.4.2: TIM2/TIM3 pins and internal signals for product specific implementation. */
    using TIM_TISEL_TI4SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_TISEL_TI4SEL_B_0x0 = 0;
        /** @brief tim_ti4_in1 */
    constexpr std::uint32_t TIM_TISEL_TI4SEL_B_0x1 = 1;
        /** @brief tim_ti4_in15 */
    constexpr std::uint32_t TIM_TISEL_TI4SEL_B_0xF = 15;
    ...
    /** @brief etr_in source selection These bits select the etr_in input source. ... Refer to Section 29.4.2: TIM2/TIM3 pins and internal signals for product specific implementation. */
    using TIM_AF1_ETRSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM_AF1_ETRSEL_B_0x0 = 0;
        /** @brief tim_etr1 */
    constexpr std::uint32_t TIM_AF1_ETRSEL_B_0x1 = 1;
        /** @brief tim_etr15 */
    constexpr std::uint32_t TIM_AF1_ETRSEL_B_0xF = 15;
    ...
    /** @brief ocref_clr source selection These bits select the ocref_clr input source. ... Refer to Section 29.4.2: TIM2/TIM3 pins and internal signals for product specific implementation. */
    ...
    constexpr std::uint32_t TIM_DCR_DBL_B_0x2 = 2;
        /** @brief 26 transfers */
    constexpr std::uint32_t TIM_DCR_DBL_B_0x1A = 26;
    ...
    constexpr std::uint32_t TIM_DCR_DBSS_B_0x2 = 2;
        /** @brief CC2 */
    constexpr std::uint32_t TIM_DCR_DBSS_B_0x3 = 3;
        /** @brief CC3 */
    constexpr std::uint32_t TIM_DCR_DBSS_B_0x4 = 4;
        /** @brief CC4 */
    constexpr std::uint32_t TIM_DCR_DBSS_B_0x5 = 5;
        /** @brief COM */
    constexpr std::uint32_t TIM_DCR_DBSS_B_0x6 = 6;
        /** @brief Trigger */
    constexpr std::uint32_t TIM_DCR_DBSS_B_0x7 = 7;
