...
#ifndef EMBEDDED_PP_STM32WBA54_SEC_RNG_HPP
#define EMBEDDED_PP_STM32WBA54_SEC_RNG_HPP
...
namespace STM32WBA54::SEC_RNG {
    ...
    /** @brief Non NIST compliant two conditioning loops are performed and 256 bits of noise source are used. Writing this bit is taken into account only if CONDRST bit is set to 1 in the same access, while CONFIGLOCK remains at 0. Writing to this bit is ignored if CONFIGLOCK = 1. */
     ...
     *          - B_0x1: Custom values for NIST compliant RNG. See Section 26.6: RNG entropy source validation for proposed configuration. (value: 1)
     */
    ...
    constexpr std::uint32_t RNG_CR_NISTC_B_0x0 = 0;
        /** @brief Custom values for NIST compliant RNG. See Section 26.6: RNG entropy source validation for proposed configuration. */
     ...
     *          - B_0x2: 2sup2/sup (= 4) RNG clock cycles per internal RNG clock. (value: 2)
     *          - B_0xF: 2sup15/sup RNG clock cycles per internal clock (for example. an incoming 48 MHz RNG clock becomes a 1.5 kHz internal RNG clock) (value: 15)
     */
    ...
    constexpr std::uint32_t RNG_CR_CLKDIV_B_0x1 = 1;
        /** @brief 2sup2/sup (= 4) RNG clock cycles per internal RNG clock. */
    constexpr std::uint32_t RNG_CR_CLKDIV_B_0x2 = 2;
        /** @brief 2sup15/sup RNG clock cycles per internal clock (for example. an incoming 48 MHz RNG clock becomes a 1.5 kHz internal RNG clock) */
