...
#ifndef EMBEDDED_PP_STM32WBA55_SEC_ADC4_HPP
#define EMBEDDED_PP_STM32WBA55_SEC_ADC4_HPP
...
namespace STM32WBA55::SEC_ADC4 {
    ...
    /** @brief End of sampling flag This bit is set by hardware during the conversion, at the end of the sampling phase.It is cleared by software by writing 1 to it. */
    ...
    /** @brief Analog watchdog 1 flag This bit is set by hardware when the converted voltage crosses the values programmed in ADC_TR1 and ADC_HR1 registers. It is cleared by software by writing 1 to it. */
    ...
    /** @brief Analog watchdog 2 flag This bit is set by hardware when the converted voltage crosses the values programmed in ADC_AWD2TR and ADC_AWD2TR registers. It is cleared by software writing 1 to it. */
    ...
    /** @brief Analog watchdog 3 flag This bit is set by hardware when the converted voltage crosses the values programmed in ADC_AWD3TR and ADC_AWD3TR registers. It is cleared by software by writing 1 to it. */
    ...
    /** @brief LDO ready This bit is set by hardware. It indicates that the ADC internal LDO output is ready. It is cleared by software by writing 1 to it. */
    ...
    /** @brief ADC ready interrupt enable This bit is set and cleared by software to enable/disable the ADC Ready interrupt. Note: The software is allowed to write this bit only when ADSTART bit is cleared to 0 by writing ADSTP to 1 (this ensures that no conversion is ongoing). */
    ...
    /** @brief End of sampling flag interrupt enable This bit is set and cleared by software to enable/disable the end of the sampling phase interrupt. Note: The software is allowed to write this bit only when ADSTART bit is cleared to 0 by writing ADSTP to 1 (this ensures that no conversion is ongoing). */
    ...
    /** @brief End of conversion interrupt enable This bit is set and cleared by software to enable/disable the end of conversion interrupt. Note: The software is allowed to write this bit only when ADSTART bit is cleared to 0 by writing ADSTP to 1 (this ensures that no conversion is ongoing). */
    ...
    /** @brief Overrun interrupt enable This bit is set and cleared by software to enable/disable the overrun interrupt. Note: The software is allowed to write this bit only when ADSTART bit is cleared to 0 by writing ADSTP to 1 (this ensures that no conversion is ongoing). */
    ...
    /** @brief Analog watchdog 1 interrupt enable This bit is set and cleared by software to enable/disable the analog watchdog interrupt. Note: The Software is allowed to write this bit only when ADSTART bit is cleared to 0 by writing ADSTP to 1 (this ensures that no conversion is ongoing). */
    ...
    /** @brief Analog watchdog 2 interrupt enable This bit is set and cleared by software to enable/disable the analog watchdog interrupt. Note: The Software is allowed to write this bit only when ADSTART bit is cleared to 0 by writing ADSTP to 1 (this ensures that no conversion is ongoing). */
    ...
    /** @brief Analog watchdog 3 interrupt enable This bit is set and cleared by software to enable/disable the analog watchdog interrupt. Note: The Software is allowed to write this bit only when ADSTART bit is cleared to 0 by writing ADSTP to 1 (this ensures that no conversion is ongoing). */
    ...
    /** @brief End of calibration interrupt enable This bit is set and cleared by software to enable/disable the end of calibration interrupt. Note: The software is allowed to write this bit only when ADSTART bit is cleared to 0 by writing ADSTP to 1 (this ensures that no conversion is ongoing). */
    ...
    /** @brief LDO ready interrupt enable This bit is set and cleared by software. It is used to enable/disable the LDORDY interrupt. Note: The software is allowed to write this bit only when ADSTART bit is cleared to 0 by writing ADSTP to 1 (this ensure that no conversion is ongoing). */
     ...
     *          - B_0x1: LDO ready interrupt enabled. An interrupt is generated when the LDO output is ready. (value: 1)
     */
        /** @brief LDO ready interrupt disabled */
    constexpr std::uint32_t ADC_IER_LDORDYIE_B_0x0 = 0;
        /** @brief LDO ready interrupt enabled. An interrupt is generated when the LDO output is ready. */
    constexpr std::uint32_t ADC_IER_LDORDYIE_B_0x1 = 1;
    ...
    /** @brief Data resolution These bits are written by software to select the resolution of the conversion. Note: The software is allowed to write these bits only when ADSTART bit is cleared to 0 by writing ADSTP to 1 (this ensures that no conversion is ongoing). */
    ...
    /** @details Possible values:
     *          - B_0x0: Upward scan (from CHSEL0 to CHSEL11) (value: 0)
     *          - B_0x1: Backward scan (from CHSEL11 to CHSEL0) (value: 1)
     */
        /** @brief Upward scan (from CHSEL0 to CHSEL11) */
    constexpr std::uint32_t ADC_CFGR1_SCANDIR_B_0x0 = 0;
        /** @brief Backward scan (from CHSEL11 to CHSEL0) */
    ...
    /** @brief Overrun management mode This bit is set and cleared by software and configure the way data overruns are managed. Note: The software is allowed to write this bit only when ADSTART bit is cleared to 0 by writing ADSTP to 1 (this ensures that no conversion is ongoing). */
    ...
    /** @brief Single / continuous conversion mode This bit is set and cleared by software. If it is set, conversion takes place continuously until it is cleared. Note: It is not possible to have both discontinuous mode and continuous mode enabled: it is forbidden to set both bits DISCEN = 1 and CONT = 1. Note: The software is allowed to write this bit only when ADSTART bit is cleared to 0 by writing ADSTP to 1 (this ensures that no conversion is ongoing). */
    ...
    /** @brief Wait conversion mode This bit is set and cleared by software to enable/disable wait conversion mode.sup./sup Note: The software is allowed to write this bit only when ADSTART bit is cleared to 0 by writing ADSTP to 1 (this ensures that no conversion is ongoing). */
    ...
    /** @brief Mode selection of the ADC_CHSELR register This bit is set and cleared by software to control the ADC_CHSELR feature: Note: The software is allowed to write this bit only when ADSTART bit is cleared to 0 by writing ADSTP to 1 (this ensures that no conversion is ongoing). */
    ...
    /** @brief Analog watchdog enable This bit is set and cleared by software. Note: The software is allowed to write this bit only when ADSTART bit is cleared to 0 by writing ADSTP to 1 (this ensures that no conversion is ongoing). */
    ...
    /** @brief Analog watchdog channel selection These bits are set and cleared by software. They select the input channel to be guarded by the analog watchdog. ..... Others: Reserved The channel selected by the AWDCH[4:0] bits must be also set into the CHSELR register. Note: The software is allowed to write this bit only when ADSTART bit is cleared to 0 by writing ADSTP to 1 (this ensures that no conversion is ongoing). */
     ...
     *          - B_0xB: ADC analog input Channel 11 monitored by AWD (value: 11)
     */
    ...
    constexpr std::uint32_t ADC_CFGR1_AWD1CH_B_0x1 = 1;
        /** @brief ADC analog input Channel 11 monitored by AWD */
    constexpr std::uint32_t ADC_CFGR1_AWD1CH_B_0xB = 11;
    ...
    /** @brief Oversampler Enable This bit is set and cleared by software. Note: Software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    ...
    /** @brief Oversampling ratio This bit filed defines the number of oversampling ratio. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    ...
    /** @brief Oversampling shift This bit is set and cleared by software. Others: Reserved Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1(which ensures that no conversion is ongoing). */
    ...
    /** @brief Triggered Oversampling This bit is set and cleared by software. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    ...
    /** @brief Low frequency trigger mode enable This bit must be set by software. Note: The software is allowed to write this bit only when ADSTART bit is cleared to 0 by writing ADSTP to 1 (this ensures that no conversion is ongoing). */
    ...
    /** @brief Sampling time selection 1 These bits are written by software to select the sampling time that applies to all channels. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
     ...
     *          - B_0x7: 814.5 ADC clock cycles (value: 7)
     */
    ...
    constexpr std::uint32_t ADC_SMPR_SMP1_B_0x6 = 6;
        /** @brief 814.5 ADC clock cycles */
    constexpr std::uint32_t ADC_SMPR_SMP1_B_0x7 = 7;

    /** @brief Sampling time selection 2 These bits are written by software to select the sampling time that applies to all channels. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    ...
    /** @brief Channel-x sampling time selection These bits are written by software to define which sampling time is used. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    ...
    /** @brief Analog watchdog 1 lower threshold These bits are written by software to define the lower threshold for the analog watchdog. Refer to Section 20.4.25: Analog window watchdog on page 638. */
    using ADC_AWD1TR_LT1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Analog watchdog 1 higher threshold These bits are written by software to define the higher threshold for the analog watchdog. Refer to Section 20.4.25: Analog window watchdog on page 638. */
    ...
    /** @brief Analog watchdog 2 lower threshold These bits are written by software to define the lower threshold for the analog watchdog. Refer to Section 20.4.25: Analog window watchdog on page 638. */
    using ADC_AWD2TR_LT2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Analog watchdog 2 higher threshold These bits are written by software to define the higher threshold for the analog watchdog. Refer to Section 20.4.25: Analog window watchdog on page 638. */
    ...
    using ADC_CHSELR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x28, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Channel x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_CHSEL0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t ADC_CHSELR_CHSEL0_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL0_B_0x1 = 1;

    /** @brief Channel x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_CHSEL1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL1_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL1_B_0x1 = 1;

    /** @brief Channel x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_CHSEL2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL2_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL2_B_0x1 = 1;

    /** @brief Channel x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_CHSEL3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL3_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL3_B_0x1 = 1;

    /** @brief Channel x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_CHSEL4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL4_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL4_B_0x1 = 1;

    /** @brief Channel x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_CHSEL5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL5_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL5_B_0x1 = 1;

    /** @brief Channel x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_CHSEL6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL6_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL6_B_0x1 = 1;

    /** @brief Channel x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_CHSEL7 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL7_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL7_B_0x1 = 1;

    /** @brief Channel x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_CHSEL8 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL8_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL8_B_0x1 = 1;

    /** @brief Channel x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_CHSEL9 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL9_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL9_B_0x1 = 1;

    /** @brief Channel x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_CHSEL10 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL10_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL10_B_0x1 = 1;

    /** @brief Channel x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_CHSEL11 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL11_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL11_B_0x1 = 1;

    /** @brief Channel x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_CHSEL12 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL12_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL12_B_0x1 = 1;

    /** @brief Channel x selection These bits are written by software and define which channels are part of the sequence of channels to be converted. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_CHSEL13 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Input Channel-x is not selected for conversion (value: 0)
     *          - B_0x1: Input Channel-x is selected for conversion (value: 1)
     */
        /** @brief Input Channel-x is not selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL13_B_0x0 = 0;
        /** @brief Input Channel-x is selected for conversion */
    constexpr std::uint32_t ADC_CHSELR_CHSEL13_B_0x1 = 1;

    /** @brief ADC channel selection register [alternate] */
    using ADC_CHSELR_ALTERNATE = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x28, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief 1st conversion of the sequence These bits are programmed by software with the channel number assigned to the 1st conversion of the sequence. 0b1111 indicates end of the sequence. When 0b1111 (end of sequence) is programmed to the lower sequence channels, these bits are ignored. Refer to SQ8[3:0] for a definition of channel selection. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_ALTERNATE_SQ1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief 2nd conversion of the sequence These bits are programmed by software with the channel number assigned to the 2nd conversion of the sequence. 0b1111 indicates end of the sequence. When 0b1111 (end of sequence) is programmed to the lower sequence channels, these bits are ignored. Refer to SQ8[3:0] for a definition of channel selection. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_ALTERNATE_SQ2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief 3rd conversion of the sequence These bits are programmed by software with the channel number assigned to the 3rd conversion of the sequence. 0b1111 indicates end of the sequence. When 0b1111 (end of sequence) is programmed to the lower sequence channels, these bits are ignored. Refer to SQ8[3:0] for a definition of channel selection. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_ALTERNATE_SQ3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief 4th conversion of the sequence These bits are programmed by software with the channel number assigned to the 4th conversion of the sequence. 0b1111 indicates end of the sequence. When 0b1111 (end of sequence) is programmed to the lower sequence channels, these bits are ignored. Refer to SQ8[3:0] for a definition of channel selection. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1(which ensures that no conversion is ongoing). */
    using ADC_CHSELR_ALTERNATE_SQ4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief 5th conversion of the sequence These bits are programmed by software with the channel number assigned to the 5th conversion of the sequence. 0b1111 indicates end of the sequence. When 0b1111 (end of sequence) is programmed to the lower sequence channels, these bits are ignored. Refer to SQ8[3:0] for a definition of channel selection. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_ALTERNATE_SQ5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief 6th conversion of the sequence These bits are programmed by software with the channel number assigned to the 6th conversion of the sequence. 0b1111 indicates end of the sequence. When 0b1111 (end of sequence) is programmed to the lower sequence channels, these bits are ignored. Refer to SQ8[3:0] for a definition of channel selection. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_ALTERNATE_SQ6 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief 7th conversion of the sequence These bits are programmed by software with the channel number assigned to the 7th conversion of the sequence. 0b1111 indicates end of the sequence. When 0b1111 (end of sequence) is programmed to the lower sequence channels, these bits are ignored. Refer to SQ8[3:0] for a definition of channel selection. Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_ALTERNATE_SQ7 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief 8th conversion of the sequence These bits are programmed by software with the channel number assigned to the 8th conversion of the sequence. 0b1111 indicates the end of the sequence. When 0b1111 (end of sequence) is programmed to the lower sequence channels, these bits are ignored. ... Note: The software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CHSELR_ALTERNATE_SQ8 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: CH0 (value: 0)
     *          - B_0x1: CH1 (value: 1)
     *          - B_0xA: CH10 (value: 10)
     ...
     */
        /** @brief CH0 */
    constexpr std::uint32_t ADC_CHSELR_ALTERNATE_SQ8_B_0x0 = 0;
        /** @brief CH1 */
    constexpr std::uint32_t ADC_CHSELR_ALTERNATE_SQ8_B_0x1 = 1;
        /** @brief CH10 */
    constexpr std::uint32_t ADC_CHSELR_ALTERNATE_SQ8_B_0xA = 10;
        /** @brief CH11 */
    constexpr std::uint32_t ADC_CHSELR_ALTERNATE_SQ8_B_0xB = 11;
        /** @brief CH12 */
    constexpr std::uint32_t ADC_CHSELR_ALTERNATE_SQ8_B_0xC = 12;
        /** @brief CH13 */
    constexpr std::uint32_t ADC_CHSELR_ALTERNATE_SQ8_B_0xD = 13;
        /** @brief No channel selected (End of sequence) */
    constexpr std::uint32_t ADC_CHSELR_ALTERNATE_SQ8_B_0xF = 15;

    /** @brief ADC watchdog threshold register */
    using ADC_AWD3TR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x2C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Analog watchdog 3lower threshold These bits are written by software to define the lower threshold for the analog watchdog. Refer to Section 20.4.25: Analog window watchdog on page 638. */
    using ADC_AWD3TR_LT3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 12, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Analog watchdog 3 higher threshold These bits are written by software to define the higher threshold for the analog watchdog. Refer to Section 20.4.25: Analog window watchdog on page 638. */
    ...
    /** @brief Auto-off mode bit This bit is set and cleared by software. it is used to enable/disable the Auto-off mode. Note: The software is allowed to write this bit only when ADEN bit is cleared to 0 (this ensures that no conversion is ongoing). */
    ...
    constexpr std::uint32_t ADC_PWR_AUTOFF_B_0x0 = 0;
        /** @brief Auto-off mode enabled */
    constexpr std::uint32_t ADC_PWR_AUTOFF_B_0x1 = 1;
    ...
    constexpr std::uint32_t ADC_PWR_DPD_B_0x0 = 0;
        /** @brief Deep-power-down mode enabled */
    constexpr std::uint32_t ADC_PWR_DPD_B_0x1 = 1;
    ...
    /** @brief VsubREFINT/sub enable This bit is set and cleared by software to enable/disable the VsubREFINT/sub buffer. Note: Software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CCR_VREFEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: VsubREFINT/sub disabled (value: 0)
     *          - B_0x1: VsubREFINT/sub enabled (value: 1)
     */
        /** @brief VsubREFINT/sub disabled */
    constexpr std::uint32_t ADC_CCR_VREFEN_B_0x0 = 0;
        /** @brief VsubREFINT/sub enabled */
    constexpr std::uint32_t ADC_CCR_VREFEN_B_0x1 = 1;

    /** @brief Temperature sensor selection This bit is set and cleared by software to enable/disable the temperature sensor. Note: Software is allowed to write this bit only when ADSTART is cleared to 0 by writing ADSTP to 1 (which ensures that no conversion is ongoing). */
    using ADC_CCR_VSENSESEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Temperature sensor disabled (value: 0)
     *          - B_0x1: Temperature sensor enabled (value: 1)
     */
        /** @brief Temperature sensor disabled */
    constexpr std::uint32_t ADC_CCR_VSENSESEL_B_0x0 = 0;
        /** @brief Temperature sensor enabled */
    constexpr std::uint32_t ADC_CCR_VSENSESEL_B_0x1 = 1;
