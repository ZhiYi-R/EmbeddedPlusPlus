...
#ifndef EMBEDDED_PP_STM32WBA55_SEC_RTC_HPP
#define EMBEDDED_PP_STM32WBA55_SEC_RTC_HPP
...
namespace STM32WBA55::SEC_RTC {
    ...
    /** @brief RTC_REFIN reference clock detection enable (50 or 60Hz) Note: BIN must be 0x00 and PREDIV_S must be 0x00FF. */
    ...
    /** @brief Calibration output selection When COE = 1, this bit selects which signal is output on CALIB. These frequencies are valid for RTCCLK at 32.768kHz and prescalers at their default values (PREDIV_A = 127 and PREDIV_S = 255). Refer to Section74.3.18: Calibration clock output. */
    ...
    /** @brief Activate timestamp on tamper detection event TAMPTS is valid even if TSE = 0 in the RTC_CR register. Timestamp flag is set up to 3 ck_apre cycles after the tamper flags. */
    ...
    /** @brief RTC_OUT2 output enable With this bit set, the RTC outputs can be remapped on RTC_OUT2 as follows: OUT2EN=0: RTC output 2 disable If OSEL different 00 or TAMPOE = 1: TAMPALRM is output on RTC_OUT1 If OSEL=00 and TAMPOE=0 and COE=1: CALIB is output on RTC_OUT1 OUT2EN = 1: RTC output 2 enable If (OSEL different 00 or TAMPOE = 1) and COE = 0: TAMPALRM is output on RTC_OUT2 If OSEL=00 and TAMPOE=0 and COE=1: CALIB is output on RTC_OUT2 If (OSEL different 00 or TAMPOE = 1) and COE = 1: CALIB is output on RTC_OUT2 and TAMPALRM is output on RTC_OUT1. */
    ...
    /** @brief Wakeup timer privilege protection */
    using RTC_PRIVCFGR_WUTPRIV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: RTC Wakeup timer configuration and interrupt clear can be written when the APB access is privileged or non-privileged. (value: 0)
     *          - B_0x1: RTC Wakeup timer configuration and interrupt clear can be written only when the APB access is privileged. (value: 1)
     */
        /** @brief RTC Wakeup timer configuration and interrupt clear can be written when the APB access is privileged or non-privileged. */
    constexpr std::uint32_t RTC_PRIVCFGR_WUTPRIV_B_0x0 = 0;
        /** @brief RTC Wakeup timer configuration and interrupt clear can be written only when the APB access is privileged. */
    ...
    /** @details Possible values:
     *          - B_0x0: RTC alarm A and SSR underflow configuration and interrupt clear can be written when the APB access is secure or non-secure. (value: 0)
     ...
     */
        /** @brief RTC alarm A and SSR underflow configuration and interrupt clear can be written when the APB access is secure or non-secure. */
    ...
    /** @details Possible values:
     *          - B_0x0: RTC alarm B configuration and interrupt clear can be written when the APB access is secure or non-secure. (value: 0)
     *          - B_0x1: RTC alarm B configuration and interrupt clear can be written only when the APB access is secure. (value: 1)
     */
        /** @brief RTC alarm B configuration and interrupt clear can be written when the APB access is secure or non-secure. */
    ...
    /** @brief Wakeup timer protection */
    using RTC_SECCFGR_WUTSEC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: RTC wakeup timer configuration and interrupt clear can be written when the APB access is secure or non-secure. (value: 0)
     *          - B_0x1: RTC wakeup timer configuration and interrupt clear can be written only when the APB access is secure. (value: 1)
     */
        /** @brief RTC wakeup timer configuration and interrupt clear can be written when the APB access is secure or non-secure. */
    constexpr std::uint32_t RTC_SECCFGR_WUTSEC_B_0x0 = 0;
        /** @brief RTC wakeup timer configuration and interrupt clear can be written only when the APB access is secure. */
    ...
    /** @details Possible values:
     *          - B_0x0: RTC timestamp configuration and interrupt clear can be written when the APB access is secure or non-secure. (value: 0)
     *          - B_0x1: RTC timestamp configuration and interrupt clear can be written only when the APB access is secure. (value: 1)
     */
        /** @brief RTC timestamp configuration and interrupt clear can be written when the APB access is secure or non-secure. */
    ...
    /** @details Possible values:
     *          - B_0x0: Shift register, daylight saving, calibration and reference clock can be written when the APB access is secure or non-secure. (value: 0)
     ...
     */
        /** @brief Shift register, daylight saving, calibration and reference clock can be written when the APB access is secure or non-secure. */
    ...
    /** @details Possible values:
     *          - B_0x0: RTC Initialization mode, calendar and prescalers registers can be written when the APB access is secure or non-secure. (value: 0)
     ...
     */
        /** @brief RTC Initialization mode, calendar and prescalers registers can be written when the APB access is secure or non-secure. */
    ...
    /** @details Possible values:
     *          - B_0x0: All RTC registers can be written when the APB access is secure or non-secure, except the registers protected by other secure protection bits. (value: 0)
     *          - B_0x1: All RTC registers can be written only when the APB access is secure. (value: 1)
     */
        /** @brief All RTC registers can be written when the APB access is secure or non-secure, except the registers protected by other secure protection bits. */
    ...
    /** @brief Calibration minus The frequency of the calendar is reduced by masking CALM out of 2sup20/sup RTCCLK pulses (32seconds if the input frequency is 32768Hz). This decreases the frequency of the calendar with a resolution of 0.9537ppm. To increase the frequency of the calendar, this feature should be used in conjunction with CALP. See Section74.3.16: RTC smooth digital calibration on page4278. */
    ...
    /** @details Possible values:
     *          - B_0x0: Calibration window is 2sup20/sup RTCCLK, which is a high-consumption mode. This mode must be set only when less than 32s calibration window is required. (value: 0)
     *          - B_0x1: Calibration window is 2sup20/sup ck_apre, which is the required configuration for ultra-low consumption mode. (value: 1)
     */
        /** @brief Calibration window is 2sup20/sup RTCCLK, which is a high-consumption mode. This mode must be set only when less than 32s calibration window is required. */
    constexpr std::uint32_t RTC_CALR_LPCAL_B_0x0 = 0;
        /** @brief Calibration window is 2sup20/sup ck_apre, which is the required configuration for ultra-low consumption mode. */
    constexpr std::uint32_t RTC_CALR_LPCAL_B_0x1 = 1;

    /** @brief Use a 16-second calibration cycle period When CALW16 is set to 1, the 16-second calibration cycle period is selected. This bit must not be set to 1 if CALW8 = 1. Note: CALM[0] is stuck at 0 when CALW16 = 1. Refer to Section74.3.16: RTC smooth digital calibration. */
    using RTC_CALR_CALW16 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 13, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Use an 8-second calibration cycle period When CALW8 is set to 1, the 8-second calibration cycle period is selected. Note: CALM[1:0] are stuck at 00 when CALW8 = 1. Refer to Section74.3.16: RTC smooth digital calibration. */
    using RTC_CALR_CALW8 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Increase frequency of RTC by 488.5ppm. This feature is intended to be used in conjunction with CALM, which lowers the frequency of the calendar with a fine resolution. if the input frequency is 32768 Hz, the number of RTCCLK pulses added during a 32 second window is calculated as follows: (512 * CALP) CALM. Refer to Section74.3.16: RTC smooth digital calibration. */
     ...
     *          - B_0x1: One RTCCLK pulse is effectively inserted every 2sup11/sup pulses (frequency increased by 488.5ppm). (value: 1)
     */
        /** @brief No RTCCLK pulses are added. */
    constexpr std::uint32_t RTC_CALR_CALP_B_0x0 = 0;
        /** @brief One RTCCLK pulse is effectively inserted every 2sup11/sup pulses (frequency increased by 488.5ppm). */
    ...
    /** @brief Subseconds value This value is compared with the contents of the synchronous prescaler counter to determine if alarm A is to be activated. Only bits 0 up MASKSS-1 are compared. This field is the mirror of SS[14:0] in the RTC_ALRMABINR, and so can also be read or written through RTC_ALRMABINR. */
     ...
     *          - B_0x1: SS[31:1] are don't care in Alarm A comparison. Only SS[0] is compared. (value: 1)
     */
    ...
    constexpr std::uint32_t RTC_ALRMASSR_MASKSS_B_0x0 = 0;
        /** @brief SS[31:1] are don't care in Alarm A comparison. Only SS[0] is compared. */
     ...
     *          - B_0x1: The synchronous binary counter (SS[31:0] in RTC_SSR) is running from 0xFFFFFFFF to RTC_ALRMABINR.SS[31:0] value and is automatically reloaded with 0xFFFFFFFF one ck_apre cycle after reaching RTC_ALRMABINR.SS[31:0]. (value: 1)
     */
        /** @brief The synchronous binary counter (SS[31:0] in RTC_SSR) is free-running. */
    constexpr std::uint32_t RTC_ALRMASSR_SSCLR_B_0x0 = 0;
        /** @brief The synchronous binary counter (SS[31:0] in RTC_SSR) is running from 0xFFFFFFFF to RTC_ALRMABINR.SS[31:0] value and is automatically reloaded with 0xFFFFFFFF one ck_apre cycle after reaching RTC_ALRMABINR.SS[31:0]. */
    ...
    /** @brief Subseconds value This value is compared with the contents of the synchronous prescaler counter to determine if alarm B is to be activated. Only bits 0 up to MASKSS-1 are compared. This field is the mirror of SS[14:0] in the RTC_ALRMBBINR, and so can also be read or written through RTC_ALRMBBINR. */
     ...
     *          - B_0x1: SS[31:1] are don't care in Alarm B comparison. Only SS[0] is compared. (value: 1)
     */
    ...
    constexpr std::uint32_t RTC_ALRMBSSR_MASKSS_B_0x0 = 0;
        /** @brief SS[31:1] are don't care in Alarm B comparison. Only SS[0] is compared. */
    ...
    /** @details Possible values:
     *          - B_0x0: The synchronous binary counter (SS[31:0] in RTC_SSR) is free-running. (value: 0)
     *          - B_0x1: The synchronous binary counter (SS[31:0] in RTC_SSR) is running from 0xFFFFFFFF to RTC_ALRMBBINR.SS[31:0] value and is automatically reloaded with 0xFFFFFFFF one ck_apre cycle after reaching RTC_ALRMBBINR.SS[31:0]. (value: 1)
     */
        /** @brief The synchronous binary counter (SS[31:0] in RTC_SSR) is free-running. */
    constexpr std::uint32_t RTC_ALRMBSSR_SSCLR_B_0x0 = 0;
        /** @brief The synchronous binary counter (SS[31:0] in RTC_SSR) is running from 0xFFFFFFFF to RTC_ALRMBBINR.SS[31:0] value and is automatically reloaded with 0xFFFFFFFF one ck_apre cycle after reaching RTC_ALRMBBINR.SS[31:0]. */
    ...
    /** @brief Alarm A masked flag This flag is set by hardware when the alarm A non-secure interrupt occurs. */
    using RTC_MISR_ALRAMF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Alarm B non-secure masked flag This flag is set by hardware when the alarm B non-secure interrupt occurs. */
    using RTC_MISR_ALRBMF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Wakeup timer non-secure masked flag This flag is set by hardware when the wakeup timer non-secure interrupt occurs. This flag must be cleared by software at least 1.5 RTCCLK periods before WUTF is set to 1 again. */
    using RTC_MISR_WUTMF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Timestamp non-secure masked flag This flag is set by hardware when a timestamp non-secure interrupt occurs. */
    using RTC_MISR_TSMF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Timestamp overflow non-secure masked flag This flag is set by hardware when a timestamp interrupt occurs while TSMF is already set. It is recommended to check and then clear TSOVF only after clearing the TSF bit. Otherwise, an overflow might not be noticed if a timestamp event occurs immediately before the TSF bit is cleared. */
    using RTC_MISR_TSOVMF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SSR underflow non-secure masked flag This flag is set by hardware when the SSR underflow non-secure interrupt occurs. */
    ...
    /** @brief Alarm A interrupt secure masked flag This flag is set by hardware when the alarm A secure interrupt occurs. */
    using RTC_SMISR_ALRAMF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Alarm B interrupt secure masked flag This flag is set by hardware when the alarm B secure interrupt occurs. */
    using RTC_SMISR_ALRBMF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Wakeup timer interrupt secure masked flag This flag is set by hardware when the wakeup timer secure interrupt occurs. This flag must be cleared by software at least 1.5 RTCCLK periods before WUTF is set to 1 again. */
    using RTC_SMISR_WUTMF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Timestamp interrupt secure masked flag This flag is set by hardware when a timestamp secure interrupt occurs. */
    using RTC_SMISR_TSMF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Timestamp overflow interrupt secure masked flag This flag is set by hardware when a timestamp secure interrupt occurs while TSMF is already set. It is recommended to check and then clear TSOVF only after clearing the TSF bit. Otherwise, an overflow might not be noticed if a timestamp event occurs immediately before the TSF bit is cleared. */
    using RTC_SMISR_TSOVMF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SSR underflow secure masked flag This flag is set by hardware when the SSR underflow secure interrupt occurs. */
    ...
    /** @brief Clear timestamp flag Writing 1 in this bit clears the TSF bit in the RTC_SR register. */
