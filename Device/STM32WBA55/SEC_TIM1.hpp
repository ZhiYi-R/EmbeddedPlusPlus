...
#ifndef EMBEDDED_PP_STM32WBA55_SEC_TIM1_HPP
#define EMBEDDED_PP_STM32WBA55_SEC_TIM1_HPP
...
namespace STM32WBA55::SEC_TIM1 {
    ...
    /** @brief Clock division This bit-field indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (tsubDTS/sub)used by the dead-time generators and the digital filters (tim_etr_in, tim_tix), */
    ...
    /** @brief Selects tim_ti1[15:0] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list. */
    ...
    /** @brief Selects tim_ti2[15:0] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list. */
    ...
    /** @brief Selects tim_ti3[15:0] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list. */
    ...
    /** @brief Selects tim_ti4[15:0] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list. */
    ...
    /** @brief etr_in source selection These bits select the etr_in input source. ... Refer to Section 28.3.2: TIM1 pins and internal signals for product specific implementation. Note: These bits can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
    ...
    /** @brief ocref_clr source selection These bits select the ocref_clr input source. ... Refer to Section 28.3.2: TIM1 pins and internal signals for product specific information. Note: These bits can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). */
