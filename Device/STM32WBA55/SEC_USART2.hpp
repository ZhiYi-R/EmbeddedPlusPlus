...
#ifndef EMBEDDED_PP_STM32WBA55_SEC_USART2_HPP
#define EMBEDDED_PP_STM32WBA55_SEC_USART2_HPP
...
namespace STM32WBA55::SEC_USART2 {
    ...
    /** @details Possible values:
     *          - B_0x0: USART not functional in low-power mode. (value: 0)
     *          - B_0x1: USART functional in low-power mode. (value: 1)
     */
        /** @brief USART not functional in low-power mode. */
    constexpr std::uint32_t USART_CR1_UESM_B_0x0 = 0;
        /** @brief USART functional in low-power mode. */
    ...
    /** @brief Receiver timeout interrupt enable This bit is set and cleared by software. Note: If the USART does not support the Receiver timeout feature, this bit is reserved and must be kept at reset value. Section 78.4: USART implementation on page 4565. */
    ...
    /** @brief End of Block interrupt enable This bit is set and cleared by software. Note: If the USART does not support Smartcard mode, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565. */
    ...
    /** @brief Synchronous Slave mode enable When the SLVEN bit is set, the Synchronous slave mode is enabled. Note: When SPI slave mode is not supported, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565. */
    ...
    /** @brief When the DIS_NSS bit is set, the NSS pin input is ignored. Note: When SPI slave mode is not supported, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565. */
    ...
    /** @brief LIN break detection interrupt enable Break interrupt mask (break detection using break delimiter). Note: If LIN mode is not supported, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565. */
    ...
    /** @brief Auto baud rate enable This bit is set and cleared by software. Note: If the USART does not support the auto baud rate feature, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565. */
    ...
    /** @brief IrDA mode enable This bit is set and cleared by software. This bit can only be written when the USART is disabled (UE=0). Note: If IrDA mode is not supported, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565. */
    ...
    /** @brief IrDA low-power This bit is used for selecting between normal and low-power IrDA modes This bit can only be written when the USART is disabled (UE=0). Note: If IrDA mode is not supported, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565. */
    ...
    /** @brief Smartcard NACK enable This bitfield can only be written when the USART is disabled (UE=0). Note: If the USART does not support Smartcard mode, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565. */
    ...
    /** @brief Smartcard mode enable This bit is used for enabling Smartcard mode. This bitfield can only be written when the USART is disabled (UE=0). Note: If the USART does not support Smartcard mode, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565. */
    ...
    /** @brief RTS enable This bit can only be written when the USART is disabled (UE=0). Note: If the hardware flow control feature is not supported, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565. */
    ...
    /** @brief CTS enable This bit can only be written when the USART is disabled (UE=0) Note: If the hardware flow control feature is not supported, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565. */
    ...
    /** @brief CTS interrupt enable Note: If the hardware flow control feature is not supported, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565. */
    ...
    /** @brief Driver enable polarity selection This bit can only be written when the USART is disabled (UE=0). Note: If the Driver Enable feature is not supported, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565. */
    ...
    /** @brief Transmission Complete before guard time, interrupt enable This bit is set and cleared by software. Note: If the USART does not support the Smartcard mode, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565. */
    ...
    /** @brief LIN break detection clear flag Writing 1 to this bit clears the LBDF flag in the USART_ISR register. Note: If LIN mode is not supported, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565. */
    using USART_ICR_LBDCF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CTS clear flag Writing 1 to this bit clears the CTSIF flag in the USART_ISR register. Note: If the hardware flow control feature is not supported, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565. */
    using USART_ICR_CTSCF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 9, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Receiver timeout clear flag Writing 1 to this bit clears the RTOF flag in the USART_ISR register. Note: If the USART does not support the Receiver timeout feature, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565. */
    using USART_ICR_RTOCF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief End of block clear flag Writing 1 to this bit clears the EOBF flag in the USART_ISR register. Note: If the USART does not support Smartcard mode, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565. */
    using USART_ICR_EOBCF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SPI slave underrun clear flag Writing 1 to this bit clears the UDRF flag in the USART_ISR register. Note: If the USART does not support SPI slave mode, this bit is reserved and must be kept at reset value. Refer to Section 78.4: USART implementation on page 4565 */
    ...
    /** @brief Receive data value Contains the received data character. The RDR register provides the parallel interface between the input shift register and the internal bus (see Figure 927). When receiving with the parity enabled, the value read in the MSB bit is the received parity bit. */
    ...
    using USART_AUTOCR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x30, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TDN transmission data number This bitfield enables the programming of the number of data to be transmitted. It can be written only when UE is cleared in USART_CR1. */
    using USART_AUTOCR_TDN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 16, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Trigger polarity bit This bitfield can be written only when the UE bit is cleared in USART_CR1 register. */
    using USART_AUTOCR_TRIGPOL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t USART_AUTOCR_TRIGPOL_B_0x0 = 0;
        /** @brief Trigger active on falling edge */
    constexpr std::uint32_t USART_AUTOCR_TRIGPOL_B_0x1 = 1;

    /** @brief Trigger enable bit Note: This bitfield can be written only when the UE bit of USART_CR1 register is cleared. Note: When a trigger is detected, TE is set to 1 in USART_CR1 and the data transfer is launched. */
    using USART_AUTOCR_TRIGEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Trigger disabled (value: 0)
     *          - B_0x1: Trigger enabled (value: 1)
     */
        /** @brief Trigger disabled */
    constexpr std::uint32_t USART_AUTOCR_TRIGEN_B_0x0 = 0;
        /** @brief Trigger enabled */
    constexpr std::uint32_t USART_AUTOCR_TRIGEN_B_0x1 = 1;
    ...
    using USART_AUTOCR_IDLEDIS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Idle frame sent after enabling the transmitter (TE = 1 in USART_CR1) (value: 0)
     *          - B_0x1: Idle frame not sent after enabling the transmitter (value: 1)
     */
        /** @brief Idle frame sent after enabling the transmitter (TE = 1 in USART_CR1) */
    constexpr std::uint32_t USART_AUTOCR_IDLEDIS_B_0x0 = 0;
        /** @brief Idle frame not sent after enabling the transmitter */
    constexpr std::uint32_t USART_AUTOCR_IDLEDIS_B_0x1 = 1;

    /** @brief Trigger selection bits Refer to Description of USART interconnections. This bitfield can be written only when the UE bit is cleared in USART_CR1 register. ... Note: This bitfield can be written only when the UE bit of USART_CR1 register is cleared. */
    using USART_AUTOCR_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: usart_trg0 selected (value: 0)
     *          - B_0x1: usart_trg1 selected (value: 1)
     *          - B_0xF: usart_trg15 selected (value: 15)
     */
        /** @brief usart_trg0 selected */
    constexpr std::uint32_t USART_AUTOCR_TRIGSEL_B_0x0 = 0;
        /** @brief usart_trg1 selected */
    constexpr std::uint32_t USART_AUTOCR_TRIGSEL_B_0x1 = 1;
        /** @brief usart_trg15 selected */
    constexpr std::uint32_t USART_AUTOCR_TRIGSEL_B_0xF = 15;
