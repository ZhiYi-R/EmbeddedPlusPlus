...
#ifndef EMBEDDED_PP_STM32WBA63_SEC_GPDMA_HPP
#define EMBEDDED_PP_STM32WBA63_SEC_GPDMA_HPP
...
namespace STM32WBA63::SEC_GPDMA {
     ...
     *          - B_0x1: the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol at a block level (see Section16. (value: 1)
     */
    ...
    constexpr std::uint32_t GPDMA_C0TR2_BREQ_B_0x0 = 0;
        /** @brief the selected hardware request is driven by a peripheral with a hardware request/acknowledge protocol at a block level (see Section16. */
     ...
     *          - B_0x1: channel x (x = 0 to 7), same as 0010: at link level: a LLI link transfer is conditioned by one hit trigger. (value: 1)
    ...
    constexpr std::uint32_t GPDMA_C0TR2_TRIGM_B_0x0 = 0;
        /** @brief channel x (x = 0 to 7), same as 0010: at link level: a LLI link transfer is conditioned by one hit trigger. */
     ...
     *          - B_0x1: channel x (x = 0 to 7), same as 00 (value: 1)
    ...
    constexpr std::uint32_t GPDMA_C0TR2_TCEM_B_0x0 = 0;
        /** @brief channel x (x = 0 to 7), same as 00 */
