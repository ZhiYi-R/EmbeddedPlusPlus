...
#ifndef EMBEDDED_PP_STM32WBA64_SEC_TAMP_HPP
#define EMBEDDED_PP_STM32WBA64_SEC_TAMP_HPP
...
namespace STM32WBA64::SEC_TAMP {
    ...
    /** @brief Configurable resource 1 protection */
    using TAMP_RPCFGR_RPCFG1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Resource 1 is not included in the device secrets protected by TAMP peripheral (value: 0)
     *          - B_0x1: Resource 1 is included in the device secrets protected by TAMP peripheral (value: 1)
     */
        /** @brief Resource 1 is not included in the device secrets protected by TAMP peripheral */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG1_B_0x0 = 0;
        /** @brief Resource 1 is included in the device secrets protected by TAMP peripheral */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG1_B_0x1 = 1;

    /** @brief Configurable resource 2 protection */
    using TAMP_RPCFGR_RPCFG2 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Resource 2 is not included in the device secrets protected by TAMP peripheral (value: 0)
     *          - B_0x1: Resource 2 is included in the device secrets protected by TAMP peripheral (value: 1)
     */
        /** @brief Resource 2 is not included in the device secrets protected by TAMP peripheral */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG2_B_0x0 = 0;
        /** @brief Resource 2 is included in the device secrets protected by TAMP peripheral */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG2_B_0x1 = 1;

    /** @brief Configurable resource 3 protection */
    using TAMP_RPCFGR_RPCFG3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Resource 3 is not included in the device secrets protected by TAMP peripheral (value: 0)
     *          - B_0x1: Resource 3 is included in the device secrets protected by TAMP peripheral (value: 1)
     */
        /** @brief Resource 3 is not included in the device secrets protected by TAMP peripheral */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG3_B_0x0 = 0;
        /** @brief Resource 3 is included in the device secrets protected by TAMP peripheral */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG3_B_0x1 = 1;

    /** @brief Configurable resource 4 protection */
    using TAMP_RPCFGR_RPCFG4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Resource 4 is not included in the device secrets protected by TAMP peripheral (value: 0)
     *          - B_0x1: Resource 4 is included in the device secrets protected by TAMP peripheral (value: 1)
     */
        /** @brief Resource 4 is not included in the device secrets protected by TAMP peripheral */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG4_B_0x0 = 0;
        /** @brief Resource 4 is included in the device secrets protected by TAMP peripheral */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG4_B_0x1 = 1;

    /** @brief Configurable resource 5 protection */
    using TAMP_RPCFGR_RPCFG5 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Resource 5 is not included in the device secrets protected by TAMP peripheral (value: 0)
     *          - B_0x1: Resource 5 is included in the device secrets protected by TAMP peripheral (value: 1)
     */
        /** @brief Resource 5 is not included in the device secrets protected by TAMP peripheral */
    constexpr std::uint32_t TAMP_RPCFGR_RPCFG5_B_0x0 = 0;
        /** @brief Resource 5 is included in the device secrets protected by TAMP peripheral */
