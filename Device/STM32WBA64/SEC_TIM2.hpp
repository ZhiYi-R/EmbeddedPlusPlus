...
#ifndef EMBEDDED_PP_STM32WBA64_SEC_TIM2_HPP
#define EMBEDDED_PP_STM32WBA64_SEC_TIM2_HPP
...
namespace STM32WBA64::SEC_TIM2 {
    ...
    using TIM2_CR2_ADSYNC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t TIM2_CCMR2_ALTERNATE1_OC3M_B_0x0 = 0;
        /** @brief Set channel 3 to active level on match. */
    constexpr std::uint32_t TIM2_CCMR2_ALTERNATE1_OC3M_B_0x1 = 1;
        /** @brief Set channel 3 to inactive level on match. */
    constexpr std::uint32_t TIM2_CCMR2_ALTERNATE1_OC3M_B_0x2 = 2;
        /** @brief Toggle - tim_oc3ref toggles when TIMx_CNT = TIMx_CCR3. */
    constexpr std::uint32_t TIM2_CCMR2_ALTERNATE1_OC3M_B_0x3 = 3;
        /** @brief Force inactive level - tim_oc3ref is forced low. */
    constexpr std::uint32_t TIM2_CCMR2_ALTERNATE1_OC3M_B_0x4 = 4;
        /** @brief Force active level - tim_oc3ref is forced high. */
    constexpr std::uint32_t TIM2_CCMR2_ALTERNATE1_OC3M_B_0x5 = 5;
        /** @brief PWM mode 1 - In up-counting, channel 3 is active as long as TIMx_CNTless thanTIMx_CCR3 else inactive. */
    constexpr std::uint32_t TIM2_CCMR2_ALTERNATE1_OC3M_B_0x6 = 6;
        /** @brief PWM mode 2 - In up-counting, channel 3 is inactive as long as TIMx_CNTless thanTIMx_CCR3 else active. */
    constexpr std::uint32_t TIM2_CCMR2_ALTERNATE1_OC3M_B_0x7 = 7;
    ...
    /** @brief TIM2 autoreload register */
    ...
    using TIM2_ECR_IBLK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    using TIM2_DCR_DBSS = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     ...
     */
        /** @brief Update */
    constexpr std::uint32_t TIM2_DCR_DBSS_B_0x1 = 1;
        /** @brief CC1 */
    constexpr std::uint32_t TIM2_DCR_DBSS_B_0x2 = 2;
        /** @brief CC2 */
    constexpr std::uint32_t TIM2_DCR_DBSS_B_0x3 = 3;
        /** @brief CC3 */
    constexpr std::uint32_t TIM2_DCR_DBSS_B_0x4 = 4;
        /** @brief CC4 */
    constexpr std::uint32_t TIM2_DCR_DBSS_B_0x5 = 5;
        /** @brief COM */
    constexpr std::uint32_t TIM2_DCR_DBSS_B_0x6 = 6;
        /** @brief Trigger */
    constexpr std::uint32_t TIM2_DCR_DBSS_B_0x7 = 7;
