...
#ifndef EMBEDDED_PP_STM32WBA65_SEC_I2C4_HPP
#define EMBEDDED_PP_STM32WBA65_SEC_I2C4_HPP
...
/** @brief I2C1 address block description */
namespace STM32WBA65::SEC_I2C4 {
     ...
     *          - B_0x1: Digital filter enabled and filtering capability up to one tless thansub I2CCLKless than/sub (value: 1)
     *          - B_0xF: digital filter enabled and filtering capability up to fifteen tless thansub I2CCLKless than/sub (value: 15)
     */
        /** @brief Digital filter disabled */
    constexpr std::uint32_t I2C_CR1_DNF_B_0x0 = 0;
        /** @brief Digital filter enabled and filtering capability up to one tless thansub I2CCLKless than/sub */
    constexpr std::uint32_t I2C_CR1_DNF_B_0x1 = 1;
        /** @brief digital filter enabled and filtering capability up to fifteen tless thansub I2CCLKless than/sub */
    ...
    /** @details Possible values:
     *          - B_0x0: Wake-up from Stop mode disabled. (value: 0)
     *          - B_0x1: Wake-up from Stop mode enabled. (value: 1)
     */
        /** @brief Wake-up from Stop mode disabled. */
    constexpr std::uint32_t I2C_CR1_WUPEN_B_0x0 = 0;
        /** @brief Wake-up from Stop mode enabled. */
    ...
    /** @details Possible values:
     *          - B_0x0: General call disabled. (value: 0)
     *          - B_0x1: General call enabled. (value: 1)
     */
        /** @brief General call disabled. */
    constexpr std::uint32_t I2C_CR1_GCEN_B_0x0 = 0;
        /** @brief General call enabled. */
    ...
    /** @details Possible values:
     *          - B_0x0: Host address disabled. (value: 0)
     *          - B_0x1: Host address enabled. (value: 1)
     */
        /** @brief Host address disabled. */
    constexpr std::uint32_t I2C_CR1_SMBHEN_B_0x0 = 0;
        /** @brief Host address enabled. */
    ...
    /** @details Possible values:
     *          - B_0x0: Device default address disabled. (value: 0)
     *          - B_0x1: Device default address enabled. (value: 1)
     */
        /** @brief Device default address disabled. */
    constexpr std::uint32_t I2C_CR1_SMBDEN_B_0x0 = 0;
        /** @brief Device default address enabled. */
    ...
    /** @details Possible values:
     *          - B_0x0: The SMBALERT# signal on SMBA pin is not supported in host mode (SMBHEN = 1). (value: 0)
     *          - B_0x1: The SMBALERT# signal on SMBA pin is supported in host mode (SMBHEN = 1). (value: 1)
     */
        /** @brief The SMBALERT# signal on SMBA pin is not supported in host mode (SMBHEN = 1). */
    constexpr std::uint32_t I2C_CR1_ALERTEN_B_0x0 = 0;
        /** @brief The SMBALERT# signal on SMBA pin is supported in host mode (SMBHEN = 1). */
    ...
    /** @details Possible values:
     *          - B_0x0: ADDR flag is set by hardware, cleared by software by setting ADDRCF bit. (value: 0)
     *          - B_0x1: ADDR flag remains cleared by hardware. (value: 1)
     */
        /** @brief ADDR flag is set by hardware, cleared by software by setting ADDRCF bit. */
    constexpr std::uint32_t I2C_CR1_ADDRACLR_B_0x0 = 0;
        /** @brief ADDR flag remains cleared by hardware. */
    ...
    /** @details Possible values:
     *          - B_0x0: STOPF flag is set by hardware, cleared by software by setting STOPCF bit. (value: 0)
     *          - B_0x1: STOPF flag remains cleared by hardware. (value: 1)
     */
        /** @brief STOPF flag is set by hardware, cleared by software by setting STOPCF bit. */
    constexpr std::uint32_t I2C_CR1_STOPFACLR_B_0x0 = 0;
        /** @brief STOPF flag remains cleared by hardware. */
    ...
    /** @details Possible values:
     *          - B_0x0: The master sends the complete 10-bit slave address read sequence: START + 2 bytes 10-bit address in write direction + RESTART + first seven bits of the 10-bit address in read direction. (value: 0)
     *          - B_0x1: The master sends only the first seven bits of the 10-bit address, followed by read direction. (value: 1)
     */
        /** @brief The master sends the complete 10-bit slave address read sequence: START + 2 bytes 10-bit address in write direction + RESTART + first seven bits of the 10-bit address in read direction. */
    constexpr std::uint32_t I2C_CR2_HEAD10R_B_0x0 = 0;
        /** @brief The master sends only the first seven bits of the 10-bit address, followed by read direction. */
     ...
     *          - B_0x1: The transfer is not completed after the NBYTES data transfer (NBYTES is reloaded). (value: 1)
     */
    ...
    constexpr std::uint32_t I2C_CR2_RELOAD_B_0x0 = 0;
        /** @brief The transfer is not completed after the NBYTES data transfer (NBYTES is reloaded). */
    ...
    /** @details Possible values:
     *          - B_0x0: Own address 1 disabled. (value: 0)
     *          - B_0x1: Own address 1 enabled. (value: 1)
     */
        /** @brief Own address 1 disabled. */
    constexpr std::uint32_t I2C_OAR1_OA1EN_B_0x0 = 0;
        /** @brief Own address 1 enabled. */
     ...
     *          - B_0x1: OA2[1] is masked and don't care. (value: 1)
     *          - B_0x2: OA2[2:1] are masked and don't care. (value: 2)
     *          - B_0x3: OA2[3:1] are masked and don't care. (value: 3)
     *          - B_0x4: OA2[4:1] are masked and don't care. (value: 4)
     *          - B_0x5: OA2[5:1] are masked and don't care. (value: 5)
     *          - B_0x6: OA2[6:1] are masked and don't care. (value: 6)
     *          - B_0x7: OA2[7:1] are masked and don't care. (value: 7)
     */
        /** @brief No mask */
    constexpr std::uint32_t I2C_OAR2_OA2MSK_B_0x0 = 0;
        /** @brief OA2[1] is masked and don't care. */
    constexpr std::uint32_t I2C_OAR2_OA2MSK_B_0x1 = 1;
        /** @brief OA2[2:1] are masked and don't care. */
    constexpr std::uint32_t I2C_OAR2_OA2MSK_B_0x2 = 2;
        /** @brief OA2[3:1] are masked and don't care. */
    constexpr std::uint32_t I2C_OAR2_OA2MSK_B_0x3 = 3;
        /** @brief OA2[4:1] are masked and don't care. */
    constexpr std::uint32_t I2C_OAR2_OA2MSK_B_0x4 = 4;
        /** @brief OA2[5:1] are masked and don't care. */
    constexpr std::uint32_t I2C_OAR2_OA2MSK_B_0x5 = 5;
        /** @brief OA2[6:1] are masked and don't care. */
    constexpr std::uint32_t I2C_OAR2_OA2MSK_B_0x6 = 6;
        /** @brief OA2[7:1] are masked and don't care. */
    ...
    /** @details Possible values:
     *          - B_0x0: Own address 2 disabled. (value: 0)
     *          - B_0x1: Own address 2 enabled. (value: 1)
     */
        /** @brief Own address 2 disabled. */
    constexpr std::uint32_t I2C_OAR2_OA2EN_B_0x0 = 0;
        /** @brief Own address 2 enabled. */
     ...
     *          - B_0x1: Extended clock timeout detection is enabled. (value: 1)
     */
        /** @brief Extended clock timeout detection is disabled */
    constexpr std::uint32_t I2C_TIMEOUTR_TEXTEN_B_0x0 = 0;
        /** @brief Extended clock timeout detection is enabled. */
    ...
    /** @brief Timeout or tless thansub LOWless than/sub detection flag */
    ...
    using I2C_AUTOCR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x2C, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DMA request enable on Transfer Complete event */
    using I2C_AUTOCR_TCDMAEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: DMA request not generated on Transfer Complete event (value: 0)
     *          - B_0x1: DMA request generated on Transfer Complete event (value: 1)
     */
        /** @brief DMA request not generated on Transfer Complete event */
    constexpr std::uint32_t I2C_AUTOCR_TCDMAEN_B_0x0 = 0;
        /** @brief DMA request generated on Transfer Complete event */
    constexpr std::uint32_t I2C_AUTOCR_TCDMAEN_B_0x1 = 1;

    /** @brief DMA request enable on Transfer Complete Reload event */
    using I2C_AUTOCR_TCRDMAEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 7, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: DMA request not generated on Transfer Complete Reload event (value: 0)
     *          - B_0x1: DMA request generated on Transfer Complete Reload event (value: 1)
     */
        /** @brief DMA request not generated on Transfer Complete Reload event */
    constexpr std::uint32_t I2C_AUTOCR_TCRDMAEN_B_0x0 = 0;
        /** @brief DMA request generated on Transfer Complete Reload event */
    constexpr std::uint32_t I2C_AUTOCR_TCRDMAEN_B_0x1 = 1;

    /** @brief Trigger selection (refer to Section32. */
    using I2C_AUTOCR_TRIGSEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: i2c_trg0 selected (value: 0)
     *          - B_0x1: i2c_trg1 selected (value: 1)
     *          - B_0xF: i2c_trg15 selected (value: 15)
     */
        /** @brief i2c_trg0 selected */
    constexpr std::uint32_t I2C_AUTOCR_TRIGSEL_B_0x0 = 0;
        /** @brief i2c_trg1 selected */
    constexpr std::uint32_t I2C_AUTOCR_TRIGSEL_B_0x1 = 1;
        /** @brief i2c_trg15 selected */
    constexpr std::uint32_t I2C_AUTOCR_TRIGSEL_B_0xF = 15;

    /** @brief Trigger polarity */
    using I2C_AUTOCR_TRIGPOL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 20, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
    ...
    constexpr std::uint32_t I2C_AUTOCR_TRIGPOL_B_0x0 = 0;
        /** @brief Trigger active on falling edge */
    constexpr std::uint32_t I2C_AUTOCR_TRIGPOL_B_0x1 = 1;

    /** @brief Trigger enable */
    using I2C_AUTOCR_TRIGEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: Trigger disabled (value: 0)
     *          - B_0x1: Trigger enabled (value: 1)
     */
        /** @brief Trigger disabled */
    constexpr std::uint32_t I2C_AUTOCR_TRIGEN_B_0x0 = 0;
        /** @brief Trigger enabled */
    constexpr std::uint32_t I2C_AUTOCR_TRIGEN_B_0x1 = 1;
