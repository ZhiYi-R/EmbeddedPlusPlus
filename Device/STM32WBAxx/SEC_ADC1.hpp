...
#ifndef EMBEDDED_PP_STM32WBAXX_SEC_ADC1_HPP
#define EMBEDDED_PP_STM32WBAXX_SEC_ADC1_HPP
...
namespace STM32WBAxx::SEC_ADC1 {
    ...
    /** @brief RES */
    using ADC_CFGR1_RES = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DMNGT */
    using ADC_CFGR1_DMNGT = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
