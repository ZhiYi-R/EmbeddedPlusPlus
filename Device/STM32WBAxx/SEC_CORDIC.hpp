...
#ifndef EMBEDDED_PP_STM32WBAXX_SEC_CORDIC_HPP
#define EMBEDDED_PP_STM32WBAXX_SEC_CORDIC_HPP
...
namespace STM32WBAxx::SEC_CORDIC {
    ...
    /** @brief Precision required (number of iterations) */
