...
#ifndef EMBEDDED_PP_STM32WBAXX_SEC_EXTI_HPP
#define EMBEDDED_PP_STM32WBAXX_SEC_EXTI_HPP
...
namespace STM32WBAxx::SEC_EXTI {
    ...
    /** @brief configurable event inputs x rising edge pending bit */
    using RPR1_RPIF19 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief configurable event inputs x rising edge pending bit */
    ...
    /** @brief configurable event inputs x falling edge pending bit. */
    using FPR1_FPIF19 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 19, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief configurable event inputs x falling edge pending bit. */
    ...
    using LOCKR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x70, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief LOCK */
    using LOCKR_LOCK = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief CPU wakeup with event generation mask on event input */
