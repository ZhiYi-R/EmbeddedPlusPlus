...
#ifndef EMBEDDED_PP_STM32WBAXX_SEC_GPIOI_HPP
#define EMBEDDED_PP_STM32WBAXX_SEC_GPIOI_HPP
...
namespace STM32WBAxx::SEC_GPIOI {
    ...
    /** @brief Port x configuration bits (y =7 .. 0) */
    ...
    /** @brief Port x reset bit y (y = 0..7) */
    ...
    /** @brief Port x high-speed low-voltage configuration (y= 7 to 0) */
