...
#ifndef EMBEDDED_PP_STM32WBAXX_SEC_GTZC2_TZSC_HPP
#define EMBEDDED_PP_STM32WBAXX_SEC_GTZC2_TZSC_HPP
...
/** @brief GTZC2_TZSC */
namespace STM32WBAxx::SEC_GTZC2_TZSC {
    ...
    /** @brief secure access mode for ADC2 */
    using TZSC_SECCFGR1_ADC2SEC = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief privileged access mode for ADC2 */
    using TZSC_PRIVCFGR1_ADC2PRIV = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
