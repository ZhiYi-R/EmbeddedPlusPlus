...
#ifndef EMBEDDED_PP_STM32WBAXX_SEC_I2C1_HPP
#define EMBEDDED_PP_STM32WBAXX_SEC_I2C1_HPP
...
namespace STM32WBAxx::SEC_I2C1 {
    ...
    using CR1_FMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Address match flag (ADDR) automatic clear */
    using CR1_ADDRACLR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 30, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief STOP detection flag (STOPF) automatic clear */
    using CR1_STOPFACLR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Slave address bit (master mode) */
    using CR2_SADD = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 10, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
