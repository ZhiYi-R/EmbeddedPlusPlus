...
#ifndef EMBEDDED_PP_STM32WBAXX_SEC_RCC_HPP
#define EMBEDDED_PP_STM32WBAXX_SEC_RCC_HPP
...
namespace STM32WBAxx::SEC_RCC {
    ...
    /** @brief MSIS clock ready flag Set by hardware to indicate that the MSIS oscillator is stable. This bit is set only when MSIS is enabled by software by setting MSISON. Note: Once the MSISON bit is cleared, MSISRDY goes low after six MSIS clock cycles. */
    ...
    /** @brief MSIK clock ready flag Set by hardware to indicate that the MSIK is stable. This bit is set only when MSI kernel oscillator is enabled by software by setting MSIKON. Note: Once the MSIKON bit is cleared, MSIKRDY goes low after six MSIK oscillator clock cycles. */
    ...
    /** @brief HSI16 clock ready flag Set by hardware to indicate that HSI16 oscillator is stable. This bit is set only when HSI16 is enabled by software by setting HSION. Note: Once the HSION bit is cleared, HSIRDY goes low after six HSI16 clock cycles. */
    ...
    /** @brief SHSI clock enable Set and cleared by software. Cleared by hardware to stop the SHSI when entering in Stop, Standby or Shutdown modes. */
    ...
    /** @brief SHSI clock ready flag Set by hardware to indicate that the SHSI oscillator is stable. This bit is set only when SHSI is enabled by software by setting SHSION. Note: Once the SHSION bit is cleared, SHSIRDY goes low after six SHSI clock cycles. */
    ...
    /** @brief HSE clock ready flag Set by hardware to indicate that the HSE oscillator is stable. Note: Once the HSEON bit is cleared, HSERDY goes low after six HSE clock cycles. */
    ...
    /** @brief PLL1 enable Set and cleared by software to enable the main PLL. Cleared by hardware when entering Stop, Standby or Shutdown mode. This bit cannot be reset if the PLL1 clock is used as the system clock. */
    ...
    /** @brief PLL2 enable Set and cleared by software to enable PLL2. Cleared by hardware when entering Stop, Standby or Shutdown mode. */
    ...
    /** @brief PLL3 enable Set and cleared by software to enable PLL3. Cleared by hardware when entering Stop, Standby or Shutdown mode. */
    ...
    /** @brief MSIRC0 clock calibration for MSI ranges 0 to 3 These bits are initialized at startup with the factory-programmed MSIRC0 calibration trim value for ranges 0 to 3. When MSITRIM0 is written, MSICAL0 is updated with the sum of MSITRIM0[4:0] and the factory-programmed calibration trim value MSIRC0[4:0]. */
    using RCC_ICSCR1_MSICAL0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 15, 5, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief MSI bias mode selection Set by software to select the MSI bias mode. By default, the MSI bias is in continuous mode in order to maintain the output clocks accuracy. Setting this bit reduces the MSI consumption under range 4 but decrease its accuracy. */
    ...
    /** @brief HSI clock trimming These bits provide an additional user-programmable trimming value that is added to the HSICAL[11:0] bits. It can be programmed to adjust to voltage and temperature variations that influence the frequency of the HSI. */
    ...
    /** @details Possible values:
     *          - B_0x0: MSIS oscillator selected as wakeup from stop clock and CSS backup clock (value: 0)
     *          - B_0x1: HSI16 oscillator selected as wakeup from stop clock and CSS backup clock (value: 1)
     */
        /** @brief MSIS oscillator selected as wakeup from stop clock and CSS backup clock */
    constexpr std::uint32_t RCC_CFGR1_STOPWUCK_B_0x0 = 0;
        /** @brief HSI16 oscillator selected as wakeup from stop clock and CSS backup clock */
    constexpr std::uint32_t RCC_CFGR1_STOPWUCK_B_0x1 = 1;

    /** @brief wakeup from Stop kernel clock automatic enable selection Set and cleared by software to enable automatically another oscillator when exiting Stop mode. This oscillator can be used as independent kernel clock by peripherals. */
    ...
    /** @brief AHB2_2 clock disable This bit can be set in order to further reduce power consumption, when none of the AHB2 peripherals from RCC_AHB2ENR2 are used and when their clocks are disabled in RCC_AHB2ENR2. When this bit is set, all the AHB2 peripherals clocks from RCC_AHB2EBNR2 are off. */
    ...
    /** @brief APB2 clock disable This bit can be set in order to further reduce power consumption, when none of the APB2 peripherals are used and when their clocks are disabled in RCC_APB2ENR. When this bit is set, all the APB2 peripherals clocks are off. */
    ...
    /** @brief APB3 prescaler Set and cleared by software to control the division factor of the APB3 clock (PCLK3). 0xx: HCLK not divided */
    ...
    /** @brief PLL1 entry clock source Set and cleared by software to select PLL1 clock source. These bits can be written only when the PLL1 is disabled. In order to save power, when no PLL1 is used, the value of PLL1SRC must be 0. */
    ...
    /** @brief PLL1 DIVP divider output enable Set and reset by software to enable the pll1_p_ck output of the PLL1. To save power, PLL1PEN and PLL1P bits must be set to 0 when the pll1_p_ck is not used. This bit can be written only when the PLL1 is disabled (PLL1ON = 0 and PLL1RDY = 0). */
    ...
    /** @brief PLL1 DIVQ divider output enable Set and reset by software to enable the pll1_q_ck output of the PLL1. To save power, PLL1QEN and PLL1Q bits must be set to 0 when the pll1_q_ck is not used. This bit can be written only when the PLL1 is disabled (PLL1ON = 0 and PLL1RDY = 0). */
    ...
    /** @brief PLL1 DIVR divider output enable Set and reset by software to enable the pll1_r_ck output of the PLL1. To save power, PLL1RENPLL2REN and PLL1R bits must be set to 0 when the pll1_r_ck is not used. This bit can be written only when the PLL1 is disabled (PLL1ON = 0 and PLL1RDY = 0). */
    ...
    /** @brief PLL2 entry clock source Set and cleared by software to select PLL2 clock source. These bits can be written only when the PLL2 is disabled. In order to save power, when no PLL2 is used, the value of PLL2SRC must be 0. */
    ...
    /** @brief PLL2 input frequency range Set and reset by software to select the proper reference frequency range used for PLL2. This bit must be written before enabling the PLL2. 00-01-10: PLL2 input (ref2_ck) clock range frequency between 4 and 8 MHz */
    ...
    /** @brief Prescaler for PLL2 Set and cleared by software to configure the prescaler of the PLL2. The VCO2 input frequency is PLL2 input clock frequency/PLL2M. This bit can be written only when the PLL2 is disabled (PLL2ON = 0 and PLL2RDY = 0). ... */
    ...
    /** @brief PLL2 DIVP divider output enable Set and reset by software to enable the pll2_p_ck output of the PLL2. To save power, PLL2PEN and PLL2P bits must be set to 0 when the pll2_p_ck is not used. This bit can be written only when the PLL2 is disabled (PLL2ON = 0 and PLL2RDY = 0). */
    ...
    /** @brief PLL2 DIVQ divider output enable Set and reset by software to enable the pll2_q_ck output of the PLL2. To save power, PLL2QEN and PLL2Q bits must be set to 0 when the pll2_q_ck is not used. This bit can be written only when the PLL2 is disabled (PLL2ON = 0 and PLL2RDY = 0. */
    ...
    /** @brief PLL2 DIVR divider output enable Set and reset by software to enable the pll2_r_ck output of the PLL2. To save power, PLL2REN and PLL2R bits must be set to 0 when the pll2_r_ck is not used. This bit can be written only when the PLL2 is disabled (PLL2ON = 0 and PLL2RDY = 0). */
    ...
    /** @brief PLL3 entry clock source Set and cleared by software to select PLL3 clock source. These bits can be written only when the PLL3 is disabled. In order to save power, when no PLL3 is used, the value of PLL3SRC must be 00. */
    ...
    /** @brief PLL3 input frequency range Set and reset by software to select the proper reference frequency range used for PLL3. This bit must be written before enabling the PLL3. 00-01-10: PLL3 input (ref3_ck) clock range frequency between 4 and 8 MHz */
    ...
    /** @brief Prescaler for PLL3 Set and cleared by software to configure the prescaler of the PLL3. The VCO3 input frequency is PLL3 input clock frequency/PLL3M. This bit can be written only when the PLL3 is disabled (PLL3ON = 0 and PLL3RDY = 0). ... */
    ...
    /** @brief PLL3 DIVP divider output enable Set and reset by software to enable the pll3_p_ck output of the PLL3. To save power, PLL3PEN and PLL3P bits must be set to 0 when the pll3_p_ck is not used. This bit can be written only when the PLL3 is disabled (PLL3ON = 0 and PLL3RDY = 0). */
    ...
    /** @brief PLL3 DIVQ divider output enable Set and reset by software to enable the pll3_q_ck output of the PLL3. To save power, PLL3QEN and PLL3Q bits must be set to 0 when the pll3_q_ck is not used. This bit can be written only when the PLL3 is disabled (PLL3ON = 0 and PLL3RDY = 0). */
    ...
    /** @brief PLL3 DIVR divider output enable Set and reset by software to enable the pll3_r_ck output of the PLL3. To save power, PLL3REN and PLL3R bits must be set to 0 when the pll3_r_ck is not used. This bit can be written only when the PLL3 is disabled (PLL3ON = 0 and PLL3RDY = 0). */
    ...
    /** @brief PLL2 DIVR division factor Set and reset by software to control the frequency of the pll2_r_ck clock. These bits can be written only when the PLL2 is disabled (PLL2ON = 0 and PLL2RDY = 0). ... */
    ...
    /** @details Possible values:
     *          - B_0x3: PLL3N = 4 (value: 3)
     *          - B_0x4: PLL3N = 5 (value: 4)
     *          - B_0x5: PLL3N = 6 (value: 5)
     *          - B_0x80: PLL3N = 129 (default after reset) (value: 128)
     *          - B_0x1FF: PLL3N = 512 (value: 511)
     */
        /** @brief PLL3N = 4 */
    constexpr std::uint32_t RCC_PLL3DIVR_PLL3N_B_0x3 = 3;
        /** @brief PLL3N = 5 */
    constexpr std::uint32_t RCC_PLL3DIVR_PLL3N_B_0x4 = 4;
        /** @brief PLL3N = 6 */
    constexpr std::uint32_t RCC_PLL3DIVR_PLL3N_B_0x5 = 5;
        /** @brief PLL3N = 129 (default after reset) */
    constexpr std::uint32_t RCC_PLL3DIVR_PLL3N_B_0x80 = 128;
        /** @brief PLL3N = 512 */
    constexpr std::uint32_t RCC_PLL3DIVR_PLL3N_B_0x1FF = 511;

    /** @brief PLL3 DIVP division factor Set and reset by software to control the frequency of the pll3_p_ck clock. These bits can be written only when the PLL3 is disabled (PLL3ON = 0 and PLL3RDY = 0). ... */
    ...
    /** @brief PLL3 DIVQ division factor Set and reset by software to control the frequency of the pll3_q_ck clock. These bits can be written only when the PLL3 is disabled (PLL3ON = 0 and PLL3RDY = 0). ... */
    ...
    /** @brief PLL3 DIVR division factor Set and reset by software to control the frequency of the pll3_r_ck clock. These bits can be written only when the PLL3 is disabled (PLL3ON = 0 and PLL3RDY = 0). ... */
    ...
    /** @brief MSIS ready interrupt enable Set and cleared by software to enable/disable interrupt caused by the MSIS oscillator stabilization. */
    ...
    /** @brief HSI48 ready interrupt enable Set and cleared by software to enable/disable interrupt caused by the HSI48 oscillator stabilization. */
    ...
    /** @brief PLL ready interrupt enable Set and cleared by software to enable/disable interrupt caused by PLL1 lock. */
    ...
    /** @brief PLL2 ready interrupt enable Set and cleared by software to enable/disable interrupt caused by PLL2 lock. */
    ...
    /** @brief PLL3 ready interrupt enable Set and cleared by software to enable/disable interrupt caused by PLL3 lock. */
    ...
    /** @brief MSIK ready interrupt enable Set and cleared by software to enable/disable interrupt caused by the MSIK oscillator stabilization. */
    ...
    /** @brief SHSI ready interrupt enable Set and cleared by software to enable/disable interrupt caused by the SHSI oscillator stabilization. */
    ...
    /** @brief LSI ready interrupt flag Set by hardware when the LSI clock becomes stable and LSIRDYIE is set. Cleared by software setting the LSIRDYC bit. */
    ...
    /** @brief LSE ready interrupt flag Set by hardware when the LSE clock becomes stable and LSERDYIE is set. Cleared by software setting the LSERDYC bit. */
    ...
    /** @brief MSIS ready interrupt flag Set by hardware when the MSIS clock becomes stable and MSISRDYIE is set. Cleared by software setting the MSISRDYC bit. */
    ...
    /** @brief HSI48 ready interrupt flag Set by hardware when the HSI48 clock becomes stable and HSI48RDYIE is set. Cleared by software setting the HSI48RDYC bit. */
    ...
    /** @brief PLL1 ready interrupt flag Set by hardware when the PLL1 locks and PLL1RDYIE is set. Cleared by software setting the PLL1RDYC bit. */
    ...
    /** @brief PLL2 ready interrupt flag Set by hardware when the PLL2 locks and PLL2RDYIE is set. Cleared by software setting the PLL2RDYC bit. */
    ...
    /** @brief PLL3 ready interrupt flag Set by hardware when the PLL3 locks and PLL3RDYIE is set. Cleared by software setting the PLL3RDYC bit. */
    ...
    /** @brief MSIK ready interrupt flag Set by hardware when the MSIK clock becomes stable and MSIKRDYIE is set. Cleared by software setting the MSIKRDYC bit. */
    ...
    /** @brief SHSI ready interrupt flag Set by hardware when the SHSI clock becomes stable and SHSIRDYIE is set. Cleared by software setting the SHSIRDYC bit. */
    ...
    /** @brief ADC1 reset Set and cleared by software. */
    using RCC_AHB2RSTR1_ADC1RST = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: No effect (value: 0)
     *          - B_0x1: Reset ADC1 (value: 1)
     */
        /** @brief No effect */
    constexpr std::uint32_t RCC_AHB2RSTR1_ADC1RST_B_0x0 = 0;
        /** @brief Reset ADC1 */
    constexpr std::uint32_t RCC_AHB2RSTR1_ADC1RST_B_0x1 = 1;
    ...
    /** @brief ADC4 reset Set and cleared by software. */
    ...
    /** @brief ADF1 reset Set and cleared by software. */
    ...
    /** @brief LPTIM1 reset Set and cleared by software. */
    ...
    /** @brief COMP reset Set and cleared by software. */
    ...
    /** @brief VREFBUF reset Set and cleared by software. */
    ...
    /** @brief GPDMA1 clock enable Set and cleared by software. */
    ...
    /** @brief CORDIC clock enable Set and cleared by software. */
    ...
    /** @brief FMAC clock enable Set and reset by software. */
    ...
    /** @brief MDF1 clock enable Set and reset by software. */
    ...
    /** @brief FLASH clock enable Set and cleared by software. This bit can be disabled only when the Flash memory is in power down mode. */
    ...
    /** @brief RAMCFG clock enable Set and cleared by software. */
    ...
    /** @brief DMA2D clock enable Set and cleared by software. */
    ...
    /** @brief GTZC1 clock enable Set and reset by software. */
    ...
    /** @brief BKPSRAM clock enable Set and reset by software. */
    ...
    /** @brief DCACHE1 clock enable Set and reset by software. Note: DCACHE1 clock must be enabled when external memories are accessed through OCTOSPI1, OCTOSPI2 or FSMC, even if the DCACHE1 is bypassed. */
    ...
    /** @brief ADC1 clock enable Set and cleared by software. */
    using RCC_AHB2ENR1_ADC1EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: ADC1 clock disabled (value: 0)
     *          - B_0x1: ADC1 clock enabled (value: 1)
     */
        /** @brief ADC1 clock disabled */
    constexpr std::uint32_t RCC_AHB2ENR1_ADC1EN_B_0x0 = 0;
        /** @brief ADC1 clock enabled */
    constexpr std::uint32_t RCC_AHB2ENR1_ADC1EN_B_0x1 = 1;
    ...
    /** @brief OTG_FS clock enable Set and cleared by software. */
    using RCC_AHB2ENR1_OTGEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: OTG_FS clock disabled (value: 0)
     *          - B_0x1: OTG_FS clock enabled (value: 1)
     */
        /** @brief OTG_FS clock disabled */
    constexpr std::uint32_t RCC_AHB2ENR1_OTGEN_B_0x0 = 0;
        /** @brief OTG_FS clock enabled */
    ...
    /** @brief LPGPIO1 enable Set and cleared by software. */
    ...
    /** @brief PWR clock enable Set and cleared by software. */
    ...
    /** @brief ADC4 clock enable Set and cleared by software. */
    ...
    /** @brief LPDMA1 clock enable Set and cleared by software. */
    ...
    /** @brief ADF1 clock enable Set and cleared by software. */
    ...
    /** @brief GTZC2 clock enable Set and cleared by software. */
    ...
    /** @brief SRAM4 clock enable Set and reset by software. */
    ...
    /** @brief LPTIM3 clock enable Set and cleared by software. */
    ...
    /** @brief LPTIM4 clock enable Set and cleared by software. */
    ...
    /** @brief COMP clock enable Set and cleared by software. */
    ...
    /** @brief VREFBUF clock enable Set and cleared by software. */
    ...
    /** @brief RTC and TAMP APB clock enable Set and cleared by software. */
    ...
    /** @brief RCC AHB2 peripheral clocks enable in Sleep and	Stop modes register 1 */
    ...
    /** @brief ADC1 clocks enable during Sleep and Stop modes Set and cleared by software. */
    using RCC_AHB2SMENR1_ADC1SMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: ADC1 clocks disabled by the clock gating during Sleep and Stop modes (value: 0)
     *          - B_0x1: ADC1 clocks enabled by the clock gating during Sleep and Stop modes (value: 1)
     */
        /** @brief ADC1 clocks disabled by the clock gating during Sleep and Stop modes */
    constexpr std::uint32_t RCC_AHB2SMENR1_ADC1SMEN_B_0x0 = 0;
        /** @brief ADC1 clocks enabled by the clock gating during Sleep and Stop modes */
    constexpr std::uint32_t RCC_AHB2SMENR1_ADC1SMEN_B_0x1 = 1;
    ...
    /** @brief OTG_FS clocks enable during Sleep and Stop modes Set and cleared by software. */
    using RCC_AHB2SMENR1_OTGSMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: OTG_FS clocks disabled by the clock gating during Sleep and Stop modes (value: 0)
     *          - B_0x1: OTG_FS clocks enabled by the clock gating during Sleep and Stop modes (value: 1)
     */
        /** @brief OTG_FS clocks disabled by the clock gating during Sleep and Stop modes */
    constexpr std::uint32_t RCC_AHB2SMENR1_OTGSMEN_B_0x0 = 0;
        /** @brief OTG_FS clocks enabled by the clock gating during Sleep and Stop modes */
    ...
    /** @brief RCC AHB2 peripheral clocks enable in Sleep and	Stop modes register 2 */
    ...
    /** @brief RCC AHB3 peripheral clocks enable in Sleep and Stop modes register */
    using RCC_AHB3SMENR = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0xBC, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief LPGPIO1 enable during Sleep and Stop modes Set and cleared by software. */
    ...
    /** @brief PWR clock enable during Sleep and Stop modes Set and cleared by software. */
    ...
    /** @brief ADC4 clock enable during Sleep and Stop modes Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief DAC1 clock enable during Sleep and Stop modes Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief LPDMA1 clock enable during Sleep and Stop modes Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief ADF1 clock enable during Sleep and Stop modes Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief GTZC2 clock enable during Sleep and Stop modes Set and cleared by software. */
    ...
    /** @brief SRAM4 clocks enable during Sleep and Stop modes Set and cleared by software. */
    ...
    /** @brief SYSCFG clocks enable during Sleep and Stop modes Set and cleared by software. */
    ...
    /** @brief SPI3 clocks enable during Sleep and Stop modes Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief LPUART1 clocks enable during Sleep and Stop modes Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief I2C3 clocks enable during Sleep and Stop modes Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief LPTIM1 clocks enable during Sleep and Stop modes Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief LPTIM3 clocks enable during Sleep and Stop modes Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief LPTIM4 clocks enable during Sleep and Stop modes Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief OPAMP clocks enable during Sleep and Stop modes Set and cleared by software. */
    ...
    /** @brief COMP clocks enable during Sleep and Stop modes Set and cleared by software. */
    ...
    /** @brief VREFBUF clocks enable during Sleep and Stop modes Set and cleared by software. */
    ...
    /** @brief RTC and TAMP APB clock enable during Sleep and Stop modes Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief SPI3 autonomous mode enable in Stop 0,1, 2 mode Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief LPUART1 autonomous mode enable in Stop 0,1, 2 mode Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief I2C3 autonomous mode enable in Stop 0,1,2 mode Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief LPTIM1 autonomous mode enable in Stop 0,1,2 mode Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief LPTIM3 autonomous mode enable in Stop 0,1,2 mode Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief LPTIM4 autonomous mode enable in Stop 0,1,2 mode Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief OPAMP autonomous mode enable in Stop 0,1,2 mode Set and cleared by software. */
    ...
    /** @brief COMP autonomous mode enable in Stop 0,1,2 mode Set and cleared by software. */
    ...
    /** @brief VREFBUF autonomous mode enable in Stop 0,1,2 mode Set and cleared by software. */
    ...
    /** @brief RTC and TAMP autonomous mode enable in Stop 0,1,2 mode Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    using RCC_SRDAMR_RTCAPBAMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: RTC and TAMP autonomous mode disabled during Stop 0,1,2 mode (value: 0)
     *          - B_0x1: RTC and TAMP autonomous mode enabled during Stop 0,1,2 mode (value: 1)
     */
        /** @brief RTC and TAMP autonomous mode disabled during Stop 0,1,2 mode */
    ...
    /** @brief ADC4 autonomous mode enable in Stop 0,1,2 mode Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief LPGPIO1 autonomous mode enable in Stop 0,1,2 mode Set and cleared by software. */
    ...
    /** @brief DAC1 autonomous mode enable in Stop 0,1,2 mode Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief LPDMA1 autonomous mode enable in Stop 0,1,2 mode Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief ADF1 autonomous mode enable in Stop 0,1,2 mode Set and cleared by software. Note: This bit must be set to allow the peripheral to wake up from Stop modes. */
    ...
    /** @brief SRAM4 autonomous mode enable in Stop 0,1,2 mode Set and cleared by software. */
    ...
    /** @brief USART1 kernel clock source selection This bits are used to select the USART1 kernel clock source. Note: The USART1 is functional in Stop 0 and Stop 1 mode only when the kernel clock is HSI16 or LSE. */
    ...
    /** @brief USART2 kernel clock source selection This bits are used to select the USART2 kernel clock source. Note: The USART2 is functional in Stop 0 and Stop 1 mode only when the kernel clock is HSI16 or LSE. */
    ...
    /** @brief USART3 kernel clock source selection This bits are used to select the USART3 kernel clock source. Note: The USART3 is functional in Stop 0 and Stop 1 mode only when the kernel clock is HSI16 or LSE. */
    ...
    /** @brief UART4 kernel clock source selection This bits are used to select the UART4 kernel clock source. Note: The UART4 is functional in Stop 0 and Stop 1 mode only when the kernel clock is HSI16 or LSE. */
    ...
    /** @brief UART5 kernel clock source selection These bits are used to select the UART5 kernel clock source. Note: The UART5 is functional in Stop 0 and Stop 1 mode only when the kernel clock is HSI16 or LSE. */
    ...
    /** @brief I2C1 kernel clock source selection These bits are used to select the I2C1 kernel clock source. Note: The I2C1 is functional in Stop 0 and Stop 1 mode only when the kernel clock is HSI16 or MSIK. */
    ...
    /** @brief I2C2 kernel clock source selection These bits are used to select the I2C2 kernel clock source. Note: The I2C2 is functional in Stop 0 and Stop 1 mode only when the kernel clock is HSI16 or MSIK. */
    ...
    /** @brief I2C4 kernel clock source selection These bits are used to select the I2C4 kernel clock source. Note: The I2C4 is functional in Stop 0 and Stop 1 mode only when the kernel clock is HSI16 or MSIK. */
    ...
    /** @brief intermediate clock source selection These bits are used to select the clock source used by OTG_FS and SDMMC. */
    ...
    /** @brief ADC1, ADC4 and DAC1 kernel clock source selection These bits are used to select the ADC1, ADC4 and DAC1 kernel clock source. others: reserved Note: The ADC1, ADC4 and DAC1 are functional in Stop 0, Stop 1 and Stop 2 modes only when the kernel clock is HSI16 or MSIK (only ADC4 and DAC1 are functional in Stop 2 mode). */
    ...
    /** @brief LSE oscillator ready Set and cleared by hardware to indicate when the external 32 kHz oscillator is stable. After the LSEON bit is cleared, LSERDY goes low after six external low-speed oscillator clock cycles. */
    ...
    /** @brief LSE oscillator drive capability Set by software to modulate the drive capability of the LSE oscillator. This field can be written only when the external 32 kHz oscillator is disabled (LSEON = 0 and LSERDY = 0). Note: The oscillator is in 'Xtal mode when it is not in bypass mode. */
    ...
    /** @brief CSS on LSE failure Detection Set by hardware to indicate when a failure is detected by the CCS on the external 32 kHz oscillator (LSE). */
    ...
    /** @brief LSE system clock (LSESYS) ready Set and cleared by hardware to indicate when the LSE system clock is stable.When the LSESYSEN bit is set, the LSESYSRDY flag is set after two LSE clock cycles. The LSE clock must be already enabled and stable (LSEON and LSERDY are set). When the LSEON bit is cleared, LSERDY goes low after six external low-speed oscillator clock cycles. */
    ...
    /** @brief LSE clock glitch filter enable Set and cleared by hardware to enable the LSE glitch filter. This bit can be written only when the LSE is disabled (LSEON = 0 and LSERDY = 0) */
    ...
    /** @brief RTC and TAMP clock enable Set and cleared by software. */
    ...
    /** @brief Backup domain software reset Set and cleared by software. */
     ...
     *          - B_0x5: range 5 around 2 MHz (value: 5)
     *          - B_0x6: range 6 around 1.5 MHz (value: 6)
     *          - B_0x7: range 7 around 1 MHz (value: 7)
     *          - B_0x8: range 8 around 3.072 MHz (value: 8)
     */
    ...
    /** @brief Low-power reset flag Set by hardware when a reset occurs due to Stop, Standby or Shutdown mode entry, whereas the corresponding nRST_STOP, nRST_STBY or nRST_SHDW option bit is cleared. Cleared by writing to the RMVF bit. */
    ...
    /** @brief HSI clock configuration and status bits security Set and reset by software. */
    ...
    /** @brief HSE clock configuration bits, status bits and HSE_CSS security Set and reset by software. */
    ...
    /** @brief MSI clock configuration and status bits security Set and reset by software. */
    ...
    /** @brief SYSCLK clock selection, STOPWUCK bit, clock output on MCO configuration security Set and reset by software. */
    ...
    /** @brief PLL2 clock configuration and status bits security Set and reset by software. */
    ...
    /** @brief PLL3 clock configuration and status bits security Set and reset by software. */
    ...
    /** @brief intermediate clock source selection security Set and reset by software. */
    ...
    /** @brief HSI48 clock configuration and status bits security Set and reset by software. */
