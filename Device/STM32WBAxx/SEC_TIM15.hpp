...
#ifndef EMBEDDED_PP_STM32WBAXX_SEC_TIM15_HPP
#define EMBEDDED_PP_STM32WBAXX_SEC_TIM15_HPP
...
namespace STM32WBAxx::SEC_TIM15 {
    ...
    /** @brief Capture/Compare 1 value */
    using CCR2_CCR1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 20, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
