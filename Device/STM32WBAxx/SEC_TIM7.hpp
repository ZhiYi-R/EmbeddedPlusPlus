...
#ifndef EMBEDDED_PP_STM32WBAXX_SEC_TIM7_HPP
#define EMBEDDED_PP_STM32WBAXX_SEC_TIM7_HPP
...
namespace STM32WBAxx::SEC_TIM7 {
    ...
    /** @brief ARR */
    using ARR_ARR = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 19, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
