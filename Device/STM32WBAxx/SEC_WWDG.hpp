...
#ifndef EMBEDDED_PP_STM32WBAXX_SEC_WWDG_HPP
#define EMBEDDED_PP_STM32WBAXX_SEC_WWDG_HPP
...
namespace STM32WBAxx::SEC_WWDG {
    ...
    /** @brief Timer base */
    using CFR_WDGTB = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
