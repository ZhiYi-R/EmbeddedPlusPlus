...
#ifndef EMBEDDED_PP_STM32WL33_LPUART_HPP
#define EMBEDDED_PP_STM32WL33_LPUART_HPP
...
/** @brief LPUART peripheral */
namespace STM32WL33::LPUART {
    ...
    /** @brief WUF: Wakeup from Stop mode flag This bit is set by hardware, when a wakeup event is detected. The event is defined by the WUS bit field. It is cleared by software, writing a 1 to the WUCF in the LPUART_ICR register. An interrupt is generated if WUFIE=1 in the LPUART_CR3 register */
    ...
    /** @brief WUCF: Wakeup from Stop mode clear flag Writing 1 to this bit clears the WUF flag in the LPUART_ISR register. */
