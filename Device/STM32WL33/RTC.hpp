...
#ifndef EMBEDDED_PP_STM32WL33_RTC_HPP
#define EMBEDDED_PP_STM32WL33_RTC_HPP
...
namespace STM32WL33::RTC {
    ...
    /** @brief Time-stamp event active edge 0: RTC_TS input rising edge generates a time-stamp event 1: RTC_TS input falling edge generates a time-stamp event TSE must be reset when TSEDGE is changed to avoid unwanted TSF setting. */
    ...
    /** @brief Timestamp enable 0: Timestamp disable 1: Timestamp enable */
    ...
    /** @details Possible values:
     *          - B_0x0: Time-stamp Interrupt disable (value: 0)
     *          - B_0x1: Time-stamp Interrupt enable (value: 1)
     */
        /** @brief Time-stamp Interrupt disable */
    ...
    /** @brief Timestamp on internal event enable 0: Internal event timestamp disable 1: Internal event timestamp enable */
    ...
    /** @brief This flag is set by hardware when a time-stamp event occurs. This flag is cleared by software by writing 0. If ITSF flag is set, TSF must be cleared together with ITSF by writing 0 in both bits. */
    using RTC_ISR_TSF = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 11, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief This flag is set by hardware when a time-stamp event occurs while TSF is already set. This flag is cleared by software by writing 0. It is recommended to check and then clear TSOVF only after clearing the TSF bit. Otherwise, an overflow might not be noticed if a timestamp event occurs immediately before the TSF bit is cleared. */
    ...
    /** @brief Internal time-stamp flag This flag is set by hardware when a time-stamp on the internal event occurs. This flag is cleared by software by writing 0, and must be cleared together with TSF bit by writing 0 in both bits. */
    ...
    /** @brief Sub second value SS[15:0] is the value of the synchronous prescalers counter when the timestamp event occurred. */
    ...
    /** @brief RTC_ALARM on PA8 output type */
    using RTC_OR_ALARMOUTTYPE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @details Possible values:
     *          - B_0x0: RTC_ALARM, when mapped on PA8, is open-drain output (value: 0)
     *          - B_0x1: RTC_ALARM, when mapped on PA8, is push-pull output (value: 1)
     */
        /** @brief RTC_ALARM, when mapped on PA8, is open-drain output */
    constexpr std::uint32_t RTC_OR_ALARMOUTTYPE_B_0x0 = 0;
        /** @brief RTC_ALARM, when mapped on PA8, is push-pull output */
    constexpr std::uint32_t RTC_OR_ALARMOUTTYPE_B_0x1 = 1;

    /** @brief RTC_OUT remap Setting this bit allows to remap the RTC outputs on PA9 as follows: 0 : If OSEL/= '00' : RTC_ALARM is ouput on PA8 If OSEL= '00' and COE = 1 : RTC_CALIB is output on PA8 1 : If OSEL /= '00' and COE = 0 : RTC_ALARM is output on PA9 If OSEL = '00' and COE = 1: RTC_CALIB is output on PA9 If OSEL /= '00' and COE = 1: RTC_CALIB is output on PA9 and RTC_ALARM is output on PA8. Note: the RTC outputs are functional in DEEPSTOP mode only on PA8. */
