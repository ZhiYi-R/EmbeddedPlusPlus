...
#ifndef EMBEDDED_PP_STM32WL33_TIM2_HPP
#define EMBEDDED_PP_STM32WL33_TIM2_HPP
...
namespace STM32WL33::TIM2 {
    ...
    /** @brief Trigger selection. See TS_2_0_ description */
    ...
    /** @brief ETR_RMP: ETR remapping capability 0: TIMx_ETR is not connected to ADC AWD (must be selected when the ETR comes from the ETR input pin) 1: TIMx_ETR is connected to ADC AWD Note: ADC AWD source is 'ORed' with the TIMx_ETR input signals. When ADC AWD is used, it is necessary to make sure that the corresponding TIMx_ETR input pin is not enabled in the alternate function controller. */
    using OR1_ETR_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief This field is not used in Blue51. Not available in IUM */
    using OR1_OR1_1 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TI4_RMP: Input capture 4 remap 0: TIM2 input capture 4 is connected to I/O 1: TIM2 input capture 4 is connected to COMP1-OUT */
    using OR1_TI4_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief AF1 register */
    using AF1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x60, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ETRSEL[2:0]: External trigger source selection 000: TIMx External trigger legacy mode 001: TIMx External trigger source select COMP1_OUT Other: Reserved Note: These bits can't be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register) */
    using AF1_ETR_SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief ETRSEL[2:0]: External trigger source selection This field is not used in Blue51. Not available in IUM */
    using AF1_ETR_SEL_3 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief TI2SEL[3:0]: selects TI2[0] to TI2[15] input 0000: TIMx_CH2 input Others: Reserved */
    using TISEL_TI2SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 8, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TI3SEL[3:0]: selects TI3[0] to TI3[15] input 0000: TIMx_CH3 input Others: Reserved */
    using TISEL_TI3SEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 16, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TI4SEL[3:0]: selects TI4[0] to TI4[15] input 0000: TIMx_CH4 input Others: Reserved */
