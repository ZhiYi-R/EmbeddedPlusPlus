...
#ifndef EMBEDDED_PP_STM32WL5X_CM0P_DAC_HPP
#define EMBEDDED_PP_STM32WL5X_CM0P_DAC_HPP
...
namespace STM32WL5x_CM0P::DAC {
    ...
    using CR_TSEL13 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TSEL12 */
    using CR_TSEL12 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 4, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TSEL11 */
    using CR_TSEL11 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 3, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TSEL10 */
    using CR_TSEL10 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief DAC Channel 1 sample Time (only valid in Sample and Hold mode) */
