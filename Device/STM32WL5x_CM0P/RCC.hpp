...
#ifndef EMBEDDED_PP_STM32WL5X_CM0P_RCC_HPP
#define EMBEDDED_PP_STM32WL5X_CM0P_RCC_HPP
...
namespace STM32WL5x_CM0P::RCC {
    ...
    /** @brief DAC1 clock enable during CPU1 CSleep mode. */
    ...
    /** @brief CLK2 prescaler flag (CPU2) */
    ...
    /** @brief [dual core device only] HCLK2 prescaler (CPU2) */
    ...
    /** @brief CPU2 DMAMUX1 clock enable */
    using C2AHB1ENR_DMAMUX1EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief CPU2 Low power timer 1 clocks enable */
    using C2APB1ENR1_LPTIM1EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CPU2 DAC1 clock enable */
    using C2APB1ENR1_DAC1EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CPU2 I2C3 clocks enable */
    using C2APB1ENR1_I2C3EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CPU2 I2C2 clocks enable */
    using C2APB1ENR1_I2C2EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CPU2 I2C1 clocks enable */
    using C2APB1ENR1_I2C1EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CPU2 USART2 clock enable */
    using C2APB1ENR1_USART2EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CPU2 SPI2S2 clock enable */
    using C2APB1ENR1_SPI2S2EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief CPU2 Low power timer 3 clocks enable */
    using C2APB1ENR2_LPTIM3EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CPU2 Low power timer 2 clocks enable */
    using C2APB1ENR2_LPTIM2EN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief CPU2 Low power UART 1 clocks enable */
    ...
    /** @brief CPU2 USART1clocks enable */
    ...
    /** @brief CPU2 sub-GHz radio SPI clock enable */
    using C2APB3ENR_SUBGHZSPIEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief CRC clock enable during CPU2 CSleep mode. */
    using C2AHB1SMENR_CRCSMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DMAMUX1 clock enable during CPU2 CSleep mode. */
    using C2AHB1SMENR_DMAMUX1SMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DMA2 clock enable during CPU2 CSleep mode. */
    using C2AHB1SMENR_DMA2SMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DMA1 clock enable during CPU2 CSleep mode. */
    ...
    /** @brief Flash interface clock enable during CPU2 CSleep mode. */
    using C2AHB3SMENR_FLASHSMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 25, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SRAM2 memory interface clock enable during CPU2 CSleep mode. */
    using C2AHB3SMENR_SRAM2SMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SRAM1 interface clock enable during CPU2 CSleep mode. */
    using C2AHB3SMENR_SRAM1SMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief True RNG clock enable during CPU2 CSleep and CStop mode. */
    using C2AHB3SMENR_RNGSMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 18, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief AES accelerator clock enable during CPU2 CSleep mode. */
    using C2AHB3SMENR_AESSMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief PKA accelerator clock enable during CPU2 CSleep mode. */
    ...
    /** @brief Low power timer 1 clock enable during CPU2 CSleep and CStop mode */
    using C2APB1SMENR1_LPTIM1SMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 31, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief DAC1 clock enable during CPU2 CSleep mode. */
    using C2APB1SMENR1_DAC1SMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 29, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief I2C3 clock enable during CPU2 CSleep and CStop modes */
    using C2APB1SMENR1_I2C3SMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 23, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief I2C2 clock enable during CPU2 CSleep and CStop modes */
    using C2APB1SMENR1_I2C2SMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 22, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief I2C1 clock enable during CPU2 CSleep and CStop modes */
    using C2APB1SMENR1_I2C1SMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 21, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief USART2 clock enable during CPU2 CSleep mode. */
    using C2APB1SMENR1_USART2SMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief SPI2S2 clock enable during CPU2 CSleep mode. */
    using C2APB1SMENR1_SPI2S2SMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 14, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief RTC bus clock enable during CPU2 CSleep mode. */
    using C2APB1SMENR1_RTCAPBSMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 10, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief TIM2 timer clock enable during CPU2 CSleep mode. */
    ...
    /** @brief Low power timer 3 clocks enable during CPU2 CSleep and CStop modes. */
    using C2APB1SMENR2_LPTIM3SMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 6, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Low power timer 2 clocks enable during CPU2 CSleep and CStop modes. */
    using C2APB1SMENR2_LPTIM2SMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 5, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Low power UART 1 clock enable during CPU2 CSleep and CStop mode */
    ...
    /** @brief sub-GHz radio SPI clock enable during CPU2 CSleep and CStop modes */
    using C2APB3SMENR_SUBGHZSPISMEN = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
