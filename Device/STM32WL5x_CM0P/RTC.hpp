...
#ifndef EMBEDDED_PP_STM32WL5X_CM0P_RTC_HPP
#define EMBEDDED_PP_STM32WL5X_CM0P_RTC_HPP
...
namespace STM32WL5x_CM0P::RTC {
    ...
    /** @brief Wakeup auto-reload output clear value */
    ...
    /** @brief Calibration low-power mode */
    ...
    /** @brief SSR underflow masked flag */
