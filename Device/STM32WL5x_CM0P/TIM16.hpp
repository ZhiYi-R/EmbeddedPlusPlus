...
#ifndef EMBEDDED_PP_STM32WL5X_CM0P_TIM16_HPP
#define EMBEDDED_PP_STM32WL5X_CM0P_TIM16_HPP
...
namespace STM32WL5x_CM0P::TIM16 {
    ...
    using TIM16_OR1 = ::EmbeddedPP::LowLevel::Register<std::uint32_t, 0x50, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Timer 17 input 1 connection */
    using TIM16_OR1_TI1_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief TISEL */
    using TIM16_TISEL_TISEL = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 0, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
}
