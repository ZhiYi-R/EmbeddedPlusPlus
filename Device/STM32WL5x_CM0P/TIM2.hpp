...
#ifndef EMBEDDED_PP_STM32WL5X_CM0P_TIM2_HPP
#define EMBEDDED_PP_STM32WL5X_CM0P_TIM2_HPP
...
namespace STM32WL5x_CM0P::TIM2 {
    ...
    using TIM2_OR1_TI4_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 2, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief External trigger remap */
    using TIM2_OR1_ETR_RMP = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 1, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
