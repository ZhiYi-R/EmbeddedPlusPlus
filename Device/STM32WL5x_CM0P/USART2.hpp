...
#ifndef EMBEDDED_PP_STM32WL5X_CM0P_USART2_HPP
#define EMBEDDED_PP_STM32WL5X_CM0P_USART2_HPP
...
namespace STM32WL5x_CM0P::USART2 {
    ...
    /** @brief Word length */
    using CR1_M = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 12, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief Transmit data register empty/TXFIFO not full interrupt enable */
    ...
    /** @brief Receive data register not empty/RXFIFO not empty interrupt enable */
    ...
    using CR2_ADD7_4 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 28, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief Address of the USART node */
    using CR2_ADD3_0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 24, 4, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    using CR3_SCARCNT2_0 = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 17, 3, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    ...
    /** @brief NE */
    using ISR_NE = ::EmbeddedPP::LowLevel::BitField<std::uint32_t, 2, 1, ::EmbeddedPP::LowLevel::Accessibility::ReadWrite>;
    /** @brief FE */
